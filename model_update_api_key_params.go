...
// UpdateApiKeyParams Specifies the parameters to update an API key.
...
func (o *UpdateApiKeyParams) SetExpiringTimeMsecsNil() {
...
func (o *UpdateApiKeyParams) SetIsActiveNil() {
	o.IsActive.Set(nil)
}
...
func (o UpdateApiKeyParams) MarshalJSON() ([]byte, error) {
...
type NullableUpdateApiKeyParams struct {
	value *UpdateApiKeyParams
	isSet bool
}

func (v NullableUpdateApiKeyParams) Get() *UpdateApiKeyParams {
	return v.value
}

func (v *NullableUpdateApiKeyParams) Set(val *UpdateApiKeyParams) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateApiKeyParams) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateApiKeyParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateApiKeyParams(val *UpdateApiKeyParams) *NullableUpdateApiKeyParams {
	return &NullableUpdateApiKeyParams{value: val, isSet: true}
}

func (v NullableUpdateApiKeyParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateApiKeyParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
