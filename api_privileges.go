...
func (r ApiGetPrivilegesRequest) Name(name string) ApiGetPrivilegesRequest {
	r.name = &name
	return r
}
*/
...
/*
func (r ApiGetPrivilegesRequest) Execute() ([]PrivilegeInfo, *_nethttp.Response, error) {
	return r.ApiService.GetPrivilegesExecute(r)
}

 * GetPrivileges List the privileges defined on the Cohesity Cluster.
...
func (a *PrivilegesApiService) GetPrivileges(ctx _context.Context) ApiGetPrivilegesRequest {
	return ApiGetPrivilegesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PrivilegesApiService) GetPrivileges(r ApiGetPrivilegesRequest) ([]PrivilegeInfo, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokensApiService" {
		token, err := GetTokenHelper(a.client)

		if err != nil {
			return []PrivilegeInfo{}, nil, GenericOpenAPIError{
				error: err.Error(),
			}
		}
 ...
 */
func (a *PrivilegesApiService) GetPrivilegesExecute(r ApiGetPrivilegesRequest) ([]PrivilegeInfo, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrivilegesApiService.GetPrivileges")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/public/privileges"
