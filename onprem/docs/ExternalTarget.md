...
func main() {
    ...
    request := onprem.ApiCreateExternalTargetRequest{
        Body: &body
    }
...
> DeleteExternalTarget(ctx, id).Execute()
...
func main() {
    ...
    request := onprem.ApiDeleteExternalTargetRequest{
        Id: &id
    }
...
func main() {
    ...
    request := onprem.ApiGetExternalTargetByIdRequest{
        Id: &id
    }
...
func main() {
    ...
    request := onprem.ApiGetExternalTargetSettingsRequest{
    }
...
> ExternalTargets GetExternalTargets(ctx).Ids(ids).Names(names).PurposeTypes(purposeTypes).StorageTypes(storageTypes).StorageClasses(storageClasses).Execute()
...
func main() {
    ...
    request := onprem.ApiGetExternalTargetsRequest{
        Ids: &ids
        Names: &names
...
func main() {
    ...
    request := onprem.ApiUpdateExternalTargetRequest{
        Id: &id
        Body: &body
    }
...
func main() {
    ...
    request := onprem.ApiUpdateExternalTargetSettingsRequest{
        Body: &body
    }
