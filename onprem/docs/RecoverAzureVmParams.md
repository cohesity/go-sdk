...
**AzureTargetParams** | Pointer to [**NullableAzureTargetParamsForRecoverVm**](AzureTargetParamsForRecoverVm.md) | Specifies the params for recovering to an Azure target. | [optional] 
