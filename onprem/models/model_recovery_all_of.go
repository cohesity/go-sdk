...
// RecoveryAllOf struct for RecoveryAllOf
type RecoveryAllOf struct {
...
func (o RecoveryAllOf) MarshalJSON() ([]byte, error) {
...
type NullableRecoveryAllOf struct {
	value *RecoveryAllOf
	isSet bool
}

func (v NullableRecoveryAllOf) Get() *RecoveryAllOf {
	return v.value
}

func (v *NullableRecoveryAllOf) Set(val *RecoveryAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoveryAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoveryAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoveryAllOf(val *RecoveryAllOf) *NullableRecoveryAllOf {
	return &NullableRecoveryAllOf{value: val, isSet: true}
}

func (v NullableRecoveryAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoveryAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
