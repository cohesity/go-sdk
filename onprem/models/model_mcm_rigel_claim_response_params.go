...
func (o *McmRigelClaimResponseParams) GetRigelCertificate() string {
	if o == nil || o.RigelCertificate.Get() == nil {
		var ret string
		return ret
	}
...
func (o *McmRigelClaimResponseParams) GetRigelPrivateKey() string {
	if o == nil || o.RigelPrivateKey.Get() == nil {
		var ret string
		return ret
	}
...
func (o *McmRigelClaimResponseParams) GetRigelCaChain() string {
	if o == nil || o.RigelCaChain.Get() == nil {
		var ret string
		return ret
	}
...
func (o *McmRigelClaimResponseParams) GetRigelUseCase() string {
	if o == nil || o.RigelUseCase.Get() == nil {
		var ret string
		return ret
	}
...
func (o McmRigelClaimResponseParams) Print() {
