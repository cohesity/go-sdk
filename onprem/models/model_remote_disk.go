...
func (o *RemoteDisk) GetUsedCapacityBytes() int64 {
	if o == nil || o.UsedCapacityBytes.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *RemoteDisk) GetFileSystemName() string {
	if o == nil || o.FileSystemName.Get() == nil {
		var ret string
		return ret
	}
...
func (o *RemoteDisk) GetUsedCapacityBytesPhysical() int64 {
	if o == nil || o.UsedCapacityBytesPhysical.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *RemoteDisk) GetCapacityBytesPhysical() int64 {
	if o == nil || o.CapacityBytesPhysical.Get() == nil {
		var ret int64
		return ret
	}
