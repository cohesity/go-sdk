...
type RecoverKvmVmParams struct {
	...
	KvmTargetParams NullableKvmTargetParamsForRecoverVm `json:"kvmTargetParams,omitempty"`
}
...
func (o *RecoverKvmVmParams) GetKvmTargetParams() KvmTargetParamsForRecoverVm {
	if o == nil || o.KvmTargetParams.Get() == nil {
		var ret KvmTargetParamsForRecoverVm
		return ret
	}
...
// SetKvmTargetParams gets a reference to the given NullableKvmTargetParamsForRecoverVm and assigns it to the KvmTargetParams field.
...
func (o RecoverKvmVmParams) Print() {
