...
// HyperVObjectProtectionResponseAllOf struct for HyperVObjectProtectionResponseAllOf
type HyperVObjectProtectionResponseAllOf struct {
...
func NewHyperVObjectProtectionResponseAllOf() *HyperVObjectProtectionResponseAllOf {
	this := HyperVObjectProtectionResponseAllOf{}
	return &this
}
...
func (o HyperVObjectProtectionResponseAllOf) MarshalJSON() ([]byte, error) {
...
type NullableHyperVObjectProtectionResponseAllOf struct {
	value *HyperVObjectProtectionResponseAllOf
	isSet bool
}

func (v NullableHyperVObjectProtectionResponseAllOf) Get() *HyperVObjectProtectionResponseAllOf {
	return v.value
}

func (v *NullableHyperVObjectProtectionResponseAllOf) Set(val *HyperVObjectProtectionResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperVObjectProtectionResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperVObjectProtectionResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperVObjectProtectionResponseAllOf(val *HyperVObjectProtectionResponseAllOf) *NullableHyperVObjectProtectionResponseAllOf {
	return &NullableHyperVObjectProtectionResponseAllOf{value: val, isSet: true}
}

func (v NullableHyperVObjectProtectionResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperVObjectProtectionResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
...
func (o HyperVObjectProtectionResponseAllOf) Print() {
