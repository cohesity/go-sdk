...
type RecoverOracleParams struct {
	...
	RecoverAppParams NullableRecoverOracleAppParams `json:"recoverAppParams,omitempty"`
}
...
func (o *RecoverOracleParams) GetRecoverAppParams() RecoverOracleAppParams {
	if o == nil || o.RecoverAppParams.Get() == nil {
		var ret RecoverOracleAppParams
		return ret
	}
...
// SetRecoverAppParams gets a reference to the given NullableRecoverOracleAppParams and assigns it to the RecoverAppParams field.
...
func (o RecoverOracleParams) Print() {
