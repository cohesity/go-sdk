...
func (o *DataTieringShareStats) GetFileTypeTag() string {
	if o == nil || o.FileTypeTag.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DataTieringShareStats) GetFileSizeTag() string {
	if o == nil || o.FileSizeTag.Get() == nil {
		var ret string
		return ret
	}
...
func (o *DataTieringShareStats) GetAccessTimeTag() string {
	if o == nil || o.AccessTimeTag.Get() == nil {
		var ret string
		return ret
	}
...
func (o DataTieringShareStats) Print() {
