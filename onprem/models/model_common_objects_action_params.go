...
// CommonObjectsActionParams Specifies the comon action params needed for performing bulk actions on list of objects.
...
func (o CommonObjectsActionParams) Print() {
