...
func (o *VolumeInfo) GetVolumeSizeInBytes() int64 {
	if o == nil || o.VolumeSizeInBytes.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *VolumeInfo) GetLogicalVolumeInfo() LogicalVolumeInfo {
	if o == nil || o.LogicalVolumeInfo == nil {
		var ret LogicalVolumeInfo
		return ret
	}
...
// SetLogicalVolumeInfo gets a reference to the given LogicalVolumeInfo and assigns it to the LogicalVolumeInfo field.
