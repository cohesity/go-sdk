...
func (o *SecurityConfigCertificateBasedAuth) GetEnableMappingBasedAuthentication() bool {
	if o == nil || o.EnableMappingBasedAuthentication.Get() == nil {
		var ret bool
		return ret
	}
...
func (o *SecurityConfigCertificateBasedAuth) GetCertificateMapping() string {
	if o == nil || o.CertificateMapping.Get() == nil {
		var ret string
		return ret
	}
...
func (o SecurityConfigCertificateBasedAuth) Print() {
