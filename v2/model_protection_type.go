...
// checks if the ProtectionType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionType{}
...
func (o ProtectionType) ToMap() (map[string]interface{}, error) {
