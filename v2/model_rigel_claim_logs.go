...
// checks if the RigelClaimLogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RigelClaimLogs{}
...
func (o *RigelClaimLogs) GetRigelClaimLogsOk() ([]RigelClaimLog, bool) {
	if o == nil || IsNil(o.RigelClaimLogs) {
		return nil, false
	}
...
func (o RigelClaimLogs) ToMap() (map[string]interface{}, error) {
