...
// checks if the ProtectedObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectedObject{}
...
func (o *ProtectedObject) GetLatestSnapshotsInfoOk() ([]ObjectSnapshotsInfo, bool) {
	if o == nil || IsNil(o.LatestSnapshotsInfo) {
		return nil, false
	}
...
func (o ProtectedObject) ToMap() (map[string]interface{}, error) {
