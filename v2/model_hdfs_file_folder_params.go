...
// checks if the HdfsFileFolderParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HdfsFileFolderParams{}
...
func (o HdfsFileFolderParams) ToMap() (map[string]interface{}, error) {
