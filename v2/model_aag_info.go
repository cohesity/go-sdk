...
// checks if the AAGInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AAGInfo{}
...
func (o AAGInfo) ToMap() (map[string]interface{}, error) {
