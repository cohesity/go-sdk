...
// checks if the CommonMssqlFileObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonMssqlFileObjectProtectionParams{}
...
func (o *CommonMssqlFileObjectProtectionParams) SetLogBackupNumStreamsNil() {
...
func (o *CommonMssqlFileObjectProtectionParams) SetLogBackupWithClauseNil() {
...
func (o CommonMssqlFileObjectProtectionParams) ToMap() (map[string]interface{}, error) {
