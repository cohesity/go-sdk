...
// checks if the DowntieredDataLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DowntieredDataLocation{}
...
type _DowntieredDataLocation DowntieredDataLocation
...
func (o DowntieredDataLocation) ToMap() (map[string]interface{}, error) {
...
func (o *DowntieredDataLocation) UnmarshalJSON(data []byte) (err error) {
	...
	varDowntieredDataLocation := _DowntieredDataLocation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDowntieredDataLocation)

	if err != nil {
		return err
	}

	*o = DowntieredDataLocation(varDowntieredDataLocation)
