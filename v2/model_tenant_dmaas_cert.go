...
// checks if the TenantDmaasCert type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantDmaasCert{}
...
func (o *TenantDmaasCert) GetConnectorCaChain() string {
	if o == nil || IsNil(o.ConnectorCaChain.Get()) {
		var ret string
		return ret
	}
...
func (o TenantDmaasCert) ToMap() (map[string]interface{}, error) {
