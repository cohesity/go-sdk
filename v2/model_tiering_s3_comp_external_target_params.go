...
// checks if the TieringS3CompExternalTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TieringS3CompExternalTargetParams{}
...
type _TieringS3CompExternalTargetParams TieringS3CompExternalTargetParams
...
func (o *TieringS3CompExternalTargetParams) SetIsAwsSnowballNil() {
...
func (o *TieringS3CompExternalTargetParams) SetRegionNil() {
	o.Region.Set(nil)
}
...
func (o *TieringS3CompExternalTargetParams) SetSecretAccessKeyNil() {
...
func (o TieringS3CompExternalTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *TieringS3CompExternalTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varTieringS3CompExternalTargetParams := _TieringS3CompExternalTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTieringS3CompExternalTargetParams)

	if err != nil {
		return err
	}

	*o = TieringS3CompExternalTargetParams(varTieringS3CompExternalTargetParams)
