...
// checks if the KvmTargetParamsForRecoverVmVlanConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KvmTargetParamsForRecoverVmVlanConfig{}

// KvmTargetParamsForRecoverVmVlanConfig Specifies VLAN Params associated with the recovered. If this is not specified, then the VLAN settings will be automatically selected from one of the below options: a. If VLANs are configured on Cohesity, then the VLAN host/VIP will be automatically based on the client's (e.g. ESXI host) IP address. b. If VLANs are not configured on Cohesity, then the partition hostname or VIPs will be used for Recovery.
type KvmTargetParamsForRecoverVmVlanConfig struct {
...
func NewKvmTargetParamsForRecoverVmVlanConfig() *KvmTargetParamsForRecoverVmVlanConfig {
	this := KvmTargetParamsForRecoverVmVlanConfig{}
	return &this
}
...
func (o *KvmTargetParamsForRecoverVmVlanConfig) SetDisableVlanNil() {
...
func (o *KvmTargetParamsForRecoverVmVlanConfig) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *KvmTargetParamsForRecoverVmVlanConfig) SetInterfaceNameNil() {
...
func (o KvmTargetParamsForRecoverVmVlanConfig) MarshalJSON() ([]byte, error) {
...
func (o KvmTargetParamsForRecoverVmVlanConfig) ToMap() (map[string]interface{}, error) {
...
type NullableKvmTargetParamsForRecoverVmVlanConfig struct {
	value *KvmTargetParamsForRecoverVmVlanConfig
	isSet bool
}

func (v NullableKvmTargetParamsForRecoverVmVlanConfig) Get() *KvmTargetParamsForRecoverVmVlanConfig {
	return v.value
}

func (v *NullableKvmTargetParamsForRecoverVmVlanConfig) Set(val *KvmTargetParamsForRecoverVmVlanConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableKvmTargetParamsForRecoverVmVlanConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableKvmTargetParamsForRecoverVmVlanConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKvmTargetParamsForRecoverVmVlanConfig(val *KvmTargetParamsForRecoverVmVlanConfig) *NullableKvmTargetParamsForRecoverVmVlanConfig {
	return &NullableKvmTargetParamsForRecoverVmVlanConfig{value: val, isSet: true}
}

func (v NullableKvmTargetParamsForRecoverVmVlanConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKvmTargetParamsForRecoverVmVlanConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
