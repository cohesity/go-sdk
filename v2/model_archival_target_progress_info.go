...
// checks if the ArchivalTargetProgressInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArchivalTargetProgressInfo{}
...
func (o *ArchivalTargetProgressInfo) SetOwnershipContextNil() {
...
func (o *ArchivalTargetProgressInfo) SetUsageTypeNil() {
	o.UsageType.Set(nil)
}
...
func (o ArchivalTargetProgressInfo) ToMap() (map[string]interface{}, error) {
