...
// checks if the MinuteSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MinuteSchedule{}
...
type _MinuteSchedule MinuteSchedule
...
func (o MinuteSchedule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["frequency"] = o.Frequency.Get()
	return toSerialize, nil
}

func (o *MinuteSchedule) UnmarshalJSON(data []byte) (err error) {
	...
	varMinuteSchedule := _MinuteSchedule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMinuteSchedule)

	if err != nil {
		return err
	}

	*o = MinuteSchedule(varMinuteSchedule)
