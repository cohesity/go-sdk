...
// checks if the ProtectionSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionSummary{}
...
func (o ProtectionSummary) ToMap() (map[string]interface{}, error) {
