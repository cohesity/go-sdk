...
// checks if the SecurityConfigPasswordStrength type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityConfigPasswordStrength{}
...
func (o *SecurityConfigPasswordStrength) GetIncludeLowerLetter() bool {
	if o == nil || IsNil(o.IncludeLowerLetter.Get()) {
		var ret bool
		return ret
	}
...
func (o *SecurityConfigPasswordStrength) GetIncludeNumber() bool {
	if o == nil || IsNil(o.IncludeNumber.Get()) {
		var ret bool
		return ret
	}
...
func (o *SecurityConfigPasswordStrength) GetIncludeSpecialChar() bool {
	if o == nil || IsNil(o.IncludeSpecialChar.Get()) {
		var ret bool
		return ret
	}
...
func (o *SecurityConfigPasswordStrength) GetIncludeUpperLetter() bool {
	if o == nil || IsNil(o.IncludeUpperLetter.Get()) {
		var ret bool
		return ret
	}
...
func (o SecurityConfigPasswordStrength) ToMap() (map[string]interface{}, error) {
