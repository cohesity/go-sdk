...
// checks if the S3AclPermission type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3AclPermission{}
...
func (o S3AclPermission) ToMap() (map[string]interface{}, error) {
