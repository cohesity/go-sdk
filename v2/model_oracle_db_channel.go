...
// checks if the OracleDbChannel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleDbChannel{}
...
type OracleDbChannel struct {
	...
	ArchiveLogRetentionHours NullableInt32 `json:"archiveLogRetentionHours,omitempty"`
...
func (o *OracleDbChannel) GetArchiveLogRetentionDays() int32 {
	if o == nil || IsNil(o.ArchiveLogRetentionDays.Get()) {
		var ret int32
		return ret
	}
...
// GetArchiveLogRetentionHours returns the ArchiveLogRetentionHours field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OracleDbChannel) GetArchiveLogRetentionHours() int32 {
	if o == nil || IsNil(o.ArchiveLogRetentionHours.Get()) {
		var ret int32
		return ret
	}
	return *o.ArchiveLogRetentionHours.Get()
}

// GetArchiveLogRetentionHoursOk returns a tuple with the ArchiveLogRetentionHours field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OracleDbChannel) GetArchiveLogRetentionHoursOk() (*int32, bool) {
	...
	return o.ArchiveLogRetentionHours.Get(), o.ArchiveLogRetentionHours.IsSet()
}
...
func (o *OracleDbChannel) HasArchiveLogRetentionHours() bool {
	if o != nil && o.ArchiveLogRetentionHours.IsSet() {
		return true
	}
...
// SetArchiveLogRetentionHours gets a reference to the given NullableInt32 and assigns it to the ArchiveLogRetentionHours field.
func (o *OracleDbChannel) SetArchiveLogRetentionHours(v int32) {
	o.ArchiveLogRetentionHours.Set(&v)
}
// SetArchiveLogRetentionHoursNil sets the value for ArchiveLogRetentionHours to be an explicit nil
func (o *OracleDbChannel) SetArchiveLogRetentionHoursNil() {
	o.ArchiveLogRetentionHours.Set(nil)
}
...
func (o *OracleDbChannel) UnsetArchiveLogRetentionHours() {
	o.ArchiveLogRetentionHours.Unset()
}
...
func (o *OracleDbChannel) GetDatabaseNodeListOk() ([]OracleDatabaseHost, bool) {
	if o == nil || IsNil(o.DatabaseNodeList) {
		return nil, false
	}
...
func (o *OracleDbChannel) GetDatabaseUniqueName() string {
	if o == nil || IsNil(o.DatabaseUniqueName.Get()) {
		var ret string
		return ret
	}
...
func (o *OracleDbChannel) GetDatabaseUuid() string {
	if o == nil || IsNil(o.DatabaseUuid.Get()) {
		var ret string
		return ret
	}
...
func (o *OracleDbChannel) GetDefaultChannelCount() int32 {
	if o == nil || IsNil(o.DefaultChannelCount.Get()) {
		var ret int32
		return ret
	}
...
func (o *OracleDbChannel) GetEnableDgPrimaryBackup() bool {
	if o == nil || IsNil(o.EnableDgPrimaryBackup.Get()) {
		var ret bool
		return ret
	}
...
func (o *OracleDbChannel) GetMaxHostCount() int32 {
	if o == nil || IsNil(o.MaxHostCount.Get()) {
		var ret int32
		return ret
	}
...
func (o *OracleDbChannel) GetRmanBackupType() string {
	if o == nil || IsNil(o.RmanBackupType) {
		var ret string
		return ret
	}
...
func (o OracleDbChannel) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.ArchiveLogRetentionDays.IsSet() {
		toSerialize["archiveLogRetentionDays"] = o.ArchiveLogRetentionDays.Get()
	}
	if o.ArchiveLogRetentionHours.IsSet() {
		toSerialize["archiveLogRetentionHours"] = o.ArchiveLogRetentionHours.Get()
	}
