...
// checks if the HeliosPoliciesResponseWithPagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosPoliciesResponseWithPagination{}
...
func (o HeliosPoliciesResponseWithPagination) ToMap() (map[string]interface{}, error) {
