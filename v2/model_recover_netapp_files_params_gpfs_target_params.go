...
// checks if the RecoverNetappFilesParamsGpfsTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappFilesParamsGpfsTargetParams{}

// RecoverNetappFilesParamsGpfsTargetParams Specifies the params for a GPFS recovery target.
type RecoverNetappFilesParamsGpfsTargetParams struct {
...
type _RecoverNetappFilesParamsGpfsTargetParams RecoverNetappFilesParamsGpfsTargetParams
...
func NewRecoverNetappFilesParamsGpfsTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverNetappFilesParamsGpfsTargetParams {
	this := RecoverNetappFilesParamsGpfsTargetParams{}
...
func (o *RecoverNetappFilesParamsGpfsTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverNetappFilesParamsGpfsTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverNetappFilesParamsGpfsTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverNetappFilesParamsGpfsTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverNetappFilesParamsGpfsTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverNetappFilesParamsGpfsTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappFilesParamsGpfsTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappFilesParamsGpfsTargetParams := _RecoverNetappFilesParamsGpfsTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappFilesParamsGpfsTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverNetappFilesParamsGpfsTargetParams(varRecoverNetappFilesParamsGpfsTargetParams)

	return err
}

type NullableRecoverNetappFilesParamsGpfsTargetParams struct {
	value *RecoverNetappFilesParamsGpfsTargetParams
	isSet bool
}

func (v NullableRecoverNetappFilesParamsGpfsTargetParams) Get() *RecoverNetappFilesParamsGpfsTargetParams {
	return v.value
}

func (v *NullableRecoverNetappFilesParamsGpfsTargetParams) Set(val *RecoverNetappFilesParamsGpfsTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverNetappFilesParamsGpfsTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverNetappFilesParamsGpfsTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverNetappFilesParamsGpfsTargetParams(val *RecoverNetappFilesParamsGpfsTargetParams) *NullableRecoverNetappFilesParamsGpfsTargetParams {
	return &NullableRecoverNetappFilesParamsGpfsTargetParams{value: val, isSet: true}
}

func (v NullableRecoverNetappFilesParamsGpfsTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverNetappFilesParamsGpfsTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
