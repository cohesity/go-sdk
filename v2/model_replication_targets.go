...
// checks if the ReplicationTargets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicationTargets{}
...
func (o ReplicationTargets) ToMap() (map[string]interface{}, error) {
