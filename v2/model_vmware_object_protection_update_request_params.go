...
// checks if the VmwareObjectProtectionUpdateRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareObjectProtectionUpdateRequestParams{}
...
func (o VmwareObjectProtectionUpdateRequestParams) ToMap() (map[string]interface{}, error) {
