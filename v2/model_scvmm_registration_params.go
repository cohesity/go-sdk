...
// checks if the ScvmmRegistrationParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScvmmRegistrationParams{}
...
type _ScvmmRegistrationParams ScvmmRegistrationParams
...
func (o *ScvmmRegistrationParams) GetAgentEndpoint() string {
	if o == nil || IsNil(o.AgentEndpoint.Get()) {
		var ret string
		return ret
	}
...
func (o ScvmmRegistrationParams) ToMap() (map[string]interface{}, error) {
...
func (o *ScvmmRegistrationParams) UnmarshalJSON(data []byte) (err error) {
	...
	varScvmmRegistrationParams := _ScvmmRegistrationParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScvmmRegistrationParams)

	if err != nil {
		return err
	}

	*o = ScvmmRegistrationParams(varScvmmRegistrationParams)
