...
// checks if the LocalGlobalObjectIdList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalGlobalObjectIdList{}
...
func (o *LocalGlobalObjectIdList) GetObjectIdentifiers() []LocalGlobalObjectIds {
	if o == nil || IsNil(o.ObjectIdentifiers) {
...
func (o LocalGlobalObjectIdList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ObjectIdentifiers) {
