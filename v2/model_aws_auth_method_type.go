...
// checks if the AwsAuthMethodType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAuthMethodType{}
...
func (o *AwsAuthMethodType) GetAwsAuthMethodType() string {
	if o == nil || IsNil(o.AwsAuthMethodType) {
		var ret string
		return ret
	}
...
func (o AwsAuthMethodType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AwsAuthMethodType) {
