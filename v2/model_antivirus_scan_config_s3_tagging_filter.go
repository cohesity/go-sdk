...
// checks if the AntivirusScanConfigS3TaggingFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntivirusScanConfigS3TaggingFilter{}

// AntivirusScanConfigS3TaggingFilter For S3 usage only. If set, only objects with these taggings will be scanned or not scanned, depending on the mode.
type AntivirusScanConfigS3TaggingFilter struct {
...
func NewAntivirusScanConfigS3TaggingFilter() *AntivirusScanConfigS3TaggingFilter {
	this := AntivirusScanConfigS3TaggingFilter{}
	return &this
}
...
func (o *AntivirusScanConfigS3TaggingFilter) SetIsEnabledNil() {
	o.IsEnabled.Set(nil)
}
...
func (o *AntivirusScanConfigS3TaggingFilter) SetModeNil() {
	o.Mode.Set(nil)
}
...
func (o AntivirusScanConfigS3TaggingFilter) MarshalJSON() ([]byte, error) {
...
func (o AntivirusScanConfigS3TaggingFilter) ToMap() (map[string]interface{}, error) {
...
type NullableAntivirusScanConfigS3TaggingFilter struct {
	value *AntivirusScanConfigS3TaggingFilter
	isSet bool
}

func (v NullableAntivirusScanConfigS3TaggingFilter) Get() *AntivirusScanConfigS3TaggingFilter {
	return v.value
}

func (v *NullableAntivirusScanConfigS3TaggingFilter) Set(val *AntivirusScanConfigS3TaggingFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAntivirusScanConfigS3TaggingFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAntivirusScanConfigS3TaggingFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAntivirusScanConfigS3TaggingFilter(val *AntivirusScanConfigS3TaggingFilter) *NullableAntivirusScanConfigS3TaggingFilter {
	return &NullableAntivirusScanConfigS3TaggingFilter{value: val, isSet: true}
}

func (v NullableAntivirusScanConfigS3TaggingFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAntivirusScanConfigS3TaggingFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
