...
// checks if the TenantNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantNetwork{}
...
type _TenantNetwork TenantNetwork
...
func (o *TenantNetwork) GetClusterHostname() string {
	if o == nil || IsNil(o.ClusterHostname.Get()) {
		var ret string
		return ret
	}
...
func (o TenantNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *TenantNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varTenantNetwork := _TenantNetwork{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTenantNetwork)

	if err != nil {
		return err
	}

	*o = TenantNetwork(varTenantNetwork)
