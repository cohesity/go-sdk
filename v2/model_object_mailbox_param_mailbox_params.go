...
// checks if the ObjectMailboxParamMailboxParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectMailboxParamMailboxParams{}

// ObjectMailboxParamMailboxParams Specifies parameters to recover a Mailbox.
type ObjectMailboxParamMailboxParams struct {
...
func NewObjectMailboxParamMailboxParams() *ObjectMailboxParamMailboxParams {
	this := ObjectMailboxParamMailboxParams{}
	return &this
}
...
func (o *ObjectMailboxParamMailboxParams) SetRecoverEntireMailboxNil() {
...
func (o ObjectMailboxParamMailboxParams) MarshalJSON() ([]byte, error) {
...
func (o ObjectMailboxParamMailboxParams) ToMap() (map[string]interface{}, error) {
...
type NullableObjectMailboxParamMailboxParams struct {
	value *ObjectMailboxParamMailboxParams
	isSet bool
}

func (v NullableObjectMailboxParamMailboxParams) Get() *ObjectMailboxParamMailboxParams {
	return v.value
}

func (v *NullableObjectMailboxParamMailboxParams) Set(val *ObjectMailboxParamMailboxParams) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectMailboxParamMailboxParams) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectMailboxParamMailboxParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectMailboxParamMailboxParams(val *ObjectMailboxParamMailboxParams) *NullableObjectMailboxParamMailboxParams {
	return &NullableObjectMailboxParamMailboxParams{value: val, isSet: true}
}

func (v NullableObjectMailboxParamMailboxParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectMailboxParamMailboxParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
