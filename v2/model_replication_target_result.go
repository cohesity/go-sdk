...
// checks if the ReplicationTargetResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicationTargetResult{}
...
type ReplicationTargetResult struct {
	...
	EntriesChanged NullableInt64 `json:"entriesChanged,omitempty"`
	...
	MultiObjectReplication NullableBool `json:"multiObjectReplication,omitempty"`
...
func (o *ReplicationTargetResult) GetEntriesChanged() int64 {
	if o == nil || IsNil(o.EntriesChanged.Get()) {
		var ret int64
		return ret
	}
...
// SetEntriesChanged gets a reference to the given NullableInt64 and assigns it to the EntriesChanged field.
...
// GetMultiObjectReplication returns the MultiObjectReplication field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ReplicationTargetResult) GetMultiObjectReplication() bool {
	if o == nil || IsNil(o.MultiObjectReplication.Get()) {
		var ret bool
		return ret
	}
	return *o.MultiObjectReplication.Get()
}

// GetMultiObjectReplicationOk returns a tuple with the MultiObjectReplication field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ReplicationTargetResult) GetMultiObjectReplicationOk() (*bool, bool) {
	...
	return o.MultiObjectReplication.Get(), o.MultiObjectReplication.IsSet()
}
...
func (o *ReplicationTargetResult) HasMultiObjectReplication() bool {
	if o != nil && o.MultiObjectReplication.IsSet() {
		return true
	}
...
// SetMultiObjectReplication gets a reference to the given NullableBool and assigns it to the MultiObjectReplication field.
func (o *ReplicationTargetResult) SetMultiObjectReplication(v bool) {
	o.MultiObjectReplication.Set(&v)
}
// SetMultiObjectReplicationNil sets the value for MultiObjectReplication to be an explicit nil
func (o *ReplicationTargetResult) SetMultiObjectReplicationNil() {
	o.MultiObjectReplication.Set(nil)
}
...
func (o *ReplicationTargetResult) UnsetMultiObjectReplication() {
	o.MultiObjectReplication.Unset()
}
...
func (o *ReplicationTargetResult) GetPercentageCompleted() int32 {
	if o == nil || IsNil(o.PercentageCompleted.Get()) {
		var ret int32
		return ret
	}
...
func (o *ReplicationTargetResult) GetQueuedTimeUsecs() int64 {
	if o == nil || IsNil(o.QueuedTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o *ReplicationTargetResult) GetReplicationTaskId() string {
	if o == nil || IsNil(o.ReplicationTaskId.Get()) {
		var ret string
		return ret
	}
...
func (o ReplicationTargetResult) ToMap() (map[string]interface{}, error) {
	...
	if o.MultiObjectReplication.IsSet() {
		toSerialize["multiObjectReplication"] = o.MultiObjectReplication.Get()
	}
