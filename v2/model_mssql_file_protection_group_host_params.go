...
// checks if the MSSQLFileProtectionGroupHostParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MSSQLFileProtectionGroupHostParams{}
...
type _MSSQLFileProtectionGroupHostParams MSSQLFileProtectionGroupHostParams
...
func (o *MSSQLFileProtectionGroupHostParams) GetDisableSourceSideDeduplication() bool {
	if o == nil || IsNil(o.DisableSourceSideDeduplication.Get()) {
		var ret bool
		return ret
	}
...
func (o MSSQLFileProtectionGroupHostParams) ToMap() (map[string]interface{}, error) {
...
func (o *MSSQLFileProtectionGroupHostParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMSSQLFileProtectionGroupHostParams := _MSSQLFileProtectionGroupHostParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMSSQLFileProtectionGroupHostParams)

	if err != nil {
		return err
	}

	*o = MSSQLFileProtectionGroupHostParams(varMSSQLFileProtectionGroupHostParams)
