...
// checks if the MOref type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MOref{}
...
func (o MOref) ToMap() (map[string]interface{}, error) {
