...
// checks if the CommonCsrResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonCsrResponseParams{}
...
type _CommonCsrResponseParams CommonCsrResponseParams
...
func (o CommonCsrResponseParams) ToMap() (map[string]interface{}, error) {
...
func (o *CommonCsrResponseParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonCsrResponseParams := _CommonCsrResponseParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonCsrResponseParams)

	if err != nil {
		return err
	}

	*o = CommonCsrResponseParams(varCommonCsrResponseParams)
