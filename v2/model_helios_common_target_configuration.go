...
// checks if the HeliosCommonTargetConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosCommonTargetConfiguration{}

// HeliosCommonTargetConfiguration Specifies common parameters required while setting up additional protection target configuration.
...
func NewHeliosCommonTargetConfiguration() *HeliosCommonTargetConfiguration {
	this := HeliosCommonTargetConfiguration{}
	return &this
}
...
func (o *HeliosCommonTargetConfiguration) SetConfigIdNil() {
	o.ConfigId.Set(nil)
}
...
func (o *HeliosCommonTargetConfiguration) SetCopyOnRunSuccessNil() {
...
func (o HeliosCommonTargetConfiguration) MarshalJSON() ([]byte, error) {
...
func (o HeliosCommonTargetConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableHeliosCommonTargetConfiguration struct {
	value *HeliosCommonTargetConfiguration
	isSet bool
}

func (v NullableHeliosCommonTargetConfiguration) Get() *HeliosCommonTargetConfiguration {
	return v.value
}

func (v *NullableHeliosCommonTargetConfiguration) Set(val *HeliosCommonTargetConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableHeliosCommonTargetConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableHeliosCommonTargetConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeliosCommonTargetConfiguration(val *HeliosCommonTargetConfiguration) *NullableHeliosCommonTargetConfiguration {
	return &NullableHeliosCommonTargetConfiguration{value: val, isSet: true}
}

func (v NullableHeliosCommonTargetConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeliosCommonTargetConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
