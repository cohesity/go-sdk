...
// checks if the GetProtectedObjectResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetProtectedObjectResponse{}
...
func (o GetProtectedObjectResponse) ToMap() (map[string]interface{}, error) {
