...
// checks if the ObjectSiteParamOwnerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectSiteParamOwnerInfo{}

// ObjectSiteParamOwnerInfo Specifies the Site owner info.
type ObjectSiteParamOwnerInfo struct {
...
type _ObjectSiteParamOwnerInfo ObjectSiteParamOwnerInfo
...
func (o *ObjectSiteParamOwnerInfo) SetArchivalTargetInfoNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetBytesRestoredNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetEndTimeUsecsNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetObjectInfoNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetPointInTimeUsecsNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetProgressTaskIdNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetProtectionGroupIdNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetProtectionGroupNameNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetRecoverFromStandbyNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetSnapshotCreationTimeUsecsNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetSnapshotTargetTypeNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetStartTimeUsecsNil() {
...
func (o *ObjectSiteParamOwnerInfo) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ObjectSiteParamOwnerInfo) SetStorageDomainIdNil() {
...
func (o ObjectSiteParamOwnerInfo) MarshalJSON() ([]byte, error) {
...
func (o ObjectSiteParamOwnerInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ObjectSiteParamOwnerInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectSiteParamOwnerInfo := _ObjectSiteParamOwnerInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectSiteParamOwnerInfo)

	if err != nil {
		return err
	}

	*o = ObjectSiteParamOwnerInfo(varObjectSiteParamOwnerInfo)

	return err
}

type NullableObjectSiteParamOwnerInfo struct {
	value *ObjectSiteParamOwnerInfo
	isSet bool
}

func (v NullableObjectSiteParamOwnerInfo) Get() *ObjectSiteParamOwnerInfo {
	return v.value
}

func (v *NullableObjectSiteParamOwnerInfo) Set(val *ObjectSiteParamOwnerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectSiteParamOwnerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectSiteParamOwnerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectSiteParamOwnerInfo(val *ObjectSiteParamOwnerInfo) *NullableObjectSiteParamOwnerInfo {
	return &NullableObjectSiteParamOwnerInfo{value: val, isSet: true}
}

func (v NullableObjectSiteParamOwnerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectSiteParamOwnerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
