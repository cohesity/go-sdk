...
// checks if the RecoverNetappToNetappVolumeTargetParamsNewSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappToNetappVolumeTargetParamsNewSourceConfig{}

// RecoverNetappToNetappVolumeTargetParamsNewSourceConfig Specifies the new destination Source configuration parameters where the volumes will be recovered. This is mandatory if recoverToNewSource is set to true.
type RecoverNetappToNetappVolumeTargetParamsNewSourceConfig struct {
...
type _RecoverNetappToNetappVolumeTargetParamsNewSourceConfig RecoverNetappToNetappVolumeTargetParamsNewSourceConfig
...
func NewRecoverNetappToNetappVolumeTargetParamsNewSourceConfig(volume RecoverOtherNasToIsilonVolumeTargetParamsVolume) *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig {
	this := RecoverNetappToNetappVolumeTargetParamsNewSourceConfig{}
	this.Volume = volume
	return &this
}
...
func (o *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappToNetappVolumeTargetParamsNewSourceConfig := _RecoverNetappToNetappVolumeTargetParamsNewSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappToNetappVolumeTargetParamsNewSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverNetappToNetappVolumeTargetParamsNewSourceConfig(varRecoverNetappToNetappVolumeTargetParamsNewSourceConfig)

	return err
}

type NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig struct {
	value *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig
	isSet bool
}

func (v NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig) Get() *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig {
	return v.value
}

func (v *NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig) Set(val *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig(val *RecoverNetappToNetappVolumeTargetParamsNewSourceConfig) *NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig {
	return &NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverNetappToNetappVolumeTargetParamsNewSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
