...
// checks if the PhysicalObjectEntityParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalObjectEntityParams{}
...
func (o PhysicalObjectEntityParams) ToMap() (map[string]interface{}, error) {
