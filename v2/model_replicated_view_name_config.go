...
// checks if the ReplicatedViewNameConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicatedViewNameConfig{}
...
type _ReplicatedViewNameConfig ReplicatedViewNameConfig
...
func (o *ReplicatedViewNameConfig) GetUseSameViewName() bool {
	if o == nil || IsNil(o.UseSameViewName.Get()) {
		var ret bool
		return ret
	}
...
func (o ReplicatedViewNameConfig) ToMap() (map[string]interface{}, error) {
...
func (o *ReplicatedViewNameConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varReplicatedViewNameConfig := _ReplicatedViewNameConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReplicatedViewNameConfig)

	if err != nil {
		return err
	}

	*o = ReplicatedViewNameConfig(varReplicatedViewNameConfig)
