...
// checks if the O365HeliosSearchEmailsRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &O365HeliosSearchEmailsRequestParams{}
...
func (o O365HeliosSearchEmailsRequestParams) ToMap() (map[string]interface{}, error) {
