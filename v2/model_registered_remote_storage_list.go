...
// checks if the RegisteredRemoteStorageList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisteredRemoteStorageList{}
...
func (o *RegisteredRemoteStorageList) GetRemoteStorages() []RemoteStorageInfo {
	if o == nil || IsNil(o.RemoteStorages) {
...
func (o RegisteredRemoteStorageList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RemoteStorages) {
