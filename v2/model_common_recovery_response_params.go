...
// checks if the CommonRecoveryResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonRecoveryResponseParams{}
...
func (o *CommonRecoveryResponseParams) SetIsMultiStageRestoreNil() {
...
func (o CommonRecoveryResponseParams) ToMap() (map[string]interface{}, error) {
