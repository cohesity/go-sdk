...
// checks if the AwsS3OneZoneIAParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsS3OneZoneIAParams{}
...
type _AwsS3OneZoneIAParams AwsS3OneZoneIAParams
...
func (o AwsS3OneZoneIAParams) ToMap() (map[string]interface{}, error) {
...
func (o *AwsS3OneZoneIAParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsS3OneZoneIAParams := _AwsS3OneZoneIAParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsS3OneZoneIAParams)

	if err != nil {
		return err
	}

	*o = AwsS3OneZoneIAParams(varAwsS3OneZoneIAParams)
