...
// checks if the DataTieringSource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataTieringSource{}
...
func (o DataTieringSource) ToMap() (map[string]interface{}, error) {
