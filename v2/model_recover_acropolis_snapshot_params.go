...
// checks if the RecoverAcropolisSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverAcropolisSnapshotParams{}

// RecoverAcropolisSnapshotParams Specifies the snapshot parameters to recover Acropolis VM.
type RecoverAcropolisSnapshotParams struct {
	...
	// Specifies the info about datastore migration. This is only applicable for AcropolisVm.
	DatastoreMigrationInfo map[string]interface{} `json:"datastoreMigrationInfo,omitempty"`
	// Specifies the info about instant recovery. This is only applicable for AcropolisVm.
	InstantRecoveryInfo map[string]interface{} `json:"instantRecoveryInfo,omitempty"`
}

type _RecoverAcropolisSnapshotParams RecoverAcropolisSnapshotParams
...
func NewRecoverAcropolisSnapshotParams(snapshotId string) *RecoverAcropolisSnapshotParams {
	this := RecoverAcropolisSnapshotParams{}
...
func (o *RecoverAcropolisSnapshotParams) SetArchivalTargetInfoNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetBytesRestoredNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetEndTimeUsecsNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetObjectInfoNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetPointInTimeUsecsNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetProgressTaskIdNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetProtectionGroupIdNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetProtectionGroupNameNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetRecoverFromStandbyNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetSnapshotCreationTimeUsecsNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetSnapshotTargetTypeNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetStartTimeUsecsNil() {
...
func (o *RecoverAcropolisSnapshotParams) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *RecoverAcropolisSnapshotParams) SetStorageDomainIdNil() {
...
func (o *RecoverAcropolisSnapshotParams) GetDatastoreMigrationInfo() map[string]interface{} {
	...
	return o.DatastoreMigrationInfo
}
...
func (o *RecoverAcropolisSnapshotParams) GetDatastoreMigrationInfoOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.DatastoreMigrationInfo) {
		return map[string]interface{}{}, false
	}
	return o.DatastoreMigrationInfo, true
}
...
// SetDatastoreMigrationInfo gets a reference to the given map[string]interface{} and assigns it to the DatastoreMigrationInfo field.
func (o *RecoverAcropolisSnapshotParams) SetDatastoreMigrationInfo(v map[string]interface{}) {
	o.DatastoreMigrationInfo = v
}
...
func (o *RecoverAcropolisSnapshotParams) GetInstantRecoveryInfoOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.InstantRecoveryInfo) {
		return map[string]interface{}{}, false
	}
	return o.InstantRecoveryInfo, true
}
...
// SetInstantRecoveryInfo gets a reference to the given map[string]interface{} and assigns it to the InstantRecoveryInfo field.
func (o *RecoverAcropolisSnapshotParams) SetInstantRecoveryInfo(v map[string]interface{}) {
	o.InstantRecoveryInfo = v
}

func (o RecoverAcropolisSnapshotParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverAcropolisSnapshotParams) ToMap() (map[string]interface{}, error) {
	...
	if o.DatastoreMigrationInfo != nil {
		toSerialize["datastoreMigrationInfo"] = o.DatastoreMigrationInfo
	}
	if o.InstantRecoveryInfo != nil {
		toSerialize["instantRecoveryInfo"] = o.InstantRecoveryInfo
	}
	return toSerialize, nil
}

func (o *RecoverAcropolisSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverAcropolisSnapshotParams := _RecoverAcropolisSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverAcropolisSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverAcropolisSnapshotParams(varRecoverAcropolisSnapshotParams)

	return err
}

type NullableRecoverAcropolisSnapshotParams struct {
	value *RecoverAcropolisSnapshotParams
	isSet bool
}

func (v NullableRecoverAcropolisSnapshotParams) Get() *RecoverAcropolisSnapshotParams {
	return v.value
}

func (v *NullableRecoverAcropolisSnapshotParams) Set(val *RecoverAcropolisSnapshotParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverAcropolisSnapshotParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverAcropolisSnapshotParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverAcropolisSnapshotParams(val *RecoverAcropolisSnapshotParams) *NullableRecoverAcropolisSnapshotParams {
	return &NullableRecoverAcropolisSnapshotParams{value: val, isSet: true}
}

func (v NullableRecoverAcropolisSnapshotParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverAcropolisSnapshotParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
