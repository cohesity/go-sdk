...
// checks if the HostInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HostInformation{}
...
func (o HostInformation) ToMap() (map[string]interface{}, error) {
