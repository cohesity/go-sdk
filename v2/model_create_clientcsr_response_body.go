...
// checks if the CreateClientcsrResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateClientcsrResponseBody{}
...
func (o *CreateClientcsrResponseBody) GetCsrClient() string {
	if o == nil || IsNil(o.CsrClient.Get()) {
		var ret string
		return ret
	}
...
func (o *CreateClientcsrResponseBody) GetCsrServer() string {
	if o == nil || IsNil(o.CsrServer.Get()) {
		var ret string
		return ret
	}
...
func (o *CreateClientcsrResponseBody) GetFileCsrClient() string {
	if o == nil || IsNil(o.FileCsrClient.Get()) {
		var ret string
		return ret
	}
...
func (o *CreateClientcsrResponseBody) GetFileCsrServer() string {
	if o == nil || IsNil(o.FileCsrServer.Get()) {
		var ret string
		return ret
	}
...
func (o *CreateClientcsrResponseBody) GetPublicKeyClient() string {
	if o == nil || IsNil(o.PublicKeyClient.Get()) {
		var ret string
		return ret
	}
...
func (o *CreateClientcsrResponseBody) GetPublicKeyServer() string {
	if o == nil || IsNil(o.PublicKeyServer.Get()) {
		var ret string
		return ret
	}
...
func (o CreateClientcsrResponseBody) ToMap() (map[string]interface{}, error) {
