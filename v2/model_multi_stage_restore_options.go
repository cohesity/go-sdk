...
// checks if the MultiStageRestoreOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiStageRestoreOptions{}
...
func (o *MultiStageRestoreOptions) GetEnableMultiStageRestore() bool {
	if o == nil || IsNil(o.EnableMultiStageRestore.Get()) {
		var ret bool
		return ret
	}
...
func (o MultiStageRestoreOptions) ToMap() (map[string]interface{}, error) {
