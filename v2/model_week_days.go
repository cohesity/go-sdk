...
// checks if the WeekDays type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WeekDays{}
...
func (o WeekDays) ToMap() (map[string]interface{}, error) {
