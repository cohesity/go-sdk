...
// checks if the RecoverVmwareSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverVmwareSnapshotParams{}

// RecoverVmwareSnapshotParams Specifies the snapshot parameters for VMware recovery.
...
type _RecoverVmwareSnapshotParams RecoverVmwareSnapshotParams
...
func NewRecoverVmwareSnapshotParams(snapshotId string) *RecoverVmwareSnapshotParams {
	this := RecoverVmwareSnapshotParams{}
...
func (o *RecoverVmwareSnapshotParams) SetArchivalTargetInfoNil() {
...
func (o *RecoverVmwareSnapshotParams) SetBytesRestoredNil() {
...
func (o *RecoverVmwareSnapshotParams) SetEndTimeUsecsNil() {
...
func (o *RecoverVmwareSnapshotParams) SetObjectInfoNil() {
...
func (o *RecoverVmwareSnapshotParams) SetPointInTimeUsecsNil() {
...
func (o *RecoverVmwareSnapshotParams) SetProgressTaskIdNil() {
...
func (o *RecoverVmwareSnapshotParams) SetProtectionGroupIdNil() {
...
func (o *RecoverVmwareSnapshotParams) SetProtectionGroupNameNil() {
...
func (o *RecoverVmwareSnapshotParams) SetRecoverFromStandbyNil() {
...
func (o *RecoverVmwareSnapshotParams) SetSnapshotCreationTimeUsecsNil() {
...
func (o *RecoverVmwareSnapshotParams) SetSnapshotTargetTypeNil() {
...
func (o *RecoverVmwareSnapshotParams) SetStartTimeUsecsNil() {
...
func (o *RecoverVmwareSnapshotParams) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *RecoverVmwareSnapshotParams) SetStorageDomainIdNil() {
...
func (o RecoverVmwareSnapshotParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverVmwareSnapshotParams) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ChildSnapshots) {
		toSerialize["childSnapshots"] = o.ChildSnapshots
	}
	return toSerialize, nil
}

func (o *RecoverVmwareSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverVmwareSnapshotParams := _RecoverVmwareSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverVmwareSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverVmwareSnapshotParams(varRecoverVmwareSnapshotParams)

	return err
}

type NullableRecoverVmwareSnapshotParams struct {
	value *RecoverVmwareSnapshotParams
	isSet bool
}

func (v NullableRecoverVmwareSnapshotParams) Get() *RecoverVmwareSnapshotParams {
	return v.value
}

func (v *NullableRecoverVmwareSnapshotParams) Set(val *RecoverVmwareSnapshotParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverVmwareSnapshotParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverVmwareSnapshotParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverVmwareSnapshotParams(val *RecoverVmwareSnapshotParams) *NullableRecoverVmwareSnapshotParams {
	return &NullableRecoverVmwareSnapshotParams{value: val, isSet: true}
}

func (v NullableRecoverVmwareSnapshotParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverVmwareSnapshotParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
