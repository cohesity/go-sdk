...
// checks if the ReplicationTargetSummaryInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicationTargetSummaryInfo{}
...
func (o ReplicationTargetSummaryInfo) ToMap() (map[string]interface{}, error) {
