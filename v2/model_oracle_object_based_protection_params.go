...
// checks if the OracleObjectBasedProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleObjectBasedProtectionParams{}
...
type _OracleObjectBasedProtectionParams OracleObjectBasedProtectionParams
...
func (o *OracleObjectBasedProtectionParams) SetFullAutoKillTimeoutSecsNil() {
...
func (o *OracleObjectBasedProtectionParams) SetIncrAutoKillTimeoutSecsNil() {
...
func (o *OracleObjectBasedProtectionParams) SetLogAutoKillTimeoutSecsNil() {
...
func (o OracleObjectBasedProtectionParams) ToMap() (map[string]interface{}, error) {
...
func (o *OracleObjectBasedProtectionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOracleObjectBasedProtectionParams := _OracleObjectBasedProtectionParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOracleObjectBasedProtectionParams)

	if err != nil {
		return err
	}

	*o = OracleObjectBasedProtectionParams(varOracleObjectBasedProtectionParams)
