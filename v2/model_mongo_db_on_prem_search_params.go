...
// checks if the MongoDbOnPremSearchParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MongoDbOnPremSearchParams{}
...
type _MongoDbOnPremSearchParams MongoDbOnPremSearchParams
...
func (o MongoDbOnPremSearchParams) ToMap() (map[string]interface{}, error) {
...
func (o *MongoDbOnPremSearchParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMongoDbOnPremSearchParams := _MongoDbOnPremSearchParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMongoDbOnPremSearchParams)

	if err != nil {
		return err
	}

	*o = MongoDbOnPremSearchParams(varMongoDbOnPremSearchParams)
