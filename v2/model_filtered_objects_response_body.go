...
// checks if the FilteredObjectsResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilteredObjectsResponseBody{}
...
func (o *FilteredObjectsResponseBody) GetFilteredObjectsOk() ([]FilteredObject, bool) {
	if o == nil || IsNil(o.FilteredObjects) {
		return nil, false
	}
...
func (o FilteredObjectsResponseBody) ToMap() (map[string]interface{}, error) {
