...
// checks if the TenantAssignments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantAssignments{}
...
func (o *TenantAssignments) GetAssignments() TenantAssignmentsResult {
	if o == nil || IsNil(o.Assignments.Get()) {
...
func (o TenantAssignments) ToMap() (map[string]interface{}, error) {
