...
// checks if the McmClusterIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &McmClusterIdentifier{}
...
func (o McmClusterIdentifier) ToMap() (map[string]interface{}, error) {
