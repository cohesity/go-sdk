...
// checks if the ExternalTargets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalTargets{}
...
func (o *ExternalTargets) GetExternalTargetsOk() ([]ExternalTarget, bool) {
	if o == nil || IsNil(o.ExternalTargets) {
		return nil, false
	}
...
func (o ExternalTargets) ToMap() (map[string]interface{}, error) {
