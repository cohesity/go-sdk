...
// checks if the DowntieringPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DowntieringPolicy{}
...
func (o *DowntieringPolicy) GetTieringGoal() int64 {
	if o == nil || IsNil(o.TieringGoal.Get()) {
		var ret int64
		return ret
	}
...
func (o DowntieringPolicy) ToMap() (map[string]interface{}, error) {
