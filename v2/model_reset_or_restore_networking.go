...
// checks if the ResetOrRestoreNetworking type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResetOrRestoreNetworking{}
...
func (o ResetOrRestoreNetworking) ToMap() (map[string]interface{}, error) {
