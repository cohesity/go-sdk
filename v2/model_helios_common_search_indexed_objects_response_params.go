...
// checks if the HeliosCommonSearchIndexedObjectsResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosCommonSearchIndexedObjectsResponseParams{}
...
func (o HeliosCommonSearchIndexedObjectsResponseParams) ToMap() (map[string]interface{}, error) {
