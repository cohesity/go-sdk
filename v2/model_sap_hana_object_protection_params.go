...
// checks if the SapHanaObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SapHanaObjectProtectionParams{}

// SapHanaObjectProtectionParams Specifies the parameters that are specific to SAP HANA Object Protection.
...
type _SapHanaObjectProtectionParams SapHanaObjectProtectionParams
...
func NewSapHanaObjectProtectionParams(objects []UdaObjectProtectionObjectParams) *SapHanaObjectProtectionParams {
	this := SapHanaObjectProtectionParams{}
...
func (o *SapHanaObjectProtectionParams) SetConcurrencyNil() {
...
func (o *SapHanaObjectProtectionParams) SetDeltaNil() {
	o.Delta.Set(nil)
}
...
func (o SapHanaObjectProtectionParams) MarshalJSON() ([]byte, error) {
...
func (o SapHanaObjectProtectionParams) ToMap() (map[string]interface{}, error) {
...
func (o *SapHanaObjectProtectionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varSapHanaObjectProtectionParams := _SapHanaObjectProtectionParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSapHanaObjectProtectionParams)

	if err != nil {
		return err
	}

	*o = SapHanaObjectProtectionParams(varSapHanaObjectProtectionParams)

	return err
}

type NullableSapHanaObjectProtectionParams struct {
	value *SapHanaObjectProtectionParams
	isSet bool
}

func (v NullableSapHanaObjectProtectionParams) Get() *SapHanaObjectProtectionParams {
	return v.value
}

func (v *NullableSapHanaObjectProtectionParams) Set(val *SapHanaObjectProtectionParams) {
	v.value = val
	v.isSet = true
}

func (v NullableSapHanaObjectProtectionParams) IsSet() bool {
	return v.isSet
}

func (v *NullableSapHanaObjectProtectionParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSapHanaObjectProtectionParams(val *SapHanaObjectProtectionParams) *NullableSapHanaObjectProtectionParams {
	return &NullableSapHanaObjectProtectionParams{value: val, isSet: true}
}

func (v NullableSapHanaObjectProtectionParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSapHanaObjectProtectionParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
