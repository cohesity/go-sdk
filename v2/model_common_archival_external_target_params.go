...
// checks if the CommonArchivalExternalTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonArchivalExternalTargetParams{}
...
type _CommonArchivalExternalTargetParams CommonArchivalExternalTargetParams
...
func (o CommonArchivalExternalTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *CommonArchivalExternalTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonArchivalExternalTargetParams := _CommonArchivalExternalTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonArchivalExternalTargetParams)

	if err != nil {
		return err
	}

	*o = CommonArchivalExternalTargetParams(varCommonArchivalExternalTargetParams)
