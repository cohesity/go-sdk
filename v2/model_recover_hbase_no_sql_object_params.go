...
// checks if the RecoverHbaseNoSqlObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverHbaseNoSqlObjectParams{}
...
type _RecoverHbaseNoSqlObjectParams RecoverHbaseNoSqlObjectParams
...
func (o RecoverHbaseNoSqlObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverHbaseNoSqlObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverHbaseNoSqlObjectParams := _RecoverHbaseNoSqlObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverHbaseNoSqlObjectParams)

	if err != nil {
		return err
	}

	*o = RecoverHbaseNoSqlObjectParams(varRecoverHbaseNoSqlObjectParams)
