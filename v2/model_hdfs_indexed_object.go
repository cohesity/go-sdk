...
// checks if the HDFSIndexedObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HDFSIndexedObject{}
...
func (o *HDFSIndexedObject) SetPolicyIdNil() {
	o.PolicyId.Set(nil)
}
...
func (o *HDFSIndexedObject) SetPolicyNameNil() {
...
func (o HDFSIndexedObject) ToMap() (map[string]interface{}, error) {
