...
// checks if the SmbPermission type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbPermission{}
...
func (o *SmbPermission) GetSpecialAccessMask() int32 {
	if o == nil || IsNil(o.SpecialAccessMask.Get()) {
		var ret int32
		return ret
	}
...
func (o *SmbPermission) GetSpecialType() int32 {
	if o == nil || IsNil(o.SpecialType.Get()) {
		var ret int32
		return ret
	}
...
func (o SmbPermission) ToMap() (map[string]interface{}, error) {
