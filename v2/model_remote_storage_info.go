...
// checks if the RemoteStorageInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteStorageInfo{}
...
type _RemoteStorageInfo RemoteStorageInfo
...
func (o RemoteStorageInfo) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteStorageInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteStorageInfo := _RemoteStorageInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRemoteStorageInfo)

	if err != nil {
		return err
	}

	*o = RemoteStorageInfo(varRemoteStorageInfo)
