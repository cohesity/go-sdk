...
// checks if the RecoverPureVolumeTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverPureVolumeTargetParams{}
...
type _RecoverPureVolumeTargetParams RecoverPureVolumeTargetParams
...
func (o *RecoverPureVolumeTargetParams) SetUseThinCloneNil() {
...
func (o RecoverPureVolumeTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverPureVolumeTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverPureVolumeTargetParams := _RecoverPureVolumeTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverPureVolumeTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverPureVolumeTargetParams(varRecoverPureVolumeTargetParams)
