...
// checks if the RecoverAzureSqlSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverAzureSqlSnapshotParams{}

// RecoverAzureSqlSnapshotParams Specifies the snapshot parameters for a protected Azure SQL object.
...
type _RecoverAzureSqlSnapshotParams RecoverAzureSqlSnapshotParams
...
func NewRecoverAzureSqlSnapshotParams(snapshotId string) *RecoverAzureSqlSnapshotParams {
	this := RecoverAzureSqlSnapshotParams{}
...
func (o *RecoverAzureSqlSnapshotParams) SetArchivalTargetInfoNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetBytesRestoredNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetEndTimeUsecsNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetObjectInfoNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetPointInTimeUsecsNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetProgressTaskIdNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetProtectionGroupIdNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetProtectionGroupNameNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetRecoverFromStandbyNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetSnapshotCreationTimeUsecsNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetSnapshotTargetTypeNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetStartTimeUsecsNil() {
...
func (o *RecoverAzureSqlSnapshotParams) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *RecoverAzureSqlSnapshotParams) SetStorageDomainIdNil() {
...
// GetRecoverAzureSqlObjectParams returns the RecoverAzureSqlObjectParams field value if set, zero value otherwise.
func (o *RecoverAzureSqlSnapshotParams) GetRecoverAzureSqlObjectParams() RecoverAzureSqlObjectParams {
	if o == nil || IsNil(o.RecoverAzureSqlObjectParams) {
		var ret RecoverAzureSqlObjectParams
		return ret
	}
	return *o.RecoverAzureSqlObjectParams
}

// GetRecoverAzureSqlObjectParamsOk returns a tuple with the RecoverAzureSqlObjectParams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RecoverAzureSqlSnapshotParams) GetRecoverAzureSqlObjectParamsOk() (*RecoverAzureSqlObjectParams, bool) {
	if o == nil || IsNil(o.RecoverAzureSqlObjectParams) {
		return nil, false
	}
	return o.RecoverAzureSqlObjectParams, true
}
...
// SetRecoverAzureSqlObjectParams gets a reference to the given RecoverAzureSqlObjectParams and assigns it to the RecoverAzureSqlObjectParams field.
func (o *RecoverAzureSqlSnapshotParams) SetRecoverAzureSqlObjectParams(v RecoverAzureSqlObjectParams) {
	o.RecoverAzureSqlObjectParams = &v
}

func (o RecoverAzureSqlSnapshotParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverAzureSqlSnapshotParams) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RecoverAzureSqlObjectParams) {
		toSerialize["recoverAzureSqlObjectParams"] = o.RecoverAzureSqlObjectParams
	}
	return toSerialize, nil
}

func (o *RecoverAzureSqlSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverAzureSqlSnapshotParams := _RecoverAzureSqlSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverAzureSqlSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverAzureSqlSnapshotParams(varRecoverAzureSqlSnapshotParams)

	return err
}

type NullableRecoverAzureSqlSnapshotParams struct {
	value *RecoverAzureSqlSnapshotParams
	isSet bool
}

func (v NullableRecoverAzureSqlSnapshotParams) Get() *RecoverAzureSqlSnapshotParams {
	return v.value
}

func (v *NullableRecoverAzureSqlSnapshotParams) Set(val *RecoverAzureSqlSnapshotParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverAzureSqlSnapshotParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverAzureSqlSnapshotParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverAzureSqlSnapshotParams(val *RecoverAzureSqlSnapshotParams) *NullableRecoverAzureSqlSnapshotParams {
	return &NullableRecoverAzureSqlSnapshotParams{value: val, isSet: true}
}

func (v NullableRecoverAzureSqlSnapshotParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverAzureSqlSnapshotParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
