...
// checks if the SecurityPrincipal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPrincipal{}
...
func (o SecurityPrincipal) ToMap() (map[string]interface{}, error) {
