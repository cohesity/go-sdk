...
// checks if the MSSQLVolumeProtectionGroupHostParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MSSQLVolumeProtectionGroupHostParams{}
...
type _MSSQLVolumeProtectionGroupHostParams MSSQLVolumeProtectionGroupHostParams
...
func (o MSSQLVolumeProtectionGroupHostParams) ToMap() (map[string]interface{}, error) {
...
func (o *MSSQLVolumeProtectionGroupHostParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMSSQLVolumeProtectionGroupHostParams := _MSSQLVolumeProtectionGroupHostParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMSSQLVolumeProtectionGroupHostParams)

	if err != nil {
		return err
	}

	*o = MSSQLVolumeProtectionGroupHostParams(varMSSQLVolumeProtectionGroupHostParams)
