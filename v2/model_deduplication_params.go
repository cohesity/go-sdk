...
// checks if the DeduplicationParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeduplicationParams{}
...
func (o DeduplicationParams) ToMap() (map[string]interface{}, error) {
