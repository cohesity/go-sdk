...
// checks if the ObjectLastRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectLastRun{}
...
func (o *ObjectLastRun) GetArchivalRunStatus() string {
	if o == nil || IsNil(o.ArchivalRunStatus.Get()) {
		var ret string
		return ret
	}
...
func (o *ObjectLastRun) GetBackupRunStatus() string {
	if o == nil || IsNil(o.BackupRunStatus.Get()) {
		var ret string
		return ret
	}
...
func (o *ObjectLastRun) GetReplicationRunStatus() string {
	if o == nil || IsNil(o.ReplicationRunStatus.Get()) {
		var ret string
		return ret
	}
...
func (o ObjectLastRun) ToMap() (map[string]interface{}, error) {
