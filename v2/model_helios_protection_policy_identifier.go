...
// checks if the HeliosProtectionPolicyIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosProtectionPolicyIdentifier{}
...
func (o *HeliosProtectionPolicyIdentifier) GetProtectionPolicyName() string {
	if o == nil || IsNil(o.ProtectionPolicyName.Get()) {
		var ret string
		return ret
	}
...
func (o HeliosProtectionPolicyIdentifier) ToMap() (map[string]interface{}, error) {
