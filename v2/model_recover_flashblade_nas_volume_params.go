...
// checks if the RecoverFlashbladeNasVolumeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverFlashbladeNasVolumeParams{}

// RecoverFlashbladeNasVolumeParams Specifies the parameters to recover Flashblade NAS volumes.
...
type _RecoverFlashbladeNasVolumeParams RecoverFlashbladeNasVolumeParams
...
func NewRecoverFlashbladeNasVolumeParams(targetEnvironment string) *RecoverFlashbladeNasVolumeParams {
	this := RecoverFlashbladeNasVolumeParams{}
...
func (o *RecoverFlashbladeNasVolumeParams) SetElastifileTargetParamsNil() {
...
func (o *RecoverFlashbladeNasVolumeParams) SetFlashbladeTargetParamsNil() {
...
func (o *RecoverFlashbladeNasVolumeParams) SetGenericNasTargetParamsNil() {
...
func (o *RecoverFlashbladeNasVolumeParams) SetGpfsTargetParamsNil() {
...
func (o *RecoverFlashbladeNasVolumeParams) SetIsilonTargetParamsNil() {
...
func (o *RecoverFlashbladeNasVolumeParams) SetNetappTargetParamsNil() {
...
func (o *RecoverFlashbladeNasVolumeParams) SetViewTargetParamsNil() {
...
func (o RecoverFlashbladeNasVolumeParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverFlashbladeNasVolumeParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverFlashbladeNasVolumeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverFlashbladeNasVolumeParams := _RecoverFlashbladeNasVolumeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverFlashbladeNasVolumeParams)

	if err != nil {
		return err
	}

	*o = RecoverFlashbladeNasVolumeParams(varRecoverFlashbladeNasVolumeParams)

	return err
}

type NullableRecoverFlashbladeNasVolumeParams struct {
	value *RecoverFlashbladeNasVolumeParams
	isSet bool
}

func (v NullableRecoverFlashbladeNasVolumeParams) Get() *RecoverFlashbladeNasVolumeParams {
	return v.value
}

func (v *NullableRecoverFlashbladeNasVolumeParams) Set(val *RecoverFlashbladeNasVolumeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverFlashbladeNasVolumeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverFlashbladeNasVolumeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverFlashbladeNasVolumeParams(val *RecoverFlashbladeNasVolumeParams) *NullableRecoverFlashbladeNasVolumeParams {
	return &NullableRecoverFlashbladeNasVolumeParams{value: val, isSet: true}
}

func (v NullableRecoverFlashbladeNasVolumeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverFlashbladeNasVolumeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
