...
// checks if the FailoverReplication type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailoverReplication{}
...
func (o *FailoverReplication) GetTargetClusterId() int64 {
	if o == nil || IsNil(o.TargetClusterId.Get()) {
		var ret int64
		return ret
	}
...
func (o *FailoverReplication) GetTargetClusterIncarnationId() int64 {
	if o == nil || IsNil(o.TargetClusterIncarnationId.Get()) {
		var ret int64
		return ret
	}
...
func (o *FailoverReplication) GetTargetClusterName() string {
	if o == nil || IsNil(o.TargetClusterName.Get()) {
		var ret string
		return ret
	}
...
func (o FailoverReplication) ToMap() (map[string]interface{}, error) {
