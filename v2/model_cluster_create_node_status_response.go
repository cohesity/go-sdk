...
// checks if the ClusterCreateNodeStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterCreateNodeStatusResponse{}
...
func (o ClusterCreateNodeStatusResponse) ToMap() (map[string]interface{}, error) {
