...
// checks if the AwsNativeProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsNativeProtectionGroupParams{}
...
func (o AwsNativeProtectionGroupParams) ToMap() (map[string]interface{}, error) {
