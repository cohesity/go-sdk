...
func (o *BackupPolicy) GetStorageArraySnapshot() StorageArraySnapshotBackupPolicy {
	if o == nil || IsNil(o.StorageArraySnapshot) {
		var ret StorageArraySnapshotBackupPolicy
		return ret
	}
...
// SetStorageArraySnapshot gets a reference to the given StorageArraySnapshotBackupPolicy and assigns it to the StorageArraySnapshot field.
