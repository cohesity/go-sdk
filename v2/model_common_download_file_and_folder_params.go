...
// checks if the CommonDownloadFileAndFolderParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonDownloadFileAndFolderParams{}
...
func (o *CommonDownloadFileAndFolderParams) SetExpiryTimeUsecsNil() {
...
func (o CommonDownloadFileAndFolderParams) ToMap() (map[string]interface{}, error) {
