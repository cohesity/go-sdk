...
// checks if the FlashbladeObjectProtectionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlashbladeObjectProtectionResponseParams{}

// FlashbladeObjectProtectionResponseParams Specifies the parameters which are specific to Flashblade object protection.
type FlashbladeObjectProtectionResponseParams struct {
...
func NewFlashbladeObjectProtectionResponseParams() *FlashbladeObjectProtectionResponseParams {
	this := FlashbladeObjectProtectionResponseParams{}
	return &this
}
...
func (o *FlashbladeObjectProtectionResponseParams) SetContinueOnErrorNil() {
...
func (o *FlashbladeObjectProtectionResponseParams) SetEncryptionEnabledNil() {
...
func (o *FlashbladeObjectProtectionResponseParams) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o FlashbladeObjectProtectionResponseParams) MarshalJSON() ([]byte, error) {
...
func (o FlashbladeObjectProtectionResponseParams) ToMap() (map[string]interface{}, error) {
...
type NullableFlashbladeObjectProtectionResponseParams struct {
	value *FlashbladeObjectProtectionResponseParams
	isSet bool
}

func (v NullableFlashbladeObjectProtectionResponseParams) Get() *FlashbladeObjectProtectionResponseParams {
	return v.value
}

func (v *NullableFlashbladeObjectProtectionResponseParams) Set(val *FlashbladeObjectProtectionResponseParams) {
	v.value = val
	v.isSet = true
}

func (v NullableFlashbladeObjectProtectionResponseParams) IsSet() bool {
	return v.isSet
}

func (v *NullableFlashbladeObjectProtectionResponseParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlashbladeObjectProtectionResponseParams(val *FlashbladeObjectProtectionResponseParams) *NullableFlashbladeObjectProtectionResponseParams {
	return &NullableFlashbladeObjectProtectionResponseParams{value: val, isSet: true}
}

func (v NullableFlashbladeObjectProtectionResponseParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlashbladeObjectProtectionResponseParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
