...
// checks if the FileSizePolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileSizePolicy{}
...
func (o FileSizePolicy) ToMap() (map[string]interface{}, error) {
