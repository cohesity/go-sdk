...
// checks if the CommonVmwareProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonVmwareProtectionParams{}
...
func (o CommonVmwareProtectionParams) ToMap() (map[string]interface{}, error) {
