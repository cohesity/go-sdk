...
// checks if the HeliosMongoObjectsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosMongoObjectsInner{}

// HeliosMongoObjectsInner struct for HeliosMongoObjectsInner
type HeliosMongoObjectsInner struct {
...
func (o *HeliosMongoObjectsInner) SetClusterIdentifierNil() {
...
func (o *HeliosMongoObjectsInner) SetRegionIdNil() {
	o.RegionId.Set(nil)
}
...
func (o *HeliosMongoObjectsInner) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *HeliosMongoObjectsInner) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *HeliosMongoObjectsInner) SetPolicyIdNil() {
	o.PolicyId.Set(nil)
}
...
func (o *HeliosMongoObjectsInner) SetPolicyNameNil() {
...
func (o *HeliosMongoObjectsInner) SetProtectionGroupIdNil() {
...
func (o *HeliosMongoObjectsInner) SetProtectionGroupNameNil() {
...
func (o *HeliosMongoObjectsInner) SetStorageDomainIdNil() {
...
func (o *HeliosMongoObjectsInner) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *HeliosMongoObjectsInner) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o HeliosMongoObjectsInner) MarshalJSON() ([]byte, error) {
...
func (o HeliosMongoObjectsInner) ToMap() (map[string]interface{}, error) {
...
type NullableHeliosMongoObjectsInner struct {
	value *HeliosMongoObjectsInner
	isSet bool
}

func (v NullableHeliosMongoObjectsInner) Get() *HeliosMongoObjectsInner {
	return v.value
}

func (v *NullableHeliosMongoObjectsInner) Set(val *HeliosMongoObjectsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableHeliosMongoObjectsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableHeliosMongoObjectsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeliosMongoObjectsInner(val *HeliosMongoObjectsInner) *NullableHeliosMongoObjectsInner {
	return &NullableHeliosMongoObjectsInner{value: val, isSet: true}
}

func (v NullableHeliosMongoObjectsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeliosMongoObjectsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
