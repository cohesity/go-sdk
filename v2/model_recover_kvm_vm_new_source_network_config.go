...
// checks if the RecoverKvmVmNewSourceNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverKvmVmNewSourceNetworkConfig{}
...
func (o RecoverKvmVmNewSourceNetworkConfig) ToMap() (map[string]interface{}, error) {
