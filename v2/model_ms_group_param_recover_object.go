...
// checks if the MsGroupParamRecoverObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MsGroupParamRecoverObject{}

// MsGroupParamRecoverObject Specifies the MS group recover Object info.
type MsGroupParamRecoverObject struct {
...
type _MsGroupParamRecoverObject MsGroupParamRecoverObject
...
func NewMsGroupParamRecoverObject(snapshotId string) *MsGroupParamRecoverObject {
	this := MsGroupParamRecoverObject{}
...
func (o *MsGroupParamRecoverObject) SetArchivalTargetInfoNil() {
...
func (o *MsGroupParamRecoverObject) SetBytesRestoredNil() {
...
func (o *MsGroupParamRecoverObject) SetEndTimeUsecsNil() {
...
func (o *MsGroupParamRecoverObject) SetObjectInfoNil() {
...
func (o *MsGroupParamRecoverObject) SetPointInTimeUsecsNil() {
...
func (o *MsGroupParamRecoverObject) SetProgressTaskIdNil() {
...
func (o *MsGroupParamRecoverObject) SetProtectionGroupIdNil() {
...
func (o *MsGroupParamRecoverObject) SetProtectionGroupNameNil() {
...
func (o *MsGroupParamRecoverObject) SetRecoverFromStandbyNil() {
...
func (o *MsGroupParamRecoverObject) SetSnapshotCreationTimeUsecsNil() {
...
func (o *MsGroupParamRecoverObject) SetSnapshotTargetTypeNil() {
...
func (o *MsGroupParamRecoverObject) SetStartTimeUsecsNil() {
...
func (o *MsGroupParamRecoverObject) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *MsGroupParamRecoverObject) SetStorageDomainIdNil() {
...
func (o MsGroupParamRecoverObject) MarshalJSON() ([]byte, error) {
...
func (o MsGroupParamRecoverObject) ToMap() (map[string]interface{}, error) {
...
func (o *MsGroupParamRecoverObject) UnmarshalJSON(data []byte) (err error) {
	...
	varMsGroupParamRecoverObject := _MsGroupParamRecoverObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMsGroupParamRecoverObject)

	if err != nil {
		return err
	}

	*o = MsGroupParamRecoverObject(varMsGroupParamRecoverObject)

	return err
}

type NullableMsGroupParamRecoverObject struct {
	value *MsGroupParamRecoverObject
	isSet bool
}

func (v NullableMsGroupParamRecoverObject) Get() *MsGroupParamRecoverObject {
	return v.value
}

func (v *NullableMsGroupParamRecoverObject) Set(val *MsGroupParamRecoverObject) {
	v.value = val
	v.isSet = true
}

func (v NullableMsGroupParamRecoverObject) IsSet() bool {
	return v.isSet
}

func (v *NullableMsGroupParamRecoverObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMsGroupParamRecoverObject(val *MsGroupParamRecoverObject) *NullableMsGroupParamRecoverObject {
	return &NullableMsGroupParamRecoverObject{value: val, isSet: true}
}

func (v NullableMsGroupParamRecoverObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMsGroupParamRecoverObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
