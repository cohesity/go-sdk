...
// checks if the HyperVProtectionGroupObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperVProtectionGroupObjectParams{}

// HyperVProtectionGroupObjectParams Specifies the object parameters to create HyperV Protection Group.
...
type _HyperVProtectionGroupObjectParams HyperVProtectionGroupObjectParams
...
func NewHyperVProtectionGroupObjectParams(id NullableInt64) *HyperVProtectionGroupObjectParams {
	this := HyperVProtectionGroupObjectParams{}
	this.Id = id
	return &this
}
...
func (o *HyperVProtectionGroupObjectParams) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o HyperVProtectionGroupObjectParams) MarshalJSON() ([]byte, error) {
...
func (o HyperVProtectionGroupObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *HyperVProtectionGroupObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varHyperVProtectionGroupObjectParams := _HyperVProtectionGroupObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHyperVProtectionGroupObjectParams)

	if err != nil {
		return err
	}

	*o = HyperVProtectionGroupObjectParams(varHyperVProtectionGroupObjectParams)

	return err
}

type NullableHyperVProtectionGroupObjectParams struct {
	value *HyperVProtectionGroupObjectParams
	isSet bool
}

func (v NullableHyperVProtectionGroupObjectParams) Get() *HyperVProtectionGroupObjectParams {
	return v.value
}

func (v *NullableHyperVProtectionGroupObjectParams) Set(val *HyperVProtectionGroupObjectParams) {
	v.value = val
	v.isSet = true
}

func (v NullableHyperVProtectionGroupObjectParams) IsSet() bool {
	return v.isSet
}

func (v *NullableHyperVProtectionGroupObjectParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHyperVProtectionGroupObjectParams(val *HyperVProtectionGroupObjectParams) *NullableHyperVProtectionGroupObjectParams {
	return &NullableHyperVProtectionGroupObjectParams{value: val, isSet: true}
}

func (v NullableHyperVProtectionGroupObjectParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHyperVProtectionGroupObjectParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
