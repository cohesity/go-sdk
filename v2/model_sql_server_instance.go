...
// checks if the SQLServerInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SQLServerInstance{}
...
func (o *SQLServerInstance) GetIsPartofFCI() bool {
	if o == nil || IsNil(o.IsPartofFCI.Get()) {
		var ret bool
		return ret
	}
...
func (o SQLServerInstance) ToMap() (map[string]interface{}, error) {
