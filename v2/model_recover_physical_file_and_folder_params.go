...
// checks if the RecoverPhysicalFileAndFolderParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverPhysicalFileAndFolderParams{}
...
type _RecoverPhysicalFileAndFolderParams RecoverPhysicalFileAndFolderParams
...
func (o RecoverPhysicalFileAndFolderParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverPhysicalFileAndFolderParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverPhysicalFileAndFolderParams := _RecoverPhysicalFileAndFolderParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverPhysicalFileAndFolderParams)

	if err != nil {
		return err
	}

	*o = RecoverPhysicalFileAndFolderParams(varRecoverPhysicalFileAndFolderParams)
