...
// checks if the SwiftConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SwiftConfig{}
...
func (o SwiftConfig) ToMap() (map[string]interface{}, error) {
