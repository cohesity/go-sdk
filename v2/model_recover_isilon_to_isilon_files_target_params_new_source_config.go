...
// checks if the RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig{}

// RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig Specifies the new destination Source configuration parameters where the files will be recovered. This is mandatory if recoverToNewSource is set to true.
type RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig struct {
...
type _RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig
...
func NewRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig {
	this := RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig{}
...
func (o *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig := _RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig(varRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig)

	return err
}

type NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig struct {
	value *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig
	isSet bool
}

func (v NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) Get() *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig {
	return v.value
}

func (v *NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) Set(val *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig(val *RecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) *NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig {
	return &NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverIsilonToIsilonFilesTargetParamsNewSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
