...
// checks if the OracleProtectionGroupObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleProtectionGroupObjectParams{}
...
type _OracleProtectionGroupObjectParams OracleProtectionGroupObjectParams
...
func (o OracleProtectionGroupObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *OracleProtectionGroupObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOracleProtectionGroupObjectParams := _OracleProtectionGroupObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOracleProtectionGroupObjectParams)

	if err != nil {
		return err
	}

	*o = OracleProtectionGroupObjectParams(varOracleProtectionGroupObjectParams)
