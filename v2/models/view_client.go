...
type ViewClient struct {
	...
	// Specifies if the connection is idle.
	IsIdle *bool `json:"isIdle,omitempty"`

	// Specifies the time the client was last active. This property Only applies for SMB protocol
	LastActiveTimeUsecs *int64 `json:"lastActiveTimeUsecs,omitempty"`
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["NFS","SMB","NFS4"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// ViewClientProtocolNFS4 captures enum value "NFS4"
	ViewClientProtocolNFS4 string = "NFS4"
)
