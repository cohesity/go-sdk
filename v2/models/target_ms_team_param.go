...
type TargetMsTeamParam struct {
	...
	TargetTeam *RecoveryObjectIdentifier `json:"targetTeam,omitempty"`
...
func (m *TargetMsTeamParam) validateTargetTeam(formats strfmt.Registry) error {
	...
	if m.TargetTeam != nil {
		if err := m.TargetTeam.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("targetTeam")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("targetTeam")
			}
			return err
		}
	}
...
func (m *TargetMsTeamParam) contextValidateTargetTeam(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.TargetTeam != nil {
		if err := m.TargetTeam.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("targetTeam")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("targetTeam")
