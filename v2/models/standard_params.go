...
type StandardParams struct {
	...
	FleetParams *AwsFleetParams `json:"fleetParams,omitempty"`
...
func (m *StandardParams) validateFleetParams(formats strfmt.Registry) error {
...
func (m *StandardParams) contextValidateFleetParams(ctx context.Context, formats strfmt.Registry) error {
