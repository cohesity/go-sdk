...
// GcpNativeProtectionGroupParams GCP Native Protection Group Request Params.
//
...
//
// swagger:model GcpNativeProtectionGroupParams
type GcpNativeProtectionGroupParams struct {
	...
	// Unique: true
	Objects []*GcpNativeProtectionGroupObjectParams `json:"objects"`
...
// Validate validates this gcp native protection group params
func (m *GcpNativeProtectionGroupParams) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateGcpDiskExclusionParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *GcpNativeProtectionGroupParams) validateExcludeObjectIds(formats strfmt.Registry) error {
...
func (m *GcpNativeProtectionGroupParams) validateGcpDiskExclusionParams(formats strfmt.Registry) error {
	if swag.IsZero(m.GcpDiskExclusionParams) { // not required
		return nil
	}

	if m.GcpDiskExclusionParams != nil {
		if err := m.GcpDiskExclusionParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gcpDiskExclusionParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gcpDiskExclusionParams")
			}
			return err
		}
	}
...
func (m *GcpNativeProtectionGroupParams) validateIndexingPolicy(formats strfmt.Registry) error {
...
func (m *GcpNativeProtectionGroupParams) validateObjects(formats strfmt.Registry) error {
...
// ContextValidate validate this gcp native protection group params based on the context it is used
func (m *GcpNativeProtectionGroupParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateGcpDiskExclusionParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *GcpNativeProtectionGroupParams) contextValidateGcpDiskExclusionParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GcpDiskExclusionParams != nil {
		...
		if err := m.GcpDiskExclusionParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gcpDiskExclusionParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gcpDiskExclusionParams")
...
func (m *GcpNativeProtectionGroupParams) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpNativeProtectionGroupParams) contextValidateObjects(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpNativeProtectionGroupParams) contextValidateSourceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpNativeProtectionGroupParams) contextValidateSourceName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpNativeProtectionGroupParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GcpNativeProtectionGroupParams) UnmarshalBinary(b []byte) error {
	var res GcpNativeProtectionGroupParams
