...
type CommonRecoverObjectSnapshotParams struct {
	...
	// Specifies whether recovery should be triggerred from the latest snapshot. If snapshotId is not specified and this param is set to true, then recovery will happen from the latest snapshot. The request will fail if this param is set to true and snapshotId is also specified. Currently this is only being used for M365 CSM based restores.
	...
	// Specifies the replication target information if the snapshot is a replication snapshot.
	// Read Only: true
...
func (m *CommonRecoverObjectSnapshotParams) validateReplicationTargetInfo(formats strfmt.Registry) error {
...
const (
	...
	// CommonRecoverObjectSnapshotParamsSnapshotTargetTypeSource captures enum value "Source"
	CommonRecoverObjectSnapshotParamsSnapshotTargetTypeSource string = "Source"
)
...
func (m *CommonRecoverObjectSnapshotParams) contextValidateReplicationTargetInfo(ctx context.Context, formats strfmt.Registry) error {
