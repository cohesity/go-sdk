...
type RecoverAcropolisVMOriginalSourceConfig struct {
	...
	// Specifies the category configuration to be applied to the recovered VMs.
	IncludeCategories *bool `json:"includeCategories,omitempty"`

	// Specifies the project owners configuration to be applied to the recovered VMs.
	IncludeProjectOwners *bool `json:"includeProjectOwners,omitempty"`
