...
// OriginalFlashbladeFilesTargetParams Recover To Original Flashblade Files Target Params.
//
// Specifies the params of the original Flashblade recovery target.
//
// swagger:model OriginalFlashbladeFilesTargetParams
...
// Validate validates this original flashblade files target params
func (m *OriginalFlashbladeFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalFlashbladeFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeFilesTargetParams) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original flashblade files target params based on the context it is used
func (m *OriginalFlashbladeFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalFlashbladeFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalFlashbladeFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalFlashbladeFilesTargetParams
