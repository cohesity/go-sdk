...
// OriginalNutanixFSTargetParams Recover To Original NutanixFS Volume Target Params.
//
// Specifies the params of the original NutanixFS recovery target.
//
// swagger:model OriginalNutanixFSTargetParams
type OriginalNutanixFSTargetParams struct {
...
// Validate validates this original nutanix f s target params
func (m *OriginalNutanixFSTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalNutanixFSTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original nutanix f s target params based on the context it is used
func (m *OriginalNutanixFSTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalNutanixFSTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalNutanixFSTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalNutanixFSTargetParams
