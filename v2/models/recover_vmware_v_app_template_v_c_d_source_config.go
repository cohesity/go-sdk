...
type RecoverVmwareVAppTemplateVCDSourceConfig struct {
	...
	// Specifies the VM placement compute policy to apply during recovery.
	PlacementPolicy *VcdPolicyParams `json:"placementPolicy,omitempty"`

	// Specifies the VM sizing compute policy to apply during recovery.
	SizingPolicy *VcdPolicyParams `json:"sizingPolicy,omitempty"`
...
func (m *RecoverVmwareVAppTemplateVCDSourceConfig) validatePlacementPolicy(formats strfmt.Registry) error {
...
func (m *RecoverVmwareVAppTemplateVCDSourceConfig) validateSizingPolicy(formats strfmt.Registry) error {
...
func (m *RecoverVmwareVAppTemplateVCDSourceConfig) contextValidatePlacementPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverVmwareVAppTemplateVCDSourceConfig) contextValidateSizingPolicy(ctx context.Context, formats strfmt.Registry) error {
