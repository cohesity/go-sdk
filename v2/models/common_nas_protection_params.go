...
//
// swagger:model CommonNasProtectionParams
...
// Validate validates this common nas protection params
func (m *CommonNasProtectionParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CommonNasProtectionParams) validateFileFilters(formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) validateFileLockConfig(formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) validateIndexingPolicy(formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) validatePrePostScript(formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) validateThrottlingConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this common nas protection params based on the context it is used
func (m *CommonNasProtectionParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CommonNasProtectionParams) contextValidateFileFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) contextValidateFileLockConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) contextValidatePrePostScript(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) contextValidateThrottlingConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CommonNasProtectionParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CommonNasProtectionParams) UnmarshalBinary(b []byte) error {
	var res CommonNasProtectionParams
