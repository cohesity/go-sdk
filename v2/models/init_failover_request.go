...
const (
	...
	// InitFailoverRequestProtectionGroupEnvironmentKGCPBigQuery captures enum value "kGCPBigQuery"
	InitFailoverRequestProtectionGroupEnvironmentKGCPBigQuery string = "kGCPBigQuery"

	// InitFailoverRequestProtectionGroupEnvironmentKGCPMySQL captures enum value "kGCPMySQL"
	InitFailoverRequestProtectionGroupEnvironmentKGCPMySQL string = "kGCPMySQL"

	// InitFailoverRequestProtectionGroupEnvironmentKGCPSQLServer captures enum value "kGCPSQLServer"
	InitFailoverRequestProtectionGroupEnvironmentKGCPSQLServer string = "kGCPSQLServer"

	// InitFailoverRequestProtectionGroupEnvironmentKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	InitFailoverRequestProtectionGroupEnvironmentKGCPPostgreSQL string = "kGCPPostgreSQL"

	// InitFailoverRequestProtectionGroupEnvironmentKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	InitFailoverRequestProtectionGroupEnvironmentKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// InitFailoverRequestProtectionGroupEnvironmentKGCPFirestore captures enum value "kGCPFirestore"
	InitFailoverRequestProtectionGroupEnvironmentKGCPFirestore string = "kGCPFirestore"

	// InitFailoverRequestProtectionGroupEnvironmentKGoogleSpanner captures enum value "kGoogleSpanner"
	InitFailoverRequestProtectionGroupEnvironmentKGoogleSpanner string = "kGoogleSpanner"

	// InitFailoverRequestProtectionGroupEnvironmentKGCPBigtable captures enum value "kGCPBigtable"
	InitFailoverRequestProtectionGroupEnvironmentKGCPBigtable string = "kGCPBigtable"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// InitFailoverRequestProtectionGroupEnvironmentKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	InitFailoverRequestProtectionGroupEnvironmentKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKAWSMySQL captures enum value "kAWSMySQL"
	InitFailoverRequestProtectionGroupEnvironmentKAWSMySQL string = "kAWSMySQL"

	// InitFailoverRequestProtectionGroupEnvironmentKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	InitFailoverRequestProtectionGroupEnvironmentKAWSAuroraMySQL string = "kAWSAuroraMySQL"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKAWSRdsOracle captures enum value "kAWSRdsOracle"
	InitFailoverRequestProtectionGroupEnvironmentKAWSRdsOracle string = "kAWSRdsOracle"

	// InitFailoverRequestProtectionGroupEnvironmentKAWSDocumentDB captures enum value "kAWSDocumentDB"
	InitFailoverRequestProtectionGroupEnvironmentKAWSDocumentDB string = "kAWSDocumentDB"

	// InitFailoverRequestProtectionGroupEnvironmentKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	InitFailoverRequestProtectionGroupEnvironmentKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// InitFailoverRequestProtectionGroupEnvironmentKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	InitFailoverRequestProtectionGroupEnvironmentKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// InitFailoverRequestProtectionGroupEnvironmentKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	InitFailoverRequestProtectionGroupEnvironmentKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// InitFailoverRequestProtectionGroupEnvironmentKAWSRedshift captures enum value "kAWSRedshift"
	InitFailoverRequestProtectionGroupEnvironmentKAWSRedshift string = "kAWSRedshift"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKAzureMySQL captures enum value "kAzureMySQL"
	InitFailoverRequestProtectionGroupEnvironmentKAzureMySQL string = "kAzureMySQL"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	InitFailoverRequestProtectionGroupEnvironmentKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	InitFailoverRequestProtectionGroupEnvironmentKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureBlobStorage captures enum value "kAzureBlobStorage"
	InitFailoverRequestProtectionGroupEnvironmentKAzureBlobStorage string = "kAzureBlobStorage"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	InitFailoverRequestProtectionGroupEnvironmentKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// InitFailoverRequestProtectionGroupEnvironmentKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	InitFailoverRequestProtectionGroupEnvironmentKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureSQLDB captures enum value "kAzureSQLDB"
	InitFailoverRequestProtectionGroupEnvironmentKAzureSQLDB string = "kAzureSQLDB"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureSQLMI captures enum value "kAzureSQLMI"
	InitFailoverRequestProtectionGroupEnvironmentKAzureSQLMI string = "kAzureSQLMI"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureTableStorage captures enum value "kAzureTableStorage"
	InitFailoverRequestProtectionGroupEnvironmentKAzureTableStorage string = "kAzureTableStorage"

	// InitFailoverRequestProtectionGroupEnvironmentKAzureTableAPI captures enum value "kAzureTableAPI"
	InitFailoverRequestProtectionGroupEnvironmentKAzureTableAPI string = "kAzureTableAPI"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKNutanixFS captures enum value "kNutanixFS"
	InitFailoverRequestProtectionGroupEnvironmentKNutanixFS string = "kNutanixFS"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKS3Compatible captures enum value "kS3Compatible"
	InitFailoverRequestProtectionGroupEnvironmentKS3Compatible string = "kS3Compatible"
	...
	// InitFailoverRequestProtectionGroupEnvironmentKGoogleWorkspace captures enum value "kGoogleWorkspace"
	InitFailoverRequestProtectionGroupEnvironmentKGoogleWorkspace string = "kGoogleWorkspace"

	// InitFailoverRequestProtectionGroupEnvironmentKGmail captures enum value "kGmail"
	InitFailoverRequestProtectionGroupEnvironmentKGmail string = "kGmail"

	// InitFailoverRequestProtectionGroupEnvironmentKGoogleDrive captures enum value "kGoogleDrive"
	InitFailoverRequestProtectionGroupEnvironmentKGoogleDrive string = "kGoogleDrive"

	// InitFailoverRequestProtectionGroupEnvironmentKDB2 captures enum value "kDB2"
	InitFailoverRequestProtectionGroupEnvironmentKDB2 string = "kDB2"

	// InitFailoverRequestProtectionGroupEnvironmentKServiceNow captures enum value "kServiceNow"
	InitFailoverRequestProtectionGroupEnvironmentKServiceNow string = "kServiceNow"

	// InitFailoverRequestProtectionGroupEnvironmentKSalesforce captures enum value "kSalesforce"
	InitFailoverRequestProtectionGroupEnvironmentKSalesforce string = "kSalesforce"

	// InitFailoverRequestProtectionGroupEnvironmentKPostgres captures enum value "kPostgres"
	InitFailoverRequestProtectionGroupEnvironmentKPostgres string = "kPostgres"

	// InitFailoverRequestProtectionGroupEnvironmentKJira captures enum value "kJira"
	InitFailoverRequestProtectionGroupEnvironmentKJira string = "kJira"

	// InitFailoverRequestProtectionGroupEnvironmentKPinecone captures enum value "kPinecone"
	InitFailoverRequestProtectionGroupEnvironmentKPinecone string = "kPinecone"
)
