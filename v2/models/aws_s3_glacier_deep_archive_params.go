...
func (m *AwsS3GlacierDeepArchiveParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AwsS3GlacierDeepArchiveParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this aws s3 glacier deep archive params
func (m *AwsS3GlacierDeepArchiveParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsS3GlacierDeepArchiveParams) validateAwsCloudGovParams(formats strfmt.Registry) error {
...
func (m *AwsS3GlacierDeepArchiveParams) validateAwsCloudStandardParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws s3 glacier deep archive params based on the context it is used
func (m *AwsS3GlacierDeepArchiveParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsS3GlacierDeepArchiveParams) contextValidateAwsCloudGovParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsS3GlacierDeepArchiveParams) contextValidateAwsCloudStandardParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsS3GlacierDeepArchiveParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsS3GlacierDeepArchiveParams) UnmarshalBinary(b []byte) error {
	var res AwsS3GlacierDeepArchiveParams
