...
// RecoverOtherNasToNutanixFSVolumeTargetParams Recover To NutanixFS Volume Target Params.
//
// Specifies the params of the NutanixFS recovery target.
//
// swagger:model RecoverOtherNasToNutanixFSVolumeTargetParams
type RecoverOtherNasToNutanixFSVolumeTargetParams struct {
...
// Validate validates this recover other nas to nutanix f s volume target params
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to nutanix f s volume target params based on the context it is used
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToNutanixFSVolumeTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToNutanixFSVolumeTargetParams
