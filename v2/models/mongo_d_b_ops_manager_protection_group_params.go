...
type MongoDBOpsManagerProtectionGroupParams struct {
	...
	// Specifies the comma separated list of hostnames to take backup from; in the order of preference. If provided, these nodes will be preferred as a backup source. The hostnames MUST match the hostnames reported by OpsManager in cluster status result.
	PreferredBackupNodes *string `json:"preferredBackupNodes,omitempty"`
...
func (m *MongoDBOpsManagerProtectionGroupParams) contextValidateSourceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MongoDBOpsManagerProtectionGroupParams) contextValidateSourceName(ctx context.Context, formats strfmt.Registry) error {
