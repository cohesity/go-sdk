...
// RecoverAcropolisVMNewNetworkConfig Recover VMware VMs New Network configuration.
//
// Specifies the new network config parameters to be applied to VMware VMs.
//
// swagger:model RecoverAcropolisVmNewNetworkConfig
type RecoverAcropolisVMNewNetworkConfig struct {
...
// Validate validates this recover acropolis Vm new network config
func (m *RecoverAcropolisVMNewNetworkConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverAcropolisVMNewNetworkConfig) validateNetworkPortGroup(formats strfmt.Registry) error {
...
// ContextValidate validate this recover acropolis Vm new network config based on the context it is used
func (m *RecoverAcropolisVMNewNetworkConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverAcropolisVMNewNetworkConfig) contextValidateNetworkPortGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverAcropolisVMNewNetworkConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverAcropolisVMNewNetworkConfig) UnmarshalBinary(b []byte) error {
	var res RecoverAcropolisVMNewNetworkConfig
