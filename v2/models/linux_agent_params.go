...
type LinuxAgentParams struct {
	...
	// Required: true
	// Enum: [kScript kRPM kSuseRPM kDEB kPowerPCRPM kS390XRPM kUnknownLinuxPackage kAarch64RPM]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kScript","kRPM","kSuseRPM","kDEB","kPowerPCRPM","kS390XRPM","kUnknownLinuxPackage","kAarch64RPM"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// LinuxAgentParamsPackageTypeKS390XRPM captures enum value "kS390XRPM"
	LinuxAgentParamsPackageTypeKS390XRPM string = "kS390XRPM"

	// LinuxAgentParamsPackageTypeKUnknownLinuxPackage captures enum value "kUnknownLinuxPackage"
	LinuxAgentParamsPackageTypeKUnknownLinuxPackage string = "kUnknownLinuxPackage"

	// LinuxAgentParamsPackageTypeKAarch64RPM captures enum value "kAarch64RPM"
	LinuxAgentParamsPackageTypeKAarch64RPM string = "kAarch64RPM"
)
