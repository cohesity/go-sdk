...
// AwsObjectProtectionResponseParams AWS Object Protection Response Params.
//
// Specifies the parameters which are specific to AWS related Object Protection response.
//
// swagger:model AwsObjectProtectionResponseParams
...
func (m *AwsObjectProtectionResponseParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AwsObjectProtectionResponseParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this aws object protection response params
func (m *AwsObjectProtectionResponseParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsObjectProtectionResponseParams) validateAuroraSnapshotManagerProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) validateDynamoDBProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) validateNativeProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) validateRdsPostgresProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) validateRdsSnapshotManagerProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) validateS3ProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) validateSnapshotManagerProtectionTypeParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws object protection response params based on the context it is used
func (m *AwsObjectProtectionResponseParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsObjectProtectionResponseParams) contextValidateAuroraSnapshotManagerProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) contextValidateDynamoDBProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) contextValidateNativeProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) contextValidateRdsPostgresProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) contextValidateRdsSnapshotManagerProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) contextValidateS3ProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) contextValidateSnapshotManagerProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionResponseParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsObjectProtectionResponseParams) UnmarshalBinary(b []byte) error {
	var res AwsObjectProtectionResponseParams
