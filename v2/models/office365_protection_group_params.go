...
type Office365ProtectionGroupParams struct {
	...
	// Specifies the parameters specific to Teams Protection Group type.
	TeamsProtectionTypeParams *Office365TeamsProtectionGroupParams `json:"teamsProtectionTypeParams,omitempty"`
}
...
func (m *Office365ProtectionGroupParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTeamsProtectionTypeParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Office365ProtectionGroupParams) validateTeamsProtectionTypeParams(formats strfmt.Registry) error {
	if swag.IsZero(m.TeamsProtectionTypeParams) { // not required
		return nil
	}

	if m.TeamsProtectionTypeParams != nil {
		if err := m.TeamsProtectionTypeParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("teamsProtectionTypeParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("teamsProtectionTypeParams")
			}
			return err
		}
	}
...
func (m *Office365ProtectionGroupParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTeamsProtectionTypeParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Office365ProtectionGroupParams) contextValidateTeamsProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.TeamsProtectionTypeParams != nil {
		...
		if err := m.TeamsProtectionTypeParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("teamsProtectionTypeParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("teamsProtectionTypeParams")
