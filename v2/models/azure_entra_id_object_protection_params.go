...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Unknown","AdminUnit","Application","Contact","Device","DirRole","Group","ServicePrincipal","AppRoleAssignment","User","CondAccessPolicy"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
