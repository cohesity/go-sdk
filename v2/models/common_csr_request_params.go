...
type CommonCsrRequestParams struct {
	...
	// Specifies the Cohesity service name for which the CSR is
	// generated. Default service name is iris.
	//
...
const (
	...
	// CommonCsrRequestParamsServiceNameHeliosUIHeliosSelfManaged captures enum value "helios_ui_helios_self_managed"
	CommonCsrRequestParamsServiceNameHeliosUIHeliosSelfManaged string = "helios_ui_helios_self_managed"
)
