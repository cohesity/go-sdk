...
type GroupParams struct {
	...
	// Specifies if the group is build-in group.
	// Required: true
	// Read Only: true
...
func (m *GroupParams) validateIsBuiltIn(formats strfmt.Registry) error {
...
func (m *GroupParams) contextValidateIsBuiltIn(ctx context.Context, formats strfmt.Registry) error {
