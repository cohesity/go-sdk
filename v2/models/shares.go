...
func (m *Shares) validateShares(formats strfmt.Registry) error {
...
func (m *Shares) contextValidateShares(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Shares) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Shares) UnmarshalBinary(b []byte) error {
	var res Shares
