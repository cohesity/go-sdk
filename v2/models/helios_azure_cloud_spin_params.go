...
// HeliosAzureCloudSpinParams Azure Parameters.
//
// Specifies various resources when converting and deploying a VM to Azure.
//
// swagger:model HeliosAzureCloudSpinParams
...
// Validate validates this helios azure cloud spin params
func (m *HeliosAzureCloudSpinParams) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this helios azure cloud spin params based on context it is used
func (m *HeliosAzureCloudSpinParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *HeliosAzureCloudSpinParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HeliosAzureCloudSpinParams) UnmarshalBinary(b []byte) error {
	var res HeliosAzureCloudSpinParams
