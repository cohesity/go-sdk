...
type ClusterCreateNetworkConfig struct {
	...
	// Specifies the FQDN hostname of the cluster. Note: This field will be deprecated in future. Use hostNames field instead.
...
func (m *ClusterCreateNetworkConfig) contextValidateHostNames(ctx context.Context, formats strfmt.Registry) error {
