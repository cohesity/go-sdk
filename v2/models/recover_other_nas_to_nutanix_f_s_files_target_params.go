...
// RecoverOtherNasToNutanixFSFilesTargetParams Recover To NutanixFS Files Target Params.
//
// Specifies the params of the NutanixFS recovery target.
//
// swagger:model RecoverOtherNasToNutanixFSFilesTargetParams
type RecoverOtherNasToNutanixFSFilesTargetParams struct {
...
// Validate validates this recover other nas to nutanix f s files target params
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) validateAlternatePath(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to nutanix f s files target params based on the context it is used
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToNutanixFSFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToNutanixFSFilesTargetParams
