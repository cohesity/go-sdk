...
//
// swagger:model HeliosTierLevelSettings
...
// Validate validates this helios tier level settings
func (m *HeliosTierLevelSettings) Validate(formats strfmt.Registry) error {
	var res []error
...
var heliosTierLevelSettingsTypeCloudPlatformPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		heliosTierLevelSettingsTypeCloudPlatformPropEnum = append(heliosTierLevelSettingsTypeCloudPlatformPropEnum, v)
	}
}

const (

	// HeliosTierLevelSettingsCloudPlatformAWS captures enum value "AWS"
	HeliosTierLevelSettingsCloudPlatformAWS string = "AWS"

	// HeliosTierLevelSettingsCloudPlatformAzure captures enum value "Azure"
	HeliosTierLevelSettingsCloudPlatformAzure string = "Azure"

	// HeliosTierLevelSettingsCloudPlatformOracle captures enum value "Oracle"
	HeliosTierLevelSettingsCloudPlatformOracle string = "Oracle"

	// HeliosTierLevelSettingsCloudPlatformGoogle captures enum value "Google"
	HeliosTierLevelSettingsCloudPlatformGoogle string = "Google"
)

// prop value enum
func (m *HeliosTierLevelSettings) validateCloudPlatformEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, heliosTierLevelSettingsTypeCloudPlatformPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *HeliosTierLevelSettings) validateCloudPlatform(formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) validateAwsTiering(formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) validateAzureTiering(formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) validateGoogleTiering(formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) validateOracleTiering(formats strfmt.Registry) error {
...
// ContextValidate validate this helios tier level settings based on the context it is used
func (m *HeliosTierLevelSettings) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosTierLevelSettings) contextValidateAwsTiering(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) contextValidateAzureTiering(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) contextValidateGoogleTiering(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) contextValidateOracleTiering(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTierLevelSettings) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HeliosTierLevelSettings) UnmarshalBinary(b []byte) error {
	var res HeliosTierLevelSettings
