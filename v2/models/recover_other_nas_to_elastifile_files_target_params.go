...
// RecoverOtherNasToElastifileFilesTargetParams Recover To Elastifile Files Target Params.
//
// Specifies the params of the Elastifile recovery target.
//
// swagger:model RecoverOtherNasToElastifileFilesTargetParams
...
// Validate validates this recover other nas to elastifile files target params
func (m *RecoverOtherNasToElastifileFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) validateAlternatePath(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to elastifile files target params based on the context it is used
func (m *RecoverOtherNasToElastifileFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToElastifileFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToElastifileFilesTargetParams
