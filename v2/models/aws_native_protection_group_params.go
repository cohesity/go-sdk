...
// AwsNativeProtectionGroupParams AWS Native Protection Group Request Params.
//
...
//
// swagger:model AwsNativeProtectionGroupParams
type AwsNativeProtectionGroupParams struct {
	...
	Objects []*AwsNativeProtectionGroupObjectParams `json:"objects"`
...
// Validate validates this aws native protection group params
func (m *AwsNativeProtectionGroupParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsNativeProtectionGroupParams) validateExcludeObjectIds(formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) validateIndexingPolicy(formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) validateObjects(formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) validateVolumeExclusionParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws native protection group params based on the context it is used
func (m *AwsNativeProtectionGroupParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsNativeProtectionGroupParams) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) contextValidateObjects(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) contextValidateSourceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) contextValidateSourceName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) contextValidateVolumeExclusionParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsNativeProtectionGroupParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsNativeProtectionGroupParams) UnmarshalBinary(b []byte) error {
	var res AwsNativeProtectionGroupParams
