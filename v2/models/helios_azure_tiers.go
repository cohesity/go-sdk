...
//
// swagger:model HeliosAzureTiers
...
// Validate validates this helios azure tiers
func (m *HeliosAzureTiers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosAzureTiers) validateTiers(formats strfmt.Registry) error {
...
// ContextValidate validate this helios azure tiers based on the context it is used
func (m *HeliosAzureTiers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosAzureTiers) contextValidateTiers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosAzureTiers) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HeliosAzureTiers) UnmarshalBinary(b []byte) error {
	var res HeliosAzureTiers
