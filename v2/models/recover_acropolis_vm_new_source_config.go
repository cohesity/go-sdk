...
type RecoverAcropolisVMNewSourceConfig struct {
	...
	// A Prism Element where the VM should be restored to. Applicable only when the parent source is Prism Central.
	PrismElement *RecoveryObjectIdentifier `json:"prismElement,omitempty"`
...
func (m *RecoverAcropolisVMNewSourceConfig) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePrismElement(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RecoverAcropolisVMNewSourceConfig) validatePrismElement(formats strfmt.Registry) error {
	if swag.IsZero(m.PrismElement) { // not required
		return nil
	}

	if m.PrismElement != nil {
		if err := m.PrismElement.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("prismElement")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("prismElement")
			}
			return err
		}
	}
...
func (m *RecoverAcropolisVMNewSourceConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePrismElement(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RecoverAcropolisVMNewSourceConfig) contextValidatePrismElement(ctx context.Context, formats strfmt.Registry) error {

	if m.PrismElement != nil {
		if err := m.PrismElement.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("prismElement")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("prismElement")
