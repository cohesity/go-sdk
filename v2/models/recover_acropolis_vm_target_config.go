...
// RecoverAcropolisVMTargetConfig Vm Target Configuration for Acropolis Recovery
//
// Specifies the target configuration source parameters.
//
// swagger:model RecoverAcropolisVmTargetConfig
type RecoverAcropolisVMTargetConfig struct {
	...
	NewSourceConfig *RecoverAcropolisVMNewSourceConfig `json:"newSourceConfig,omitempty"`
	...
	OriginalSourceConfig *RecoverAcropolisVMOriginalSourceConfig `json:"originalSourceConfig,omitempty"`
...
// Validate validates this recover acropolis Vm target config
func (m *RecoverAcropolisVMTargetConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverAcropolisVMTargetConfig) validateNewSourceConfig(formats strfmt.Registry) error {
...
func (m *RecoverAcropolisVMTargetConfig) validateOriginalSourceConfig(formats strfmt.Registry) error {
...
func (m *RecoverAcropolisVMTargetConfig) validateRecoverToNewSource(formats strfmt.Registry) error {
...
// ContextValidate validate this recover acropolis Vm target config based on the context it is used
func (m *RecoverAcropolisVMTargetConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverAcropolisVMTargetConfig) contextValidateNewSourceConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverAcropolisVMTargetConfig) contextValidateOriginalSourceConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverAcropolisVMTargetConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverAcropolisVMTargetConfig) UnmarshalBinary(b []byte) error {
	var res RecoverAcropolisVMTargetConfig
