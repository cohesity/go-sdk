...
type DownloadAgentRequestParams struct {
	...
	// Required: true
	// Enum: [kAix kCockroachDB kDB2 kHPUX kLinux kMariaDB kMySQL kPostgreSQL kSapASE kSapHana kSapMaxDB kSapOracle kSapSybase kSapSybaseIQ kSolaris kVMWareCDPFilter kVOS kWindows]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kAix","kCockroachDB","kDB2","kHPUX","kLinux","kMariaDB","kMySQL","kPostgreSQL","kSapASE","kSapHana","kSapMaxDB","kSapOracle","kSapSybase","kSapSybaseIQ","kSolaris","kVMWareCDPFilter","kVOS","kWindows"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// DownloadAgentRequestParamsPlatformKDB2 captures enum value "kDB2"
	DownloadAgentRequestParamsPlatformKDB2 string = "kDB2"
	...
	// DownloadAgentRequestParamsPlatformKMariaDB captures enum value "kMariaDB"
	DownloadAgentRequestParamsPlatformKMariaDB string = "kMariaDB"
	...
	// DownloadAgentRequestParamsPlatformKPostgreSQL captures enum value "kPostgreSQL"
	DownloadAgentRequestParamsPlatformKPostgreSQL string = "kPostgreSQL"

	// DownloadAgentRequestParamsPlatformKSapASE captures enum value "kSapASE"
	DownloadAgentRequestParamsPlatformKSapASE string = "kSapASE"
	...
	// DownloadAgentRequestParamsPlatformKSapMaxDB captures enum value "kSapMaxDB"
	DownloadAgentRequestParamsPlatformKSapMaxDB string = "kSapMaxDB"
	...
	// DownloadAgentRequestParamsPlatformKSapSybase captures enum value "kSapSybase"
	DownloadAgentRequestParamsPlatformKSapSybase string = "kSapSybase"

	// DownloadAgentRequestParamsPlatformKSapSybaseIQ captures enum value "kSapSybaseIQ"
	DownloadAgentRequestParamsPlatformKSapSybaseIQ string = "kSapSybaseIQ"
