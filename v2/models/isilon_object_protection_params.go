...
var isilonObjectProtectionParamsTypeNfsVersionPreferencePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		isilonObjectProtectionParamsTypeNfsVersionPreferencePropEnum = append(isilonObjectProtectionParamsTypeNfsVersionPreferencePropEnum, v)
	}
}

const (

	// IsilonObjectProtectionParamsNfsVersionPreferenceKNfs3 captures enum value "kNfs3"
	IsilonObjectProtectionParamsNfsVersionPreferenceKNfs3 string = "kNfs3"

	// IsilonObjectProtectionParamsNfsVersionPreferenceKNfs41 captures enum value "kNfs4_1"
	IsilonObjectProtectionParamsNfsVersionPreferenceKNfs41 string = "kNfs4_1"
)

// prop value enum
func (m *IsilonObjectProtectionParams) validateNfsVersionPreferenceEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, isilonObjectProtectionParamsTypeNfsVersionPreferencePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *IsilonObjectProtectionParams) validateNfsVersionPreference(formats strfmt.Registry) error {
