...
//
// swagger:model FlashbladeProtectionGroupParams
...
// Validate validates this flashblade protection group params
func (m *FlashbladeProtectionGroupParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FlashbladeProtectionGroupParams) validateFileFilters(formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) validateFileLockConfig(formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) validateIndexingPolicy(formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) validateObjects(formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) validatePrePostScript(formats strfmt.Registry) error {
...
var flashbladeProtectionGroupParamsTypeProtocolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		flashbladeProtectionGroupParamsTypeProtocolPropEnum = append(flashbladeProtectionGroupParamsTypeProtocolPropEnum, v)
	}
}

const (

	// FlashbladeProtectionGroupParamsProtocolKNoProtocol captures enum value "kNoProtocol"
	FlashbladeProtectionGroupParamsProtocolKNoProtocol string = "kNoProtocol"

	// FlashbladeProtectionGroupParamsProtocolKNfs3 captures enum value "kNfs3"
	FlashbladeProtectionGroupParamsProtocolKNfs3 string = "kNfs3"

	// FlashbladeProtectionGroupParamsProtocolKNfs41 captures enum value "kNfs4_1"
	FlashbladeProtectionGroupParamsProtocolKNfs41 string = "kNfs4_1"

	// FlashbladeProtectionGroupParamsProtocolKCifs1 captures enum value "kCifs1"
	FlashbladeProtectionGroupParamsProtocolKCifs1 string = "kCifs1"

	// FlashbladeProtectionGroupParamsProtocolKCifs2 captures enum value "kCifs2"
	FlashbladeProtectionGroupParamsProtocolKCifs2 string = "kCifs2"

	// FlashbladeProtectionGroupParamsProtocolKCifs3 captures enum value "kCifs3"
	FlashbladeProtectionGroupParamsProtocolKCifs3 string = "kCifs3"
)

// prop value enum
func (m *FlashbladeProtectionGroupParams) validateProtocolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, flashbladeProtectionGroupParamsTypeProtocolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *FlashbladeProtectionGroupParams) validateProtocol(formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) validateThrottlingConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this flashblade protection group params based on the context it is used
func (m *FlashbladeProtectionGroupParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *FlashbladeProtectionGroupParams) contextValidateFileFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateFileLockConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateObjects(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidatePrePostScript(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateSourceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateSourceName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) contextValidateThrottlingConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *FlashbladeProtectionGroupParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *FlashbladeProtectionGroupParams) UnmarshalBinary(b []byte) error {
	var res FlashbladeProtectionGroupParams
