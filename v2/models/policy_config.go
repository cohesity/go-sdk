...
type PolicyConfig struct {
	...
	// Min Items: 1
	// Unique: true
	Policies []*ObjectPolicy `json:"policies"`
}
...
func (m *PolicyConfig) validatePolicies(formats strfmt.Registry) error {
...
func (m *PolicyConfig) contextValidatePolicies(ctx context.Context, formats strfmt.Registry) error {
