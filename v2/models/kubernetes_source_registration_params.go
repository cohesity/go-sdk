...
type KubernetesSourceRegistrationParams struct {
	...
	// Specifies the datamover image location of Kubernetes source. If not specified, it will pull the appropriate image from the registry.
	...
	// Enum: ["kCluster","kNamespace","kService","kPVC","kPersistentVolumeClaim","kPersistentVolume","kLabel","kVirtualMachine"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kCluster","kNamespace","kService","kPVC","kPersistentVolumeClaim","kPersistentVolume","kLabel","kVirtualMachine"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// KubernetesSourceRegistrationParamsKubernetesTypeKVirtualMachine captures enum value "kVirtualMachine"
	KubernetesSourceRegistrationParamsKubernetesTypeKVirtualMachine string = "kVirtualMachine"
)
