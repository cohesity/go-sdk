...
type StorageDomain struct {
	...
	// Specifies whether to enable direct archive on this Storage Domain. If enabled, this Storage Domain can be used as a staging area while copying a large dataset that can't fit on the cluster to an external target.
	...
	// purpose
	Purpose *StorageDomainPurposeParam `json:"purpose,omitempty"`
...
func (m *StorageDomain) validatePurpose(formats strfmt.Registry) error {
...
func (m *StorageDomain) contextValidatePurpose(ctx context.Context, formats strfmt.Registry) error {
