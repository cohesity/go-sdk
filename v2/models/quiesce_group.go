...
type QuiesceGroup struct {
	...
	// Required: true
	// Enum: [kQuiesceTogether kQuiesceIndependently kQuiesceSequential]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kQuiesceTogether","kQuiesceIndependently","kQuiesceSequential"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// QuiesceGroupQuiesceModeKQuiesceSequential captures enum value "kQuiesceSequential"
	QuiesceGroupQuiesceModeKQuiesceSequential string = "kQuiesceSequential"
)
