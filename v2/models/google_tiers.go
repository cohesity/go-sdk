...
// Validate validates this google tiers
func (m *GoogleTiers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GoogleTiers) validateTiers(formats strfmt.Registry) error {
...
// ContextValidate validate this google tiers based on the context it is used
func (m *GoogleTiers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GoogleTiers) contextValidateTiers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GoogleTiers) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GoogleTiers) UnmarshalBinary(b []byte) error {
	var res GoogleTiers
