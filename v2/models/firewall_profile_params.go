...
type FirewallProfileParams struct {
	...
	// Enum: ["INPUT","OUTPUT","NAT_INPUT","FORWARD"]
	Direction *string `json:"direction,omitempty"`

	// Specifies the network interface groups.
	InterfaceGroups []string `json:"interfaceGroups"`
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["INPUT","OUTPUT","NAT_INPUT","FORWARD"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// FirewallProfileParamsDirectionFORWARD captures enum value "FORWARD"
	FirewallProfileParamsDirectionFORWARD string = "FORWARD"
)
