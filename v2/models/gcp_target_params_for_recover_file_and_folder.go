...
// GcpTargetParamsForRecoverFileAndFolder GCP Target Params for Recover File And Folder
//
// Specifies the parameters for a GCP recovery target.
//
// swagger:model GcpTargetParamsForRecoverFileAndFolder
type GcpTargetParamsForRecoverFileAndFolder struct {
	...
	NewTargetConfig *GcpRecoverFilesNewTargetConfig `json:"newTargetConfig,omitempty"`

	// Specifies the configuration for recovering to the original target.
	OriginalTargetConfig *GcpRecoverFilesOriginalTargetConfig `json:"originalTargetConfig,omitempty"`
...
// Validate validates this gcp target params for recover file and folder
func (m *GcpTargetParamsForRecoverFileAndFolder) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GcpTargetParamsForRecoverFileAndFolder) validateNewTargetConfig(formats strfmt.Registry) error {
...
func (m *GcpTargetParamsForRecoverFileAndFolder) validateOriginalTargetConfig(formats strfmt.Registry) error {
...
func (m *GcpTargetParamsForRecoverFileAndFolder) validateRecoverToOriginalTarget(formats strfmt.Registry) error {
...
func (m *GcpTargetParamsForRecoverFileAndFolder) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this gcp target params for recover file and folder based on the context it is used
func (m *GcpTargetParamsForRecoverFileAndFolder) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GcpTargetParamsForRecoverFileAndFolder) contextValidateNewTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpTargetParamsForRecoverFileAndFolder) contextValidateOriginalTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpTargetParamsForRecoverFileAndFolder) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpTargetParamsForRecoverFileAndFolder) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GcpTargetParamsForRecoverFileAndFolder) UnmarshalBinary(b []byte) error {
	var res GcpTargetParamsForRecoverFileAndFolder
