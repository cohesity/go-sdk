...
const (
	...
	// FileExtensionFilterModeWhitelist captures enum value "Whitelist"
	FileExtensionFilterModeWhitelist string = "Whitelist"

	// FileExtensionFilterModeBlacklist captures enum value "Blacklist"
	FileExtensionFilterModeBlacklist string = "Blacklist"
)
