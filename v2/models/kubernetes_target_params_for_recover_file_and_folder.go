...
// KubernetesTargetParamsForRecoverFileAndFolder Kubernetes Target Params for Recover File And Folder
//
// Specifies the parameters for a Kubernetes recovery target.
//
// swagger:model KubernetesTargetParamsForRecoverFileAndFolder
type KubernetesTargetParamsForRecoverFileAndFolder struct {
	...
	NewTargetConfig *KubernetesRecoverFilesNewTargetConfig `json:"newTargetConfig,omitempty"`

	// Specifies the configuration for recovering to the original target.
	OriginalTargetConfig *KubernetesRecoverFilesOriginalTargetConfig `json:"originalTargetConfig,omitempty"`
...
// Validate validates this kubernetes target params for recover file and folder
func (m *KubernetesTargetParamsForRecoverFileAndFolder) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) validateNewTargetConfig(formats strfmt.Registry) error {
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) validateOriginalTargetConfig(formats strfmt.Registry) error {
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) validateRecoverToOriginalTarget(formats strfmt.Registry) error {
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this kubernetes target params for recover file and folder based on the context it is used
func (m *KubernetesTargetParamsForRecoverFileAndFolder) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) contextValidateNewTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) contextValidateOriginalTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *KubernetesTargetParamsForRecoverFileAndFolder) UnmarshalBinary(b []byte) error {
	var res KubernetesTargetParamsForRecoverFileAndFolder
