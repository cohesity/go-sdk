...
func (m *AwsGlacierParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AwsGlacierParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this aws glacier params
func (m *AwsGlacierParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsGlacierParams) validateAwsCloudC2SParams(formats strfmt.Registry) error {
...
func (m *AwsGlacierParams) validateAwsCloudGovParams(formats strfmt.Registry) error {
...
func (m *AwsGlacierParams) validateAwsCloudStandardParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws glacier params based on the context it is used
func (m *AwsGlacierParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsGlacierParams) contextValidateAwsCloudC2SParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsGlacierParams) contextValidateAwsCloudGovParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsGlacierParams) contextValidateAwsCloudStandardParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsGlacierParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsGlacierParams) UnmarshalBinary(b []byte) error {
	var res AwsGlacierParams
