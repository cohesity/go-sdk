...
type UpdateViewParam struct {
	...
	// Required: true
	// Enum: [BackupTarget FileServices ObjectServices ArchiveServices]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["BackupTarget","FileServices","ObjectServices","ArchiveServices"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
