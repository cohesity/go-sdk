...
func (m *RecoverElastifileNasVolumeParams) validateNutanixFSTargetParams(formats strfmt.Registry) error {
...
const (
	...
	// RecoverElastifileNasVolumeParamsTargetEnvironmentKNutanixFS captures enum value "kNutanixFS"
	RecoverElastifileNasVolumeParamsTargetEnvironmentKNutanixFS string = "kNutanixFS"
...
func (m *RecoverElastifileNasVolumeParams) contextValidateNutanixFSTargetParams(ctx context.Context, formats strfmt.Registry) error {
