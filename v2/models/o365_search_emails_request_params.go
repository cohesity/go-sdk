...
type O365SearchEmailsRequestParams struct {
	...
	// If true, includes items from Archive Recoverable Items folder in search results.
	IncludeArchiveRecoverableItems *bool `json:"includeArchiveRecoverableItems,omitempty"`

	// If true, includes items from InPlace-Archive in search results.
	IncludeInPlaceArchiveItems *bool `json:"includeInPlaceArchiveItems,omitempty"`

	// If true, includes items from Primary Mailbox in search results.
	IncludePrimaryMailboxItems *bool `json:"includePrimaryMailboxItems,omitempty"`

	// If true, includes items from Recoverable Items folder in search results.
	IncludeRecoverableItems *bool `json:"includeRecoverableItems,omitempty"`
