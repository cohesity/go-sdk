...
type BulkInstallAppTaskInfo struct {
	...
	// Job id of the bulk install app task.
	JobID *string `json:"jobId,omitempty"`

	// Number of machines on which bulk install app task is failed.
	NumMachinesFailed *int32 `json:"numMachinesFailed,omitempty"`

	// Number of machines on which bulk install app task is passed.
	NumMachinesPassed *int32 `json:"numMachinesPassed,omitempty"`

	// Number of machines on which bulk install app task is started.
	...
	// Current state of the task. This param is used to indicate the state of the job created by the bulk install app.
