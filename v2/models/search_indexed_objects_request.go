...
type SearchIndexedObjectsRequest struct {
	...
	// Specifies the parameters which are specific for searching Gmail emails and folders.
	GmailParams *SearchGmailRequestParams `json:"gmailParams,omitempty"`

	// Specifies the parameters which are specific for searching Google Drive files and folders.
	GoogleDriveParams *SearchGoogleDriveRequestParams `json:"googleDriveParams,omitempty"`
...
func (m *SearchIndexedObjectsRequest) UnmarshalJSON(raw []byte) error {
	...
	m.GmailParams = dataAO1.GmailParams

	m.GoogleDriveParams = dataAO1.GoogleDriveParams
...
func (m SearchIndexedObjectsRequest) MarshalJSON() ([]byte, error) {
	...
	dataAO1.GmailParams = m.GmailParams

	dataAO1.GoogleDriveParams = m.GoogleDriveParams
...
func (m *SearchIndexedObjectsRequest) validateGmailParams(formats strfmt.Registry) error {

	if swag.IsZero(m.GmailParams) { // not required
		return nil
	}
...
func (m *SearchIndexedObjectsRequest) validateGoogleDriveParams(formats strfmt.Registry) error {

	if swag.IsZero(m.GoogleDriveParams) { // not required
		return nil
	}
...
func (m *SearchIndexedObjectsRequest) contextValidateGmailParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SearchIndexedObjectsRequest) contextValidateGoogleDriveParams(ctx context.Context, formats strfmt.Registry) error {
