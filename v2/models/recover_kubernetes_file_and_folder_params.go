...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kKubernetes","kAzure"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// RecoverKubernetesFileAndFolderParamsTargetEnvironmentKAzure captures enum value "kAzure"
	RecoverKubernetesFileAndFolderParamsTargetEnvironmentKAzure string = "kAzure"
)
