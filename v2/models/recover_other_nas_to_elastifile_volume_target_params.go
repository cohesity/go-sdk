...
// RecoverOtherNasToElastifileVolumeTargetParams Recover To Elastifile Volume Target Params.
//
// Specifies the params of the Elastifile recovery target.
//
// swagger:model RecoverOtherNasToElastifileVolumeTargetParams
...
// Validate validates this recover other nas to elastifile volume target params
func (m *RecoverOtherNasToElastifileVolumeTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to elastifile volume target params based on the context it is used
func (m *RecoverOtherNasToElastifileVolumeTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToElastifileVolumeTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToElastifileVolumeTargetParams
