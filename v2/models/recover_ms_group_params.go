...
type RecoverMsGroupParams struct {
	...
	// Specifies whether to restore standard metadata fields for recovered items where applicable. Default value is false. If set to true, then the standard metadata fields like author, editor, created_date, modified_date will be restored.
