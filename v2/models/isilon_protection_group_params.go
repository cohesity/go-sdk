...
type IsilonProtectionGroupParams struct {
	...
	// Specifies the preference of NFS version to be used for backing up Isilon.
	// Enum: [kNfs3 kNfs4_1]
...
var isilonProtectionGroupParamsTypeNfsVersionPreferencePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		isilonProtectionGroupParamsTypeNfsVersionPreferencePropEnum = append(isilonProtectionGroupParamsTypeNfsVersionPreferencePropEnum, v)
	}
}

const (

	// IsilonProtectionGroupParamsNfsVersionPreferenceKNfs3 captures enum value "kNfs3"
	IsilonProtectionGroupParamsNfsVersionPreferenceKNfs3 string = "kNfs3"

	// IsilonProtectionGroupParamsNfsVersionPreferenceKNfs41 captures enum value "kNfs4_1"
	IsilonProtectionGroupParamsNfsVersionPreferenceKNfs41 string = "kNfs4_1"
)

// prop value enum
func (m *IsilonProtectionGroupParams) validateNfsVersionPreferenceEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, isilonProtectionGroupParamsTypeNfsVersionPreferencePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *IsilonProtectionGroupParams) validateNfsVersionPreference(formats strfmt.Registry) error {
