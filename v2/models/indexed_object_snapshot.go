...
type IndexedObjectSnapshot struct {
	...
	// Specifies whether the indexed object has a source snapshot.
	HasSourceSnapshot *bool `json:"hasSourceSnapshot,omitempty"`

	// Specifies the hash of the indexed object. This is currently only applicable for snapshots of the file.
	IndexedObjectHash *string `json:"indexedObjectHash,omitempty"`
	...
	UdaParams *UdaSnapshotMetadata `json:"udaParams,omitempty"`
}
...
func (m *IndexedObjectSnapshot) validateUdaParams(formats strfmt.Registry) error {
...
func (m *IndexedObjectSnapshot) contextValidateUdaParams(ctx context.Context, formats strfmt.Registry) error {
