...
// Validate validates this helios a w s tiers
func (m *HeliosAWSTiers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosAWSTiers) validateTiers(formats strfmt.Registry) error {
...
// ContextValidate validate this helios a w s tiers based on the context it is used
func (m *HeliosAWSTiers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosAWSTiers) contextValidateTiers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosAWSTiers) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HeliosAWSTiers) UnmarshalBinary(b []byte) error {
	var res HeliosAWSTiers
