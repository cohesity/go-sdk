...
type StoragePolicy struct {
	...
	// Specifies the redundancy type of the Storage Domain. This value is read-only and is derived from the configured numDiskFailuresTolerated and erasureCodingParams fields.
	// Read Only: true
...
func (m *StoragePolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRedundancy(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *StoragePolicy) contextValidateRedundancy(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "redundancy", "body", m.Redundancy); err != nil {
		return err
	}
