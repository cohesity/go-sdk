...
func (m *RecoverNetappFilesParams) validateNutanixFSTargetParams(formats strfmt.Registry) error {
...
const (
	...
	// RecoverNetappFilesParamsTargetEnvironmentKNutanixFS captures enum value "kNutanixFS"
	RecoverNetappFilesParamsTargetEnvironmentKNutanixFS string = "kNutanixFS"
)
...
func (m *RecoverNetappFilesParams) contextValidateNutanixFSTargetParams(ctx context.Context, formats strfmt.Registry) error {
