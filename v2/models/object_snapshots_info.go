...
type ObjectSnapshotsInfo struct {
	...
	// Specifies the replication snapshot information.
	ReplicationSnapshotInfo *ReplicationTargetSummaryInfo `json:"replicationSnapshotInfo,omitempty"`
	...
	// Specifies the source snapshot information.
	SourceSnapshotInfo *ObjectSourceSnapshotInfo `json:"sourceSnapshotInfo,omitempty"`
...
func (m *ObjectSnapshotsInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateReplicationSnapshotInfo(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateSourceSnapshotInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ObjectSnapshotsInfo) validateReplicationSnapshotInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.ReplicationSnapshotInfo) { // not required
		return nil
	}

	if m.ReplicationSnapshotInfo != nil {
		if err := m.ReplicationSnapshotInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replicationSnapshotInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replicationSnapshotInfo")
			}
			return err
		}
	}
...
func (m *ObjectSnapshotsInfo) validateSourceSnapshotInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.SourceSnapshotInfo) { // not required
		return nil
	}

	if m.SourceSnapshotInfo != nil {
		if err := m.SourceSnapshotInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceSnapshotInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceSnapshotInfo")
			}
			return err
		}
	}
...
func (m *ObjectSnapshotsInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateReplicationSnapshotInfo(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSourceSnapshotInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ObjectSnapshotsInfo) contextValidateReplicationSnapshotInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.ReplicationSnapshotInfo != nil {
		if err := m.ReplicationSnapshotInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("replicationSnapshotInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("replicationSnapshotInfo")
...
func (m *ObjectSnapshotsInfo) contextValidateSourceSnapshotInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.SourceSnapshotInfo != nil {
		if err := m.SourceSnapshotInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceSnapshotInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceSnapshotInfo")
