...
// RecoverOtherNasToIsilonFilesTargetParams Recover To Isilon Files Target Params.
//
// Specifies the params of the Isilon recovery target.
//
// swagger:model RecoverOtherNasToIsilonFilesTargetParams
...
// Validate validates this recover other nas to isilon files target params
func (m *RecoverOtherNasToIsilonFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) validateAlternatePath(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to isilon files target params based on the context it is used
func (m *RecoverOtherNasToIsilonFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToIsilonFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToIsilonFilesTargetParams
