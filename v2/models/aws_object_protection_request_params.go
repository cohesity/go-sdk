...
// AwsObjectProtectionRequestParams AWS Object Protection Request Params.
//
// Specifies the parameters which are specific to AWS related Object Protection.
//
// swagger:model AwsObjectProtectionRequestParams
...
func (m *AwsObjectProtectionRequestParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AwsObjectProtectionRequestParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this aws object protection request params
func (m *AwsObjectProtectionRequestParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsObjectProtectionRequestParams) validateAuroraSnapshotManagerProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) validateDynamoDBProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) validateNativeProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) validateRdsPostgresProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) validateRdsSnapshotManagerProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) validateS3ProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) validateSnapshotManagerProtectionTypeParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws object protection request params based on the context it is used
func (m *AwsObjectProtectionRequestParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsObjectProtectionRequestParams) contextValidateAuroraSnapshotManagerProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) contextValidateDynamoDBProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) contextValidateNativeProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) contextValidateRdsPostgresProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) contextValidateRdsSnapshotManagerProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) contextValidateS3ProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) contextValidateSnapshotManagerProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsObjectProtectionRequestParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsObjectProtectionRequestParams) UnmarshalBinary(b []byte) error {
	var res AwsObjectProtectionRequestParams
