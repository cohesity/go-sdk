...
type ArchivalAzureExternalTargetParams struct {
	...
	// cold blob params
	ColdBlobParams *AzureColdBlobParams `json:"coldBlobParams,omitempty"`
...
func (m *ArchivalAzureExternalTargetParams) UnmarshalJSON(raw []byte) error {
	...
	m.ColdBlobParams = dataAO1.ColdBlobParams
...
func (m ArchivalAzureExternalTargetParams) MarshalJSON() ([]byte, error) {
	...
	dataAO1.ColdBlobParams = m.ColdBlobParams
...
func (m *ArchivalAzureExternalTargetParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateColdBlobParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ArchivalAzureExternalTargetParams) validateColdBlobParams(formats strfmt.Registry) error {

	if swag.IsZero(m.ColdBlobParams) { // not required
		return nil
	}

	if m.ColdBlobParams != nil {
		if err := m.ColdBlobParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("coldBlobParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("coldBlobParams")
			}
			return err
		}
	}
...
func (m *ArchivalAzureExternalTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateColdBlobParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ArchivalAzureExternalTargetParams) contextValidateColdBlobParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ColdBlobParams != nil {
		...
		if err := m.ColdBlobParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("coldBlobParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("coldBlobParams")
