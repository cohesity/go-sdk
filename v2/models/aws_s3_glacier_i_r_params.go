...
func (m *AwsS3GlacierIRParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AwsS3GlacierIRParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this aws s3 glacier i r params
func (m *AwsS3GlacierIRParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsS3GlacierIRParams) validateAwsCloudGovParams(formats strfmt.Registry) error {
...
func (m *AwsS3GlacierIRParams) validateAwsCloudStandardParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws s3 glacier i r params based on the context it is used
func (m *AwsS3GlacierIRParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsS3GlacierIRParams) contextValidateAwsCloudGovParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsS3GlacierIRParams) contextValidateAwsCloudStandardParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsS3GlacierIRParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsS3GlacierIRParams) UnmarshalBinary(b []byte) error {
	var res AwsS3GlacierIRParams
