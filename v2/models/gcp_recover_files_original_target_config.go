...
// GcpRecoverFilesOriginalTargetConfig GCP Recover Files Original Target Config.
//
// Specifies the configuration for recovering files and folders to the original target.
//
// swagger:model GcpRecoverFilesOriginalTargetConfig
...
// Validate validates this gcp recover files original target config
func (m *GcpRecoverFilesOriginalTargetConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GcpRecoverFilesOriginalTargetConfig) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *GcpRecoverFilesOriginalTargetConfig) validateTargetVMCredentials(formats strfmt.Registry) error {
...
// ContextValidate validate this gcp recover files original target config based on the context it is used
func (m *GcpRecoverFilesOriginalTargetConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GcpRecoverFilesOriginalTargetConfig) contextValidateTargetVMCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GcpRecoverFilesOriginalTargetConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GcpRecoverFilesOriginalTargetConfig) UnmarshalBinary(b []byte) error {
	var res GcpRecoverFilesOriginalTargetConfig
