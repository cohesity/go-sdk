...
type HeliosRegConfig struct {
	...
	// Enum: ["Rigel","Cluster","Cohesion","IBMStorageProtect","CloudNativeDataplane"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Rigel","Cluster","Cohesion","IBMStorageProtect","CloudNativeDataplane"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// HeliosRegConfigEntityTypeCloudNativeDataplane captures enum value "CloudNativeDataplane"
	HeliosRegConfigEntityTypeCloudNativeDataplane string = "CloudNativeDataplane"
)
