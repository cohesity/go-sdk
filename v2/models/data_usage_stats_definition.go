...
// DataUsageStatsDefinition Data Usage Statistics.
//
// # Specifies the data usage metric of the data stored on the Cohesity Cluster
//
// swagger:model DataUsageStatsDefinition
type DataUsageStatsDefinition struct {
	...
	DataInBytesPrev *int64 `json:"dataInBytesPrev,omitempty"`

	// Specifies Timestamp of DataInBytesPrev
	DataInBytesPrevTimestampUsec *int64 `json:"dataInBytesPrevTimestampUsec,omitempty"`
	...
	// Specifies the data written after it has been reduced by deduplication and compression at a previous time.
	...
	// Specifies the logical usage as computed by the Cohesity Cluster.
	...
	// Specifies the total capacity, as computed by the Cohesity Cluster, after the size of the data has been reduced by change-block tracking, compression and deduplication at a previous time to compare.
	...
	UniquePhysicalDataBytesTimestampUsec *int64 `json:"uniquePhysicalDataBytesTimestampUsec,omitempty"`
}

// Validate validates this data usage stats definition
func (m *DataUsageStatsDefinition) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this data usage stats definition based on context it is used
func (m *DataUsageStatsDefinition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *DataUsageStatsDefinition) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DataUsageStatsDefinition) UnmarshalBinary(b []byte) error {
	var res DataUsageStatsDefinition
