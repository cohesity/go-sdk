...
type RecoverNasVolumeToViewParams struct {
	...
	// Specifies if the snapshot data should be downloaded to the cluster during recovery. If this is false, then the cluster will download the corresponding data only when files in the view are read.
