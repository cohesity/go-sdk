...
type CompressionParams struct {
	...
	// Specifies whether inline compression is enabled. This field is applicable only if inlineDeduplicationEnabled is set to true and compression is enabled.
	InlineEnabled *bool `json:"inlineEnabled,omitempty"`

	// Specifies compression type for a Storage Domain.
	// Enum: ["None","Low","High"]
