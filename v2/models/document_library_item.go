...
func (m *DocumentLibraryItem) UnmarshalJSON(raw []byte) error {
	...
	m.SubsiteItem = dataAO1.SubsiteItem
...
func (m DocumentLibraryItem) MarshalJSON() ([]byte, error) {
	...
	dataAO1.SubsiteItem = m.SubsiteItem
...
func (m *DocumentLibraryItem) validateSubsiteItem(formats strfmt.Registry) error {
...
func (m *DocumentLibraryItem) contextValidateSubsiteItem(ctx context.Context, formats strfmt.Registry) error {
