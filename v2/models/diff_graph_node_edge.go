...
func (m *DiffGraphNodeEdge) validateBaseRelation(formats strfmt.Registry) error {
	...
	if m.BaseRelation != nil {
		if err := m.BaseRelation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("baseRelation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("baseRelation")
			}
			return err
		}
	}
...
func (m *DiffGraphNodeEdge) validateCurrentRelation(formats strfmt.Registry) error {
	...
	if m.CurrentRelation != nil {
		if err := m.CurrentRelation.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("currentRelation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("currentRelation")
			}
			return err
		}
	}
...
func (m *DiffGraphNodeEdge) contextValidateBaseRelation(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.BaseRelation != nil {
		if err := m.BaseRelation.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("baseRelation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("baseRelation")
...
func (m *DiffGraphNodeEdge) contextValidateCurrentRelation(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.CurrentRelation != nil {
		if err := m.CurrentRelation.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("currentRelation")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("currentRelation")
