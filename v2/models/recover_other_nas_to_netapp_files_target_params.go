...
// RecoverOtherNasToNetappFilesTargetParams Recover To Netapp Files Target Params.
//
// Specifies the params of the Netapp recovery target.
//
// swagger:model RecoverOtherNasToNetappFilesTargetParams
...
// Validate validates this recover other nas to netapp files target params
func (m *RecoverOtherNasToNetappFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToNetappFilesTargetParams) validateAlternatePath(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to netapp files target params based on the context it is used
func (m *RecoverOtherNasToNetappFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToNetappFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToNetappFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToNetappFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToNetappFilesTargetParams
