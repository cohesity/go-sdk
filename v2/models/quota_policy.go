...
func (m *QuotaPolicy) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAlertLimitBytes(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateAlertThresholdPercentage(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateHardLimitBytes(formats); err != nil {
		res = append(res, err)
	}
...
func (m *QuotaPolicy) validateAlertLimitBytes(formats strfmt.Registry) error {
	if swag.IsZero(m.AlertLimitBytes) { // not required
		return nil
	}

	if err := validate.MinimumInt("alertLimitBytes", "body", *m.AlertLimitBytes, 0, false); err != nil {
		return err
	}
...
func (m *QuotaPolicy) validateAlertThresholdPercentage(formats strfmt.Registry) error {
	if swag.IsZero(m.AlertThresholdPercentage) { // not required
		return nil
	}

	if err := validate.MinimumInt("alertThresholdPercentage", "body", *m.AlertThresholdPercentage, 0, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("alertThresholdPercentage", "body", *m.AlertThresholdPercentage, 100, false); err != nil {
		return err
	}
...
func (m *QuotaPolicy) validateHardLimitBytes(formats strfmt.Registry) error {
	if swag.IsZero(m.HardLimitBytes) { // not required
		return nil
	}

	if err := validate.MinimumInt("hardLimitBytes", "body", *m.HardLimitBytes, 0, false); err != nil {
		return err
	}
