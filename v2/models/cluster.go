...
type Cluster struct {
	...
	AuthorizedSSHPublicKeys []string `json:"authorizedSshPublicKeys"`
...
const (
	...
	// ClusterSoftwareTypeKNetBackup captures enum value "kNetBackup"
	ClusterSoftwareTypeKNetBackup string = "kNetBackup"
)
...
func (m *Cluster) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateFipsCertVersion(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Cluster) contextValidateFipsCertVersion(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "fipsCertVersion", "body", string(m.FipsCertVersion)); err != nil {
		return err
	}
