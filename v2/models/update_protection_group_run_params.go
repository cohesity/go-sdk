...
type UpdateProtectionGroupRunParams struct {
	...
	// Specifies the params to perform actions on source snapshot taken by this Protection Group Run.
	SourceSnapshotConfig *UpdateSourceSnapshotConfig `json:"sourceSnapshotConfig,omitempty"`
}
...
func (m *UpdateProtectionGroupRunParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSourceSnapshotConfig(formats); err != nil {
		res = append(res, err)
	}
...
func (m *UpdateProtectionGroupRunParams) validateSourceSnapshotConfig(formats strfmt.Registry) error {
	if swag.IsZero(m.SourceSnapshotConfig) { // not required
		return nil
	}

	if m.SourceSnapshotConfig != nil {
		if err := m.SourceSnapshotConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceSnapshotConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceSnapshotConfig")
			}
			return err
		}
	}
...
func (m *UpdateProtectionGroupRunParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSourceSnapshotConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *UpdateProtectionGroupRunParams) contextValidateSourceSnapshotConfig(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.SourceSnapshotConfig != nil {
		...
		if err := m.SourceSnapshotConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceSnapshotConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceSnapshotConfig")
