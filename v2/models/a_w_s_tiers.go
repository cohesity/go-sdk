...
// Validate validates this a w s tiers
func (m *AWSTiers) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AWSTiers) validateTiers(formats strfmt.Registry) error {
...
// ContextValidate validate this a w s tiers based on the context it is used
func (m *AWSTiers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AWSTiers) contextValidateTiers(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AWSTiers) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AWSTiers) UnmarshalBinary(b []byte) error {
	var res AWSTiers
