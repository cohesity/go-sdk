...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kScsi","kIde","kSata","kNvme"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// DiskInfoControllerTypeKNvme captures enum value "kNvme"
	DiskInfoControllerTypeKNvme string = "kNvme"
)
