...
// OriginalNetappTargetParams Recover To Original Netapp Volume Target Params.
//
// Specifies the params of the original Netapp recovery target.
//
// swagger:model OriginalNetappTargetParams
...
// Validate validates this original netapp target params
func (m *OriginalNetappTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalNetappTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalNetappTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original netapp target params based on the context it is used
func (m *OriginalNetappTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalNetappTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalNetappTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalNetappTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalNetappTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalNetappTargetParams
