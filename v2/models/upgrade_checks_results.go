...
type UpgradeChecksResults struct {
	...
	NodeResults []*UpgradeCheckNodeResult `json:"nodeResults"`
	...
	// Required: true
	TestRunInstanceID string `json:"testRunInstanceId"`
}
...
func (m *UpgradeChecksResults) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTestRunInstanceID(formats); err != nil {
		res = append(res, err)
	}
...
func (m *UpgradeChecksResults) validateError(formats strfmt.Registry) error {
...
func (m *UpgradeChecksResults) validateRequestType(formats strfmt.Registry) error {

	if err := validate.RequiredString("requestType", "body", m.RequestType); err != nil {
		return err
	}
...
func (m *UpgradeChecksResults) validateResultStatus(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("resultStatus", "body", m.ResultStatus); err != nil {
		return err
	}
...
func (m *UpgradeChecksResults) validateTestRunInstanceID(formats strfmt.Registry) error {

	if err := validate.RequiredString("testRunInstanceId", "body", m.TestRunInstanceID); err != nil {
		return err
	}
