...
type OracleRestoreMetaInfoResult struct {
	...
	// Specifies source RAC information used for RAC-to-RAC alternate restore workflow. This is used to prevent upscaling of target RAC and also for mapping source to target instances during pfile generation.
	SourceRacInfo *SourceRacInfo `json:"sourceRacInfo,omitempty"`
}
...
func (m *OracleRestoreMetaInfoResult) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSourceRacInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *OracleRestoreMetaInfoResult) validateSourceRacInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.SourceRacInfo) { // not required
		return nil
	}

	if m.SourceRacInfo != nil {
		if err := m.SourceRacInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceRacInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceRacInfo")
			}
			return err
		}
	}
...
func (m *OracleRestoreMetaInfoResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSourceRacInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *OracleRestoreMetaInfoResult) contextValidateSourceRacInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.SourceRacInfo != nil {
		if err := m.SourceRacInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceRacInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceRacInfo")
