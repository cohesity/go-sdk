...
// OriginalGpfsFilesTargetParams Recover To Original GPFS Files Target Params.
//
// Specifies the params of the original GPFS recovery target.
//
// swagger:model OriginalGpfsFilesTargetParams
...
// Validate validates this original gpfs files target params
func (m *OriginalGpfsFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalGpfsFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalGpfsFilesTargetParams) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *OriginalGpfsFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original gpfs files target params based on the context it is used
func (m *OriginalGpfsFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalGpfsFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalGpfsFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalGpfsFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalGpfsFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalGpfsFilesTargetParams
