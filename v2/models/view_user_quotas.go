...
type ViewUserQuotas struct {
	...
	// Specifies quota and usage in all views.
	QuotaAndUsageInAllViews []*QuotaAndUsageInAllViews `json:"quotaAndUsageInAllViews"`

	// Specifies summary for views in a user quota.
...
func (m *ViewUserQuotas) UnmarshalJSON(raw []byte) error {
	...
	m.QuotaAndUsageInAllViews = dataAO2.QuotaAndUsageInAllViews

	m.SummaryForUser = dataAO2.SummaryForUser
...
func (m ViewUserQuotas) MarshalJSON() ([]byte, error) {
	...
	dataAO2.QuotaAndUsageInAllViews = m.QuotaAndUsageInAllViews

	dataAO2.SummaryForUser = m.SummaryForUser
