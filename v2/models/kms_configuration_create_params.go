...
type KmsConfigurationCreateParams struct {
	...
	GcpKmsParams *GcpKmsConfiguration `json:"gcpKmsParams,omitempty"`
...
func (m *KmsConfigurationCreateParams) UnmarshalJSON(raw []byte) error {
	...
	m.GcpKmsParams = dataAO0.GcpKmsParams
...
func (m KmsConfigurationCreateParams) MarshalJSON() ([]byte, error) {
	...
	dataAO0.GcpKmsParams = m.GcpKmsParams
...
func (m *KmsConfigurationCreateParams) validateGcpKmsParams(formats strfmt.Registry) error {
...
func (m *KmsConfigurationCreateParams) contextValidateGcpKmsParams(ctx context.Context, formats strfmt.Registry) error {
