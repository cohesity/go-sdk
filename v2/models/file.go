...
type File struct {
	...
	// Specifies hash value for this file.
	Hash *string `json:"hash,omitempty"`

	// Specifies modification time for this file in usecs.
...
func (m *File) UnmarshalJSON(raw []byte) error {
	...
	m.ModifiedTimeUsecs = dataAO0.ModifiedTimeUsecs
...
func (m File) MarshalJSON() ([]byte, error) {
	...
	dataAO0.ModifiedTimeUsecs = m.ModifiedTimeUsecs
