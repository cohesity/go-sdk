...
// OriginalFlashbladeTargetParams Recover To Original Flashblade Volume Target Params.
//
// Specifies the params of the original Flashblade recovery target.
//
// swagger:model OriginalFlashbladeTargetParams
...
// Validate validates this original flashblade target params
func (m *OriginalFlashbladeTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalFlashbladeTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original flashblade target params based on the context it is used
func (m *OriginalFlashbladeTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalFlashbladeTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalFlashbladeTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalFlashbladeTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalFlashbladeTargetParams
