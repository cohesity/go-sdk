...
type CommonProtectionGroupRunResponseParameters struct {
	...
	// Summary information about all replication runs for this backup run. replicationInfo provides information about the latest replication run for this backup run. whereas this field provides information about all historical replication runs for this backup run.
	ReplicationRuns []*ReplicationRunSummary `json:"replicationRuns"`

	// Specifies if this protection run was initiated by a user in out of band manner.
...
const (
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	CommonProtectionGroupRunResponseParametersEnvironmentKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSMySQL captures enum value "kAWSMySQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSMySQL string = "kAWSMySQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSAuroraMySQL string = "kAWSAuroraMySQL"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSDocumentDB captures enum value "kAWSDocumentDB"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSDocumentDB string = "kAWSDocumentDB"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSRdsOracle captures enum value "kAWSRdsOracle"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSRdsOracle string = "kAWSRdsOracle"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAWSRedshift captures enum value "kAWSRedshift"
	CommonProtectionGroupRunResponseParametersEnvironmentKAWSRedshift string = "kAWSRedshift"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureMySQL captures enum value "kAzureMySQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureMySQL string = "kAzureMySQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureBlobStorage captures enum value "kAzureBlobStorage"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureBlobStorage string = "kAzureBlobStorage"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureSQLDB captures enum value "kAzureSQLDB"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureSQLDB string = "kAzureSQLDB"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureSQLMI captures enum value "kAzureSQLMI"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureSQLMI string = "kAzureSQLMI"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureTableStorage captures enum value "kAzureTableStorage"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureTableStorage string = "kAzureTableStorage"

	// CommonProtectionGroupRunResponseParametersEnvironmentKAzureTableAPI captures enum value "kAzureTableAPI"
	CommonProtectionGroupRunResponseParametersEnvironmentKAzureTableAPI string = "kAzureTableAPI"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPBigQuery captures enum value "kGCPBigQuery"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPBigQuery string = "kGCPBigQuery"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPFirestore captures enum value "kGCPFirestore"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPFirestore string = "kGCPFirestore"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPMySQL captures enum value "kGCPMySQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPMySQL string = "kGCPMySQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPSQLServer captures enum value "kGCPSQLServer"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPSQLServer string = "kGCPSQLServer"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPPostgreSQL string = "kGCPPostgreSQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGoogleSpanner captures enum value "kGoogleSpanner"
	CommonProtectionGroupRunResponseParametersEnvironmentKGoogleSpanner string = "kGoogleSpanner"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGCPBigtable captures enum value "kGCPBigtable"
	CommonProtectionGroupRunResponseParametersEnvironmentKGCPBigtable string = "kGCPBigtable"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKS3Compatible captures enum value "kS3Compatible"
	CommonProtectionGroupRunResponseParametersEnvironmentKS3Compatible string = "kS3Compatible"
	...
	// CommonProtectionGroupRunResponseParametersEnvironmentKGoogleWorkspace captures enum value "kGoogleWorkspace"
	CommonProtectionGroupRunResponseParametersEnvironmentKGoogleWorkspace string = "kGoogleWorkspace"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGmail captures enum value "kGmail"
	CommonProtectionGroupRunResponseParametersEnvironmentKGmail string = "kGmail"

	// CommonProtectionGroupRunResponseParametersEnvironmentKGoogleDrive captures enum value "kGoogleDrive"
	CommonProtectionGroupRunResponseParametersEnvironmentKGoogleDrive string = "kGoogleDrive"

	// CommonProtectionGroupRunResponseParametersEnvironmentKDB2 captures enum value "kDB2"
	CommonProtectionGroupRunResponseParametersEnvironmentKDB2 string = "kDB2"

	// CommonProtectionGroupRunResponseParametersEnvironmentKEwsExchange captures enum value "kEwsExchange"
	CommonProtectionGroupRunResponseParametersEnvironmentKEwsExchange string = "kEwsExchange"

	// CommonProtectionGroupRunResponseParametersEnvironmentKServiceNow captures enum value "kServiceNow"
	CommonProtectionGroupRunResponseParametersEnvironmentKServiceNow string = "kServiceNow"

	// CommonProtectionGroupRunResponseParametersEnvironmentKSalesforce captures enum value "kSalesforce"
	CommonProtectionGroupRunResponseParametersEnvironmentKSalesforce string = "kSalesforce"

	// CommonProtectionGroupRunResponseParametersEnvironmentKPostgres captures enum value "kPostgres"
	CommonProtectionGroupRunResponseParametersEnvironmentKPostgres string = "kPostgres"

	// CommonProtectionGroupRunResponseParametersEnvironmentKNutanixFS captures enum value "kNutanixFS"
	CommonProtectionGroupRunResponseParametersEnvironmentKNutanixFS string = "kNutanixFS"

	// CommonProtectionGroupRunResponseParametersEnvironmentKJira captures enum value "kJira"
	CommonProtectionGroupRunResponseParametersEnvironmentKJira string = "kJira"

	// CommonProtectionGroupRunResponseParametersEnvironmentKPinecone captures enum value "kPinecone"
	CommonProtectionGroupRunResponseParametersEnvironmentKPinecone string = "kPinecone"
)
...
func (m *CommonProtectionGroupRunResponseParameters) validateReplicationRuns(formats strfmt.Registry) error {
...
func (m *CommonProtectionGroupRunResponseParameters) contextValidateReplicationRuns(ctx context.Context, formats strfmt.Registry) error {
