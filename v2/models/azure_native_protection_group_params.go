...
func (m *AzureNativeProtectionGroupParams) validateDiskExclusionParams(formats strfmt.Registry) error {
...
func (m *AzureNativeProtectionGroupParams) contextValidateDiskExclusionParams(ctx context.Context, formats strfmt.Registry) error {
