...
// OriginalElastifileTargetParams Recover To Original Elastifile Volume Target Params.
//
// Specifies the params of the original Elastifile recovery target.
//
// swagger:model OriginalElastifileTargetParams
...
// Validate validates this original elastifile target params
func (m *OriginalElastifileTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalElastifileTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalElastifileTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original elastifile target params based on the context it is used
func (m *OriginalElastifileTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalElastifileTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalElastifileTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalElastifileTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalElastifileTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalElastifileTargetParams
