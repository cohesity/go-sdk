...
// OriginalNutanixFSFilesTargetParams Recover To Original NutanixFS Files Target Params.
//
// Specifies the params of the original NutanixFS recovery target.
//
// swagger:model OriginalNutanixFSFilesTargetParams
type OriginalNutanixFSFilesTargetParams struct {
...
// Validate validates this original nutanix f s files target params
func (m *OriginalNutanixFSFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalNutanixFSFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSFilesTargetParams) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original nutanix f s files target params based on the context it is used
func (m *OriginalNutanixFSFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalNutanixFSFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalNutanixFSFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalNutanixFSFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalNutanixFSFilesTargetParams
