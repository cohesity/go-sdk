...
type SnapshotDiffParams struct {
	...
	// entity type
	// Required: true
	// Enum: ["kVMware","kPhysical","kView","kHyperV","kNetapp","kPure","kIsilon","kAzure","kAWS","kAzureNative"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kVMware","kPhysical","kView","kHyperV","kNetapp","kPure","kIsilon","kAzure","kAWS","kAzureNative"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// SnapshotDiffParamsEntityTypeKAzure captures enum value "kAzure"
	SnapshotDiffParamsEntityTypeKAzure string = "kAzure"

	// SnapshotDiffParamsEntityTypeKAWS captures enum value "kAWS"
	SnapshotDiffParamsEntityTypeKAWS string = "kAWS"

	// SnapshotDiffParamsEntityTypeKAzureNative captures enum value "kAzureNative"
	SnapshotDiffParamsEntityTypeKAzureNative string = "kAzureNative"
)
