...
type ViewProtection struct {
	...
	ProtectionGroups []*ProtectionGroupInfo `json:"protectionGroups"`
}
...
func (m *ViewProtection) validateProtectionGroups(formats strfmt.Registry) error {
...
func (m *ViewProtection) contextValidateProtectionGroups(ctx context.Context, formats strfmt.Registry) error {
