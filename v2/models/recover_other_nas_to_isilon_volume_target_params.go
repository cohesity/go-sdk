...
// RecoverOtherNasToIsilonVolumeTargetParams Recover To Isilon Volume Target Params.
//
// Specifies the params of the Isilon recovery target.
//
// swagger:model RecoverOtherNasToIsilonVolumeTargetParams
...
// Validate validates this recover other nas to isilon volume target params
func (m *RecoverOtherNasToIsilonVolumeTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to isilon volume target params based on the context it is used
func (m *RecoverOtherNasToIsilonVolumeTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToIsilonVolumeTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToIsilonVolumeTargetParams
