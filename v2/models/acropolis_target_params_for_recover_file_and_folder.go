...
// AcropolisTargetParamsForRecoverFileAndFolder Acropolis Target Params for Recover Files
//
// Specifies the parameters for an Acropolis files and folders recovery target.
//
// swagger:model AcropolisTargetParamsForRecoverFileAndFolder
type AcropolisTargetParamsForRecoverFileAndFolder struct {
	...
	NewTargetConfig *AcropolisRecoverFilesNewTargetConfig `json:"newTargetConfig,omitempty"`

	// Specifies the configuration for recovering to the original target.
	OriginalTargetConfig *AcropolisRecoverFilesOriginalTargetConfig `json:"originalTargetConfig,omitempty"`
...
// Validate validates this acropolis target params for recover file and folder
func (m *AcropolisTargetParamsForRecoverFileAndFolder) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) validateNewTargetConfig(formats strfmt.Registry) error {
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) validateOriginalTargetConfig(formats strfmt.Registry) error {
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) validateRecoverToOriginalTarget(formats strfmt.Registry) error {
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this acropolis target params for recover file and folder based on the context it is used
func (m *AcropolisTargetParamsForRecoverFileAndFolder) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) contextValidateNewTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) contextValidateOriginalTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AcropolisTargetParamsForRecoverFileAndFolder) UnmarshalBinary(b []byte) error {
	var res AcropolisTargetParamsForRecoverFileAndFolder
