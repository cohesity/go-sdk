...
// RecoverOtherNasToGpfsVolumeTargetParams Recover To GPFS Nas Volume Target Params.
//
// Specifies the params of the GPFS recovery target.
//
// swagger:model RecoverOtherNasToGpfsVolumeTargetParams
...
// Validate validates this recover other nas to gpfs volume target params
func (m *RecoverOtherNasToGpfsVolumeTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to gpfs volume target params based on the context it is used
func (m *RecoverOtherNasToGpfsVolumeTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToGpfsVolumeTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToGpfsVolumeTargetParams
