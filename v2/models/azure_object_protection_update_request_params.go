...
// AzureObjectProtectionUpdateRequestParams Azure Object Protection Update Request Params.
//
// Specifies the parameters which are specific to Azure related Object Protection update request.
//
// swagger:model AzureObjectProtectionUpdateRequestParams
type AzureObjectProtectionUpdateRequestParams struct {
	...
	// Specifies the parameters which are specific to Azure related Protection using Azure native snapshot APIs.
	NativeProtectionTypeParams *AzureNativeObjectProtectionParams `json:"nativeProtectionTypeParams,omitempty"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *AzureObjectProtectionUpdateRequestParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AzureObjectProtectionUpdateRequestParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this azure object protection update request params
func (m *AzureObjectProtectionUpdateRequestParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureObjectProtectionUpdateRequestParams) validateAzureEntraIDProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AzureObjectProtectionUpdateRequestParams) validateAzureSQLProtectionTypeParams(formats strfmt.Registry) error {
...
func (m *AzureObjectProtectionUpdateRequestParams) validateNativeProtectionTypeParams(formats strfmt.Registry) error {
...
// ContextValidate validate this azure object protection update request params based on the context it is used
func (m *AzureObjectProtectionUpdateRequestParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureObjectProtectionUpdateRequestParams) contextValidateAzureEntraIDProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureObjectProtectionUpdateRequestParams) contextValidateAzureSQLProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureObjectProtectionUpdateRequestParams) contextValidateNativeProtectionTypeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureObjectProtectionUpdateRequestParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AzureObjectProtectionUpdateRequestParams) UnmarshalBinary(b []byte) error {
	var res AzureObjectProtectionUpdateRequestParams
