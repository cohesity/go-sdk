...
// OriginalViewFilesTargetParams Recover To Original View Files Target Params.
//
// Specifies the params of the original View recovery target.
//
// swagger:model OriginalViewFilesTargetParams
...
// Validate validates this original view files target params
func (m *OriginalViewFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalViewFilesTargetParams) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *OriginalViewFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original view files target params based on the context it is used
func (m *OriginalViewFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalViewFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalViewFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalViewFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalViewFilesTargetParams
