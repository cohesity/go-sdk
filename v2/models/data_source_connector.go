...
type DataSourceConnector struct {
	...
	// Read Only: true
	// Enum: ["kRigelVE","kRigelAWS","kRigelHyperv","kRigelAzure","kIBMRigelVE","kIBMRigelVSI","kRigelContainer","kRigelSPVE","kRigelSPHyperv"]
...
var dataSourceConnectorTypeConnectorTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kRigelVE","kRigelAWS","kRigelHyperv","kRigelAzure","kIBMRigelVE","kIBMRigelVSI","kRigelContainer","kRigelSPVE","kRigelSPHyperv"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		dataSourceConnectorTypeConnectorTypePropEnum = append(dataSourceConnectorTypeConnectorTypePropEnum, v)
	}
}

const (

	// DataSourceConnectorConnectorTypeKRigelVE captures enum value "kRigelVE"
	DataSourceConnectorConnectorTypeKRigelVE string = "kRigelVE"

	// DataSourceConnectorConnectorTypeKRigelAWS captures enum value "kRigelAWS"
	DataSourceConnectorConnectorTypeKRigelAWS string = "kRigelAWS"

	// DataSourceConnectorConnectorTypeKRigelHyperv captures enum value "kRigelHyperv"
	DataSourceConnectorConnectorTypeKRigelHyperv string = "kRigelHyperv"

	// DataSourceConnectorConnectorTypeKRigelAzure captures enum value "kRigelAzure"
	DataSourceConnectorConnectorTypeKRigelAzure string = "kRigelAzure"

	// DataSourceConnectorConnectorTypeKIBMRigelVE captures enum value "kIBMRigelVE"
	DataSourceConnectorConnectorTypeKIBMRigelVE string = "kIBMRigelVE"

	// DataSourceConnectorConnectorTypeKIBMRigelVSI captures enum value "kIBMRigelVSI"
	DataSourceConnectorConnectorTypeKIBMRigelVSI string = "kIBMRigelVSI"

	// DataSourceConnectorConnectorTypeKRigelContainer captures enum value "kRigelContainer"
	DataSourceConnectorConnectorTypeKRigelContainer string = "kRigelContainer"

	// DataSourceConnectorConnectorTypeKRigelSPVE captures enum value "kRigelSPVE"
	DataSourceConnectorConnectorTypeKRigelSPVE string = "kRigelSPVE"

	// DataSourceConnectorConnectorTypeKRigelSPHyperv captures enum value "kRigelSPHyperv"
	DataSourceConnectorConnectorTypeKRigelSPHyperv string = "kRigelSPHyperv"
)

// prop value enum
func (m *DataSourceConnector) validateConnectorTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, dataSourceConnectorTypeConnectorTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DataSourceConnector) validateConnectorType(formats strfmt.Registry) error {
...
func (m *DataSourceConnector) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidatePatchSoftwareVersion(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DataSourceConnector) contextValidateConnectorType(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "connectorType", "body", m.ConnectorType); err != nil {
		return err
	}
...
func (m *DataSourceConnector) contextValidatePatchSoftwareVersion(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "patchSoftwareVersion", "body", m.PatchSoftwareVersion); err != nil {
		return err
	}
