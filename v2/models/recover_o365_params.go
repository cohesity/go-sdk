...
type RecoverO365Params struct {
	...
	// Required: true
	// Enum: ["RecoverMailbox","RecoverOneDrive","RecoverSharePoint","RecoverPublicFolders","RecoverMsGroup","RecoverMsTeam","ConvertToPst","DownloadChats","RecoverMailboxCSM","RecoverOneDriveCSM","RecoverSharePointCSM","RecoverO365ToExchangeServer"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["RecoverMailbox","RecoverOneDrive","RecoverSharePoint","RecoverPublicFolders","RecoverMsGroup","RecoverMsTeam","ConvertToPst","DownloadChats","RecoverMailboxCSM","RecoverOneDriveCSM","RecoverSharePointCSM","RecoverO365ToExchangeServer"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// RecoverO365ParamsRecoveryActionRecoverO365ToExchangeServer captures enum value "RecoverO365ToExchangeServer"
	RecoverO365ParamsRecoveryActionRecoverO365ToExchangeServer string = "RecoverO365ToExchangeServer"
)
