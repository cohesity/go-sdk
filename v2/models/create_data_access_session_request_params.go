...
type CreateDataAccessSessionRequestParams struct {
	...
	BaseSnapshotInfo *DataAccessSnapshotInfo `json:"baseSnapshotInfo,omitempty"`
...
func (m *CreateDataAccessSessionRequestParams) validateCurrentSnapshotInfo(formats strfmt.Registry) error {
	...
	if err := validate.Required("currentSnapshotInfo", "body", m.CurrentSnapshotInfo); err != nil {
		return err
	}
