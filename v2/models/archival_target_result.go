...
type ArchivalTargetResult struct {
	...
	// Specifies the count of app objects for which backup was skipped.
	SkippedAppObjectsCount *int32 `json:"skippedAppObjectsCount,omitempty"`
	...
	// Specifies the warning messages for the archival run.
...
func (m *ArchivalTargetResult) UnmarshalJSON(raw []byte) error {
	...
	m.SkippedAppObjectsCount = dataAO1.SkippedAppObjectsCount
...
func (m ArchivalTargetResult) MarshalJSON() ([]byte, error) {
	...
	dataAO1.SkippedAppObjectsCount = m.SkippedAppObjectsCount
