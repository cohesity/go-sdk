...
// RecoverVmwareVMVCenterSourceConfig Recover VMware VMs vCenter Source Config.
//
// Specifies the new destination Source configuration where the VMs will be recovered for vCenter sources.
//
// swagger:model RecoverVmwareVmVCenterSourceConfig
...
// Validate validates this recover vmware Vm v center source config
func (m *RecoverVmwareVMVCenterSourceConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverVmwareVMVCenterSourceConfig) validateDatastores(formats strfmt.Registry) error {

	if err := validate.Required("datastores", "body", m.Datastores); err != nil {
		return err
	}
...
func (m *RecoverVmwareVMVCenterSourceConfig) validateNetworkConfig(formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) validateResourcePool(formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) validateSource(formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) validateVMFolder(formats strfmt.Registry) error {
...
// ContextValidate validate this recover vmware Vm v center source config based on the context it is used
func (m *RecoverVmwareVMVCenterSourceConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverVmwareVMVCenterSourceConfig) contextValidateDatastores(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) contextValidateNetworkConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) contextValidateResourcePool(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) contextValidateSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) contextValidateVMFolder(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverVmwareVMVCenterSourceConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverVmwareVMVCenterSourceConfig) UnmarshalBinary(b []byte) error {
	var res RecoverVmwareVMVCenterSourceConfig
