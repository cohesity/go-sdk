...
type FetchDirectoriesParams struct {
	...
	// Enum: [kVMware kHyperV kSQL kView kRemoteAdapter kPhysical kPhysicalFiles kPure kIbmFlashSystem kAzure kNetapp kNutanixFS kGenericNas kAcropolis kIsilon kGPFS kKVM kAWS kExchange kOracle kGCP kFlashBlade kO365 kHyperFlex kKubernetes kElastifile kS3Compatible kSAPHANA kUDA kSfdc kExperimentalAdapter kMongoDBPhysical kGoogleWorkspace kDB2 kServiceNow kSalesforce kPostgres kJira]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kVMware","kHyperV","kSQL","kView","kRemoteAdapter","kPhysical","kPhysicalFiles","kPure","kIbmFlashSystem","kAzure","kNetapp","kNutanixFS","kGenericNas","kAcropolis","kIsilon","kGPFS","kKVM","kAWS","kExchange","kOracle","kGCP","kFlashBlade","kO365","kHyperFlex","kKubernetes","kElastifile","kS3Compatible","kSAPHANA","kUDA","kSfdc","kExperimentalAdapter","kMongoDBPhysical","kGoogleWorkspace","kDB2","kServiceNow","kSalesforce","kPostgres","kJira"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
