...
type FetchDirectoriesParams struct {
	...
	// Enum: ["kVMware","kHyperV","kSQL","kView","kRemoteAdapter","kPhysical","kPhysicalFiles","kPure","kIbmFlashSystem","kAzure","kNetapp","kNutanixFS","kGenericNas","kAcropolis","kIsilon","kGPFS","kKVM","kAWS","kExchange","kOracle","kGCP","kFlashBlade","kO365","kHyperFlex","kKubernetes","kElastifile","kS3Compatible","kSAPHANA","kUDA","kSfdc","kExperimentalAdapter","kMongoDBPhysical","kGoogleWorkspace","kDB2","kServiceNow","kSalesforce","kPostgres","kJira","kPinecone"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kVMware","kHyperV","kSQL","kView","kRemoteAdapter","kPhysical","kPhysicalFiles","kPure","kIbmFlashSystem","kAzure","kNetapp","kNutanixFS","kGenericNas","kAcropolis","kIsilon","kGPFS","kKVM","kAWS","kExchange","kOracle","kGCP","kFlashBlade","kO365","kHyperFlex","kKubernetes","kElastifile","kS3Compatible","kSAPHANA","kUDA","kSfdc","kExperimentalAdapter","kMongoDBPhysical","kGoogleWorkspace","kDB2","kServiceNow","kSalesforce","kPostgres","kJira","kPinecone"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// FetchDirectoriesParamsEnvironmentKNutanixFS captures enum value "kNutanixFS"
	FetchDirectoriesParamsEnvironmentKNutanixFS string = "kNutanixFS"
	...
	// FetchDirectoriesParamsEnvironmentKS3Compatible captures enum value "kS3Compatible"
	FetchDirectoriesParamsEnvironmentKS3Compatible string = "kS3Compatible"
	...
	// FetchDirectoriesParamsEnvironmentKGoogleWorkspace captures enum value "kGoogleWorkspace"
	FetchDirectoriesParamsEnvironmentKGoogleWorkspace string = "kGoogleWorkspace"

	// FetchDirectoriesParamsEnvironmentKDB2 captures enum value "kDB2"
	FetchDirectoriesParamsEnvironmentKDB2 string = "kDB2"

	// FetchDirectoriesParamsEnvironmentKServiceNow captures enum value "kServiceNow"
	FetchDirectoriesParamsEnvironmentKServiceNow string = "kServiceNow"

	// FetchDirectoriesParamsEnvironmentKSalesforce captures enum value "kSalesforce"
	FetchDirectoriesParamsEnvironmentKSalesforce string = "kSalesforce"

	// FetchDirectoriesParamsEnvironmentKPostgres captures enum value "kPostgres"
	FetchDirectoriesParamsEnvironmentKPostgres string = "kPostgres"

	// FetchDirectoriesParamsEnvironmentKJira captures enum value "kJira"
	FetchDirectoriesParamsEnvironmentKJira string = "kJira"

	// FetchDirectoriesParamsEnvironmentKPinecone captures enum value "kPinecone"
	FetchDirectoriesParamsEnvironmentKPinecone string = "kPinecone"
)
