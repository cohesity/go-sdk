...
type CommonVmwareObjectParams struct {
	...
	// Specifies a list of disks to be protected. This is only applicable to VM objects.
	IncludeDisks []*DiskInfo `json:"includeDisks"`
...
func (m *CommonVmwareObjectParams) validateIncludeDisks(formats strfmt.Registry) error {
...
func (m *CommonVmwareObjectParams) contextValidateIncludeDisks(ctx context.Context, formats strfmt.Registry) error {
