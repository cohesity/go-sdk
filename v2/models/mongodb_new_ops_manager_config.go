...
type MongodbNewOpsManagerConfig struct {
	...
	// Specifies the name of the target source.
	// Read Only: true
...
// ContextValidate validate this mongodb new ops manager config based on the context it is used
...
func (m *MongodbNewOpsManagerConfig) contextValidateSourceName(ctx context.Context, formats strfmt.Registry) error {
