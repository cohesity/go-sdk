...
const (
	...
	// CommonProtectionGroupResponseParamsEnvironmentKPinecone captures enum value "kPinecone"
	CommonProtectionGroupResponseParamsEnvironmentKPinecone string = "kPinecone"
)
