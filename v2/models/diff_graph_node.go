...
func (m *DiffGraphNode) validateBaseGraphNode(formats strfmt.Registry) error {
	...
	if m.BaseGraphNode != nil {
		if err := m.BaseGraphNode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("baseGraphNode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("baseGraphNode")
			}
			return err
		}
	}
...
func (m *DiffGraphNode) validateCurrentGraphNode(formats strfmt.Registry) error {
	...
	if m.CurrentGraphNode != nil {
		if err := m.CurrentGraphNode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("currentGraphNode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("currentGraphNode")
			}
			return err
		}
	}
...
func (m *DiffGraphNode) contextValidateBaseGraphNode(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.BaseGraphNode != nil {
		...
		if err := m.BaseGraphNode.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("baseGraphNode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("baseGraphNode")
...
func (m *DiffGraphNode) contextValidateCurrentGraphNode(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.CurrentGraphNode != nil {
		...
		if err := m.CurrentGraphNode.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("currentGraphNode")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("currentGraphNode")
