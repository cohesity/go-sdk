...
type TargetsConfiguration struct {
	...
	CrossRegionTargets []*HeliosCrossRegionConfig `json:"crossRegionTargets"`

	// onprem deploy targets
	OnpremDeployTargets []*OnpremDeployConfig `json:"onpremDeployTargets"`

	// onprem vault targets
	OnpremVaultTargets []*OnpremVaultConfig `json:"onpremVaultTargets"`
	...
	// source targets
	SourceTargets *SourceConfig `json:"sourceTargets,omitempty"`
}
...
func (m *TargetsConfiguration) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateCrossRegionTargets(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateOnpremVaultTargets(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateSourceTargets(formats); err != nil {
		res = append(res, err)
	}
...
func (m *TargetsConfiguration) validateCrossRegionTargets(formats strfmt.Registry) error {
	if swag.IsZero(m.CrossRegionTargets) { // not required
		return nil
	}

	for i := 0; i < len(m.CrossRegionTargets); i++ {
		if swag.IsZero(m.CrossRegionTargets[i]) { // not required
			continue
		}

		if m.CrossRegionTargets[i] != nil {
			if err := m.CrossRegionTargets[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("crossRegionTargets" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("crossRegionTargets" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *TargetsConfiguration) validateOnpremVaultTargets(formats strfmt.Registry) error {
	if swag.IsZero(m.OnpremVaultTargets) { // not required
		return nil
	}

	for i := 0; i < len(m.OnpremVaultTargets); i++ {
		if swag.IsZero(m.OnpremVaultTargets[i]) { // not required
			continue
		}

		if m.OnpremVaultTargets[i] != nil {
			if err := m.OnpremVaultTargets[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("onpremVaultTargets" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("onpremVaultTargets" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *TargetsConfiguration) validateSourceTargets(formats strfmt.Registry) error {
	if swag.IsZero(m.SourceTargets) { // not required
		return nil
	}

	if m.SourceTargets != nil {
		if err := m.SourceTargets.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceTargets")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceTargets")
			}
			return err
		}
	}
...
func (m *TargetsConfiguration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateCrossRegionTargets(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateOnpremVaultTargets(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateSourceTargets(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *TargetsConfiguration) contextValidateCrossRegionTargets(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.CrossRegionTargets); i++ {

		if m.CrossRegionTargets[i] != nil {
			if err := m.CrossRegionTargets[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("crossRegionTargets" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("crossRegionTargets" + "." + strconv.Itoa(i))
...
func (m *TargetsConfiguration) contextValidateOnpremVaultTargets(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.OnpremVaultTargets); i++ {

		if m.OnpremVaultTargets[i] != nil {
			if err := m.OnpremVaultTargets[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("onpremVaultTargets" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("onpremVaultTargets" + "." + strconv.Itoa(i))
...
func (m *TargetsConfiguration) contextValidateSourceTargets(ctx context.Context, formats strfmt.Registry) error {

	if m.SourceTargets != nil {
		if err := m.SourceTargets.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sourceTargets")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sourceTargets")
