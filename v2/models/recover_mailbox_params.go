...
type RecoverMailboxParams struct {
	...
	// Specifies the Exchange target to recover to.
	EwsExchangeTarget *EwsExchangeTargetParam `json:"ewsExchangeTarget,omitempty"`
...
func (m *RecoverMailboxParams) validateEwsExchangeTarget(formats strfmt.Registry) error {
...
func (m *RecoverMailboxParams) contextValidateEwsExchangeTarget(ctx context.Context, formats strfmt.Registry) error {
