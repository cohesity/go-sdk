...
//
// swagger:model ElastifileProtectionGroupParams
type ElastifileProtectionGroupParams struct {
	...
	// Specifies whether to store additional SMB attributes in the snapshot metadata during backup. When enabled, extra SMB attributes are included in the snapshot information.
...
// Validate validates this elastifile protection group params
func (m *ElastifileProtectionGroupParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ElastifileProtectionGroupParams) validateFileFilters(formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) validateFileLockConfig(formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) validateIndexingPolicy(formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) validateObjects(formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) validatePrePostScript(formats strfmt.Registry) error {
...
var elastifileProtectionGroupParamsTypeProtocolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		elastifileProtectionGroupParamsTypeProtocolPropEnum = append(elastifileProtectionGroupParamsTypeProtocolPropEnum, v)
	}
}

const (

	// ElastifileProtectionGroupParamsProtocolKNoProtocol captures enum value "kNoProtocol"
	ElastifileProtectionGroupParamsProtocolKNoProtocol string = "kNoProtocol"

	// ElastifileProtectionGroupParamsProtocolKNfs3 captures enum value "kNfs3"
	ElastifileProtectionGroupParamsProtocolKNfs3 string = "kNfs3"

	// ElastifileProtectionGroupParamsProtocolKNfs41 captures enum value "kNfs4_1"
	ElastifileProtectionGroupParamsProtocolKNfs41 string = "kNfs4_1"

	// ElastifileProtectionGroupParamsProtocolKCifs1 captures enum value "kCifs1"
	ElastifileProtectionGroupParamsProtocolKCifs1 string = "kCifs1"

	// ElastifileProtectionGroupParamsProtocolKCifs2 captures enum value "kCifs2"
	ElastifileProtectionGroupParamsProtocolKCifs2 string = "kCifs2"

	// ElastifileProtectionGroupParamsProtocolKCifs3 captures enum value "kCifs3"
	ElastifileProtectionGroupParamsProtocolKCifs3 string = "kCifs3"
)

// prop value enum
func (m *ElastifileProtectionGroupParams) validateProtocolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, elastifileProtectionGroupParamsTypeProtocolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ElastifileProtectionGroupParams) validateProtocol(formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) validateThrottlingConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this elastifile protection group params based on the context it is used
func (m *ElastifileProtectionGroupParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ElastifileProtectionGroupParams) contextValidateFileFilters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateFileLockConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateObjects(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidatePrePostScript(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateSourceID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateSourceName(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) contextValidateThrottlingConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ElastifileProtectionGroupParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ElastifileProtectionGroupParams) UnmarshalBinary(b []byte) error {
	var res ElastifileProtectionGroupParams
