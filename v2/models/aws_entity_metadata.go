...
type AwsEntityMetadata struct {
	...
	DocumentDBParams *AwsDocumentDBEntityMetadata `json:"documentDBParams,omitempty"`
...
func (m *AwsEntityMetadata) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDocumentDBParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AwsEntityMetadata) validateDocumentDBParams(formats strfmt.Registry) error {
	if swag.IsZero(m.DocumentDBParams) { // not required
		return nil
	}

	if m.DocumentDBParams != nil {
		if err := m.DocumentDBParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("documentDBParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("documentDBParams")
			}
			return err
		}
	}
...
func (m *AwsEntityMetadata) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDocumentDBParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AwsEntityMetadata) contextValidateDocumentDBParams(ctx context.Context, formats strfmt.Registry) error {

	if m.DocumentDBParams != nil {
		if err := m.DocumentDBParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("documentDBParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("documentDBParams")
