...
type ClusterOperationStatus struct {
	...
	//
	Events []*OperationEvents `json:"events"`
	...
	NodesAssessmentResults []*NodeAssessmentResults `json:"nodesAssessmentResults"`

	// Specifies the status of operation on the cluster nodes.
	NodesOperationStatus []*ClusterNodeOperationStatus `json:"nodesOperationStatus"`
...
func (m *ClusterOperationStatus) validateErrorMessage(formats strfmt.Registry) error {

	if err := validate.RequiredString("errorMessage", "body", m.ErrorMessage); err != nil {
		return err
	}
