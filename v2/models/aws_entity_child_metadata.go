...
type AwsEntityChildMetadata struct {
	...
	// Specifies the entity metadata of documentdb entities.
	DocumentDBMetadata *AwsDocumentDBEntityMetadata `json:"documentDBMetadata,omitempty"`
...
func (m *AwsEntityChildMetadata) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDocumentDBMetadata(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AwsEntityChildMetadata) validateDocumentDBMetadata(formats strfmt.Registry) error {
	if swag.IsZero(m.DocumentDBMetadata) { // not required
		return nil
	}

	if m.DocumentDBMetadata != nil {
		if err := m.DocumentDBMetadata.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("documentDBMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("documentDBMetadata")
			}
			return err
		}
	}
...
func (m *AwsEntityChildMetadata) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDocumentDBMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AwsEntityChildMetadata) contextValidateDocumentDBMetadata(ctx context.Context, formats strfmt.Registry) error {

	if m.DocumentDBMetadata != nil {
		if err := m.DocumentDBMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("documentDBMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("documentDBMetadata")
