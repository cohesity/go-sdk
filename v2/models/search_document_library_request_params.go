...
type SearchDocumentLibraryRequestParams struct {
	...
	// Specifies the Google Workspace specific params to search for indexed items.
...
func (m *SearchDocumentLibraryRequestParams) validateGoogleWorkspaceParams(formats strfmt.Registry) error {
...
func (m *SearchDocumentLibraryRequestParams) contextValidateGoogleWorkspaceParams(ctx context.Context, formats strfmt.Registry) error {
