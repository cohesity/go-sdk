...
type SharepointItemMetadata struct {
	...
	// Enum: ["Unspecified","File","Directory","SiteDoclib","SiteList","OneNoteNotebook"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Unspecified","File","Directory","SiteDoclib","SiteList","OneNoteNotebook"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// SharepointItemMetadataTypeOneNoteNotebook captures enum value "OneNoteNotebook"
	SharepointItemMetadataTypeOneNoteNotebook string = "OneNoteNotebook"
)
