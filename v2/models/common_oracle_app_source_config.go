...
var commonOracleAppSourceConfigTypeNfsProtocolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		commonOracleAppSourceConfigTypeNfsProtocolPropEnum = append(commonOracleAppSourceConfigTypeNfsProtocolPropEnum, v)
	}
}

const (

	// CommonOracleAppSourceConfigNfsProtocolKNoProtocol captures enum value "kNoProtocol"
	CommonOracleAppSourceConfigNfsProtocolKNoProtocol string = "kNoProtocol"

	// CommonOracleAppSourceConfigNfsProtocolKNfs3 captures enum value "kNfs3"
	CommonOracleAppSourceConfigNfsProtocolKNfs3 string = "kNfs3"

	// CommonOracleAppSourceConfigNfsProtocolKNfs41 captures enum value "kNfs4_1"
	CommonOracleAppSourceConfigNfsProtocolKNfs41 string = "kNfs4_1"

	// CommonOracleAppSourceConfigNfsProtocolKCifs1 captures enum value "kCifs1"
	CommonOracleAppSourceConfigNfsProtocolKCifs1 string = "kCifs1"

	// CommonOracleAppSourceConfigNfsProtocolKCifs2 captures enum value "kCifs2"
	CommonOracleAppSourceConfigNfsProtocolKCifs2 string = "kCifs2"

	// CommonOracleAppSourceConfigNfsProtocolKCifs3 captures enum value "kCifs3"
	CommonOracleAppSourceConfigNfsProtocolKCifs3 string = "kCifs3"
)

// prop value enum
func (m *CommonOracleAppSourceConfig) validateNfsProtocolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, commonOracleAppSourceConfigTypeNfsProtocolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CommonOracleAppSourceConfig) validateNfsProtocol(formats strfmt.Registry) error {
