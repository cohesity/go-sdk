...
func (m *AwsS3OneZoneIAParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m AwsS3OneZoneIAParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this aws s3 one zone i a params
func (m *AwsS3OneZoneIAParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsS3OneZoneIAParams) validateAwsCloudGovParams(formats strfmt.Registry) error {
...
func (m *AwsS3OneZoneIAParams) validateAwsCloudStandardParams(formats strfmt.Registry) error {
...
// ContextValidate validate this aws s3 one zone i a params based on the context it is used
func (m *AwsS3OneZoneIAParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsS3OneZoneIAParams) contextValidateAwsCloudGovParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsS3OneZoneIAParams) contextValidateAwsCloudStandardParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsS3OneZoneIAParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsS3OneZoneIAParams) UnmarshalBinary(b []byte) error {
	var res AwsS3OneZoneIAParams
