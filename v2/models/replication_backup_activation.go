...
const (
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPBigQuery captures enum value "kGCPBigQuery"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPBigQuery string = "kGCPBigQuery"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPMySQL captures enum value "kGCPMySQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPMySQL string = "kGCPMySQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPSQLServer captures enum value "kGCPSQLServer"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPSQLServer string = "kGCPSQLServer"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPPostgreSQL string = "kGCPPostgreSQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPFirestore captures enum value "kGCPFirestore"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPFirestore string = "kGCPFirestore"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGoogleSpanner captures enum value "kGoogleSpanner"
	ReplicationBackupActivationTargetFailoverEnvironmentKGoogleSpanner string = "kGoogleSpanner"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGCPBigtable captures enum value "kGCPBigtable"
	ReplicationBackupActivationTargetFailoverEnvironmentKGCPBigtable string = "kGCPBigtable"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	ReplicationBackupActivationTargetFailoverEnvironmentKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSMySQL captures enum value "kAWSMySQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSMySQL string = "kAWSMySQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSAuroraMySQL string = "kAWSAuroraMySQL"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSRdsOracle captures enum value "kAWSRdsOracle"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSRdsOracle string = "kAWSRdsOracle"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSDocumentDB captures enum value "kAWSDocumentDB"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSDocumentDB string = "kAWSDocumentDB"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAWSRedshift captures enum value "kAWSRedshift"
	ReplicationBackupActivationTargetFailoverEnvironmentKAWSRedshift string = "kAWSRedshift"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureMySQL captures enum value "kAzureMySQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureMySQL string = "kAzureMySQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureBlobStorage captures enum value "kAzureBlobStorage"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureBlobStorage string = "kAzureBlobStorage"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureSQLDB captures enum value "kAzureSQLDB"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureSQLDB string = "kAzureSQLDB"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureSQLMI captures enum value "kAzureSQLMI"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureSQLMI string = "kAzureSQLMI"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureTableStorage captures enum value "kAzureTableStorage"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureTableStorage string = "kAzureTableStorage"

	// ReplicationBackupActivationTargetFailoverEnvironmentKAzureTableAPI captures enum value "kAzureTableAPI"
	ReplicationBackupActivationTargetFailoverEnvironmentKAzureTableAPI string = "kAzureTableAPI"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKNutanixFS captures enum value "kNutanixFS"
	ReplicationBackupActivationTargetFailoverEnvironmentKNutanixFS string = "kNutanixFS"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKS3Compatible captures enum value "kS3Compatible"
	ReplicationBackupActivationTargetFailoverEnvironmentKS3Compatible string = "kS3Compatible"
	...
	// ReplicationBackupActivationTargetFailoverEnvironmentKGoogleWorkspace captures enum value "kGoogleWorkspace"
	ReplicationBackupActivationTargetFailoverEnvironmentKGoogleWorkspace string = "kGoogleWorkspace"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGmail captures enum value "kGmail"
	ReplicationBackupActivationTargetFailoverEnvironmentKGmail string = "kGmail"

	// ReplicationBackupActivationTargetFailoverEnvironmentKGoogleDrive captures enum value "kGoogleDrive"
	ReplicationBackupActivationTargetFailoverEnvironmentKGoogleDrive string = "kGoogleDrive"

	// ReplicationBackupActivationTargetFailoverEnvironmentKDB2 captures enum value "kDB2"
	ReplicationBackupActivationTargetFailoverEnvironmentKDB2 string = "kDB2"

	// ReplicationBackupActivationTargetFailoverEnvironmentKServiceNow captures enum value "kServiceNow"
	ReplicationBackupActivationTargetFailoverEnvironmentKServiceNow string = "kServiceNow"

	// ReplicationBackupActivationTargetFailoverEnvironmentKSalesforce captures enum value "kSalesforce"
	ReplicationBackupActivationTargetFailoverEnvironmentKSalesforce string = "kSalesforce"

	// ReplicationBackupActivationTargetFailoverEnvironmentKPostgres captures enum value "kPostgres"
	ReplicationBackupActivationTargetFailoverEnvironmentKPostgres string = "kPostgres"

	// ReplicationBackupActivationTargetFailoverEnvironmentKJira captures enum value "kJira"
	ReplicationBackupActivationTargetFailoverEnvironmentKJira string = "kJira"

	// ReplicationBackupActivationTargetFailoverEnvironmentKPinecone captures enum value "kPinecone"
	ReplicationBackupActivationTargetFailoverEnvironmentKPinecone string = "kPinecone"
)
