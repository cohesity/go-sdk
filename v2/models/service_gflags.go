...
const (
	...
	// ServiceGflagsServiceNameKRolloutFlagEvaluator captures enum value "KRolloutFlagEvaluator"
	ServiceGflagsServiceNameKRolloutFlagEvaluator string = "KRolloutFlagEvaluator"

	// ServiceGflagsServiceNameKNbMediaServer captures enum value "kNbMediaServer"
	ServiceGflagsServiceNameKNbMediaServer string = "kNbMediaServer"

	// ServiceGflagsServiceNameKNasAPIBroker captures enum value "kNasApiBroker"
	ServiceGflagsServiceNameKNasAPIBroker string = "kNasApiBroker"
)
