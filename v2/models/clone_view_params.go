...
type CloneViewParams struct {
	...
	// Specifies whether to disable S3 Object Lock configuration on the cloned S3 View. This field is only applicable if the source View is an S3 View with S3 Object Lock configuration enabled.
	DisableS3ObjectLockConfig *bool `json:"disableS3ObjectLockConfig,omitempty"`
