...
func (m *UpgradeCheckTestResult) validateTestID(formats strfmt.Registry) error {
...
func (m *UpgradeCheckTestResult) validateTestKbLink(formats strfmt.Registry) error {
...
func (m *UpgradeCheckTestResult) validateTestName(formats strfmt.Registry) error {
...
func (m *UpgradeCheckTestResult) validateTestOutput(formats strfmt.Registry) error {
