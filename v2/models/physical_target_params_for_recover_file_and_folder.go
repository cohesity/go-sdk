...
type PhysicalTargetParamsForRecoverFileAndFolder struct {
	...
	// Specifies credentials for mounting the SMB share of the view during FLR restore from a block based back up for windows. If not specified either of the options are possible: a. If both the cluster and agent are on same AD, then logged in user credentials from the agent will be used for the mount. b. If cluster and agent are not on same AD, then a cluster local user with appropriate access will be selected automatically.
	MountCredentials *MountUserCreds `json:"mountCredentials,omitempty"`
...
func (m *PhysicalTargetParamsForRecoverFileAndFolder) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateMountCredentials(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PhysicalTargetParamsForRecoverFileAndFolder) validateMountCredentials(formats strfmt.Registry) error {
	if swag.IsZero(m.MountCredentials) { // not required
		return nil
	}

	if m.MountCredentials != nil {
		if err := m.MountCredentials.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("mountCredentials")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("mountCredentials")
			}
			return err
		}
	}
...
func (m *PhysicalTargetParamsForRecoverFileAndFolder) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateMountCredentials(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PhysicalTargetParamsForRecoverFileAndFolder) contextValidateMountCredentials(ctx context.Context, formats strfmt.Registry) error {

	if m.MountCredentials != nil {
		if err := m.MountCredentials.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("mountCredentials")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("mountCredentials")
