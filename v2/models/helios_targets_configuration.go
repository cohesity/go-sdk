...
//
// swagger:model HeliosTargetsConfiguration
type HeliosTargetsConfiguration struct {

	// replication targets
	ReplicationTargets []*HeliosReplicationConfig `json:"replicationTargets"`

	// archival targets
	ArchivalTargets []*HeliosArchivalConfig `json:"archivalTargets"`

	// cloud spin targets
	CloudSpinTargets []*HeliosCloudSpinConfig `json:"cloudSpinTargets"`

	// onprem deploy targets
	OnpremDeployTargets []*HeliosOnpremDeployConfig `json:"onpremDeployTargets"`

	// rpaas targets
	RpaasTargets []*HeliosRpaasConfig `json:"rpaasTargets"`
}

// Validate validates this helios targets configuration
func (m *HeliosTargetsConfiguration) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosTargetsConfiguration) validateReplicationTargets(formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) validateArchivalTargets(formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) validateCloudSpinTargets(formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) validateOnpremDeployTargets(formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) validateRpaasTargets(formats strfmt.Registry) error {
...
// ContextValidate validate this helios targets configuration based on the context it is used
func (m *HeliosTargetsConfiguration) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *HeliosTargetsConfiguration) contextValidateReplicationTargets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) contextValidateArchivalTargets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) contextValidateCloudSpinTargets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) contextValidateOnpremDeployTargets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) contextValidateRpaasTargets(ctx context.Context, formats strfmt.Registry) error {
...
func (m *HeliosTargetsConfiguration) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HeliosTargetsConfiguration) UnmarshalBinary(b []byte) error {
	var res HeliosTargetsConfiguration
