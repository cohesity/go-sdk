...
const (
	...
	// ProtectionGroupInfoTypeKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	ProtectionGroupInfoTypeKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// ProtectionGroupInfoTypeKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	ProtectionGroupInfoTypeKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// ProtectionGroupInfoTypeKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	ProtectionGroupInfoTypeKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// ProtectionGroupInfoTypeKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	ProtectionGroupInfoTypeKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// ProtectionGroupInfoTypeKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	ProtectionGroupInfoTypeKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// ProtectionGroupInfoTypeKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	ProtectionGroupInfoTypeKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// ProtectionGroupInfoTypeKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	ProtectionGroupInfoTypeKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// ProtectionGroupInfoTypeKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	ProtectionGroupInfoTypeKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// ProtectionGroupInfoTypeKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	ProtectionGroupInfoTypeKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// ProtectionGroupInfoTypeKAWSMySQL captures enum value "kAWSMySQL"
	ProtectionGroupInfoTypeKAWSMySQL string = "kAWSMySQL"

	// ProtectionGroupInfoTypeKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	ProtectionGroupInfoTypeKAWSAuroraMySQL string = "kAWSAuroraMySQL"

	// ProtectionGroupInfoTypeKAwsDynamoDB captures enum value "kAwsDynamoDB"
	ProtectionGroupInfoTypeKAwsDynamoDB string = "kAwsDynamoDB"

	// ProtectionGroupInfoTypeKAWSDocumentDB captures enum value "kAWSDocumentDB"
	ProtectionGroupInfoTypeKAWSDocumentDB string = "kAWSDocumentDB"

	// ProtectionGroupInfoTypeKAWSRdsOracle captures enum value "kAWSRdsOracle"
	ProtectionGroupInfoTypeKAWSRdsOracle string = "kAWSRdsOracle"

	// ProtectionGroupInfoTypeKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	ProtectionGroupInfoTypeKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// ProtectionGroupInfoTypeKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	ProtectionGroupInfoTypeKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// ProtectionGroupInfoTypeKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	ProtectionGroupInfoTypeKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// ProtectionGroupInfoTypeKAWSRedshift captures enum value "kAWSRedshift"
	ProtectionGroupInfoTypeKAWSRedshift string = "kAWSRedshift"
	...
	// ProtectionGroupInfoTypeKAzureEntraID captures enum value "kAzureEntraID"
	ProtectionGroupInfoTypeKAzureEntraID string = "kAzureEntraID"

	// ProtectionGroupInfoTypeKAzureMySQL captures enum value "kAzureMySQL"
	ProtectionGroupInfoTypeKAzureMySQL string = "kAzureMySQL"

	// ProtectionGroupInfoTypeKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	ProtectionGroupInfoTypeKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// ProtectionGroupInfoTypeKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	ProtectionGroupInfoTypeKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// ProtectionGroupInfoTypeKAzureBlobStorage captures enum value "kAzureBlobStorage"
	ProtectionGroupInfoTypeKAzureBlobStorage string = "kAzureBlobStorage"

	// ProtectionGroupInfoTypeKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	ProtectionGroupInfoTypeKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// ProtectionGroupInfoTypeKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	ProtectionGroupInfoTypeKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// ProtectionGroupInfoTypeKAzureSQLDB captures enum value "kAzureSQLDB"
	ProtectionGroupInfoTypeKAzureSQLDB string = "kAzureSQLDB"

	// ProtectionGroupInfoTypeKAzureSQLMI captures enum value "kAzureSQLMI"
	ProtectionGroupInfoTypeKAzureSQLMI string = "kAzureSQLMI"

	// ProtectionGroupInfoTypeKAzureTableStorage captures enum value "kAzureTableStorage"
	ProtectionGroupInfoTypeKAzureTableStorage string = "kAzureTableStorage"

	// ProtectionGroupInfoTypeKAzureTableAPI captures enum value "kAzureTableAPI"
	ProtectionGroupInfoTypeKAzureTableAPI string = "kAzureTableAPI"
	...
	// ProtectionGroupInfoTypeKGCPBigQuery captures enum value "kGCPBigQuery"
	ProtectionGroupInfoTypeKGCPBigQuery string = "kGCPBigQuery"

	// ProtectionGroupInfoTypeKGCPFirestore captures enum value "kGCPFirestore"
	ProtectionGroupInfoTypeKGCPFirestore string = "kGCPFirestore"

	// ProtectionGroupInfoTypeKGCPMySQL captures enum value "kGCPMySQL"
	ProtectionGroupInfoTypeKGCPMySQL string = "kGCPMySQL"

	// ProtectionGroupInfoTypeKGCPSQLServer captures enum value "kGCPSQLServer"
	ProtectionGroupInfoTypeKGCPSQLServer string = "kGCPSQLServer"

	// ProtectionGroupInfoTypeKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	ProtectionGroupInfoTypeKGCPPostgreSQL string = "kGCPPostgreSQL"

	// ProtectionGroupInfoTypeKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	ProtectionGroupInfoTypeKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// ProtectionGroupInfoTypeKGoogleSpanner captures enum value "kGoogleSpanner"
	ProtectionGroupInfoTypeKGoogleSpanner string = "kGoogleSpanner"

	// ProtectionGroupInfoTypeKGCPBigtable captures enum value "kGCPBigtable"
	ProtectionGroupInfoTypeKGCPBigtable string = "kGCPBigtable"
	...
	// ProtectionGroupInfoTypeKS3Compatible captures enum value "kS3Compatible"
	ProtectionGroupInfoTypeKS3Compatible string = "kS3Compatible"
	...
	// ProtectionGroupInfoTypeKExperimentalAdapter captures enum value "kExperimentalAdapter"
	ProtectionGroupInfoTypeKExperimentalAdapter string = "kExperimentalAdapter"

	// ProtectionGroupInfoTypeKMongoDBPhysical captures enum value "kMongoDBPhysical"
	ProtectionGroupInfoTypeKMongoDBPhysical string = "kMongoDBPhysical"

	// ProtectionGroupInfoTypeKGoogleWorkspace captures enum value "kGoogleWorkspace"
	ProtectionGroupInfoTypeKGoogleWorkspace string = "kGoogleWorkspace"

	// ProtectionGroupInfoTypeKGmail captures enum value "kGmail"
	ProtectionGroupInfoTypeKGmail string = "kGmail"

	// ProtectionGroupInfoTypeKGoogleDrive captures enum value "kGoogleDrive"
	ProtectionGroupInfoTypeKGoogleDrive string = "kGoogleDrive"

	// ProtectionGroupInfoTypeKDB2 captures enum value "kDB2"
	ProtectionGroupInfoTypeKDB2 string = "kDB2"

	// ProtectionGroupInfoTypeKEwsExchange captures enum value "kEwsExchange"
	ProtectionGroupInfoTypeKEwsExchange string = "kEwsExchange"

	// ProtectionGroupInfoTypeKServiceNow captures enum value "kServiceNow"
	ProtectionGroupInfoTypeKServiceNow string = "kServiceNow"

	// ProtectionGroupInfoTypeKSalesforce captures enum value "kSalesforce"
	ProtectionGroupInfoTypeKSalesforce string = "kSalesforce"

	// ProtectionGroupInfoTypeKPostgres captures enum value "kPostgres"
	ProtectionGroupInfoTypeKPostgres string = "kPostgres"

	// ProtectionGroupInfoTypeKNutanixFS captures enum value "kNutanixFS"
	ProtectionGroupInfoTypeKNutanixFS string = "kNutanixFS"

	// ProtectionGroupInfoTypeKJira captures enum value "kJira"
	ProtectionGroupInfoTypeKJira string = "kJira"

	// ProtectionGroupInfoTypeKPinecone captures enum value "kPinecone"
	ProtectionGroupInfoTypeKPinecone string = "kPinecone"
)
