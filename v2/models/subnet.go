...
var subnetTypeNfsSquashPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		subnetTypeNfsSquashPropEnum = append(subnetTypeNfsSquashPropEnum, v)
	}
}

const (

	// SubnetNfsSquashKNone captures enum value "kNone"
	SubnetNfsSquashKNone string = "kNone"

	// SubnetNfsSquashKRootSquash captures enum value "kRootSquash"
	SubnetNfsSquashKRootSquash string = "kRootSquash"

	// SubnetNfsSquashKAllSquash captures enum value "kAllSquash"
	SubnetNfsSquashKAllSquash string = "kAllSquash"
)

// prop value enum
func (m *Subnet) validateNfsSquashEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, subnetTypeNfsSquashPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Subnet) validateNfsSquash(formats strfmt.Registry) error {
