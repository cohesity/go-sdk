...
// AzureVMRecoveryTargetConfig Azure VMs Recovery Target Config.
//
// Specifies the target object parameters to recover Azure vms.
//
// swagger:model AzureVmRecoveryTargetConfig
type AzureVMRecoveryTargetConfig struct {
	...
	NewSourceConfig *RecoverAzureVMNewSourceConfig `json:"newSourceConfig,omitempty"`

	// Specifies the Source configuration if VM's are being recovered to Original Source.
	OriginalSourceConfig *RecoverAzureVMOriginalSourceConfig `json:"originalSourceConfig,omitempty"`
...
// Validate validates this azure Vm recovery target config
func (m *AzureVMRecoveryTargetConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureVMRecoveryTargetConfig) validateNewSourceConfig(formats strfmt.Registry) error {
...
func (m *AzureVMRecoveryTargetConfig) validateOriginalSourceConfig(formats strfmt.Registry) error {
...
func (m *AzureVMRecoveryTargetConfig) validateRecoverToNewSource(formats strfmt.Registry) error {
...
// ContextValidate validate this azure Vm recovery target config based on the context it is used
func (m *AzureVMRecoveryTargetConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureVMRecoveryTargetConfig) contextValidateNewSourceConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureVMRecoveryTargetConfig) contextValidateOriginalSourceConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureVMRecoveryTargetConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AzureVMRecoveryTargetConfig) UnmarshalBinary(b []byte) error {
	var res AzureVMRecoveryTargetConfig
