...
const (
	...
	// CommonProtectionGroupRequestParamsEnvironmentKGCPBigQuery captures enum value "kGCPBigQuery"
	CommonProtectionGroupRequestParamsEnvironmentKGCPBigQuery string = "kGCPBigQuery"

	// CommonProtectionGroupRequestParamsEnvironmentKGCPMySQL captures enum value "kGCPMySQL"
	CommonProtectionGroupRequestParamsEnvironmentKGCPMySQL string = "kGCPMySQL"

	// CommonProtectionGroupRequestParamsEnvironmentKGCPSQLServer captures enum value "kGCPSQLServer"
	CommonProtectionGroupRequestParamsEnvironmentKGCPSQLServer string = "kGCPSQLServer"

	// CommonProtectionGroupRequestParamsEnvironmentKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	CommonProtectionGroupRequestParamsEnvironmentKGCPPostgreSQL string = "kGCPPostgreSQL"

	// CommonProtectionGroupRequestParamsEnvironmentKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	CommonProtectionGroupRequestParamsEnvironmentKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// CommonProtectionGroupRequestParamsEnvironmentKGCPFirestore captures enum value "kGCPFirestore"
	CommonProtectionGroupRequestParamsEnvironmentKGCPFirestore string = "kGCPFirestore"

	// CommonProtectionGroupRequestParamsEnvironmentKGoogleSpanner captures enum value "kGoogleSpanner"
	CommonProtectionGroupRequestParamsEnvironmentKGoogleSpanner string = "kGoogleSpanner"

	// CommonProtectionGroupRequestParamsEnvironmentKGCPBigtable captures enum value "kGCPBigtable"
	CommonProtectionGroupRequestParamsEnvironmentKGCPBigtable string = "kGCPBigtable"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// CommonProtectionGroupRequestParamsEnvironmentKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	CommonProtectionGroupRequestParamsEnvironmentKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKAWSMySQL captures enum value "kAWSMySQL"
	CommonProtectionGroupRequestParamsEnvironmentKAWSMySQL string = "kAWSMySQL"

	// CommonProtectionGroupRequestParamsEnvironmentKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	CommonProtectionGroupRequestParamsEnvironmentKAWSAuroraMySQL string = "kAWSAuroraMySQL"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKAWSRdsOracle captures enum value "kAWSRdsOracle"
	CommonProtectionGroupRequestParamsEnvironmentKAWSRdsOracle string = "kAWSRdsOracle"

	// CommonProtectionGroupRequestParamsEnvironmentKAWSDocumentDB captures enum value "kAWSDocumentDB"
	CommonProtectionGroupRequestParamsEnvironmentKAWSDocumentDB string = "kAWSDocumentDB"

	// CommonProtectionGroupRequestParamsEnvironmentKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	CommonProtectionGroupRequestParamsEnvironmentKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// CommonProtectionGroupRequestParamsEnvironmentKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	CommonProtectionGroupRequestParamsEnvironmentKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// CommonProtectionGroupRequestParamsEnvironmentKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	CommonProtectionGroupRequestParamsEnvironmentKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// CommonProtectionGroupRequestParamsEnvironmentKAWSRedshift captures enum value "kAWSRedshift"
	CommonProtectionGroupRequestParamsEnvironmentKAWSRedshift string = "kAWSRedshift"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKAzureMySQL captures enum value "kAzureMySQL"
	CommonProtectionGroupRequestParamsEnvironmentKAzureMySQL string = "kAzureMySQL"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	CommonProtectionGroupRequestParamsEnvironmentKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	CommonProtectionGroupRequestParamsEnvironmentKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureBlobStorage captures enum value "kAzureBlobStorage"
	CommonProtectionGroupRequestParamsEnvironmentKAzureBlobStorage string = "kAzureBlobStorage"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	CommonProtectionGroupRequestParamsEnvironmentKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// CommonProtectionGroupRequestParamsEnvironmentKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	CommonProtectionGroupRequestParamsEnvironmentKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureSQLDB captures enum value "kAzureSQLDB"
	CommonProtectionGroupRequestParamsEnvironmentKAzureSQLDB string = "kAzureSQLDB"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureSQLMI captures enum value "kAzureSQLMI"
	CommonProtectionGroupRequestParamsEnvironmentKAzureSQLMI string = "kAzureSQLMI"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureTableStorage captures enum value "kAzureTableStorage"
	CommonProtectionGroupRequestParamsEnvironmentKAzureTableStorage string = "kAzureTableStorage"

	// CommonProtectionGroupRequestParamsEnvironmentKAzureTableAPI captures enum value "kAzureTableAPI"
	CommonProtectionGroupRequestParamsEnvironmentKAzureTableAPI string = "kAzureTableAPI"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKNutanixFS captures enum value "kNutanixFS"
	CommonProtectionGroupRequestParamsEnvironmentKNutanixFS string = "kNutanixFS"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKS3Compatible captures enum value "kS3Compatible"
	CommonProtectionGroupRequestParamsEnvironmentKS3Compatible string = "kS3Compatible"
	...
	// CommonProtectionGroupRequestParamsEnvironmentKGoogleWorkspace captures enum value "kGoogleWorkspace"
	CommonProtectionGroupRequestParamsEnvironmentKGoogleWorkspace string = "kGoogleWorkspace"

	// CommonProtectionGroupRequestParamsEnvironmentKGmail captures enum value "kGmail"
	CommonProtectionGroupRequestParamsEnvironmentKGmail string = "kGmail"

	// CommonProtectionGroupRequestParamsEnvironmentKGoogleDrive captures enum value "kGoogleDrive"
	CommonProtectionGroupRequestParamsEnvironmentKGoogleDrive string = "kGoogleDrive"

	// CommonProtectionGroupRequestParamsEnvironmentKDB2 captures enum value "kDB2"
	CommonProtectionGroupRequestParamsEnvironmentKDB2 string = "kDB2"

	// CommonProtectionGroupRequestParamsEnvironmentKServiceNow captures enum value "kServiceNow"
	CommonProtectionGroupRequestParamsEnvironmentKServiceNow string = "kServiceNow"

	// CommonProtectionGroupRequestParamsEnvironmentKSalesforce captures enum value "kSalesforce"
	CommonProtectionGroupRequestParamsEnvironmentKSalesforce string = "kSalesforce"

	// CommonProtectionGroupRequestParamsEnvironmentKPostgres captures enum value "kPostgres"
	CommonProtectionGroupRequestParamsEnvironmentKPostgres string = "kPostgres"

	// CommonProtectionGroupRequestParamsEnvironmentKJira captures enum value "kJira"
	CommonProtectionGroupRequestParamsEnvironmentKJira string = "kJira"

	// CommonProtectionGroupRequestParamsEnvironmentKPinecone captures enum value "kPinecone"
	CommonProtectionGroupRequestParamsEnvironmentKPinecone string = "kPinecone"
)
