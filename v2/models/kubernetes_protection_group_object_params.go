...
type KubernetesProtectionGroupObjectParams struct {
	...
	// Specifies the object ids to be excluded for protection. This is supported for object protection on helios only
	// Unique: true
...
func (m *KubernetesProtectionGroupObjectParams) validateExcludeObjectIds(formats strfmt.Registry) error {
...
func (m *KubernetesProtectionGroupObjectParams) validateExcludeParams(formats strfmt.Registry) error {
...
func (m *KubernetesProtectionGroupObjectParams) validateIncludeParams(formats strfmt.Registry) error {
...
func (m *KubernetesProtectionGroupObjectParams) contextValidateExcludeParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *KubernetesProtectionGroupObjectParams) contextValidateIncludeParams(ctx context.Context, formats strfmt.Registry) error {
