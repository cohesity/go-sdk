...
// RecoverHiveParams Recover Hive params.
//
// Specifies the type of recover action to be performed.
//
// swagger:model RecoverHiveParams
...
func (m *RecoverHiveParams) UnmarshalJSON(raw []byte) error {
	// AO0
...
func (m RecoverHiveParams) MarshalJSON() ([]byte, error) {
...
// Validate validates this recover hive params
func (m *RecoverHiveParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverHiveParams) validateSnapshots(formats strfmt.Registry) error {
...
// ContextValidate validate this recover hive params based on the context it is used
func (m *RecoverHiveParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverHiveParams) contextValidateSnapshots(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverHiveParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverHiveParams) UnmarshalBinary(b []byte) error {
	var res RecoverHiveParams
