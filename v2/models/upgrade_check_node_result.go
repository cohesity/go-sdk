...
type UpgradeCheckNodeResult struct {
	...
	NodeTestResults []*UpgradeCheckTestResult `json:"nodeTestResults"`

	// The healthcheck run status for node
	// Required: true
	// Enum: ["Running","Passed","Failed","Skipped","Error"]
	NodeTestStatus string `json:"nodeTestStatus"`
}
...
func (m *UpgradeCheckNodeResult) validateNodeIP(formats strfmt.Registry) error {

	if err := validate.RequiredString("nodeIp", "body", m.NodeIP); err != nil {
		return err
	}
...
func (m *UpgradeCheckNodeResult) validateNodeTestStatus(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("nodeTestStatus", "body", m.NodeTestStatus); err != nil {
		return err
	}
