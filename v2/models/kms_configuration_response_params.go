...
type KmsConfigurationResponseParams struct {
	...
	GcpKmsParams *GcpKmsConfigurationResponse `json:"gcpKmsParams,omitempty"`
	...
	// Enum: [InternalKms AwsKms KmipKms IbmKms GcpKms]
...
func (m *KmsConfigurationResponseParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGcpKmsParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *KmsConfigurationResponseParams) validateGcpKmsParams(formats strfmt.Registry) error {
	if swag.IsZero(m.GcpKmsParams) { // not required
		return nil
	}

	if m.GcpKmsParams != nil {
		if err := m.GcpKmsParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gcpKmsParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gcpKmsParams")
			}
			return err
		}
	}
...
const (
	...
	// KmsConfigurationResponseParamsOwnershipContextFortKnoxOnprem captures enum value "FortKnoxOnprem"
	KmsConfigurationResponseParamsOwnershipContextFortKnoxOnprem string = "FortKnoxOnprem"
)
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["InternalKms","AwsKms","KmipKms","IbmKms","GcpKms"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// KmsConfigurationResponseParamsTypeGcpKms captures enum value "GcpKms"
	KmsConfigurationResponseParamsTypeGcpKms string = "GcpKms"
)
...
func (m *KmsConfigurationResponseParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGcpKmsParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *KmsConfigurationResponseParams) contextValidateGcpKmsParams(ctx context.Context, formats strfmt.Registry) error {

	if m.GcpKmsParams != nil {
		if err := m.GcpKmsParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gcpKmsParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gcpKmsParams")
