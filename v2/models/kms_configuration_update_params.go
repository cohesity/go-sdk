...
type KmsConfigurationUpdateParams struct {
	...
	GcpKmsParams *GcpKmsConfigurationUpdateParams `json:"gcpKmsParams,omitempty"`
...
func (m *KmsConfigurationUpdateParams) validateGcpKmsParams(formats strfmt.Registry) error {
...
func (m *KmsConfigurationUpdateParams) contextValidateGcpKmsParams(ctx context.Context, formats strfmt.Registry) error {
