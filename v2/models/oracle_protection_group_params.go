...
var oracleProtectionGroupParamsTypeNfsProtocolPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		oracleProtectionGroupParamsTypeNfsProtocolPropEnum = append(oracleProtectionGroupParamsTypeNfsProtocolPropEnum, v)
	}
}

const (

	// OracleProtectionGroupParamsNfsProtocolKNoProtocol captures enum value "kNoProtocol"
	OracleProtectionGroupParamsNfsProtocolKNoProtocol string = "kNoProtocol"

	// OracleProtectionGroupParamsNfsProtocolKNfs3 captures enum value "kNfs3"
	OracleProtectionGroupParamsNfsProtocolKNfs3 string = "kNfs3"

	// OracleProtectionGroupParamsNfsProtocolKNfs41 captures enum value "kNfs4_1"
	OracleProtectionGroupParamsNfsProtocolKNfs41 string = "kNfs4_1"

	// OracleProtectionGroupParamsNfsProtocolKCifs1 captures enum value "kCifs1"
	OracleProtectionGroupParamsNfsProtocolKCifs1 string = "kCifs1"

	// OracleProtectionGroupParamsNfsProtocolKCifs2 captures enum value "kCifs2"
	OracleProtectionGroupParamsNfsProtocolKCifs2 string = "kCifs2"

	// OracleProtectionGroupParamsNfsProtocolKCifs3 captures enum value "kCifs3"
	OracleProtectionGroupParamsNfsProtocolKCifs3 string = "kCifs3"
)

// prop value enum
func (m *OracleProtectionGroupParams) validateNfsProtocolEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, oracleProtectionGroupParamsTypeNfsProtocolPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *OracleProtectionGroupParams) validateNfsProtocol(formats strfmt.Registry) error {
