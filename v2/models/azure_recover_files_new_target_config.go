...
// AzureRecoverFilesNewTargetConfig Azure Recover Files New Target Config.
//
// Specifies the configuration for recovering files and folders to the new target.
//
// swagger:model AzureRecoverFilesNewTargetConfig
...
// Validate validates this azure recover files new target config
func (m *AzureRecoverFilesNewTargetConfig) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AzureRecoverFilesNewTargetConfig) validateAbsolutePath(formats strfmt.Registry) error {
...
func (m *AzureRecoverFilesNewTargetConfig) validateTargetVM(formats strfmt.Registry) error {
...
func (m *AzureRecoverFilesNewTargetConfig) validateTargetVMCredentials(formats strfmt.Registry) error {
...
// ContextValidate validate this azure recover files new target config based on the context it is used
func (m *AzureRecoverFilesNewTargetConfig) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AzureRecoverFilesNewTargetConfig) contextValidateTargetVM(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureRecoverFilesNewTargetConfig) contextValidateTargetVMCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AzureRecoverFilesNewTargetConfig) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AzureRecoverFilesNewTargetConfig) UnmarshalBinary(b []byte) error {
	var res AzureRecoverFilesNewTargetConfig
