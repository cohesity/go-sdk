...
// RecoverOtherNasToFlashbladeVolumeTargetParams Recover To Flashblade Volume Target Params.
//
// Specifies the params of the Flashblade recovery target.
//
// swagger:model RecoverOtherNasToFlashbladeVolumeTargetParams
...
// Validate validates this recover other nas to flashblade volume target params
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to flashblade volume target params based on the context it is used
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToFlashbladeVolumeTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToFlashbladeVolumeTargetParams
