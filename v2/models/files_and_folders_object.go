...
type FilesAndFoldersObject struct {
	...
	// Specifies additional info needed for filse/folder recovery/download.
	DocumentParams *AdditionalDocumentInfo `json:"documentParams,omitempty"`
...
func (m *FilesAndFoldersObject) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDocumentParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FilesAndFoldersObject) validateDocumentParams(formats strfmt.Registry) error {
	if swag.IsZero(m.DocumentParams) { // not required
		return nil
	}

	if m.DocumentParams != nil {
		if err := m.DocumentParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("documentParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("documentParams")
			}
			return err
		}
	}
...
// ContextValidate validate this files and folders object based on the context it is used
func (m *FilesAndFoldersObject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateDocumentParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *FilesAndFoldersObject) contextValidateDocumentParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.DocumentParams != nil {
		...
		if err := m.DocumentParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("documentParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("documentParams")
