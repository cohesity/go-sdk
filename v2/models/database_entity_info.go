...
type DatabaseEntityInfo struct {
	...
	// Specifies the type of host on which the Oracle database is running.
...
var databaseEntityInfoTypeHostTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		databaseEntityInfoTypeHostTypePropEnum = append(databaseEntityInfoTypeHostTypePropEnum, v)
	}
}

const (

	// DatabaseEntityInfoHostTypeKLinux captures enum value "kLinux"
	DatabaseEntityInfoHostTypeKLinux string = "kLinux"

	// DatabaseEntityInfoHostTypeKWindows captures enum value "kWindows"
	DatabaseEntityInfoHostTypeKWindows string = "kWindows"

	// DatabaseEntityInfoHostTypeKAix captures enum value "kAix"
	DatabaseEntityInfoHostTypeKAix string = "kAix"

	// DatabaseEntityInfoHostTypeKSolaris captures enum value "kSolaris"
	DatabaseEntityInfoHostTypeKSolaris string = "kSolaris"

	// DatabaseEntityInfoHostTypeKSapHana captures enum value "kSapHana"
	DatabaseEntityInfoHostTypeKSapHana string = "kSapHana"

	// DatabaseEntityInfoHostTypeKOther captures enum value "kOther"
	DatabaseEntityInfoHostTypeKOther string = "kOther"

	// DatabaseEntityInfoHostTypeKHPUX captures enum value "kHPUX"
	DatabaseEntityInfoHostTypeKHPUX string = "kHPUX"

	// DatabaseEntityInfoHostTypeKVOS captures enum value "kVOS"
	DatabaseEntityInfoHostTypeKVOS string = "kVOS"
)

// prop value enum
func (m *DatabaseEntityInfo) validateHostTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, databaseEntityInfoTypeHostTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DatabaseEntityInfo) validateHostType(formats strfmt.Registry) error {
