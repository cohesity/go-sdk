...
// OriginalIsilonFilesTargetParams Recover To Original Isilon Files Target Params.
//
// Specifies the params of the original Isilon recovery target.
//
// swagger:model OriginalIsilonFilesTargetParams
...
// Validate validates this original isilon files target params
func (m *OriginalIsilonFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalIsilonFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalIsilonFilesTargetParams) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *OriginalIsilonFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original isilon files target params based on the context it is used
func (m *OriginalIsilonFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalIsilonFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalIsilonFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalIsilonFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalIsilonFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalIsilonFilesTargetParams
