...
func (m *AliasSmbConfig) contextValidateContinuousAvailability(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "continuousAvailability", "body", m.ContinuousAvailability); err != nil {
		return err
	}
