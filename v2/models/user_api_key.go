...
type UserAPIKey struct {
	...
	// Specifies the username of the user who created the API key.
	// Read Only: true
	...
	// Specifies the username of the user who owns the API key.
	// Read Only: true
...
func (m *UserAPIKey) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateOwnerUsername(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *UserAPIKey) contextValidateCreatedByUsername(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "createdByUsername", "body", m.CreatedByUsername); err != nil {
		return err
	}
...
func (m *UserAPIKey) contextValidateOwnerUsername(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "ownerUsername", "body", m.OwnerUsername); err != nil {
		return err
	}
