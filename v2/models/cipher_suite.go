...
const (
	...
	// CipherSuiteCipherTLSECDHERSAWITHAES256CBCSHA captures enum value "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"
	CipherSuiteCipherTLSECDHERSAWITHAES256CBCSHA string = "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"

	// CipherSuiteCipherTLSECDHERSAWITHAES128CBCSHA captures enum value "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA"
	CipherSuiteCipherTLSECDHERSAWITHAES128CBCSHA string = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA"
