...
// RecoverAwsAuroraParams Recover AWS Aurora params.
//
// Specifies the parameters to recover AWS Aurora.
//
// swagger:model RecoverAwsAuroraParams
type RecoverAwsAuroraParams struct {

	// Specifies the params for recovering to an AWS target.
	AwsTargetParams *AwsTargetParamsForRecoverAurora `json:"awsTargetParams,omitempty"`
...
// Validate validates this recover aws aurora params
func (m *RecoverAwsAuroraParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverAwsAuroraParams) validateAwsTargetParams(formats strfmt.Registry) error {
...
func (m *RecoverAwsAuroraParams) validateRecoverProtectionGroupRunsParams(formats strfmt.Registry) error {
...
var recoverAwsAuroraParamsTypeTargetEnvironmentPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		recoverAwsAuroraParamsTypeTargetEnvironmentPropEnum = append(recoverAwsAuroraParamsTypeTargetEnvironmentPropEnum, v)
	}
}

const (

	// RecoverAwsAuroraParamsTargetEnvironmentKAWS captures enum value "kAWS"
	RecoverAwsAuroraParamsTargetEnvironmentKAWS string = "kAWS"
)

// prop value enum
func (m *RecoverAwsAuroraParams) validateTargetEnvironmentEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, recoverAwsAuroraParamsTypeTargetEnvironmentPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *RecoverAwsAuroraParams) validateTargetEnvironment(formats strfmt.Registry) error {
...
// ContextValidate validate this recover aws aurora params based on the context it is used
func (m *RecoverAwsAuroraParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverAwsAuroraParams) contextValidateAwsTargetParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverAwsAuroraParams) contextValidateRecoverProtectionGroupRunsParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverAwsAuroraParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverAwsAuroraParams) UnmarshalBinary(b []byte) error {
	var res RecoverAwsAuroraParams
