...
type FileStatInfo struct {
	...
	// Metadata for the OneDrive item. This will be set only if we are quering for user's OneDrive. This is used to further different between item types, for example a kDirectory item in OneDrive could be a OneNote Notebook (kNotebook) or folder (kDirectory).
	OneDriveItemMetadata *OneDriveItemMetadata `json:"oneDriveItemMetadata,omitempty"`

	// Metadata for the sharepoint item. This will be set only if we are quering for sharepoint site. This is used to further different between item types, for example a kDirectory item in sharepoint site could be a Document library (kSiteDoclib), list (kSiteList) or folder (kDirectory).
	...
	// Enum: [File Directory Symlink OneNoteNotebook]
...
func (m *FileStatInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateOneDriveItemMetadata(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FileStatInfo) validateOneDriveItemMetadata(formats strfmt.Registry) error {
	if swag.IsZero(m.OneDriveItemMetadata) { // not required
		return nil
	}

	if m.OneDriveItemMetadata != nil {
		if err := m.OneDriveItemMetadata.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("oneDriveItemMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("oneDriveItemMetadata")
			}
			return err
		}
	}
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["File","Directory","Symlink","OneNoteNotebook"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// FileStatInfoTypeOneNoteNotebook captures enum value "OneNoteNotebook"
	FileStatInfoTypeOneNoteNotebook string = "OneNoteNotebook"
)
...
func (m *FileStatInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateOneDriveItemMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *FileStatInfo) contextValidateOneDriveItemMetadata(ctx context.Context, formats strfmt.Registry) error {

	if m.OneDriveItemMetadata != nil {
		if err := m.OneDriveItemMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("oneDriveItemMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("oneDriveItemMetadata")
