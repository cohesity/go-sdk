...
type CommonExternalTargetParams struct {
	...
	// Required: true
	// Enum: [Archival Tiering Rpaas Logbackup]
	...
	WormLockInComplianceMode *bool `json:"wormLockInComplianceMode,omitempty"`
}
...
const (
	...
	// CommonExternalTargetParamsOwnershipContextFortKnoxOnprem captures enum value "FortKnoxOnprem"
	CommonExternalTargetParamsOwnershipContextFortKnoxOnprem string = "FortKnoxOnprem"
)
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["Archival","Tiering","Rpaas","Logbackup"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// CommonExternalTargetParamsPurposeTypeLogbackup captures enum value "Logbackup"
	CommonExternalTargetParamsPurposeTypeLogbackup string = "Logbackup"
)
...
func (m *CommonExternalTargetParams) validateVaultTagMap(formats strfmt.Registry) error {
	if swag.IsZero(m.VaultTagMap) { // not required
		return nil
	}

	iVaultTagMapSize := int64(len(m.VaultTagMap))

	if err := validate.MaxItems("vaultTagMap", "body", iVaultTagMapSize, 100); err != nil {
		return err
	}
...
func (m *CommonExternalTargetParams) contextValidateVaultTagMap(ctx context.Context, formats strfmt.Registry) error {
