...
const (
	...
	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// ObjectProtectionGroupSummaryProtectionEnvTypeKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSMySQL captures enum value "kAWSMySQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSMySQL string = "kAWSMySQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSSnapshotManager captures enum value "kAWSSnapshotManager"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSSnapshotManager string = "kAWSSnapshotManager"
	...
	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSAuroraMySQL string = "kAWSAuroraMySQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSDocumentDB captures enum value "kAWSDocumentDB"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSDocumentDB string = "kAWSDocumentDB"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRdsOracle captures enum value "kAWSRdsOracle"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRdsOracle string = "kAWSRdsOracle"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRedshift captures enum value "kAWSRedshift"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAWSRedshift string = "kAWSRedshift"
	...
	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureMySQL captures enum value "kAzureMySQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureMySQL string = "kAzureMySQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureBlobStorage captures enum value "kAzureBlobStorage"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureBlobStorage string = "kAzureBlobStorage"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCassandra captures enum value "kAzureCassandra"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureCassandra string = "kAzureCassandra"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzurePostgreSQL captures enum value "kAzurePostgreSQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzurePostgreSQL string = "kAzurePostgreSQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureSQLDB captures enum value "kAzureSQLDB"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureSQLDB string = "kAzureSQLDB"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureSQLMI captures enum value "kAzureSQLMI"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureSQLMI string = "kAzureSQLMI"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureTableStorage captures enum value "kAzureTableStorage"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureTableStorage string = "kAzureTableStorage"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKAzureTableAPI captures enum value "kAzureTableAPI"
	ObjectProtectionGroupSummaryProtectionEnvTypeKAzureTableAPI string = "kAzureTableAPI"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKKubernetes captures enum value "kKubernetes"
	ObjectProtectionGroupSummaryProtectionEnvTypeKKubernetes string = "kKubernetes"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPBigQuery captures enum value "kGCPBigQuery"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPBigQuery string = "kGCPBigQuery"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPFirestore captures enum value "kGCPFirestore"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPFirestore string = "kGCPFirestore"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPBigtable captures enum value "kGCPBigtable"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPBigtable string = "kGCPBigtable"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPMySQL captures enum value "kGCPMySQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPMySQL string = "kGCPMySQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPSQLServer captures enum value "kGCPSQLServer"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPSQLServer string = "kGCPSQLServer"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPPostgreSQL string = "kGCPPostgreSQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGoogleSpanner captures enum value "kGoogleSpanner"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGoogleSpanner string = "kGoogleSpanner"
	...
	// ObjectProtectionGroupSummaryProtectionEnvTypeKGmail captures enum value "kGmail"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGmail string = "kGmail"

	// ObjectProtectionGroupSummaryProtectionEnvTypeKGoogleDrive captures enum value "kGoogleDrive"
	ObjectProtectionGroupSummaryProtectionEnvTypeKGoogleDrive string = "kGoogleDrive"
)
