...
func (m *NewGroupParam) validateIndexingPolicy(formats strfmt.Registry) error {
...
// ContextValidate validate this new group param based on the context it is used
...
func (m *NewGroupParam) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
