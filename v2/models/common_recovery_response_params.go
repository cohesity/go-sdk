...
type CommonRecoveryResponseParams struct {
	...
	// Enum: ["kVMware","kHyperV","kAzure","kGCP","kKVM","kAcropolis","kAWS","kPhysical","kGPFS","kElastifile","kNetapp","kNutanixFS","kGenericNas","kIsilon","kFlashBlade","kPure","kIbmFlashSystem","kSQL","kExchange","kAD","kOracle","kView","kRemoteAdapter","kO365","kKubernetes","kCassandra","kMongoDB","kCouchbase","kHdfs","kHive","kS3Compatible","kSAPHANA","kHBase","kUDA","kSfdc","kExperimentalAdapter","kMongoDBPhysical","kGoogleWorkspace","kDB2","kServiceNow","kPostgres","kSalesforce","kJira","kPinecone"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["RecoverVMs","RecoverFiles","InstantVolumeMount","RecoverVmDisks","RecoverVApps","RecoverVAppTemplates","UptierSnapshot","RecoverRDS","RecoverAurora","RecoverS3Buckets","RecoverRDSPostgres","RecoverAwsDynamoDB","RecoverRDSMySQL","RecoverRDSAuroraMySQL","RecoverRDSOracle","RecoverAWSDocumentDB","RecoverAWSRDSPostgresDB","RecoverAWSAuroraPostgresDB","RecoverAWSRDSMSSQL","RecoverAWSRedshift","RecoverGCPBigQuery","RecoverGCPFirestore","RecoverGCPMySQL","RecoverGCPSQLServer","RecoverGCPPostgreSQL","RecoverGCPAlloyDBPostgreSQL","RecoverGoogleSpanner","RecoverGCPBigtable","RecoverAzureSQL","RecoverAzureEntraID","RecoverAzureMySQL","RecoverAzureCosmosDBCassandra","RecoverAzureBlobStorage","RecoverAzurePostgreSQL","RecoverAzureCosmosDBNoSQL","RecoverAzureCosmosDBMongoDB","RecoverAzureSQLDB","RecoverAzureSQLMI","RecoverAzureTableStorage","RecoverAzureTableAPI","RecoverNamespaces","RecoverApps","CloneApps","RecoverAppFiles","RecoverNasVolume","RecoverPhysicalVolumes","RecoverSystem","RecoverSnapshotToView","RecoverExchangeDbs","CloneAppView","RecoverSanVolumes","RecoverSanGroup","RecoverMailbox","RecoverOneDrive","RecoverSharePoint","RecoverPublicFolders","RecoverMsGroup","RecoverMsTeam","ConvertToPst","DownloadChats","RecoverMailboxCSM","RecoverOneDriveCSM","RecoverSharePointCSM","RecoverO365ToExchangeServer","DownloadFilesAndFolders","RecoverObjects","RecoverSfdcObjects","RecoverSfdcOrg","RecoverSfdcRecords","RecoverGmail","RecoverGoogleDrive","CloneVMs","CloneView","CloneRefreshApp","CloneVMsToView","ConvertAndDeployVMs","DeployVMs","RecoverMongodbClusters","RecoverServiceNowTables","RecoverServiceNowInstance","DownloadTables","RecoverSalesforceStructuredData","RecoverSalesforceMetadata","RecoverJiraInstance","RecoverIndexes"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// CommonRecoveryResponseParamsRecoveryActionRecoverIndexes captures enum value "RecoverIndexes"
	CommonRecoveryResponseParamsRecoveryActionRecoverIndexes string = "RecoverIndexes"
)
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kVMware","kHyperV","kAzure","kGCP","kKVM","kAcropolis","kAWS","kPhysical","kGPFS","kElastifile","kNetapp","kNutanixFS","kGenericNas","kIsilon","kFlashBlade","kPure","kIbmFlashSystem","kSQL","kExchange","kAD","kOracle","kView","kRemoteAdapter","kO365","kKubernetes","kCassandra","kMongoDB","kCouchbase","kHdfs","kHive","kS3Compatible","kSAPHANA","kHBase","kUDA","kSfdc","kExperimentalAdapter","kMongoDBPhysical","kGoogleWorkspace","kDB2","kServiceNow","kPostgres","kSalesforce","kJira","kPinecone"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// CommonRecoveryResponseParamsSnapshotEnvironmentKPinecone captures enum value "kPinecone"
	CommonRecoveryResponseParamsSnapshotEnvironmentKPinecone string = "kPinecone"
)
