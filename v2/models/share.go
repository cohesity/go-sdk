...
type Share struct {
	...
	// Specifies the view this share belongs to is a read only view.
	// Read Only: true
	IsReadOnlyView *bool `json:"isReadOnlyView,omitempty"`
...
func (m *Share) UnmarshalJSON(raw []byte) error {
	...
	m.IsReadOnlyView = dataAO1.IsReadOnlyView
...
func (m Share) MarshalJSON() ([]byte, error) {
	...
	dataAO1.IsReadOnlyView = m.IsReadOnlyView
...
func (m *Share) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIsReadOnlyView(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Share) contextValidateIsReadOnlyView(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "isReadOnlyView", "body", m.IsReadOnlyView); err != nil {
		return err
	}
