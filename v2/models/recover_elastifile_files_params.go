...
func (m *RecoverElastifileFilesParams) validateNutanixFSTargetParams(formats strfmt.Registry) error {
...
const (
	...
	// RecoverElastifileFilesParamsTargetEnvironmentKNutanixFS captures enum value "kNutanixFS"
	RecoverElastifileFilesParamsTargetEnvironmentKNutanixFS string = "kNutanixFS"
)
...
func (m *RecoverElastifileFilesParams) contextValidateNutanixFSTargetParams(ctx context.Context, formats strfmt.Registry) error {
