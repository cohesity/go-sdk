...
type OracleDbChannel struct {
	...
	DatabaseNodeList []*OracleDatabaseHost `json:"databaseNodeList"`
...
func (m *OracleDbChannel) validateDatabaseNodeList(formats strfmt.Registry) error {
...
func (m *OracleDbChannel) contextValidateDatabaseNodeList(ctx context.Context, formats strfmt.Registry) error {
