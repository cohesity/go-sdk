...
// AwsTargetParamsForRecoverFileAndFolder AWS Target Params for Recover File And Folder
//
// Specifies the parameters for an AWS recovery target.
//
// swagger:model AwsTargetParamsForRecoverFileAndFolder
type AwsTargetParamsForRecoverFileAndFolder struct {
	...
	NewTargetConfig *AwsRecoverFilesNewTargetConfig `json:"newTargetConfig,omitempty"`

	// Specifies the configuration for recovering to the original target.
	OriginalTargetConfig *AwsRecoverFilesOriginalTargetConfig `json:"originalTargetConfig,omitempty"`
...
// Validate validates this aws target params for recover file and folder
func (m *AwsTargetParamsForRecoverFileAndFolder) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AwsTargetParamsForRecoverFileAndFolder) validateNewTargetConfig(formats strfmt.Registry) error {
...
func (m *AwsTargetParamsForRecoverFileAndFolder) validateOriginalTargetConfig(formats strfmt.Registry) error {
...
func (m *AwsTargetParamsForRecoverFileAndFolder) validateRecoverToOriginalTarget(formats strfmt.Registry) error {
...
func (m *AwsTargetParamsForRecoverFileAndFolder) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this aws target params for recover file and folder based on the context it is used
func (m *AwsTargetParamsForRecoverFileAndFolder) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AwsTargetParamsForRecoverFileAndFolder) contextValidateNewTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsTargetParamsForRecoverFileAndFolder) contextValidateOriginalTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsTargetParamsForRecoverFileAndFolder) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AwsTargetParamsForRecoverFileAndFolder) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AwsTargetParamsForRecoverFileAndFolder) UnmarshalBinary(b []byte) error {
	var res AwsTargetParamsForRecoverFileAndFolder
