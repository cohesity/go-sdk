...
// OriginalElastifileFilesTargetParams Recover To Original Elastifile Files Target Params.
//
// Specifies the params of the original Elastifile recovery target.
//
// swagger:model OriginalElastifileFilesTargetParams
...
// Validate validates this original elastifile files target params
func (m *OriginalElastifileFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalElastifileFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *OriginalElastifileFilesTargetParams) validateRecoverToOriginalPath(formats strfmt.Registry) error {
...
func (m *OriginalElastifileFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this original elastifile files target params based on the context it is used
func (m *OriginalElastifileFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OriginalElastifileFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalElastifileFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OriginalElastifileFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OriginalElastifileFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res OriginalElastifileFilesTargetParams
