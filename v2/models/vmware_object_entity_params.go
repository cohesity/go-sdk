...
type VmwareObjectEntityParams struct {
	...
	// Specifies the name associated with the object.
	...
	// Specifies the uuid associated with the object.
...
const (
	...
	// VmwareObjectEntityParamsTypeKProviderVDC captures enum value "kProviderVDC"
	VmwareObjectEntityParamsTypeKProviderVDC string = "kProviderVDC"

	// VmwareObjectEntityParamsTypeKPlacementPolicy captures enum value "kPlacementPolicy"
	VmwareObjectEntityParamsTypeKPlacementPolicy string = "kPlacementPolicy"

	// VmwareObjectEntityParamsTypeKSizingPolicy captures enum value "kSizingPolicy"
	VmwareObjectEntityParamsTypeKSizingPolicy string = "kSizingPolicy"

	// VmwareObjectEntityParamsTypeKComputePolicy captures enum value "kComputePolicy"
	VmwareObjectEntityParamsTypeKComputePolicy string = "kComputePolicy"
)
