...
const (
	...
	// ProtectdObjectsActionRequestObjectActionKeyKGCPBigQuery captures enum value "kGCPBigQuery"
	ProtectdObjectsActionRequestObjectActionKeyKGCPBigQuery string = "kGCPBigQuery"

	// ProtectdObjectsActionRequestObjectActionKeyKGCPMySQL captures enum value "kGCPMySQL"
	ProtectdObjectsActionRequestObjectActionKeyKGCPMySQL string = "kGCPMySQL"

	// ProtectdObjectsActionRequestObjectActionKeyKGCPSQLServer captures enum value "kGCPSQLServer"
	ProtectdObjectsActionRequestObjectActionKeyKGCPSQLServer string = "kGCPSQLServer"

	// ProtectdObjectsActionRequestObjectActionKeyKGCPPostgreSQL captures enum value "kGCPPostgreSQL"
	ProtectdObjectsActionRequestObjectActionKeyKGCPPostgreSQL string = "kGCPPostgreSQL"

	// ProtectdObjectsActionRequestObjectActionKeyKGCPAlloyDBPostgreSQL captures enum value "kGCPAlloyDBPostgreSQL"
	ProtectdObjectsActionRequestObjectActionKeyKGCPAlloyDBPostgreSQL string = "kGCPAlloyDBPostgreSQL"

	// ProtectdObjectsActionRequestObjectActionKeyKGCPFirestore captures enum value "kGCPFirestore"
	ProtectdObjectsActionRequestObjectActionKeyKGCPFirestore string = "kGCPFirestore"

	// ProtectdObjectsActionRequestObjectActionKeyKGoogleSpanner captures enum value "kGoogleSpanner"
	ProtectdObjectsActionRequestObjectActionKeyKGoogleSpanner string = "kGoogleSpanner"

	// ProtectdObjectsActionRequestObjectActionKeyKGCPBigtable captures enum value "kGCPBigtable"
	ProtectdObjectsActionRequestObjectActionKeyKGCPBigtable string = "kGCPBigtable"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKRDSPostgresSnapshotManager captures enum value "kRDSPostgresSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSPostgresSnapshotManager string = "kRDSPostgresSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKRDSMySQLSnapshotManager captures enum value "kRDSMySQLSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSMySQLSnapshotManager string = "kRDSMySQLSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKRDSMSSQLSnapshotManager captures enum value "kRDSMSSQLSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSMSSQLSnapshotManager string = "kRDSMSSQLSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKRDSOracleSnapshotManager captures enum value "kRDSOracleSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSOracleSnapshotManager string = "kRDSOracleSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKRDSMariaDBSnapshotManager captures enum value "kRDSMariaDBSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSMariaDBSnapshotManager string = "kRDSMariaDBSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKRDSCustomMSSQLSnapshotManager captures enum value "kRDSCustomMSSQLSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSCustomMSSQLSnapshotManager string = "kRDSCustomMSSQLSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKRDSCustomOracleSnapshotManager captures enum value "kRDSCustomOracleSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKRDSCustomOracleSnapshotManager string = "kRDSCustomOracleSnapshotManager"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKAuroraPostgresSnapshotManager captures enum value "kAuroraPostgresSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKAuroraPostgresSnapshotManager string = "kAuroraPostgresSnapshotManager"

	// ProtectdObjectsActionRequestObjectActionKeyKAuroraMySQLSnapshotManager captures enum value "kAuroraMySQLSnapshotManager"
	ProtectdObjectsActionRequestObjectActionKeyKAuroraMySQLSnapshotManager string = "kAuroraMySQLSnapshotManager"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKAWSMySQL captures enum value "kAWSMySQL"
	ProtectdObjectsActionRequestObjectActionKeyKAWSMySQL string = "kAWSMySQL"

	// ProtectdObjectsActionRequestObjectActionKeyKAWSAuroraMySQL captures enum value "kAWSAuroraMySQL"
	ProtectdObjectsActionRequestObjectActionKeyKAWSAuroraMySQL string = "kAWSAuroraMySQL"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKAWSRdsOracle captures enum value "kAWSRdsOracle"
	ProtectdObjectsActionRequestObjectActionKeyKAWSRdsOracle string = "kAWSRdsOracle"

	// ProtectdObjectsActionRequestObjectActionKeyKAWSDocumentDB captures enum value "kAWSDocumentDB"
	ProtectdObjectsActionRequestObjectActionKeyKAWSDocumentDB string = "kAWSDocumentDB"

	// ProtectdObjectsActionRequestObjectActionKeyKAWSRDSPostgresDB captures enum value "kAWSRDSPostgresDB"
	ProtectdObjectsActionRequestObjectActionKeyKAWSRDSPostgresDB string = "kAWSRDSPostgresDB"

	// ProtectdObjectsActionRequestObjectActionKeyKAWSAuroraPostgresDB captures enum value "kAWSAuroraPostgresDB"
	ProtectdObjectsActionRequestObjectActionKeyKAWSAuroraPostgresDB string = "kAWSAuroraPostgresDB"

	// ProtectdObjectsActionRequestObjectActionKeyKAWSRDSMSSQL captures enum value "kAWSRDSMSSQL"
	ProtectdObjectsActionRequestObjectActionKeyKAWSRDSMSSQL string = "kAWSRDSMSSQL"

	// ProtectdObjectsActionRequestObjectActionKeyKAWSRedshift captures enum value "kAWSRedshift"
	ProtectdObjectsActionRequestObjectActionKeyKAWSRedshift string = "kAWSRedshift"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKAzureMySQL captures enum value "kAzureMySQL"
	ProtectdObjectsActionRequestObjectActionKeyKAzureMySQL string = "kAzureMySQL"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureCosmosDBNoSQL captures enum value "kAzureCosmosDBNoSQL"
	ProtectdObjectsActionRequestObjectActionKeyKAzureCosmosDBNoSQL string = "kAzureCosmosDBNoSQL"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureCosmosDBMongoDB captures enum value "kAzureCosmosDBMongoDB"
	ProtectdObjectsActionRequestObjectActionKeyKAzureCosmosDBMongoDB string = "kAzureCosmosDBMongoDB"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureBlobStorage captures enum value "kAzureBlobStorage"
	ProtectdObjectsActionRequestObjectActionKeyKAzureBlobStorage string = "kAzureBlobStorage"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureCosmosDBCassandra captures enum value "kAzureCosmosDBCassandra"
	ProtectdObjectsActionRequestObjectActionKeyKAzureCosmosDBCassandra string = "kAzureCosmosDBCassandra"

	// ProtectdObjectsActionRequestObjectActionKeyKAzurePostgreSQLServer captures enum value "kAzurePostgreSQLServer"
	ProtectdObjectsActionRequestObjectActionKeyKAzurePostgreSQLServer string = "kAzurePostgreSQLServer"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureSQLDB captures enum value "kAzureSQLDB"
	ProtectdObjectsActionRequestObjectActionKeyKAzureSQLDB string = "kAzureSQLDB"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureSQLMI captures enum value "kAzureSQLMI"
	ProtectdObjectsActionRequestObjectActionKeyKAzureSQLMI string = "kAzureSQLMI"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureTableStorage captures enum value "kAzureTableStorage"
	ProtectdObjectsActionRequestObjectActionKeyKAzureTableStorage string = "kAzureTableStorage"

	// ProtectdObjectsActionRequestObjectActionKeyKAzureTableAPI captures enum value "kAzureTableAPI"
	ProtectdObjectsActionRequestObjectActionKeyKAzureTableAPI string = "kAzureTableAPI"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKNutanixFS captures enum value "kNutanixFS"
	ProtectdObjectsActionRequestObjectActionKeyKNutanixFS string = "kNutanixFS"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKS3Compatible captures enum value "kS3Compatible"
	ProtectdObjectsActionRequestObjectActionKeyKS3Compatible string = "kS3Compatible"
	...
	// ProtectdObjectsActionRequestObjectActionKeyKGoogleWorkspace captures enum value "kGoogleWorkspace"
	ProtectdObjectsActionRequestObjectActionKeyKGoogleWorkspace string = "kGoogleWorkspace"

	// ProtectdObjectsActionRequestObjectActionKeyKGmail captures enum value "kGmail"
	ProtectdObjectsActionRequestObjectActionKeyKGmail string = "kGmail"

	// ProtectdObjectsActionRequestObjectActionKeyKGoogleDrive captures enum value "kGoogleDrive"
	ProtectdObjectsActionRequestObjectActionKeyKGoogleDrive string = "kGoogleDrive"

	// ProtectdObjectsActionRequestObjectActionKeyKDB2 captures enum value "kDB2"
	ProtectdObjectsActionRequestObjectActionKeyKDB2 string = "kDB2"

	// ProtectdObjectsActionRequestObjectActionKeyKServiceNow captures enum value "kServiceNow"
	ProtectdObjectsActionRequestObjectActionKeyKServiceNow string = "kServiceNow"

	// ProtectdObjectsActionRequestObjectActionKeyKSalesforce captures enum value "kSalesforce"
	ProtectdObjectsActionRequestObjectActionKeyKSalesforce string = "kSalesforce"

	// ProtectdObjectsActionRequestObjectActionKeyKPostgres captures enum value "kPostgres"
	ProtectdObjectsActionRequestObjectActionKeyKPostgres string = "kPostgres"

	// ProtectdObjectsActionRequestObjectActionKeyKJira captures enum value "kJira"
	ProtectdObjectsActionRequestObjectActionKeyKJira string = "kJira"

	// ProtectdObjectsActionRequestObjectActionKeyKPinecone captures enum value "kPinecone"
	ProtectdObjectsActionRequestObjectActionKeyKPinecone string = "kPinecone"
)
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kAWSNative","kAWSSnapshotManager","kPhysical","kSQL","kOracle","kRDSSnapshotManager","kRDSPostgresSnapshotManager","kRDSMySQLSnapshotManager","kRDSMSSQLSnapshotManager","kRDSOracleSnapshotManager","kRDSMariaDBSnapshotManager","kRDSCustomMSSQLSnapshotManager","kRDSCustomOracleSnapshotManager","kAuroraSnapshotManager","kAuroraPostgresSnapshotManager","kAuroraMySQLSnapshotManager","kAwsS3","kAwsRDSPostgresBackup","kAzureNative","kAzureSnapshotManager","kAzureSQL","kAwsAuroraPostgres","kAwsRDSPostgres","kAWSMySQL","kAWSDocumentDB","kAWSRdsOracle","kAzureEntraID","kAzureMySQL","kAzureCosmosDBNoSQL","kAzureCosmosDBMongoDB","kAzureBlobStorage","kAzureCosmosDBCassandra","kAzurePostgreSQLServer","kAzureCassandra","kAzurePostgreSQL","kAzureSQLDB","kAzureSQLMI","kAzureTableStorage","kAzureTableAPI","kAwsDynamoDB","kO365Exchange","kO365OneDrive","kAWSAuroraMySQL","kNutanixFS","kAWSRDSPostgresDB","kAWSAuroraPostgresDB","kAWSRDSMSSQL","kAWSRedshift"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
