...
var clusterSWUpdateParamsTypeNodeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		clusterSWUpdateParamsTypeNodeTypePropEnum = append(clusterSWUpdateParamsTypeNodeTypePropEnum, v)
	}
}

const (

	// ClusterSWUpdateParamsNodeTypeClusterNode captures enum value "ClusterNode"
	ClusterSWUpdateParamsNodeTypeClusterNode string = "ClusterNode"

	// ClusterSWUpdateParamsNodeTypeFreeNode captures enum value "FreeNode"
	ClusterSWUpdateParamsNodeTypeFreeNode string = "FreeNode"

	// ClusterSWUpdateParamsNodeTypeConnectorNode captures enum value "ConnectorNode"
	ClusterSWUpdateParamsNodeTypeConnectorNode string = "ConnectorNode"
)

// prop value enum
func (m *ClusterSWUpdateParams) validateNodeTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, clusterSWUpdateParamsTypeNodeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ClusterSWUpdateParams) validateNodeType(formats strfmt.Registry) error {
