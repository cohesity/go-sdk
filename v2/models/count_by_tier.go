...
type CountByTier struct {
	...
	// Enum: [PCIeSSD SATASSD SATAHDD CLOUD]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["PCIeSSD","SATASSD","SATAHDD","CLOUD"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// CountByTierStorageTierSATASSD captures enum value "SATASSD"
	CountByTierStorageTierSATASSD string = "SATASSD"

	// CountByTierStorageTierSATAHDD captures enum value "SATAHDD"
	CountByTierStorageTierSATAHDD string = "SATAHDD"
