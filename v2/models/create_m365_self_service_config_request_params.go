...
type CreateM365SelfServiceConfigRequestParams struct {
	...
	// Specifies the domain name of the Microsoft365 Source.
	// Required: true
	...
	// Specifies the OpenID Connect configuration of the IdP to be used for Self-Service login workflows.
	OidcConfig *OIDCStandardConfiguration `json:"oidcConfig,omitempty"`
	...
	// Specifies the authentication mode for Self Service workflow. If unspecified this will default to Azure AD. Otherwise Self-Service will use associated IdP OIDC Configuration.
	// Enum: [AzureAD CustomIdP]
	PreferredAuthenticationMode *string `json:"preferredAuthenticationMode,omitempty"`
...
func (m *CreateM365SelfServiceConfigRequestParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePreferredAuthenticationMode(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CreateM365SelfServiceConfigRequestParams) validateDomain(formats strfmt.Registry) error {
...
func (m *CreateM365SelfServiceConfigRequestParams) validateOidcConfig(formats strfmt.Registry) error {
...
var createM365SelfServiceConfigRequestParamsTypePreferredAuthenticationModePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["AzureAD","CustomIdP"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		createM365SelfServiceConfigRequestParamsTypePreferredAuthenticationModePropEnum = append(createM365SelfServiceConfigRequestParamsTypePreferredAuthenticationModePropEnum, v)
	}
}

const (

	// CreateM365SelfServiceConfigRequestParamsPreferredAuthenticationModeAzureAD captures enum value "AzureAD"
	CreateM365SelfServiceConfigRequestParamsPreferredAuthenticationModeAzureAD string = "AzureAD"

	// CreateM365SelfServiceConfigRequestParamsPreferredAuthenticationModeCustomIDP captures enum value "CustomIdP"
	CreateM365SelfServiceConfigRequestParamsPreferredAuthenticationModeCustomIDP string = "CustomIdP"
)

// prop value enum
func (m *CreateM365SelfServiceConfigRequestParams) validatePreferredAuthenticationModeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createM365SelfServiceConfigRequestParamsTypePreferredAuthenticationModePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreateM365SelfServiceConfigRequestParams) validatePreferredAuthenticationMode(formats strfmt.Registry) error {
	if swag.IsZero(m.PreferredAuthenticationMode) { // not required
		return nil
	}

	// value enum
	if err := m.validatePreferredAuthenticationModeEnum("preferredAuthenticationMode", "body", *m.PreferredAuthenticationMode); err != nil {
		return err
	}
...
func (m *CreateM365SelfServiceConfigRequestParams) contextValidateOidcConfig(ctx context.Context, formats strfmt.Registry) error {
