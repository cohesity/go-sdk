...
func (m *VmwareProtectionGroupParams) validateGlobalIncludeDisks(formats strfmt.Registry) error {
...
func (m *VmwareProtectionGroupParams) contextValidateGlobalIncludeDisks(ctx context.Context, formats strfmt.Registry) error {
