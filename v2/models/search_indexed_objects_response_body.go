...
type SearchIndexedObjectsResponseBody struct {
	...
	// gmail objects
	GmailObjects GmailObjects `json:"gmailObjects,omitempty"`

	// google drive objects
	GoogleDriveObjects GoogleDriveObjects `json:"googleDriveObjects,omitempty"`
...
func (m *SearchIndexedObjectsResponseBody) UnmarshalJSON(raw []byte) error {
	...
	m.GmailObjects = dataAO1.GmailObjects

	m.GoogleDriveObjects = dataAO1.GoogleDriveObjects
...
func (m SearchIndexedObjectsResponseBody) MarshalJSON() ([]byte, error) {
	...
	dataAO1.GmailObjects = m.GmailObjects

	dataAO1.GoogleDriveObjects = m.GoogleDriveObjects
...
func (m *SearchIndexedObjectsResponseBody) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGmailObjects(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateGoogleDriveObjects(formats); err != nil {
		res = append(res, err)
	}
...
func (m *SearchIndexedObjectsResponseBody) validateGmailObjects(formats strfmt.Registry) error {

	if swag.IsZero(m.GmailObjects) { // not required
		return nil
	}

	if err := m.GmailObjects.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("gmailObjects")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("gmailObjects")
		}
		return err
	}
...
func (m *SearchIndexedObjectsResponseBody) validateGoogleDriveObjects(formats strfmt.Registry) error {

	if swag.IsZero(m.GoogleDriveObjects) { // not required
		return nil
	}

	if err := m.GoogleDriveObjects.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("googleDriveObjects")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("googleDriveObjects")
		}
		return err
	}
...
func (m *SearchIndexedObjectsResponseBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGmailObjects(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateGoogleDriveObjects(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SearchIndexedObjectsResponseBody) contextValidateGmailObjects(ctx context.Context, formats strfmt.Registry) error {

	if err := m.GmailObjects.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("gmailObjects")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("gmailObjects")
...
func (m *SearchIndexedObjectsResponseBody) contextValidateGoogleDriveObjects(ctx context.Context, formats strfmt.Registry) error {

	if err := m.GoogleDriveObjects.ContextValidate(ctx, formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("googleDriveObjects")
		} else if ce, ok := err.(*errors.CompositeError); ok {
			return ce.ValidateName("googleDriveObjects")
