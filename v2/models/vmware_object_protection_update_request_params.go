...
func (m *VmwareObjectProtectionUpdateRequestParams) UnmarshalJSON(raw []byte) error {
	...
	m.GlobalExcludeDisks = dataAO2.GlobalExcludeDisks

	m.GlobalIncludeDisks = dataAO2.GlobalIncludeDisks
...
func (m VmwareObjectProtectionUpdateRequestParams) MarshalJSON() ([]byte, error) {
	...
	dataAO2.GlobalExcludeDisks = m.GlobalExcludeDisks

	dataAO2.GlobalIncludeDisks = m.GlobalIncludeDisks
...
func (m *VmwareObjectProtectionUpdateRequestParams) validateGlobalExcludeDisks(formats strfmt.Registry) error {
...
func (m *VmwareObjectProtectionUpdateRequestParams) validateGlobalIncludeDisks(formats strfmt.Registry) error {
...
func (m *VmwareObjectProtectionUpdateRequestParams) contextValidateGlobalExcludeDisks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VmwareObjectProtectionUpdateRequestParams) contextValidateGlobalIncludeDisks(ctx context.Context, formats strfmt.Registry) error {
