...
// PhysicalTargetParamsForMountVolume Physical Recovery Target Params
//
// Specifies the parameters for a physical recovery target.
//
// swagger:model PhysicalTargetParamsForMountVolume
type PhysicalTargetParamsForMountVolume struct {
	...
	NewTargetConfig *PhysicalMountVolumesNewTargetConfig `json:"newTargetConfig,omitempty"`

	// Specifies the configuration for mounting to the original target.
	OriginalTargetConfig *PhysicalMountVolumesOriginalTargetConfig `json:"originalTargetConfig,omitempty"`
...
// Validate validates this physical target params for mount volume
func (m *PhysicalTargetParamsForMountVolume) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PhysicalTargetParamsForMountVolume) validateMountToOriginalTarget(formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) validateMountedVolumeMapping(formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) validateNewTargetConfig(formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) validateOriginalTargetConfig(formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) validateVlanConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this physical target params for mount volume based on the context it is used
func (m *PhysicalTargetParamsForMountVolume) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PhysicalTargetParamsForMountVolume) contextValidateMountedVolumeMapping(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) contextValidateNewTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) contextValidateOriginalTargetConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PhysicalTargetParamsForMountVolume) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PhysicalTargetParamsForMountVolume) UnmarshalBinary(b []byte) error {
	var res PhysicalTargetParamsForMountVolume
