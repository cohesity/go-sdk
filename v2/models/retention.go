...
// Validate validates this retention
func (m *Retention) Validate(formats strfmt.Registry) error {
	var res []error
...
var retentionTypeUnitPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		retentionTypeUnitPropEnum = append(retentionTypeUnitPropEnum, v)
	}
}

const (

	// RetentionUnitDays captures enum value "Days"
	RetentionUnitDays string = "Days"

	// RetentionUnitWeeks captures enum value "Weeks"
	RetentionUnitWeeks string = "Weeks"

	// RetentionUnitMonths captures enum value "Months"
	RetentionUnitMonths string = "Months"

	// RetentionUnitYears captures enum value "Years"
	RetentionUnitYears string = "Years"
)

// prop value enum
func (m *Retention) validateUnitEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, retentionTypeUnitPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *Retention) validateUnit(formats strfmt.Registry) error {
...
func (m *Retention) validateDuration(formats strfmt.Registry) error {
...
func (m *Retention) validateDataLockConfig(formats strfmt.Registry) error {
...
// ContextValidate validate this retention based on the context it is used
func (m *Retention) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Retention) contextValidateDataLockConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Retention) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Retention) UnmarshalBinary(b []byte) error {
	var res Retention
