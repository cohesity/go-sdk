...
// RecoverOtherNasToFlashbladeFilesTargetParams Recover To Flashblade Files Target Params.
//
// Specifies the params of the Flashblade recovery target.
//
// swagger:model RecoverOtherNasToFlashbladeFilesTargetParams
...
// Validate validates this recover other nas to flashblade files target params
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) validateAlternatePath(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) validateFilterIPConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) validateParentSource(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) validateVlanConfig(formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) validateVolume(formats strfmt.Registry) error {
...
// ContextValidate validate this recover other nas to flashblade files target params based on the context it is used
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) contextValidateFilterIPConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) contextValidateParentSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) contextValidateVlanConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) contextValidateVolume(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RecoverOtherNasToFlashbladeFilesTargetParams) UnmarshalBinary(b []byte) error {
	var res RecoverOtherNasToFlashbladeFilesTargetParams
