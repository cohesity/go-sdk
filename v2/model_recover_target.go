...
// checks if the RecoverTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverTarget{}
...
type _RecoverTarget RecoverTarget
...
func (o RecoverTarget) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverTarget := _RecoverTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverTarget)

	if err != nil {
		return err
	}

	*o = RecoverTarget(varRecoverTarget)
