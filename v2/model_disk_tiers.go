...
// checks if the DiskTiers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiskTiers{}
...
func (o DiskTiers) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DiskTiers) {
