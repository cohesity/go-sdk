...
// checks if the AlertGroupSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertGroupSummary{}
...
func (o *AlertGroupSummary) GetCriticalCount() int64 {
	if o == nil || IsNil(o.CriticalCount.Get()) {
		var ret int64
		return ret
	}
...
func (o *AlertGroupSummary) GetInfoCount() int64 {
	if o == nil || IsNil(o.InfoCount.Get()) {
		var ret int64
		return ret
	}
...
func (o *AlertGroupSummary) GetWarningCount() int64 {
	if o == nil || IsNil(o.WarningCount.Get()) {
		var ret int64
		return ret
	}
...
func (o AlertGroupSummary) ToMap() (map[string]interface{}, error) {
