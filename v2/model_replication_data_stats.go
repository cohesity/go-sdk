...
// checks if the ReplicationDataStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicationDataStats{}
...
func (o ReplicationDataStats) ToMap() (map[string]interface{}, error) {
