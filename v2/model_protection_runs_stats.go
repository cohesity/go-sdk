...
// checks if the ProtectionRunsStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRunsStats{}
...
func (o *ProtectionRunsStats) GetProtectionRunStatus() string {
	if o == nil || IsNil(o.ProtectionRunStatus.Get()) {
		var ret string
		return ret
	}
...
func (o *ProtectionRunsStats) GetProtectionRunsCount() int64 {
	if o == nil || IsNil(o.ProtectionRunsCount.Get()) {
		var ret int64
		return ret
	}
...
func (o ProtectionRunsStats) ToMap() (map[string]interface{}, error) {
