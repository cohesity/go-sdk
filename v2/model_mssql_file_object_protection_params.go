...
// checks if the MssqlFileObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MssqlFileObjectProtectionParams{}
...
type _MssqlFileObjectProtectionParams MssqlFileObjectProtectionParams
...
func NewMssqlFileObjectProtectionParams(objects []MssqlFileObjectProtection) *MssqlFileObjectProtectionParams {
	this := MssqlFileObjectProtectionParams{}
...
func (o *MssqlFileObjectProtectionParams) SetAagBackupPreferenceTypeNil() {
...
func (o *MssqlFileObjectProtectionParams) SetBackupSystemDbsNil() {
...
func (o *MssqlFileObjectProtectionParams) SetFullBackupsCopyOnlyNil() {
...
func (o *MssqlFileObjectProtectionParams) SetLogBackupNumStreamsNil() {
...
func (o *MssqlFileObjectProtectionParams) SetLogBackupWithClauseNil() {
...
func (o *MssqlFileObjectProtectionParams) SetUseAagPreferencesFromServerNil() {
...
func (o *MssqlFileObjectProtectionParams) SetUserDbBackupPreferenceTypeNil() {
...
func (o MssqlFileObjectProtectionParams) MarshalJSON() ([]byte, error) {
...
func (o MssqlFileObjectProtectionParams) ToMap() (map[string]interface{}, error) {
...
func (o *MssqlFileObjectProtectionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMssqlFileObjectProtectionParams := _MssqlFileObjectProtectionParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMssqlFileObjectProtectionParams)

	if err != nil {
		return err
	}

	*o = MssqlFileObjectProtectionParams(varMssqlFileObjectProtectionParams)

	return err
}

type NullableMssqlFileObjectProtectionParams struct {
	value *MssqlFileObjectProtectionParams
	isSet bool
}

func (v NullableMssqlFileObjectProtectionParams) Get() *MssqlFileObjectProtectionParams {
	return v.value
}

func (v *NullableMssqlFileObjectProtectionParams) Set(val *MssqlFileObjectProtectionParams) {
	v.value = val
	v.isSet = true
}

func (v NullableMssqlFileObjectProtectionParams) IsSet() bool {
	return v.isSet
}

func (v *NullableMssqlFileObjectProtectionParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMssqlFileObjectProtectionParams(val *MssqlFileObjectProtectionParams) *NullableMssqlFileObjectProtectionParams {
	return &NullableMssqlFileObjectProtectionParams{value: val, isSet: true}
}

func (v NullableMssqlFileObjectProtectionParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMssqlFileObjectProtectionParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
