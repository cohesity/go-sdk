...
// checks if the NimbleProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NimbleProtectionGroupParams{}
...
type _NimbleProtectionGroupParams NimbleProtectionGroupParams
...
func (o NimbleProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *NimbleProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varNimbleProtectionGroupParams := _NimbleProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNimbleProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = NimbleProtectionGroupParams(varNimbleProtectionGroupParams)
