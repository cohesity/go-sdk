...
// checks if the SecurityConfigDataClassification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityConfigDataClassification{}
...
func (o *SecurityConfigDataClassification) GetClassifiedDataMessage() string {
	if o == nil || IsNil(o.ClassifiedDataMessage.Get()) {
		var ret string
		return ret
	}
...
func (o *SecurityConfigDataClassification) GetIsDataClassified() bool {
	if o == nil || IsNil(o.IsDataClassified.Get()) {
		var ret bool
		return ret
	}
...
func (o *SecurityConfigDataClassification) GetUnclassifiedDataMessage() string {
	if o == nil || IsNil(o.UnclassifiedDataMessage.Get()) {
		var ret string
		return ret
	}
...
func (o SecurityConfigDataClassification) ToMap() (map[string]interface{}, error) {
