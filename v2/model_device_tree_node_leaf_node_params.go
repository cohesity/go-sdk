...
// checks if the DeviceTreeNodeLeafNodeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceTreeNodeLeafNodeParams{}

// DeviceTreeNodeLeafNodeParams Specifies the parameters for a leaf node.
type DeviceTreeNodeLeafNodeParams struct {
...
func NewDeviceTreeNodeLeafNodeParams() *DeviceTreeNodeLeafNodeParams {
	this := DeviceTreeNodeLeafNodeParams{}
	return &this
}
...
func (o *DeviceTreeNodeLeafNodeParams) SetDiskNameNil() {
	o.DiskName.Set(nil)
}
...
func (o *DeviceTreeNodeLeafNodeParams) SetLengthBytesNil() {
...
func (o *DeviceTreeNodeLeafNodeParams) SetOffsetBytesNil() {
...
func (o *DeviceTreeNodeLeafNodeParams) SetPartitionNumberNil() {
...
func (o DeviceTreeNodeLeafNodeParams) MarshalJSON() ([]byte, error) {
...
func (o DeviceTreeNodeLeafNodeParams) ToMap() (map[string]interface{}, error) {
...
type NullableDeviceTreeNodeLeafNodeParams struct {
	value *DeviceTreeNodeLeafNodeParams
	isSet bool
}

func (v NullableDeviceTreeNodeLeafNodeParams) Get() *DeviceTreeNodeLeafNodeParams {
	return v.value
}

func (v *NullableDeviceTreeNodeLeafNodeParams) Set(val *DeviceTreeNodeLeafNodeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceTreeNodeLeafNodeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceTreeNodeLeafNodeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceTreeNodeLeafNodeParams(val *DeviceTreeNodeLeafNodeParams) *NullableDeviceTreeNodeLeafNodeParams {
	return &NullableDeviceTreeNodeLeafNodeParams{value: val, isSet: true}
}

func (v NullableDeviceTreeNodeLeafNodeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceTreeNodeLeafNodeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
