...
// checks if the LocalGlobalObjectIds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalGlobalObjectIds{}
...
func (o LocalGlobalObjectIds) ToMap() (map[string]interface{}, error) {
