...
// checks if the GetProtectionRunsStatusResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetProtectionRunsStatusResponseBody{}
...
func (o *GetProtectionRunsStatusResponseBody) GetProtectionRunsStatsListOk() ([]ProtectionRunsStatsList, bool) {
	if o == nil || IsNil(o.ProtectionRunsStatsList) {
		return nil, false
	}
...
func (o GetProtectionRunsStatusResponseBody) ToMap() (map[string]interface{}, error) {
