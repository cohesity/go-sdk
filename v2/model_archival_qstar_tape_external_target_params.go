...
// checks if the ArchivalQstarTapeExternalTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArchivalQstarTapeExternalTargetParams{}
...
type _ArchivalQstarTapeExternalTargetParams ArchivalQstarTapeExternalTargetParams
...
func (o *ArchivalQstarTapeExternalTargetParams) GetIntegralVolumeNamesOk() ([]string, bool) {
	if o == nil || IsNil(o.IntegralVolumeNames) {
		return nil, false
	}
...
func (o *ArchivalQstarTapeExternalTargetParams) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o ArchivalQstarTapeExternalTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *ArchivalQstarTapeExternalTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varArchivalQstarTapeExternalTargetParams := _ArchivalQstarTapeExternalTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varArchivalQstarTapeExternalTargetParams)

	if err != nil {
		return err
	}

	*o = ArchivalQstarTapeExternalTargetParams(varArchivalQstarTapeExternalTargetParams)
