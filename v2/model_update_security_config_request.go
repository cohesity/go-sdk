...
// checks if the UpdateSecurityConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSecurityConfigRequest{}
...
func (o *UpdateSecurityConfigRequest) SetAuthTokenTimeoutMinutesNil() {
...
func (o *UpdateSecurityConfigRequest) SetInactivityTimeoutMSecsNil() {
...
func (o UpdateSecurityConfigRequest) ToMap() (map[string]interface{}, error) {
