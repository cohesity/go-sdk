...
// checks if the ObjectLinkingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectLinkingRequest{}
...
func (o ObjectLinkingRequest) ToMap() (map[string]interface{}, error) {
