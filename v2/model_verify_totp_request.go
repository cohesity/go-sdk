...
// checks if the VerifyTotpRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VerifyTotpRequest{}
...
func (o VerifyTotpRequest) ToMap() (map[string]interface{}, error) {
