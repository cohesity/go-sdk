...
// checks if the PerformRunActionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PerformRunActionResponse{}
...
func (o PerformRunActionResponse) ToMap() (map[string]interface{}, error) {
