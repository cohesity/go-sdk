...
// checks if the IncrementalSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncrementalSchedule{}
...
type _IncrementalSchedule IncrementalSchedule
...
func (o IncrementalSchedule) ToMap() (map[string]interface{}, error) {
...
func (o *IncrementalSchedule) UnmarshalJSON(data []byte) (err error) {
	...
	varIncrementalSchedule := _IncrementalSchedule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncrementalSchedule)

	if err != nil {
		return err
	}

	*o = IncrementalSchedule(varIncrementalSchedule)
