...
// checks if the ViewOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewOptions{}
...
func (o *ViewOptions) GetWhitelistRestoreViewForAll() bool {
	if o == nil || IsNil(o.WhitelistRestoreViewForAll.Get()) {
		var ret bool
		return ret
	}
...
func (o ViewOptions) ToMap() (map[string]interface{}, error) {
