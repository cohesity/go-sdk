...
// checks if the PhysicalProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalProtectionGroupParams{}
...
type _PhysicalProtectionGroupParams PhysicalProtectionGroupParams
...
func (o *PhysicalProtectionGroupParams) GetFileProtectionTypeParams() PhysicalFileProtectionGroupParams {
	if o == nil || IsNil(o.FileProtectionTypeParams.Get()) {
...
func (o *PhysicalProtectionGroupParams) GetVolumeProtectionTypeParams() PhysicalVolumeProtectionGroupParams {
	if o == nil || IsNil(o.VolumeProtectionTypeParams.Get()) {
...
func (o PhysicalProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalProtectionGroupParams := _PhysicalProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhysicalProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = PhysicalProtectionGroupParams(varPhysicalProtectionGroupParams)
