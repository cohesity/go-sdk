...
// checks if the CreateTotpKeyRequestBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTotpKeyRequestBody{}
...
func (o *CreateTotpKeyRequestBody) GetTotpKeyName() string {
	if o == nil || IsNil(o.TotpKeyName.Get()) {
		var ret string
		return ret
	}
...
func (o CreateTotpKeyRequestBody) ToMap() (map[string]interface{}, error) {
