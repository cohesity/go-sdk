...
// checks if the RecoverHdfsParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverHdfsParams{}
...
type _RecoverHdfsParams RecoverHdfsParams
...
func (o *RecoverHdfsParams) GetTargetDirectory() string {
	if o == nil || IsNil(o.TargetDirectory.Get()) {
		var ret string
		return ret
	}
...
func (o RecoverHdfsParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverHdfsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverHdfsParams := _RecoverHdfsParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverHdfsParams)

	if err != nil {
		return err
	}

	*o = RecoverHdfsParams(varRecoverHdfsParams)
