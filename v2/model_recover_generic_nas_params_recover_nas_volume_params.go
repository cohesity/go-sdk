...
// checks if the RecoverGenericNasParamsRecoverNasVolumeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGenericNasParamsRecoverNasVolumeParams{}

// RecoverGenericNasParamsRecoverNasVolumeParams Specifies the parameters to recover Nas Volumes.
type RecoverGenericNasParamsRecoverNasVolumeParams struct {
...
type _RecoverGenericNasParamsRecoverNasVolumeParams RecoverGenericNasParamsRecoverNasVolumeParams
...
func NewRecoverGenericNasParamsRecoverNasVolumeParams(targetEnvironment string) *RecoverGenericNasParamsRecoverNasVolumeParams {
	this := RecoverGenericNasParamsRecoverNasVolumeParams{}
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetElastifileTargetParamsNil() {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetFlashbladeTargetParamsNil() {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetGenericNasTargetParamsNil() {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetGpfsTargetParamsNil() {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetIsilonTargetParamsNil() {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetNetappTargetParamsNil() {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) SetViewTargetParamsNil() {
...
func (o RecoverGenericNasParamsRecoverNasVolumeParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverGenericNasParamsRecoverNasVolumeParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverGenericNasParamsRecoverNasVolumeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverGenericNasParamsRecoverNasVolumeParams := _RecoverGenericNasParamsRecoverNasVolumeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverGenericNasParamsRecoverNasVolumeParams)

	if err != nil {
		return err
	}

	*o = RecoverGenericNasParamsRecoverNasVolumeParams(varRecoverGenericNasParamsRecoverNasVolumeParams)

	return err
}

type NullableRecoverGenericNasParamsRecoverNasVolumeParams struct {
	value *RecoverGenericNasParamsRecoverNasVolumeParams
	isSet bool
}

func (v NullableRecoverGenericNasParamsRecoverNasVolumeParams) Get() *RecoverGenericNasParamsRecoverNasVolumeParams {
	return v.value
}

func (v *NullableRecoverGenericNasParamsRecoverNasVolumeParams) Set(val *RecoverGenericNasParamsRecoverNasVolumeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverGenericNasParamsRecoverNasVolumeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverGenericNasParamsRecoverNasVolumeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverGenericNasParamsRecoverNasVolumeParams(val *RecoverGenericNasParamsRecoverNasVolumeParams) *NullableRecoverGenericNasParamsRecoverNasVolumeParams {
	return &NullableRecoverGenericNasParamsRecoverNasVolumeParams{value: val, isSet: true}
}

func (v NullableRecoverGenericNasParamsRecoverNasVolumeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverGenericNasParamsRecoverNasVolumeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
