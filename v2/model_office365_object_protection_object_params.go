...
// checks if the Office365ObjectProtectionObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365ObjectProtectionObjectParams{}
...
type _Office365ObjectProtectionObjectParams Office365ObjectProtectionObjectParams
...
func (o *Office365ObjectProtectionObjectParams) GetShouldAutoProtectObject() bool {
	if o == nil || IsNil(o.ShouldAutoProtectObject.Get()) {
		var ret bool
		return ret
	}
...
func (o Office365ObjectProtectionObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *Office365ObjectProtectionObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOffice365ObjectProtectionObjectParams := _Office365ObjectProtectionObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOffice365ObjectProtectionObjectParams)

	if err != nil {
		return err
	}

	*o = Office365ObjectProtectionObjectParams(varOffice365ObjectProtectionObjectParams)
