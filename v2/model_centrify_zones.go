...
// checks if the CentrifyZones type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CentrifyZones{}
...
func (o CentrifyZones) ToMap() (map[string]interface{}, error) {
