...
// checks if the RecoverUdaParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverUdaParams{}
...
type RecoverUdaParams struct {
	...
	RecoveryJobArguments []KeyValuePair `json:"recoveryJobArguments,omitempty"`
...
type _RecoverUdaParams RecoverUdaParams
...
// GetRecoveryJobArguments returns the RecoveryJobArguments field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RecoverUdaParams) GetRecoveryJobArguments() []KeyValuePair {
	if o == nil {
		var ret []KeyValuePair
		return ret
	}
	return o.RecoveryJobArguments
}

// GetRecoveryJobArgumentsOk returns a tuple with the RecoveryJobArguments field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *RecoverUdaParams) GetRecoveryJobArgumentsOk() ([]KeyValuePair, bool) {
	if o == nil || IsNil(o.RecoveryJobArguments) {
		return nil, false
	}
	return o.RecoveryJobArguments, true
}
...
// SetRecoveryJobArguments gets a reference to the given []KeyValuePair and assigns it to the RecoveryJobArguments field.
func (o *RecoverUdaParams) SetRecoveryJobArguments(v []KeyValuePair) {
	o.RecoveryJobArguments = v
}
...
func (o RecoverUdaParams) ToMap() (map[string]interface{}, error) {
	...
	if o.RecoveryJobArguments != nil {
		toSerialize["recoveryJobArguments"] = o.RecoveryJobArguments
	}
	if o.Snapshots != nil {
...
func (o *RecoverUdaParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverUdaParams := _RecoverUdaParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverUdaParams)

	if err != nil {
		return err
	}

	*o = RecoverUdaParams(varRecoverUdaParams)
