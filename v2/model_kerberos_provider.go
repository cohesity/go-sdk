...
// checks if the KerberosProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosProvider{}
...
type _KerberosProvider KerberosProvider
...
func (o KerberosProvider) ToMap() (map[string]interface{}, error) {
...
func (o *KerberosProvider) UnmarshalJSON(data []byte) (err error) {
	...
	varKerberosProvider := _KerberosProvider{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKerberosProvider)

	if err != nil {
		return err
	}

	*o = KerberosProvider(varKerberosProvider)
