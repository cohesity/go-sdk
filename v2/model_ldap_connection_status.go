...
// checks if the LdapConnectionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapConnectionStatus{}
...
func (o LdapConnectionStatus) ToMap() (map[string]interface{}, error) {
