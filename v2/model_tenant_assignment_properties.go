...
// checks if the TenantAssignmentProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantAssignmentProperties{}
...
func (o TenantAssignmentProperties) ToMap() (map[string]interface{}, error) {
