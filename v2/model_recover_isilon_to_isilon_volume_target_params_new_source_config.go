...
// checks if the RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig{}

// RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig Specifies the new destination Source configuration parameters where the volumes will be recovered. This is mandatory if recoverToNewSource is set to true.
type RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig struct {
...
type _RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig
...
func NewRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig(volume RecoverOtherNasToIsilonVolumeTargetParamsVolume) *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig {
	this := RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig{}
	this.Volume = volume
	return &this
}
...
func (o *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig := _RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig(varRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig)

	return err
}

type NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig struct {
	value *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig
	isSet bool
}

func (v NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) Get() *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig {
	return v.value
}

func (v *NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) Set(val *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig(val *RecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) *NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig {
	return &NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverIsilonToIsilonVolumeTargetParamsNewSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
