...
// checks if the RecoverHiveNoSqlObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverHiveNoSqlObjectParams{}
...
type _RecoverHiveNoSqlObjectParams RecoverHiveNoSqlObjectParams
...
func (o RecoverHiveNoSqlObjectParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["objectName"] = o.ObjectName.Get()
	return toSerialize, nil
}

func (o *RecoverHiveNoSqlObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverHiveNoSqlObjectParams := _RecoverHiveNoSqlObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverHiveNoSqlObjectParams)

	if err != nil {
		return err
	}

	*o = RecoverHiveNoSqlObjectParams(varRecoverHiveNoSqlObjectParams)
