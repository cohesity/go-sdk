...
// checks if the CreateActiveDirectoryRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateActiveDirectoryRequest{}
...
type CreateActiveDirectoryRequest struct {
	...
	ActiveDirectoryAdminParams map[string]interface{} `json:"activeDirectoryAdminParams"`
...
type _CreateActiveDirectoryRequest CreateActiveDirectoryRequest
...
func (o CreateActiveDirectoryRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateActiveDirectoryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateActiveDirectoryRequest := _CreateActiveDirectoryRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateActiveDirectoryRequest)

	if err != nil {
		return err
	}

	*o = CreateActiveDirectoryRequest(varCreateActiveDirectoryRequest)
