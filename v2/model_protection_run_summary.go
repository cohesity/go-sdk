...
// checks if the ProtectionRunSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionRunSummary{}
...
func (o *ProtectionRunSummary) GetIsFullRun() bool {
	if o == nil || IsNil(o.IsFullRun.Get()) {
		var ret bool
		return ret
	}
...
func (o *ProtectionRunSummary) GetSuccessObjectsCount() int64 {
	if o == nil || IsNil(o.SuccessObjectsCount.Get()) {
		var ret int64
		return ret
	}
...
func (o *ProtectionRunSummary) GetTotalObjectsCount() int64 {
	if o == nil || IsNil(o.TotalObjectsCount.Get()) {
		var ret int64
		return ret
	}
...
func (o ProtectionRunSummary) ToMap() (map[string]interface{}, error) {
