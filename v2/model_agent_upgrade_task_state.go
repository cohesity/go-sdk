...
// checks if the AgentUpgradeTaskState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentUpgradeTaskState{}
...
func (o *AgentUpgradeTaskState) GetClusterVersion() string {
	if o == nil || IsNil(o.ClusterVersion.Get()) {
		var ret string
		return ret
	}
...
func (o *AgentUpgradeTaskState) GetIsRetryable() bool {
	if o == nil || IsNil(o.IsRetryable.Get()) {
		var ret bool
		return ret
	}
...
func (o *AgentUpgradeTaskState) GetRetriedTaskID() int64 {
	if o == nil || IsNil(o.RetriedTaskID.Get()) {
		var ret int64
		return ret
	}
...
func (o AgentUpgradeTaskState) ToMap() (map[string]interface{}, error) {
