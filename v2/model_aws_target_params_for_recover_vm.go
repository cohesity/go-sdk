...
// checks if the AwsTargetParamsForRecoverVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsTargetParamsForRecoverVm{}
...
func (o AwsTargetParamsForRecoverVm) ToMap() (map[string]interface{}, error) {
