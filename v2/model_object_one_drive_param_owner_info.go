...
// checks if the ObjectOneDriveParamOwnerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectOneDriveParamOwnerInfo{}

// ObjectOneDriveParamOwnerInfo Specifies the OneDrive owner info.
type ObjectOneDriveParamOwnerInfo struct {
...
type _ObjectOneDriveParamOwnerInfo ObjectOneDriveParamOwnerInfo
...
func NewObjectOneDriveParamOwnerInfo(snapshotId string) *ObjectOneDriveParamOwnerInfo {
	this := ObjectOneDriveParamOwnerInfo{}
...
func (o *ObjectOneDriveParamOwnerInfo) SetArchivalTargetInfoNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetBytesRestoredNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetEndTimeUsecsNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetObjectInfoNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetPointInTimeUsecsNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetProgressTaskIdNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetProtectionGroupIdNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetProtectionGroupNameNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetRecoverFromStandbyNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetSnapshotCreationTimeUsecsNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetSnapshotTargetTypeNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetStartTimeUsecsNil() {
...
func (o *ObjectOneDriveParamOwnerInfo) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ObjectOneDriveParamOwnerInfo) SetStorageDomainIdNil() {
...
func (o ObjectOneDriveParamOwnerInfo) MarshalJSON() ([]byte, error) {
...
func (o ObjectOneDriveParamOwnerInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ObjectOneDriveParamOwnerInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectOneDriveParamOwnerInfo := _ObjectOneDriveParamOwnerInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectOneDriveParamOwnerInfo)

	if err != nil {
		return err
	}

	*o = ObjectOneDriveParamOwnerInfo(varObjectOneDriveParamOwnerInfo)

	return err
}

type NullableObjectOneDriveParamOwnerInfo struct {
	value *ObjectOneDriveParamOwnerInfo
	isSet bool
}

func (v NullableObjectOneDriveParamOwnerInfo) Get() *ObjectOneDriveParamOwnerInfo {
	return v.value
}

func (v *NullableObjectOneDriveParamOwnerInfo) Set(val *ObjectOneDriveParamOwnerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectOneDriveParamOwnerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectOneDriveParamOwnerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectOneDriveParamOwnerInfo(val *ObjectOneDriveParamOwnerInfo) *NullableObjectOneDriveParamOwnerInfo {
	return &NullableObjectOneDriveParamOwnerInfo{value: val, isSet: true}
}

func (v NullableObjectOneDriveParamOwnerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectOneDriveParamOwnerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
