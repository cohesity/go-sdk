...
// checks if the NumWeekInMonth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumWeekInMonth{}
...
func (o *NumWeekInMonth) GetNumWeekInMonth() string {
	if o == nil || IsNil(o.NumWeekInMonth) {
		var ret string
		return ret
	}
...
func (o NumWeekInMonth) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NumWeekInMonth) {
