...
// checks if the AzureTargetParamsForRecoverFileAndFolderNewTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureTargetParamsForRecoverFileAndFolderNewTargetConfig{}

// AzureTargetParamsForRecoverFileAndFolderNewTargetConfig Specifies the configuration for recovering to a new target.
type AzureTargetParamsForRecoverFileAndFolderNewTargetConfig struct {
...
type _AzureTargetParamsForRecoverFileAndFolderNewTargetConfig AzureTargetParamsForRecoverFileAndFolderNewTargetConfig
...
func NewAzureTargetParamsForRecoverFileAndFolderNewTargetConfig(absolutePath NullableString, targetVm NullableAcropolisRecoverFilesNewTargetConfigTargetVm) *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig {
	this := AzureTargetParamsForRecoverFileAndFolderNewTargetConfig{}
...
func (o *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig) SetTargetVmCredentialsNil() {
...
func (o AzureTargetParamsForRecoverFileAndFolderNewTargetConfig) MarshalJSON() ([]byte, error) {
...
func (o AzureTargetParamsForRecoverFileAndFolderNewTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureTargetParamsForRecoverFileAndFolderNewTargetConfig := _AzureTargetParamsForRecoverFileAndFolderNewTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureTargetParamsForRecoverFileAndFolderNewTargetConfig)

	if err != nil {
		return err
	}

	*o = AzureTargetParamsForRecoverFileAndFolderNewTargetConfig(varAzureTargetParamsForRecoverFileAndFolderNewTargetConfig)

	return err
}

type NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig struct {
	value *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig
	isSet bool
}

func (v NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig) Get() *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig {
	return v.value
}

func (v *NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig) Set(val *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig(val *AzureTargetParamsForRecoverFileAndFolderNewTargetConfig) *NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig {
	return &NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig{value: val, isSet: true}
}

func (v NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureTargetParamsForRecoverFileAndFolderNewTargetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
