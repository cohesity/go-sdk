...
// checks if the RecoverKvmVmParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverKvmVmParams{}

// RecoverKvmVmParams Specifies the parameters to recover VMs.
...
type _RecoverKvmVmParams RecoverKvmVmParams
...
func (o *RecoverKvmVmParams) SetKvmTargetParamsNil() {
...
func (o RecoverKvmVmParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverKvmVmParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverKvmVmParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverKvmVmParams := _RecoverKvmVmParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverKvmVmParams)

	if err != nil {
		return err
	}

	*o = RecoverKvmVmParams(varRecoverKvmVmParams)

	return err
}

type NullableRecoverKvmVmParams struct {
	value *RecoverKvmVmParams
	isSet bool
}

func (v NullableRecoverKvmVmParams) Get() *RecoverKvmVmParams {
	return v.value
}

func (v *NullableRecoverKvmVmParams) Set(val *RecoverKvmVmParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverKvmVmParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverKvmVmParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverKvmVmParams(val *RecoverKvmVmParams) *NullableRecoverKvmVmParams {
	return &NullableRecoverKvmVmParams{value: val, isSet: true}
}

func (v NullableRecoverKvmVmParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverKvmVmParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
