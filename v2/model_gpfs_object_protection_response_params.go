...
// checks if the GpfsObjectProtectionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GpfsObjectProtectionResponseParams{}
...
func (o GpfsObjectProtectionResponseParams) ToMap() (map[string]interface{}, error) {
