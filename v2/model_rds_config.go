...
// checks if the RdsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RdsConfig{}
...
func (o *RdsConfig) SetPointInTimeUsecsNil() {
...
func (o RdsConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RdsConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRdsConfig := _RdsConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRdsConfig)

	if err != nil {
		return err
	}

	*o = RdsConfig(varRdsConfig)
