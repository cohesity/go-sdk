...
// checks if the BandwidthThrottlingOverride type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BandwidthThrottlingOverride{}
...
func (o BandwidthThrottlingOverride) ToMap() (map[string]interface{}, error) {
