...
// checks if the UpdateFeatureFlagParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateFeatureFlagParams{}
...
func (o UpdateFeatureFlagParams) ToMap() (map[string]interface{}, error) {
