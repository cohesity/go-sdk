...
// checks if the SmbPermissionsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbPermissionsInfo{}
...
func (o SmbPermissionsInfo) ToMap() (map[string]interface{}, error) {
