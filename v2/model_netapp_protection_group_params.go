...
// checks if the NetappProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetappProtectionGroupParams{}
...
type _NetappProtectionGroupParams NetappProtectionGroupParams
...
func (o *NetappProtectionGroupParams) SetModifySourcePermissionsNil() {
...
func (o *NetappProtectionGroupParams) GetSnapMirrorConfig() SnapMirrorConfig {
	if o == nil || IsNil(o.SnapMirrorConfig) {
...
func (o NetappProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *NetappProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varNetappProtectionGroupParams := _NetappProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNetappProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = NetappProtectionGroupParams(varNetappProtectionGroupParams)
