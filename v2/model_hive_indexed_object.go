...
// checks if the HiveIndexedObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HiveIndexedObject{}
...
func (o *HiveIndexedObject) SetPolicyIdNil() {
	o.PolicyId.Set(nil)
}
...
func (o *HiveIndexedObject) SetPolicyNameNil() {
...
func (o HiveIndexedObject) ToMap() (map[string]interface{}, error) {
