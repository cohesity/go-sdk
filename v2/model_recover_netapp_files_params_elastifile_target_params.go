...
// checks if the RecoverNetappFilesParamsElastifileTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappFilesParamsElastifileTargetParams{}

// RecoverNetappFilesParamsElastifileTargetParams Specifies the params for an Elastifile recovery target.
type RecoverNetappFilesParamsElastifileTargetParams struct {
...
type _RecoverNetappFilesParamsElastifileTargetParams RecoverNetappFilesParamsElastifileTargetParams
...
func NewRecoverNetappFilesParamsElastifileTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverNetappFilesParamsElastifileTargetParams {
	this := RecoverNetappFilesParamsElastifileTargetParams{}
...
func (o *RecoverNetappFilesParamsElastifileTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverNetappFilesParamsElastifileTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverNetappFilesParamsElastifileTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverNetappFilesParamsElastifileTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverNetappFilesParamsElastifileTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverNetappFilesParamsElastifileTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappFilesParamsElastifileTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappFilesParamsElastifileTargetParams := _RecoverNetappFilesParamsElastifileTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappFilesParamsElastifileTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverNetappFilesParamsElastifileTargetParams(varRecoverNetappFilesParamsElastifileTargetParams)

	return err
}

type NullableRecoverNetappFilesParamsElastifileTargetParams struct {
	value *RecoverNetappFilesParamsElastifileTargetParams
	isSet bool
}

func (v NullableRecoverNetappFilesParamsElastifileTargetParams) Get() *RecoverNetappFilesParamsElastifileTargetParams {
	return v.value
}

func (v *NullableRecoverNetappFilesParamsElastifileTargetParams) Set(val *RecoverNetappFilesParamsElastifileTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverNetappFilesParamsElastifileTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverNetappFilesParamsElastifileTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverNetappFilesParamsElastifileTargetParams(val *RecoverNetappFilesParamsElastifileTargetParams) *NullableRecoverNetappFilesParamsElastifileTargetParams {
	return &NullableRecoverNetappFilesParamsElastifileTargetParams{value: val, isSet: true}
}

func (v NullableRecoverNetappFilesParamsElastifileTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverNetappFilesParamsElastifileTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
