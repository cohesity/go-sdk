...
// checks if the ProgressTaskInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgressTaskInfo{}
...
func (o ProgressTaskInfo) ToMap() (map[string]interface{}, error) {
