...
// checks if the RecoverFlashbladeFilesParamsElastifileTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverFlashbladeFilesParamsElastifileTargetParams{}

// RecoverFlashbladeFilesParamsElastifileTargetParams Specifies the params for an Elastifile recovery target.
type RecoverFlashbladeFilesParamsElastifileTargetParams struct {
...
type _RecoverFlashbladeFilesParamsElastifileTargetParams RecoverFlashbladeFilesParamsElastifileTargetParams
...
func NewRecoverFlashbladeFilesParamsElastifileTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverFlashbladeFilesParamsElastifileTargetParams {
	this := RecoverFlashbladeFilesParamsElastifileTargetParams{}
...
func (o *RecoverFlashbladeFilesParamsElastifileTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverFlashbladeFilesParamsElastifileTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverFlashbladeFilesParamsElastifileTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverFlashbladeFilesParamsElastifileTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverFlashbladeFilesParamsElastifileTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverFlashbladeFilesParamsElastifileTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverFlashbladeFilesParamsElastifileTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverFlashbladeFilesParamsElastifileTargetParams := _RecoverFlashbladeFilesParamsElastifileTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverFlashbladeFilesParamsElastifileTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverFlashbladeFilesParamsElastifileTargetParams(varRecoverFlashbladeFilesParamsElastifileTargetParams)

	return err
}

type NullableRecoverFlashbladeFilesParamsElastifileTargetParams struct {
	value *RecoverFlashbladeFilesParamsElastifileTargetParams
	isSet bool
}

func (v NullableRecoverFlashbladeFilesParamsElastifileTargetParams) Get() *RecoverFlashbladeFilesParamsElastifileTargetParams {
	return v.value
}

func (v *NullableRecoverFlashbladeFilesParamsElastifileTargetParams) Set(val *RecoverFlashbladeFilesParamsElastifileTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverFlashbladeFilesParamsElastifileTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverFlashbladeFilesParamsElastifileTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverFlashbladeFilesParamsElastifileTargetParams(val *RecoverFlashbladeFilesParamsElastifileTargetParams) *NullableRecoverFlashbladeFilesParamsElastifileTargetParams {
	return &NullableRecoverFlashbladeFilesParamsElastifileTargetParams{value: val, isSet: true}
}

func (v NullableRecoverFlashbladeFilesParamsElastifileTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverFlashbladeFilesParamsElastifileTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
