...
// checks if the CassandraPortInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CassandraPortInfo{}
...
func (o *CassandraPortInfo) GetNativeTransportPort() int32 {
	if o == nil || IsNil(o.NativeTransportPort.Get()) {
		var ret int32
		return ret
	}
...
func (o *CassandraPortInfo) GetSslStoragePort() int32 {
	if o == nil || IsNil(o.SslStoragePort.Get()) {
		var ret int32
		return ret
	}
...
func (o *CassandraPortInfo) GetStoragePort() int32 {
	if o == nil || IsNil(o.StoragePort.Get()) {
		var ret int32
		return ret
	}
...
func (o CassandraPortInfo) ToMap() (map[string]interface{}, error) {
