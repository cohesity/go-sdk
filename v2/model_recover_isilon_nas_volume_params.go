...
// checks if the RecoverIsilonNasVolumeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverIsilonNasVolumeParams{}
...
type _RecoverIsilonNasVolumeParams RecoverIsilonNasVolumeParams
...
func (o RecoverIsilonNasVolumeParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverIsilonNasVolumeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverIsilonNasVolumeParams := _RecoverIsilonNasVolumeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverIsilonNasVolumeParams)

	if err != nil {
		return err
	}

	*o = RecoverIsilonNasVolumeParams(varRecoverIsilonNasVolumeParams)
