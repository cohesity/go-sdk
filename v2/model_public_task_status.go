...
// checks if the PublicTaskStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicTaskStatus{}
...
func (o *PublicTaskStatus) GetPublicTaskStatus() string {
	if o == nil || IsNil(o.PublicTaskStatus) {
		var ret string
		return ret
	}
...
func (o PublicTaskStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PublicTaskStatus) {
