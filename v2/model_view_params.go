...
// checks if the ViewParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewParams{}
...
func (o ViewParams) ToMap() (map[string]interface{}, error) {
