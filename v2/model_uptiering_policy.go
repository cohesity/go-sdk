...
// checks if the UptieringPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UptieringPolicy{}
...
func (o UptieringPolicy) ToMap() (map[string]interface{}, error) {
