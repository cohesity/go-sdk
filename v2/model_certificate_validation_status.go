...
// checks if the CertificateValidationStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateValidationStatus{}
...
func (o CertificateValidationStatus) ToMap() (map[string]interface{}, error) {
