...
// checks if the CommonTdmTaskResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonTdmTaskResponseParams{}
...
type _CommonTdmTaskResponseParams CommonTdmTaskResponseParams
...
func (o CommonTdmTaskResponseParams) ToMap() (map[string]interface{}, error) {
...
func (o *CommonTdmTaskResponseParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonTdmTaskResponseParams := _CommonTdmTaskResponseParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonTdmTaskResponseParams)

	if err != nil {
		return err
	}

	*o = CommonTdmTaskResponseParams(varCommonTdmTaskResponseParams)
