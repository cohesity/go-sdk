...
// checks if the MailboxParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailboxParam{}
...
func (o MailboxParam) ToMap() (map[string]interface{}, error) {
