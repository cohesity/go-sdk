...
// checks if the ObjectMailboxParamOwnerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectMailboxParamOwnerInfo{}

// ObjectMailboxParamOwnerInfo Specifies the Mailbox owner info.
type ObjectMailboxParamOwnerInfo struct {
...
type _ObjectMailboxParamOwnerInfo ObjectMailboxParamOwnerInfo
...
func NewObjectMailboxParamOwnerInfo(snapshotId string) *ObjectMailboxParamOwnerInfo {
	this := ObjectMailboxParamOwnerInfo{}
...
func (o *ObjectMailboxParamOwnerInfo) SetArchivalTargetInfoNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetBytesRestoredNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetEndTimeUsecsNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetObjectInfoNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetPointInTimeUsecsNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetProgressTaskIdNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetProtectionGroupIdNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetProtectionGroupNameNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetRecoverFromStandbyNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetSnapshotCreationTimeUsecsNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetSnapshotTargetTypeNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetStartTimeUsecsNil() {
...
func (o *ObjectMailboxParamOwnerInfo) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ObjectMailboxParamOwnerInfo) SetStorageDomainIdNil() {
...
func (o ObjectMailboxParamOwnerInfo) MarshalJSON() ([]byte, error) {
...
func (o ObjectMailboxParamOwnerInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ObjectMailboxParamOwnerInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectMailboxParamOwnerInfo := _ObjectMailboxParamOwnerInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectMailboxParamOwnerInfo)

	if err != nil {
		return err
	}

	*o = ObjectMailboxParamOwnerInfo(varObjectMailboxParamOwnerInfo)

	return err
}

type NullableObjectMailboxParamOwnerInfo struct {
	value *ObjectMailboxParamOwnerInfo
	isSet bool
}

func (v NullableObjectMailboxParamOwnerInfo) Get() *ObjectMailboxParamOwnerInfo {
	return v.value
}

func (v *NullableObjectMailboxParamOwnerInfo) Set(val *ObjectMailboxParamOwnerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectMailboxParamOwnerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectMailboxParamOwnerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectMailboxParamOwnerInfo(val *ObjectMailboxParamOwnerInfo) *NullableObjectMailboxParamOwnerInfo {
	return &NullableObjectMailboxParamOwnerInfo{value: val, isSet: true}
}

func (v NullableObjectMailboxParamOwnerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectMailboxParamOwnerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
