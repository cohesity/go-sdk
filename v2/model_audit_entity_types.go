...
// checks if the AuditEntityTypes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditEntityTypes{}
...
func (o AuditEntityTypes) ToMap() (map[string]interface{}, error) {
