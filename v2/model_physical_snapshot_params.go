...
// checks if the PhysicalSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalSnapshotParams{}
...
func (o PhysicalSnapshotParams) ToMap() (map[string]interface{}, error) {
