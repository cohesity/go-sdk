...
// checks if the FlashbladeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlashbladeParams{}
...
func (o *FlashbladeParams) GetAssignedCapacityBytes() int64 {
	if o == nil || IsNil(o.AssignedCapacityBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *FlashbladeParams) GetAssignedDataVipsOk() ([]string, bool) {
	if o == nil || IsNil(o.AssignedDataVips) {
		return nil, false
	}
...
func (o *FlashbladeParams) GetAvailableCapacity() int64 {
	if o == nil || IsNil(o.AvailableCapacity.Get()) {
		var ret int64
		return ret
	}
...
func (o *FlashbladeParams) GetAvailableDataVips() []*string {
	if o == nil || IsNil(o.AvailableDataVips) {
		var ret []*string
		return ret
	}
...
func (o *FlashbladeParams) GetCreatedFileSystemCount() int64 {
	if o == nil || IsNil(o.CreatedFileSystemCount.Get()) {
		var ret int64
		return ret
	}
...
func (o *FlashbladeParams) GetIsDedicatedStorage() bool {
	if o == nil || IsNil(o.IsDedicatedStorage.Get()) {
		var ret bool
		return ret
	}
...
func (o *FlashbladeParams) GetRegistrationParams() FlashBladeRegistrationInfo {
	if o == nil || IsNil(o.RegistrationParams) {
...
func (o *FlashbladeParams) GetSoftwareOsVersion() string {
	if o == nil || IsNil(o.SoftwareOsVersion.Get()) {
		var ret string
		return ret
	}
...
func (o *FlashbladeParams) GetTotalCapacity() int64 {
	if o == nil || IsNil(o.TotalCapacity.Get()) {
		var ret int64
		return ret
	}
...
func (o *FlashbladeParams) GetUpdatedFileSystemCount() int64 {
	if o == nil || IsNil(o.UpdatedFileSystemCount.Get()) {
		var ret int64
		return ret
	}
...
func (o FlashbladeParams) ToMap() (map[string]interface{}, error) {
