...
// checks if the HeliosAWSTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosAWSTier{}
...
type _HeliosAWSTier HeliosAWSTier
...
func (o *HeliosAWSTier) SetMoveAfterNil() {
	o.MoveAfter.Set(nil)
}
...
func (o *HeliosAWSTier) SetMoveAfterUnitNil() {
...
func (o HeliosAWSTier) MarshalJSON() ([]byte, error) {
...
func (o HeliosAWSTier) ToMap() (map[string]interface{}, error) {
...
func (o *HeliosAWSTier) UnmarshalJSON(data []byte) (err error) {
	...
	varHeliosAWSTier := _HeliosAWSTier{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeliosAWSTier)

	if err != nil {
		return err
	}

	*o = HeliosAWSTier(varHeliosAWSTier)

	return err
}

type NullableHeliosAWSTier struct {
	value *HeliosAWSTier
	isSet bool
}

func (v NullableHeliosAWSTier) Get() *HeliosAWSTier {
	return v.value
}

func (v *NullableHeliosAWSTier) Set(val *HeliosAWSTier) {
	v.value = val
	v.isSet = true
}

func (v NullableHeliosAWSTier) IsSet() bool {
	return v.isSet
}

func (v *NullableHeliosAWSTier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeliosAWSTier(val *HeliosAWSTier) *NullableHeliosAWSTier {
	return &NullableHeliosAWSTier{value: val, isSet: true}
}

func (v NullableHeliosAWSTier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeliosAWSTier) UnmarshalJSON(src []byte) error {
	v.isSet = true
