...
// checks if the Office365ObjectProtectionCommonParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365ObjectProtectionCommonParams{}
...
type _Office365ObjectProtectionCommonParams Office365ObjectProtectionCommonParams
...
func (o Office365ObjectProtectionCommonParams) ToMap() (map[string]interface{}, error) {
...
func (o *Office365ObjectProtectionCommonParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOffice365ObjectProtectionCommonParams := _Office365ObjectProtectionCommonParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOffice365ObjectProtectionCommonParams)

	if err != nil {
		return err
	}

	*o = Office365ObjectProtectionCommonParams(varOffice365ObjectProtectionCommonParams)
