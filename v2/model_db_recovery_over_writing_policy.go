...
// checks if the DbRecoveryOverWritingPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DbRecoveryOverWritingPolicy{}
...
func (o *DbRecoveryOverWritingPolicy) GetDbRecoveryOverWritingPolicy() string {
	if o == nil || IsNil(o.DbRecoveryOverWritingPolicy) {
		var ret string
		return ret
	}
...
func (o DbRecoveryOverWritingPolicy) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DbRecoveryOverWritingPolicy) {
