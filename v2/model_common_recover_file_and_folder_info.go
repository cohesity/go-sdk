...
// checks if the CommonRecoverFileAndFolderInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonRecoverFileAndFolderInfo{}
...
type _CommonRecoverFileAndFolderInfo CommonRecoverFileAndFolderInfo
...
func (o *CommonRecoverFileAndFolderInfo) SetIsViewFileRecoveryNil() {
...
func (o CommonRecoverFileAndFolderInfo) ToMap() (map[string]interface{}, error) {
...
func (o *CommonRecoverFileAndFolderInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonRecoverFileAndFolderInfo := _CommonRecoverFileAndFolderInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonRecoverFileAndFolderInfo)

	if err != nil {
		return err
	}

	*o = CommonRecoverFileAndFolderInfo(varCommonRecoverFileAndFolderInfo)
