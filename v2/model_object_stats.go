...
// checks if the ObjectStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStats{}
...
func (o *ObjectStats) GetSnapshotsSummaryOk() ([]SnapshotsSummary, bool) {
	if o == nil || IsNil(o.SnapshotsSummary) {
		return nil, false
	}
...
func (o ObjectStats) ToMap() (map[string]interface{}, error) {
