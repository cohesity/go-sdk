...
// checks if the RecoverElastifileNasVolumeParamsGenericNasTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverElastifileNasVolumeParamsGenericNasTargetParams{}

// RecoverElastifileNasVolumeParamsGenericNasTargetParams Specifies the params for a Generic NAS recovery target.
type RecoverElastifileNasVolumeParamsGenericNasTargetParams struct {
...
type _RecoverElastifileNasVolumeParamsGenericNasTargetParams RecoverElastifileNasVolumeParamsGenericNasTargetParams
...
func NewRecoverElastifileNasVolumeParamsGenericNasTargetParams(volume RecoverOtherNasToElastifileVolumeTargetParamsVolume) *RecoverElastifileNasVolumeParamsGenericNasTargetParams {
	this := RecoverElastifileNasVolumeParamsGenericNasTargetParams{}
	this.Volume = volume
	return &this
}
...
func (o *RecoverElastifileNasVolumeParamsGenericNasTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverElastifileNasVolumeParamsGenericNasTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverElastifileNasVolumeParamsGenericNasTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverElastifileNasVolumeParamsGenericNasTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverElastifileNasVolumeParamsGenericNasTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverElastifileNasVolumeParamsGenericNasTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverElastifileNasVolumeParamsGenericNasTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverElastifileNasVolumeParamsGenericNasTargetParams := _RecoverElastifileNasVolumeParamsGenericNasTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverElastifileNasVolumeParamsGenericNasTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverElastifileNasVolumeParamsGenericNasTargetParams(varRecoverElastifileNasVolumeParamsGenericNasTargetParams)

	return err
}

type NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams struct {
	value *RecoverElastifileNasVolumeParamsGenericNasTargetParams
	isSet bool
}

func (v NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams) Get() *RecoverElastifileNasVolumeParamsGenericNasTargetParams {
	return v.value
}

func (v *NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams) Set(val *RecoverElastifileNasVolumeParamsGenericNasTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverElastifileNasVolumeParamsGenericNasTargetParams(val *RecoverElastifileNasVolumeParamsGenericNasTargetParams) *NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams {
	return &NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams{value: val, isSet: true}
}

func (v NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverElastifileNasVolumeParamsGenericNasTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
