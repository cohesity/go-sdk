...
// checks if the CloudSpinRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudSpinRun{}
...
func (o CloudSpinRun) ToMap() (map[string]interface{}, error) {
