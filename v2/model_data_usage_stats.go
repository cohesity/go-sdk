...
// checks if the DataUsageStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataUsageStats{}
...
func (o *DataUsageStats) SetNumDirectoriesNil() {
...
func (o *DataUsageStats) SetNumFilesNil() {
	o.NumFiles.Set(nil)
}
...
func (o DataUsageStats) ToMap() (map[string]interface{}, error) {
