...
// checks if the GenericNasDataTieringParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericNasDataTieringParams{}
...
type _GenericNasDataTieringParams GenericNasDataTieringParams
...
func (o GenericNasDataTieringParams) ToMap() (map[string]interface{}, error) {
...
func (o *GenericNasDataTieringParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGenericNasDataTieringParams := _GenericNasDataTieringParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenericNasDataTieringParams)

	if err != nil {
		return err
	}

	*o = GenericNasDataTieringParams(varGenericNasDataTieringParams)
