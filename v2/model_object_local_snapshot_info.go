...
// checks if the ObjectLocalSnapshotInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectLocalSnapshotInfo{}
...
func (o ObjectLocalSnapshotInfo) ToMap() (map[string]interface{}, error) {
