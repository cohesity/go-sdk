...
// checks if the PhysicalObjectProtectionUpdateRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalObjectProtectionUpdateRequestParams{}
...
type _PhysicalObjectProtectionUpdateRequestParams PhysicalObjectProtectionUpdateRequestParams
...
func (o PhysicalObjectProtectionUpdateRequestParams) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalObjectProtectionUpdateRequestParams) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalObjectProtectionUpdateRequestParams := _PhysicalObjectProtectionUpdateRequestParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhysicalObjectProtectionUpdateRequestParams)

	if err != nil {
		return err
	}

	*o = PhysicalObjectProtectionUpdateRequestParams(varPhysicalObjectProtectionUpdateRequestParams)
