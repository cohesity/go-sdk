...
// checks if the AcropolisTargetParamsForRecoverVmVlanConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcropolisTargetParamsForRecoverVmVlanConfig{}
...
type AcropolisTargetParamsForRecoverVmVlanConfig struct {
...
func NewAcropolisTargetParamsForRecoverVmVlanConfig() *AcropolisTargetParamsForRecoverVmVlanConfig {
	this := AcropolisTargetParamsForRecoverVmVlanConfig{}
	return &this
}
...
func (o *AcropolisTargetParamsForRecoverVmVlanConfig) SetDisableVlanNil() {
...
func (o *AcropolisTargetParamsForRecoverVmVlanConfig) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *AcropolisTargetParamsForRecoverVmVlanConfig) SetInterfaceNameNil() {
...
func (o AcropolisTargetParamsForRecoverVmVlanConfig) MarshalJSON() ([]byte, error) {
...
func (o AcropolisTargetParamsForRecoverVmVlanConfig) ToMap() (map[string]interface{}, error) {
...
type NullableAcropolisTargetParamsForRecoverVmVlanConfig struct {
	value *AcropolisTargetParamsForRecoverVmVlanConfig
	isSet bool
}

func (v NullableAcropolisTargetParamsForRecoverVmVlanConfig) Get() *AcropolisTargetParamsForRecoverVmVlanConfig {
	return v.value
}

func (v *NullableAcropolisTargetParamsForRecoverVmVlanConfig) Set(val *AcropolisTargetParamsForRecoverVmVlanConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAcropolisTargetParamsForRecoverVmVlanConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAcropolisTargetParamsForRecoverVmVlanConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcropolisTargetParamsForRecoverVmVlanConfig(val *AcropolisTargetParamsForRecoverVmVlanConfig) *NullableAcropolisTargetParamsForRecoverVmVlanConfig {
	return &NullableAcropolisTargetParamsForRecoverVmVlanConfig{value: val, isSet: true}
}

func (v NullableAcropolisTargetParamsForRecoverVmVlanConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcropolisTargetParamsForRecoverVmVlanConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
