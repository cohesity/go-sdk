...
type _CreateCsrRequest CreateCsrRequest
...
func (o *CreateCsrRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCsrRequest := _CreateCsrRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCsrRequest)

	if err != nil {
		return err
	}

	*o = CreateCsrRequest(varCreateCsrRequest)
