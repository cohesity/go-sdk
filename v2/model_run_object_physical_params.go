...
// checks if the RunObjectPhysicalParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RunObjectPhysicalParams{}
...
func (o RunObjectPhysicalParams) ToMap() (map[string]interface{}, error) {
