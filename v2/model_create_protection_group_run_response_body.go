...
// checks if the CreateProtectionGroupRunResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateProtectionGroupRunResponseBody{}
...
func (o *CreateProtectionGroupRunResponseBody) GetUdaParams() UdaCreateRunResponseParams {
	if o == nil || IsNil(o.UdaParams) {
		var ret UdaCreateRunResponseParams
		return ret
	}
	return *o.UdaParams
}
...
// SetUdaParams gets a reference to the given UdaCreateRunResponseParams and assigns it to the UdaParams field.
...
func (o CreateProtectionGroupRunResponseBody) ToMap() (map[string]interface{}, error) {
