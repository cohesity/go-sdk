...
// checks if the RecoverPhysicalParamsRecoverVolumeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverPhysicalParamsRecoverVolumeParams{}
...
type _RecoverPhysicalParamsRecoverVolumeParams RecoverPhysicalParamsRecoverVolumeParams
...
func NewRecoverPhysicalParamsRecoverVolumeParams(targetEnvironment string) *RecoverPhysicalParamsRecoverVolumeParams {
	this := RecoverPhysicalParamsRecoverVolumeParams{}
...
func (o *RecoverPhysicalParamsRecoverVolumeParams) SetPhysicalTargetParamsNil() {
...
func (o RecoverPhysicalParamsRecoverVolumeParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverPhysicalParamsRecoverVolumeParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverPhysicalParamsRecoverVolumeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverPhysicalParamsRecoverVolumeParams := _RecoverPhysicalParamsRecoverVolumeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverPhysicalParamsRecoverVolumeParams)

	if err != nil {
		return err
	}

	*o = RecoverPhysicalParamsRecoverVolumeParams(varRecoverPhysicalParamsRecoverVolumeParams)

	return err
}

type NullableRecoverPhysicalParamsRecoverVolumeParams struct {
	value *RecoverPhysicalParamsRecoverVolumeParams
	isSet bool
}

func (v NullableRecoverPhysicalParamsRecoverVolumeParams) Get() *RecoverPhysicalParamsRecoverVolumeParams {
	return v.value
}

func (v *NullableRecoverPhysicalParamsRecoverVolumeParams) Set(val *RecoverPhysicalParamsRecoverVolumeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverPhysicalParamsRecoverVolumeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverPhysicalParamsRecoverVolumeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverPhysicalParamsRecoverVolumeParams(val *RecoverPhysicalParamsRecoverVolumeParams) *NullableRecoverPhysicalParamsRecoverVolumeParams {
	return &NullableRecoverPhysicalParamsRecoverVolumeParams{value: val, isSet: true}
}

func (v NullableRecoverPhysicalParamsRecoverVolumeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverPhysicalParamsRecoverVolumeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
