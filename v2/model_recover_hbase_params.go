...
// checks if the RecoverHbaseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverHbaseParams{}

// RecoverHbaseParams Specifies the parameters to recover Hbase objects.
...
type _RecoverHbaseParams RecoverHbaseParams
...
func (o *RecoverHbaseParams) SetBandwidthMBPSNil() {
...
func (o *RecoverHbaseParams) SetConcurrencyNil() {
...
func (o *RecoverHbaseParams) SetOverwriteNil() {
	o.Overwrite.Set(nil)
}
...
func (o *RecoverHbaseParams) SetRecoverToNil() {
	o.RecoverTo.Set(nil)
}
...
func (o *RecoverHbaseParams) SetSuffixNil() {
	o.Suffix.Set(nil)
}
...
func (o RecoverHbaseParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverHbaseParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverHbaseParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverHbaseParams := _RecoverHbaseParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverHbaseParams)

	if err != nil {
		return err
	}

	*o = RecoverHbaseParams(varRecoverHbaseParams)

	return err
}

type NullableRecoverHbaseParams struct {
	value *RecoverHbaseParams
	isSet bool
}

func (v NullableRecoverHbaseParams) Get() *RecoverHbaseParams {
	return v.value
}

func (v *NullableRecoverHbaseParams) Set(val *RecoverHbaseParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverHbaseParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverHbaseParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverHbaseParams(val *RecoverHbaseParams) *NullableRecoverHbaseParams {
	return &NullableRecoverHbaseParams{value: val, isSet: true}
}

func (v NullableRecoverHbaseParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverHbaseParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
