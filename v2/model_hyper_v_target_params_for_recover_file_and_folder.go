...
// checks if the HyperVTargetParamsForRecoverFileAndFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperVTargetParamsForRecoverFileAndFolder{}
...
type _HyperVTargetParamsForRecoverFileAndFolder HyperVTargetParamsForRecoverFileAndFolder
...
func (o HyperVTargetParamsForRecoverFileAndFolder) ToMap() (map[string]interface{}, error) {
...
func (o *HyperVTargetParamsForRecoverFileAndFolder) UnmarshalJSON(data []byte) (err error) {
	...
	varHyperVTargetParamsForRecoverFileAndFolder := _HyperVTargetParamsForRecoverFileAndFolder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHyperVTargetParamsForRecoverFileAndFolder)

	if err != nil {
		return err
	}

	*o = HyperVTargetParamsForRecoverFileAndFolder(varHyperVTargetParamsForRecoverFileAndFolder)
