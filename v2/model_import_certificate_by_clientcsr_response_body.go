...
// checks if the ImportCertificateByClientcsrResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImportCertificateByClientcsrResponseBody{}
...
func (o *ImportCertificateByClientcsrResponseBody) GetCertificateServer() string {
	if o == nil || IsNil(o.CertificateServer.Get()) {
		var ret string
		return ret
	}
...
func (o *ImportCertificateByClientcsrResponseBody) GetFileServerCert() string {
	if o == nil || IsNil(o.FileServerCert.Get()) {
		var ret string
		return ret
	}
...
func (o ImportCertificateByClientcsrResponseBody) ToMap() (map[string]interface{}, error) {
