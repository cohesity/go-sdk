...
// checks if the PreparePlannedFailverParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PreparePlannedFailverParams{}
...
func (o PreparePlannedFailverParams) ToMap() (map[string]interface{}, error) {
