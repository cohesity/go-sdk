...
// checks if the OriginalGpfsFilesTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OriginalGpfsFilesTargetParams{}
...
type _OriginalGpfsFilesTargetParams OriginalGpfsFilesTargetParams
...
func (o OriginalGpfsFilesTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *OriginalGpfsFilesTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOriginalGpfsFilesTargetParams := _OriginalGpfsFilesTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOriginalGpfsFilesTargetParams)

	if err != nil {
		return err
	}

	*o = OriginalGpfsFilesTargetParams(varOriginalGpfsFilesTargetParams)
