...
// checks if the CreateCsrResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCsrResponseBody{}
...
type _CreateCsrResponseBody CreateCsrResponseBody
...
func (o CreateCsrResponseBody) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCsrResponseBody) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCsrResponseBody := _CreateCsrResponseBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCsrResponseBody)

	if err != nil {
		return err
	}

	*o = CreateCsrResponseBody(varCreateCsrResponseBody)
