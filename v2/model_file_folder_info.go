...
// checks if the FileFolderInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileFolderInfo{}
...
func (o FileFolderInfo) ToMap() (map[string]interface{}, error) {
