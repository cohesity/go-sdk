...
// checks if the CommonCloudTierSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonCloudTierSettings{}
...
func (o CommonCloudTierSettings) ToMap() (map[string]interface{}, error) {
