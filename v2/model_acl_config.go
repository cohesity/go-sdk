...
// checks if the AclConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclConfig{}
...
func (o AclConfig) ToMap() (map[string]interface{}, error) {
