...
// checks if the ObjectActionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectActionRequest{}
...
type _ObjectActionRequest ObjectActionRequest
...
func (o ObjectActionRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ObjectActionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectActionRequest := _ObjectActionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectActionRequest)

	if err != nil {
		return err
	}

	*o = ObjectActionRequest(varObjectActionRequest)
