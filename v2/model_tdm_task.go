...
// checks if the TdmTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TdmTask{}
...
func (o TdmTask) ToMap() (map[string]interface{}, error) {
...
func (o *TdmTask) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varTdmTask)

	if err != nil {
		return err
	}

	*o = TdmTask(varTdmTask)
