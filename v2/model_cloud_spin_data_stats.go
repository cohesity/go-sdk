...
// checks if the CloudSpinDataStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudSpinDataStats{}
...
func (o CloudSpinDataStats) ToMap() (map[string]interface{}, error) {
