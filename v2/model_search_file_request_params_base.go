...
// checks if the SearchFileRequestParamsBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchFileRequestParamsBase{}
...
func (o SearchFileRequestParamsBase) ToMap() (map[string]interface{}, error) {
