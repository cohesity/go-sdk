...
// checks if the SelfServiceSnapshotConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfServiceSnapshotConfig{}
...
func (o *SelfServiceSnapshotConfig) GetAllowAccessSids() []string {
	if o == nil || IsNil(o.AllowAccessSids) {
		var ret []string
		return ret
	}
...
func (o *SelfServiceSnapshotConfig) GetAlternateSnapshotDirectoryName() string {
	if o == nil || IsNil(o.AlternateSnapshotDirectoryName.Get()) {
		var ret string
		return ret
	}
...
func (o *SelfServiceSnapshotConfig) GetDenyAccessSids() []string {
	if o == nil || IsNil(o.DenyAccessSids) {
		var ret []string
		return ret
	}
...
func (o *SelfServiceSnapshotConfig) GetNfsAccessEnabled() bool {
	if o == nil || IsNil(o.NfsAccessEnabled.Get()) {
		var ret bool
		return ret
	}
...
func (o *SelfServiceSnapshotConfig) GetPreviousVersionsEnabled() bool {
	if o == nil || IsNil(o.PreviousVersionsEnabled.Get()) {
		var ret bool
		return ret
	}
...
func (o *SelfServiceSnapshotConfig) GetSmbAccessEnabled() bool {
	if o == nil || IsNil(o.SmbAccessEnabled.Get()) {
		var ret bool
		return ret
	}
...
func (o *SelfServiceSnapshotConfig) GetSnapshotDirectoryName() string {
	if o == nil || IsNil(o.SnapshotDirectoryName.Get()) {
		var ret string
		return ret
	}
...
func (o SelfServiceSnapshotConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AllowAccessSids) {
