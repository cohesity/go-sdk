...
// checks if the TargetEncryptionLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetEncryptionLevel{}
...
func (o TargetEncryptionLevel) ToMap() (map[string]interface{}, error) {
