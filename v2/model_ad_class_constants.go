...
// checks if the ADClassConstants type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADClassConstants{}
...
func (o *ADClassConstants) GetAdClassConstants() string {
	if o == nil || IsNil(o.AdClassConstants) {
		var ret string
		return ret
	}
...
func (o ADClassConstants) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AdClassConstants) {
