...
// checks if the RecoverKubernetesParamsRecoverNamespaceParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverKubernetesParamsRecoverNamespaceParams{}
...
type _RecoverKubernetesParamsRecoverNamespaceParams RecoverKubernetesParamsRecoverNamespaceParams
...
func NewRecoverKubernetesParamsRecoverNamespaceParams(targetEnvironment string) *RecoverKubernetesParamsRecoverNamespaceParams {
	this := RecoverKubernetesParamsRecoverNamespaceParams{}
...
func (o *RecoverKubernetesParamsRecoverNamespaceParams) SetKubernetesTargetParamsNil() {
...
func (o *RecoverKubernetesParamsRecoverNamespaceParams) SetVlanConfigNil() {
...
func (o RecoverKubernetesParamsRecoverNamespaceParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverKubernetesParamsRecoverNamespaceParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverKubernetesParamsRecoverNamespaceParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverKubernetesParamsRecoverNamespaceParams := _RecoverKubernetesParamsRecoverNamespaceParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverKubernetesParamsRecoverNamespaceParams)

	if err != nil {
		return err
	}

	*o = RecoverKubernetesParamsRecoverNamespaceParams(varRecoverKubernetesParamsRecoverNamespaceParams)

	return err
}

type NullableRecoverKubernetesParamsRecoverNamespaceParams struct {
	value *RecoverKubernetesParamsRecoverNamespaceParams
	isSet bool
}

func (v NullableRecoverKubernetesParamsRecoverNamespaceParams) Get() *RecoverKubernetesParamsRecoverNamespaceParams {
	return v.value
}

func (v *NullableRecoverKubernetesParamsRecoverNamespaceParams) Set(val *RecoverKubernetesParamsRecoverNamespaceParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverKubernetesParamsRecoverNamespaceParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverKubernetesParamsRecoverNamespaceParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverKubernetesParamsRecoverNamespaceParams(val *RecoverKubernetesParamsRecoverNamespaceParams) *NullableRecoverKubernetesParamsRecoverNamespaceParams {
	return &NullableRecoverKubernetesParamsRecoverNamespaceParams{value: val, isSet: true}
}

func (v NullableRecoverKubernetesParamsRecoverNamespaceParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverKubernetesParamsRecoverNamespaceParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
