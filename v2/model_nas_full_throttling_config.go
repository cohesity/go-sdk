...
// checks if the NasFullThrottlingConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NasFullThrottlingConfig{}
...
func (o NasFullThrottlingConfig) ToMap() (map[string]interface{}, error) {
