...
// checks if the RigelConnectionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RigelConnectionInfo{}
...
func (o RigelConnectionInfo) ToMap() (map[string]interface{}, error) {
