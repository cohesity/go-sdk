...
// checks if the TdmRefreshTaskResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TdmRefreshTaskResponseParams{}
...
type _TdmRefreshTaskResponseParams TdmRefreshTaskResponseParams
...
func (o TdmRefreshTaskResponseParams) ToMap() (map[string]interface{}, error) {
...
func (o *TdmRefreshTaskResponseParams) UnmarshalJSON(data []byte) (err error) {
	...
	varTdmRefreshTaskResponseParams := _TdmRefreshTaskResponseParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTdmRefreshTaskResponseParams)

	if err != nil {
		return err
	}

	*o = TdmRefreshTaskResponseParams(varTdmRefreshTaskResponseParams)
