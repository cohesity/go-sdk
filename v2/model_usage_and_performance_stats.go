...
// checks if the UsageAndPerformanceStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsageAndPerformanceStats{}
...
func (o *UsageAndPerformanceStats) GetDataInBytesAfterReduction() int64 {
	if o == nil || IsNil(o.DataInBytesAfterReduction.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetMinUsablePhysicalCapacityBytes() int64 {
	if o == nil || IsNil(o.MinUsablePhysicalCapacityBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetNumBytesRead() int64 {
	if o == nil || IsNil(o.NumBytesRead.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetNumBytesWritten() int64 {
	if o == nil || IsNil(o.NumBytesWritten.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetPhysicalCapacityBytes() int64 {
	if o == nil || IsNil(o.PhysicalCapacityBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetReadLatencyMsecs() float64 {
	if o == nil || IsNil(o.ReadLatencyMsecs.Get()) {
		var ret float64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetSystemCapacityBytes() int64 {
	if o == nil || IsNil(o.SystemCapacityBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetSystemUsageBytes() int64 {
	if o == nil || IsNil(o.SystemUsageBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetTotalPhysicalRawUsageBytes() int64 {
	if o == nil || IsNil(o.TotalPhysicalRawUsageBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetTotalPhysicalUsageBytes() int64 {
	if o == nil || IsNil(o.TotalPhysicalUsageBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *UsageAndPerformanceStats) GetWriteLatencyMsecs() float64 {
	if o == nil || IsNil(o.WriteLatencyMsecs.Get()) {
		var ret float64
		return ret
	}
...
func (o UsageAndPerformanceStats) ToMap() (map[string]interface{}, error) {
