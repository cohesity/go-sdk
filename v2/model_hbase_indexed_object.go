...
// checks if the HbaseIndexedObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HbaseIndexedObject{}
...
func (o *HbaseIndexedObject) SetPolicyIdNil() {
	o.PolicyId.Set(nil)
}
...
func (o *HbaseIndexedObject) SetPolicyNameNil() {
...
func (o HbaseIndexedObject) ToMap() (map[string]interface{}, error) {
