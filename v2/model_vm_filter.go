...
// checks if the VMFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VMFilter{}
...
func (o *VMFilter) GetCaseSensitive() bool {
	if o == nil || IsNil(o.CaseSensitive.Get()) {
		var ret bool
		return ret
	}
...
func (o VMFilter) ToMap() (map[string]interface{}, error) {
