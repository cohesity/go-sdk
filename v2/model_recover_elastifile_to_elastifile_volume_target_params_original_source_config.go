...
// checks if the RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig{}

// RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig Specifies the Source configuration if volumes are being recovered to original Source. If not specified, all the configuration parameters will be retained.
type RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig struct {
...
func NewRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig() *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig {
	this := RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig{}
	return &this
}
...
func (o *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) ToMap() (map[string]interface{}, error) {
...
type NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig struct {
	value *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig
	isSet bool
}

func (v NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) Get() *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig {
	return v.value
}

func (v *NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) Set(val *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig(val *RecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) *NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig {
	return &NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverElastifileToElastifileVolumeTargetParamsOriginalSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
