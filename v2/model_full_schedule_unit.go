...
// checks if the FullScheduleUnit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FullScheduleUnit{}
...
func (o *FullScheduleUnit) GetFullScheduleUnit() string {
	if o == nil || IsNil(o.FullScheduleUnit) {
		var ret string
		return ret
	}
...
func (o FullScheduleUnit) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.FullScheduleUnit) {
