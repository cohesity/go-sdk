...
// checks if the Office365PublicFoldersProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365PublicFoldersProtectionGroupParams{}
...
func (o Office365PublicFoldersProtectionGroupParams) ToMap() (map[string]interface{}, error) {
