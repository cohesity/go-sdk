...
// checks if the RpaasConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RpaasConfig{}

// RpaasConfig Specifies settings for copying Snapshots to RPaaS Targets.
...
func (o *RpaasConfig) SetBackupRunTypeNil() {
...
func (o *RpaasConfig) SetConfigIdNil() {
	o.ConfigId.Set(nil)
}
...
func (o *RpaasConfig) SetCopyOnRunSuccessNil() {
...
func (o *RpaasConfig) SetTargetNameNil() {
...
func (o *RpaasConfig) SetTargetTypeNil() {
...
func (o RpaasConfig) MarshalJSON() ([]byte, error) {
...
func (o RpaasConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RpaasConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRpaasConfig := _RpaasConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRpaasConfig)

	if err != nil {
		return err
	}

	*o = RpaasConfig(varRpaasConfig)

	return err
}

type NullableRpaasConfig struct {
	value *RpaasConfig
	isSet bool
}

func (v NullableRpaasConfig) Get() *RpaasConfig {
	return v.value
}

func (v *NullableRpaasConfig) Set(val *RpaasConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRpaasConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRpaasConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRpaasConfig(val *RpaasConfig) *NullableRpaasConfig {
	return &NullableRpaasConfig{value: val, isSet: true}
}

func (v NullableRpaasConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRpaasConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
