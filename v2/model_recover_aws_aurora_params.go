...
// checks if the RecoverAwsAuroraParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverAwsAuroraParams{}
...
type _RecoverAwsAuroraParams RecoverAwsAuroraParams
...
func (o RecoverAwsAuroraParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverAwsAuroraParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverAwsAuroraParams := _RecoverAwsAuroraParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverAwsAuroraParams)

	if err != nil {
		return err
	}

	*o = RecoverAwsAuroraParams(varRecoverAwsAuroraParams)
