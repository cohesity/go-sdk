...
// checks if the CreateClusterParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateClusterParams{}
...
type _CreateClusterParams CreateClusterParams
...
func (o *CreateClusterParams) GetCloudClusterParams() ClusterCreateCloudParams {
	if o == nil || IsNil(o.CloudClusterParams.Get()) {
...
func (o *CreateClusterParams) GetVirtualClusterParams() ClusterCreateVirtualParams {
	if o == nil || IsNil(o.VirtualClusterParams) {
...
func (o CreateClusterParams) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VirtualClusterParams) {
		toSerialize["virtualClusterParams"] = o.VirtualClusterParams
	}
	return toSerialize, nil
}

func (o *CreateClusterParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateClusterParams := _CreateClusterParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateClusterParams)

	if err != nil {
		return err
	}

	*o = CreateClusterParams(varCreateClusterParams)
