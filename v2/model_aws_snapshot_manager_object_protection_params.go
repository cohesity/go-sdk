...
// checks if the AwsSnapshotManagerObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSnapshotManagerObjectProtectionParams{}
...
func (o AwsSnapshotManagerObjectProtectionParams) ToMap() (map[string]interface{}, error) {
