...
// checks if the IncrementalBackupPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IncrementalBackupPolicy{}
...
type _IncrementalBackupPolicy IncrementalBackupPolicy
...
func (o IncrementalBackupPolicy) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["schedule"] = o.Schedule
	return toSerialize, nil
}

func (o *IncrementalBackupPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varIncrementalBackupPolicy := _IncrementalBackupPolicy{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIncrementalBackupPolicy)

	if err != nil {
		return err
	}

	*o = IncrementalBackupPolicy(varIncrementalBackupPolicy)
