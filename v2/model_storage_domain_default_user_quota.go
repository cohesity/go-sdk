...
// checks if the StorageDomainDefaultUserQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StorageDomainDefaultUserQuota{}

// StorageDomainDefaultUserQuota Specifies a default user quota limit for users within views in this Storage Domain.
type StorageDomainDefaultUserQuota struct {
...
func NewStorageDomainDefaultUserQuota() *StorageDomainDefaultUserQuota {
	this := StorageDomainDefaultUserQuota{}
	return &this
}
...
func (o *StorageDomainDefaultUserQuota) SetAlertLimitBytesNil() {
...
func (o *StorageDomainDefaultUserQuota) SetAlertThresholdPercentageNil() {
...
func (o *StorageDomainDefaultUserQuota) SetHardLimitBytesNil() {
...
func (o StorageDomainDefaultUserQuota) MarshalJSON() ([]byte, error) {
...
func (o StorageDomainDefaultUserQuota) ToMap() (map[string]interface{}, error) {
...
type NullableStorageDomainDefaultUserQuota struct {
	value *StorageDomainDefaultUserQuota
	isSet bool
}

func (v NullableStorageDomainDefaultUserQuota) Get() *StorageDomainDefaultUserQuota {
	return v.value
}

func (v *NullableStorageDomainDefaultUserQuota) Set(val *StorageDomainDefaultUserQuota) {
	v.value = val
	v.isSet = true
}

func (v NullableStorageDomainDefaultUserQuota) IsSet() bool {
	return v.isSet
}

func (v *NullableStorageDomainDefaultUserQuota) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStorageDomainDefaultUserQuota(val *StorageDomainDefaultUserQuota) *NullableStorageDomainDefaultUserQuota {
	return &NullableStorageDomainDefaultUserQuota{value: val, isSet: true}
}

func (v NullableStorageDomainDefaultUserQuota) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStorageDomainDefaultUserQuota) UnmarshalJSON(src []byte) error {
	v.isSet = true
