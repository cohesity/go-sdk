...
// checks if the HeliosAzureTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosAzureTargetConfig{}

// HeliosAzureTargetConfig Specifies the configuration for adding Azure as replication target
...
type _HeliosAzureTargetConfig HeliosAzureTargetConfig
...
func (o *HeliosAzureTargetConfig) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *HeliosAzureTargetConfig) SetResourceGroupNil() {
...
func (o *HeliosAzureTargetConfig) SetResourceGroupNameNil() {
...
func (o *HeliosAzureTargetConfig) SetStorageAccountNil() {
...
func (o *HeliosAzureTargetConfig) SetStorageAccountNameNil() {
...
func (o *HeliosAzureTargetConfig) SetStorageContainerNil() {
...
func (o *HeliosAzureTargetConfig) GetStorageContainerName() string {
	if o == nil || IsNil(o.StorageContainerName.Get()) {
		var ret string
		return ret
	}
...
func (o *HeliosAzureTargetConfig) SetStorageContainerNameNil() {
...
func (o *HeliosAzureTargetConfig) SetStorageResourceGroupNil() {
...
func (o *HeliosAzureTargetConfig) GetStorageResourceGroupName() string {
	if o == nil || IsNil(o.StorageResourceGroupName.Get()) {
		var ret string
		return ret
	}
...
func (o *HeliosAzureTargetConfig) SetStorageResourceGroupNameNil() {
...
func (o HeliosAzureTargetConfig) MarshalJSON() ([]byte, error) {
...
func (o HeliosAzureTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *HeliosAzureTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varHeliosAzureTargetConfig := _HeliosAzureTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeliosAzureTargetConfig)

	if err != nil {
		return err
	}

	*o = HeliosAzureTargetConfig(varHeliosAzureTargetConfig)

	return err
}

type NullableHeliosAzureTargetConfig struct {
	value *HeliosAzureTargetConfig
	isSet bool
}

func (v NullableHeliosAzureTargetConfig) Get() *HeliosAzureTargetConfig {
	return v.value
}

func (v *NullableHeliosAzureTargetConfig) Set(val *HeliosAzureTargetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableHeliosAzureTargetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableHeliosAzureTargetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeliosAzureTargetConfig(val *HeliosAzureTargetConfig) *NullableHeliosAzureTargetConfig {
	return &NullableHeliosAzureTargetConfig{value: val, isSet: true}
}

func (v NullableHeliosAzureTargetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeliosAzureTargetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
