...
// checks if the SecurityPrincipals type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityPrincipals{}
...
func (o SecurityPrincipals) ToMap() (map[string]interface{}, error) {
