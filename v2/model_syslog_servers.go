...
// checks if the SyslogServers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogServers{}
...
func (o SyslogServers) ToMap() (map[string]interface{}, error) {
