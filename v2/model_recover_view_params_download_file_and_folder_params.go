...
// checks if the RecoverViewParamsDownloadFileAndFolderParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverViewParamsDownloadFileAndFolderParams{}

// RecoverViewParamsDownloadFileAndFolderParams Specifies the parameters to download files and folders.
type RecoverViewParamsDownloadFileAndFolderParams struct {
...
func NewRecoverViewParamsDownloadFileAndFolderParams() *RecoverViewParamsDownloadFileAndFolderParams {
	this := RecoverViewParamsDownloadFileAndFolderParams{}
	return &this
}
...
func (o *RecoverViewParamsDownloadFileAndFolderParams) SetDownloadFilePathNil() {
...
func (o *RecoverViewParamsDownloadFileAndFolderParams) SetExpiryTimeUsecsNil() {
...
func (o RecoverViewParamsDownloadFileAndFolderParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverViewParamsDownloadFileAndFolderParams) ToMap() (map[string]interface{}, error) {
...
type NullableRecoverViewParamsDownloadFileAndFolderParams struct {
	value *RecoverViewParamsDownloadFileAndFolderParams
	isSet bool
}

func (v NullableRecoverViewParamsDownloadFileAndFolderParams) Get() *RecoverViewParamsDownloadFileAndFolderParams {
	return v.value
}

func (v *NullableRecoverViewParamsDownloadFileAndFolderParams) Set(val *RecoverViewParamsDownloadFileAndFolderParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverViewParamsDownloadFileAndFolderParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverViewParamsDownloadFileAndFolderParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverViewParamsDownloadFileAndFolderParams(val *RecoverViewParamsDownloadFileAndFolderParams) *NullableRecoverViewParamsDownloadFileAndFolderParams {
	return &NullableRecoverViewParamsDownloadFileAndFolderParams{value: val, isSet: true}
}

func (v NullableRecoverViewParamsDownloadFileAndFolderParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverViewParamsDownloadFileAndFolderParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
