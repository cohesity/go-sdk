...
// checks if the AcropolisTargetParamsForRecoverVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcropolisTargetParamsForRecoverVm{}
...
func (o *AcropolisTargetParamsForRecoverVm) SetRecoverExcludedDiskNil() {
...
func (o AcropolisTargetParamsForRecoverVm) ToMap() (map[string]interface{}, error) {
