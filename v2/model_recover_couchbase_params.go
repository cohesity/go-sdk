...
// checks if the RecoverCouchbaseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverCouchbaseParams{}
...
type _RecoverCouchbaseParams RecoverCouchbaseParams
...
func (o *RecoverCouchbaseParams) GetAppendDocuments() bool {
	if o == nil || IsNil(o.AppendDocuments.Get()) {
		var ret bool
		return ret
	}
...
func (o *RecoverCouchbaseParams) GetDdlOnlyRecovery() bool {
	if o == nil || IsNil(o.DdlOnlyRecovery.Get()) {
		var ret bool
		return ret
	}
...
func (o *RecoverCouchbaseParams) GetOverwriteUsers() bool {
	if o == nil || IsNil(o.OverwriteUsers.Get()) {
		var ret bool
		return ret
	}
...
func (o RecoverCouchbaseParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverCouchbaseParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverCouchbaseParams := _RecoverCouchbaseParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverCouchbaseParams)

	if err != nil {
		return err
	}

	*o = RecoverCouchbaseParams(varRecoverCouchbaseParams)
