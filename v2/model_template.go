...
type Template struct {
	...
	ViewParams *TemplateViewParams `json:"viewParams,omitempty"`
}
...
// SetViewParams gets a reference to the given TemplateViewParams and assigns it to the ViewParams field.
