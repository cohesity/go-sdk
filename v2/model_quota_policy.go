...
// checks if the QuotaPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuotaPolicy{}
...
func (o QuotaPolicy) ToMap() (map[string]interface{}, error) {
