...
// checks if the RecoverKubernetesFileAndFolderParamsKubernetesTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverKubernetesFileAndFolderParamsKubernetesTargetParams{}
...
type _RecoverKubernetesFileAndFolderParamsKubernetesTargetParams RecoverKubernetesFileAndFolderParamsKubernetesTargetParams
...
func NewRecoverKubernetesFileAndFolderParamsKubernetesTargetParams(recoverToOriginalTarget NullableBool) *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams {
	this := RecoverKubernetesFileAndFolderParamsKubernetesTargetParams{}
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) SetNewTargetConfigNil() {
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) SetOriginalTargetConfigNil() {
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) SetOverwriteExistingNil() {
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) SetPreserveAttributesNil() {
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) SetVlanConfigNil() {
...
func (o RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverKubernetesFileAndFolderParamsKubernetesTargetParams := _RecoverKubernetesFileAndFolderParamsKubernetesTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverKubernetesFileAndFolderParamsKubernetesTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverKubernetesFileAndFolderParamsKubernetesTargetParams(varRecoverKubernetesFileAndFolderParamsKubernetesTargetParams)

	return err
}

type NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams struct {
	value *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams
	isSet bool
}

func (v NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams) Get() *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams {
	return v.value
}

func (v *NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams) Set(val *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams(val *RecoverKubernetesFileAndFolderParamsKubernetesTargetParams) *NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams {
	return &NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams{value: val, isSet: true}
}

func (v NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverKubernetesFileAndFolderParamsKubernetesTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
