...
// checks if the RecoverVmwareVmOriginalSourceNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverVmwareVmOriginalSourceNetworkConfig{}
...
func (o RecoverVmwareVmOriginalSourceNetworkConfig) ToMap() (map[string]interface{}, error) {
