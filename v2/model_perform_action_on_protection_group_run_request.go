...
// checks if the PerformActionOnProtectionGroupRunRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PerformActionOnProtectionGroupRunRequest{}
...
type _PerformActionOnProtectionGroupRunRequest PerformActionOnProtectionGroupRunRequest
...
func (o PerformActionOnProtectionGroupRunRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["action"] = o.Action.Get()
	if !IsNil(o.CancelParams) {
...
func (o *PerformActionOnProtectionGroupRunRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPerformActionOnProtectionGroupRunRequest := _PerformActionOnProtectionGroupRunRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerformActionOnProtectionGroupRunRequest)

	if err != nil {
		return err
	}

	*o = PerformActionOnProtectionGroupRunRequest(varPerformActionOnProtectionGroupRunRequest)
