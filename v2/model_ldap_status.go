...
// checks if the LdapStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapStatus{}
...
func (o LdapStatus) ToMap() (map[string]interface{}, error) {
