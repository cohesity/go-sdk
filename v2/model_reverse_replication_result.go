...
// checks if the ReverseReplicationResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReverseReplicationResult{}
...
func (o *ReverseReplicationResult) GetIsReverseReplicationEnabled() bool {
	if o == nil || IsNil(o.IsReverseReplicationEnabled.Get()) {
		var ret bool
		return ret
	}
...
func (o ReverseReplicationResult) ToMap() (map[string]interface{}, error) {
