...
// checks if the RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig{}

// RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig Specifies the Source configuration if files are being recovered to original Source. If not specified, all the configuration parameters will be retained.
type RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig struct {
...
type _RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig
...
func NewRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig(recoverToOriginalPath NullableBool) *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig {
	this := RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig{}
...
func (o *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) SetAlternatePathNil() {
...
func (o *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig := _RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig(varRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig)

	return err
}

type NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig struct {
	value *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig
	isSet bool
}

func (v NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) Get() *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig {
	return v.value
}

func (v *NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) Set(val *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig(val *RecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) *NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig {
	return &NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverElastifileToElastifileFilesTargetParamsOriginalSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
