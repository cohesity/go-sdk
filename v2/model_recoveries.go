...
// checks if the Recoveries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Recoveries{}
...
func (o Recoveries) ToMap() (map[string]interface{}, error) {
