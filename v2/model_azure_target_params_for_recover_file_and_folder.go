...
// checks if the AzureTargetParamsForRecoverFileAndFolder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureTargetParamsForRecoverFileAndFolder{}
...
type _AzureTargetParamsForRecoverFileAndFolder AzureTargetParamsForRecoverFileAndFolder
...
func (o AzureTargetParamsForRecoverFileAndFolder) ToMap() (map[string]interface{}, error) {
...
func (o *AzureTargetParamsForRecoverFileAndFolder) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureTargetParamsForRecoverFileAndFolder := _AzureTargetParamsForRecoverFileAndFolder{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureTargetParamsForRecoverFileAndFolder)

	if err != nil {
		return err
	}

	*o = AzureTargetParamsForRecoverFileAndFolder(varAzureTargetParamsForRecoverFileAndFolder)
