...
// checks if the MongodbSearchParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MongodbSearchParams{}
...
type _MongodbSearchParams MongodbSearchParams
...
func (o MongodbSearchParams) ToMap() (map[string]interface{}, error) {
...
func (o *MongodbSearchParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMongodbSearchParams := _MongodbSearchParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMongodbSearchParams)

	if err != nil {
		return err
	}

	*o = MongodbSearchParams(varMongodbSearchParams)
