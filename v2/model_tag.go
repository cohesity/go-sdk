...
type Tag struct {
	...
	Id NullableString `json:"id,omitempty" validate:"regexp=^\\\\d+:\\\\d+:[A-Z0-9-]+$"`
...
func (o *Tag) GetCreatedTimeUsecs() int32 {
	if o == nil || IsNil(o.CreatedTimeUsecs.Get()) {
		var ret int32
		return ret
	}
...
func (o *Tag) GetMarkedForDeletion() bool {
	if o == nil || IsNil(o.MarkedForDeletion.Get()) {
		var ret bool
		return ret
	}
...
func (o *Tag) GetUiPathElementsOk() ([]string, bool) {
	if o == nil || IsNil(o.UiPathElements) {
		return nil, false
	}
