...
// checks if the AcropolisTargetParamsForRecoverFileAndFolderVlanConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcropolisTargetParamsForRecoverFileAndFolderVlanConfig{}
...
type AcropolisTargetParamsForRecoverFileAndFolderVlanConfig struct {
...
func NewAcropolisTargetParamsForRecoverFileAndFolderVlanConfig() *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig {
	this := AcropolisTargetParamsForRecoverFileAndFolderVlanConfig{}
	return &this
}
...
func (o *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) SetDisableVlanNil() {
...
func (o *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) SetInterfaceNameNil() {
...
func (o AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) MarshalJSON() ([]byte, error) {
...
func (o AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) ToMap() (map[string]interface{}, error) {
...
type NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig struct {
	value *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig
	isSet bool
}

func (v NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig) Get() *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig {
	return v.value
}

func (v *NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig) Set(val *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig(val *AcropolisTargetParamsForRecoverFileAndFolderVlanConfig) *NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig {
	return &NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig{value: val, isSet: true}
}

func (v NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcropolisTargetParamsForRecoverFileAndFolderVlanConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
