...
// checks if the ArchivalTargetSummaryInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArchivalTargetSummaryInfo{}
...
func NewArchivalTargetSummaryInfo() *ArchivalTargetSummaryInfo {
	this := ArchivalTargetSummaryInfo{}
	return &this
}
...
func (o *ArchivalTargetSummaryInfo) SetArchivalTaskIdNil() {
...
func (o *ArchivalTargetSummaryInfo) SetOwnershipContextNil() {
...
func (o *ArchivalTargetSummaryInfo) SetTargetIdNil() {
	o.TargetId.Set(nil)
}
...
func (o *ArchivalTargetSummaryInfo) SetTargetNameNil() {
...
func (o *ArchivalTargetSummaryInfo) SetTargetTypeNil() {
...
func (o *ArchivalTargetSummaryInfo) SetUsageTypeNil() {
	o.UsageType.Set(nil)
}
...
func (o ArchivalTargetSummaryInfo) MarshalJSON() ([]byte, error) {
...
func (o ArchivalTargetSummaryInfo) ToMap() (map[string]interface{}, error) {
...
type NullableArchivalTargetSummaryInfo struct {
	value *ArchivalTargetSummaryInfo
	isSet bool
}

func (v NullableArchivalTargetSummaryInfo) Get() *ArchivalTargetSummaryInfo {
	return v.value
}

func (v *NullableArchivalTargetSummaryInfo) Set(val *ArchivalTargetSummaryInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableArchivalTargetSummaryInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableArchivalTargetSummaryInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArchivalTargetSummaryInfo(val *ArchivalTargetSummaryInfo) *NullableArchivalTargetSummaryInfo {
	return &NullableArchivalTargetSummaryInfo{value: val, isSet: true}
}

func (v NullableArchivalTargetSummaryInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArchivalTargetSummaryInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
