...
------------ | ------------- | ------------- | -------------
**Value** | Pointer to **string** | Specifies the node status of running upgrade checks. | [optional] 

## Methods

### NewUpgradecheckNodeTestStatus
...
### NewUpgradecheckNodeTestStatusWithDefaults
