...
**IsCadArchive** | Pointer to **NullableBool** | Whether this is CAD archive or not | [optional] 
...
**StatsTaskId** | Pointer to **NullableString** | Run Stats task id for archival. | [optional] 
