...
`func NewCreateCsrResponseBody(city NullableString, countryCode NullableString, organization NullableString, organizationUnit NullableString, state NullableString, ) *CreateCsrResponseBody`
