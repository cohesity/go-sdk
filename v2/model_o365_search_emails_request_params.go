...
// checks if the O365SearchEmailsRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &O365SearchEmailsRequestParams{}
...
func (o O365SearchEmailsRequestParams) ToMap() (map[string]interface{}, error) {
