...
// checks if the RecoverGcpParamsDownloadFileAndFolderParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGcpParamsDownloadFileAndFolderParams{}

// RecoverGcpParamsDownloadFileAndFolderParams Specifies the parameters to download files and folders.
type RecoverGcpParamsDownloadFileAndFolderParams struct {
...
func NewRecoverGcpParamsDownloadFileAndFolderParams() *RecoverGcpParamsDownloadFileAndFolderParams {
	this := RecoverGcpParamsDownloadFileAndFolderParams{}
	return &this
}
...
func (o *RecoverGcpParamsDownloadFileAndFolderParams) SetDownloadFilePathNil() {
...
func (o *RecoverGcpParamsDownloadFileAndFolderParams) SetExpiryTimeUsecsNil() {
...
func (o RecoverGcpParamsDownloadFileAndFolderParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverGcpParamsDownloadFileAndFolderParams) ToMap() (map[string]interface{}, error) {
...
type NullableRecoverGcpParamsDownloadFileAndFolderParams struct {
	value *RecoverGcpParamsDownloadFileAndFolderParams
	isSet bool
}

func (v NullableRecoverGcpParamsDownloadFileAndFolderParams) Get() *RecoverGcpParamsDownloadFileAndFolderParams {
	return v.value
}

func (v *NullableRecoverGcpParamsDownloadFileAndFolderParams) Set(val *RecoverGcpParamsDownloadFileAndFolderParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverGcpParamsDownloadFileAndFolderParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverGcpParamsDownloadFileAndFolderParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverGcpParamsDownloadFileAndFolderParams(val *RecoverGcpParamsDownloadFileAndFolderParams) *NullableRecoverGcpParamsDownloadFileAndFolderParams {
	return &NullableRecoverGcpParamsDownloadFileAndFolderParams{value: val, isSet: true}
}

func (v NullableRecoverGcpParamsDownloadFileAndFolderParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverGcpParamsDownloadFileAndFolderParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
