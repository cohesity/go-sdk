...
// checks if the TargetMsTeamParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetMsTeamParam{}
...
func (o *TargetMsTeamParam) SetParentSourceIdNil() {
...
func (o *TargetMsTeamParam) SetTargetTeamNil() {
...
func (o TargetMsTeamParam) MarshalJSON() ([]byte, error) {
...
func (o TargetMsTeamParam) ToMap() (map[string]interface{}, error) {
...
type NullableTargetMsTeamParam struct {
	value *TargetMsTeamParam
	isSet bool
}

func (v NullableTargetMsTeamParam) Get() *TargetMsTeamParam {
	return v.value
}

func (v *NullableTargetMsTeamParam) Set(val *TargetMsTeamParam) {
	v.value = val
	v.isSet = true
}

func (v NullableTargetMsTeamParam) IsSet() bool {
	return v.isSet
}

func (v *NullableTargetMsTeamParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTargetMsTeamParam(val *TargetMsTeamParam) *NullableTargetMsTeamParam {
	return &NullableTargetMsTeamParam{value: val, isSet: true}
}

func (v NullableTargetMsTeamParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTargetMsTeamParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
