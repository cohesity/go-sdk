...
// checks if the PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget{}
...
type _PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget
...
func NewPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(id NullableInt64) *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget {
	this := PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget{}
	this.Id = id
	return &this
}
...
func (o *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) SetParentSourceIdNil() {
...
func (o *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) SetParentSourceNameNil() {
...
func (o PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) MarshalJSON() ([]byte, error) {
...
func (o PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget := _PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget)

	if err != nil {
		return err
	}

	*o = PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(varPhysicalTargetParamsForRecoverFileAndFolderRecoverTarget)

	return err
}

type NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget struct {
	value *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget
	isSet bool
}

func (v NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) Get() *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget {
	return v.value
}

func (v *NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) Set(val *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) {
	v.value = val
	v.isSet = true
}

func (v NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) IsSet() bool {
	return v.isSet
}

func (v *NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget(val *PhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) *NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget {
	return &NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget{value: val, isSet: true}
}

func (v NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhysicalTargetParamsForRecoverFileAndFolderRecoverTarget) UnmarshalJSON(src []byte) error {
	v.isSet = true
