...
// checks if the HbaseSourceRegistrationUpdateParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HbaseSourceRegistrationUpdateParams{}
...
func (o HbaseSourceRegistrationUpdateParams) ToMap() (map[string]interface{}, error) {
