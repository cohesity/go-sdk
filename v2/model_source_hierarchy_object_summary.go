...
// checks if the SourceHierarchyObjectSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceHierarchyObjectSummary{}
...
func (o SourceHierarchyObjectSummary) ToMap() (map[string]interface{}, error) {
