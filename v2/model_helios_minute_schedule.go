...
// checks if the HeliosMinuteSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosMinuteSchedule{}
...
type _HeliosMinuteSchedule HeliosMinuteSchedule
...
func (o HeliosMinuteSchedule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["frequency"] = o.Frequency.Get()
	return toSerialize, nil
}

func (o *HeliosMinuteSchedule) UnmarshalJSON(data []byte) (err error) {
	...
	varHeliosMinuteSchedule := _HeliosMinuteSchedule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeliosMinuteSchedule)

	if err != nil {
		return err
	}

	*o = HeliosMinuteSchedule(varHeliosMinuteSchedule)
