...
// checks if the OriginalIsilonFilesTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OriginalIsilonFilesTargetParams{}

// OriginalIsilonFilesTargetParams Specifies the params of the original Isilon recovery target.
type OriginalIsilonFilesTargetParams struct {
...
type _OriginalIsilonFilesTargetParams OriginalIsilonFilesTargetParams
...
func NewOriginalIsilonFilesTargetParams(recoverToOriginalPath NullableBool) *OriginalIsilonFilesTargetParams {
	this := OriginalIsilonFilesTargetParams{}
...
func (o *OriginalIsilonFilesTargetParams) SetAlternatePathNil() {
...
func (o *OriginalIsilonFilesTargetParams) SetContinueOnErrorNil() {
...
func (o *OriginalIsilonFilesTargetParams) SetEncryptionEnabledNil() {
...
func (o *OriginalIsilonFilesTargetParams) SetOverwriteExistingFileNil() {
...
func (o *OriginalIsilonFilesTargetParams) SetPreserveFileAttributesNil() {
...
func (o OriginalIsilonFilesTargetParams) MarshalJSON() ([]byte, error) {
...
func (o OriginalIsilonFilesTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *OriginalIsilonFilesTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOriginalIsilonFilesTargetParams := _OriginalIsilonFilesTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOriginalIsilonFilesTargetParams)

	if err != nil {
		return err
	}

	*o = OriginalIsilonFilesTargetParams(varOriginalIsilonFilesTargetParams)

	return err
}

type NullableOriginalIsilonFilesTargetParams struct {
	value *OriginalIsilonFilesTargetParams
	isSet bool
}

func (v NullableOriginalIsilonFilesTargetParams) Get() *OriginalIsilonFilesTargetParams {
	return v.value
}

func (v *NullableOriginalIsilonFilesTargetParams) Set(val *OriginalIsilonFilesTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableOriginalIsilonFilesTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableOriginalIsilonFilesTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOriginalIsilonFilesTargetParams(val *OriginalIsilonFilesTargetParams) *NullableOriginalIsilonFilesTargetParams {
	return &NullableOriginalIsilonFilesTargetParams{value: val, isSet: true}
}

func (v NullableOriginalIsilonFilesTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOriginalIsilonFilesTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
