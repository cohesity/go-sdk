...
// checks if the RecoverExchangeDbsSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverExchangeDbsSnapshotParams{}

// RecoverExchangeDbsSnapshotParams Specifies the snapshot parameters to recover Exchange databases.
type RecoverExchangeDbsSnapshotParams struct {
	...
	RecoveryTargetConfig map[string]interface{} `json:"recoveryTargetConfig,omitempty"`
}

type _RecoverExchangeDbsSnapshotParams RecoverExchangeDbsSnapshotParams
...
func NewRecoverExchangeDbsSnapshotParams(snapshotId string) *RecoverExchangeDbsSnapshotParams {
	this := RecoverExchangeDbsSnapshotParams{}
...
func (o *RecoverExchangeDbsSnapshotParams) SetArchivalTargetInfoNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetBytesRestoredNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetEndTimeUsecsNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetObjectInfoNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetPointInTimeUsecsNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetProgressTaskIdNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetProtectionGroupIdNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetProtectionGroupNameNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetRecoverFromStandbyNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetSnapshotCreationTimeUsecsNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetSnapshotTargetTypeNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetStartTimeUsecsNil() {
...
func (o *RecoverExchangeDbsSnapshotParams) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *RecoverExchangeDbsSnapshotParams) SetStorageDomainIdNil() {
...
// SetRecoveryTargetConfig gets a reference to the given map[string]interface{} and assigns it to the RecoveryTargetConfig field.
func (o *RecoverExchangeDbsSnapshotParams) SetRecoveryTargetConfig(v map[string]interface{}) {
	o.RecoveryTargetConfig = v
}

func (o RecoverExchangeDbsSnapshotParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverExchangeDbsSnapshotParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverExchangeDbsSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverExchangeDbsSnapshotParams := _RecoverExchangeDbsSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverExchangeDbsSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverExchangeDbsSnapshotParams(varRecoverExchangeDbsSnapshotParams)

	return err
}

type NullableRecoverExchangeDbsSnapshotParams struct {
	value *RecoverExchangeDbsSnapshotParams
	isSet bool
}

func (v NullableRecoverExchangeDbsSnapshotParams) Get() *RecoverExchangeDbsSnapshotParams {
	return v.value
}

func (v *NullableRecoverExchangeDbsSnapshotParams) Set(val *RecoverExchangeDbsSnapshotParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverExchangeDbsSnapshotParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverExchangeDbsSnapshotParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverExchangeDbsSnapshotParams(val *RecoverExchangeDbsSnapshotParams) *NullableRecoverExchangeDbsSnapshotParams {
	return &NullableRecoverExchangeDbsSnapshotParams{value: val, isSet: true}
}

func (v NullableRecoverExchangeDbsSnapshotParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverExchangeDbsSnapshotParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
