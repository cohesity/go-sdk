...
// checks if the CommonStandbyResourceParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonStandbyResourceParams{}
...
func (o CommonStandbyResourceParams) ToMap() (map[string]interface{}, error) {
