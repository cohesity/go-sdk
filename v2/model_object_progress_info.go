...
// checks if the ObjectProgressInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectProgressInfo{}
...
func (o ObjectProgressInfo) ToMap() (map[string]interface{}, error) {
