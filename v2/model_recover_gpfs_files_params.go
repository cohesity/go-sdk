...
// checks if the RecoverGpfsFilesParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGpfsFilesParams{}
...
type _RecoverGpfsFilesParams RecoverGpfsFilesParams
...
func (o RecoverGpfsFilesParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverGpfsFilesParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverGpfsFilesParams := _RecoverGpfsFilesParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverGpfsFilesParams)

	if err != nil {
		return err
	}

	*o = RecoverGpfsFilesParams(varRecoverGpfsFilesParams)
