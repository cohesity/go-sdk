...
// checks if the OrgVDCNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgVDCNetwork{}
...
type _OrgVDCNetwork OrgVDCNetwork
...
func (o *OrgVDCNetwork) GetVCenterUuid() string {
	if o == nil || IsNil(o.VCenterUuid.Get()) {
		var ret string
		return ret
	}
...
func (o OrgVDCNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *OrgVDCNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varOrgVDCNetwork := _OrgVDCNetwork{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrgVDCNetwork)

	if err != nil {
		return err
	}

	*o = OrgVDCNetwork(varOrgVDCNetwork)
