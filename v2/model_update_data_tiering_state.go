...
// checks if the UpdateDataTieringState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDataTieringState{}
...
func (o UpdateDataTieringState) ToMap() (map[string]interface{}, error) {
