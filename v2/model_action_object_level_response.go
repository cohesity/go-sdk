...
// checks if the ActionObjectLevelResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionObjectLevelResponse{}
...
type _ActionObjectLevelResponse ActionObjectLevelResponse
...
func (o *ActionObjectLevelResponse) GetUnProtectStatus() UnprotectActionObjectLevelResponse {
	if o == nil || IsNil(o.UnProtectStatus) {
...
func (o ActionObjectLevelResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ResumeStatus) {
		toSerialize["resumeStatus"] = o.ResumeStatus
	}
	if !IsNil(o.RunNowStatus) {
		toSerialize["runNowStatus"] = o.RunNowStatus
	}
	if !IsNil(o.UnProtectStatus) {
		toSerialize["unProtectStatus"] = o.UnProtectStatus
	}
	return toSerialize, nil
}

func (o *ActionObjectLevelResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varActionObjectLevelResponse := _ActionObjectLevelResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varActionObjectLevelResponse)

	if err != nil {
		return err
	}

	*o = ActionObjectLevelResponse(varActionObjectLevelResponse)
