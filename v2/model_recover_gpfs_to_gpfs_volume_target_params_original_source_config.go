...
// checks if the RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig{}

// RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig Specifies the Source configuration if volumes are being recovered to original Source. If not specified, all the configuration parameters will be retained.
type RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig struct {
...
func NewRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig() *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig {
	this := RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig{}
	return &this
}
...
func (o *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) ToMap() (map[string]interface{}, error) {
...
type NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig struct {
	value *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig
	isSet bool
}

func (v NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) Get() *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig {
	return v.value
}

func (v *NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) Set(val *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig(val *RecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) *NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig {
	return &NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverGpfsToGpfsVolumeTargetParamsOriginalSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
