...
// checks if the RecoverCassandraNoSqlObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverCassandraNoSqlObjectParams{}
...
type _RecoverCassandraNoSqlObjectParams RecoverCassandraNoSqlObjectParams
...
func (o RecoverCassandraNoSqlObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverCassandraNoSqlObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverCassandraNoSqlObjectParams := _RecoverCassandraNoSqlObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverCassandraNoSqlObjectParams)

	if err != nil {
		return err
	}

	*o = RecoverCassandraNoSqlObjectParams(varRecoverCassandraNoSqlObjectParams)
