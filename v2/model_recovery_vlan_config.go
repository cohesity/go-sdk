...
// checks if the RecoveryVlanConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryVlanConfig{}
...
func (o RecoveryVlanConfig) ToMap() (map[string]interface{}, error) {
