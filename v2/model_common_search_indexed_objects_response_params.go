...
// checks if the CommonSearchIndexedObjectsResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonSearchIndexedObjectsResponseParams{}
...
func (o CommonSearchIndexedObjectsResponseParams) ToMap() (map[string]interface{}, error) {
