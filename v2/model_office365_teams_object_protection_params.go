...
// checks if the Office365TeamsObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365TeamsObjectProtectionParams{}
...
type _Office365TeamsObjectProtectionParams Office365TeamsObjectProtectionParams
...
func (o Office365TeamsObjectProtectionParams) ToMap() (map[string]interface{}, error) {
...
func (o *Office365TeamsObjectProtectionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOffice365TeamsObjectProtectionParams := _Office365TeamsObjectProtectionParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOffice365TeamsObjectProtectionParams)

	if err != nil {
		return err
	}

	*o = Office365TeamsObjectProtectionParams(varOffice365TeamsObjectProtectionParams)
