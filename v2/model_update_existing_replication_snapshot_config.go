...
// checks if the UpdateExistingReplicationSnapshotConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateExistingReplicationSnapshotConfig{}
...
type _UpdateExistingReplicationSnapshotConfig UpdateExistingReplicationSnapshotConfig
...
func (o *UpdateExistingReplicationSnapshotConfig) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o UpdateExistingReplicationSnapshotConfig) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateExistingReplicationSnapshotConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateExistingReplicationSnapshotConfig := _UpdateExistingReplicationSnapshotConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateExistingReplicationSnapshotConfig)

	if err != nil {
		return err
	}

	*o = UpdateExistingReplicationSnapshotConfig(varUpdateExistingReplicationSnapshotConfig)
