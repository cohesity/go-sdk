...
// checks if the GenericNasObjectProtectionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericNasObjectProtectionResponseParams{}
...
func (o *GenericNasObjectProtectionResponseParams) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o GenericNasObjectProtectionResponseParams) ToMap() (map[string]interface{}, error) {
