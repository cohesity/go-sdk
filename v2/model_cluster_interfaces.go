...
// checks if the ClusterInterfaces type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterInterfaces{}
...
func (o ClusterInterfaces) ToMap() (map[string]interface{}, error) {
