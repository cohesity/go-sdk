...
// checks if the HeliosTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosTier{}
...
func (o *HeliosTier) GetIsDefaultTier() bool {
	if o == nil || IsNil(o.IsDefaultTier.Get()) {
		var ret bool
		return ret
	}
...
func (o HeliosTier) ToMap() (map[string]interface{}, error) {
