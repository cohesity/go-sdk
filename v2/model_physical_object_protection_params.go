...
// checks if the PhysicalObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhysicalObjectProtectionParams{}
...
type _PhysicalObjectProtectionParams PhysicalObjectProtectionParams
...
func (o PhysicalObjectProtectionParams) ToMap() (map[string]interface{}, error) {
...
func (o *PhysicalObjectProtectionParams) UnmarshalJSON(data []byte) (err error) {
	...
	varPhysicalObjectProtectionParams := _PhysicalObjectProtectionParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPhysicalObjectProtectionParams)

	if err != nil {
		return err
	}

	*o = PhysicalObjectProtectionParams(varPhysicalObjectProtectionParams)
