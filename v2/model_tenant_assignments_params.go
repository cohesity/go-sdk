...
// checks if the TenantAssignmentsParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantAssignmentsParams{}
...
func (o *TenantAssignmentsParams) GetVlanIfaceNamesOk() ([]string, bool) {
	if o == nil || IsNil(o.VlanIfaceNames) {
		return nil, false
	}
...
func (o TenantAssignmentsParams) ToMap() (map[string]interface{}, error) {
