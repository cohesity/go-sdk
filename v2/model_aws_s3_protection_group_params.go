...
// checks if the AwsS3ProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsS3ProtectionGroupParams{}

// AwsS3ProtectionGroupParams Specifies the parameters which are specific to AWS S3 Protection.
type AwsS3ProtectionGroupParams struct {
	...
	Objects []AwsS3ProtectionGroupObjectParams `json:"objects,omitempty"`
...
func NewAwsS3ProtectionGroupParams() *AwsS3ProtectionGroupParams {
	this := AwsS3ProtectionGroupParams{}
	return &this
}
...
func (o *AwsS3ProtectionGroupParams) SetBackupObjectLevelACLsNil() {
...
func (o *AwsS3ProtectionGroupParams) SetBaselineIncrementalFrequencyNil() {
...
func (o *AwsS3ProtectionGroupParams) SetInventoryReportDestinationNil() {
...
func (o *AwsS3ProtectionGroupParams) SetInventoryReportDestinationPrefixNil() {
...
func (o *AwsS3ProtectionGroupParams) SetInventoryReportFrequencyNil() {
...
func (o *AwsS3ProtectionGroupParams) GetObjects() []AwsS3ProtectionGroupObjectParams {
	if o == nil || IsNil(o.Objects) {
		var ret []AwsS3ProtectionGroupObjectParams
		return ret
	}
	return o.Objects
}
...
// SetObjects gets a reference to the given []AwsS3ProtectionGroupObjectParams and assigns it to the Objects field.
...
func (o *AwsS3ProtectionGroupParams) SetSkipOnErrorNil() {
...
func (o *AwsS3ProtectionGroupParams) SetSourceIdNil() {
	o.SourceId.Set(nil)
}
...
func (o *AwsS3ProtectionGroupParams) SetSourceNameNil() {
...
func (o AwsS3ProtectionGroupParams) MarshalJSON() ([]byte, error) {
...
func (o AwsS3ProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
type NullableAwsS3ProtectionGroupParams struct {
	value *AwsS3ProtectionGroupParams
	isSet bool
}

func (v NullableAwsS3ProtectionGroupParams) Get() *AwsS3ProtectionGroupParams {
	return v.value
}

func (v *NullableAwsS3ProtectionGroupParams) Set(val *AwsS3ProtectionGroupParams) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsS3ProtectionGroupParams) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsS3ProtectionGroupParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsS3ProtectionGroupParams(val *AwsS3ProtectionGroupParams) *NullableAwsS3ProtectionGroupParams {
	return &NullableAwsS3ProtectionGroupParams{value: val, isSet: true}
}

func (v NullableAwsS3ProtectionGroupParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsS3ProtectionGroupParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
