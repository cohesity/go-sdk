...
// checks if the AzureTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureTargetConfig{}
...
type _AzureTargetConfig AzureTargetConfig
...
func (o AzureTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AzureTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureTargetConfig := _AzureTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureTargetConfig)

	if err != nil {
		return err
	}

	*o = AzureTargetConfig(varAzureTargetConfig)
