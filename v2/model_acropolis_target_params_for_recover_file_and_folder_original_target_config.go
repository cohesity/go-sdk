...
// checks if the AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig{}

// AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig Specifies the configuration for recovering to the original target.
type AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig struct {
...
type _AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig
...
func NewAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig(recoverToOriginalPath NullableBool) *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig {
	this := AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig{}
...
func (o *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) SetAlternatePathNil() {
...
func (o *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) SetTargetVmCredentialsNil() {
...
func (o AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) MarshalJSON() ([]byte, error) {
...
func (o AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig := _AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig)

	if err != nil {
		return err
	}

	*o = AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig(varAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig)

	return err
}

type NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig struct {
	value *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig
	isSet bool
}

func (v NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) Get() *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig {
	return v.value
}

func (v *NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) Set(val *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig(val *AcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) *NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig {
	return &NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig{value: val, isSet: true}
}

func (v NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcropolisTargetParamsForRecoverFileAndFolderOriginalTargetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
