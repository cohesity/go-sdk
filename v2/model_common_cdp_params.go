...
// checks if the CommonCdpParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonCdpParams{}
...
func (o CommonCdpParams) ToMap() (map[string]interface{}, error) {
