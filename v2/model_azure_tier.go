...
// checks if the AzureTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureTier{}
...
func (o AzureTier) ToMap() (map[string]interface{}, error) {
...
func (o *AzureTier) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureTier := _AzureTier{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureTier)

	if err != nil {
		return err
	}

	*o = AzureTier(varAzureTier)
