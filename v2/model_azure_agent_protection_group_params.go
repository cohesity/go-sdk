...
// checks if the AzureAgentProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureAgentProtectionGroupParams{}
...
type _AzureAgentProtectionGroupParams AzureAgentProtectionGroupParams
...
func (o AzureAgentProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *AzureAgentProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureAgentProtectionGroupParams := _AzureAgentProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureAgentProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = AzureAgentProtectionGroupParams(varAzureAgentProtectionGroupParams)
