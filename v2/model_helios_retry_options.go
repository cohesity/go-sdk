...
// checks if the HeliosRetryOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosRetryOptions{}
...
func (o *HeliosRetryOptions) GetRetryIntervalMins() int32 {
	if o == nil || IsNil(o.RetryIntervalMins.Get()) {
		var ret int32
		return ret
	}
...
func (o HeliosRetryOptions) ToMap() (map[string]interface{}, error) {
