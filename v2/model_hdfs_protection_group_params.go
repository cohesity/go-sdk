...
// checks if the HdfsProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HdfsProtectionGroupParams{}
...
type _HdfsProtectionGroupParams HdfsProtectionGroupParams
...
func (o HdfsProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *HdfsProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varHdfsProtectionGroupParams := _HdfsProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHdfsProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = HdfsProtectionGroupParams(varHdfsProtectionGroupParams)
