...
func (o *DeleteInfectedFilesCreated) Error() string {
	return fmt.Sprintf("[DELETE /antivirus-service/infected-files][%d] deleteInfectedFilesCreated  %+v", 201, o.Payload)
}
...
func (o *DeleteInfectedFilesDefault) Error() string {
	return fmt.Sprintf("[DELETE /antivirus-service/infected-files][%d] DeleteInfectedFiles default  %+v", o._statusCode, o.Payload)
}
