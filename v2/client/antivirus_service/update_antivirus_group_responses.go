...
func (o *UpdateAntivirusGroupOK) Error() string {
	return fmt.Sprintf("[PUT /antivirus-service/groups/{id}][%d] updateAntivirusGroupOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAntivirusGroupDefault) Error() string {
	return fmt.Sprintf("[PUT /antivirus-service/groups/{id}][%d] UpdateAntivirusGroup default  %+v", o._statusCode, o.Payload)
}
