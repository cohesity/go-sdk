...
func (o *UpdateAMQPTargetConfigOK) Error() string {
	return fmt.Sprintf("[PUT /clusters/amqp-target-config][%d] updateAMQPTargetConfigOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAMQPTargetConfigDefault) Error() string {
	return fmt.Sprintf("[PUT /clusters/amqp-target-config][%d] UpdateAMQPTargetConfig default  %+v", o._statusCode, o.Payload)
}
