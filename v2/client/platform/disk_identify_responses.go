...
func (o *DiskIdentifyOK) Error() string {
	return fmt.Sprintf("[POST /disks/identify][%d] diskIdentifyOK  %+v", 200, o.Payload)
}
...
func (o *DiskIdentifyDefault) Error() string {
	return fmt.Sprintf("[POST /disks/identify][%d] DiskIdentify default  %+v", o._statusCode, o.Payload)
}
