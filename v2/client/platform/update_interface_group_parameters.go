...
// WithName adds the name to the update interface group params
func (o *UpdateInterfaceGroupParams) WithName(name string) *UpdateInterfaceGroupParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the update interface group params
func (o *UpdateInterfaceGroupParams) SetName(name string) {
	o.Name = name
}
