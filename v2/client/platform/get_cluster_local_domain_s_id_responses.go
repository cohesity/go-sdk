...
func (o *GetClusterLocalDomainSIDOK) Error() string {
	return fmt.Sprintf("[GET /clusters/local-domain-sid][%d] getClusterLocalDomainSIdOK  %+v", 200, o.Payload)
}
...
func (o *GetClusterLocalDomainSIDDefault) Error() string {
	return fmt.Sprintf("[GET /clusters/local-domain-sid][%d] GetClusterLocalDomainSID default  %+v", o._statusCode, o.Payload)
}
