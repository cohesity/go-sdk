...
func (o *GetClusterStateOK) Error() string {
	return fmt.Sprintf("[GET /clusters/state][%d] getClusterStateOK  %+v", 200, o.Payload)
}
...
func (o *GetClusterStateDefault) Error() string {
	return fmt.Sprintf("[GET /clusters/state][%d] GetClusterState default  %+v", o._statusCode, o.Payload)
}
