...
func (o *UpgradeCheckGetResultsOK) Error() string {
	return fmt.Sprintf("[GET /clusters/upgrade-checks/{testRunInstanceId}][%d] upgradeCheckGetResultsOK  %+v", 200, o.Payload)
}
...
func (o *UpgradeCheckGetResultsDefault) Error() string {
	return fmt.Sprintf("[GET /clusters/upgrade-checks/{testRunInstanceId}][%d] UpgradeCheckGetResults default  %+v", o._statusCode, o.Payload)
}
