...
func (o *GetRemoteDisksOK) Error() string {
	return fmt.Sprintf("[GET /disks/remote][%d] getRemoteDisksOK  %+v", 200, o.Payload)
}
...
func (o *GetRemoteDisksDefault) Error() string {
	return fmt.Sprintf("[GET /disks/remote][%d] GetRemoteDisks default  %+v", o._statusCode, o.Payload)
}
