...
func (o *GetIpmiLanInfoOK) Error() string {
	return fmt.Sprintf("[GET /ipmi/get-lan-info][%d] getIpmiLanInfoOK  %+v", 200, o.Payload)
}
...
func (o *GetIpmiLanInfoDefault) Error() string {
	return fmt.Sprintf("[GET /ipmi/get-lan-info][%d] GetIpmiLanInfo default  %+v", o._statusCode, o.Payload)
}
