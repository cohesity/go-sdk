...
func (o *GetNetworkInterfacesOK) Error() string {
	return fmt.Sprintf("[GET /network-interfaces][%d] getNetworkInterfacesOK  %+v", 200, o.Payload)
}
...
func (o *GetNetworkInterfacesDefault) Error() string {
	return fmt.Sprintf("[GET /network-interfaces][%d] GetNetworkInterfaces default  %+v", o._statusCode, o.Payload)
}
