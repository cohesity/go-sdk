...
func (o *UpdateIsDMaaSClusterOK) Error() string {
	return fmt.Sprintf("[PUT /clusters/is-dmaas][%d] updateIsDMaaSClusterOK  %+v", 200, o.Payload)
}
...
func (o *UpdateIsDMaaSClusterDefault) Error() string {
	return fmt.Sprintf("[PUT /clusters/is-dmaas][%d] UpdateIsDMaaSCluster default  %+v", o._statusCode, o.Payload)
}
