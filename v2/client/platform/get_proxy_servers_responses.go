...
type GetProxyServersOK struct {
	Payload *models.ProxyServerList
}
...
func (o *GetProxyServersOK) Error() string {
	return fmt.Sprintf("[GET /proxy-servers][%d] getProxyServersOK  %+v", 200, o.Payload)
}
...
func (o *GetProxyServersOK) GetPayload() *models.ProxyServerList {
	return o.Payload
}
...
func (o *GetProxyServersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ProxyServerList)
...
func (o *GetProxyServersDefault) Error() string {
	return fmt.Sprintf("[GET /proxy-servers][%d] GetProxyServers default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetProxyServersDefault) GetPayload() *models.Error {
	return o.Payload
}
