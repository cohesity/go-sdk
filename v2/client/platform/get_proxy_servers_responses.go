...
func (o *GetProxyServersOK) Error() string {
	...
	return fmt.Sprintf("[GET /proxy-servers][%d] getProxyServersOK %s", 200, payload)
}
...
func (o *GetProxyServersDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /proxy-servers][%d] GetProxyServers default %s", o._statusCode, payload)
}
