...
type ClientService interface {
	...
	AddUpdateNetBackupTuningParameter(params *AddUpdateNetBackupTuningParameterParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddUpdateNetBackupTuningParameterOK, *AddUpdateNetBackupTuningParameterCreated, error)
	...
	ClusterDeleteIpmiUsers(params *ClusterDeleteIpmiUsersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ClusterDeleteIpmiUsersOK, error)
	...
	CreateOrUpdateEmailProviderConfiguration(params *CreateOrUpdateEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateOrUpdateEmailProviderConfigurationOK, error)

	CreateProxyServer(params *CreateProxyServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateProxyServerCreated, error)
	...
	DeleteEmailProviderConfiguration(params *DeleteEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteEmailProviderConfigurationNoContent, error)
	...
	DeleteNetBackupTuningParameter(params *DeleteNetBackupTuningParameterParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteNetBackupTuningParameterOK, error)
	...
	GetClusterVlan(params *GetClusterVlanParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetClusterVlanOK, error)
	...
	GetEmailProviderConfiguration(params *GetEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetEmailProviderConfigurationOK, error)

	GetFipsMode(params *GetFipsModeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetFipsModeOK, error)
	...
	GetLoginBanner(params *GetLoginBannerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetLoginBannerOK, error)

	GetNetBackupMediaServer(params *GetNetBackupMediaServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupMediaServerOK, error)

	GetNetBackupMediaServersList(params *GetNetBackupMediaServersListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupMediaServersListOK, error)

	GetNetBackupPrimaryServersInfo(params *GetNetBackupPrimaryServersInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupPrimaryServersInfoOK, error)

	GetNetBackupStorageServers(params *GetNetBackupStorageServersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupStorageServersOK, error)

	GetNetBackupTuningParameter(params *GetNetBackupTuningParameterParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupTuningParameterOK, error)
	...
	ListEmailProviders(params *ListEmailProvidersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListEmailProvidersOK, error)
	...
	NodeImportSignedCert(params *NodeImportSignedCertParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*NodeImportSignedCertOK, error)

	NodeStatus(params *NodeStatusParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*NodeStatusOK, error)

	PatchEmailProviderConfiguration(params *PatchEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PatchEmailProviderConfigurationOK, error)
	...
	RegisterNetBackupStorageServer(params *RegisterNetBackupStorageServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RegisterNetBackupStorageServerCreated, error)
	...
	RestoreConfiguration(params *RestoreConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RestoreConfigurationOK, error)
	...
	UnregisterNetBackupStorageServer(params *UnregisterNetBackupStorageServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UnregisterNetBackupStorageServerNoContent, error)
	...
	UpdateFipsMode(params *UpdateFipsModeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateFipsModeOK, error)
	...
	UpdateLoginBanner(params *UpdateLoginBannerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateLoginBannerOK, error)

	UpdateNetBackupMediaServerState(params *UpdateNetBackupMediaServerStateParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateNetBackupMediaServerStateOK, error)
	...
	UpdateRestoreConfiguration(params *UpdateRestoreConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateRestoreConfigurationOK, error)
	...
	ValidateEmailProviderConfiguration(params *ValidateEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ValidateEmailProviderConfigurationNoContent, error)
...
/*
	AddUpdateNetBackupTuningParameter adds or update net backup tuning parameter

	**Privileges:** ```CLUSTER_MODIFY``` <br><br>Add or update NetBackup tuning parameter. This can be used to configure

sysctl, ulimit, touch-file, or bpconf parameters for NetBackup media servers.
*/
func (a *Client) AddUpdateNetBackupTuningParameter(params *AddUpdateNetBackupTuningParameterParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddUpdateNetBackupTuningParameterOK, *AddUpdateNetBackupTuningParameterCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAddUpdateNetBackupTuningParameterParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "AddUpdateNetBackupTuningParameter",
		Method:             "POST",
		PathPattern:        "/clusters/netbackup/tuning-parameters",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &AddUpdateNetBackupTuningParameterReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	case *AddUpdateNetBackupTuningParameterOK:
		return value, nil, nil
	case *AddUpdateNetBackupTuningParameterCreated:
		return nil, value, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*AddUpdateNetBackupTuningParameterDefault)
...
/*
ClusterDeleteIpmiUsers tos delete IP m i users for cluster

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Deletes the specified cluster ipmi user.
*/
func (a *Client) ClusterDeleteIpmiUsers(params *ClusterDeleteIpmiUsersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ClusterDeleteIpmiUsersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewClusterDeleteIpmiUsersParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ClusterDeleteIpmiUsers",
		Method:             "DELETE",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ClusterDeleteIpmiUsersReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*ClusterDeleteIpmiUsersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*ClusterDeleteIpmiUsersDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
	CreateOrUpdateEmailProviderConfiguration creates or replace email provider configuration

	**Privileges:** ```CLUSTER_MODIFY``` <br><br>Create or replace email configuration for the specified provider.

All required fields must be provided. Use PATCH for partial
updates.
Note: For SMTP configuration, use PUT /clusters/smtp endpoint.
*/
func (a *Client) CreateOrUpdateEmailProviderConfiguration(params *CreateOrUpdateEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateOrUpdateEmailProviderConfigurationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateOrUpdateEmailProviderConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "CreateOrUpdateEmailProviderConfiguration",
		Method:             "PUT",
		PathPattern:        "/clusters/email/{providerType}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CreateOrUpdateEmailProviderConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*CreateOrUpdateEmailProviderConfigurationOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*CreateOrUpdateEmailProviderConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
CreateProxyServer creares a proxy server

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Create a proxy server. If a proxy server with given name exists error will be returned.
*/
func (a *Client) CreateProxyServer(params *CreateProxyServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateProxyServerCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateProxyServerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "CreateProxyServer",
		Method:             "POST",
		PathPattern:        "/proxy-servers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CreateProxyServerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*CreateProxyServerCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*CreateProxyServerDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
func (a *Client) DeleteClusterVlan(params *DeleteClusterVlanParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteClusterVlanNoContent, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "DELETE",
		PathPattern:        "/network/vlans/{vlanInterfaceGroupName}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
...
/*
	DeleteEmailProviderConfiguration deletes email provider configuration

	**Privileges:** ```CLUSTER_MODIFY``` <br><br>Delete email configuration for the specified provider.

Note: For SMTP configuration, use DELETE /clusters/smtp endpoint.
*/
func (a *Client) DeleteEmailProviderConfiguration(params *DeleteEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteEmailProviderConfigurationNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeleteEmailProviderConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "DeleteEmailProviderConfiguration",
		Method:             "DELETE",
		PathPattern:        "/clusters/email/{providerType}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &DeleteEmailProviderConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*DeleteEmailProviderConfigurationNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*DeleteEmailProviderConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
func (a *Client) DeleteInterfaceGroup(params *DeleteInterfaceGroupParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteInterfaceGroupNoContent, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "DELETE",
		PathPattern:        "/network/interface-groups/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
...
/*
DeleteNetBackupTuningParameter deletes net backup tuning parameter

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Deletes a NetBackup tuning parameter by type and name.
*/
func (a *Client) DeleteNetBackupTuningParameter(params *DeleteNetBackupTuningParameterParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteNetBackupTuningParameterOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeleteNetBackupTuningParameterParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "DeleteNetBackupTuningParameter",
		Method:             "DELETE",
		PathPattern:        "/clusters/netbackup/tuning-parameters/{type}/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &DeleteNetBackupTuningParameterReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*DeleteNetBackupTuningParameterOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*DeleteNetBackupTuningParameterDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
GetClusterVlan gets vlan

```Unknown Privileges``` <br><br>Get a vlan on the cluster.
*/
func (a *Client) GetClusterVlan(params *GetClusterVlanParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetClusterVlanOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetClusterVlanParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetClusterVlan",
		Method:             "GET",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetClusterVlanReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetClusterVlanOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetClusterVlanDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
	GetEmailProviderConfiguration gets email provider configuration

	**Privileges:** ```CLUSTER_VIEW``` <br><br>Get email configuration for the specified provider.

Note: For SMTP configuration, use GET /clusters/smtp endpoint.
*/
func (a *Client) GetEmailProviderConfiguration(params *GetEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetEmailProviderConfigurationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetEmailProviderConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetEmailProviderConfiguration",
		Method:             "GET",
		PathPattern:        "/clusters/email/{providerType}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetEmailProviderConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetEmailProviderConfigurationOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetEmailProviderConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
GetFipsMode gets f IP s mode status

**Privileges:** ```CLUSTER_VIEW``` <br><br>Get the current kernel FIPS mode status on the cluster.
*/
func (a *Client) GetFipsMode(params *GetFipsModeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetFipsModeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetFipsModeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetFipsMode",
		Method:             "GET",
		PathPattern:        "/clusters/fips",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetFipsModeReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetFipsModeOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetFipsModeDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
GetLoginBanner gets login banner

```No Privileges Required``` <br><br>Return contents of login banner.
*/
func (a *Client) GetLoginBanner(params *GetLoginBannerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetLoginBannerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetLoginBannerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetLoginBanner",
		Method:             "GET",
		PathPattern:        "/login-banners",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetLoginBannerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetLoginBannerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetLoginBannerDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
GetNetBackupMediaServer gets net backup media server details

**Privileges:** ```CLUSTER_VIEW``` <br><br>Retrieve details of a specific NetBackup media server.
*/
func (a *Client) GetNetBackupMediaServer(params *GetNetBackupMediaServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupMediaServerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNetBackupMediaServerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNetBackupMediaServer",
		Method:             "GET",
		PathPattern:        "/clusters/netbackup/media-servers/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNetBackupMediaServerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNetBackupMediaServerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetNetBackupMediaServerDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
	GetNetBackupMediaServersList lists net backup media servers

	**Privileges:** ```CLUSTER_VIEW``` <br><br>Retrieve a list of NetBackup media servers deployed in the

cluster.
*/
func (a *Client) GetNetBackupMediaServersList(params *GetNetBackupMediaServersListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupMediaServersListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNetBackupMediaServersListParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNetBackupMediaServersList",
		Method:             "GET",
		PathPattern:        "/clusters/netbackup/media-servers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNetBackupMediaServersListReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNetBackupMediaServersListOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetNetBackupMediaServersListDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
	GetNetBackupPrimaryServersInfo gets net backup primary server information

	**Privileges:** ```CLUSTER_VIEW``` <br><br>Retrieves details of the NetBackup primary servers with which

this cluster is connected.
*/
func (a *Client) GetNetBackupPrimaryServersInfo(params *GetNetBackupPrimaryServersInfoParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupPrimaryServersInfoOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNetBackupPrimaryServersInfoParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNetBackupPrimaryServersInfo",
		Method:             "GET",
		PathPattern:        "/clusters/netbackup/primary-servers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNetBackupPrimaryServersInfoReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNetBackupPrimaryServersInfoOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetNetBackupPrimaryServersInfoDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
	GetNetBackupStorageServers lists net backup storage servers

	**Privileges:** ```CLUSTER_VIEW``` <br><br>Retrieves a list of NetBackup storage servers created and registered

by this cluster.
*/
func (a *Client) GetNetBackupStorageServers(params *GetNetBackupStorageServersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupStorageServersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNetBackupStorageServersParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNetBackupStorageServers",
		Method:             "GET",
		PathPattern:        "/clusters/netbackup/storage-servers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNetBackupStorageServersReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNetBackupStorageServersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetNetBackupStorageServersDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
	GetNetBackupTuningParameter lists net backup tuning parameter

	**Privileges:** ```CLUSTER_VIEW``` <br><br>List the available NetBackup tuning parameters. Query parameters can be

used to filter by name and/or type. If no query parameters are provided,
returns all available tuning parameters.
*/
func (a *Client) GetNetBackupTuningParameter(params *GetNetBackupTuningParameterParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNetBackupTuningParameterOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNetBackupTuningParameterParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNetBackupTuningParameter",
		Method:             "GET",
		PathPattern:        "/clusters/netbackup/tuning-parameters",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNetBackupTuningParameterReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNetBackupTuningParameterOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetNetBackupTuningParameterDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
GetNtpServers gets list of n t p servers
...
/*
GetProxyServers gets list of proxy servers
...
/*
	ListEmailProviders lists email providers and active provider

	**Privileges:** ```CLUSTER_VIEW``` <br><br>Get list of supported email service provider types and the

currently active provider.
Note: For SMTP configuration, use /clusters/smtp endpoint.
*/
func (a *Client) ListEmailProviders(params *ListEmailProvidersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ListEmailProvidersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewListEmailProvidersParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ListEmailProviders",
		Method:             "GET",
		PathPattern:        "/clusters/email/providers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ListEmailProvidersReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*ListEmailProvidersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*ListEmailProvidersDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
NodeImportSignedCert imports a signed certificate used for n2n communication

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Import a signed certificate.
*/
func (a *Client) NodeImportSignedCert(params *NodeImportSignedCertParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*NodeImportSignedCertOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewNodeImportSignedCertParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "NodeImportSignedCert",
		Method:             "POST",
		PathPattern:        "/node/import/signed-csr",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &NodeImportSignedCertReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*NodeImportSignedCertOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*NodeImportSignedCertDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
	PatchEmailProviderConfiguration partiallies update email provider configuration

	**Privileges:** ```CLUSTER_MODIFY``` <br><br>Partially update email provider configuration.

Only provided fields will be updated. Use PUT to replace entire
configuration.
Note: For SMTP configuration, use PUT /clusters/smtp endpoint.
*/
func (a *Client) PatchEmailProviderConfiguration(params *PatchEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PatchEmailProviderConfigurationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPatchEmailProviderConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PatchEmailProviderConfiguration",
		Method:             "PATCH",
		PathPattern:        "/clusters/email/{providerType}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PatchEmailProviderConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*PatchEmailProviderConfigurationOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*PatchEmailProviderConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
RegisterNetBackupStorageServer registers net backup storage server

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Register a new NetBackup storage server on the NetBackup Primary for this cluster.
*/
func (a *Client) RegisterNetBackupStorageServer(params *RegisterNetBackupStorageServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RegisterNetBackupStorageServerCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewRegisterNetBackupStorageServerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "RegisterNetBackupStorageServer",
		Method:             "POST",
		PathPattern:        "/clusters/netbackup/storage-servers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &RegisterNetBackupStorageServerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*RegisterNetBackupStorageServerCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*RegisterNetBackupStorageServerDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
RemoveProxyServer removes specified proxy server
...
func (a *Client) RemoveProxyServer(params *RemoveProxyServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RemoveProxyServerNoContent, error) {
	...
	op := &runtime.ClientOperation{
		...
		Method:             "DELETE",
		PathPattern:        "/proxy-servers/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
...
/*
RestoreConfiguration restores configuration

**Privileges:** ```CLUSTER_VIEW``` <br><br>Config to be restored during one-helios cluster creation.
*/
func (a *Client) RestoreConfiguration(params *RestoreConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RestoreConfigurationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewRestoreConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "RestoreConfiguration",
		Method:             "GET",
		PathPattern:        "/clusters/restore-config",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &RestoreConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*RestoreConfigurationOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*RestoreConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
UnregisterNetBackupStorageServer unregisters net backup storage server

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Unregisters a NetBackup storage server configured for this cluster.
*/
func (a *Client) UnregisterNetBackupStorageServer(params *UnregisterNetBackupStorageServerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UnregisterNetBackupStorageServerNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUnregisterNetBackupStorageServerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UnregisterNetBackupStorageServer",
		Method:             "DELETE",
		PathPattern:        "/clusters/netbackup/storage-servers/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UnregisterNetBackupStorageServerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UnregisterNetBackupStorageServerNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UnregisterNetBackupStorageServerDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
UpdateFipsMode updates f IP s mode status

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Enable or disable kernel FIPS mode on the cluster. A system reboot may be required for changes to take full effect.
*/
func (a *Client) UpdateFipsMode(params *UpdateFipsModeParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateFipsModeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateFipsModeParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateFipsMode",
		Method:             "PUT",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateFipsModeReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UpdateFipsModeOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UpdateFipsModeDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
UpdateLoginBanner updates login banner
...
*/
func (a *Client) UpdateLoginBanner(params *UpdateLoginBannerParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateLoginBannerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateLoginBannerParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateLoginBanner",
		Method:             "PUT",
		PathPattern:        "/login-banners",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateLoginBannerReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UpdateLoginBannerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UpdateLoginBannerDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
UpdateNetBackupMediaServerState updates net backup media server state

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Update the operational state of a NetBackup media server.
*/
func (a *Client) UpdateNetBackupMediaServerState(params *UpdateNetBackupMediaServerStateParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateNetBackupMediaServerStateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateNetBackupMediaServerStateParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateNetBackupMediaServerState",
		Method:             "POST",
		PathPattern:        "/clusters/netbackup/media-servers/{id}/states",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateNetBackupMediaServerStateReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UpdateNetBackupMediaServerStateOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UpdateNetBackupMediaServerStateDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
UpdateNtpServers updates n t p servers
...
func (a *Client) UpdateNtpServers(params *UpdateNtpServersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateNtpServersOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for UpdateNtpServers: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
UpdateProxyServer updates specified proxy server
...
/*
UpdateRestoreConfiguration updates restore configuration

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Update the restore config for one-helios cluster restore.
*/
func (a *Client) UpdateRestoreConfiguration(params *UpdateRestoreConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateRestoreConfigurationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateRestoreConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateRestoreConfiguration",
		Method:             "PUT",
		PathPattern:        "/clusters/restore-config",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateRestoreConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UpdateRestoreConfigurationOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UpdateRestoreConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
	ValidateEmailProviderConfiguration validates email provider configuration

	**Privileges:** ```CLUSTER_MODIFY``` <br><br>Validate email configuration by sending a test email.

Note: For SMTP validation, use POST /clusters/smtp/validate
endpoint.
*/
func (a *Client) ValidateEmailProviderConfiguration(params *ValidateEmailProviderConfigurationParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ValidateEmailProviderConfigurationNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewValidateEmailProviderConfigurationParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ValidateEmailProviderConfiguration",
		Method:             "POST",
		PathPattern:        "/clusters/email/{providerType}/validate",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ValidateEmailProviderConfigurationReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*ValidateEmailProviderConfigurationNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*ValidateEmailProviderConfigurationDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
