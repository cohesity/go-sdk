...
func (o *GetNodesOK) Error() string {
	...
	return fmt.Sprintf("[GET /clusters/nodes][%d] getNodesOK %s", 200, payload)
}
...
func (o *GetNodesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /clusters/nodes][%d] GetNodes default %s", o._statusCode, payload)
}
...
func (o *GetNodesDefault) GetPayload() *models.Error {
	return o.Payload
}
