...
func (o *UpgradeCheckRunTestsOK) Error() string {
	return fmt.Sprintf("[PUT /clusters/upgrade-checks][%d] upgradeCheckRunTestsOK  %+v", 200, o.Payload)
}
...
func (o *UpgradeCheckRunTestsDefault) Error() string {
	return fmt.Sprintf("[PUT /clusters/upgrade-checks][%d] UpgradeCheckRunTests default  %+v", o._statusCode, o.Payload)
}
