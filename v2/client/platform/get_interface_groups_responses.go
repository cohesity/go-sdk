...
func (o *GetInterfaceGroupsOK) Error() string {
	return fmt.Sprintf("[GET /network/interface-groups][%d] getInterfaceGroupsOK  %+v", 200, o.Payload)
}
...
func (o *GetInterfaceGroupsDefault) Error() string {
	return fmt.Sprintf("[GET /network/interface-groups][%d] GetInterfaceGroups default  %+v", o._statusCode, o.Payload)
}
