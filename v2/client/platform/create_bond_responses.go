...
func (o *CreateBondCreated) Error() string {
	return fmt.Sprintf("[POST /network/bonds][%d] createBondCreated  %+v", 201, o.Payload)
}
...
func (o *CreateBondDefault) Error() string {
	return fmt.Sprintf("[POST /network/bonds][%d] CreateBond default  %+v", o._statusCode, o.Payload)
}
