...
func (o *CreateClusterVlanCreated) Error() string {
	return fmt.Sprintf("[POST /network/vlans][%d] createClusterVlanCreated  %+v", 201, o.Payload)
}
...
func (o *CreateClusterVlanDefault) Error() string {
	return fmt.Sprintf("[POST /network/vlans][%d] CreateClusterVlan default  %+v", o._statusCode, o.Payload)
}
