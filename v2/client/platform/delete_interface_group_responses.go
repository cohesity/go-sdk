...
func (o *DeleteInterfaceGroupNoContent) Error() string {
	return fmt.Sprintf("[DELETE /network/interface-groups/{name}][%d] deleteInterfaceGroupNoContent ", 204)
}
...
func (o *DeleteInterfaceGroupDefault) Error() string {
	return fmt.Sprintf("[DELETE /network/interface-groups/{name}][%d] DeleteInterfaceGroup default  %+v", o._statusCode, o.Payload)
}
...
func (o *DeleteInterfaceGroupDefault) GetPayload() *models.Error {
	return o.Payload
}
