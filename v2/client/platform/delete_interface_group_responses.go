...
func (o *DeleteInterfaceGroupNoContent) Error() string {
	return fmt.Sprintf("[DELETE /network/interface-groups/{id}][%d] deleteInterfaceGroupNoContent", 204)
}
...
func (o *DeleteInterfaceGroupDefault) Error() string {
	...
	return fmt.Sprintf("[DELETE /network/interface-groups/{id}][%d] DeleteInterfaceGroup default %s", o._statusCode, payload)
}
