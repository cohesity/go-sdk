...
func (o *GetChassisByIDOK) Error() string {
	return fmt.Sprintf("[GET /chassis/{id}][%d] getChassisByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetChassisByIDDefault) Error() string {
	return fmt.Sprintf("[GET /chassis/{id}][%d] GetChassisById default  %+v", o._statusCode, o.Payload)
}
