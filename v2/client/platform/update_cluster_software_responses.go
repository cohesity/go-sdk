...
func (o *UpdateClusterSoftwareAccepted) Error() string {
	return fmt.Sprintf("[PUT /clusters/softwares][%d] updateClusterSoftwareAccepted  %+v", 202, o.Payload)
}
...
func (o *UpdateClusterSoftwareDefault) Error() string {
	return fmt.Sprintf("[PUT /clusters/softwares][%d] UpdateClusterSoftware default  %+v", o._statusCode, o.Payload)
}
