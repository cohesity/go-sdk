...
func (o *GetKubernetesInfraHealthStatusOK) Error() string {
	return fmt.Sprintf("[GET /kubernetes/status][%d] getKubernetesInfraHealthStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetKubernetesInfraHealthStatusDefault) Error() string {
	return fmt.Sprintf("[GET /kubernetes/status][%d] GetKubernetesInfraHealthStatus default  %+v", o._statusCode, o.Payload)
}
