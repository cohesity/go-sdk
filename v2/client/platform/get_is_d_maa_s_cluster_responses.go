...
func (o *GetIsDMaaSClusterOK) Error() string {
	return fmt.Sprintf("[GET /clusters/is-dmaas][%d] getIsDMaaSClusterOK  %+v", 200, o.Payload)
}
...
func (o *GetIsDMaaSClusterDefault) Error() string {
	return fmt.Sprintf("[GET /clusters/is-dmaas][%d] GetIsDMaaSCluster default  %+v", o._statusCode, o.Payload)
}
