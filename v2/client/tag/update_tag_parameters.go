...
// WithID adds the id to the update tag params
func (o *UpdateTagParams) WithID(id string) *UpdateTagParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update tag params
func (o *UpdateTagParams) SetID(id string) {
	o.ID = id
}
