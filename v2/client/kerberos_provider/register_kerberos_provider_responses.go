...
func (o *RegisterKerberosProviderCreated) Error() string {
	return fmt.Sprintf("[POST /kerberos-providers/register][%d] registerKerberosProviderCreated  %+v", 201, o.Payload)
}
...
func (o *RegisterKerberosProviderDefault) Error() string {
	return fmt.Sprintf("[POST /kerberos-providers/register][%d] RegisterKerberosProvider default  %+v", o._statusCode, o.Payload)
}
