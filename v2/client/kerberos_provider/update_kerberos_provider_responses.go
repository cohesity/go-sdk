...
func (o *UpdateKerberosProviderOK) Error() string {
	return fmt.Sprintf("[PUT /kerberos-providers/{id}][%d] updateKerberosProviderOK  %+v", 200, o.Payload)
}
...
func (o *UpdateKerberosProviderDefault) Error() string {
	return fmt.Sprintf("[PUT /kerberos-providers/{id}][%d] UpdateKerberosProvider default  %+v", o._statusCode, o.Payload)
}
