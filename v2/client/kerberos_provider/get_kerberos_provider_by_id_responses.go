...
func (o *GetKerberosProviderByIDOK) Error() string {
	return fmt.Sprintf("[GET /kerberos-providers/{id}][%d] getKerberosProviderByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetKerberosProviderByIDDefault) Error() string {
	return fmt.Sprintf("[GET /kerberos-providers/{id}][%d] GetKerberosProviderById default  %+v", o._statusCode, o.Payload)
}
