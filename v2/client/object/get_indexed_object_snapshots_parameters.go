...
type GetIndexedObjectSnapshotsParams struct {
	...
	/* FromFileMtimeUsecs.
	   ...
	   Specifies the timestamp in Unix time epoch in microseconds to filter indexed object's snapshots based on file mtime after and equal to this value. If not specified and toFileMtimeUsecs is specified, then the fromFileMtimeUsecs will be set to 7 days before toFileMtimeUsecs.

	   Format: int64
	*/
	FromFileMtimeUsecs *int64
	...
	*/
	...
	/* ToFileMtimeUsecs.
	   ...
	   Specifies the timestamp in Unix time epoch in microseconds to filter indexed object's snapshots based on file mtime before and equal to this value. If not specified and fromFileMtimeUsecs is specified, then the toFileMtimeUsecs will be set to current time.

	   Format: int64
	*/
	ToFileMtimeUsecs *int64
...
// WithFromFileMtimeUsecs adds the fromFileMtimeUsecs to the get indexed object snapshots params
func (o *GetIndexedObjectSnapshotsParams) WithFromFileMtimeUsecs(fromFileMtimeUsecs *int64) *GetIndexedObjectSnapshotsParams {
	o.SetFromFileMtimeUsecs(fromFileMtimeUsecs)
	return o
}

// SetFromFileMtimeUsecs adds the fromFileMtimeUsecs to the get indexed object snapshots params
func (o *GetIndexedObjectSnapshotsParams) SetFromFileMtimeUsecs(fromFileMtimeUsecs *int64) {
	o.FromFileMtimeUsecs = fromFileMtimeUsecs
}
...
// WithToFileMtimeUsecs adds the toFileMtimeUsecs to the get indexed object snapshots params
func (o *GetIndexedObjectSnapshotsParams) WithToFileMtimeUsecs(toFileMtimeUsecs *int64) *GetIndexedObjectSnapshotsParams {
	o.SetToFileMtimeUsecs(toFileMtimeUsecs)
	return o
}

// SetToFileMtimeUsecs adds the toFileMtimeUsecs to the get indexed object snapshots params
func (o *GetIndexedObjectSnapshotsParams) SetToFileMtimeUsecs(toFileMtimeUsecs *int64) {
	o.ToFileMtimeUsecs = toFileMtimeUsecs
}
...
func (o *GetIndexedObjectSnapshotsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.FromFileMtimeUsecs != nil {

		// query param fromFileMtimeUsecs
		var qrFromFileMtimeUsecs int64

		if o.FromFileMtimeUsecs != nil {
			qrFromFileMtimeUsecs = *o.FromFileMtimeUsecs
		}
		qFromFileMtimeUsecs := swag.FormatInt64(qrFromFileMtimeUsecs)
		if qFromFileMtimeUsecs != "" {

			if err := r.SetQueryParam("fromFileMtimeUsecs", qFromFileMtimeUsecs); err != nil {
				return err
			}
		}
	}
	...
	if o.ToFileMtimeUsecs != nil {

		// query param toFileMtimeUsecs
		var qrToFileMtimeUsecs int64

		if o.ToFileMtimeUsecs != nil {
			qrToFileMtimeUsecs = *o.ToFileMtimeUsecs
		}
		qToFileMtimeUsecs := swag.FormatInt64(qrToFileMtimeUsecs)
		if qToFileMtimeUsecs != "" {

			if err := r.SetQueryParam("toFileMtimeUsecs", qToFileMtimeUsecs); err != nil {
				return err
			}
		}
	}
