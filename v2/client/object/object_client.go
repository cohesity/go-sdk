...
type ClientService interface {
	...
	GetAgentHosts(params *GetAgentHostsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAgentHostsOK, error)
	...
	GetObjectRunSuccessFiles(params *GetObjectRunSuccessFilesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetObjectRunSuccessFilesOK, error)
	...
	ModifySourceHierarchyObjects(params *ModifySourceHierarchyObjectsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ModifySourceHierarchyObjectsMultiStatus, error)
...
/*
GetAgentHosts lists hosts associated with the registered source

**Privileges:** ```PROTECTION_VIEW``` <br><br>List hosts associated with the registered source which have agents installed on them.
*/
func (a *Client) GetAgentHosts(params *GetAgentHostsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetAgentHostsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetAgentHostsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetAgentHosts",
		Method:             "GET",
		PathPattern:        "/data-protect/agent-hosts",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAgentHostsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetAgentHostsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetAgentHostsDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
GetObjectRunSuccessFiles gets the c s v of errors warnings for a given run and an object
...
*/
func (a *Client) GetObjectRunSuccessFiles(params *GetObjectRunSuccessFilesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetObjectRunSuccessFilesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetObjectRunSuccessFilesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetObjectRunSuccessFiles",
		Method:             "GET",
		PathPattern:        "/data-protect/objects/{id}/runs/{runId}/downloadFiles",
		ProducesMediaTypes: []string{"application/octet-stream"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetObjectRunSuccessFilesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetObjectRunSuccessFilesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetObjectRunSuccessFilesDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
ModifySourceHierarchyObjects modifies objects in source hierarchy

**Privileges:** ```PROTECTION_MODIFY``` <br><br>Add/Update objects to/from an entity hierarchy for a given source.
*/
func (a *Client) ModifySourceHierarchyObjects(params *ModifySourceHierarchyObjectsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ModifySourceHierarchyObjectsMultiStatus, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewModifySourceHierarchyObjectsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ModifySourceHierarchyObjects",
		Method:             "PUT",
		PathPattern:        "/data-protect/sources/{sourceId}/objects",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ModifySourceHierarchyObjectsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*ModifySourceHierarchyObjectsMultiStatus)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*ModifySourceHierarchyObjectsDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
