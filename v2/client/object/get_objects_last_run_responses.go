...
func (o *GetObjectsLastRunOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/objects/last-run][%d] getObjectsLastRunOK  %+v", 200, o.Payload)
}
...
func (o *GetObjectsLastRunDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/objects/last-run][%d] GetObjectsLastRun default  %+v", o._statusCode, o.Payload)
}
