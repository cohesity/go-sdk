...
type GetSourceHierarchyObjectsParams struct {
	...
	*/
	...
	/* NutanixFSObjectTypes.

	   Specifies the Nutanix FS object types to filter objects.
	*/
	NutanixFSObjectTypes []string
...
// WithGoogleWorkspaceObjectTypes adds the googleWorkspaceObjectTypes to the get source hierarchy objects params
func (o *GetSourceHierarchyObjectsParams) WithGoogleWorkspaceObjectTypes(googleWorkspaceObjectTypes []string) *GetSourceHierarchyObjectsParams {
	o.SetGoogleWorkspaceObjectTypes(googleWorkspaceObjectTypes)
	return o
}

// SetGoogleWorkspaceObjectTypes adds the googleWorkspaceObjectTypes to the get source hierarchy objects params
func (o *GetSourceHierarchyObjectsParams) SetGoogleWorkspaceObjectTypes(googleWorkspaceObjectTypes []string) {
...
// WithNutanixFSObjectTypes adds the nutanixFSObjectTypes to the get source hierarchy objects params
func (o *GetSourceHierarchyObjectsParams) WithNutanixFSObjectTypes(nutanixFSObjectTypes []string) *GetSourceHierarchyObjectsParams {
	o.SetNutanixFSObjectTypes(nutanixFSObjectTypes)
	return o
}

// SetNutanixFSObjectTypes adds the nutanixFSObjectTypes to the get source hierarchy objects params
func (o *GetSourceHierarchyObjectsParams) SetNutanixFSObjectTypes(nutanixFSObjectTypes []string) {
	o.NutanixFSObjectTypes = nutanixFSObjectTypes
}
...
func (o *GetSourceHierarchyObjectsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.NutanixFSObjectTypes != nil {

		// binding items for nutanixFSObjectTypes
		joinedNutanixFSObjectTypes := o.bindParamNutanixFSObjectTypes(reg)

		// query array param nutanixFSObjectTypes
		if err := r.SetQueryParam("nutanixFSObjectTypes", joinedNutanixFSObjectTypes...); err != nil {
			return err
		}
	}
...
// bindParamGetSourceHierarchyObjects binds the parameter googleWorkspaceObjectTypes
func (o *GetSourceHierarchyObjectsParams) bindParamGoogleWorkspaceObjectTypes(formats strfmt.Registry) []string {
...
// bindParamGetSourceHierarchyObjects binds the parameter nutanixFSObjectTypes
func (o *GetSourceHierarchyObjectsParams) bindParamNutanixFSObjectTypes(formats strfmt.Registry) []string {
	nutanixFSObjectTypesIR := o.NutanixFSObjectTypes

	var nutanixFSObjectTypesIC []string
	for _, nutanixFSObjectTypesIIR := range nutanixFSObjectTypesIR { // explode []string

		nutanixFSObjectTypesIIV := nutanixFSObjectTypesIIR // string as string
		nutanixFSObjectTypesIC = append(nutanixFSObjectTypesIC, nutanixFSObjectTypesIIV)
	}

	// items.CollectionFormat: ""
	nutanixFSObjectTypesIS := swag.JoinByFormat(nutanixFSObjectTypesIC, "")

	return nutanixFSObjectTypesIS
}
