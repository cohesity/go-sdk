...
func (o *GetSourceHierarchyObjectsOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/sources/{sourceId}/objects][%d] getSourceHierarchyObjectsOK  %+v", 200, o.Payload)
}
...
func (o *GetSourceHierarchyObjectsDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/sources/{sourceId}/objects][%d] GetSourceHierarchyObjects default  %+v", o._statusCode, o.Payload)
}
