...
func (o *CreateAccessTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		...
		return result, nil
	default:
		result := NewCreateAccessTokenDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *CreateAccessTokenCreated) Error() string {
	return fmt.Sprintf("[POST /access-tokens][%d] createAccessTokenCreated  %+v", 201, o.Payload)
}
...
func (o *CreateAccessTokenCreated) GetPayload() *models.AccessTokenResponse {
	return o.Payload
}
...
func NewCreateAccessTokenDefault(code int) *CreateAccessTokenDefault {
	return &CreateAccessTokenDefault{
		_statusCode: code,
	}
}
...
Error
*/
type CreateAccessTokenDefault struct {
	_statusCode int

	Payload *models.Error
}

// Code gets the status code for the create access token default response
func (o *CreateAccessTokenDefault) Code() int {
	return o._statusCode
}

// IsSuccess returns true when this create access token default response has a 2xx status code
func (o *CreateAccessTokenDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this create access token default response has a 3xx status code
func (o *CreateAccessTokenDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this create access token default response has a 4xx status code
func (o *CreateAccessTokenDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this create access token default response has a 5xx status code
func (o *CreateAccessTokenDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this create access token default response a status code equal to that given
func (o *CreateAccessTokenDefault) IsCode(code int) bool {
	return o._statusCode == code
}

func (o *CreateAccessTokenDefault) Error() string {
	return fmt.Sprintf("[POST /access-tokens][%d] CreateAccessToken default  %+v", o._statusCode, o.Payload)
}

func (o *CreateAccessTokenDefault) String() string {
	return fmt.Sprintf("[POST /access-tokens][%d] CreateAccessToken default  %+v", o._statusCode, o.Payload)
}

func (o *CreateAccessTokenDefault) GetPayload() *models.Error {
	return o.Payload
}

func (o *CreateAccessTokenDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
