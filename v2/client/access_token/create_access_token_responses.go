...
func (o *CreateAccessTokenCreated) Error() string {
	...
	return fmt.Sprintf("[POST /access-tokens][%d] createAccessTokenCreated %s", 201, payload)
}
...
func (o *CreateAccessTokenDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /access-tokens][%d] CreateAccessToken default %s", o._statusCode, payload)
}
