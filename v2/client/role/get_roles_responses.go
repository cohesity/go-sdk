...
func (o *GetRolesOK) GetPayload() *models.Roles {
	return o.Payload
}
...
func (o *GetRolesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /roles][%d] GetRoles default %s", o._statusCode, payload)
}
...
func (o *GetRolesDefault) GetPayload() *models.Error {
	return o.Payload
}
