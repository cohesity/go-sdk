...
type CreateRoleParams struct {
	...
	*/
	Body *models.CreateRoleParameters
...
func (o *CreateRoleParams) WithBody(body *models.CreateRoleParameters) *CreateRoleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create role params
func (o *CreateRoleParams) SetBody(body *models.CreateRoleParameters) {
	o.Body = body
}
