...
func (o *GetKmsConfigurationsOK) Error() string {
	return fmt.Sprintf("[GET /kms][%d] getKmsConfigurationsOK  %+v", 200, o.Payload)
}
...
func (o *GetKmsConfigurationsDefault) Error() string {
	return fmt.Sprintf("[GET /kms][%d] GetKmsConfigurations default  %+v", o._statusCode, o.Payload)
}
