...
type ClientService interface {
	...
	GetReplicationBacklogStats(params *GetReplicationBacklogStatsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationBacklogStatsOK, error)

	GetReplicationClusters(params *GetReplicationClustersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationClustersOK, error)

	GetReplicationDataTrend(params *GetReplicationDataTrendParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationDataTrendOK, error)

	GetReplicationObjects(params *GetReplicationObjectsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationObjectsOK, error)

	GetReplicationObjectsTrend(params *GetReplicationObjectsTrendParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationObjectsTrendOK, error)
...
/*
GetReplicationBacklogStats gets time series stats for replication backlog

**Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get Replication Backlog Stats.
*/
func (a *Client) GetReplicationBacklogStats(params *GetReplicationBacklogStatsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationBacklogStatsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetReplicationBacklogStatsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetReplicationBacklogStats",
		Method:             "GET",
		PathPattern:        "/stats/replication-backlog",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetReplicationBacklogStatsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetReplicationBacklogStatsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetReplicationBacklogStatsDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
GetReplicationClusters **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get list of clusters with total data replicated for each.
*/
func (a *Client) GetReplicationClusters(params *GetReplicationClustersParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationClustersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetReplicationClustersParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetReplicationClusters",
		Method:             "GET",
		PathPattern:        "/stats/replication-clusters",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetReplicationClustersReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetReplicationClustersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetReplicationClustersDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
GetReplicationDataTrend **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get replication data trends over time for all entities in the given schema.
*/
func (a *Client) GetReplicationDataTrend(params *GetReplicationDataTrendParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationDataTrendOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetReplicationDataTrendParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetReplicationDataTrend",
		Method:             "GET",
		PathPattern:        "/stats/replication-data-trend",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetReplicationDataTrendReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetReplicationDataTrendOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetReplicationDataTrendDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
GetReplicationObjects **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get list of all replicated objects in the given time range
*/
func (a *Client) GetReplicationObjects(params *GetReplicationObjectsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationObjectsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetReplicationObjectsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetReplicationObjects",
		Method:             "GET",
		PathPattern:        "/stats/replication-objects",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetReplicationObjectsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetReplicationObjectsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetReplicationObjectsDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}

/*
GetReplicationObjectsTrend **Privileges:** ```CLUSTER_VIEW, TENANT_VIEW, STORAGE_DOMAIN_VIEW, STORAGE_VIEW, PROTECTION_VIEW``` <br><br>Get replication object trends over time for all entities in the given schema.
*/
func (a *Client) GetReplicationObjectsTrend(params *GetReplicationObjectsTrendParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReplicationObjectsTrendOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetReplicationObjectsTrendParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetReplicationObjectsTrend",
		Method:             "GET",
		PathPattern:        "/stats/replication-objects-trend",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetReplicationObjectsTrendReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetReplicationObjectsTrendOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetReplicationObjectsTrendDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
