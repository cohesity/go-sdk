...
func (o *GetProtectionRunsStatsOK) Error() string {
	return fmt.Sprintf("[GET /stats/protection-runs][%d] getProtectionRunsStatsOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionRunsStatsDefault) Error() string {
	return fmt.Sprintf("[GET /stats/protection-runs][%d] GetProtectionRunsStats default  %+v", o._statusCode, o.Payload)
}
