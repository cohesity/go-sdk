...
func (o *UpdateAlertNotificationRuleOK) Error() string {
	return fmt.Sprintf("[PUT /alerts/config/notification-rules/{id}][%d] updateAlertNotificationRuleOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAlertNotificationRuleDefault) Error() string {
	return fmt.Sprintf("[PUT /alerts/config/notification-rules/{id}][%d] UpdateAlertNotificationRule default  %+v", o._statusCode, o.Payload)
}
