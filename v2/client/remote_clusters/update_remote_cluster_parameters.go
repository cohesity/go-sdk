...
// WithClusterID adds the clusterID to the update remote cluster params
func (o *UpdateRemoteClusterParams) WithClusterID(clusterID int64) *UpdateRemoteClusterParams {
	o.SetClusterID(clusterID)
	return o
}

// SetClusterID adds the clusterId to the update remote cluster params
func (o *UpdateRemoteClusterParams) SetClusterID(clusterID int64) {
