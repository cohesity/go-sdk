...
func (o *GetRemoteClusterByIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /remote-clusters/{clusterId}][%d] getRemoteClusterByIdOK %s", 200, payload)
}
...
func (o *GetRemoteClusterByIDDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /remote-clusters/{clusterId}][%d] GetRemoteClusterById default %s", o._statusCode, payload)
}
