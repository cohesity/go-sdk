...
func (o *GetRemoteClusterByIDOK) Error() string {
	return fmt.Sprintf("[GET /remote-clusters/{clusterId}][%d] getRemoteClusterByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetRemoteClusterByIDDefault) Error() string {
	return fmt.Sprintf("[GET /remote-clusters/{clusterId}][%d] GetRemoteClusterById default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetRemoteClusterByIDDefault) GetPayload() *models.Error {
	return o.Payload
}
