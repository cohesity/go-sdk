...
func (o *PatchDataSourceConnectorOK) Error() string {
	return fmt.Sprintf("[PATCH /data-source-connectors/{connectorId}][%d] patchDataSourceConnectorOK  %+v", 200, o.Payload)
}
...
func (o *PatchDataSourceConnectorDefault) Error() string {
	return fmt.Sprintf("[PATCH /data-source-connectors/{connectorId}][%d] PatchDataSourceConnector default  %+v", o._statusCode, o.Payload)
}
