...
func (o *UpdateTenantOK) Error() string {
	return fmt.Sprintf("[PUT /tenants/{id}][%d] updateTenantOK  %+v", 200, o.Payload)
}
...
func (o *UpdateTenantOK) GetPayload() *models.TenantInfo {
	return o.Payload
}
...
func (o *UpdateTenantDefault) Error() string {
	return fmt.Sprintf("[PUT /tenants/{id}][%d] UpdateTenant default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateTenantDefault) GetPayload() *models.Error {
	return o.Payload
}
