...
func (o *AssignPropertiesToTenantOK) Error() string {
	return fmt.Sprintf("[PUT /tenants/{id}/assignments][%d] assignPropertiesToTenantOK  %+v", 200, o.Payload)
}
...
func (o *AssignPropertiesToTenantDefault) Error() string {
	return fmt.Sprintf("[PUT /tenants/{id}/assignments][%d] AssignPropertiesToTenant default  %+v", o._statusCode, o.Payload)
}
