...
type ClientService interface {
	...
	GetGraphNodeDetailsDiff(params *GetGraphNodeDetailsDiffParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetGraphNodeDetailsDiffOK, error)
	...
	GetNodeEdges(params *GetNodeEdgesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNodeEdgesOK, error)
...
/*
GetGraphNodeDetailsDiff detaileds differences of graph nodes

```No Privileges Required``` <br><br>Get detailed differences of graph nodes.
*/
func (a *Client) GetGraphNodeDetailsDiff(params *GetGraphNodeDetailsDiffParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetGraphNodeDetailsDiffOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetGraphNodeDetailsDiffParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetGraphNodeDetailsDiff",
		Method:             "POST",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetGraphNodeDetailsDiffReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetGraphNodeDetailsDiffOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetGraphNodeDetailsDiffDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
GetNodeEdges gets node edges and relations

```No Privileges Required``` <br><br>Get node edges/relations for a given session id from given source nodes
*/
func (a *Client) GetNodeEdges(params *GetNodeEdgesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetNodeEdgesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetNodeEdgesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetNodeEdges",
		Method:             "POST",
		PathPattern:        "/data-access/snapshots/sessions/{sessionId}/node-edges",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetNodeEdgesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetNodeEdgesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetNodeEdgesDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
