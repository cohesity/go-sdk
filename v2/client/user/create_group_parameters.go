...
type CreateGroupParams struct {
	...
	*/
	Body models.CreateGroupsParams
...
func (o *CreateGroupParams) WithBody(body models.CreateGroupsParams) *CreateGroupParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create group params
func (o *CreateGroupParams) SetBody(body models.CreateGroupsParams) {
	o.Body = body
}
