...
func (o *UpdatePrincipalSourcesOK) Error() string {
	return fmt.Sprintf("[PUT /security-principals/{sid}/sources][%d] updatePrincipalSourcesOK  %+v", 200, o.Payload)
}
...
func (o *UpdatePrincipalSourcesDefault) Error() string {
	return fmt.Sprintf("[PUT /security-principals/{sid}/sources][%d] UpdatePrincipalSources default  %+v", o._statusCode, o.Payload)
}
