...
func (o *CreateUserAPIKeyCreated) Error() string {
	return fmt.Sprintf("[POST /users/{userSid}/api-keys][%d] createUserApiKeyCreated  %+v", 201, o.Payload)
}
...
func (o *CreateUserAPIKeyDefault) Error() string {
	return fmt.Sprintf("[POST /users/{userSid}/api-keys][%d] CreateUserAPIKey default  %+v", o._statusCode, o.Payload)
}
