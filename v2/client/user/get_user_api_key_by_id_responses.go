...
func (o *GetUserAPIKeyByIDOK) Error() string {
	return fmt.Sprintf("[GET /users/{userSid}/api-keys/{id}][%d] getUserApiKeyByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetUserAPIKeyByIDDefault) Error() string {
	return fmt.Sprintf("[GET /users/{userSid}/api-keys/{id}][%d] GetUserAPIKeyById default  %+v", o._statusCode, o.Payload)
}
