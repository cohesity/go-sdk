...
func (o *UpdateUserAPIKeyByIDOK) Error() string {
	return fmt.Sprintf("[PUT /users/{userSid}/api-keys/{id}][%d] updateUserApiKeyByIdOK  %+v", 200, o.Payload)
}
...
func (o *UpdateUserAPIKeyByIDDefault) Error() string {
	return fmt.Sprintf("[PUT /users/{userSid}/api-keys/{id}][%d] UpdateUserAPIKeyById default  %+v", o._statusCode, o.Payload)
}
