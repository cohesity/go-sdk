...
func (o *RotateUserAPIKeyOK) Error() string {
	...
	return fmt.Sprintf("[POST /users/{userSid}/api-keys/{id}/rotate][%d] rotateUserApiKeyOK %s", 200, payload)
}
...
func (o *RotateUserAPIKeyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /users/{userSid}/api-keys/{id}/rotate][%d] RotateUserAPIKey default %s", o._statusCode, payload)
}
