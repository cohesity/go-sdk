...
func (o *RotateUserAPIKeyOK) Error() string {
	return fmt.Sprintf("[POST /users/{userSid}/api-keys/{id}/rotate][%d] rotateUserApiKeyOK  %+v", 200, o.Payload)
}
...
func (o *RotateUserAPIKeyOK) GetPayload() *models.CreatedUserAPIKey {
	return o.Payload
}
...
func (o *RotateUserAPIKeyDefault) Error() string {
	return fmt.Sprintf("[POST /users/{userSid}/api-keys/{id}/rotate][%d] RotateUserAPIKey default  %+v", o._statusCode, o.Payload)
}
...
func (o *RotateUserAPIKeyDefault) GetPayload() *models.Error {
	return o.Payload
}
