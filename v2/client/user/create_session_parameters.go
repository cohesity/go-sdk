...
type CreateSessionParams struct {
	...
	*/
	Body *models.CreateUserSessionRequestParams
...
func (o *CreateSessionParams) WithBody(body *models.CreateUserSessionRequestParams) *CreateSessionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create session params
func (o *CreateSessionParams) SetBody(body *models.CreateUserSessionRequestParams) {
	o.Body = body
}
