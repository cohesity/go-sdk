...
type ClientService interface {
	AddPrincipals(params *AddPrincipalsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddPrincipalsCreated, error)

	CreateGroup(params *CreateGroupParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateGroupCreated, error)

	CreateSession(params *CreateSessionParams, opts ...ClientOption) (*CreateSessionCreated, error)
	...
	CreateUserS3Key(params *CreateUserS3KeyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateUserS3KeyCreated, error)
	...
	DeleteUserS3Key(params *DeleteUserS3KeyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteUserS3KeyNoContent, error)
	...
	GetUserTaskNotifications(params *GetUserTaskNotificationsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetUserTaskNotificationsOK, error)
	...
	UpdateUserS3Key(params *UpdateUserS3KeyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateUserS3KeyOK, error)
	...
	VerifyUserOtp(params *VerifyUserOtpParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*VerifyUserOtpOK, error)

	SetTransport(transport runtime.ClientTransport)
}

/*
AddPrincipals adds the specified principals for the users or groups created on the cohesity cluster
...
*/
func (a *Client) AddPrincipals(params *AddPrincipalsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*AddPrincipalsCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewAddPrincipalsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "AddPrincipals",
		Method:             "POST",
		PathPattern:        "/principals",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &AddPrincipalsReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*AddPrincipalsCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*AddPrincipalsDefault)
...
*/
func (a *Client) CreateSession(params *CreateSessionParams, opts ...ClientOption) (*CreateSessionCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
/*
CreateUserS3Key creates a new s3 key for a user

```No Privileges Required``` <br><br>Create a new S3 key for the specified user.
*/
func (a *Client) CreateUserS3Key(params *CreateUserS3KeyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateUserS3KeyCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateUserS3KeyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "CreateUserS3Key",
		Method:             "POST",
		PathPattern:        "/users/{sid}/s3-keys",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CreateUserS3KeyReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*CreateUserS3KeyCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*CreateUserS3KeyDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
	...
	```No Privileges Required``` <br><br>Deletes user sessions.

When current is true, only the current session is deleted.
When current is not specified or false, all the sessions for
given sid are deleted if sid is specified, else all sessions system
wide are deleted.
*/
...
/*
DeleteUserS3Key deletes an s3 key for a user

```No Privileges Required``` <br><br>Delete an S3 key for the specified user.
*/
func (a *Client) DeleteUserS3Key(params *DeleteUserS3KeyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*DeleteUserS3KeyNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeleteUserS3KeyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "DeleteUserS3Key",
		Method:             "DELETE",
		PathPattern:        "/users/{sid}/s3-keys/{keyId}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &DeleteUserS3KeyReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*DeleteUserS3KeyNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*DeleteUserS3KeyDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
GetUserTaskNotifications gets task notifications for the given user

**Privileges:** ```CLUSTER_VIEW, TENANT_VIEW``` <br><br>Get task notifications for the given user.
*/
func (a *Client) GetUserTaskNotifications(params *GetUserTaskNotificationsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetUserTaskNotificationsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetUserTaskNotificationsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetUserTaskNotifications",
		Method:             "GET",
		PathPattern:        "/users/{sid}/notifications",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetUserTaskNotificationsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetUserTaskNotificationsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetUserTaskNotificationsDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
UpdateUserS3Key updates an s3 key for a user

```No Privileges Required``` <br><br>Update S3 key for the specified user. This can be used to disable/enable/rotate an existing S3 key or update the expiry time of the key.
*/
func (a *Client) UpdateUserS3Key(params *UpdateUserS3KeyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UpdateUserS3KeyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUpdateUserS3KeyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "UpdateUserS3Key",
		Method:             "PUT",
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &UpdateUserS3KeyReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*UpdateUserS3KeyOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*UpdateUserS3KeyDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
```No Privileges Required``` <br><br>Updates the first S3 Access/Secret Key pair for a user. Requires 'Manage Users' and 'Manage S3Key' privileges to modify keys for other users.
*/
...
/*
VerifyUserOtp verifies the o t p for a user

```No Privileges Required``` <br><br>Returns the user info if the otp verification is successful.
*/
func (a *Client) VerifyUserOtp(params *VerifyUserOtpParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*VerifyUserOtpOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewVerifyUserOtpParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "VerifyUserOtp",
		Method:             "POST",
		PathPattern:        "/users/verify-otp",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &VerifyUserOtpReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*VerifyUserOtpOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*VerifyUserOtpDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
