...
func (o *CreateSessionCreated) Error() string {
	return fmt.Sprintf("[POST /users/sessions][%d] createSessionCreated  %+v", 201, o.Payload)
}
...
func (o *CreateSessionDefault) Error() string {
	return fmt.Sprintf("[POST /users/sessions][%d] CreateSession default  %+v", o._statusCode, o.Payload)
}
