...
type DeleteSessionParams struct {
	...
	/* Current.
	   ...
	   Specifies if only the current session is to be deleted.
	*/
	Current *bool
...
func (o *DeleteSessionParams) SetDefaults() {
	var (
		currentDefault = bool(false)
	)

	val := DeleteSessionParams{
...
// WithCurrent adds the current to the delete session params
func (o *DeleteSessionParams) WithCurrent(current *bool) *DeleteSessionParams {
	o.SetCurrent(current)
	return o
}

// SetCurrent adds the current to the delete session params
func (o *DeleteSessionParams) SetCurrent(current *bool) {
	o.Current = current
}
