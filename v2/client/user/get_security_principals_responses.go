...
func (o *GetSecurityPrincipalsOK) Error() string {
	return fmt.Sprintf("[GET /security-principals][%d] getSecurityPrincipalsOK  %+v", 200, o.Payload)
}
...
func (o *GetSecurityPrincipalsDefault) Error() string {
	return fmt.Sprintf("[GET /security-principals][%d] GetSecurityPrincipals default  %+v", o._statusCode, o.Payload)
}
