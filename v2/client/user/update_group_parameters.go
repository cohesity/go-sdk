...
type UpdateGroupParams struct {
	...
	*/
	Body *models.UpdateGroupParameters
...
func (o *UpdateGroupParams) WithBody(body *models.UpdateGroupParameters) *UpdateGroupParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update group params
func (o *UpdateGroupParams) SetBody(body *models.UpdateGroupParameters) {
	o.Body = body
}

// WithSid adds the sid to the update group params
func (o *UpdateGroupParams) WithSid(sid string) *UpdateGroupParams {
	o.SetSid(sid)
	return o
}

// SetSid adds the sid to the update group params
func (o *UpdateGroupParams) SetSid(sid string) {
	o.Sid = sid
}
