...
type UpdateUserParams struct {
	...
	*/
	Body *models.UpdateUserParameters
...
func (o *UpdateUserParams) WithBody(body *models.UpdateUserParameters) *UpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user params
func (o *UpdateUserParams) SetBody(body *models.UpdateUserParameters) {
	o.Body = body
}

// WithSid adds the sid to the update user params
func (o *UpdateUserParams) WithSid(sid string) *UpdateUserParams {
	o.SetSid(sid)
	return o
}

// SetSid adds the sid to the update user params
func (o *UpdateUserParams) SetSid(sid string) {
	o.Sid = sid
}
