...
type CreateUsersParams struct {
	...
	*/
	Body models.CreateUsersParameters
...
func (o *CreateUsersParams) WithBody(body models.CreateUsersParameters) *CreateUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create users params
func (o *CreateUsersParams) SetBody(body models.CreateUsersParameters) {
	o.Body = body
}
