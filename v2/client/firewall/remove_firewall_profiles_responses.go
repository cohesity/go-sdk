...
func (o *RemoveFirewallProfilesOK) Error() string {
	return fmt.Sprintf("[PUT /network/firewall/profile/remove][%d] removeFirewallProfilesOK  %+v", 200, o.Payload)
}
...
func (o *RemoveFirewallProfilesDefault) Error() string {
	return fmt.Sprintf("[PUT /network/firewall/profile/remove][%d] RemoveFirewallProfiles default  %+v", o._statusCode, o.Payload)
}
