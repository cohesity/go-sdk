...
type ClientService interface {
	...
	GetSslCertificates(params *GetSslCertificatesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSslCertificatesOK, error)
...
/*
GetSslCertificates gets list of s s l certificates

**Privileges:** ```CLUSTER_VIEW``` <br><br>Get list of SSL certificates.
*/
func (a *Client) GetSslCertificates(params *GetSslCertificatesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSslCertificatesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetSslCertificatesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetSslCertificates",
		Method:             "GET",
		PathPattern:        "/ssl-certificates",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetSslCertificatesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetSslCertificatesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetSslCertificatesDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
