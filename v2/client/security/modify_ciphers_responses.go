...
func (o *ModifyCiphersOK) Error() string {
	return fmt.Sprintf("[POST /security/ciphers][%d] modifyCiphersOK  %+v", 200, o.Payload)
}
...
func (o *ModifyCiphersDefault) Error() string {
	return fmt.Sprintf("[POST /security/ciphers][%d] ModifyCiphers default  %+v", o._statusCode, o.Payload)
}
