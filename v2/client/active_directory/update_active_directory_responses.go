...
func (o *UpdateActiveDirectoryOK) Error() string {
	return fmt.Sprintf("[PUT /active-directories/{id}][%d] updateActiveDirectoryOK  %+v", 200, o.Payload)
}
...
func (o *UpdateActiveDirectoryDefault) Error() string {
	return fmt.Sprintf("[PUT /active-directories/{id}][%d] UpdateActiveDirectory default  %+v", o._statusCode, o.Payload)
}
