...
type ClientService interface {
	...
	GetActiveDirectoryTopology(params *GetActiveDirectoryTopologyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetActiveDirectoryTopologyOK, error)
...
/*
GetActiveDirectoryTopology gets active directory topology
...
*/
func (a *Client) GetActiveDirectoryTopology(params *GetActiveDirectoryTopologyParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetActiveDirectoryTopologyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetActiveDirectoryTopologyParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetActiveDirectoryTopology",
		Method:             "GET",
		PathPattern:        "/active-directory-topology",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetActiveDirectoryTopologyReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetActiveDirectoryTopologyOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetActiveDirectoryTopologyDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
