...
func (o *GetCentrifyZonesOK) Error() string {
	return fmt.Sprintf("[GET /centrify-zones][%d] getCentrifyZonesOK  %+v", 200, o.Payload)
}
...
func (o *GetCentrifyZonesDefault) Error() string {
	return fmt.Sprintf("[GET /centrify-zones][%d] GetCentrifyZones default  %+v", o._statusCode, o.Payload)
}
