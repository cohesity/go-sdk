...
func (o *CreateActiveDirectoryCreated) Error() string {
	return fmt.Sprintf("[POST /active-directories][%d] createActiveDirectoryCreated  %+v", 201, o.Payload)
}
...
func (o *CreateActiveDirectoryDefault) Error() string {
	return fmt.Sprintf("[POST /active-directories][%d] CreateActiveDirectory default  %+v", o._statusCode, o.Payload)
}
