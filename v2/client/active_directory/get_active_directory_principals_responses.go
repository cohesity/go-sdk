...
func (o *GetActiveDirectoryPrincipalsOK) Error() string {
	return fmt.Sprintf("[GET /active-directory-principals][%d] getActiveDirectoryPrincipalsOK  %+v", 200, o.Payload)
}
...
func (o *GetActiveDirectoryPrincipalsDefault) Error() string {
	return fmt.Sprintf("[GET /active-directory-principals][%d] GetActiveDirectoryPrincipals default  %+v", o._statusCode, o.Payload)
}
