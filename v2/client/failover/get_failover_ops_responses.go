...
func (o *GetFailoverOpsOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/failover/views/{id}/operations][%d] getFailoverOpsOK  %+v", 200, o.Payload)
}
...
func (o *GetFailoverOpsDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/failover/views/{id}/operations][%d] GetFailoverOps default  %+v", o._statusCode, o.Payload)
}
