...
type ClientService interface {
	ConfigureSupportMFAConfig(params *ConfigureSupportMFAConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ConfigureSupportMFAConfigOK, error)
...
/*
ConfigureSupportMFAConfig stores the updated m f a configuration

**Privileges:** ```CLUSTER_MODIFY``` <br><br>Configures MFA configuration for support user.
*/
func (a *Client) ConfigureSupportMFAConfig(params *ConfigureSupportMFAConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ConfigureSupportMFAConfigOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewConfigureSupportMFAConfigParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ConfigureSupportMFAConfig",
		Method:             "PUT",
		...
		Params:             params,
		Reader:             &ConfigureSupportMFAConfigReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ConfigureSupportMFAConfigOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*ConfigureSupportMFAConfigDefault)
