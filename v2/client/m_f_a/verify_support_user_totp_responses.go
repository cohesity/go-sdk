...
func (o *VerifySupportUserTotpOK) Error() string {
	return fmt.Sprintf("[POST /support-user/verify-totp][%d] verifySupportUserTotpOK  %+v", 200, o.Payload)
}
...
func (o *VerifySupportUserTotpDefault) Error() string {
	return fmt.Sprintf("[POST /support-user/verify-totp][%d] VerifySupportUserTotp default  %+v", o._statusCode, o.Payload)
}
