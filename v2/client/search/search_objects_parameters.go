...
type SearchObjectsParams struct {
	...
	*/
	...
	/* FetchConsistentSortedOrder.

	   Specifies whether to always give a consistent sorted order of results by ensuring consistent scoring across shards. If true, performance might be impacted to trade deterministic scoring.
	*/
	FetchConsistentSortedOrder *bool

	/* GoogleWorkspaceObjectTypes.

	   Specifies the object types to filter objects on. Only applicable if the environment is kGoogleWorkspace.
	*/
	GoogleWorkspaceObjectTypes []string
	...
	*/
	...
	/* M365CountryList.
	   ...
	   Specifies the Microsoft365 Country list filter.
	*/
	M365CountryList []string

	/* M365DepartmentList.

	   Specifies the Microsoft365 Department list filter.
	*/
	M365DepartmentList []string

	/* M365TitleList.

	   Specifies the Microsoft365 Title list filter.
	*/
	M365TitleList []string
...
// WithFetchConsistentSortedOrder adds the fetchConsistentSortedOrder to the search objects params
func (o *SearchObjectsParams) WithFetchConsistentSortedOrder(fetchConsistentSortedOrder *bool) *SearchObjectsParams {
	o.SetFetchConsistentSortedOrder(fetchConsistentSortedOrder)
	return o
}

// SetFetchConsistentSortedOrder adds the fetchConsistentSortedOrder to the search objects params
func (o *SearchObjectsParams) SetFetchConsistentSortedOrder(fetchConsistentSortedOrder *bool) {
	o.FetchConsistentSortedOrder = fetchConsistentSortedOrder
}

// WithGoogleWorkspaceObjectTypes adds the googleWorkspaceObjectTypes to the search objects params
func (o *SearchObjectsParams) WithGoogleWorkspaceObjectTypes(googleWorkspaceObjectTypes []string) *SearchObjectsParams {
	o.SetGoogleWorkspaceObjectTypes(googleWorkspaceObjectTypes)
	return o
}

// SetGoogleWorkspaceObjectTypes adds the googleWorkspaceObjectTypes to the search objects params
func (o *SearchObjectsParams) SetGoogleWorkspaceObjectTypes(googleWorkspaceObjectTypes []string) {
	o.GoogleWorkspaceObjectTypes = googleWorkspaceObjectTypes
}
...
// WithM365CountryList adds the m365CountryList to the search objects params
func (o *SearchObjectsParams) WithM365CountryList(m365CountryList []string) *SearchObjectsParams {
	o.SetM365CountryList(m365CountryList)
	return o
}

// SetM365CountryList adds the m365CountryList to the search objects params
func (o *SearchObjectsParams) SetM365CountryList(m365CountryList []string) {
	o.M365CountryList = m365CountryList
}

// WithM365DepartmentList adds the m365DepartmentList to the search objects params
func (o *SearchObjectsParams) WithM365DepartmentList(m365DepartmentList []string) *SearchObjectsParams {
	o.SetM365DepartmentList(m365DepartmentList)
	return o
}

// SetM365DepartmentList adds the m365DepartmentList to the search objects params
func (o *SearchObjectsParams) SetM365DepartmentList(m365DepartmentList []string) {
	o.M365DepartmentList = m365DepartmentList
}

// WithM365TitleList adds the m365TitleList to the search objects params
func (o *SearchObjectsParams) WithM365TitleList(m365TitleList []string) *SearchObjectsParams {
	o.SetM365TitleList(m365TitleList)
	return o
}

// SetM365TitleList adds the m365TitleList to the search objects params
func (o *SearchObjectsParams) SetM365TitleList(m365TitleList []string) {
	o.M365TitleList = m365TitleList
}
...
// WithObjectUuids adds the objectUuids to the search objects params
func (o *SearchObjectsParams) WithObjectUuids(objectUuids []string) *SearchObjectsParams {
	o.SetObjectUuids(objectUuids)
	return o
}

// SetObjectUuids adds the objectUuids to the search objects params
func (o *SearchObjectsParams) SetObjectUuids(objectUuids []string) {
	o.ObjectUuids = objectUuids
}

// WithOnlyDeleted adds the onlyDeleted to the search objects params
func (o *SearchObjectsParams) WithOnlyDeleted(onlyDeleted *bool) *SearchObjectsParams {
	o.SetOnlyDeleted(onlyDeleted)
	return o
}

// SetOnlyDeleted adds the onlyDeleted to the search objects params
func (o *SearchObjectsParams) SetOnlyDeleted(onlyDeleted *bool) {
...
func (o *SearchObjectsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.FetchConsistentSortedOrder != nil {

		// query param fetchConsistentSortedOrder
		var qrFetchConsistentSortedOrder bool

		if o.FetchConsistentSortedOrder != nil {
			qrFetchConsistentSortedOrder = *o.FetchConsistentSortedOrder
		}
		qFetchConsistentSortedOrder := swag.FormatBool(qrFetchConsistentSortedOrder)
		if qFetchConsistentSortedOrder != "" {

			if err := r.SetQueryParam("fetchConsistentSortedOrder", qFetchConsistentSortedOrder); err != nil {
				return err
			}
		}
	}

	if o.GoogleWorkspaceObjectTypes != nil {

		// binding items for googleWorkspaceObjectTypes
		joinedGoogleWorkspaceObjectTypes := o.bindParamGoogleWorkspaceObjectTypes(reg)

		// query array param googleWorkspaceObjectTypes
		if err := r.SetQueryParam("googleWorkspaceObjectTypes", joinedGoogleWorkspaceObjectTypes...); err != nil {
			return err
		}
	}
	...
	if o.M365CountryList != nil {

		// binding items for m365CountryList
		joinedM365CountryList := o.bindParamM365CountryList(reg)

		// query array param m365CountryList
		if err := r.SetQueryParam("m365CountryList", joinedM365CountryList...); err != nil {
			return err
		}
	}

	if o.M365DepartmentList != nil {

		// binding items for m365DepartmentList
		joinedM365DepartmentList := o.bindParamM365DepartmentList(reg)

		// query array param m365DepartmentList
		if err := r.SetQueryParam("m365DepartmentList", joinedM365DepartmentList...); err != nil {
			return err
		}
	}

	if o.M365TitleList != nil {

		// binding items for m365TitleList
		joinedM365TitleList := o.bindParamM365TitleList(reg)

		// query array param m365TitleList
		if err := r.SetQueryParam("m365TitleList", joinedM365TitleList...); err != nil {
			return err
		}
	}
	...
	if o.ObjectUuids != nil {

		// binding items for objectUuids
		joinedObjectUuids := o.bindParamObjectUuids(reg)

		// query array param objectUuids
		if err := r.SetQueryParam("objectUuids", joinedObjectUuids...); err != nil {
			return err
		}
	}

	if o.OnlyDeleted != nil {

		// query param onlyDeleted
		var qrOnlyDeleted bool

		if o.OnlyDeleted != nil {
			qrOnlyDeleted = *o.OnlyDeleted
		}
		qOnlyDeleted := swag.FormatBool(qrOnlyDeleted)
		if qOnlyDeleted != "" {

			if err := r.SetQueryParam("onlyDeleted", qOnlyDeleted); err != nil {
				return err
			}
		}
	}
...
// bindParamSearchObjects binds the parameter googleWorkspaceObjectTypes
func (o *SearchObjectsParams) bindParamGoogleWorkspaceObjectTypes(formats strfmt.Registry) []string {
	googleWorkspaceObjectTypesIR := o.GoogleWorkspaceObjectTypes

	var googleWorkspaceObjectTypesIC []string
	for _, googleWorkspaceObjectTypesIIR := range googleWorkspaceObjectTypesIR { // explode []string

		googleWorkspaceObjectTypesIIV := googleWorkspaceObjectTypesIIR // string as string
		googleWorkspaceObjectTypesIC = append(googleWorkspaceObjectTypesIC, googleWorkspaceObjectTypesIIV)
	}

	// items.CollectionFormat: ""
	googleWorkspaceObjectTypesIS := swag.JoinByFormat(googleWorkspaceObjectTypesIC, "")

	return googleWorkspaceObjectTypesIS
}
...
// bindParamSearchObjects binds the parameter m365CountryList
func (o *SearchObjectsParams) bindParamM365CountryList(formats strfmt.Registry) []string {
	m365CountryListIR := o.M365CountryList

	var m365CountryListIC []string
	for _, m365CountryListIIR := range m365CountryListIR { // explode []string

		m365CountryListIIV := m365CountryListIIR // string as string
		m365CountryListIC = append(m365CountryListIC, m365CountryListIIV)
	}

	// items.CollectionFormat: ""
	m365CountryListIS := swag.JoinByFormat(m365CountryListIC, "")

	return m365CountryListIS
}

// bindParamSearchObjects binds the parameter m365DepartmentList
func (o *SearchObjectsParams) bindParamM365DepartmentList(formats strfmt.Registry) []string {
	m365DepartmentListIR := o.M365DepartmentList

	var m365DepartmentListIC []string
	for _, m365DepartmentListIIR := range m365DepartmentListIR { // explode []string

		m365DepartmentListIIV := m365DepartmentListIIR // string as string
		m365DepartmentListIC = append(m365DepartmentListIC, m365DepartmentListIIV)
	}

	// items.CollectionFormat: ""
	m365DepartmentListIS := swag.JoinByFormat(m365DepartmentListIC, "")

	return m365DepartmentListIS
}

// bindParamSearchObjects binds the parameter m365TitleList
func (o *SearchObjectsParams) bindParamM365TitleList(formats strfmt.Registry) []string {
	m365TitleListIR := o.M365TitleList

	var m365TitleListIC []string
	for _, m365TitleListIIR := range m365TitleListIR { // explode []string

		m365TitleListIIV := m365TitleListIIR // string as string
		m365TitleListIC = append(m365TitleListIC, m365TitleListIIV)
	}

	// items.CollectionFormat: ""
	m365TitleListIS := swag.JoinByFormat(m365TitleListIC, "")

	return m365TitleListIS
}
...
// bindParamSearchObjects binds the parameter objectUuids
func (o *SearchObjectsParams) bindParamObjectUuids(formats strfmt.Registry) []string {
	objectUuidsIR := o.ObjectUuids

	var objectUuidsIC []string
	for _, objectUuidsIIR := range objectUuidsIR { // explode []string

		objectUuidsIIV := objectUuidsIIR // string as string
		objectUuidsIC = append(objectUuidsIC, objectUuidsIIV)
	}

	// items.CollectionFormat: ""
	objectUuidsIS := swag.JoinByFormat(objectUuidsIC, "")

	return objectUuidsIS
}
