...
func (o *SearchObjectsOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/search/objects][%d] searchObjectsOK  %+v", 200, o.Payload)
}
...
func (o *SearchObjectsDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/search/objects][%d] SearchObjects default  %+v", o._statusCode, o.Payload)
}
