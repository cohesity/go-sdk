...
type DownloadFilesFromRecoveryParams struct {
	...
	/* FilePath.
	   ...
	   Specifies the path of the file on the cluster to be downloaded.
	*/
	FilePath *string
...
// WithFilePath adds the filePath to the download files from recovery params
func (o *DownloadFilesFromRecoveryParams) WithFilePath(filePath *string) *DownloadFilesFromRecoveryParams {
	o.SetFilePath(filePath)
	return o
}

// SetFilePath adds the filePath to the download files from recovery params
func (o *DownloadFilesFromRecoveryParams) SetFilePath(filePath *string) {
	o.FilePath = filePath
}
