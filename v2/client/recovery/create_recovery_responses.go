...
func (o *CreateRecoveryCreated) Error() string {
	return fmt.Sprintf("[POST /data-protect/recoveries][%d] createRecoveryCreated  %+v", 201, o.Payload)
}
...
func (o *CreateRecoveryDefault) Error() string {
	return fmt.Sprintf("[POST /data-protect/recoveries][%d] CreateRecovery default  %+v", o._statusCode, o.Payload)
}
