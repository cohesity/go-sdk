...
func (o *CreateDownloadFilesAndFoldersRecoveryCreated) Error() string {
	return fmt.Sprintf("[POST /data-protect/recoveries/download-files-folders][%d] createDownloadFilesAndFoldersRecoveryCreated  %+v", 201, o.Payload)
}
...
func (o *CreateDownloadFilesAndFoldersRecoveryDefault) Error() string {
	return fmt.Sprintf("[POST /data-protect/recoveries/download-files-folders][%d] CreateDownloadFilesAndFoldersRecovery default  %+v", o._statusCode, o.Payload)
}
