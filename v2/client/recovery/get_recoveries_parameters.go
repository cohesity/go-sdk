...
type GetRecoveriesParams struct {
	...
	*/
	...
	/* FortknoxOnpremRecoveriesOnly.

	   Return only recoveries initiated from the snapshots in FortKnox Onprem vaults if it set to true. Otherwise, return all recoveries as default.
	*/
	FortknoxOnpremRecoveriesOnly *bool
	...
	*/
	...
	/* PruneObjects.
	   ...
	   Specifies if objects should be excluded from the response.
	*/
	PruneObjects *bool
...
func (o *GetRecoveriesParams) SetDefaults() {
	var (
		fortknoxOnpremRecoveriesOnlyDefault = bool(false)

		pruneObjectsDefault = bool(false)

		returnChildTasksDefault = bool(false)
	)

	val := GetRecoveriesParams{
		FortknoxOnpremRecoveriesOnly: &fortknoxOnpremRecoveriesOnlyDefault,
		PruneObjects:                 &pruneObjectsDefault,
...
// WithFortknoxOnpremRecoveriesOnly adds the fortknoxOnpremRecoveriesOnly to the get recoveries params
func (o *GetRecoveriesParams) WithFortknoxOnpremRecoveriesOnly(fortknoxOnpremRecoveriesOnly *bool) *GetRecoveriesParams {
	o.SetFortknoxOnpremRecoveriesOnly(fortknoxOnpremRecoveriesOnly)
	return o
}

// SetFortknoxOnpremRecoveriesOnly adds the fortknoxOnpremRecoveriesOnly to the get recoveries params
func (o *GetRecoveriesParams) SetFortknoxOnpremRecoveriesOnly(fortknoxOnpremRecoveriesOnly *bool) {
	o.FortknoxOnpremRecoveriesOnly = fortknoxOnpremRecoveriesOnly
}
...
// WithPruneObjects adds the pruneObjects to the get recoveries params
func (o *GetRecoveriesParams) WithPruneObjects(pruneObjects *bool) *GetRecoveriesParams {
	o.SetPruneObjects(pruneObjects)
	return o
}

// SetPruneObjects adds the pruneObjects to the get recoveries params
func (o *GetRecoveriesParams) SetPruneObjects(pruneObjects *bool) {
	o.PruneObjects = pruneObjects
}
...
func (o *GetRecoveriesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.FortknoxOnpremRecoveriesOnly != nil {

		// query param fortknoxOnpremRecoveriesOnly
		var qrFortknoxOnpremRecoveriesOnly bool

		if o.FortknoxOnpremRecoveriesOnly != nil {
			qrFortknoxOnpremRecoveriesOnly = *o.FortknoxOnpremRecoveriesOnly
		}
		qFortknoxOnpremRecoveriesOnly := swag.FormatBool(qrFortknoxOnpremRecoveriesOnly)
		if qFortknoxOnpremRecoveriesOnly != "" {

			if err := r.SetQueryParam("fortknoxOnpremRecoveriesOnly", qFortknoxOnpremRecoveriesOnly); err != nil {
				return err
			}
		}
	}
	...
	if o.PruneObjects != nil {

		// query param pruneObjects
		var qrPruneObjects bool

		if o.PruneObjects != nil {
			qrPruneObjects = *o.PruneObjects
		}
		qPruneObjects := swag.FormatBool(qrPruneObjects)
		if qPruneObjects != "" {

			if err := r.SetQueryParam("pruneObjects", qPruneObjects); err != nil {
				return err
			}
		}
	}
