...
func (o *UpdateSnmpConfigOK) Error() string {
	return fmt.Sprintf("[PUT /snmp/config][%d] updateSnmpConfigOK  %+v", 200, o.Payload)
}
...
func (o *UpdateSnmpConfigDefault) Error() string {
	return fmt.Sprintf("[PUT /snmp/config][%d] UpdateSnmpConfig default  %+v", o._statusCode, o.Payload)
}
