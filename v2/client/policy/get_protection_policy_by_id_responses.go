...
func (o *GetProtectionPolicyByIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /data-protect/policies/{id}][%d] getProtectionPolicyByIdOK %s", 200, payload)
}
...
func (o *GetProtectionPolicyByIDDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /data-protect/policies/{id}][%d] GetProtectionPolicyById default %s", o._statusCode, payload)
}
