...
func (o *GetProtectionPolicyByIDOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/policies/{id}][%d] getProtectionPolicyByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionPolicyByIDOK) GetPayload() *models.ProtectionPolicyResponse {
	return o.Payload
}
...
func (o *GetProtectionPolicyByIDDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/policies/{id}][%d] GetProtectionPolicyById default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetProtectionPolicyByIDDefault) GetPayload() *models.Error {
	return o.Payload
}
