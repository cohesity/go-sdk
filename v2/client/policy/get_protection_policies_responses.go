...
func (o *GetProtectionPoliciesOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/policies][%d] getProtectionPoliciesOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionPoliciesDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/policies][%d] GetProtectionPolicies default  %+v", o._statusCode, o.Payload)
}
