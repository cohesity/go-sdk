...
func (o *GetPolicyTemplateByIDOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/policy-templates/{id}][%d] getPolicyTemplateByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetPolicyTemplateByIDDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/policy-templates/{id}][%d] GetPolicyTemplateById default  %+v", o._statusCode, o.Payload)
}
