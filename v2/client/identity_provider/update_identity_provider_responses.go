...
func (o *UpdateIdentityProviderOK) Error() string {
	return fmt.Sprintf("[PUT /idps/{id}][%d] updateIdentityProviderOK  %+v", 200, o.Payload)
}
...
func (o *UpdateIdentityProviderDefault) Error() string {
	return fmt.Sprintf("[PUT /idps/{id}][%d] UpdateIdentityProvider default  %+v", o._statusCode, o.Payload)
}
