...
func (o *CreateIdentityCreated) Error() string {
	return fmt.Sprintf("[POST /identity-providers][%d] createIdentityCreated  %+v", 201, o.Payload)
}
...
func (o *CreateIdentityDefault) Error() string {
	return fmt.Sprintf("[POST /identity-providers][%d] CreateIdentity default  %+v", o._statusCode, o.Payload)
}
