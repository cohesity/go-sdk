...
func (o *UpdateIdentityOK) Error() string {
	return fmt.Sprintf("[PUT /identity-providers/{id}][%d] updateIdentityOK  %+v", 200, o.Payload)
}
...
func (o *UpdateIdentityDefault) Error() string {
	return fmt.Sprintf("[PUT /identity-providers/{id}][%d] UpdateIdentity default  %+v", o._statusCode, o.Payload)
}
