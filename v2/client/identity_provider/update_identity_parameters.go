...
func (o *UpdateIdentityParams) WithBody(body *models.IdentityConfig) *UpdateIdentityParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update identity params
func (o *UpdateIdentityParams) SetBody(body *models.IdentityConfig) {
	o.Body = body
}

// WithID adds the id to the update identity params
func (o *UpdateIdentityParams) WithID(id int64) *UpdateIdentityParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update identity params
func (o *UpdateIdentityParams) SetID(id int64) {
	o.ID = id
}
