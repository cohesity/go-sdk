...
func (o *GetDataTieringTaskByIDOK) Error() string {
	return fmt.Sprintf("[GET /data-tiering/tasks/{id}][%d] getDataTieringTaskByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetDataTieringTaskByIDDefault) Error() string {
	return fmt.Sprintf("[GET /data-tiering/tasks/{id}][%d] GetDataTieringTaskById default  %+v", o._statusCode, o.Payload)
}
