...
func (o *UpdateDataTieringTasksStateOK) Error() string {
	return fmt.Sprintf("[POST /data-tiering/tasks/states][%d] updateDataTieringTasksStateOK  %+v", 200, o.Payload)
}
...
func (o *UpdateDataTieringTasksStateDefault) Error() string {
	return fmt.Sprintf("[POST /data-tiering/tasks/states][%d] UpdateDataTieringTasksState default  %+v", o._statusCode, o.Payload)
}
