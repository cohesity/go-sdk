...
type ClientService interface {
	...
	GetSupportedSyslogAuthModes(params *GetSupportedSyslogAuthModesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSupportedSyslogAuthModesOK, error)
...
/*
GetSupportedSyslogAuthModes gets supported program names

**Privileges:** ```CLUSTER_VIEW``` <br><br>Get supported authentation modes.
*/
func (a *Client) GetSupportedSyslogAuthModes(params *GetSupportedSyslogAuthModesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetSupportedSyslogAuthModesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetSupportedSyslogAuthModesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetSupportedSyslogAuthModes",
		Method:             "GET",
		PathPattern:        "/syslog/auth-modes",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetSupportedSyslogAuthModesReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetSupportedSyslogAuthModesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetSupportedSyslogAuthModesDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
