...
func (o *PatchSyslogServerByIDOK) Error() string {
	return fmt.Sprintf("[PATCH /syslog/{id}][%d] patchSyslogServerByIdOK  %+v", 200, o.Payload)
}
...
func (o *PatchSyslogServerByIDDefault) Error() string {
	return fmt.Sprintf("[PATCH /syslog/{id}][%d] PatchSyslogServerById default  %+v", o._statusCode, o.Payload)
}
