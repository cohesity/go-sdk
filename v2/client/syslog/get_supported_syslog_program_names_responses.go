...
func (o *GetSupportedSyslogProgramNamesOK) Error() string {
	return fmt.Sprintf("[GET /syslog/program-names][%d] getSupportedSyslogProgramNamesOK  %+v", 200, o.Payload)
}
...
func (o *GetSupportedSyslogProgramNamesDefault) Error() string {
	return fmt.Sprintf("[GET /syslog/program-names][%d] GetSupportedSyslogProgramNames default  %+v", o._statusCode, o.Payload)
}
