...
func (o *GetSyslogAuditTagsOK) Error() string {
	return fmt.Sprintf("[GET /syslog/audit-tags][%d] getSyslogAuditTagsOK  %+v", 200, o.Payload)
}
...
func (o *GetSyslogAuditTagsDefault) Error() string {
	return fmt.Sprintf("[GET /syslog/audit-tags][%d] GetSyslogAuditTags default  %+v", o._statusCode, o.Payload)
}
