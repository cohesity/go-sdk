...
type ClientService interface {
	...
	GetViewUserQuotasByID(params *GetViewUserQuotasByIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetViewUserQuotasByIDOK, error)
...
**Privileges:** ```STORAGE_VIEW``` <br><br>Get user quotas for the View. This api will be deprecated. Use the API '/file-services/views/user-quota' instead.
*/
...
/*
GetViewUserQuotasByID gets view user quotas

**Privileges:** ```STORAGE_VIEW``` <br><br>Get user quotas for the View.
*/
func (a *Client) GetViewUserQuotasByID(params *GetViewUserQuotasByIDParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetViewUserQuotasByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetViewUserQuotasByIDParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetViewUserQuotasById",
		Method:             "GET",
		PathPattern:        "/file-services/views/user-quotas",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetViewUserQuotasByIDReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetViewUserQuotasByIDOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetViewUserQuotasByIDDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
/*
	...
	**Privileges:** ```STORAGE_VIEW``` <br><br>All view templates on the Cohesity Cluster are returned.
