...
func (o *GetViewByIDOK) Error() string {
	return fmt.Sprintf("[GET /file-services/views/{id}][%d] getViewByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetViewByIDDefault) Error() string {
	return fmt.Sprintf("[GET /file-services/views/{id}][%d] GetViewById default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetViewByIDDefault) GetPayload() *models.Error {
	return o.Payload
}
