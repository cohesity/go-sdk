...
func (o *GetViewByIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /file-services/views/{id}][%d] getViewByIdOK %s", 200, payload)
}
...
func (o *GetViewByIDDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /file-services/views/{id}][%d] GetViewById default %s", o._statusCode, payload)
}
