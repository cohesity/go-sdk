...
func (o *CloneViewCreated) Error() string {
	return fmt.Sprintf("[POST /file-services/views/{id}/clone][%d] cloneViewCreated  %+v", 201, o.Payload)
}
...
func (o *CloneViewDefault) Error() string {
	return fmt.Sprintf("[POST /file-services/views/{id}/clone][%d] CloneView default  %+v", o._statusCode, o.Payload)
}
...
func (o *CloneViewDefault) GetPayload() *models.Error {
	return o.Payload
}
