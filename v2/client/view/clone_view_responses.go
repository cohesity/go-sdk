...
func (o *CloneViewCreated) Error() string {
	...
	return fmt.Sprintf("[POST /file-services/views/{id}/clone][%d] cloneViewCreated %s", 201, payload)
}
...
func (o *CloneViewDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /file-services/views/{id}/clone][%d] CloneView default %s", o._statusCode, payload)
}
