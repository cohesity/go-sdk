...
func (o *UpdateViewOK) Error() string {
	return fmt.Sprintf("[PUT /file-services/views/{id}][%d] updateViewOK  %+v", 200, o.Payload)
}
...
func (o *UpdateViewDefault) Error() string {
	return fmt.Sprintf("[PUT /file-services/views/{id}][%d] UpdateView default  %+v", o._statusCode, o.Payload)
}
