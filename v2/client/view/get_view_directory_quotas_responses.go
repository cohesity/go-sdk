...
func (o *GetViewDirectoryQuotasOK) Error() string {
	return fmt.Sprintf("[GET /file-services/views/{id}/directory-quotas][%d] getViewDirectoryQuotasOK  %+v", 200, o.Payload)
}
...
func (o *GetViewDirectoryQuotasDefault) Error() string {
	return fmt.Sprintf("[GET /file-services/views/{id}/directory-quotas][%d] GetViewDirectoryQuotas default  %+v", o._statusCode, o.Payload)
}
