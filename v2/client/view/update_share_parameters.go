...
func (o *UpdateShareParams) WithBody(body *models.UpdateShareParam) *UpdateShareParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update share params
func (o *UpdateShareParams) SetBody(body *models.UpdateShareParam) {
	o.Body = body
}

// WithName adds the name to the update share params
func (o *UpdateShareParams) WithName(name string) *UpdateShareParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the update share params
func (o *UpdateShareParams) SetName(name string) {
	o.Name = name
}
