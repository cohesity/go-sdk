...
func (o *GetViewsSummaryOK) Error() string {
	return fmt.Sprintf("[GET /file-services/views-summary][%d] getViewsSummaryOK  %+v", 200, o.Payload)
}
...
func (o *GetViewsSummaryDefault) Error() string {
	return fmt.Sprintf("[GET /file-services/views-summary][%d] GetViewsSummary default  %+v", o._statusCode, o.Payload)
}
