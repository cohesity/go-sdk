...
func (o *GetFileLockStatusOK) Error() string {
	return fmt.Sprintf("[GET /file-services/views/{id}/file-lock][%d] getFileLockStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetFileLockStatusDefault) Error() string {
	return fmt.Sprintf("[GET /file-services/views/{id}/file-lock][%d] GetFileLockStatus default  %+v", o._statusCode, o.Payload)
}
