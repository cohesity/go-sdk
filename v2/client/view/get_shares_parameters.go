...
type GetSharesParams struct {
	...
	*/
	...
	/* IsReadOnlyView.
	   ...
	   If true, only shares of Views that are Read-Only will be returned.
	*/
	IsReadOnlyView *bool
...
// WithIsReadOnlyView adds the isReadOnlyView to the get shares params
func (o *GetSharesParams) WithIsReadOnlyView(isReadOnlyView *bool) *GetSharesParams {
	o.SetIsReadOnlyView(isReadOnlyView)
	return o
}

// SetIsReadOnlyView adds the isReadOnlyView to the get shares params
func (o *GetSharesParams) SetIsReadOnlyView(isReadOnlyView *bool) {
	o.IsReadOnlyView = isReadOnlyView
}
...
func (o *GetSharesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IsReadOnlyView != nil {

		// query param isReadOnlyView
		var qrIsReadOnlyView bool

		if o.IsReadOnlyView != nil {
			qrIsReadOnlyView = *o.IsReadOnlyView
		}
		qIsReadOnlyView := swag.FormatBool(qrIsReadOnlyView)
		if qIsReadOnlyView != "" {

			if err := r.SetQueryParam("isReadOnlyView", qIsReadOnlyView); err != nil {
				return err
			}
		}
	}
