...
type GetViewsParams struct {
	...
	*/
	...
	/* SkipHighIDViews.
	     ...
	     Specifies if Views with ID greater than BridgeConstants::kViewIdMangleMask
	should be returned. These Views are created by MagnetoV2 or NetBackup.
	*/
	SkipHighIDViews *bool
...
// WithSkipHighIDViews adds the skipHighIDViews to the get views params
func (o *GetViewsParams) WithSkipHighIDViews(skipHighIDViews *bool) *GetViewsParams {
	o.SetSkipHighIDViews(skipHighIDViews)
	return o
}

// SetSkipHighIDViews adds the skipHighIdViews to the get views params
func (o *GetViewsParams) SetSkipHighIDViews(skipHighIDViews *bool) {
	o.SkipHighIDViews = skipHighIDViews
}
...
func (o *GetViewsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.SkipHighIDViews != nil {

		// query param skipHighIdViews
		var qrSkipHighIDViews bool

		if o.SkipHighIDViews != nil {
			qrSkipHighIDViews = *o.SkipHighIDViews
		}
		qSkipHighIDViews := swag.FormatBool(qrSkipHighIDViews)
		if qSkipHighIDViews != "" {

			if err := r.SetQueryParam("skipHighIdViews", qSkipHighIDViews); err != nil {
				return err
			}
		}
	}
