...
func (o *GetViewClientsOK) Error() string {
	return fmt.Sprintf("[GET /file-services/view-clients][%d] getViewClientsOK  %+v", 200, o.Payload)
}
...
func (o *GetViewClientsDefault) Error() string {
	return fmt.Sprintf("[GET /file-services/view-clients][%d] GetViewClients default  %+v", o._statusCode, o.Payload)
}
