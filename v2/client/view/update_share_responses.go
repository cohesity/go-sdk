...
func (o *UpdateShareOK) Error() string {
	return fmt.Sprintf("[PUT /file-services/shares/{name}][%d] updateShareOK  %+v", 200, o.Payload)
}
...
func (o *UpdateShareDefault) Error() string {
	return fmt.Sprintf("[PUT /file-services/shares/{name}][%d] UpdateShare default  %+v", o._statusCode, o.Payload)
}
