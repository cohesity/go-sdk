...
func (o *GetNlmLocksOK) Error() string {
	return fmt.Sprintf("[GET /file-services/nlm-locks][%d] getNlmLocksOK  %+v", 200, o.Payload)
}
...
func (o *GetNlmLocksDefault) Error() string {
	return fmt.Sprintf("[GET /file-services/nlm-locks][%d] GetNlmLocks default  %+v", o._statusCode, o.Payload)
}
