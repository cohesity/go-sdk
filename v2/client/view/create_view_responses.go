...
func (o *CreateViewCreated) Error() string {
	return fmt.Sprintf("[POST /file-services/views][%d] createViewCreated  %+v", 201, o.Payload)
}
...
func (o *CreateViewDefault) Error() string {
	return fmt.Sprintf("[POST /file-services/views][%d] CreateView default  %+v", o._statusCode, o.Payload)
}
