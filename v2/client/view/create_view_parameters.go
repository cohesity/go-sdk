...
func (o *CreateViewParams) WithBody(body *models.CreateViewRequest) *CreateViewParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create view params
func (o *CreateViewParams) SetBody(body *models.CreateViewRequest) {
	o.Body = body
}
