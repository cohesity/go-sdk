...
type GetViewClientsParams struct {
	...
	/* IncludeSummary.
	   ...
	   Set this to include response summary. Parameter 'maxCount' will be ignored if this is set to true.
	*/
	IncludeSummary *bool

	/* MaxCount.

	   Specifies the maximum number of connections to return for SMB and NFS protocols respectively. It will be ignored if parameter 'includeSummary' is set to true.
...
// WithIncludeSummary adds the includeSummary to the get view clients params
func (o *GetViewClientsParams) WithIncludeSummary(includeSummary *bool) *GetViewClientsParams {
	o.SetIncludeSummary(includeSummary)
	return o
}

// SetIncludeSummary adds the includeSummary to the get view clients params
func (o *GetViewClientsParams) SetIncludeSummary(includeSummary *bool) {
...
func (o *GetViewClientsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeSummary != nil {
		...
		if qIncludeSummary != "" {
			...
			if err := r.SetQueryParam("includeSummary", qIncludeSummary); err != nil {
				return err
			}
		}
	}
