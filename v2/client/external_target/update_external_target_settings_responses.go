...
func (o *UpdateExternalTargetSettingsOK) Error() string {
	return fmt.Sprintf("[PUT /data-protect/external-targets/settings][%d] updateExternalTargetSettingsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateExternalTargetSettingsDefault) Error() string {
	return fmt.Sprintf("[PUT /data-protect/external-targets/settings][%d] UpdateExternalTargetSettings default  %+v", o._statusCode, o.Payload)
}
