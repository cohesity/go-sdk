...
type GetExternalTargetsParams struct {
	...
	*/
	...
	/* IbmCosTargetTypes.
	   ...
	   Filter by a list of External Target types.
	*/
	IbmCosTargetTypes []string
...
// WithIbmCosTargetTypes adds the ibmCosTargetTypes to the get external targets params
func (o *GetExternalTargetsParams) WithIbmCosTargetTypes(ibmCosTargetTypes []string) *GetExternalTargetsParams {
	o.SetIbmCosTargetTypes(ibmCosTargetTypes)
	return o
}

// SetIbmCosTargetTypes adds the ibmCosTargetTypes to the get external targets params
func (o *GetExternalTargetsParams) SetIbmCosTargetTypes(ibmCosTargetTypes []string) {
	o.IbmCosTargetTypes = ibmCosTargetTypes
}
...
func (o *GetExternalTargetsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IbmCosTargetTypes != nil {

		// binding items for ibmCosTargetTypes
		joinedIbmCosTargetTypes := o.bindParamIbmCosTargetTypes(reg)

		// query array param ibmCosTargetTypes
		if err := r.SetQueryParam("ibmCosTargetTypes", joinedIbmCosTargetTypes...); err != nil {
			return err
		}
	}
...
// bindParamGetExternalTargets binds the parameter ibmCosTargetTypes
func (o *GetExternalTargetsParams) bindParamIbmCosTargetTypes(formats strfmt.Registry) []string {
	ibmCosTargetTypesIR := o.IbmCosTargetTypes

	var ibmCosTargetTypesIC []string
	for _, ibmCosTargetTypesIIR := range ibmCosTargetTypesIR { // explode []string

		ibmCosTargetTypesIIV := ibmCosTargetTypesIIR // string as string
		ibmCosTargetTypesIC = append(ibmCosTargetTypesIC, ibmCosTargetTypesIIV)
	}

	// items.CollectionFormat: ""
	ibmCosTargetTypesIS := swag.JoinByFormat(ibmCosTargetTypesIC, "")

	return ibmCosTargetTypesIS
}
