...
func (o *GetExternalTargetsOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/external-targets][%d] getExternalTargetsOK  %+v", 200, o.Payload)
}
...
func (o *GetExternalTargetsDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/external-targets][%d] GetExternalTargets default  %+v", o._statusCode, o.Payload)
}
