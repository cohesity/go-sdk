...
func (o *GetExternalTargetSettingsOK) Error() string {
	return fmt.Sprintf("[GET /data-protect/external-targets/settings][%d] getExternalTargetSettingsOK  %+v", 200, o.Payload)
}
...
func (o *GetExternalTargetSettingsDefault) Error() string {
	return fmt.Sprintf("[GET /data-protect/external-targets/settings][%d] GetExternalTargetSettings default  %+v", o._statusCode, o.Payload)
}
