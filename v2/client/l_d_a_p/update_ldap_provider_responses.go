...
func (o *UpdateLdapProviderOK) Error() string {
	return fmt.Sprintf("[PUT /ldap][%d] updateLdapProviderOK  %+v", 200, o.Payload)
}
...
func (o *UpdateLdapProviderOK) GetPayload() *models.Ldap {
	return o.Payload
}
...
func (o *UpdateLdapProviderDefault) Error() string {
	return fmt.Sprintf("[PUT /ldap][%d] UpdateLdapProvider default  %+v", o._statusCode, o.Payload)
}
