...
func (o *GetLdapConnectionStatusOK) Error() string {
	return fmt.Sprintf("[GET /ldap/{id}/connection-status][%d] getLdapConnectionStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetLdapConnectionStatusDefault) Error() string {
	return fmt.Sprintf("[GET /ldap/{id}/connection-status][%d] GetLdapConnectionStatus default  %+v", o._statusCode, o.Payload)
}
