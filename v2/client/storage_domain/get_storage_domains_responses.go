...
func (o *GetStorageDomainsOK) Error() string {
	return fmt.Sprintf("[GET /storage-domains][%d] getStorageDomainsOK  %+v", 200, o.Payload)
}
...
func (o *GetStorageDomainsDefault) Error() string {
	return fmt.Sprintf("[GET /storage-domains][%d] GetStorageDomains default  %+v", o._statusCode, o.Payload)
}
