...
type GetStorageDomainsParams struct {
	...
	*/
	...
	/* Purpose.
	   ...
	   Filter by Storage Domain purpose.
	*/
	Purpose []string
...
// WithPurpose adds the purpose to the get storage domains params
func (o *GetStorageDomainsParams) WithPurpose(purpose []string) *GetStorageDomainsParams {
	o.SetPurpose(purpose)
	return o
}

// SetPurpose adds the purpose to the get storage domains params
func (o *GetStorageDomainsParams) SetPurpose(purpose []string) {
	o.Purpose = purpose
}
...
// bindParamGetStorageDomains binds the parameter purpose
func (o *GetStorageDomainsParams) bindParamPurpose(formats strfmt.Registry) []string {
	purposeIR := o.Purpose
