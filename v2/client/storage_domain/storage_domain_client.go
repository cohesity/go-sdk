...
type ClientService interface {
	...
	GetFaultToleranceSettings(params *GetFaultToleranceSettingsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetFaultToleranceSettingsOK, error)
...
/*
GetFaultToleranceSettings gets fault tolerance settings

**Privileges:** ```STORAGE_DOMAIN_VIEW``` <br><br>Get the fault tolerance settings and options for Storage Domains.
*/
func (a *Client) GetFaultToleranceSettings(params *GetFaultToleranceSettingsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetFaultToleranceSettingsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetFaultToleranceSettingsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetFaultToleranceSettings",
		Method:             "GET",
		PathPattern:        "/storage-domains/fault-tolerance-options",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetFaultToleranceSettingsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetFaultToleranceSettingsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetFaultToleranceSettingsDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
