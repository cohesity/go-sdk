...
// WithReason adds the reason to the delete protection group params
func (o *DeleteProtectionGroupParams) WithReason(reason *string) *DeleteProtectionGroupParams {
	o.SetReason(reason)
	return o
}

// SetReason adds the reason to the delete protection group params
func (o *DeleteProtectionGroupParams) SetReason(reason *string) {
	o.Reason = reason
}
