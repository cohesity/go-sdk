...
type GetRunMessagesReportParams struct {
	...
	*/
	...
	/* ObjectActionKey.
	   ...
	   Specifies the backup type for the object. Currently this is used to filter the coulumns of the report. If not specified, all the columns will be returned. This is applicable only for O365 onedrive, sharepoint, group and teams objects.
	*/
...
// WithObjectActionKey adds the objectActionKey to the get run messages report params
func (o *GetRunMessagesReportParams) WithObjectActionKey(objectActionKey *string) *GetRunMessagesReportParams {
	o.SetObjectActionKey(objectActionKey)
	return o
}

// SetObjectActionKey adds the objectActionKey to the get run messages report params
func (o *GetRunMessagesReportParams) SetObjectActionKey(objectActionKey *string) {
