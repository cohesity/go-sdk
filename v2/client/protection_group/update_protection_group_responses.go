...
func (o *UpdateProtectionGroupOK) Error() string {
	return fmt.Sprintf("[PUT /data-protect/protection-groups/{id}][%d] updateProtectionGroupOK  %+v", 200, o.Payload)
}
...
func (o *UpdateProtectionGroupDefault) Error() string {
	return fmt.Sprintf("[PUT /data-protect/protection-groups/{id}][%d] UpdateProtectionGroup default  %+v", o._statusCode, o.Payload)
}
