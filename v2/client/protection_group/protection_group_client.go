...
type ClientService interface {
	...
	GetIndexingRunsSummary(params *GetIndexingRunsSummaryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetIndexingRunsSummaryOK, error)
...
/*
GetIndexingRunsSummary gets the list of indexing runs summary for a given range

**Privileges:** ```PROTECTION_VIEW``` <br><br>Get the indexing runs summary for a given range.
*/
func (a *Client) GetIndexingRunsSummary(params *GetIndexingRunsSummaryParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetIndexingRunsSummaryOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetIndexingRunsSummaryParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetIndexingRunsSummary",
		Method:             "GET",
		PathPattern:        "/data-protect/indexing/runs/summary",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetIndexingRunsSummaryReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetIndexingRunsSummaryOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetIndexingRunsSummaryDefault)
	return nil, runtime.NewAPIError("unexpected success response: content available as default response in error", unexpectedSuccess, unexpectedSuccess.Code())
}
...
**Privileges:** ```PROTECTION_JOB_OPERATE``` <br><br>Perform various actions on a Protection Group run.
*/
