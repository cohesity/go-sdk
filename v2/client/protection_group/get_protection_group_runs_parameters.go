...
type GetProtectionGroupRunsParams struct {
	...
	*/
	IncludeExternalTargetRuns *bool
...
// WithIncludeExternalTargetRuns adds the includeExternalTargetRuns to the get protection group runs params
func (o *GetProtectionGroupRunsParams) WithIncludeExternalTargetRuns(includeExternalTargetRuns *bool) *GetProtectionGroupRunsParams {
	o.SetIncludeExternalTargetRuns(includeExternalTargetRuns)
	return o
}

// SetIncludeExternalTargetRuns adds the includeExternalTargetRuns to the get protection group runs params
func (o *GetProtectionGroupRunsParams) SetIncludeExternalTargetRuns(includeExternalTargetRuns *bool) {
	o.IncludeExternalTargetRuns = includeExternalTargetRuns
}
...
func (o *GetProtectionGroupRunsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeExternalTargetRuns != nil {

		// query param includeExternalTargetRuns
		var qrIncludeExternalTargetRuns bool

		if o.IncludeExternalTargetRuns != nil {
			qrIncludeExternalTargetRuns = *o.IncludeExternalTargetRuns
		}
		qIncludeExternalTargetRuns := swag.FormatBool(qrIncludeExternalTargetRuns)
		if qIncludeExternalTargetRuns != "" {

			if err := r.SetQueryParam("includeExternalTargetRuns", qIncludeExternalTargetRuns); err != nil {
				return err
			}
		}
	}
