...
func (o *UpdateProtectionGroupRunMultiStatus) Error() string {
	return fmt.Sprintf("[PUT /data-protect/protection-groups/{id}/runs][%d] updateProtectionGroupRunMultiStatus  %+v", 207, o.Payload)
}
...
func (o *UpdateProtectionGroupRunDefault) Error() string {
	return fmt.Sprintf("[PUT /data-protect/protection-groups/{id}/runs][%d] UpdateProtectionGroupRun default  %+v", o._statusCode, o.Payload)
}
