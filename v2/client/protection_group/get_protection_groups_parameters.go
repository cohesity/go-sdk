...
type GetProtectionGroupsParams struct {
	...
	*/
	...
	/* LastRunVaultingStatus.

	   Filter by last vaulting run status.<br> 'Running' indicates that the run is still running.<br> 'Canceled' indicates that the run has been canceled.<br> 'Canceling' indicates that the run is in the process of being canceled.<br> 'Failed' indicates that the run has failed.<br> 'Missed' indicates that the run was unable to take place at the scheduled time because the previous run was still happening.<br> 'Succeeded' indicates that the run has finished successfully.<br> 'SucceededWithWarning' indicates that the run finished successfully, but there were some warning messages.<br> 'Paused' indicates that the ongoing run has been paused.<br> 'Skipped' indicates that the run was skipped.
	*/
	LastRunVaultingStatus []string
...
// WithLastRunVaultingStatus adds the lastRunVaultingStatus to the get protection groups params
func (o *GetProtectionGroupsParams) WithLastRunVaultingStatus(lastRunVaultingStatus []string) *GetProtectionGroupsParams {
	o.SetLastRunVaultingStatus(lastRunVaultingStatus)
	return o
}

// SetLastRunVaultingStatus adds the lastRunVaultingStatus to the get protection groups params
func (o *GetProtectionGroupsParams) SetLastRunVaultingStatus(lastRunVaultingStatus []string) {
	o.LastRunVaultingStatus = lastRunVaultingStatus
}
...
func (o *GetProtectionGroupsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.LastRunVaultingStatus != nil {

		// binding items for lastRunVaultingStatus
		joinedLastRunVaultingStatus := o.bindParamLastRunVaultingStatus(reg)

		// query array param lastRunVaultingStatus
		if err := r.SetQueryParam("lastRunVaultingStatus", joinedLastRunVaultingStatus...); err != nil {
			return err
		}
	}
...
// bindParamGetProtectionGroups binds the parameter lastRunVaultingStatus
func (o *GetProtectionGroupsParams) bindParamLastRunVaultingStatus(formats strfmt.Registry) []string {
	lastRunVaultingStatusIR := o.LastRunVaultingStatus

	var lastRunVaultingStatusIC []string
	for _, lastRunVaultingStatusIIR := range lastRunVaultingStatusIR { // explode []string

		lastRunVaultingStatusIIV := lastRunVaultingStatusIIR // string as string
		lastRunVaultingStatusIC = append(lastRunVaultingStatusIC, lastRunVaultingStatusIIV)
	}

	// items.CollectionFormat: ""
	lastRunVaultingStatusIS := swag.JoinByFormat(lastRunVaultingStatusIC, "")

	return lastRunVaultingStatusIS
}
