...
func (o *InstallLogsOK) Error() string {
	return fmt.Sprintf("[GET /helios/services/install/logs][%d] installLogsOK  %+v", 200, o.Payload)
}
...
func (o *InstallLogsDefault) Error() string {
	return fmt.Sprintf("[GET /helios/services/install/logs][%d] InstallLogs default  %+v", o._statusCode, o.Payload)
}
