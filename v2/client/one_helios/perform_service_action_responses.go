...
func (o *PerformServiceActionOK) Error() string {
	return fmt.Sprintf("[PUT /helios/services/ondemand/{serviceName}/action][%d] performServiceActionOK  %+v", 200, o.Payload)
}
...
func (o *PerformServiceActionDefault) Error() string {
	return fmt.Sprintf("[PUT /helios/services/ondemand/{serviceName}/action][%d] PerformServiceAction default  %+v", o._statusCode, o.Payload)
}
