...
type GetSourceRegistrationsParams struct {
	...
	*/
	...
	/* IncludeHosts.
	   ...
	   If true, the list of hosts associated with the registered source will be included. The default is value is false.
	*/
	IncludeHosts *bool
...
// WithIncludeHosts adds the includeHosts to the get source registrations params
func (o *GetSourceRegistrationsParams) WithIncludeHosts(includeHosts *bool) *GetSourceRegistrationsParams {
	o.SetIncludeHosts(includeHosts)
	return o
}

// SetIncludeHosts adds the includeHosts to the get source registrations params
func (o *GetSourceRegistrationsParams) SetIncludeHosts(includeHosts *bool) {
	o.IncludeHosts = includeHosts
}
...
func (o *GetSourceRegistrationsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeHosts != nil {

		// query param includeHosts
		var qrIncludeHosts bool

		if o.IncludeHosts != nil {
			qrIncludeHosts = *o.IncludeHosts
		}
		qIncludeHosts := swag.FormatBool(qrIncludeHosts)
		if qIncludeHosts != "" {

			if err := r.SetQueryParam("includeHosts", qIncludeHosts); err != nil {
				return err
			}
		}
	}
