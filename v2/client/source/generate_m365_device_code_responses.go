...
func (o *GenerateM365DeviceCodeCreated) Error() string {
	return fmt.Sprintf("[POST /data-protect/sources/microsoft365/auth/device-code][%d] generateM365DeviceCodeCreated  %+v", 201, o.Payload)
}
...
func (o *GenerateM365DeviceCodeDefault) Error() string {
	return fmt.Sprintf("[POST /data-protect/sources/microsoft365/auth/device-code][%d] GenerateM365DeviceCode default  %+v", o._statusCode, o.Payload)
}
