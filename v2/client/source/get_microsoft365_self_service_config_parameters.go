...
type GetMicrosoft365SelfServiceConfigParams struct {
	...
	/* Domain.
	   ...
	   Specifies the domain name for the Microsoft365 source.
	*/
	Domain *string
...
// WithDomain adds the domain to the get microsoft365 self service config params
func (o *GetMicrosoft365SelfServiceConfigParams) WithDomain(domain *string) *GetMicrosoft365SelfServiceConfigParams {
	o.SetDomain(domain)
	return o
}

// SetDomain adds the domain to the get microsoft365 self service config params
func (o *GetMicrosoft365SelfServiceConfigParams) SetDomain(domain *string) {
	o.Domain = domain
}
