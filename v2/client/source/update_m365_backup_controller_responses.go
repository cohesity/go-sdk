...
func (o *UpdateM365BackupControllerOK) Error() string {
	return fmt.Sprintf("[PATCH /data-protect/sources/microsoft365/backup-controllers/{id}][%d] updateM365BackupControllerOK  %+v", 200, o.Payload)
}
...
func (o *UpdateM365BackupControllerDefault) Error() string {
	return fmt.Sprintf("[PATCH /data-protect/sources/microsoft365/backup-controllers/{id}][%d] UpdateM365BackupController default  %+v", o._statusCode, o.Payload)
}
