...
func (o *GenerateM365DeviceAccessTokenCreated) Error() string {
	return fmt.Sprintf("[POST /data-protect/sources/microsoft365/auth/token][%d] generateM365DeviceAccessTokenCreated  %+v", 201, o.Payload)
}
...
func (o *GenerateM365DeviceAccessTokenDefault) Error() string {
	return fmt.Sprintf("[POST /data-protect/sources/microsoft365/auth/token][%d] GenerateM365DeviceAccessToken default  %+v", o._statusCode, o.Payload)
}
