...
func (o *PerformActionOnAgentUpgradeTaskCreated) Error() string {
	return fmt.Sprintf("[POST /data-protect/agents/upgrade-tasks/actions][%d] performActionOnAgentUpgradeTaskCreated  %+v", 201, o.Payload)
}
...
func (o *PerformActionOnAgentUpgradeTaskDefault) Error() string {
	return fmt.Sprintf("[POST /data-protect/agents/upgrade-tasks/actions][%d] PerformActionOnAgentUpgradeTask default  %+v", o._statusCode, o.Payload)
}
