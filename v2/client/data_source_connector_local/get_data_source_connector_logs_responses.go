...
func (o *GetDataSourceConnectorLogsOK) Error() string {
	return fmt.Sprintf("[GET /data-source-connector/logs][%d] getDataSourceConnectorLogsOK  %+v", 200, o.Payload)
}
...
func (o *GetDataSourceConnectorLogsDefault) Error() string {
	return fmt.Sprintf("[GET /data-source-connector/logs][%d] GetDataSourceConnectorLogs default  %+v", o._statusCode, o.Payload)
}
