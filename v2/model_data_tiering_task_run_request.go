...
// checks if the DataTieringTaskRunRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataTieringTaskRunRequest{}
...
func (o DataTieringTaskRunRequest) ToMap() (map[string]interface{}, error) {
