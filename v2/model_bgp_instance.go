...
// checks if the BgpInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BgpInstance{}
...
func (o BgpInstance) ToMap() (map[string]interface{}, error) {
