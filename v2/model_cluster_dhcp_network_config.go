...
// checks if the ClusterDhcpNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterDhcpNetworkConfig{}
...
type _ClusterDhcpNetworkConfig ClusterDhcpNetworkConfig
...
func (o ClusterDhcpNetworkConfig) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterDhcpNetworkConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterDhcpNetworkConfig := _ClusterDhcpNetworkConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClusterDhcpNetworkConfig)

	if err != nil {
		return err
	}

	*o = ClusterDhcpNetworkConfig(varClusterDhcpNetworkConfig)
