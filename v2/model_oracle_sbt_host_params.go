...
// checks if the OracleSbtHostParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleSbtHostParams{}
...
func (o *OracleSbtHostParams) GetSbtLibraryPath() string {
	if o == nil || IsNil(o.SbtLibraryPath.Get()) {
		var ret string
		return ret
	}
...
func (o *OracleSbtHostParams) GetViewFsPath() string {
	if o == nil || IsNil(o.ViewFsPath.Get()) {
		var ret string
		return ret
	}
...
func (o OracleSbtHostParams) ToMap() (map[string]interface{}, error) {
