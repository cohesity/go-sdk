...
// checks if the MountedVolumeMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MountedVolumeMapping{}
...
func (o *MountedVolumeMapping) GetMountedVolume() string {
	if o == nil || IsNil(o.MountedVolume.Get()) {
		var ret string
		return ret
	}
...
func (o *MountedVolumeMapping) GetOriginalVolume() string {
	if o == nil || IsNil(o.OriginalVolume.Get()) {
		var ret string
		return ret
	}
...
func (o MountedVolumeMapping) ToMap() (map[string]interface{}, error) {
