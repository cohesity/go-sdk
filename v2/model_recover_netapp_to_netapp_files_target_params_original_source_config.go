...
// checks if the RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig{}

// RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig Specifies the Source configuration if files are being recovered to original Source. If not specified, all the configuration parameters will be retained.
type RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig struct {
...
type _RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig
...
func NewRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig(recoverToOriginalPath NullableBool) *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig {
	this := RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig{}
...
func (o *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) SetAlternatePathNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig := _RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig(varRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig)

	return err
}

type NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig struct {
	value *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig
	isSet bool
}

func (v NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) Get() *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig {
	return v.value
}

func (v *NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) Set(val *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig(val *RecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) *NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig {
	return &NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverNetappToNetappFilesTargetParamsOriginalSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
