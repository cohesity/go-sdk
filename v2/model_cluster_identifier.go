...
// checks if the ClusterIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterIdentifier{}
...
func (o ClusterIdentifier) ToMap() (map[string]interface{}, error) {
