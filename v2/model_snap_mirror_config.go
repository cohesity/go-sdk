...
// checks if the SnapMirrorConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapMirrorConfig{}
...
func (o *SnapMirrorConfig) GetIncrementalPrefix() string {
	if o == nil || IsNil(o.IncrementalPrefix.Get()) {
		var ret string
		return ret
	}
...
func (o SnapMirrorConfig) ToMap() (map[string]interface{}, error) {
