...
// checks if the PauseActionObjectLevelResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PauseActionObjectLevelResponse{}
...
func (o PauseActionObjectLevelResponse) ToMap() (map[string]interface{}, error) {
