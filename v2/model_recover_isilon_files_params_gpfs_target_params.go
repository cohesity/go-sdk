...
// checks if the RecoverIsilonFilesParamsGpfsTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverIsilonFilesParamsGpfsTargetParams{}

// RecoverIsilonFilesParamsGpfsTargetParams Specifies the params for a GPFS recovery target.
type RecoverIsilonFilesParamsGpfsTargetParams struct {
...
type _RecoverIsilonFilesParamsGpfsTargetParams RecoverIsilonFilesParamsGpfsTargetParams
...
func NewRecoverIsilonFilesParamsGpfsTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverIsilonFilesParamsGpfsTargetParams {
	this := RecoverIsilonFilesParamsGpfsTargetParams{}
...
func (o *RecoverIsilonFilesParamsGpfsTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverIsilonFilesParamsGpfsTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverIsilonFilesParamsGpfsTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverIsilonFilesParamsGpfsTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverIsilonFilesParamsGpfsTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverIsilonFilesParamsGpfsTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverIsilonFilesParamsGpfsTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverIsilonFilesParamsGpfsTargetParams := _RecoverIsilonFilesParamsGpfsTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverIsilonFilesParamsGpfsTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverIsilonFilesParamsGpfsTargetParams(varRecoverIsilonFilesParamsGpfsTargetParams)

	return err
}

type NullableRecoverIsilonFilesParamsGpfsTargetParams struct {
	value *RecoverIsilonFilesParamsGpfsTargetParams
	isSet bool
}

func (v NullableRecoverIsilonFilesParamsGpfsTargetParams) Get() *RecoverIsilonFilesParamsGpfsTargetParams {
	return v.value
}

func (v *NullableRecoverIsilonFilesParamsGpfsTargetParams) Set(val *RecoverIsilonFilesParamsGpfsTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverIsilonFilesParamsGpfsTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverIsilonFilesParamsGpfsTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverIsilonFilesParamsGpfsTargetParams(val *RecoverIsilonFilesParamsGpfsTargetParams) *NullableRecoverIsilonFilesParamsGpfsTargetParams {
	return &NullableRecoverIsilonFilesParamsGpfsTargetParams{value: val, isSet: true}
}

func (v NullableRecoverIsilonFilesParamsGpfsTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverIsilonFilesParamsGpfsTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
