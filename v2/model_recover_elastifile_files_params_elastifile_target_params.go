...
// checks if the RecoverElastifileFilesParamsElastifileTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverElastifileFilesParamsElastifileTargetParams{}

// RecoverElastifileFilesParamsElastifileTargetParams Specifies the params for a Elastifile recovery target.
type RecoverElastifileFilesParamsElastifileTargetParams struct {
...
type _RecoverElastifileFilesParamsElastifileTargetParams RecoverElastifileFilesParamsElastifileTargetParams
...
func NewRecoverElastifileFilesParamsElastifileTargetParams(recoverToNewSource bool) *RecoverElastifileFilesParamsElastifileTargetParams {
	this := RecoverElastifileFilesParamsElastifileTargetParams{}
...
func (o *RecoverElastifileFilesParamsElastifileTargetParams) SetNewSourceConfigNil() {
...
func (o *RecoverElastifileFilesParamsElastifileTargetParams) SetOriginalSourceConfigNil() {
...
func (o RecoverElastifileFilesParamsElastifileTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverElastifileFilesParamsElastifileTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverElastifileFilesParamsElastifileTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverElastifileFilesParamsElastifileTargetParams := _RecoverElastifileFilesParamsElastifileTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverElastifileFilesParamsElastifileTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverElastifileFilesParamsElastifileTargetParams(varRecoverElastifileFilesParamsElastifileTargetParams)

	return err
}

type NullableRecoverElastifileFilesParamsElastifileTargetParams struct {
	value *RecoverElastifileFilesParamsElastifileTargetParams
	isSet bool
}

func (v NullableRecoverElastifileFilesParamsElastifileTargetParams) Get() *RecoverElastifileFilesParamsElastifileTargetParams {
	return v.value
}

func (v *NullableRecoverElastifileFilesParamsElastifileTargetParams) Set(val *RecoverElastifileFilesParamsElastifileTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverElastifileFilesParamsElastifileTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverElastifileFilesParamsElastifileTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverElastifileFilesParamsElastifileTargetParams(val *RecoverElastifileFilesParamsElastifileTargetParams) *NullableRecoverElastifileFilesParamsElastifileTargetParams {
	return &NullableRecoverElastifileFilesParamsElastifileTargetParams{value: val, isSet: true}
}

func (v NullableRecoverElastifileFilesParamsElastifileTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverElastifileFilesParamsElastifileTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
