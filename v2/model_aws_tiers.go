...
// checks if the AWSTiers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AWSTiers{}
...
func (o AWSTiers) ToMap() (map[string]interface{}, error) {
...
func (o *AWSTiers) UnmarshalJSON(data []byte) (err error) {
	...
	varAWSTiers := _AWSTiers{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAWSTiers)

	if err != nil {
		return err
	}

	*o = AWSTiers(varAWSTiers)
