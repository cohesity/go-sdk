...
// checks if the GpfsObjectProtectionUpdateRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GpfsObjectProtectionUpdateRequestParams{}
...
func (o GpfsObjectProtectionUpdateRequestParams) ToMap() (map[string]interface{}, error) {
