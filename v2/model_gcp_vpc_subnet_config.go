...
// checks if the GcpVpcSubnetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GcpVpcSubnetConfig{}
...
type _GcpVpcSubnetConfig GcpVpcSubnetConfig
...
func (o GcpVpcSubnetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *GcpVpcSubnetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varGcpVpcSubnetConfig := _GcpVpcSubnetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGcpVpcSubnetConfig)

	if err != nil {
		return err
	}

	*o = GcpVpcSubnetConfig(varGcpVpcSubnetConfig)
