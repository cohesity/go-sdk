...
// checks if the FailoverReplicaCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailoverReplicaCluster{}
...
type _FailoverReplicaCluster FailoverReplicaCluster
...
func (o FailoverReplicaCluster) ToMap() (map[string]interface{}, error) {
...
func (o *FailoverReplicaCluster) UnmarshalJSON(data []byte) (err error) {
	...
	varFailoverReplicaCluster := _FailoverReplicaCluster{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFailoverReplicaCluster)

	if err != nil {
		return err
	}

	*o = FailoverReplicaCluster(varFailoverReplicaCluster)
