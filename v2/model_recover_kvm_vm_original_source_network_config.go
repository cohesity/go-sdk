...
// checks if the RecoverKvmVmOriginalSourceNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverKvmVmOriginalSourceNetworkConfig{}
...
func (o RecoverKvmVmOriginalSourceNetworkConfig) ToMap() (map[string]interface{}, error) {
