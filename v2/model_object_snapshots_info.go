...
// checks if the ObjectSnapshotsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectSnapshotsInfo{}
...
type ObjectSnapshotsInfo struct {
	...
	LocalSnapshotInfo NullableObjectSnapshotsInfoLocalSnapshotInfo `json:"localSnapshotInfo,omitempty"`
...
func (o *ObjectSnapshotsInfo) GetArchivalSnapshotsInfoOk() ([]ObjectArchivalSnapshotInfo, bool) {
	if o == nil || IsNil(o.ArchivalSnapshotsInfo) {
		return nil, false
	}
...
func (o *ObjectSnapshotsInfo) GetLocalSnapshotInfo() ObjectSnapshotsInfoLocalSnapshotInfo {
	if o == nil || IsNil(o.LocalSnapshotInfo.Get()) {
		var ret ObjectSnapshotsInfoLocalSnapshotInfo
		return ret
	}
...
// SetLocalSnapshotInfo gets a reference to the given NullableObjectSnapshotsInfoLocalSnapshotInfo and assigns it to the LocalSnapshotInfo field.
...
func (o *ObjectSnapshotsInfo) GetProtectionRunEndTimeUsecs() int64 {
	if o == nil || IsNil(o.ProtectionRunEndTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o *ObjectSnapshotsInfo) GetProtectionRunId() string {
	if o == nil || IsNil(o.ProtectionRunId.Get()) {
		var ret string
		return ret
	}
...
func (o *ObjectSnapshotsInfo) GetProtectionRunStartTimeUsecs() int64 {
	if o == nil || IsNil(o.ProtectionRunStartTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o ObjectSnapshotsInfo) ToMap() (map[string]interface{}, error) {
