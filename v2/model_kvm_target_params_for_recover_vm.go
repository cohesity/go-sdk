...
// checks if the KvmTargetParamsForRecoverVm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KvmTargetParamsForRecoverVm{}
...
func (o KvmTargetParamsForRecoverVm) ToMap() (map[string]interface{}, error) {
