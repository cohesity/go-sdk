...
// checks if the LockRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LockRange{}
...
func (o LockRange) ToMap() (map[string]interface{}, error) {
