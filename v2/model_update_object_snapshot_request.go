...
// checks if the UpdateObjectSnapshotRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateObjectSnapshotRequest{}
...
type UpdateObjectSnapshotRequest struct {
	...
	ExpiryTimeSecs NullableInt64 `json:"expiryTimeSecs,omitempty"`
...
func (o *UpdateObjectSnapshotRequest) GetDataLockType() string {
	if o == nil || IsNil(o.DataLockType.Get()) {
		var ret string
		return ret
	}
...
func (o *UpdateObjectSnapshotRequest) GetExpiryTimeSecs() int64 {
	if o == nil || IsNil(o.ExpiryTimeSecs.Get()) {
		var ret int64
		return ret
	}
...
// SetExpiryTimeSecs gets a reference to the given NullableInt64 and assigns it to the ExpiryTimeSecs field.
...
func (o *UpdateObjectSnapshotRequest) GetSetLegalHold() bool {
	if o == nil || IsNil(o.SetLegalHold.Get()) {
		var ret bool
		return ret
	}
...
func (o UpdateObjectSnapshotRequest) ToMap() (map[string]interface{}, error) {
