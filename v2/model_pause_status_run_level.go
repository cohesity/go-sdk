...
// checks if the PauseStatusRunLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PauseStatusRunLevel{}
...
func (o *PauseStatusRunLevel) GetPauseStatusRunLevel() string {
	if o == nil || IsNil(o.PauseStatusRunLevel) {
		var ret string
		return ret
	}
...
func (o PauseStatusRunLevel) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PauseStatusRunLevel) {
