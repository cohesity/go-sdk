...
// checks if the ProgressSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgressSummary{}
...
func (o ProgressSummary) ToMap() (map[string]interface{}, error) {
