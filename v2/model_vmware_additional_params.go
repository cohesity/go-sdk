...
// checks if the VmwareAdditionalParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareAdditionalParams{}
...
func (o VmwareAdditionalParams) ToMap() (map[string]interface{}, error) {
