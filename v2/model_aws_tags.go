...
// checks if the AWSTags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AWSTags{}
...
func (o AWSTags) ToMap() (map[string]interface{}, error) {
