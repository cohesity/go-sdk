...
// checks if the HDFSOnPremSearchParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HDFSOnPremSearchParams{}
...
type _HDFSOnPremSearchParams HDFSOnPremSearchParams
...
func (o HDFSOnPremSearchParams) ToMap() (map[string]interface{}, error) {
...
func (o *HDFSOnPremSearchParams) UnmarshalJSON(data []byte) (err error) {
	...
	varHDFSOnPremSearchParams := _HDFSOnPremSearchParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHDFSOnPremSearchParams)

	if err != nil {
		return err
	}

	*o = HDFSOnPremSearchParams(varHDFSOnPremSearchParams)
