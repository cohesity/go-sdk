...
// checks if the AwsAuroraProtectionGroupObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsAuroraProtectionGroupObjectParams{}
...
type _AwsAuroraProtectionGroupObjectParams AwsAuroraProtectionGroupObjectParams
...
func (o AwsAuroraProtectionGroupObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *AwsAuroraProtectionGroupObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsAuroraProtectionGroupObjectParams := _AwsAuroraProtectionGroupObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsAuroraProtectionGroupObjectParams)

	if err != nil {
		return err
	}

	*o = AwsAuroraProtectionGroupObjectParams(varAwsAuroraProtectionGroupObjectParams)
