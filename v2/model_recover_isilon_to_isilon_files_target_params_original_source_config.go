...
// checks if the RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig{}

// RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig Specifies the Source configuration if files are being recovered to original Source. If not specified, all the configuration parameters will be retained.
type RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig struct {
...
type _RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig
...
func NewRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig(recoverToOriginalPath NullableBool) *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig {
	this := RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig{}
...
func (o *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) SetAlternatePathNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig := _RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig(varRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig)

	return err
}

type NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig struct {
	value *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig
	isSet bool
}

func (v NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) Get() *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig {
	return v.value
}

func (v *NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) Set(val *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig(val *RecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) *NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig {
	return &NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverIsilonToIsilonFilesTargetParamsOriginalSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
