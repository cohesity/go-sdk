...
// checks if the OracleRangeMetaInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRangeMetaInfo{}
...
type OracleRangeMetaInfo struct {
	...
	ThreadId NullableInt64 `json:"threadId,omitempty"`
}
...
func (o *OracleRangeMetaInfo) GetEndOfRange() int64 {
	if o == nil || IsNil(o.EndOfRange.Get()) {
		var ret int64
		return ret
	}
...
func (o *OracleRangeMetaInfo) GetResetLogId() int64 {
	if o == nil || IsNil(o.ResetLogId.Get()) {
		var ret int64
		return ret
	}
...
func (o *OracleRangeMetaInfo) GetStartOfRange() int64 {
	if o == nil || IsNil(o.StartOfRange.Get()) {
		var ret int64
		return ret
	}
...
func (o *OracleRangeMetaInfo) SetThreadIdNil() {
	o.ThreadId.Set(nil)
}
...
func (o OracleRangeMetaInfo) ToMap() (map[string]interface{}, error) {
