...
// checks if the UpdateReplicationSnapshotConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateReplicationSnapshotConfig{}
...
func (o UpdateReplicationSnapshotConfig) ToMap() (map[string]interface{}, error) {
