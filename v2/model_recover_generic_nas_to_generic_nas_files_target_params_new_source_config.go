...
// checks if the RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig{}

// RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig Specifies the new destination Source configuration parameters where the files will be recovered. This is mandatory if recoverToNewSource is set to true.
type RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig struct {
...
type _RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig
...
func NewRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig {
	this := RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig{}
...
func (o *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig := _RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig(varRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig)

	return err
}

type NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig struct {
	value *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig
	isSet bool
}

func (v NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) Get() *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig {
	return v.value
}

func (v *NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) Set(val *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig(val *RecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) *NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig {
	return &NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverGenericNasToGenericNasFilesTargetParamsNewSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
