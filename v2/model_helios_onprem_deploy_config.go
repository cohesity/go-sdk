...
// checks if the HeliosOnpremDeployConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosOnpremDeployConfig{}

// HeliosOnpremDeployConfig Specifies settings for copying Snapshots to Cloud. This also specifies the retention policy that should be applied to Snapshots after they have been copied to Cloud.
...
func (o *HeliosOnpremDeployConfig) SetConfigIdNil() {
	o.ConfigId.Set(nil)
}
...
func (o *HeliosOnpremDeployConfig) SetCopyOnRunSuccessNil() {
...
func (o HeliosOnpremDeployConfig) MarshalJSON() ([]byte, error) {
...
func (o HeliosOnpremDeployConfig) ToMap() (map[string]interface{}, error) {
...
type NullableHeliosOnpremDeployConfig struct {
	value *HeliosOnpremDeployConfig
	isSet bool
}

func (v NullableHeliosOnpremDeployConfig) Get() *HeliosOnpremDeployConfig {
	return v.value
}

func (v *NullableHeliosOnpremDeployConfig) Set(val *HeliosOnpremDeployConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableHeliosOnpremDeployConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableHeliosOnpremDeployConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeliosOnpremDeployConfig(val *HeliosOnpremDeployConfig) *NullableHeliosOnpremDeployConfig {
	return &NullableHeliosOnpremDeployConfig{value: val, isSet: true}
}

func (v NullableHeliosOnpremDeployConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeliosOnpremDeployConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
