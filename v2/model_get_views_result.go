...
// checks if the GetViewsResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetViewsResult{}
...
func (o GetViewsResult) ToMap() (map[string]interface{}, error) {
