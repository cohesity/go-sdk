...
// checks if the CreateStorageDomainParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateStorageDomainParam{}
...
type _CreateStorageDomainParam CreateStorageDomainParam
...
func (o *CreateStorageDomainParam) SetLastKeyRotationTimestampMsecsNil() {
...
func (o *CreateStorageDomainParam) SetRemovalStateNil() {
...
func (o CreateStorageDomainParam) ToMap() (map[string]interface{}, error) {
...
func (o *CreateStorageDomainParam) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateStorageDomainParam := _CreateStorageDomainParam{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateStorageDomainParam)

	if err != nil {
		return err
	}

	*o = CreateStorageDomainParam(varCreateStorageDomainParam)
