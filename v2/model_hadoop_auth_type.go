...
// checks if the HadoopAuthType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HadoopAuthType{}
...
func (o *HadoopAuthType) GetHadoopAuthType() string {
	if o == nil || IsNil(o.HadoopAuthType) {
		var ret string
		return ret
	}
...
func (o HadoopAuthType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.HadoopAuthType) {
