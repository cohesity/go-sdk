...
// checks if the ObjectWithChildren type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectWithChildren{}
...
func (o ObjectWithChildren) ToMap() (map[string]interface{}, error) {
