...
// checks if the VmwareStandbyObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareStandbyObject{}
...
func (o *VmwareStandbyObject) GetCdpStandbyStatus() string {
	if o == nil || IsNil(o.CdpStandbyStatus.Get()) {
		var ret string
		return ret
	}
...
func (o *VmwareStandbyObject) GetStandbyTime() int64 {
	if o == nil || IsNil(o.StandbyTime.Get()) {
		var ret int64
		return ret
	}
...
func (o VmwareStandbyObject) ToMap() (map[string]interface{}, error) {
