...
// checks if the ClusterAMQPTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterAMQPTargetConfig{}
...
func (o *ClusterAMQPTargetConfig) GetVirtualHost() string {
	if o == nil || IsNil(o.VirtualHost.Get()) {
		var ret string
		return ret
	}
...
func (o ClusterAMQPTargetConfig) ToMap() (map[string]interface{}, error) {
