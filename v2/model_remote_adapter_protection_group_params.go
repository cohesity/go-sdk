...
// checks if the RemoteAdapterProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteAdapterProtectionGroupParams{}
...
type _RemoteAdapterProtectionGroupParams RemoteAdapterProtectionGroupParams
...
func (o *RemoteAdapterProtectionGroupParams) GetRemoteViewParams() RemoteAdapterProtectionGroupReplicationParams {
	if o == nil || IsNil(o.RemoteViewParams) {
...
func (o RemoteAdapterProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteAdapterProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteAdapterProtectionGroupParams := _RemoteAdapterProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRemoteAdapterProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = RemoteAdapterProtectionGroupParams(varRemoteAdapterProtectionGroupParams)
