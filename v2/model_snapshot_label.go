...
// checks if the SnapshotLabel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnapshotLabel{}
...
func (o *SnapshotLabel) GetFullLabel() string {
	if o == nil || IsNil(o.FullLabel.Get()) {
		var ret string
		return ret
	}
...
func (o *SnapshotLabel) GetIncrementalLabel() string {
	if o == nil || IsNil(o.IncrementalLabel.Get()) {
		var ret string
		return ret
	}
...
func (o SnapshotLabel) ToMap() (map[string]interface{}, error) {
