...
// checks if the PatchDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchDetail{}
...
func (o *PatchDetail) GetImportVersion() string {
	if o == nil || IsNil(o.ImportVersion.Get()) {
		var ret string
		return ret
	}
...
func (o PatchDetail) ToMap() (map[string]interface{}, error) {
