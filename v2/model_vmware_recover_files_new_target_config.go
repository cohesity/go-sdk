...
// checks if the VmwareRecoverFilesNewTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareRecoverFilesNewTargetConfig{}
...
type _VmwareRecoverFilesNewTargetConfig VmwareRecoverFilesNewTargetConfig
...
func (o VmwareRecoverFilesNewTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *VmwareRecoverFilesNewTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varVmwareRecoverFilesNewTargetConfig := _VmwareRecoverFilesNewTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVmwareRecoverFilesNewTargetConfig)

	if err != nil {
		return err
	}

	*o = VmwareRecoverFilesNewTargetConfig(varVmwareRecoverFilesNewTargetConfig)
