...
// checks if the ListTrustedCasResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTrustedCasResult{}
...
func (o ListTrustedCasResult) ToMap() (map[string]interface{}, error) {
