...
// checks if the LogicalVolumeInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogicalVolumeInfo{}
...
func (o LogicalVolumeInfo) ToMap() (map[string]interface{}, error) {
