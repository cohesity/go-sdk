...
// checks if the GetObjectSnapshotsResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetObjectSnapshotsResponseBody{}
...
func (o GetObjectSnapshotsResponseBody) ToMap() (map[string]interface{}, error) {
