...
// checks if the AwsSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSnapshotParams{}
...
func (o AwsSnapshotParams) ToMap() (map[string]interface{}, error) {
