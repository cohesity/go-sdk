...
// checks if the DataTieringObjectInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataTieringObjectInfo{}
...
type _DataTieringObjectInfo DataTieringObjectInfo
...
func (o DataTieringObjectInfo) ToMap() (map[string]interface{}, error) {
...
func (o *DataTieringObjectInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varDataTieringObjectInfo := _DataTieringObjectInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDataTieringObjectInfo)

	if err != nil {
		return err
	}

	*o = DataTieringObjectInfo(varDataTieringObjectInfo)
