...
// checks if the RecoverVmwareVAppParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverVmwareVAppParams{}
...
type _RecoverVmwareVAppParams RecoverVmwareVAppParams
...
func (o RecoverVmwareVAppParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverVmwareVAppParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverVmwareVAppParams := _RecoverVmwareVAppParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverVmwareVAppParams)

	if err != nil {
		return err
	}

	*o = RecoverVmwareVAppParams(varRecoverVmwareVAppParams)
