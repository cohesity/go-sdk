...
// checks if the RecoverOracleAppNewSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverOracleAppNewSourceConfig{}
...
type _RecoverOracleAppNewSourceConfig RecoverOracleAppNewSourceConfig
...
func (o RecoverOracleAppNewSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverOracleAppNewSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverOracleAppNewSourceConfig := _RecoverOracleAppNewSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverOracleAppNewSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverOracleAppNewSourceConfig(varRecoverOracleAppNewSourceConfig)
