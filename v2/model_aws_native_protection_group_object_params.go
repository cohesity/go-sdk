...
// checks if the AwsNativeProtectionGroupObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsNativeProtectionGroupObjectParams{}

// AwsNativeProtectionGroupObjectParams Specifies the object parameters to create AWS Native Protection Group.
type AwsNativeProtectionGroupObjectParams struct {
...
type _AwsNativeProtectionGroupObjectParams AwsNativeProtectionGroupObjectParams
...
func NewAwsNativeProtectionGroupObjectParams(id NullableInt64) *AwsNativeProtectionGroupObjectParams {
	this := AwsNativeProtectionGroupObjectParams{}
	this.Id = id
	return &this
}
...
func (o *AwsNativeProtectionGroupObjectParams) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *AwsNativeProtectionGroupObjectParams) SetVolumeExclusionParamsNil() {
...
func (o AwsNativeProtectionGroupObjectParams) MarshalJSON() ([]byte, error) {
...
func (o AwsNativeProtectionGroupObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *AwsNativeProtectionGroupObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsNativeProtectionGroupObjectParams := _AwsNativeProtectionGroupObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsNativeProtectionGroupObjectParams)

	if err != nil {
		return err
	}

	*o = AwsNativeProtectionGroupObjectParams(varAwsNativeProtectionGroupObjectParams)

	return err
}

type NullableAwsNativeProtectionGroupObjectParams struct {
	value *AwsNativeProtectionGroupObjectParams
	isSet bool
}

func (v NullableAwsNativeProtectionGroupObjectParams) Get() *AwsNativeProtectionGroupObjectParams {
	return v.value
}

func (v *NullableAwsNativeProtectionGroupObjectParams) Set(val *AwsNativeProtectionGroupObjectParams) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsNativeProtectionGroupObjectParams) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsNativeProtectionGroupObjectParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsNativeProtectionGroupObjectParams(val *AwsNativeProtectionGroupObjectParams) *NullableAwsNativeProtectionGroupObjectParams {
	return &NullableAwsNativeProtectionGroupObjectParams{value: val, isSet: true}
}

func (v NullableAwsNativeProtectionGroupObjectParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsNativeProtectionGroupObjectParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
