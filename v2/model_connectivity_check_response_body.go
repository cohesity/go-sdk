...
// checks if the ConnectivityCheckResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectivityCheckResponseBody{}
...
func (o ConnectivityCheckResponseBody) ToMap() (map[string]interface{}, error) {
