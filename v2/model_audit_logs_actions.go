...
// checks if the AuditLogsActions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditLogsActions{}
...
func (o AuditLogsActions) ToMap() (map[string]interface{}, error) {
