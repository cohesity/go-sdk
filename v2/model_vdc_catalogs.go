...
// checks if the VdcCatalogs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VdcCatalogs{}
...
func (o VdcCatalogs) ToMap() (map[string]interface{}, error) {
