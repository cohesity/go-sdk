...
// checks if the RecoverAcropolisVmNewSourceNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverAcropolisVmNewSourceNetworkConfig{}
...
func (o RecoverAcropolisVmNewSourceNetworkConfig) ToMap() (map[string]interface{}, error) {
