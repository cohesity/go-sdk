...
// checks if the CommonPrePostScriptParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonPrePostScriptParams{}
...
type _CommonPrePostScriptParams CommonPrePostScriptParams
...
func (o CommonPrePostScriptParams) ToMap() (map[string]interface{}, error) {
...
func (o *CommonPrePostScriptParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonPrePostScriptParams := _CommonPrePostScriptParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonPrePostScriptParams)

	if err != nil {
		return err
	}

	*o = CommonPrePostScriptParams(varCommonPrePostScriptParams)
