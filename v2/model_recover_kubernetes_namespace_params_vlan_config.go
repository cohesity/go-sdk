...
// checks if the RecoverKubernetesNamespaceParamsVlanConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverKubernetesNamespaceParamsVlanConfig{}
...
func NewRecoverKubernetesNamespaceParamsVlanConfig() *RecoverKubernetesNamespaceParamsVlanConfig {
	this := RecoverKubernetesNamespaceParamsVlanConfig{}
	return &this
}
...
func (o *RecoverKubernetesNamespaceParamsVlanConfig) SetDisableVlanNil() {
...
func (o *RecoverKubernetesNamespaceParamsVlanConfig) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *RecoverKubernetesNamespaceParamsVlanConfig) SetInterfaceNameNil() {
...
func (o RecoverKubernetesNamespaceParamsVlanConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverKubernetesNamespaceParamsVlanConfig) ToMap() (map[string]interface{}, error) {
...
type NullableRecoverKubernetesNamespaceParamsVlanConfig struct {
	value *RecoverKubernetesNamespaceParamsVlanConfig
	isSet bool
}

func (v NullableRecoverKubernetesNamespaceParamsVlanConfig) Get() *RecoverKubernetesNamespaceParamsVlanConfig {
	return v.value
}

func (v *NullableRecoverKubernetesNamespaceParamsVlanConfig) Set(val *RecoverKubernetesNamespaceParamsVlanConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverKubernetesNamespaceParamsVlanConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverKubernetesNamespaceParamsVlanConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverKubernetesNamespaceParamsVlanConfig(val *RecoverKubernetesNamespaceParamsVlanConfig) *NullableRecoverKubernetesNamespaceParamsVlanConfig {
	return &NullableRecoverKubernetesNamespaceParamsVlanConfig{value: val, isSet: true}
}

func (v NullableRecoverKubernetesNamespaceParamsVlanConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverKubernetesNamespaceParamsVlanConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
