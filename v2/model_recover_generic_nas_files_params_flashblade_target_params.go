...
// checks if the RecoverGenericNasFilesParamsFlashbladeTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGenericNasFilesParamsFlashbladeTargetParams{}

// RecoverGenericNasFilesParamsFlashbladeTargetParams Specifies the params for a Flashblade recovery target.
type RecoverGenericNasFilesParamsFlashbladeTargetParams struct {
...
type _RecoverGenericNasFilesParamsFlashbladeTargetParams RecoverGenericNasFilesParamsFlashbladeTargetParams
...
func NewRecoverGenericNasFilesParamsFlashbladeTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverGenericNasFilesParamsFlashbladeTargetParams {
	this := RecoverGenericNasFilesParamsFlashbladeTargetParams{}
...
func (o *RecoverGenericNasFilesParamsFlashbladeTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverGenericNasFilesParamsFlashbladeTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverGenericNasFilesParamsFlashbladeTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverGenericNasFilesParamsFlashbladeTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverGenericNasFilesParamsFlashbladeTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverGenericNasFilesParamsFlashbladeTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverGenericNasFilesParamsFlashbladeTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverGenericNasFilesParamsFlashbladeTargetParams := _RecoverGenericNasFilesParamsFlashbladeTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverGenericNasFilesParamsFlashbladeTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverGenericNasFilesParamsFlashbladeTargetParams(varRecoverGenericNasFilesParamsFlashbladeTargetParams)

	return err
}

type NullableRecoverGenericNasFilesParamsFlashbladeTargetParams struct {
	value *RecoverGenericNasFilesParamsFlashbladeTargetParams
	isSet bool
}

func (v NullableRecoverGenericNasFilesParamsFlashbladeTargetParams) Get() *RecoverGenericNasFilesParamsFlashbladeTargetParams {
	return v.value
}

func (v *NullableRecoverGenericNasFilesParamsFlashbladeTargetParams) Set(val *RecoverGenericNasFilesParamsFlashbladeTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverGenericNasFilesParamsFlashbladeTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverGenericNasFilesParamsFlashbladeTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverGenericNasFilesParamsFlashbladeTargetParams(val *RecoverGenericNasFilesParamsFlashbladeTargetParams) *NullableRecoverGenericNasFilesParamsFlashbladeTargetParams {
	return &NullableRecoverGenericNasFilesParamsFlashbladeTargetParams{value: val, isSet: true}
}

func (v NullableRecoverGenericNasFilesParamsFlashbladeTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverGenericNasFilesParamsFlashbladeTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
