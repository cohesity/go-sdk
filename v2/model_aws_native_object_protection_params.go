...
// checks if the AwsNativeObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsNativeObjectProtectionParams{}
...
func (o AwsNativeObjectProtectionParams) ToMap() (map[string]interface{}, error) {
