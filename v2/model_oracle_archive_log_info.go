...
// checks if the OracleArchiveLogInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleArchiveLogInfo{}
...
func (o OracleArchiveLogInfo) ToMap() (map[string]interface{}, error) {
