...
// checks if the CommonVmwareObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonVmwareObjectParams{}
...
func (o CommonVmwareObjectParams) ToMap() (map[string]interface{}, error) {
