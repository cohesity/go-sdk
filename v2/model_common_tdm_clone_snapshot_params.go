...
// checks if the CommonTdmCloneSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonTdmCloneSnapshotParams{}
...
func (o CommonTdmCloneSnapshotParams) ToMap() (map[string]interface{}, error) {
