...
// checks if the OneDriveItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OneDriveItem{}
...
func (o OneDriveItem) ToMap() (map[string]interface{}, error) {
