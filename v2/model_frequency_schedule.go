...
// checks if the FrequencySchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrequencySchedule{}
...
type _FrequencySchedule FrequencySchedule
...
func (o FrequencySchedule) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["frequency"] = o.Frequency.Get()
	return toSerialize, nil
}

func (o *FrequencySchedule) UnmarshalJSON(data []byte) (err error) {
	...
	varFrequencySchedule := _FrequencySchedule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFrequencySchedule)

	if err != nil {
		return err
	}

	*o = FrequencySchedule(varFrequencySchedule)
