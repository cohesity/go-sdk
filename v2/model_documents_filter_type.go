...
// checks if the DocumentsFilterType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentsFilterType{}
...
func (o *DocumentsFilterType) GetDocumentsFilterType() string {
	if o == nil || IsNil(o.DocumentsFilterType) {
		var ret string
		return ret
	}
...
func (o DocumentsFilterType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DocumentsFilterType) {
