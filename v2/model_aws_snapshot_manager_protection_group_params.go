...
// checks if the AwsSnapshotManagerProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsSnapshotManagerProtectionGroupParams{}
...
func (o AwsSnapshotManagerProtectionGroupParams) ToMap() (map[string]interface{}, error) {
