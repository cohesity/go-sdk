...
// checks if the RecoverNetappToNetappFilesTargetParamsNewSourceConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappToNetappFilesTargetParamsNewSourceConfig{}

// RecoverNetappToNetappFilesTargetParamsNewSourceConfig Specifies the new destination Source configuration parameters where the files will be recovered. This is mandatory if recoverToNewSource is set to true.
type RecoverNetappToNetappFilesTargetParamsNewSourceConfig struct {
...
type _RecoverNetappToNetappFilesTargetParamsNewSourceConfig RecoverNetappToNetappFilesTargetParamsNewSourceConfig
...
func NewRecoverNetappToNetappFilesTargetParamsNewSourceConfig(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverNetappToNetappFilesTargetParamsNewSourceConfig {
	this := RecoverNetappToNetappFilesTargetParamsNewSourceConfig{}
...
func (o *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) SetContinueOnErrorNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) SetEncryptionEnabledNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) SetOverwriteExistingFileNil() {
...
func (o *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) SetPreserveFileAttributesNil() {
...
func (o RecoverNetappToNetappFilesTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverNetappToNetappFilesTargetParamsNewSourceConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappToNetappFilesTargetParamsNewSourceConfig := _RecoverNetappToNetappFilesTargetParamsNewSourceConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappToNetappFilesTargetParamsNewSourceConfig)

	if err != nil {
		return err
	}

	*o = RecoverNetappToNetappFilesTargetParamsNewSourceConfig(varRecoverNetappToNetappFilesTargetParamsNewSourceConfig)

	return err
}

type NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig struct {
	value *RecoverNetappToNetappFilesTargetParamsNewSourceConfig
	isSet bool
}

func (v NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig) Get() *RecoverNetappToNetappFilesTargetParamsNewSourceConfig {
	return v.value
}

func (v *NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig) Set(val *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig(val *RecoverNetappToNetappFilesTargetParamsNewSourceConfig) *NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig {
	return &NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig{value: val, isSet: true}
}

func (v NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverNetappToNetappFilesTargetParamsNewSourceConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
