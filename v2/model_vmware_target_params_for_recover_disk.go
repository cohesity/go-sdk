...
// checks if the VmwareTargetParamsForRecoverDisk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareTargetParamsForRecoverDisk{}
...
func (o VmwareTargetParamsForRecoverDisk) ToMap() (map[string]interface{}, error) {
