...
// checks if the AntivirusServiceGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AntivirusServiceGroups{}
...
func (o *AntivirusServiceGroups) GetAntivirusServiceGroupsOk() ([]AntivirusServiceGroup, bool) {
	if o == nil || IsNil(o.AntivirusServiceGroups) {
		return nil, false
	}
...
func (o AntivirusServiceGroups) ToMap() (map[string]interface{}, error) {
