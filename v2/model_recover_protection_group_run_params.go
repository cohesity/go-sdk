...
// checks if the RecoverProtectionGroupRunParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverProtectionGroupRunParams{}
...
type RecoverProtectionGroupRunParams struct {
	...
	ProtectionGroupRunId NullableString `json:"protectionGroupRunId" validate:"regexp=^\\\\d+:\\\\d+$"`
}

type _RecoverProtectionGroupRunParams RecoverProtectionGroupRunParams
...
func (o *RecoverProtectionGroupRunParams) GetArchivalTargetId() int64 {
	if o == nil || IsNil(o.ArchivalTargetId.Get()) {
		var ret int64
		return ret
	}
...
func (o RecoverProtectionGroupRunParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverProtectionGroupRunParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverProtectionGroupRunParams := _RecoverProtectionGroupRunParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverProtectionGroupRunParams)

	if err != nil {
		return err
	}

	*o = RecoverProtectionGroupRunParams(varRecoverProtectionGroupRunParams)
