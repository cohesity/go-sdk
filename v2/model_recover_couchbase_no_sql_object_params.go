...
// checks if the RecoverCouchbaseNoSqlObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverCouchbaseNoSqlObjectParams{}
...
type _RecoverCouchbaseNoSqlObjectParams RecoverCouchbaseNoSqlObjectParams
...
func (o RecoverCouchbaseNoSqlObjectParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverCouchbaseNoSqlObjectParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverCouchbaseNoSqlObjectParams := _RecoverCouchbaseNoSqlObjectParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverCouchbaseNoSqlObjectParams)

	if err != nil {
		return err
	}

	*o = RecoverCouchbaseNoSqlObjectParams(varRecoverCouchbaseNoSqlObjectParams)
