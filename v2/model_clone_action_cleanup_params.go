...
// checks if the CloneActionCleanupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloneActionCleanupParams{}
...
type _CloneActionCleanupParams CloneActionCleanupParams
...
func (o *CloneActionCleanupParams) GetCloudResourcesCleanupParams() CloneActionCleanupCloudResourcesCleanupParams {
	if o == nil || IsNil(o.CloudResourcesCleanupParams) {
...
func (o CloneActionCleanupParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cleanupType"] = o.CleanupType.Get()
	if !IsNil(o.CloudResourcesCleanupParams) {
...
func (o *CloneActionCleanupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCloneActionCleanupParams := _CloneActionCleanupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCloneActionCleanupParams)

	if err != nil {
		return err
	}

	*o = CloneActionCleanupParams(varCloneActionCleanupParams)
