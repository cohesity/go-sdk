...
// checks if the SearchFileRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchFileRequestParams{}
...
func (o *SearchFileRequestParams) GetSourceEnvironmentsOk() ([]string, bool) {
	if o == nil || IsNil(o.SourceEnvironments) {
		return nil, false
	}
...
func (o SearchFileRequestParams) ToMap() (map[string]interface{}, error) {
