...
// checks if the GoogleTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GoogleTier{}
...
func (o *GoogleTier) SetMoveAfterNil() {
	o.MoveAfter.Set(nil)
}
...
func (o *GoogleTier) SetMoveAfterUnitNil() {
...
func (o GoogleTier) MarshalJSON() ([]byte, error) {
...
func (o GoogleTier) ToMap() (map[string]interface{}, error) {
...
func (o *GoogleTier) UnmarshalJSON(data []byte) (err error) {
	...
	varGoogleTier := _GoogleTier{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGoogleTier)

	if err != nil {
		return err
	}

	*o = GoogleTier(varGoogleTier)

	return err
}

type NullableGoogleTier struct {
	value *GoogleTier
	isSet bool
}

func (v NullableGoogleTier) Get() *GoogleTier {
	return v.value
}

func (v *NullableGoogleTier) Set(val *GoogleTier) {
	v.value = val
	v.isSet = true
}

func (v NullableGoogleTier) IsSet() bool {
	return v.isSet
}

func (v *NullableGoogleTier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGoogleTier(val *GoogleTier) *NullableGoogleTier {
	return &NullableGoogleTier{value: val, isSet: true}
}

func (v NullableGoogleTier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGoogleTier) UnmarshalJSON(src []byte) error {
	v.isSet = true
