...
// checks if the RecoverAwsS3BucketParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverAwsS3BucketParams{}

// RecoverAwsS3BucketParams Specifies the parameters to recover AWS S3 Buckets.
...
type _RecoverAwsS3BucketParams RecoverAwsS3BucketParams
...
func (o *RecoverAwsS3BucketParams) SetAwsS3BucketRestoreFilterPolicyNil() {
...
func (o *RecoverAwsS3BucketParams) SetAwsTargetParamsNil() {
...
func (o RecoverAwsS3BucketParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverAwsS3BucketParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverAwsS3BucketParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverAwsS3BucketParams := _RecoverAwsS3BucketParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverAwsS3BucketParams)

	if err != nil {
		return err
	}

	*o = RecoverAwsS3BucketParams(varRecoverAwsS3BucketParams)

	return err
}

type NullableRecoverAwsS3BucketParams struct {
	value *RecoverAwsS3BucketParams
	isSet bool
}

func (v NullableRecoverAwsS3BucketParams) Get() *RecoverAwsS3BucketParams {
	return v.value
}

func (v *NullableRecoverAwsS3BucketParams) Set(val *RecoverAwsS3BucketParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverAwsS3BucketParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverAwsS3BucketParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverAwsS3BucketParams(val *RecoverAwsS3BucketParams) *NullableRecoverAwsS3BucketParams {
	return &NullableRecoverAwsS3BucketParams{value: val, isSet: true}
}

func (v NullableRecoverAwsS3BucketParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverAwsS3BucketParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
