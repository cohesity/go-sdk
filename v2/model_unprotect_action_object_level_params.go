...
// checks if the UnprotectActionObjectLevelParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnprotectActionObjectLevelParams{}
...
type _UnprotectActionObjectLevelParams UnprotectActionObjectLevelParams
...
func (o *UnprotectActionObjectLevelParams) GetDeleteAllSnapshots() bool {
	if o == nil || IsNil(o.DeleteAllSnapshots.Get()) {
		var ret bool
		return ret
	}
...
func (o *UnprotectActionObjectLevelParams) GetForceUnprotect() bool {
	if o == nil || IsNil(o.ForceUnprotect.Get()) {
		var ret bool
		return ret
	}
...
func (o UnprotectActionObjectLevelParams) ToMap() (map[string]interface{}, error) {
...
func (o *UnprotectActionObjectLevelParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUnprotectActionObjectLevelParams := _UnprotectActionObjectLevelParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUnprotectActionObjectLevelParams)

	if err != nil {
		return err
	}

	*o = UnprotectActionObjectLevelParams(varUnprotectActionObjectLevelParams)
