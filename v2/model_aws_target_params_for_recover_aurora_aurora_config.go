...
// checks if the AwsTargetParamsForRecoverAuroraAuroraConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsTargetParamsForRecoverAuroraAuroraConfig{}

// AwsTargetParamsForRecoverAuroraAuroraConfig Specifies the Aurora params.
type AwsTargetParamsForRecoverAuroraAuroraConfig struct {
...
type _AwsTargetParamsForRecoverAuroraAuroraConfig AwsTargetParamsForRecoverAuroraAuroraConfig
...
func NewAwsTargetParamsForRecoverAuroraAuroraConfig(dbInstanceId NullableString, dbPort NullableInt32, enableAutoMinorVersionUpgrade NullableBool, enableCopyTagsToSnapshots NullableBool, enableIamDbAuthentication NullableBool, isMultiAzDeployment NullableBool) *AwsTargetParamsForRecoverAuroraAuroraConfig {
	this := AwsTargetParamsForRecoverAuroraAuroraConfig{}
...
func (o *AwsTargetParamsForRecoverAuroraAuroraConfig) SetDbOptionGroupNil() {
...
func (o *AwsTargetParamsForRecoverAuroraAuroraConfig) SetDbParameterGroupNil() {
...
func (o *AwsTargetParamsForRecoverAuroraAuroraConfig) SetEnablePublicAccessibilityNil() {
...
func (o *AwsTargetParamsForRecoverAuroraAuroraConfig) SetPointInTimeUsecsNil() {
...
func (o AwsTargetParamsForRecoverAuroraAuroraConfig) MarshalJSON() ([]byte, error) {
...
func (o AwsTargetParamsForRecoverAuroraAuroraConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AwsTargetParamsForRecoverAuroraAuroraConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsTargetParamsForRecoverAuroraAuroraConfig := _AwsTargetParamsForRecoverAuroraAuroraConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsTargetParamsForRecoverAuroraAuroraConfig)

	if err != nil {
		return err
	}

	*o = AwsTargetParamsForRecoverAuroraAuroraConfig(varAwsTargetParamsForRecoverAuroraAuroraConfig)

	return err
}

type NullableAwsTargetParamsForRecoverAuroraAuroraConfig struct {
	value *AwsTargetParamsForRecoverAuroraAuroraConfig
	isSet bool
}

func (v NullableAwsTargetParamsForRecoverAuroraAuroraConfig) Get() *AwsTargetParamsForRecoverAuroraAuroraConfig {
	return v.value
}

func (v *NullableAwsTargetParamsForRecoverAuroraAuroraConfig) Set(val *AwsTargetParamsForRecoverAuroraAuroraConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsTargetParamsForRecoverAuroraAuroraConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsTargetParamsForRecoverAuroraAuroraConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsTargetParamsForRecoverAuroraAuroraConfig(val *AwsTargetParamsForRecoverAuroraAuroraConfig) *NullableAwsTargetParamsForRecoverAuroraAuroraConfig {
	return &NullableAwsTargetParamsForRecoverAuroraAuroraConfig{value: val, isSet: true}
}

func (v NullableAwsTargetParamsForRecoverAuroraAuroraConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsTargetParamsForRecoverAuroraAuroraConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
