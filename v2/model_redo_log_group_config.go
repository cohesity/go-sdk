...
// checks if the RedoLogGroupConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RedoLogGroupConfig{}
...
func (o *RedoLogGroupConfig) GetMemberPrefix() string {
	if o == nil || IsNil(o.MemberPrefix.Get()) {
		var ret string
		return ret
	}
...
func (o *RedoLogGroupConfig) GetNumGroups() int32 {
	if o == nil || IsNil(o.NumGroups.Get()) {
		var ret int32
		return ret
	}
...
func (o *RedoLogGroupConfig) GetSizeMBytes() int32 {
	if o == nil || IsNil(o.SizeMBytes.Get()) {
		var ret int32
		return ret
	}
...
func (o RedoLogGroupConfig) ToMap() (map[string]interface{}, error) {
