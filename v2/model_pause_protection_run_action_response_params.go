...
// checks if the PauseProtectionRunActionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PauseProtectionRunActionResponseParams{}
...
func (o PauseProtectionRunActionResponseParams) ToMap() (map[string]interface{}, error) {
