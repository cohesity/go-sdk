...
// checks if the RecoverElastifileFilesParamsGenericNasTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverElastifileFilesParamsGenericNasTargetParams{}

// RecoverElastifileFilesParamsGenericNasTargetParams Specifies the params for a generic NAS recovery target.
type RecoverElastifileFilesParamsGenericNasTargetParams struct {
...
type _RecoverElastifileFilesParamsGenericNasTargetParams RecoverElastifileFilesParamsGenericNasTargetParams
...
func NewRecoverElastifileFilesParamsGenericNasTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverElastifileFilesParamsGenericNasTargetParams {
	this := RecoverElastifileFilesParamsGenericNasTargetParams{}
...
func (o *RecoverElastifileFilesParamsGenericNasTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverElastifileFilesParamsGenericNasTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverElastifileFilesParamsGenericNasTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverElastifileFilesParamsGenericNasTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverElastifileFilesParamsGenericNasTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverElastifileFilesParamsGenericNasTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverElastifileFilesParamsGenericNasTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverElastifileFilesParamsGenericNasTargetParams := _RecoverElastifileFilesParamsGenericNasTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverElastifileFilesParamsGenericNasTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverElastifileFilesParamsGenericNasTargetParams(varRecoverElastifileFilesParamsGenericNasTargetParams)

	return err
}

type NullableRecoverElastifileFilesParamsGenericNasTargetParams struct {
	value *RecoverElastifileFilesParamsGenericNasTargetParams
	isSet bool
}

func (v NullableRecoverElastifileFilesParamsGenericNasTargetParams) Get() *RecoverElastifileFilesParamsGenericNasTargetParams {
	return v.value
}

func (v *NullableRecoverElastifileFilesParamsGenericNasTargetParams) Set(val *RecoverElastifileFilesParamsGenericNasTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverElastifileFilesParamsGenericNasTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverElastifileFilesParamsGenericNasTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverElastifileFilesParamsGenericNasTargetParams(val *RecoverElastifileFilesParamsGenericNasTargetParams) *NullableRecoverElastifileFilesParamsGenericNasTargetParams {
	return &NullableRecoverElastifileFilesParamsGenericNasTargetParams{value: val, isSet: true}
}

func (v NullableRecoverElastifileFilesParamsGenericNasTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverElastifileFilesParamsGenericNasTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
