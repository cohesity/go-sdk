...
// checks if the ClusterVlanParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterVlanParams{}
...
type ClusterVlanParams struct {
	...
	AppIpsInUse NullableBool `json:"appIpsInUse,omitempty"`
}

type _ClusterVlanParams ClusterVlanParams
...
func (o *ClusterVlanParams) SetAllTenantAccessNil() {
...
func (o *ClusterVlanParams) SetDescriptionNil() {
...
func (o *ClusterVlanParams) SetEcmpEnabledNil() {
...
func (o *ClusterVlanParams) SetFqdnNil() {
	o.Fqdn.Set(nil)
}
...
func (o *ClusterVlanParams) SetGatewayNil() {
	o.Gateway.Set(nil)
}
...
func (o *ClusterVlanParams) SetIpAddressesTypeNil() {
...
func (o *ClusterVlanParams) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o *ClusterVlanParams) SetSubnetNil() {
	o.Subnet.Set(nil)
}
...
func (o *ClusterVlanParams) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *ClusterVlanParams) SetVlanNameNil() {
	o.VlanName.Set(nil)
}
...
// GetAppIpsInUse returns the AppIpsInUse field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ClusterVlanParams) GetAppIpsInUse() bool {
	if o == nil || IsNil(o.AppIpsInUse.Get()) {
		var ret bool
		return ret
	}
	return *o.AppIpsInUse.Get()
}

// GetAppIpsInUseOk returns a tuple with the AppIpsInUse field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetAppIpsInUse gets a reference to the given NullableBool and assigns it to the AppIpsInUse field.
func (o *ClusterVlanParams) SetAppIpsInUse(v bool) {
	o.AppIpsInUse.Set(&v)
}
// SetAppIpsInUseNil sets the value for AppIpsInUse to be an explicit nil
func (o *ClusterVlanParams) SetAppIpsInUseNil() {
	o.AppIpsInUse.Set(nil)
}
...
func (o ClusterVlanParams) MarshalJSON() ([]byte, error) {
...
func (o ClusterVlanParams) ToMap() (map[string]interface{}, error) {
	...
	if o.AppIpsInUse.IsSet() {
		toSerialize["appIpsInUse"] = o.AppIpsInUse.Get()
	}
	return toSerialize, nil
}

func (o *ClusterVlanParams) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterVlanParams := _ClusterVlanParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClusterVlanParams)

	if err != nil {
		return err
	}

	*o = ClusterVlanParams(varClusterVlanParams)

	return err
}

type NullableClusterVlanParams struct {
	value *ClusterVlanParams
	isSet bool
}

func (v NullableClusterVlanParams) Get() *ClusterVlanParams {
	return v.value
}

func (v *NullableClusterVlanParams) Set(val *ClusterVlanParams) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterVlanParams) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterVlanParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterVlanParams(val *ClusterVlanParams) *NullableClusterVlanParams {
	return &NullableClusterVlanParams{value: val, isSet: true}
}

func (v NullableClusterVlanParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterVlanParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
