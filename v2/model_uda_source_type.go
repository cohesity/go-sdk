...
// checks if the UdaSourceType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UdaSourceType{}
...
func (o UdaSourceType) ToMap() (map[string]interface{}, error) {
