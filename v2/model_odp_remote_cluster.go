...
// checks if the OdpRemoteCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OdpRemoteCluster{}
...
type _OdpRemoteCluster OdpRemoteCluster
...
func (o *OdpRemoteCluster) SetAllEndpointsReachableNil() {
...
func (o *OdpRemoteCluster) SetClusterIdStaleNil() {
...
func (o *OdpRemoteCluster) SetCompressionEnabledNil() {
...
func (o *OdpRemoteCluster) SetInterfaceGroupNameNil() {
...
func (o *OdpRemoteCluster) SetKeyEncryptionKeyNil() {
...
func (o *OdpRemoteCluster) SetRemoteTenantIdNil() {
...
func (o *OdpRemoteCluster) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *OdpRemoteCluster) SetUseBifrostBrokerChannelNil() {
...
func (o *OdpRemoteCluster) SetUsedForReplicationNil() {
...
func (o OdpRemoteCluster) MarshalJSON() ([]byte, error) {
...
func (o OdpRemoteCluster) ToMap() (map[string]interface{}, error) {
...
func (o *OdpRemoteCluster) UnmarshalJSON(data []byte) (err error) {
	...
	varOdpRemoteCluster := _OdpRemoteCluster{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOdpRemoteCluster)

	if err != nil {
		return err
	}

	*o = OdpRemoteCluster(varOdpRemoteCluster)

	return err
}

type NullableOdpRemoteCluster struct {
	value *OdpRemoteCluster
	isSet bool
}

func (v NullableOdpRemoteCluster) Get() *OdpRemoteCluster {
	return v.value
}

func (v *NullableOdpRemoteCluster) Set(val *OdpRemoteCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableOdpRemoteCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableOdpRemoteCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOdpRemoteCluster(val *OdpRemoteCluster) *NullableOdpRemoteCluster {
	return &NullableOdpRemoteCluster{value: val, isSet: true}
}

func (v NullableOdpRemoteCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOdpRemoteCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
