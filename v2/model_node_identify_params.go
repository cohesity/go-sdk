...
// checks if the NodeIdentifyParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeIdentifyParams{}
...
type _NodeIdentifyParams NodeIdentifyParams
...
func (o NodeIdentifyParams) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["identify"] = o.Identify.Get()
	return toSerialize, nil
}

func (o *NodeIdentifyParams) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeIdentifyParams := _NodeIdentifyParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeIdentifyParams)

	if err != nil {
		return err
	}

	*o = NodeIdentifyParams(varNodeIdentifyParams)
