...
// checks if the Office365AppCredentials type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365AppCredentials{}

// Office365AppCredentials Specifies credentials of azure registered applications, used for office 365/Azure source registration.
...
func (o Office365AppCredentials) ToMap() (map[string]interface{}, error) {
