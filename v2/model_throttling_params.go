...
// checks if the ThrottlingParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThrottlingParams{}
...
func (o ThrottlingParams) ToMap() (map[string]interface{}, error) {
