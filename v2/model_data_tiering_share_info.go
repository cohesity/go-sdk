...
// checks if the DataTieringShareInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataTieringShareInfo{}
...
type _DataTieringShareInfo DataTieringShareInfo
...
func (o *DataTieringShareInfo) GetUptierPath() string {
	if o == nil || IsNil(o.UptierPath.Get()) {
		var ret string
		return ret
	}
...
func (o DataTieringShareInfo) ToMap() (map[string]interface{}, error) {
...
func (o *DataTieringShareInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varDataTieringShareInfo := _DataTieringShareInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDataTieringShareInfo)

	if err != nil {
		return err
	}

	*o = DataTieringShareInfo(varDataTieringShareInfo)
