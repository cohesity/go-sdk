...
// checks if the FilenamePatternToDirectory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilenamePatternToDirectory{}
...
func (o *FilenamePatternToDirectory) GetFilenamePattern() string {
	if o == nil || IsNil(o.FilenamePattern.Get()) {
		var ret string
		return ret
	}
...
func (o FilenamePatternToDirectory) ToMap() (map[string]interface{}, error) {
