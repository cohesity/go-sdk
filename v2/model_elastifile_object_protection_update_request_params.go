...
// checks if the ElastifileObjectProtectionUpdateRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ElastifileObjectProtectionUpdateRequestParams{}
...
func (o ElastifileObjectProtectionUpdateRequestParams) ToMap() (map[string]interface{}, error) {
