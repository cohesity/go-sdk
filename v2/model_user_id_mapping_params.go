...
// checks if the UserIdMappingParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserIdMappingParams{}
...
type _UserIdMappingParams UserIdMappingParams
...
func (o UserIdMappingParams) ToMap() (map[string]interface{}, error) {
...
func (o *UserIdMappingParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUserIdMappingParams := _UserIdMappingParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserIdMappingParams)

	if err != nil {
		return err
	}

	*o = UserIdMappingParams(varUserIdMappingParams)
