...
// checks if the Keystone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Keystone{}
...
func (o Keystone) ToMap() (map[string]interface{}, error) {
...
func (o *Keystone) UnmarshalJSON(data []byte) (err error) {
	...
	varKeystone := _Keystone{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKeystone)

	if err != nil {
		return err
	}

	*o = Keystone(varKeystone)
