...
// checks if the SourceRegistrations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceRegistrations{}
...
func (o SourceRegistrations) ToMap() (map[string]interface{}, error) {
