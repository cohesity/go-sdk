...
// checks if the SyslogAuditTag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogAuditTag{}
...
func (o *SyslogAuditTag) GetAlertAudit() string {
	if o == nil || IsNil(o.AlertAudit.Get()) {
		var ret string
		return ret
	}
...
func (o *SyslogAuditTag) GetClusterAudit() string {
	if o == nil || IsNil(o.ClusterAudit.Get()) {
		var ret string
		return ret
	}
...
func (o *SyslogAuditTag) GetDataProtectionEventsAudit() string {
	if o == nil || IsNil(o.DataProtectionEventsAudit.Get()) {
		var ret string
		return ret
	}
...
func (o *SyslogAuditTag) GetFilerAudit() string {
	if o == nil || IsNil(o.FilerAudit.Get()) {
		var ret string
		return ret
	}
...
func (o SyslogAuditTag) ToMap() (map[string]interface{}, error) {
