...
// checks if the SharepointObjectEntityParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SharepointObjectEntityParams{}
...
func (o *SharepointObjectEntityParams) GetSiteWebUrl() string {
	if o == nil || IsNil(o.SiteWebUrl.Get()) {
		var ret string
		return ret
	}
...
func (o SharepointObjectEntityParams) ToMap() (map[string]interface{}, error) {
