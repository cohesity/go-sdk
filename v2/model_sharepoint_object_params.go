...
// checks if the SharepointObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SharepointObjectParams{}
...
func (o SharepointObjectParams) ToMap() (map[string]interface{}, error) {
