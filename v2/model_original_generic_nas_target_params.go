...
// checks if the OriginalGenericNasTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OriginalGenericNasTargetParams{}
...
func (o OriginalGenericNasTargetParams) ToMap() (map[string]interface{}, error) {
