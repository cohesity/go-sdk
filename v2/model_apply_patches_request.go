...
// checks if the ApplyPatchesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplyPatchesRequest{}
...
func (o ApplyPatchesRequest) ToMap() (map[string]interface{}, error) {
