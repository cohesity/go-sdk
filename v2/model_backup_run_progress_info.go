...
// checks if the BackupRunProgressInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupRunProgressInfo{}
...
func (o BackupRunProgressInfo) ToMap() (map[string]interface{}, error) {
