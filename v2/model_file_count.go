...
// checks if the FileCount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileCount{}
...
func (o *FileCount) GetLowerSizeBytes() int64 {
	if o == nil || IsNil(o.LowerSizeBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o *FileCount) GetUpperSizeBytes() int64 {
	if o == nil || IsNil(o.UpperSizeBytes.Get()) {
		var ret int64
		return ret
	}
...
func (o FileCount) ToMap() (map[string]interface{}, error) {
