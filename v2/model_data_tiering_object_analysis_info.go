...
// checks if the DataTieringObjectAnalysisInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataTieringObjectAnalysisInfo{}
...
func (o DataTieringObjectAnalysisInfo) ToMap() (map[string]interface{}, error) {
