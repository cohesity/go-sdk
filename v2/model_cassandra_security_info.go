...
// checks if the CassandraSecurityInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CassandraSecurityInfo{}
...
func (o *CassandraSecurityInfo) GetCassandraAuthRequired() bool {
	if o == nil || IsNil(o.CassandraAuthRequired.Get()) {
		var ret bool
		return ret
	}
...
func (o *CassandraSecurityInfo) GetCassandraAuthType() string {
	if o == nil || IsNil(o.CassandraAuthType.Get()) {
		var ret string
		return ret
	}
...
func (o *CassandraSecurityInfo) GetCassandraAuthorizer() string {
	if o == nil || IsNil(o.CassandraAuthorizer.Get()) {
		var ret string
		return ret
	}
...
func (o *CassandraSecurityInfo) GetClientEncryption() bool {
	if o == nil || IsNil(o.ClientEncryption.Get()) {
		var ret bool
		return ret
	}
...
func (o *CassandraSecurityInfo) GetDseAuthorization() bool {
	if o == nil || IsNil(o.DseAuthorization.Get()) {
		var ret bool
		return ret
	}
...
func (o *CassandraSecurityInfo) GetServerEncryptionReqClientAuth() bool {
	if o == nil || IsNil(o.ServerEncryptionReqClientAuth.Get()) {
		var ret bool
		return ret
	}
...
func (o *CassandraSecurityInfo) GetServerInternodeEncryptionType() string {
	if o == nil || IsNil(o.ServerInternodeEncryptionType.Get()) {
		var ret string
		return ret
	}
...
func (o CassandraSecurityInfo) ToMap() (map[string]interface{}, error) {
