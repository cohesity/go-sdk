...
// checks if the CommonTieringPolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonTieringPolicy{}
...
func (o CommonTieringPolicy) ToMap() (map[string]interface{}, error) {
