...
// checks if the RecoveryTaskInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoveryTaskInfo{}
...
func (o RecoveryTaskInfo) ToMap() (map[string]interface{}, error) {
