...
// checks if the ArchivalTargetResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArchivalTargetResult{}
...
type ArchivalTargetResult struct {
	...
	IsCadArchive NullableBool `json:"isCadArchive,omitempty"`
...
func (o *ArchivalTargetResult) SetOwnershipContextNil() {
...
func (o *ArchivalTargetResult) SetUsageTypeNil() {
	o.UsageType.Set(nil)
}
...
// GetIsCadArchive returns the IsCadArchive field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ArchivalTargetResult) GetIsCadArchive() bool {
	if o == nil || IsNil(o.IsCadArchive.Get()) {
		var ret bool
		return ret
	}
	return *o.IsCadArchive.Get()
}

// GetIsCadArchiveOk returns a tuple with the IsCadArchive field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetIsCadArchive gets a reference to the given NullableBool and assigns it to the IsCadArchive field.
func (o *ArchivalTargetResult) SetIsCadArchive(v bool) {
	o.IsCadArchive.Set(&v)
}
// SetIsCadArchiveNil sets the value for IsCadArchive to be an explicit nil
func (o *ArchivalTargetResult) SetIsCadArchiveNil() {
	o.IsCadArchive.Set(nil)
}
...
func (o *ArchivalTargetResult) GetIsForeverIncremental() bool {
	if o == nil || IsNil(o.IsForeverIncremental.Get()) {
		var ret bool
		return ret
	}
...
func (o *ArchivalTargetResult) SetStatsTaskIdNil() {
...
// GetWormProperties returns the WormProperties field value if set, zero value otherwise.
func (o *ArchivalTargetResult) GetWormProperties() WormProperties {
	if o == nil || IsNil(o.WormProperties) {
		var ret WormProperties
		return ret
	}
	return *o.WormProperties
}

// GetWormPropertiesOk returns a tuple with the WormProperties field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ArchivalTargetResult) GetWormPropertiesOk() (*WormProperties, bool) {
	if o == nil || IsNil(o.WormProperties) {
		return nil, false
	}
	return o.WormProperties, true
}
...
// SetWormProperties gets a reference to the given WormProperties and assigns it to the WormProperties field.
...
func (o ArchivalTargetResult) ToMap() (map[string]interface{}, error) {
	...
	if o.IsCadArchive.IsSet() {
		toSerialize["isCadArchive"] = o.IsCadArchive.Get()
	}
	...
	if !IsNil(o.WormProperties) {
		toSerialize["wormProperties"] = o.WormProperties
	}
