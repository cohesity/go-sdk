...
// checks if the CommonObjectSnapshotVolumeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonObjectSnapshotVolumeParams{}
...
func (o CommonObjectSnapshotVolumeParams) ToMap() (map[string]interface{}, error) {
