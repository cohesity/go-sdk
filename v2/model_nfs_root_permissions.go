...
// checks if the NfsRootPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NfsRootPermissions{}
...
func (o NfsRootPermissions) ToMap() (map[string]interface{}, error) {
