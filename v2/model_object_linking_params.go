...
// checks if the ObjectLinkingParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectLinkingParams{}
...
func (o ObjectLinkingParams) ToMap() (map[string]interface{}, error) {
