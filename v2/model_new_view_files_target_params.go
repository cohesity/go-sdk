...
// checks if the NewViewFilesTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewViewFilesTargetParams{}

// NewViewFilesTargetParams Specifies the params of the View recovery target.
...
type _NewViewFilesTargetParams NewViewFilesTargetParams
...
func (o *NewViewFilesTargetParams) SetContinueOnErrorNil() {
...
func (o *NewViewFilesTargetParams) SetOverwriteExistingFileNil() {
...
func (o *NewViewFilesTargetParams) SetPreserveFileAttributesNil() {
...
func (o NewViewFilesTargetParams) MarshalJSON() ([]byte, error) {
...
func (o NewViewFilesTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *NewViewFilesTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varNewViewFilesTargetParams := _NewViewFilesTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNewViewFilesTargetParams)

	if err != nil {
		return err
	}

	*o = NewViewFilesTargetParams(varNewViewFilesTargetParams)

	return err
}

type NullableNewViewFilesTargetParams struct {
	value *NewViewFilesTargetParams
	isSet bool
}

func (v NullableNewViewFilesTargetParams) Get() *NewViewFilesTargetParams {
	return v.value
}

func (v *NullableNewViewFilesTargetParams) Set(val *NewViewFilesTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableNewViewFilesTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableNewViewFilesTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewViewFilesTargetParams(val *NewViewFilesTargetParams) *NullableNewViewFilesTargetParams {
	return &NullableNewViewFilesTargetParams{value: val, isSet: true}
}

func (v NullableNewViewFilesTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewViewFilesTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
