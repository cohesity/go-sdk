...
// checks if the ClusterProxyServerConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterProxyServerConfig{}
...
type _ClusterProxyServerConfig ClusterProxyServerConfig
...
func (o ClusterProxyServerConfig) ToMap() (map[string]interface{}, error) {
...
func (o *ClusterProxyServerConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varClusterProxyServerConfig := _ClusterProxyServerConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClusterProxyServerConfig)

	if err != nil {
		return err
	}

	*o = ClusterProxyServerConfig(varClusterProxyServerConfig)
