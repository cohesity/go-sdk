...
// checks if the ViewStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewStats{}

// ViewStats Provides statistics about the View.
type ViewStats struct {
	DataUsageStats *ViewStatsDataUsageStats `json:"dataUsageStats,omitempty"`
...
func (o *ViewStats) GetDataUsageStats() ViewStatsDataUsageStats {
	if o == nil || IsNil(o.DataUsageStats) {
		var ret ViewStatsDataUsageStats
		return ret
	}
...
// SetDataUsageStats gets a reference to the given ViewStatsDataUsageStats and assigns it to the DataUsageStats field.
...
func (o ViewStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DataUsageStats) {
