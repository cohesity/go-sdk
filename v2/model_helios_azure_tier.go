...
// checks if the HeliosAzureTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosAzureTier{}
...
type _HeliosAzureTier HeliosAzureTier
...
func (o *HeliosAzureTier) SetMoveAfterNil() {
	o.MoveAfter.Set(nil)
}
...
func (o *HeliosAzureTier) SetMoveAfterUnitNil() {
...
func (o HeliosAzureTier) MarshalJSON() ([]byte, error) {
...
func (o HeliosAzureTier) ToMap() (map[string]interface{}, error) {
...
func (o *HeliosAzureTier) UnmarshalJSON(data []byte) (err error) {
	...
	varHeliosAzureTier := _HeliosAzureTier{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeliosAzureTier)

	if err != nil {
		return err
	}

	*o = HeliosAzureTier(varHeliosAzureTier)

	return err
}

type NullableHeliosAzureTier struct {
	value *HeliosAzureTier
	isSet bool
}

func (v NullableHeliosAzureTier) Get() *HeliosAzureTier {
	return v.value
}

func (v *NullableHeliosAzureTier) Set(val *HeliosAzureTier) {
	v.value = val
	v.isSet = true
}

func (v NullableHeliosAzureTier) IsSet() bool {
	return v.isSet
}

func (v *NullableHeliosAzureTier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeliosAzureTier(val *HeliosAzureTier) *NullableHeliosAzureTier {
	return &NullableHeliosAzureTier{value: val, isSet: true}
}

func (v NullableHeliosAzureTier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeliosAzureTier) UnmarshalJSON(src []byte) error {
	v.isSet = true
