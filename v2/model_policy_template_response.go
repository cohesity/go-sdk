...
// checks if the PolicyTemplateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyTemplateResponse{}
...
type _PolicyTemplateResponse PolicyTemplateResponse
...
func (o *PolicyTemplateResponse) SetIsCBSEnabledNil() {
...
func (o *PolicyTemplateResponse) SetLastModificationTimeUsecsNil() {
...
func (o *PolicyTemplateResponse) SetSkipIntervalMinsNil() {
...
func (o *PolicyTemplateResponse) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o PolicyTemplateResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPolicyTemplateResponse := _PolicyTemplateResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPolicyTemplateResponse)

	if err != nil {
		return err
	}

	*o = PolicyTemplateResponse(varPolicyTemplateResponse)
