...
// checks if the TdmAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TdmAction{}
...
func (o TdmAction) ToMap() (map[string]interface{}, error) {
