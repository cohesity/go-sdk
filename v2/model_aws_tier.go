...
// checks if the AWSTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AWSTier{}
...
func (o AWSTier) ToMap() (map[string]interface{}, error) {
...
func (o *AWSTier) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAWSTier)

	if err != nil {
		return err
	}

	*o = AWSTier(varAWSTier)
