...
// checks if the CommonTdmCloneTaskParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonTdmCloneTaskParams{}
...
type _CommonTdmCloneTaskParams CommonTdmCloneTaskParams
...
func (o CommonTdmCloneTaskParams) ToMap() (map[string]interface{}, error) {
...
func (o *CommonTdmCloneTaskParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonTdmCloneTaskParams := _CommonTdmCloneTaskParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonTdmCloneTaskParams)

	if err != nil {
		return err
	}

	*o = CommonTdmCloneTaskParams(varCommonTdmCloneTaskParams)
