...
// checks if the FilterObjectsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilterObjectsRequest{}
...
type _FilterObjectsRequest FilterObjectsRequest
...
func (o *FilterObjectsRequest) GetApplicationEnvironment() string {
	if o == nil || IsNil(o.ApplicationEnvironment.Get()) {
		var ret string
		return ret
	}
...
func (o FilterObjectsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *FilterObjectsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varFilterObjectsRequest := _FilterObjectsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFilterObjectsRequest)

	if err != nil {
		return err
	}

	*o = FilterObjectsRequest(varFilterObjectsRequest)
