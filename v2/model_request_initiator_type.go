...
// checks if the RequestInitiatorType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestInitiatorType{}
...
func (o *RequestInitiatorType) GetRequestInitiatorType() string {
	if o == nil || IsNil(o.RequestInitiatorType) {
		var ret string
		return ret
	}
...
func (o RequestInitiatorType) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RequestInitiatorType) {
