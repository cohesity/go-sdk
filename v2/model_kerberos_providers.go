...
// checks if the KerberosProviders type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KerberosProviders{}
...
func (o *KerberosProviders) GetKerberosProviders() []KerberosProvider {
	if o == nil || IsNil(o.KerberosProviders) {
...
func (o KerberosProviders) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.KerberosProviders) {
