...
// checks if the RetentionUnits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetentionUnits{}
...
func (o *RetentionUnits) GetRetentionUnits() string {
	if o == nil || IsNil(o.RetentionUnits) {
		var ret string
		return ret
	}
...
func (o RetentionUnits) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.RetentionUnits) {
