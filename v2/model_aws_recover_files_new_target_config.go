...
// checks if the AwsRecoverFilesNewTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRecoverFilesNewTargetConfig{}
...
type _AwsRecoverFilesNewTargetConfig AwsRecoverFilesNewTargetConfig
...
func (o *AwsRecoverFilesNewTargetConfig) SetTargetVmCredentialsNil() {
...
func (o AwsRecoverFilesNewTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRecoverFilesNewTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRecoverFilesNewTargetConfig := _AwsRecoverFilesNewTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsRecoverFilesNewTargetConfig)

	if err != nil {
		return err
	}

	*o = AwsRecoverFilesNewTargetConfig(varAwsRecoverFilesNewTargetConfig)
