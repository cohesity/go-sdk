...
// checks if the RecoverMsTeamParamsTargetMsTeamParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverMsTeamParamsTargetMsTeamParam{}

// RecoverMsTeamParamsTargetMsTeamParam Specifies the ms team target parameters in case of restoreToOriginal is false.
type RecoverMsTeamParamsTargetMsTeamParam struct {
...
func NewRecoverMsTeamParamsTargetMsTeamParam() *RecoverMsTeamParamsTargetMsTeamParam {
	this := RecoverMsTeamParamsTargetMsTeamParam{}
	return &this
}
...
func (o *RecoverMsTeamParamsTargetMsTeamParam) SetParentSourceIdNil() {
...
func (o *RecoverMsTeamParamsTargetMsTeamParam) SetTargetTeamNil() {
...
func (o RecoverMsTeamParamsTargetMsTeamParam) MarshalJSON() ([]byte, error) {
...
func (o RecoverMsTeamParamsTargetMsTeamParam) ToMap() (map[string]interface{}, error) {
...
type NullableRecoverMsTeamParamsTargetMsTeamParam struct {
	value *RecoverMsTeamParamsTargetMsTeamParam
	isSet bool
}

func (v NullableRecoverMsTeamParamsTargetMsTeamParam) Get() *RecoverMsTeamParamsTargetMsTeamParam {
	return v.value
}

func (v *NullableRecoverMsTeamParamsTargetMsTeamParam) Set(val *RecoverMsTeamParamsTargetMsTeamParam) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverMsTeamParamsTargetMsTeamParam) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverMsTeamParamsTargetMsTeamParam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverMsTeamParamsTargetMsTeamParam(val *RecoverMsTeamParamsTargetMsTeamParam) *NullableRecoverMsTeamParamsTargetMsTeamParam {
	return &NullableRecoverMsTeamParamsTargetMsTeamParam{value: val, isSet: true}
}

func (v NullableRecoverMsTeamParamsTargetMsTeamParam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverMsTeamParamsTargetMsTeamParam) UnmarshalJSON(src []byte) error {
	v.isSet = true
