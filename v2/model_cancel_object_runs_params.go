...
// checks if the CancelObjectRunsParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelObjectRunsParams{}
...
type _CancelObjectRunsParams CancelObjectRunsParams
...
func (o CancelObjectRunsParams) ToMap() (map[string]interface{}, error) {
...
func (o *CancelObjectRunsParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCancelObjectRunsParams := _CancelObjectRunsParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCancelObjectRunsParams)

	if err != nil {
		return err
	}

	*o = CancelObjectRunsParams(varCancelObjectRunsParams)
