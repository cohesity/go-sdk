...
// checks if the AzureSnapshotManagerProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureSnapshotManagerProtectionGroupParams{}
...
func (o AzureSnapshotManagerProtectionGroupParams) ToMap() (map[string]interface{}, error) {
