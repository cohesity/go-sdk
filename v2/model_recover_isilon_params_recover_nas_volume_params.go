...
// checks if the RecoverIsilonParamsRecoverNasVolumeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverIsilonParamsRecoverNasVolumeParams{}

// RecoverIsilonParamsRecoverNasVolumeParams Specifies the parameters to recover NAS Volumes.
type RecoverIsilonParamsRecoverNasVolumeParams struct {
	ElastifileTargetParams NullableRecoverIsilonNasVolumeParamsElastifileTargetParams `json:"elastifileTargetParams,omitempty"`
	...
	GpfsTargetParams NullableRecoverIsilonNasVolumeParamsGpfsTargetParams `json:"gpfsTargetParams,omitempty"`
	IsilonTargetParams NullableRecoverIsilonNasVolumeParamsIsilonTargetParams `json:"isilonTargetParams,omitempty"`
...
type _RecoverIsilonParamsRecoverNasVolumeParams RecoverIsilonParamsRecoverNasVolumeParams
...
func NewRecoverIsilonParamsRecoverNasVolumeParams(targetEnvironment string) *RecoverIsilonParamsRecoverNasVolumeParams {
	this := RecoverIsilonParamsRecoverNasVolumeParams{}
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) GetElastifileTargetParams() RecoverIsilonNasVolumeParamsElastifileTargetParams {
	if o == nil || IsNil(o.ElastifileTargetParams.Get()) {
		var ret RecoverIsilonNasVolumeParamsElastifileTargetParams
		return ret
	}
...
// SetElastifileTargetParams gets a reference to the given NullableRecoverIsilonNasVolumeParamsElastifileTargetParams and assigns it to the ElastifileTargetParams field.
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetElastifileTargetParamsNil() {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetFlashbladeTargetParamsNil() {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetGenericNasTargetParamsNil() {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) GetGpfsTargetParams() RecoverIsilonNasVolumeParamsGpfsTargetParams {
	if o == nil || IsNil(o.GpfsTargetParams.Get()) {
		var ret RecoverIsilonNasVolumeParamsGpfsTargetParams
		return ret
	}
...
// SetGpfsTargetParams gets a reference to the given NullableRecoverIsilonNasVolumeParamsGpfsTargetParams and assigns it to the GpfsTargetParams field.
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetGpfsTargetParamsNil() {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) GetIsilonTargetParams() RecoverIsilonNasVolumeParamsIsilonTargetParams {
	if o == nil || IsNil(o.IsilonTargetParams.Get()) {
		var ret RecoverIsilonNasVolumeParamsIsilonTargetParams
		return ret
	}
...
// SetIsilonTargetParams gets a reference to the given NullableRecoverIsilonNasVolumeParamsIsilonTargetParams and assigns it to the IsilonTargetParams field.
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetIsilonTargetParamsNil() {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetNetappTargetParamsNil() {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) SetViewTargetParamsNil() {
...
func (o RecoverIsilonParamsRecoverNasVolumeParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverIsilonParamsRecoverNasVolumeParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverIsilonParamsRecoverNasVolumeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverIsilonParamsRecoverNasVolumeParams := _RecoverIsilonParamsRecoverNasVolumeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverIsilonParamsRecoverNasVolumeParams)

	if err != nil {
		return err
	}

	*o = RecoverIsilonParamsRecoverNasVolumeParams(varRecoverIsilonParamsRecoverNasVolumeParams)

	return err
}

type NullableRecoverIsilonParamsRecoverNasVolumeParams struct {
	value *RecoverIsilonParamsRecoverNasVolumeParams
	isSet bool
}

func (v NullableRecoverIsilonParamsRecoverNasVolumeParams) Get() *RecoverIsilonParamsRecoverNasVolumeParams {
	return v.value
}

func (v *NullableRecoverIsilonParamsRecoverNasVolumeParams) Set(val *RecoverIsilonParamsRecoverNasVolumeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverIsilonParamsRecoverNasVolumeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverIsilonParamsRecoverNasVolumeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverIsilonParamsRecoverNasVolumeParams(val *RecoverIsilonParamsRecoverNasVolumeParams) *NullableRecoverIsilonParamsRecoverNasVolumeParams {
	return &NullableRecoverIsilonParamsRecoverNasVolumeParams{value: val, isSet: true}
}

func (v NullableRecoverIsilonParamsRecoverNasVolumeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverIsilonParamsRecoverNasVolumeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
