...
// checks if the HyperVProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HyperVProtectionGroupParams{}
...
type HyperVProtectionGroupParams struct {
	...
	GlobalExcludeDisks []HyperVDiskInfo `json:"globalExcludeDisks,omitempty"`
	// Specifies a global list of disks to be included for the all the VMs part of the protection group.
	GlobalIncludeDisks []HyperVDiskInfo `json:"globalIncludeDisks,omitempty"`
...
// SetGlobalExcludeDisks gets a reference to the given []HyperVDiskInfo and assigns it to the GlobalExcludeDisks field.
...
// SetGlobalIncludeDisks gets a reference to the given []HyperVDiskInfo and assigns it to the GlobalIncludeDisks field.
...
func (o HyperVProtectionGroupParams) ToMap() (map[string]interface{}, error) {
