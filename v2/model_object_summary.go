...
// checks if the ObjectSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectSummary{}
...
func (o *ObjectSummary) SetEnvironmentNil() {
...
func (o *ObjectSummary) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ObjectSummary) SetSourceIdNil() {
	o.SourceId.Set(nil)
}
...
func (o *ObjectSummary) SetSourceNameNil() {
...
func (o *ObjectSummary) SetGlobalIdNil() {
	o.GlobalId.Set(nil)
}
...
func (o *ObjectSummary) SetLogicalSizeBytesNil() {
...
func (o *ObjectSummary) SetObjectHashNil() {
...
func (o *ObjectSummary) SetObjectTypeNil() {
...
func (o *ObjectSummary) SetOsTypeNil() {
	o.OsType.Set(nil)
}
...
func (o *ObjectSummary) SetProtectionTypeNil() {
...
func (o *ObjectSummary) SetUuidNil() {
	o.Uuid.Set(nil)
}
...
func (o ObjectSummary) MarshalJSON() ([]byte, error) {
...
func (o ObjectSummary) ToMap() (map[string]interface{}, error) {
...
type NullableObjectSummary struct {
	value *ObjectSummary
	isSet bool
}

func (v NullableObjectSummary) Get() *ObjectSummary {
	return v.value
}

func (v *NullableObjectSummary) Set(val *ObjectSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectSummary(val *ObjectSummary) *NullableObjectSummary {
	return &NullableObjectSummary{value: val, isSet: true}
}

func (v NullableObjectSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
