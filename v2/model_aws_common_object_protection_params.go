...
// checks if the AwsCommonObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsCommonObjectProtectionParams{}
...
func (o AwsCommonObjectProtectionParams) ToMap() (map[string]interface{}, error) {
