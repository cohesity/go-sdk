...
// checks if the RecoverGpfsFilesParamsGpfsTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverGpfsFilesParamsGpfsTargetParams{}

// RecoverGpfsFilesParamsGpfsTargetParams Specifies the params for a GPFS recovery target.
type RecoverGpfsFilesParamsGpfsTargetParams struct {
...
type _RecoverGpfsFilesParamsGpfsTargetParams RecoverGpfsFilesParamsGpfsTargetParams
...
func NewRecoverGpfsFilesParamsGpfsTargetParams(recoverToNewSource bool) *RecoverGpfsFilesParamsGpfsTargetParams {
	this := RecoverGpfsFilesParamsGpfsTargetParams{}
...
func (o *RecoverGpfsFilesParamsGpfsTargetParams) SetNewSourceConfigNil() {
...
func (o *RecoverGpfsFilesParamsGpfsTargetParams) SetOriginalSourceConfigNil() {
...
func (o RecoverGpfsFilesParamsGpfsTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverGpfsFilesParamsGpfsTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverGpfsFilesParamsGpfsTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverGpfsFilesParamsGpfsTargetParams := _RecoverGpfsFilesParamsGpfsTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverGpfsFilesParamsGpfsTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverGpfsFilesParamsGpfsTargetParams(varRecoverGpfsFilesParamsGpfsTargetParams)

	return err
}

type NullableRecoverGpfsFilesParamsGpfsTargetParams struct {
	value *RecoverGpfsFilesParamsGpfsTargetParams
	isSet bool
}

func (v NullableRecoverGpfsFilesParamsGpfsTargetParams) Get() *RecoverGpfsFilesParamsGpfsTargetParams {
	return v.value
}

func (v *NullableRecoverGpfsFilesParamsGpfsTargetParams) Set(val *RecoverGpfsFilesParamsGpfsTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverGpfsFilesParamsGpfsTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverGpfsFilesParamsGpfsTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverGpfsFilesParamsGpfsTargetParams(val *RecoverGpfsFilesParamsGpfsTargetParams) *NullableRecoverGpfsFilesParamsGpfsTargetParams {
	return &NullableRecoverGpfsFilesParamsGpfsTargetParams{value: val, isSet: true}
}

func (v NullableRecoverGpfsFilesParamsGpfsTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverGpfsFilesParamsGpfsTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
