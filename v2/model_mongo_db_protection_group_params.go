...
// checks if the MongoDBProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MongoDBProtectionGroupParams{}
...
func (o *MongoDBProtectionGroupParams) SetCustomSourceNameNil() {
...
func (o *MongoDBProtectionGroupParams) SetOverwriteExcludeObjectlistNil() {
...
func (o *MongoDBProtectionGroupParams) SetOverwriteIncludeObjectlistNil() {
...
func (o MongoDBProtectionGroupParams) ToMap() (map[string]interface{}, error) {
