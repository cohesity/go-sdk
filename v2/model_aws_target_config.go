...
// checks if the AWSTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AWSTargetConfig{}
...
type _AWSTargetConfig AWSTargetConfig
...
func (o AWSTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AWSTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAWSTargetConfig := _AWSTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAWSTargetConfig)

	if err != nil {
		return err
	}

	*o = AWSTargetConfig(varAWSTargetConfig)
