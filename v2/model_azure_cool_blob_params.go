...
// checks if the AzureCoolBlobParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AzureCoolBlobParams{}
...
type _AzureCoolBlobParams AzureCoolBlobParams
...
func (o *AzureCoolBlobParams) SetFunctionAppDeploymentKeyNil() {
...
func (o *AzureCoolBlobParams) SetFunctionAppNameNil() {
...
func (o AzureCoolBlobParams) ToMap() (map[string]interface{}, error) {
...
func (o *AzureCoolBlobParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureCoolBlobParams := _AzureCoolBlobParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAzureCoolBlobParams)

	if err != nil {
		return err
	}

	*o = AzureCoolBlobParams(varAzureCoolBlobParams)
