...
// checks if the ProtectedObjectInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectedObjectInfo{}
...
func (o *ProtectedObjectInfo) GetProtectionGroupConfigurationsOk() ([]ProtectedObjectGroupBackupConfig, bool) {
	if o == nil || IsNil(o.ProtectionGroupConfigurations) {
		return nil, false
	}
...
func (o ProtectedObjectInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ObjectBackupConfiguration) {
