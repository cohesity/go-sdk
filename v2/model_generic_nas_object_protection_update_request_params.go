...
// checks if the GenericNasObjectProtectionUpdateRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenericNasObjectProtectionUpdateRequestParams{}
...
func (o *GenericNasObjectProtectionUpdateRequestParams) SetProtocolNil() {
	o.Protocol.Set(nil)
}
...
func (o GenericNasObjectProtectionUpdateRequestParams) ToMap() (map[string]interface{}, error) {
