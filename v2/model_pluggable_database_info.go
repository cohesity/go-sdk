...
// checks if the PluggableDatabaseInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PluggableDatabaseInfo{}
...
func (o PluggableDatabaseInfo) ToMap() (map[string]interface{}, error) {
