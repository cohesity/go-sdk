...
// checks if the RecoverCouchbaseSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverCouchbaseSnapshotParams{}
...
type _RecoverCouchbaseSnapshotParams RecoverCouchbaseSnapshotParams
...
func (o *RecoverCouchbaseSnapshotParams) SetBytesRestoredNil() {
...
func (o RecoverCouchbaseSnapshotParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverCouchbaseSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverCouchbaseSnapshotParams := _RecoverCouchbaseSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverCouchbaseSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverCouchbaseSnapshotParams(varRecoverCouchbaseSnapshotParams)
