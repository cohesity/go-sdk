...
// checks if the SyslogServerStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SyslogServerStatus{}
...
func (o SyslogServerStatus) ToMap() (map[string]interface{}, error) {
