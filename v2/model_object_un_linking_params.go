...
// checks if the ObjectUnLinkingParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectUnLinkingParams{}
...
func (o ObjectUnLinkingParams) ToMap() (map[string]interface{}, error) {
