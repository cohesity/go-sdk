...
// checks if the IsilonObjectProtectionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IsilonObjectProtectionResponseParams{}
...
func (o IsilonObjectProtectionResponseParams) ToMap() (map[string]interface{}, error) {
