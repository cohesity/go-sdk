...
// checks if the HeliosWeekSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosWeekSchedule{}
...
func (o HeliosWeekSchedule) ToMap() (map[string]interface{}, error) {
