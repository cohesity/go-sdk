...
// checks if the ReplicationTargetProgressInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicationTargetProgressInfo{}
...
func (o *ReplicationTargetProgressInfo) GetExpectedRemainingTimeUsecs() int64 {
	if o == nil || IsNil(o.ExpectedRemainingTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o ReplicationTargetProgressInfo) ToMap() (map[string]interface{}, error) {
