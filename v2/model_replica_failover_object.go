...
// checks if the ReplicaFailoverObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaFailoverObject{}
...
func (o *ReplicaFailoverObject) GetFailoverObjectId() int64 {
	if o == nil || IsNil(o.FailoverObjectId.Get()) {
		var ret int64
		return ret
	}
...
func (o ReplicaFailoverObject) ToMap() (map[string]interface{}, error) {
