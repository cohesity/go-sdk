...
// checks if the AppResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppResource{}
...
func (o AppResource) ToMap() (map[string]interface{}, error) {
