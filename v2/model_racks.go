...
// checks if the Racks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Racks{}
...
func (o Racks) ToMap() (map[string]interface{}, error) {
