...
// checks if the PerformActionOnClonesRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PerformActionOnClonesRequest{}
...
type _PerformActionOnClonesRequest PerformActionOnClonesRequest
...
func (o *PerformActionOnClonesRequest) GetCleanupParams() CloneActionCleanupParams {
	if o == nil || IsNil(o.CleanupParams) {
...
func (o PerformActionOnClonesRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["action"] = o.Action.Get()
	if !IsNil(o.CleanupParams) {
		toSerialize["cleanupParams"] = o.CleanupParams
	}
	return toSerialize, nil
}

func (o *PerformActionOnClonesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPerformActionOnClonesRequest := _PerformActionOnClonesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerformActionOnClonesRequest)

	if err != nil {
		return err
	}

	*o = PerformActionOnClonesRequest(varPerformActionOnClonesRequest)
