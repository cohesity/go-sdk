...
// checks if the OracleRmanBackup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRmanBackup{}
...
func (o *OracleRmanBackup) GetOracleRmanBackup() string {
	if o == nil || IsNil(o.OracleRmanBackup) {
		var ret string
		return ret
	}
...
func (o OracleRmanBackup) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OracleRmanBackup) {
