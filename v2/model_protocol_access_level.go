...
// checks if the ProtocolAccessLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtocolAccessLevel{}
...
func (o *ProtocolAccessLevel) GetProtocolAccessLevel() string {
	if o == nil || IsNil(o.ProtocolAccessLevel) {
		var ret string
		return ret
	}
...
func (o ProtocolAccessLevel) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ProtocolAccessLevel) {
