...
// checks if the CloudSpinTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudSpinTarget{}
...
func (o CloudSpinTarget) ToMap() (map[string]interface{}, error) {
