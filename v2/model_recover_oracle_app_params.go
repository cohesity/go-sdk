...
// checks if the RecoverOracleAppParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverOracleAppParams{}
...
type _RecoverOracleAppParams RecoverOracleAppParams
...
func (o RecoverOracleAppParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverOracleAppParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverOracleAppParams := _RecoverOracleAppParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverOracleAppParams)

	if err != nil {
		return err
	}

	*o = RecoverOracleAppParams(varRecoverOracleAppParams)
