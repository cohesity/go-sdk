...
// checks if the ObjectMsTeamParamRecoverObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectMsTeamParamRecoverObject{}

// ObjectMsTeamParamRecoverObject Specifies the Microsoft 365 Team recover object info.
type ObjectMsTeamParamRecoverObject struct {
...
type _ObjectMsTeamParamRecoverObject ObjectMsTeamParamRecoverObject
...
func NewObjectMsTeamParamRecoverObject(snapshotId string) *ObjectMsTeamParamRecoverObject {
	this := ObjectMsTeamParamRecoverObject{}
...
func (o *ObjectMsTeamParamRecoverObject) SetArchivalTargetInfoNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetBytesRestoredNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetEndTimeUsecsNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetObjectInfoNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetPointInTimeUsecsNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetProgressTaskIdNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetProtectionGroupIdNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetProtectionGroupNameNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetRecoverFromStandbyNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetSnapshotCreationTimeUsecsNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetSnapshotTargetTypeNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetStartTimeUsecsNil() {
...
func (o *ObjectMsTeamParamRecoverObject) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ObjectMsTeamParamRecoverObject) SetStorageDomainIdNil() {
...
func (o ObjectMsTeamParamRecoverObject) MarshalJSON() ([]byte, error) {
...
func (o ObjectMsTeamParamRecoverObject) ToMap() (map[string]interface{}, error) {
...
func (o *ObjectMsTeamParamRecoverObject) UnmarshalJSON(data []byte) (err error) {
	...
	varObjectMsTeamParamRecoverObject := _ObjectMsTeamParamRecoverObject{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObjectMsTeamParamRecoverObject)

	if err != nil {
		return err
	}

	*o = ObjectMsTeamParamRecoverObject(varObjectMsTeamParamRecoverObject)

	return err
}

type NullableObjectMsTeamParamRecoverObject struct {
	value *ObjectMsTeamParamRecoverObject
	isSet bool
}

func (v NullableObjectMsTeamParamRecoverObject) Get() *ObjectMsTeamParamRecoverObject {
	return v.value
}

func (v *NullableObjectMsTeamParamRecoverObject) Set(val *ObjectMsTeamParamRecoverObject) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectMsTeamParamRecoverObject) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectMsTeamParamRecoverObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectMsTeamParamRecoverObject(val *ObjectMsTeamParamRecoverObject) *NullableObjectMsTeamParamRecoverObject {
	return &NullableObjectMsTeamParamRecoverObject{value: val, isSet: true}
}

func (v NullableObjectMsTeamParamRecoverObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectMsTeamParamRecoverObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
