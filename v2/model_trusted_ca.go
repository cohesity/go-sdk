...
// checks if the TrustedCa type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustedCa{}
...
func (o *TrustedCa) GetExpirationTimeUsecs() int64 {
	if o == nil || IsNil(o.ExpirationTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o *TrustedCa) GetIssuedTimeUsecs() int64 {
	if o == nil || IsNil(o.IssuedTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o *TrustedCa) GetLastValidatedTimeUsecs() int64 {
	if o == nil || IsNil(o.LastValidatedTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o *TrustedCa) GetRegistrationTimeUsecs() int64 {
	if o == nil || IsNil(o.RegistrationTimeUsecs.Get()) {
		var ret int64
		return ret
	}
...
func (o TrustedCa) ToMap() (map[string]interface{}, error) {
