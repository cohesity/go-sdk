...
// checks if the OnPremObjectIds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OnPremObjectIds{}
...
func (o OnPremObjectIds) ToMap() (map[string]interface{}, error) {
