...
// checks if the RemoteTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoteTargetConfig{}
...
type _RemoteTargetConfig RemoteTargetConfig
...
func (o RemoteTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RemoteTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoteTargetConfig := _RemoteTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRemoteTargetConfig)

	if err != nil {
		return err
	}

	*o = RemoteTargetConfig(varRemoteTargetConfig)
