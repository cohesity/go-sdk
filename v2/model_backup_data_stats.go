...
// checks if the BackupDataStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupDataStats{}
...
func (o BackupDataStats) ToMap() (map[string]interface{}, error) {
