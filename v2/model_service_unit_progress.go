...
// checks if the ServiceUnitProgress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceUnitProgress{}
...
func (o *ServiceUnitProgress) GetNodesProgressOk() ([]NodeUnitProgress, bool) {
	if o == nil || IsNil(o.NodesProgress) {
		return nil, false
	}
...
func (o *ServiceUnitProgress) GetServiceMessage() string {
	if o == nil || IsNil(o.ServiceMessage.Get()) {
		var ret string
		return ret
	}
...
func (o ServiceUnitProgress) ToMap() (map[string]interface{}, error) {
