...
// checks if the GpfsObjectProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GpfsObjectProtectionParams{}
...
func (o GpfsObjectProtectionParams) ToMap() (map[string]interface{}, error) {
