...
// checks if the RecoverNetappFilesParamsFlashbladeTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappFilesParamsFlashbladeTargetParams{}

// RecoverNetappFilesParamsFlashbladeTargetParams Specifies the params for a Flashblade recovery target.
type RecoverNetappFilesParamsFlashbladeTargetParams struct {
...
type _RecoverNetappFilesParamsFlashbladeTargetParams RecoverNetappFilesParamsFlashbladeTargetParams
...
func NewRecoverNetappFilesParamsFlashbladeTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverNetappFilesParamsFlashbladeTargetParams {
	this := RecoverNetappFilesParamsFlashbladeTargetParams{}
...
func (o *RecoverNetappFilesParamsFlashbladeTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverNetappFilesParamsFlashbladeTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverNetappFilesParamsFlashbladeTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverNetappFilesParamsFlashbladeTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverNetappFilesParamsFlashbladeTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverNetappFilesParamsFlashbladeTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappFilesParamsFlashbladeTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappFilesParamsFlashbladeTargetParams := _RecoverNetappFilesParamsFlashbladeTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappFilesParamsFlashbladeTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverNetappFilesParamsFlashbladeTargetParams(varRecoverNetappFilesParamsFlashbladeTargetParams)

	return err
}

type NullableRecoverNetappFilesParamsFlashbladeTargetParams struct {
	value *RecoverNetappFilesParamsFlashbladeTargetParams
	isSet bool
}

func (v NullableRecoverNetappFilesParamsFlashbladeTargetParams) Get() *RecoverNetappFilesParamsFlashbladeTargetParams {
	return v.value
}

func (v *NullableRecoverNetappFilesParamsFlashbladeTargetParams) Set(val *RecoverNetappFilesParamsFlashbladeTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverNetappFilesParamsFlashbladeTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverNetappFilesParamsFlashbladeTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverNetappFilesParamsFlashbladeTargetParams(val *RecoverNetappFilesParamsFlashbladeTargetParams) *NullableRecoverNetappFilesParamsFlashbladeTargetParams {
	return &NullableRecoverNetappFilesParamsFlashbladeTargetParams{value: val, isSet: true}
}

func (v NullableRecoverNetappFilesParamsFlashbladeTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverNetappFilesParamsFlashbladeTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
