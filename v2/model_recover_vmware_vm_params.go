...
// checks if the RecoverVmwareVmParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverVmwareVmParams{}
...
type _RecoverVmwareVmParams RecoverVmwareVmParams
...
func (o RecoverVmwareVmParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverVmwareVmParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverVmwareVmParams := _RecoverVmwareVmParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverVmwareVmParams)

	if err != nil {
		return err
	}

	*o = RecoverVmwareVmParams(varRecoverVmwareVmParams)
