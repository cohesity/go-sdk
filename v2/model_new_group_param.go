...
// checks if the NewGroupParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewGroupParam{}
...
type _NewGroupParam NewGroupParam
...
func (o NewGroupParam) ToMap() (map[string]interface{}, error) {
...
func (o *NewGroupParam) UnmarshalJSON(data []byte) (err error) {
	...
	varNewGroupParam := _NewGroupParam{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNewGroupParam)

	if err != nil {
		return err
	}

	*o = NewGroupParam(varNewGroupParam)
