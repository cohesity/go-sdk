...
// checks if the ObjectSnapshotHypervParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectSnapshotHypervParams{}

// ObjectSnapshotHypervParams Specifies the parameters specific to HyperV type snapshot.
type ObjectSnapshotHypervParams struct {
...
func NewObjectSnapshotHypervParams() *ObjectSnapshotHypervParams {
	this := ObjectSnapshotHypervParams{}
	return &this
}
...
func (o *ObjectSnapshotHypervParams) SetProtectionTypeNil() {
...
func (o ObjectSnapshotHypervParams) MarshalJSON() ([]byte, error) {
...
func (o ObjectSnapshotHypervParams) ToMap() (map[string]interface{}, error) {
...
type NullableObjectSnapshotHypervParams struct {
	value *ObjectSnapshotHypervParams
	isSet bool
}

func (v NullableObjectSnapshotHypervParams) Get() *ObjectSnapshotHypervParams {
	return v.value
}

func (v *NullableObjectSnapshotHypervParams) Set(val *ObjectSnapshotHypervParams) {
	v.value = val
	v.isSet = true
}

func (v NullableObjectSnapshotHypervParams) IsSet() bool {
	return v.isSet
}

func (v *NullableObjectSnapshotHypervParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableObjectSnapshotHypervParams(val *ObjectSnapshotHypervParams) *NullableObjectSnapshotHypervParams {
	return &NullableObjectSnapshotHypervParams{value: val, isSet: true}
}

func (v NullableObjectSnapshotHypervParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableObjectSnapshotHypervParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
