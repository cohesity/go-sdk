...
// checks if the McmClusterClaimResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &McmClusterClaimResponseParams{}
...
func (o McmClusterClaimResponseParams) ToMap() (map[string]interface{}, error) {
