...
// checks if the LocalUserParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalUserParams{}
...
func (o *LocalUserParams) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *LocalUserParams) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *LocalUserParams) SetPrimaryGroupNil() {
...
func (o LocalUserParams) MarshalJSON() ([]byte, error) {
...
func (o LocalUserParams) ToMap() (map[string]interface{}, error) {
...
type NullableLocalUserParams struct {
	value *LocalUserParams
	isSet bool
}

func (v NullableLocalUserParams) Get() *LocalUserParams {
	return v.value
}

func (v *NullableLocalUserParams) Set(val *LocalUserParams) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalUserParams) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalUserParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalUserParams(val *LocalUserParams) *NullableLocalUserParams {
	return &NullableLocalUserParams{value: val, isSet: true}
}

func (v NullableLocalUserParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalUserParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
