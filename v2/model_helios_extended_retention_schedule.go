...
// checks if the HeliosExtendedRetentionSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosExtendedRetentionSchedule{}
...
func (o HeliosExtendedRetentionSchedule) ToMap() (map[string]interface{}, error) {
