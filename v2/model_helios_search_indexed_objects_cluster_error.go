...
// checks if the HeliosSearchIndexedObjectsClusterError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosSearchIndexedObjectsClusterError{}
...
func (o HeliosSearchIndexedObjectsClusterError) ToMap() (map[string]interface{}, error) {
