...
// checks if the TdmEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TdmEnvironment{}
...
func (o TdmEnvironment) ToMap() (map[string]interface{}, error) {
