...
// checks if the RecoverExperimentalAdapterSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverExperimentalAdapterSnapshotParams{}

// RecoverExperimentalAdapterSnapshotParams Specifies the snapshot parameters for a protected Experimental Adapter object.
type RecoverExperimentalAdapterSnapshotParams struct {
	...
	Objects []RecoverExperimentalAdapterObjectParams `json:"objects,omitempty"`
}

type _RecoverExperimentalAdapterSnapshotParams RecoverExperimentalAdapterSnapshotParams
...
func NewRecoverExperimentalAdapterSnapshotParams(snapshotId string) *RecoverExperimentalAdapterSnapshotParams {
	this := RecoverExperimentalAdapterSnapshotParams{}
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetArchivalTargetInfoNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetBytesRestoredNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetEndTimeUsecsNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetObjectInfoNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetPointInTimeUsecsNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetProgressTaskIdNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetProtectionGroupIdNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetProtectionGroupNameNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetRecoverFromStandbyNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetSnapshotCreationTimeUsecsNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetSnapshotTargetTypeNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetStartTimeUsecsNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *RecoverExperimentalAdapterSnapshotParams) SetStorageDomainIdNil() {
...
func (o *RecoverExperimentalAdapterSnapshotParams) GetObjects() []RecoverExperimentalAdapterObjectParams {
	if o == nil {
		var ret []RecoverExperimentalAdapterObjectParams
		return ret
	}
	return o.Objects
}
...
// SetObjects gets a reference to the given []RecoverExperimentalAdapterObjectParams and assigns it to the Objects field.
func (o *RecoverExperimentalAdapterSnapshotParams) SetObjects(v []RecoverExperimentalAdapterObjectParams) {
	o.Objects = v
}

func (o RecoverExperimentalAdapterSnapshotParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverExperimentalAdapterSnapshotParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverExperimentalAdapterSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverExperimentalAdapterSnapshotParams := _RecoverExperimentalAdapterSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverExperimentalAdapterSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverExperimentalAdapterSnapshotParams(varRecoverExperimentalAdapterSnapshotParams)

	return err
}

type NullableRecoverExperimentalAdapterSnapshotParams struct {
	value *RecoverExperimentalAdapterSnapshotParams
	isSet bool
}

func (v NullableRecoverExperimentalAdapterSnapshotParams) Get() *RecoverExperimentalAdapterSnapshotParams {
	return v.value
}

func (v *NullableRecoverExperimentalAdapterSnapshotParams) Set(val *RecoverExperimentalAdapterSnapshotParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverExperimentalAdapterSnapshotParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverExperimentalAdapterSnapshotParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverExperimentalAdapterSnapshotParams(val *RecoverExperimentalAdapterSnapshotParams) *NullableRecoverExperimentalAdapterSnapshotParams {
	return &NullableRecoverExperimentalAdapterSnapshotParams{value: val, isSet: true}
}

func (v NullableRecoverExperimentalAdapterSnapshotParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverExperimentalAdapterSnapshotParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
