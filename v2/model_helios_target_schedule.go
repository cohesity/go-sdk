...
// checks if the HeliosTargetSchedule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeliosTargetSchedule{}
...
func (o HeliosTargetSchedule) ToMap() (map[string]interface{}, error) {
