...
// checks if the ProtectionPolicyIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionPolicyIdentifier{}
...
func (o ProtectionPolicyIdentifier) ToMap() (map[string]interface{}, error) {
