...
// checks if the CancelObjectRunsResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelObjectRunsResults{}
...
func (o CancelObjectRunsResults) ToMap() (map[string]interface{}, error) {
