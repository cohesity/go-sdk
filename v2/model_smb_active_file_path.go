...
// checks if the SmbActiveFilePath type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SmbActiveFilePath{}

// SmbActiveFilePath Specifies a file path in an SMB view that has active sessions and opens.
type SmbActiveFilePath struct {
	// Specifies an active session where the file is open.
...
func (o SmbActiveFilePath) ToMap() (map[string]interface{}, error) {
