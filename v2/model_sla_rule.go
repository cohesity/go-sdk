...
// checks if the SlaRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlaRule{}
...
func (o *SlaRule) GetSlaMinutes() int64 {
	if o == nil || IsNil(o.SlaMinutes.Get()) {
		var ret int64
		return ret
	}
...
func (o SlaRule) ToMap() (map[string]interface{}, error) {
