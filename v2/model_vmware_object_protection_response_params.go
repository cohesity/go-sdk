...
// checks if the VmwareObjectProtectionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VmwareObjectProtectionResponseParams{}
...
func (o VmwareObjectProtectionResponseParams) ToMap() (map[string]interface{}, error) {
