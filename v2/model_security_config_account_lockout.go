...
// checks if the SecurityConfigAccountLockout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityConfigAccountLockout{}
...
func (o *SecurityConfigAccountLockout) GetFailedLoginLockTimeDurationMins() int32 {
	if o == nil || IsNil(o.FailedLoginLockTimeDurationMins.Get()) {
		var ret int32
		return ret
	}
...
func (o *SecurityConfigAccountLockout) GetInactivityTimeDays() int32 {
	if o == nil || IsNil(o.InactivityTimeDays.Get()) {
		var ret int32
		return ret
	}
...
func (o *SecurityConfigAccountLockout) GetMaxFailedLoginAttempts() int32 {
	if o == nil || IsNil(o.MaxFailedLoginAttempts.Get()) {
		var ret int32
		return ret
	}
...
func (o SecurityConfigAccountLockout) ToMap() (map[string]interface{}, error) {
