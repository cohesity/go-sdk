...
// checks if the PublicFolderItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PublicFolderItem{}
...
func (o *PublicFolderItem) SetPolicyIdNil() {
	o.PolicyId.Set(nil)
}
...
func (o *PublicFolderItem) SetPolicyNameNil() {
...
func (o PublicFolderItem) ToMap() (map[string]interface{}, error) {
