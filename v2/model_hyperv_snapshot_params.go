...
// checks if the HypervSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HypervSnapshotParams{}
...
func (o HypervSnapshotParams) ToMap() (map[string]interface{}, error) {
