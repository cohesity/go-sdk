...
// checks if the FlashbladeObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlashbladeObjectParams{}
...
func (o FlashbladeObjectParams) ToMap() (map[string]interface{}, error) {
