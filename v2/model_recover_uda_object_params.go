...
// checks if the RecoverUdaObjectParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverUdaObjectParams{}
...
func (o *RecoverUdaObjectParams) SetObjectIdNil() {
	o.ObjectId.Set(nil)
}
...
func (o RecoverUdaObjectParams) ToMap() (map[string]interface{}, error) {
