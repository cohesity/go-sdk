...
// checks if the OracleProtectionGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleProtectionGroupParams{}
...
type _OracleProtectionGroupParams OracleProtectionGroupParams
...
func (o *OracleProtectionGroupParams) SetFullAutoKillTimeoutSecsNil() {
...
func (o *OracleProtectionGroupParams) SetIncrAutoKillTimeoutSecsNil() {
...
func (o *OracleProtectionGroupParams) SetLogAutoKillTimeoutSecsNil() {
...
func (o OracleProtectionGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *OracleProtectionGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOracleProtectionGroupParams := _OracleProtectionGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOracleProtectionGroupParams)

	if err != nil {
		return err
	}

	*o = OracleProtectionGroupParams(varOracleProtectionGroupParams)
