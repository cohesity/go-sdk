...
// checks if the FilerAuditLogConfigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FilerAuditLogConfigs{}
...
func (o *FilerAuditLogConfigs) GetNfsMountPath() string {
	if o == nil || IsNil(o.NfsMountPath.Get()) {
		var ret string
		return ret
	}
...
func (o FilerAuditLogConfigs) ToMap() (map[string]interface{}, error) {
