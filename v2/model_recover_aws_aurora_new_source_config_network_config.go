...
// checks if the RecoverAwsAuroraNewSourceConfigNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverAwsAuroraNewSourceConfigNetworkConfig{}

// RecoverAwsAuroraNewSourceConfigNetworkConfig Specifies the networking configuration to be applied to the recovered VMs.
type RecoverAwsAuroraNewSourceConfigNetworkConfig struct {
...
type _RecoverAwsAuroraNewSourceConfigNetworkConfig RecoverAwsAuroraNewSourceConfigNetworkConfig
...
func NewRecoverAwsAuroraNewSourceConfigNetworkConfig(subnet NullableRecoverAwsAuroraNewSourceNetworkConfigSubnet, vpc NullableRecoverAwsAuroraNewSourceNetworkConfigVpc) *RecoverAwsAuroraNewSourceConfigNetworkConfig {
	this := RecoverAwsAuroraNewSourceConfigNetworkConfig{}
	this.Subnet = subnet
	this.Vpc = vpc
	return &this
}
...
func (o *RecoverAwsAuroraNewSourceConfigNetworkConfig) SetAvailabilityZoneNil() {
...
func (o RecoverAwsAuroraNewSourceConfigNetworkConfig) MarshalJSON() ([]byte, error) {
...
func (o RecoverAwsAuroraNewSourceConfigNetworkConfig) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverAwsAuroraNewSourceConfigNetworkConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverAwsAuroraNewSourceConfigNetworkConfig := _RecoverAwsAuroraNewSourceConfigNetworkConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverAwsAuroraNewSourceConfigNetworkConfig)

	if err != nil {
		return err
	}

	*o = RecoverAwsAuroraNewSourceConfigNetworkConfig(varRecoverAwsAuroraNewSourceConfigNetworkConfig)

	return err
}

type NullableRecoverAwsAuroraNewSourceConfigNetworkConfig struct {
	value *RecoverAwsAuroraNewSourceConfigNetworkConfig
	isSet bool
}

func (v NullableRecoverAwsAuroraNewSourceConfigNetworkConfig) Get() *RecoverAwsAuroraNewSourceConfigNetworkConfig {
	return v.value
}

func (v *NullableRecoverAwsAuroraNewSourceConfigNetworkConfig) Set(val *RecoverAwsAuroraNewSourceConfigNetworkConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverAwsAuroraNewSourceConfigNetworkConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverAwsAuroraNewSourceConfigNetworkConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverAwsAuroraNewSourceConfigNetworkConfig(val *RecoverAwsAuroraNewSourceConfigNetworkConfig) *NullableRecoverAwsAuroraNewSourceConfigNetworkConfig {
	return &NullableRecoverAwsAuroraNewSourceConfigNetworkConfig{value: val, isSet: true}
}

func (v NullableRecoverAwsAuroraNewSourceConfigNetworkConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverAwsAuroraNewSourceConfigNetworkConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
