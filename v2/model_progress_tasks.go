...
// checks if the ProgressTasks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgressTasks{}
...
func (o ProgressTasks) ToMap() (map[string]interface{}, error) {
