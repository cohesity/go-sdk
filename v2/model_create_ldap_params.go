...
// checks if the CreateLdapParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateLdapParams{}
...
type _CreateLdapParams CreateLdapParams
...
func (o *CreateLdapParams) SetAdDomainNameNil() {
...
func (o *CreateLdapParams) SetDomainNameNil() {
...
func (o CreateLdapParams) ToMap() (map[string]interface{}, error) {
...
func (o *CreateLdapParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateLdapParams := _CreateLdapParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateLdapParams)

	if err != nil {
		return err
	}

	*o = CreateLdapParams(varCreateLdapParams)
