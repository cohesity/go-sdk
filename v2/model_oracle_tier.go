...
// checks if the OracleTier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleTier{}
...
func (o OracleTier) ToMap() (map[string]interface{}, error) {
...
func (o *OracleTier) UnmarshalJSON(data []byte) (err error) {
	...
	varOracleTier := _OracleTier{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOracleTier)

	if err != nil {
		return err
	}

	*o = OracleTier(varOracleTier)
