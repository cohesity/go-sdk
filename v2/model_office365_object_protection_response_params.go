...
// checks if the Office365ObjectProtectionResponseParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Office365ObjectProtectionResponseParams{}
...
type _Office365ObjectProtectionResponseParams Office365ObjectProtectionResponseParams
...
func (o Office365ObjectProtectionResponseParams) ToMap() (map[string]interface{}, error) {
...
func (o *Office365ObjectProtectionResponseParams) UnmarshalJSON(data []byte) (err error) {
	...
	varOffice365ObjectProtectionResponseParams := _Office365ObjectProtectionResponseParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOffice365ObjectProtectionResponseParams)

	if err != nil {
		return err
	}

	*o = Office365ObjectProtectionResponseParams(varOffice365ObjectProtectionResponseParams)
