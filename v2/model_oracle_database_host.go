...
// checks if the OracleDatabaseHost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleDatabaseHost{}
...
func (o *OracleDatabaseHost) GetSbtHostParams() OracleSbtHostParams {
	if o == nil || IsNil(o.SbtHostParams) {
...
func (o OracleDatabaseHost) ToMap() (map[string]interface{}, error) {
