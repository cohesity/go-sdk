...
// checks if the OracleRestoreMetaInfoResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OracleRestoreMetaInfoResult{}
...
func (o OracleRestoreMetaInfoResult) ToMap() (map[string]interface{}, error) {
