...
// checks if the OneDriveParam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OneDriveParam{}
...
func (o *OneDriveParam) GetRecoverEntireDrive() bool {
	if o == nil || IsNil(o.RecoverEntireDrive.Get()) {
		var ret bool
		return ret
	}
...
func (o OneDriveParam) ToMap() (map[string]interface{}, error) {
