...
// checks if the ProtectionPolicyResponseWithPagination type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionPolicyResponseWithPagination{}
...
func (o ProtectionPolicyResponseWithPagination) ToMap() (map[string]interface{}, error) {
