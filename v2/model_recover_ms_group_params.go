...
// checks if the RecoverMsGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverMsGroupParams{}
...
type _RecoverMsGroupParams RecoverMsGroupParams
...
func (o RecoverMsGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverMsGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverMsGroupParams := _RecoverMsGroupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverMsGroupParams)

	if err != nil {
		return err
	}

	*o = RecoverMsGroupParams(varRecoverMsGroupParams)
