...
// checks if the HiveSourceRegistrationUpdateParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HiveSourceRegistrationUpdateParams{}
...
func (o HiveSourceRegistrationUpdateParams) ToMap() (map[string]interface{}, error) {
