...
// checks if the ProtectionGroupIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroupIdentifier{}
...
func (o ProtectionGroupIdentifier) ToMap() (map[string]interface{}, error) {
