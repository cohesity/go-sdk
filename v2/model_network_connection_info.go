...
// checks if the NetworkConnectionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkConnectionInfo{}
...
func (o *NetworkConnectionInfo) GetNetworkGateway() string {
	if o == nil || IsNil(o.NetworkGateway.Get()) {
		var ret string
		return ret
	}
...
func (o NetworkConnectionInfo) ToMap() (map[string]interface{}, error) {
