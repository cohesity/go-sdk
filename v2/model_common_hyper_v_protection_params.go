...
// checks if the CommonHyperVProtectionParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommonHyperVProtectionParams{}
...
func (o CommonHyperVProtectionParams) ToMap() (map[string]interface{}, error) {
