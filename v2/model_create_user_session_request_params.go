...
// checks if the CreateUserSessionRequestParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateUserSessionRequestParams{}
...
func (o CreateUserSessionRequestParams) ToMap() (map[string]interface{}, error) {
