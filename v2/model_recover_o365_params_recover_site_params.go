...
// checks if the RecoverO365ParamsRecoverSiteParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverO365ParamsRecoverSiteParams{}

// RecoverO365ParamsRecoverSiteParams Specifies the parameters to recover Microsoft Office 365 Sharepoint Site.
type RecoverO365ParamsRecoverSiteParams struct {
...
type _RecoverO365ParamsRecoverSiteParams RecoverO365ParamsRecoverSiteParams
...
func NewRecoverO365ParamsRecoverSiteParams(objects []ObjectSiteParam) *RecoverO365ParamsRecoverSiteParams {
	this := RecoverO365ParamsRecoverSiteParams{}
...
func (o *RecoverO365ParamsRecoverSiteParams) SetContinueOnErrorNil() {
...
func (o *RecoverO365ParamsRecoverSiteParams) SetRecoverPreservationHoldLibraryNil() {
...
func (o *RecoverO365ParamsRecoverSiteParams) SetTargetDomainObjectIdNil() {
...
func (o RecoverO365ParamsRecoverSiteParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverO365ParamsRecoverSiteParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverO365ParamsRecoverSiteParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverO365ParamsRecoverSiteParams := _RecoverO365ParamsRecoverSiteParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverO365ParamsRecoverSiteParams)

	if err != nil {
		return err
	}

	*o = RecoverO365ParamsRecoverSiteParams(varRecoverO365ParamsRecoverSiteParams)

	return err
}

type NullableRecoverO365ParamsRecoverSiteParams struct {
	value *RecoverO365ParamsRecoverSiteParams
	isSet bool
}

func (v NullableRecoverO365ParamsRecoverSiteParams) Get() *RecoverO365ParamsRecoverSiteParams {
	return v.value
}

func (v *NullableRecoverO365ParamsRecoverSiteParams) Set(val *RecoverO365ParamsRecoverSiteParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverO365ParamsRecoverSiteParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverO365ParamsRecoverSiteParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverO365ParamsRecoverSiteParams(val *RecoverO365ParamsRecoverSiteParams) *NullableRecoverO365ParamsRecoverSiteParams {
	return &NullableRecoverO365ParamsRecoverSiteParams{value: val, isSet: true}
}

func (v NullableRecoverO365ParamsRecoverSiteParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverO365ParamsRecoverSiteParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
