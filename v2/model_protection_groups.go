...
// checks if the ProtectionGroups type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProtectionGroups{}
...
func (o ProtectionGroups) ToMap() (map[string]interface{}, error) {
