...
// checks if the AwsRecoverFilesOriginalTargetConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsRecoverFilesOriginalTargetConfig{}

// AwsRecoverFilesOriginalTargetConfig Specifies the configuration for recovering files and folders to the original target.
type AwsRecoverFilesOriginalTargetConfig struct {
...
type _AwsRecoverFilesOriginalTargetConfig AwsRecoverFilesOriginalTargetConfig
...
func NewAwsRecoverFilesOriginalTargetConfig(recoverToOriginalPath NullableBool) *AwsRecoverFilesOriginalTargetConfig {
	this := AwsRecoverFilesOriginalTargetConfig{}
...
func (o *AwsRecoverFilesOriginalTargetConfig) SetAlternatePathNil() {
...
func (o *AwsRecoverFilesOriginalTargetConfig) SetTargetVmCredentialsNil() {
...
func (o AwsRecoverFilesOriginalTargetConfig) MarshalJSON() ([]byte, error) {
...
func (o AwsRecoverFilesOriginalTargetConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AwsRecoverFilesOriginalTargetConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAwsRecoverFilesOriginalTargetConfig := _AwsRecoverFilesOriginalTargetConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAwsRecoverFilesOriginalTargetConfig)

	if err != nil {
		return err
	}

	*o = AwsRecoverFilesOriginalTargetConfig(varAwsRecoverFilesOriginalTargetConfig)

	return err
}

type NullableAwsRecoverFilesOriginalTargetConfig struct {
	value *AwsRecoverFilesOriginalTargetConfig
	isSet bool
}

func (v NullableAwsRecoverFilesOriginalTargetConfig) Get() *AwsRecoverFilesOriginalTargetConfig {
	return v.value
}

func (v *NullableAwsRecoverFilesOriginalTargetConfig) Set(val *AwsRecoverFilesOriginalTargetConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAwsRecoverFilesOriginalTargetConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAwsRecoverFilesOriginalTargetConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAwsRecoverFilesOriginalTargetConfig(val *AwsRecoverFilesOriginalTargetConfig) *NullableAwsRecoverFilesOriginalTargetConfig {
	return &NullableAwsRecoverFilesOriginalTargetConfig{value: val, isSet: true}
}

func (v NullableAwsRecoverFilesOriginalTargetConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAwsRecoverFilesOriginalTargetConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
