...
// checks if the RecoverPublicFoldersParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverPublicFoldersParams{}
...
type _RecoverPublicFoldersParams RecoverPublicFoldersParams
...
func (o RecoverPublicFoldersParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverPublicFoldersParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverPublicFoldersParams := _RecoverPublicFoldersParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverPublicFoldersParams)

	if err != nil {
		return err
	}

	*o = RecoverPublicFoldersParams(varRecoverPublicFoldersParams)
