...
// checks if the AliasSmbConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AliasSmbConfig{}
...
func (o AliasSmbConfig) ToMap() (map[string]interface{}, error) {
