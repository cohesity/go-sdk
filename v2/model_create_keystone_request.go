...
// checks if the CreateKeystoneRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKeystoneRequest{}
...
type _CreateKeystoneRequest CreateKeystoneRequest
...
func (o CreateKeystoneRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateKeystoneRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateKeystoneRequest := _CreateKeystoneRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateKeystoneRequest)

	if err != nil {
		return err
	}

	*o = CreateKeystoneRequest(varCreateKeystoneRequest)
