...
// checks if the RecoverElastifileFilesParamsFlashbladeTargetParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverElastifileFilesParamsFlashbladeTargetParams{}

// RecoverElastifileFilesParamsFlashbladeTargetParams Specifies the params for a Flashblade recovery target.
type RecoverElastifileFilesParamsFlashbladeTargetParams struct {
...
type _RecoverElastifileFilesParamsFlashbladeTargetParams RecoverElastifileFilesParamsFlashbladeTargetParams
...
func NewRecoverElastifileFilesParamsFlashbladeTargetParams(alternatePath NullableString, volume RecoverOtherNasToElastifileFilesTargetParamsVolume) *RecoverElastifileFilesParamsFlashbladeTargetParams {
	this := RecoverElastifileFilesParamsFlashbladeTargetParams{}
...
func (o *RecoverElastifileFilesParamsFlashbladeTargetParams) SetContinueOnErrorNil() {
...
func (o *RecoverElastifileFilesParamsFlashbladeTargetParams) SetEncryptionEnabledNil() {
...
func (o *RecoverElastifileFilesParamsFlashbladeTargetParams) SetOverwriteExistingFileNil() {
...
func (o *RecoverElastifileFilesParamsFlashbladeTargetParams) SetPreserveFileAttributesNil() {
...
func (o RecoverElastifileFilesParamsFlashbladeTargetParams) MarshalJSON() ([]byte, error) {
...
func (o RecoverElastifileFilesParamsFlashbladeTargetParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverElastifileFilesParamsFlashbladeTargetParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverElastifileFilesParamsFlashbladeTargetParams := _RecoverElastifileFilesParamsFlashbladeTargetParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverElastifileFilesParamsFlashbladeTargetParams)

	if err != nil {
		return err
	}

	*o = RecoverElastifileFilesParamsFlashbladeTargetParams(varRecoverElastifileFilesParamsFlashbladeTargetParams)

	return err
}

type NullableRecoverElastifileFilesParamsFlashbladeTargetParams struct {
	value *RecoverElastifileFilesParamsFlashbladeTargetParams
	isSet bool
}

func (v NullableRecoverElastifileFilesParamsFlashbladeTargetParams) Get() *RecoverElastifileFilesParamsFlashbladeTargetParams {
	return v.value
}

func (v *NullableRecoverElastifileFilesParamsFlashbladeTargetParams) Set(val *RecoverElastifileFilesParamsFlashbladeTargetParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRecoverElastifileFilesParamsFlashbladeTargetParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRecoverElastifileFilesParamsFlashbladeTargetParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecoverElastifileFilesParamsFlashbladeTargetParams(val *RecoverElastifileFilesParamsFlashbladeTargetParams) *NullableRecoverElastifileFilesParamsFlashbladeTargetParams {
	return &NullableRecoverElastifileFilesParamsFlashbladeTargetParams{value: val, isSet: true}
}

func (v NullableRecoverElastifileFilesParamsFlashbladeTargetParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRecoverElastifileFilesParamsFlashbladeTargetParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
