...
// checks if the GetViewTemplatesResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetViewTemplatesResult{}
...
func (o GetViewTemplatesResult) ToMap() (map[string]interface{}, error) {
