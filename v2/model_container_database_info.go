...
// checks if the ContainerDatabaseInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContainerDatabaseInfo{}
...
func (o *ContainerDatabaseInfo) GetPluggableDatabaseListOk() ([]PluggableDatabaseInfo, bool) {
	if o == nil || IsNil(o.PluggableDatabaseList) {
		return nil, false
	}
...
func (o ContainerDatabaseInfo) ToMap() (map[string]interface{}, error) {
