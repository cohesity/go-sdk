...
// checks if the AAGGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AAGGroup{}
...
func (o AAGGroup) ToMap() (map[string]interface{}, error) {
