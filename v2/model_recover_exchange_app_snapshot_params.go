...
// checks if the RecoverExchangeAppSnapshotParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverExchangeAppSnapshotParams{}
...
type _RecoverExchangeAppSnapshotParams RecoverExchangeAppSnapshotParams
...
func (o *RecoverExchangeAppSnapshotParams) SetBytesRestoredNil() {
...
func (o RecoverExchangeAppSnapshotParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverExchangeAppSnapshotParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverExchangeAppSnapshotParams := _RecoverExchangeAppSnapshotParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverExchangeAppSnapshotParams)

	if err != nil {
		return err
	}

	*o = RecoverExchangeAppSnapshotParams(varRecoverExchangeAppSnapshotParams)
