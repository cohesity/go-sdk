...
// checks if the RecoverNetappParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecoverNetappParams{}
...
type RecoverNetappParams struct {
	...
	RecoverFileAndFolderParams NullableRecoverNetappParamsRecoverFileAndFolderParams `json:"recoverFileAndFolderParams,omitempty"`
	RecoverNasVolumeParams NullableRecoverNetappParamsRecoverNasVolumeParams `json:"recoverNasVolumeParams,omitempty"`
	// Specifies the type of recover action to be performed.
	RecoveryAction string `json:"recoveryAction"`
}

type _RecoverNetappParams RecoverNetappParams
...
func (o *RecoverNetappParams) GetRecoverFileAndFolderParams() RecoverNetappParamsRecoverFileAndFolderParams {
	if o == nil || IsNil(o.RecoverFileAndFolderParams.Get()) {
		var ret RecoverNetappParamsRecoverFileAndFolderParams
		return ret
	}
...
// SetRecoverFileAndFolderParams gets a reference to the given NullableRecoverNetappParamsRecoverFileAndFolderParams and assigns it to the RecoverFileAndFolderParams field.
...
func (o *RecoverNetappParams) GetRecoverNasVolumeParams() RecoverNetappParamsRecoverNasVolumeParams {
	if o == nil || IsNil(o.RecoverNasVolumeParams.Get()) {
		var ret RecoverNetappParamsRecoverNasVolumeParams
		return ret
	}
...
// SetRecoverNasVolumeParams gets a reference to the given NullableRecoverNetappParamsRecoverNasVolumeParams and assigns it to the RecoverNasVolumeParams field.
...
func (o RecoverNetappParams) ToMap() (map[string]interface{}, error) {
...
func (o *RecoverNetappParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRecoverNetappParams := _RecoverNetappParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecoverNetappParams)

	if err != nil {
		return err
	}

	*o = RecoverNetappParams(varRecoverNetappParams)
