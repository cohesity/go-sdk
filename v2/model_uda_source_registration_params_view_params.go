...
// checks if the UdaSourceRegistrationParamsViewParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UdaSourceRegistrationParamsViewParams{}
...
func (o UdaSourceRegistrationParamsViewParams) ToMap() (map[string]interface{}, error) {
