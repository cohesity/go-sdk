...
// checks if the UserDbBackupPreference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDbBackupPreference{}
...
func (o *UserDbBackupPreference) GetUserDbBackupPreference() string {
	if o == nil || IsNil(o.UserDbBackupPreference) {
		var ret string
		return ret
	}
...
func (o UserDbBackupPreference) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UserDbBackupPreference) {
