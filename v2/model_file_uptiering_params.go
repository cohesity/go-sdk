...
// checks if the FileUptieringParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileUptieringParams{}
...
func (o *FileUptieringParams) SetIncludeAllFilesNil() {
...
func (o *FileUptieringParams) SetTargetNil() {
	o.Target.Set(nil)
}
...
func (o FileUptieringParams) ToMap() (map[string]interface{}, error) {
