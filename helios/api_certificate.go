...
type ApiGetHeliosSslCertificateRequest struct {
...
func (a *CertificateService) GetHeliosSslCertificate(r ApiGetHeliosSslCertificateRequest) (SslCertificateParams, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)

		if err != nil {
			return SslCertificateParams{}, nil, GenericOpenAPIError{
				error: err.Error(),
			}
		}
	...
	return r.ApiService.GetHeliosSslCertificateExecute(r)
}


/*
 * Execute executes the request
 * @return SslCertificateParams
 */
func (a *CertificateService) GetHeliosSslCertificateExecute(r ApiGetHeliosSslCertificateRequest) (SslCertificateParams, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  SslCertificateParams
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CertificateService.GetHeliosSslCertificate")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/mcm/ssl-certificate"
