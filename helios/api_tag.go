...
func (a *TagService) CreateTag(r ApiCreateTagRequest) (Tag, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)

		if err != nil {
			return Tag{}, nil, GenericOpenAPIError{
				error: err.Error(),
			}
		}
 ...
 * @return Tag
 */
func (a *TagService) CreateTagExecute(r ApiCreateTagRequest) (Tag, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagService.CreateTag")
	if err != nil {
...
func (a *TagService) DeleteTag(r ApiDeleteTagRequest) (*_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)
 ...
 * Execute executes the request
 */
func (a *TagService) DeleteTagExecute(r ApiDeleteTagRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagService.DeleteTag")
	if err != nil {
...
func (a *TagService) GetTagById(r ApiGetTagByIdRequest) (Tag, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)
 ...
 * @return Tag
 */
func (a *TagService) GetTagByIdExecute(r ApiGetTagByIdRequest) (Tag, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagService.GetTagById")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *TagService) GetTags(r ApiGetTagsRequest) ([]Tag, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)
 ...
 * @return []Tag
 */
func (a *TagService) GetTagsExecute(r ApiGetTagsRequest) ([]Tag, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagService.GetTags")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.Namespaces != nil {
		localVarQueryParams.Add("namespaces", parameterToString(*r.Namespaces, "csv"))
	}
	if r.TenantIds != nil {
	...
	if r.IncludeMarkedForDeletion != nil {
		localVarQueryParams.Add("includeMarkedForDeletion", parameterToString(*r.IncludeMarkedForDeletion, ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *TagService) UpdateTag(r ApiUpdateTagRequest) (Tag, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)
 ...
 * @return Tag
 */
func (a *TagService) UpdateTagExecute(r ApiUpdateTagRequest) (Tag, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TagService.UpdateTag")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
