...
func (a *LDAPService) GetLdapConnectionStatus(r ApiGetLdapConnectionStatusRequest) (LdapStatus, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)

		if err != nil {
			return LdapStatus{}, nil, GenericOpenAPIError{
				error: err.Error(),
			}
		}
 ...
 * @return LdapStatus
 */
func (a *LDAPService) GetLdapConnectionStatusExecute(r ApiGetLdapConnectionStatusRequest) (LdapStatus, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LDAPService.GetLdapConnectionStatus")
	if err != nil {
...
func (a *LDAPService) GetLdaps(r ApiGetLdapsRequest) (Ldaps, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokenService" {
		token, err := GetTokenHelper(a.client)

		if err != nil {
			return Ldaps{}, nil, GenericOpenAPIError{
				error: err.Error(),
			}
		}
 ...
 * @return Ldaps
 */
func (a *LDAPService) GetLdapsExecute(r ApiGetLdapsRequest) (Ldaps, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LDAPService.GetLdaps")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
