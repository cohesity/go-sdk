...
------------ | ------------- | ------------- | -------------
**Objects** | Pointer to [**[]UnprotectActionObjectLevelParams**](UnprotectActionObjectLevelParams.md) | Specifies the list of objects to perform an action. If provided object id is not explicitly protected by object protection, then given action will not be performed on that. | [optional] 

## Methods

### NewProtectedObjectUnProtectActionParams
...
### NewProtectedObjectUnProtectActionParamsWithDefaults
