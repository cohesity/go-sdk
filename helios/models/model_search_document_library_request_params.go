...
type SearchDocumentLibraryRequestParams struct {
	...
	O365Params *O365SearchSharepointRequestParams `json:"o365Params,omitempty"`
}
...
func NewSearchDocumentLibraryRequestParamsWithDefaults() *SearchDocumentLibraryRequestParams {
	this := SearchDocumentLibraryRequestParams{}
	var includeFolders bool = true
	this.IncludeFolders = *NewNullableBool(&includeFolders) // model_simple false
	var includeFiles bool = true
	this.IncludeFiles = *NewNullableBool(&includeFiles) // model_simple false
	return &this
}
...
func (o *SearchDocumentLibraryRequestParams) GetIncludeFolders() bool {
	if o == nil || o.IncludeFolders.Get() == nil {
		var ret bool
		return ret
	}
...
func (o *SearchDocumentLibraryRequestParams) GetIncludeFiles() bool {
	if o == nil || o.IncludeFiles.Get() == nil {
		var ret bool
		return ret
	}
...
func (o *SearchDocumentLibraryRequestParams) GetCreationStartTimeSecs() int64 {
	if o == nil || o.CreationStartTimeSecs.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *SearchDocumentLibraryRequestParams) GetCreationEndTimeSecs() int64 {
	if o == nil || o.CreationEndTimeSecs.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *SearchDocumentLibraryRequestParams) GetSizeBytesLowerLimit() int64 {
	if o == nil || o.SizeBytesLowerLimit.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *SearchDocumentLibraryRequestParams) GetSizeBytesUpperLimit() int64 {
	if o == nil || o.SizeBytesUpperLimit.Get() == nil {
		var ret int64
		return ret
	}
...
func (o *SearchDocumentLibraryRequestParams) GetO365Params() O365SearchSharepointRequestParams {
	if o == nil || o.O365Params == nil {
		var ret O365SearchSharepointRequestParams
		return ret
	}
	return *o.O365Params
}
...
// SetO365Params gets a reference to the given O365SearchSharepointRequestParams and assigns it to the O365Params field.
