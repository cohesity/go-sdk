...
type HeliosOnPremConfig struct {
	...
	KubernetesSubnetCidr NullableString `json:"kubernetesSubnetCidr,omitempty"`
...
func (o *HeliosOnPremConfig) SetNameNil() {
	o.Name.Set(nil)
}
...
// GetKubernetesSubnetCidr returns the KubernetesSubnetCidr field value if set, zero value otherwise (both if not set or set to explicit null).
...
// GetKubernetesSubnetCidrOk returns a tuple with the KubernetesSubnetCidr field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o *HeliosOnPremConfig) HasKubernetesSubnetCidr() bool {
	if o != nil && o.KubernetesSubnetCidr.IsSet() {
		return true
	}
...
// SetKubernetesSubnetCidr gets a reference to the given NullableString and assigns it to the KubernetesSubnetCidr field.
...
func (o *HeliosOnPremConfig) SetKubernetesSubnetCidrNil() {
	o.KubernetesSubnetCidr.Set(nil)
}
...
func (o HeliosOnPremConfig) MarshalJSON() ([]byte, error) {
	...
	if o.KubernetesSubnetCidr.IsSet() {
