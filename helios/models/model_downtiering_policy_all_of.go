...
func NewDowntieringPolicyAllOfWithDefaults() *DowntieringPolicyAllOf {
	this := DowntieringPolicyAllOf{}
	var skipBackSymlink bool = true
	this.SkipBackSymlink = *NewNullableBool(&skipBackSymlink) // model_simple false
	var autoOrphanDataCleanup bool = true
	this.AutoOrphanDataCleanup = *NewNullableBool(&autoOrphanDataCleanup) // model_simple false
	return &this
}
