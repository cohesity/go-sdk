...
func NewDataTieringTaskWithDefaults() *DataTieringTask {
	this := DataTieringTask{}
	var isActive bool = true
	this.IsActive = *NewNullableBool(&isActive) // model_simple false
	var isPaused bool = true
	this.IsPaused = *NewNullableBool(&isPaused) // model_simple false
	var isDeleted bool = true
	this.IsDeleted = *NewNullableBool(&isDeleted) // model_simple false
	return &this
}
