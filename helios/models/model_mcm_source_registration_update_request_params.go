...
// McmSourceRegistrationUpdateRequestParams Specifies the request parameters to update a Protection Source.
type McmSourceRegistrationUpdateRequestParams struct {
...
func NewMcmSourceRegistrationUpdateRequestParams(environment NullableString) *McmSourceRegistrationUpdateRequestParams {
	this := McmSourceRegistrationUpdateRequestParams{}
...
func (o *McmSourceRegistrationUpdateRequestParams) SetIsInternalEncryptedNil() {
...
func (o *McmSourceRegistrationUpdateRequestParams) SetEncryptionKeyNil() {
...
func (o *McmSourceRegistrationUpdateRequestParams) SetConnectionIdNil() {
...
func (o McmSourceRegistrationUpdateRequestParams) MarshalJSON() ([]byte, error) {
...
type NullableMcmSourceRegistrationUpdateRequestParams struct {
	value *McmSourceRegistrationUpdateRequestParams
	isSet bool
}

func (v NullableMcmSourceRegistrationUpdateRequestParams) Get() *McmSourceRegistrationUpdateRequestParams {
	return v.value
}

func (v *NullableMcmSourceRegistrationUpdateRequestParams) Set(val *McmSourceRegistrationUpdateRequestParams) {
	v.value = val
	v.isSet = true
}

func (v NullableMcmSourceRegistrationUpdateRequestParams) IsSet() bool {
	return v.isSet
}

func (v *NullableMcmSourceRegistrationUpdateRequestParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMcmSourceRegistrationUpdateRequestParams(val *McmSourceRegistrationUpdateRequestParams) *NullableMcmSourceRegistrationUpdateRequestParams {
	return &NullableMcmSourceRegistrationUpdateRequestParams{value: val, isSet: true}
}

func (v NullableMcmSourceRegistrationUpdateRequestParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMcmSourceRegistrationUpdateRequestParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
