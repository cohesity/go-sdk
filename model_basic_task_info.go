...
// BasicTaskInfo struct for BasicTaskInfo
...
func (o *BasicTaskInfo) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *BasicTaskInfo) SetTaskIdNil() {
	o.TaskId.Set(nil)
}
...
func (o BasicTaskInfo) MarshalJSON() ([]byte, error) {
...
type NullableBasicTaskInfo struct {
	value *BasicTaskInfo
	isSet bool
}

func (v NullableBasicTaskInfo) Get() *BasicTaskInfo {
	return v.value
}

func (v *NullableBasicTaskInfo) Set(val *BasicTaskInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBasicTaskInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBasicTaskInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBasicTaskInfo(val *BasicTaskInfo) *NullableBasicTaskInfo {
	return &NullableBasicTaskInfo{value: val, isSet: true}
}

func (v NullableBasicTaskInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBasicTaskInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
