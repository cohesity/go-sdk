...
// SnapshotReplicationCopyPolicy Specifies settings for copying Snapshots to Remote Clusters. This also specifies the retention policy that should be applied to Snapshots after they have been copied to the specified target.
type SnapshotReplicationCopyPolicy struct {
	...
	Target NullableReplicationTargetSettings `json:"target,omitempty"`
}
...
func NewSnapshotReplicationCopyPolicy() *SnapshotReplicationCopyPolicy {
	this := SnapshotReplicationCopyPolicy{}
	return &this
}
...
func (o *SnapshotReplicationCopyPolicy) SetIdNil() {
	o.Id.Set(nil)
}
...
// GetCloudTarget returns the CloudTarget field value if set, zero value otherwise.
func (o *SnapshotReplicationCopyPolicy) GetCloudTarget() CloudDeployTargetDetails {
	if o == nil || o.CloudTarget == nil {
		var ret CloudDeployTargetDetails
		return ret
	}
	return *o.CloudTarget
}

// GetCloudTargetOk returns a tuple with the CloudTarget field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SnapshotReplicationCopyPolicy) GetCloudTargetOk() (*CloudDeployTargetDetails, bool) {
	if o == nil || o.CloudTarget == nil {
		return nil, false
	}
	return o.CloudTarget, true
}
...
// SetCloudTarget gets a reference to the given CloudDeployTargetDetails and assigns it to the CloudTarget field.
...
func (o *SnapshotReplicationCopyPolicy) SetCopyPartialNil() {
...
func (o *SnapshotReplicationCopyPolicy) SetDaysToKeepNil() {
...
func (o *SnapshotReplicationCopyPolicy) SetMultiplierNil() {
...
func (o *SnapshotReplicationCopyPolicy) SetPeriodicityNil() {
...
// SetTarget gets a reference to the given NullableReplicationTargetSettings and assigns it to the Target field.
func (o *SnapshotReplicationCopyPolicy) SetTarget(v ReplicationTargetSettings) {
	o.Target.Set(&v)
}
// SetTargetNil sets the value for Target to be an explicit nil
func (o *SnapshotReplicationCopyPolicy) SetTargetNil() {
	o.Target.Set(nil)
}
...
func (o SnapshotReplicationCopyPolicy) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.Id.IsSet() {
		toSerialize["Id"] = o.Id.Get()
	}
	if o.CloudTarget != nil {
		toSerialize["cloudTarget"] = o.CloudTarget
	}
...
type NullableSnapshotReplicationCopyPolicy struct {
	value *SnapshotReplicationCopyPolicy
	isSet bool
}

func (v NullableSnapshotReplicationCopyPolicy) Get() *SnapshotReplicationCopyPolicy {
	return v.value
}

func (v *NullableSnapshotReplicationCopyPolicy) Set(val *SnapshotReplicationCopyPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableSnapshotReplicationCopyPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableSnapshotReplicationCopyPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSnapshotReplicationCopyPolicy(val *SnapshotReplicationCopyPolicy) *NullableSnapshotReplicationCopyPolicy {
	return &NullableSnapshotReplicationCopyPolicy{value: val, isSet: true}
}

func (v NullableSnapshotReplicationCopyPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSnapshotReplicationCopyPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
