...
type ProtectionPolicy struct {
	...
	LastModifiedTimeMsecs NullableInt64 `json:"lastModifiedTimeMsecs,omitempty"`
...
func (o *ProtectionPolicy) SetDaysToKeepNil() {
...
func (o *ProtectionPolicy) SetDaysToKeepLogNil() {
...
func (o *ProtectionPolicy) SetDaysToKeepSystemNil() {
...
func (o *ProtectionPolicy) SetFullSchedulingPolicyNil() {
...
func (o *ProtectionPolicy) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ProtectionPolicy) SetIncrementalSchedulingPolicyNil() {
...
func (o *ProtectionPolicy) SetIsUsableNil() {
	o.IsUsable.Set(nil)
}
...
// GetLastModifiedTimeMsecs returns the LastModifiedTimeMsecs field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ProtectionPolicy) GetLastModifiedTimeMsecs() int64 {
	if o == nil || o.LastModifiedTimeMsecs.Get() == nil {
		var ret int64
		return ret
	}
	return *o.LastModifiedTimeMsecs.Get()
}

// GetLastModifiedTimeMsecsOk returns a tuple with the LastModifiedTimeMsecs field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetLastModifiedTimeMsecs gets a reference to the given NullableInt64 and assigns it to the LastModifiedTimeMsecs field.
func (o *ProtectionPolicy) SetLastModifiedTimeMsecs(v int64) {
	o.LastModifiedTimeMsecs.Set(&v)
}
// SetLastModifiedTimeMsecsNil sets the value for LastModifiedTimeMsecs to be an explicit nil
func (o *ProtectionPolicy) SetLastModifiedTimeMsecsNil() {
	o.LastModifiedTimeMsecs.Set(nil)
}
...
func (o *ProtectionPolicy) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ProtectionPolicy) SetNumLinkedPoliciesNil() {
...
func (o *ProtectionPolicy) SetParentPolicyIdNil() {
...
func (o *ProtectionPolicy) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o *ProtectionPolicy) SetRetryIntervalMinsNil() {
...
func (o *ProtectionPolicy) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *ProtectionPolicy) SetWormRetentionTypeNil() {
...
func (o ProtectionPolicy) MarshalJSON() ([]byte, error) {
	...
	if o.LastModifiedTimeMsecs.IsSet() {
		toSerialize["lastModifiedTimeMsecs"] = o.LastModifiedTimeMsecs.Get()
	}
