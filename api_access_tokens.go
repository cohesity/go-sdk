...
type ApiGenerateAccessTokenRequest struct {
...
func (r ApiGenerateAccessTokenRequest) Body(body AccessTokenCredential) ApiGenerateAccessTokenRequest {
	r.body = &body
	return r
}
*/
...
/*
func (r ApiGenerateAccessTokenRequest) Execute() (AccessToken, *_nethttp.Response, error) {
...
func (a *AccessTokensApiService) GenerateAccessToken(ctx _context.Context) ApiGenerateAccessTokenRequest {
	return ApiGenerateAccessTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccessTokensApiService) GenerateAccessToken(r ApiGenerateAccessTokenRequest) (AccessToken, *_nethttp.Response, error) {
	if reflect.TypeOf(*a).Name() != "AccessTokensApiService" {
		token, err := GetTokenHelper(a.client)

		if err != nil {
			return AccessToken{}, nil, GenericOpenAPIError{
				error: err.Error(),
			}
		}
 ...
 * @return AccessToken
 */
func (a *AccessTokensApiService) GenerateAccessTokenExecute(r ApiGenerateAccessTokenRequest) (AccessToken, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessTokensApiService.GenerateAccessToken")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/public/accessTokens"
