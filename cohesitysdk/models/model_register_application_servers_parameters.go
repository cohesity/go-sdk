...
// RegisterApplicationServersParameters Specifies the parameters required to register Application Servers running in a Protection Source.
...
func NewRegisterApplicationServersParameters() *RegisterApplicationServersParameters {
	this := RegisterApplicationServersParameters{}
	return &this
}
...
func (o *RegisterApplicationServersParameters) SetHasPersistentAgentNil() {
...
func (o *RegisterApplicationServersParameters) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *RegisterApplicationServersParameters) SetProtectionSourceIdNil() {
...
func (o *RegisterApplicationServersParameters) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o RegisterApplicationServersParameters) MarshalJSON() ([]byte, error) {
...
type NullableRegisterApplicationServersParameters struct {
	value *RegisterApplicationServersParameters
	isSet bool
}

func (v NullableRegisterApplicationServersParameters) Get() *RegisterApplicationServersParameters {
	return v.value
}

func (v *NullableRegisterApplicationServersParameters) Set(val *RegisterApplicationServersParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableRegisterApplicationServersParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableRegisterApplicationServersParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegisterApplicationServersParameters(val *RegisterApplicationServersParameters) *NullableRegisterApplicationServersParameters {
	return &NullableRegisterApplicationServersParameters{value: val, isSet: true}
}

func (v NullableRegisterApplicationServersParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegisterApplicationServersParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
