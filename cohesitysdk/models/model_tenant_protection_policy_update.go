...
// TenantProtectionPolicyUpdate Specifies protection policy update details response about a tenant.
...
func NewTenantProtectionPolicyUpdate() *TenantProtectionPolicyUpdate {
	this := TenantProtectionPolicyUpdate{}
	return &this
}
...
func (o *TenantProtectionPolicyUpdate) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o TenantProtectionPolicyUpdate) MarshalJSON() ([]byte, error) {
...
type NullableTenantProtectionPolicyUpdate struct {
	value *TenantProtectionPolicyUpdate
	isSet bool
}

func (v NullableTenantProtectionPolicyUpdate) Get() *TenantProtectionPolicyUpdate {
	return v.value
}

func (v *NullableTenantProtectionPolicyUpdate) Set(val *TenantProtectionPolicyUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantProtectionPolicyUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantProtectionPolicyUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantProtectionPolicyUpdate(val *TenantProtectionPolicyUpdate) *NullableTenantProtectionPolicyUpdate {
	return &NullableTenantProtectionPolicyUpdate{value: val, isSet: true}
}

func (v NullableTenantProtectionPolicyUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantProtectionPolicyUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
