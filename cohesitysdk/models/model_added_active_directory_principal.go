...
func (o *AddedActiveDirectoryPrincipal) SetDomainNil() {
	o.Domain.Set(nil)
}
...
func (o *AddedActiveDirectoryPrincipal) SetObjectClassNil() {
...
func (o *AddedActiveDirectoryPrincipal) SetPrincipalNameNil() {
