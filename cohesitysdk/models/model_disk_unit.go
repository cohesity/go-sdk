...
// DiskUnit Specifies information about a disk unit in a controller.
...
func (o *DiskUnit) SetBusNumberNil() {
	o.BusNumber.Set(nil)
}
...
func (o *DiskUnit) SetControllerTypeNil() {
...
func (o *DiskUnit) SetUnitNumberNil() {
...
func (o DiskUnit) MarshalJSON() ([]byte, error) {
...
type NullableDiskUnit struct {
	value *DiskUnit
	isSet bool
}

func (v NullableDiskUnit) Get() *DiskUnit {
	return v.value
}

func (v *NullableDiskUnit) Set(val *DiskUnit) {
	v.value = val
	v.isSet = true
}

func (v NullableDiskUnit) IsSet() bool {
	return v.isSet
}

func (v *NullableDiskUnit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiskUnit(val *DiskUnit) *NullableDiskUnit {
	return &NullableDiskUnit{value: val, isSet: true}
}

func (v NullableDiskUnit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiskUnit) UnmarshalJSON(src []byte) error {
	v.isSet = true
