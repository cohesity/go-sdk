...
func (o *GetProtectionRunErrorsOK) Error() string {
	return fmt.Sprintf("[GET /public/protectionRuns/errors][%d] getProtectionRunErrorsOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionRunErrorsDefault) Error() string {
	return fmt.Sprintf("[GET /public/protectionRuns/errors][%d] GetProtectionRunErrors default  %+v", o._statusCode, o.Payload)
}
