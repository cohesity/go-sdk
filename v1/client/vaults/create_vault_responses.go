...
func (o *CreateVaultCreated) Error() string {
	return fmt.Sprintf("[POST /public/vaults][%d] createVaultCreated  %+v", 201, o.Payload)
}
...
func (o *CreateVaultDefault) Error() string {
	return fmt.Sprintf("[POST /public/vaults][%d] CreateVault default  %+v", o._statusCode, o.Payload)
}
