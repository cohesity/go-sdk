...
func (o *UpdateVaultOK) Error() string {
	return fmt.Sprintf("[PUT /public/vaults/{id}][%d] updateVaultOK  %+v", 200, o.Payload)
}
...
func (o *UpdateVaultDefault) Error() string {
	return fmt.Sprintf("[PUT /public/vaults/{id}][%d] UpdateVault default  %+v", o._statusCode, o.Payload)
}
