...
type ClientService interface {
	CreateVault(params *CreateVaultParams, opts ...ClientOption) (*CreateVaultCreated, error)

	DeleteVault(params *DeleteVaultParams, opts ...ClientOption) (*DeleteVaultNoContent, error)

	GetArchiveMediaInfo(params *GetArchiveMediaInfoParams, opts ...ClientOption) (*GetArchiveMediaInfoOK, error)

	GetBandwidthSettings(params *GetBandwidthSettingsParams, opts ...ClientOption) (*GetBandwidthSettingsOK, error)

	GetVaultByID(params *GetVaultByIDParams, opts ...ClientOption) (*GetVaultByIDOK, error)

	GetVaultEncryptionKey(params *GetVaultEncryptionKeyParams, opts ...ClientOption) (*GetVaultEncryptionKeyOK, error)

	GetVaults(params *GetVaultsParams, opts ...ClientOption) (*GetVaultsOK, error)

	UpdateBandwidthSettings(params *UpdateBandwidthSettingsParams, opts ...ClientOption) (*UpdateBandwidthSettingsOK, error)
...
*/
func (a *Client) CreateVault(params *CreateVaultParams, opts ...ClientOption) (*CreateVaultCreated, error) {
...
A Vault is equivalent to an External Target in the Cohesity Dashboard.
*/
func (a *Client) DeleteVault(params *DeleteVaultParams, opts ...ClientOption) (*DeleteVaultNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetArchiveMediaInfo(params *GetArchiveMediaInfoParams, opts ...ClientOption) (*GetArchiveMediaInfoOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetBandwidthSettings(params *GetBandwidthSettingsParams, opts ...ClientOption) (*GetBandwidthSettingsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
A Vault is equivalent to an External Target in the Cohesity Dashboard.
*/
func (a *Client) GetVaultByID(params *GetVaultByIDParams, opts ...ClientOption) (*GetVaultByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetVaultEncryptionKey(params *GetVaultEncryptionKeyParams, opts ...ClientOption) (*GetVaultEncryptionKeyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
A Vault is equivalent to an External Target in the Cohesity Dashboard.
*/
func (a *Client) GetVaults(params *GetVaultsParams, opts ...ClientOption) (*GetVaultsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateBandwidthSettings(params *UpdateBandwidthSettingsParams, opts ...ClientOption) (*UpdateBandwidthSettingsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
