...
type ClientService interface {
	GetAuditLogsActions(params *GetAuditLogsActionsParams, opts ...ClientOption) (*GetAuditLogsActionsOK, error)

	GetAuditLogsCategories(params *GetAuditLogsCategoriesParams, opts ...ClientOption) (*GetAuditLogsCategoriesOK, error)

	SearchClusterAuditLogs(params *SearchClusterAuditLogsParams, opts ...ClientOption) (*SearchClusterAuditLogsOK, error)
...
*/
func (a *Client) GetAuditLogsActions(params *GetAuditLogsActionsParams, opts ...ClientOption) (*GetAuditLogsActionsOK, error) {
...
*/
func (a *Client) GetAuditLogsCategories(params *GetAuditLogsCategoriesParams, opts ...ClientOption) (*GetAuditLogsCategoriesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SearchClusterAuditLogs(params *SearchClusterAuditLogsParams, opts ...ClientOption) (*SearchClusterAuditLogsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
