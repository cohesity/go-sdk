...
func (o *GetAuditLogsCategoriesOK) Error() string {
	return fmt.Sprintf("[GET /public/auditLogs/categories][%d] getAuditLogsCategoriesOK  %+v", 200, o.Payload)
}
...
func (o *GetAuditLogsCategoriesDefault) Error() string {
	return fmt.Sprintf("[GET /public/auditLogs/categories][%d] GetAuditLogsCategories default  %+v", o._statusCode, o.Payload)
}
