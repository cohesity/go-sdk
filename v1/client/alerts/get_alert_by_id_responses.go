...
func (o *GetAlertByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/alerts/{id}][%d] getAlertByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetAlertByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/alerts/{id}][%d] GetAlertById default  %+v", o._statusCode, o.Payload)
}
