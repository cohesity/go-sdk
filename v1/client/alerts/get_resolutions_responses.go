...
func (o *GetResolutionsOK) Error() string {
	return fmt.Sprintf("[GET /public/alertResolutions][%d] getResolutionsOK  %+v", 200, o.Payload)
}
...
func (o *GetResolutionsDefault) Error() string {
	return fmt.Sprintf("[GET /public/alertResolutions][%d] GetResolutions default  %+v", o._statusCode, o.Payload)
}
