...
// WithEndTimeUsecs adds the endDateUsecs to the get resolutions params
func (o *GetResolutionsParams) WithEndTimeUsecs(endDateUsecs *int64) *GetResolutionsParams {
	o.SetEndTimeUsecs(endDateUsecs)
	return o
}

// SetEndTimeUsecs adds the endDateUsecs to the get resolutions params
func (o *GetResolutionsParams) SetEndTimeUsecs(endDateUsecs *int64) {
	o.EndTimeUsecs = endDateUsecs
}
...
// WithStartTimeUsecs adds the startDateUsecs to the get resolutions params
func (o *GetResolutionsParams) WithStartTimeUsecs(startDateUsecs *int64) *GetResolutionsParams {
	o.SetStartTimeUsecs(startDateUsecs)
	return o
}

// SetStartTimeUsecs adds the startDateUsecs to the get resolutions params
func (o *GetResolutionsParams) SetStartTimeUsecs(startDateUsecs *int64) {
	o.StartTimeUsecs = startDateUsecs
}
...
func (o *GetResolutionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.StartTimeUsecs != nil {
		...
		if o.StartTimeUsecs != nil {
			qrStartDateUsecs = *o.StartTimeUsecs
		}
