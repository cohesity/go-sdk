...
// WithEndTimeUsecs adds the endDateUsecs to the get alerts params
func (o *GetAlertsParams) WithEndTimeUsecs(endDateUsecs *int64) *GetAlertsParams {
	o.SetEndTimeUsecs(endDateUsecs)
	return o
}

// SetEndTimeUsecs adds the endDateUsecs to the get alerts params
func (o *GetAlertsParams) SetEndTimeUsecs(endDateUsecs *int64) {
...
// WithStartTimeUsecs adds the startDateUsecs to the get alerts params
func (o *GetAlertsParams) WithStartTimeUsecs(startDateUsecs *int64) *GetAlertsParams {
	o.SetStartTimeUsecs(startDateUsecs)
	return o
}

// SetStartTimeUsecs adds the startDateUsecs to the get alerts params
func (o *GetAlertsParams) SetStartTimeUsecs(startDateUsecs *int64) {
