...
type ClientService interface {
	GenerateAccessToken(params *GenerateAccessTokenParams, opts ...ClientOption) (*GenerateAccessTokenCreated, error)
...
*/
func (a *Client) GenerateAccessToken(params *GenerateAccessTokenParams, opts ...ClientOption) (*GenerateAccessTokenCreated, error) {
