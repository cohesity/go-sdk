...
func (o *GetApplicationsOK) Error() string {
	return fmt.Sprintf("[GET /public/analytics/apps][%d] getApplicationsOK  %+v", 200, o.Payload)
}
...
func (o *GetApplicationsDefault) Error() string {
	return fmt.Sprintf("[GET /public/analytics/apps][%d] GetApplications default  %+v", o._statusCode, o.Payload)
}
