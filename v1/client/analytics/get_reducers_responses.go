...
func (o *GetReducersOK) Error() string {
	return fmt.Sprintf("[GET /public/analytics/reducers][%d] getReducersOK  %+v", 200, o.Payload)
}
...
func (o *GetReducersDefault) Error() string {
	return fmt.Sprintf("[GET /public/analytics/reducers][%d] GetReducers default  %+v", o._statusCode, o.Payload)
}
