...
func (o *DownloadMROutputFilesOK) Error() string {
	return fmt.Sprintf("[GET /public/analytics/mrOutputfiles][%d] downloadMROutputFilesOK  %+v", 200, o.Payload)
}
...
func (o *DownloadMROutputFilesDefault) Error() string {
	return fmt.Sprintf("[GET /public/analytics/mrOutputfiles][%d] DownloadMROutputFiles default  %+v", o._statusCode, o.Payload)
}
