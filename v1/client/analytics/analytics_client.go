...
type ClientService interface {
	AnalyzeJar(params *AnalyzeJarParams, opts ...ClientOption) (*AnalyzeJarOK, error)

	CancelMapReduceInstanceRun(params *CancelMapReduceInstanceRunParams, opts ...ClientOption) (*CancelMapReduceInstanceRunOK, error)

	CreateApplication(params *CreateApplicationParams, opts ...ClientOption) (*CreateApplicationCreated, error)

	CreateMapper(params *CreateMapperParams, opts ...ClientOption) (*CreateMapperCreated, error)

	CreateReducer(params *CreateReducerParams, opts ...ClientOption) (*CreateReducerCreated, error)

	DeleteApplication(params *DeleteApplicationParams, opts ...ClientOption) (*DeleteApplicationNoContent, error)

	DeleteMapReduceInstanceRun(params *DeleteMapReduceInstanceRunParams, opts ...ClientOption) (*DeleteMapReduceInstanceRunNoContent, error)

	DeleteMapper(params *DeleteMapperParams, opts ...ClientOption) (*DeleteMapperNoContent, error)

	DeleteReducer(params *DeleteReducerParams, opts ...ClientOption) (*DeleteReducerNoContent, error)

	DeleteUploadedJar(params *DeleteUploadedJarParams, opts ...ClientOption) (*DeleteUploadedJarNoContent, error)

	DownloadMRBaseJar(params *DownloadMRBaseJarParams, opts ...ClientOption) (*DownloadMRBaseJarOK, error)

	DownloadMROutputFiles(params *DownloadMROutputFilesParams, opts ...ClientOption) (*DownloadMROutputFilesOK, error)

	GetApplicationByID(params *GetApplicationByIDParams, opts ...ClientOption) (*GetApplicationByIDOK, error)

	GetApplications(params *GetApplicationsParams, opts ...ClientOption) (*GetApplicationsOK, error)

	GetMRUploadJarPath(params *GetMRUploadJarPathParams, opts ...ClientOption) (*GetMRUploadJarPathOK, error)

	GetMapReduceAppRuns(params *GetMapReduceAppRunsParams, opts ...ClientOption) (*GetMapReduceAppRunsOK, error)

	GetMapReduceFileFormats(params *GetMapReduceFileFormatsParams, opts ...ClientOption) (*GetMapReduceFileFormatsOK, error)

	GetMapperByID(params *GetMapperByIDParams, opts ...ClientOption) (*GetMapperByIDOK, error)

	GetMappers(params *GetMappersParams, opts ...ClientOption) (*GetMappersOK, error)

	GetReducerByID(params *GetReducerByIDParams, opts ...ClientOption) (*GetReducerByIDOK, error)

	GetReducers(params *GetReducersParams, opts ...ClientOption) (*GetReducersOK, error)

	GetSupportedPatterns(params *GetSupportedPatternsParams, opts ...ClientOption) (*GetSupportedPatternsOK, error)

	RunMapReduceAppInstance(params *RunMapReduceAppInstanceParams, opts ...ClientOption) (*RunMapReduceAppInstanceOK, error)

	SavePattern(params *SavePatternParams, opts ...ClientOption) (*SavePatternCreated, error)

	UpdateApplication(params *UpdateApplicationParams, opts ...ClientOption) (*UpdateApplicationOK, error)

	UpdateMapper(params *UpdateMapperParams, opts ...ClientOption) (*UpdateMapperOK, error)

	UpdateReducer(params *UpdateReducerParams, opts ...ClientOption) (*UpdateReducerOK, error)

	UploadJar(params *UploadJarParams, opts ...ClientOption) (*UploadJarOK, error)
...
*/
func (a *Client) AnalyzeJar(params *AnalyzeJarParams, opts ...ClientOption) (*AnalyzeJarOK, error) {
...
Returns the result.
*/
func (a *Client) CancelMapReduceInstanceRun(params *CancelMapReduceInstanceRunParams, opts ...ClientOption) (*CancelMapReduceInstanceRunOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateMapper(params *CreateMapperParams, opts ...ClientOption) (*CreateMapperCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateReducer(params *CreateReducerParams, opts ...ClientOption) (*CreateReducerCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) DeleteApplication(params *DeleteApplicationParams, opts ...ClientOption) (*DeleteApplicationNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Returns delete status upon completion.
*/
func (a *Client) DeleteMapReduceInstanceRun(params *DeleteMapReduceInstanceRunParams, opts ...ClientOption) (*DeleteMapReduceInstanceRunNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Returns delete status upon completion.
*/
func (a *Client) DeleteMapper(params *DeleteMapperParams, opts ...ClientOption) (*DeleteMapperNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Returns delete status upon completion.
*/
func (a *Client) DeleteReducer(params *DeleteReducerParams, opts ...ClientOption) (*DeleteReducerNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Returns delete status upon completion.
*/
func (a *Client) DeleteUploadedJar(params *DeleteUploadedJarParams, opts ...ClientOption) (*DeleteUploadedJarNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) DownloadMRBaseJar(params *DownloadMRBaseJarParams, opts ...ClientOption) (*DownloadMRBaseJarOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) DownloadMROutputFiles(params *DownloadMROutputFilesParams, opts ...ClientOption) (*DownloadMROutputFilesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetApplicationByID(params *GetApplicationByIDParams, opts ...ClientOption) (*GetApplicationByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetMRUploadJarPath(params *GetMRUploadJarPathParams, opts ...ClientOption) (*GetMRUploadJarPathOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Specifying parameters filters the results that are returned.
*/
func (a *Client) GetMapReduceAppRuns(params *GetMapReduceAppRunsParams, opts ...ClientOption) (*GetMapReduceAppRunsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetMapReduceFileFormats(params *GetMapReduceFileFormatsParams, opts ...ClientOption) (*GetMapReduceFileFormatsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetMapperByID(params *GetMapperByIDParams, opts ...ClientOption) (*GetMapperByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Specifying parameters filters the results that are returned.
*/
func (a *Client) GetMappers(params *GetMappersParams, opts ...ClientOption) (*GetMappersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetReducerByID(params *GetReducerByIDParams, opts ...ClientOption) (*GetReducerByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Specifying parameters filters the results that are returned.
*/
func (a *Client) GetReducers(params *GetReducersParams, opts ...ClientOption) (*GetReducersOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
search.
*/
func (a *Client) GetSupportedPatterns(params *GetSupportedPatternsParams, opts ...ClientOption) (*GetSupportedPatternsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) RunMapReduceAppInstance(params *RunMapReduceAppInstanceParams, opts ...ClientOption) (*RunMapReduceAppInstanceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
searching.
*/
func (a *Client) SavePattern(params *SavePatternParams, opts ...ClientOption) (*SavePatternCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateMapper(params *UpdateMapperParams, opts ...ClientOption) (*UpdateMapperOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateReducer(params *UpdateReducerParams, opts ...ClientOption) (*UpdateReducerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
will be uploaded.
*/
func (a *Client) UploadJar(params *UploadJarParams, opts ...ClientOption) (*UploadJarOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
