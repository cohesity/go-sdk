...
func (o *GetApplicationByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/analytics/apps/{id}][%d] getApplicationByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetApplicationByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/analytics/apps/{id}][%d] GetApplicationById default  %+v", o._statusCode, o.Payload)
}
