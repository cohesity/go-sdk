...
func (o *UpdateGroupOK) Error() string {
	return fmt.Sprintf("[PUT /public/groups][%d] updateGroupOK  %+v", 200, o.Payload)
}
...
func (o *UpdateGroupDefault) Error() string {
	return fmt.Sprintf("[PUT /public/groups][%d] UpdateGroup default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateGroupDefault) GetPayload() *models.RequestError {
	return o.Payload
}
