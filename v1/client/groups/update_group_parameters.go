...
func (o *UpdateGroupParams) WithBody(body *models.GroupParameters) *UpdateGroupParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update group params
func (o *UpdateGroupParams) SetBody(body *models.GroupParameters) {
	o.Body = body
}
