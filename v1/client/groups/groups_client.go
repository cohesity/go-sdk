...
type ClientService interface {
	CreateGroup(params *CreateGroupParams, opts ...ClientOption) (*CreateGroupCreated, error)

	DeleteGroups(params *DeleteGroupsParams, opts ...ClientOption) (*DeleteGroupsNoContent, error)
...
*/
func (a *Client) CreateGroup(params *CreateGroupParams, opts ...ClientOption) (*CreateGroupCreated, error) {
...
*/
func (a *Client) DeleteGroups(params *DeleteGroupsParams, opts ...ClientOption) (*DeleteGroupsNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
