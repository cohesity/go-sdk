...
func (o *DeleteGroupsNoContent) Error() string {
	return fmt.Sprintf("[DELETE /public/groups][%d] deleteGroupsNoContent ", 204)
}
...
func (o *DeleteGroupsDefault) Error() string {
	return fmt.Sprintf("[DELETE /public/groups][%d] DeleteGroups default  %+v", o._statusCode, o.Payload)
}
...
func (o *DeleteGroupsDefault) GetPayload() *models.RequestError {
	return o.Payload
}
