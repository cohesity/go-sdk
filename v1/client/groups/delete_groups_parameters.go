...
type DeleteGroupsParams struct {
	...
	*/
	Body *models.GroupDeleteParameters
...
func (o *DeleteGroupsParams) WithBody(body *models.GroupDeleteParameters) *DeleteGroupsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete groups params
func (o *DeleteGroupsParams) SetBody(body *models.GroupDeleteParameters) {
	o.Body = body
}
