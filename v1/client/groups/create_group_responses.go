...
func (o *CreateGroupCreated) Error() string {
	...
	return fmt.Sprintf("[POST /public/groups][%d] createGroupCreated %s", 201, payload)
}
...
func (o *CreateGroupDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/groups][%d] CreateGroup default %s", o._statusCode, payload)
}
