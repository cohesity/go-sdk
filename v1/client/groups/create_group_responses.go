...
func (o *CreateGroupCreated) Error() string {
	return fmt.Sprintf("[POST /public/groups][%d] createGroupCreated  %+v", 201, o.Payload)
}
...
func (o *CreateGroupDefault) Error() string {
	return fmt.Sprintf("[POST /public/groups][%d] CreateGroup default  %+v", o._statusCode, o.Payload)
}
...
func (o *CreateGroupDefault) GetPayload() *models.RequestError {
	return o.Payload
}
