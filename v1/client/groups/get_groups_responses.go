...
func (o *GetGroupsOK) Error() string {
	return fmt.Sprintf("[GET /public/groups][%d] getGroupsOK  %+v", 200, o.Payload)
}
...
func (o *GetGroupsDefault) Error() string {
	return fmt.Sprintf("[GET /public/groups][%d] GetGroups default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetGroupsDefault) GetPayload() *models.RequestError {
	return o.Payload
}
