...
type GetGroupsParams struct {
	...
	*/
	...
	/* IncludeOnlyTenantsGroups.

	     Providing this option will only return tenant groups
	and will not include out any local groups
	*/
	IncludeOnlyTenantsGroups *bool
...
// WithIncludeOnlyTenantsGroups adds the includeOnlyTenantsGroups to the get groups params
func (o *GetGroupsParams) WithIncludeOnlyTenantsGroups(includeOnlyTenantsGroups *bool) *GetGroupsParams {
	o.SetIncludeOnlyTenantsGroups(includeOnlyTenantsGroups)
	return o
}

// SetIncludeOnlyTenantsGroups adds the includeOnlyTenantsGroups to the get groups params
func (o *GetGroupsParams) SetIncludeOnlyTenantsGroups(includeOnlyTenantsGroups *bool) {
	o.IncludeOnlyTenantsGroups = includeOnlyTenantsGroups
}
...
func (o *GetGroupsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeOnlyTenantsGroups != nil {

		// query param includeOnlyTenantsGroups
		var qrIncludeOnlyTenantsGroups bool

		if o.IncludeOnlyTenantsGroups != nil {
			qrIncludeOnlyTenantsGroups = *o.IncludeOnlyTenantsGroups
		}
		qIncludeOnlyTenantsGroups := swag.FormatBool(qrIncludeOnlyTenantsGroups)
		if qIncludeOnlyTenantsGroups != "" {

			if err := r.SetQueryParam("includeOnlyTenantsGroups", qIncludeOnlyTenantsGroups); err != nil {
				return err
			}
		}
	}
