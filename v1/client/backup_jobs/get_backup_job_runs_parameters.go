...
type GetBackupJobRunsParams struct {
	...
	*/
	...
	/* TruncateResponse.
	     ...
	     If set, magneto will truncate the response if it exceeds
	max size limit governed by magneto_http_rpc_response_size_limit_bytes
	*/
...
// WithTruncateResponse adds the truncateResponse to the get backup job runs params
func (o *GetBackupJobRunsParams) WithTruncateResponse(truncateResponse *bool) *GetBackupJobRunsParams {
	o.SetTruncateResponse(truncateResponse)
	return o
}

// SetTruncateResponse adds the truncateResponse to the get backup job runs params
func (o *GetBackupJobRunsParams) SetTruncateResponse(truncateResponse *bool) {
