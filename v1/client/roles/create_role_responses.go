...
func (o *CreateRoleCreated) Error() string {
	return fmt.Sprintf("[POST /public/roles][%d] createRoleCreated  %+v", 201, o.Payload)
}
...
func (o *CreateRoleDefault) Error() string {
	return fmt.Sprintf("[POST /public/roles][%d] CreateRole default  %+v", o._statusCode, o.Payload)
}
