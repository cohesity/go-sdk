...
type CreateRoleParams struct {
	...
	*/
	Body *models.RoleCreateParameters
...
func (o *CreateRoleParams) WithBody(body *models.RoleCreateParameters) *CreateRoleParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create role params
func (o *CreateRoleParams) SetBody(body *models.RoleCreateParameters) {
	o.Body = body
}
