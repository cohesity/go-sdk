...
func (o *UpdateRoleOK) Error() string {
	return fmt.Sprintf("[PUT /public/roles/{name}][%d] updateRoleOK  %+v", 200, o.Payload)
}
...
func (o *UpdateRoleDefault) Error() string {
	return fmt.Sprintf("[PUT /public/roles/{name}][%d] UpdateRole default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateRoleDefault) GetPayload() *models.RequestError {
	return o.Payload
}
