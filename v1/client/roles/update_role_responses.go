...
func (o *UpdateRoleOK) Error() string {
	...
	return fmt.Sprintf("[PUT /public/roles/{name}][%d] updateRoleOK %s", 200, payload)
}
...
func (o *UpdateRoleDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /public/roles/{name}][%d] UpdateRole default %s", o._statusCode, payload)
}
