...
type ClientService interface {
	...
	DeleteRoles(params *DeleteRolesParams, opts ...ClientOption) (*DeleteRolesNoContent, error)
...
*/
func (a *Client) DeleteRoles(params *DeleteRolesParams, opts ...ClientOption) (*DeleteRolesNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
