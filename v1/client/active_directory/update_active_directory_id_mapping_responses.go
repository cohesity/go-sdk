...
func (o *UpdateActiveDirectoryIDMappingOK) Error() string {
	return fmt.Sprintf("[PUT /public/activeDirectory/{name}/idMappingInfo][%d] updateActiveDirectoryIdMappingOK  %+v", 200, o.Payload)
}
...
func (o *UpdateActiveDirectoryIDMappingDefault) Error() string {
	return fmt.Sprintf("[PUT /public/activeDirectory/{name}/idMappingInfo][%d] UpdateActiveDirectoryIdMapping default  %+v", o._statusCode, o.Payload)
}
