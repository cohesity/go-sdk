...
func (o *UpdateInterfaceOK) Error() string {
	return fmt.Sprintf("[PUT /public/interface][%d] updateInterfaceOK  %+v", 200, o.Payload)
}
...
func (o *UpdateInterfaceDefault) Error() string {
	return fmt.Sprintf("[PUT /public/interface][%d] UpdateInterface default  %+v", o._statusCode, o.Payload)
}
