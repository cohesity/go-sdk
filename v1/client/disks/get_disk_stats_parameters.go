...
type GetDiskStatsParams struct {
	...
	*/
	...
	/* InMigration.
	     ...
	     InMigration is used to list all disks in migratable disk vec which are
	being migrated.
	*/
	InMigration *bool
...
// WithInMigration adds the inMigration to the get disk stats params
func (o *GetDiskStatsParams) WithInMigration(inMigration *bool) *GetDiskStatsParams {
	o.SetInMigration(inMigration)
	return o
}

// SetInMigration adds the inMigration to the get disk stats params
func (o *GetDiskStatsParams) SetInMigration(inMigration *bool) {
	o.InMigration = inMigration
}
...
func (o *GetDiskStatsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.InMigration != nil {

		// query param inMigration
		var qrInMigration bool

		if o.InMigration != nil {
			qrInMigration = *o.InMigration
		}
		qInMigration := swag.FormatBool(qrInMigration)
		if qInMigration != "" {

			if err := r.SetQueryParam("inMigration", qInMigration); err != nil {
				return err
			}
		}
	}
