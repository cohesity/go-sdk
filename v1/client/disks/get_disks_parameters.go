...
// WithInMigration adds the inMigration to the get disks params
func (o *GetDisksParams) WithInMigration(inMigration *bool) *GetDisksParams {
	o.SetInMigration(inMigration)
	return o
}

// SetInMigration adds the inMigration to the get disks params
func (o *GetDisksParams) SetInMigration(inMigration *bool) {
