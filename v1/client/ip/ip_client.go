...
type ClientService interface {
	ConfigureIP(params *ConfigureIPParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ConfigureIPOK, error)

	UnconfigureIP(params *UnconfigureIPParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*UnconfigureIPNoContent, error)
