...
func (o *GetRemoteClusterByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/remoteClusters/{id}][%d] getRemoteClusterByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetRemoteClusterByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/remoteClusters/{id}][%d] GetRemoteClusterById default  %+v", o._statusCode, o.Payload)
}
