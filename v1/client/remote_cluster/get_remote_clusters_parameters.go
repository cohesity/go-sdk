...
type GetRemoteClustersParams struct {
	...
	*/
	...
	/* IncludeOnpremVault.
	     ...
	     Filter for whether to include onprem vaults. Returns OnPrem vaults if
	set to true. Onprem vault will not be included by default.
	*/
	IncludeOnpremVault *bool
...
// WithIncludeOnpremVault adds the includeOnpremVault to the get remote clusters params
func (o *GetRemoteClustersParams) WithIncludeOnpremVault(includeOnpremVault *bool) *GetRemoteClustersParams {
	o.SetIncludeOnpremVault(includeOnpremVault)
	return o
}

// SetIncludeOnpremVault adds the includeOnpremVault to the get remote clusters params
func (o *GetRemoteClustersParams) SetIncludeOnpremVault(includeOnpremVault *bool) {
	o.IncludeOnpremVault = includeOnpremVault
}
...
func (o *GetRemoteClustersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeOnpremVault != nil {

		// query param includeOnpremVault
		var qrIncludeOnpremVault bool

		if o.IncludeOnpremVault != nil {
			qrIncludeOnpremVault = *o.IncludeOnpremVault
		}
		qIncludeOnpremVault := swag.FormatBool(qrIncludeOnpremVault)
		if qIncludeOnpremVault != "" {

			if err := r.SetQueryParam("includeOnpremVault", qIncludeOnpremVault); err != nil {
				return err
			}
		}
	}
