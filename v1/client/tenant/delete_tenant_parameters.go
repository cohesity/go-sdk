...
// WithBody adds the body to the delete tenant params
func (o *DeleteTenantParams) WithBody(body *models.TenantIDData) *DeleteTenantParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete tenant params
func (o *DeleteTenantParams) SetBody(body *models.TenantIDData) {
	o.Body = body
}
