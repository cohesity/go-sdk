...
func (o *UpdateTenantViewOK) Error() string {
	return fmt.Sprintf("[PUT /public/tenants/view][%d] updateTenantViewOK  %+v", 200, o.Payload)
}
...
func (o *UpdateTenantViewDefault) Error() string {
	return fmt.Sprintf("[PUT /public/tenants/view][%d] UpdateTenantView default  %+v", o._statusCode, o.Payload)
}
