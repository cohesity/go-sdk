...
func (o *UpdateTenantEntityOK) Error() string {
	return fmt.Sprintf("[PUT /public/tenants/entity][%d] updateTenantEntityOK  %+v", 200, o.Payload)
}
...
func (o *UpdateTenantEntityDefault) Error() string {
	return fmt.Sprintf("[PUT /public/tenants/entity][%d] UpdateTenantEntity default  %+v", o._statusCode, o.Payload)
}
