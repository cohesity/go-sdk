...
func (o *CreateTenantCreated) Error() string {
	return fmt.Sprintf("[POST /public/tenants][%d] createTenantCreated  %+v", 201, o.Payload)
}
...
func (o *CreateTenantDefault) Error() string {
	return fmt.Sprintf("[POST /public/tenants][%d] CreateTenant default  %+v", o._statusCode, o.Payload)
}
