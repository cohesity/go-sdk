...
func (o *GetTenantsProxiesOK) Error() string {
	return fmt.Sprintf("[GET /public/tenants/proxies][%d] getTenantsProxiesOK  %+v", 200, o.Payload)
}
...
func (o *GetTenantsProxiesDefault) Error() string {
	return fmt.Sprintf("[GET /public/tenants/proxies][%d] GetTenantsProxies default  %+v", o._statusCode, o.Payload)
}
