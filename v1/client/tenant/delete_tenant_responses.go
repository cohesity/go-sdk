...
func (o *DeleteTenantNoContent) Error() string {
	...
	return fmt.Sprintf("[DELETE /public/tenants][%d] deleteTenantNoContent %s", 204, payload)
}
...
func (o *DeleteTenantDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /public/tenants][%d] DeleteTenant default %s", o._statusCode, payload)
}
