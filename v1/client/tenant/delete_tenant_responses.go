...
func (o *DeleteTenantNoContent) Error() string {
	return fmt.Sprintf("[DELETE /public/tenants][%d] deleteTenantNoContent  %+v", 204, o.Payload)
}
...
func (o *DeleteTenantNoContent) GetPayload() []*models.Tenant {
	return o.Payload
}
...
func (o *DeleteTenantDefault) Error() string {
	return fmt.Sprintf("[DELETE /public/tenants][%d] DeleteTenant default  %+v", o._statusCode, o.Payload)
}
...
func (o *DeleteTenantDefault) GetPayload() *models.RequestError {
	return o.Payload
}
