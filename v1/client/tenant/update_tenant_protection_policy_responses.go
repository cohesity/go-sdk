...
func (o *UpdateTenantProtectionPolicyOK) Error() string {
	return fmt.Sprintf("[PUT /public/tenants/policy][%d] updateTenantProtectionPolicyOK  %+v", 200, o.Payload)
}
...
func (o *UpdateTenantProtectionPolicyDefault) Error() string {
	return fmt.Sprintf("[PUT /public/tenants/policy][%d] UpdateTenantProtectionPolicy default  %+v", o._statusCode, o.Payload)
}
