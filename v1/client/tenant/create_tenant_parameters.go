...
type CreateTenantParams struct {
	...
	*/
	Body *models.TenantCreateParameters
...
func (o *CreateTenantParams) WithBody(body *models.TenantCreateParameters) *CreateTenantParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create tenant params
func (o *CreateTenantParams) SetBody(body *models.TenantCreateParameters) {
	o.Body = body
}
