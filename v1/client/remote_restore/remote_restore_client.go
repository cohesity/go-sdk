...
type ClientService interface {
	CreateCloudDomainMigrationRequest(params *CreateCloudDomainMigrationRequestParams, opts ...ClientOption) (*CreateCloudDomainMigrationRequestNoContent, error)

	CreateRemoteVaultRestoreTask(params *CreateRemoteVaultRestoreTaskParams, opts ...ClientOption) (*CreateRemoteVaultRestoreTaskCreated, error)

	CreateRemoteVaultSearchJob(params *CreateRemoteVaultSearchJobParams, opts ...ClientOption) (*CreateRemoteVaultSearchJobCreated, error)

	GetRemoteVaultSearchJobResults(params *GetRemoteVaultSearchJobResultsParams, opts ...ClientOption) (*GetRemoteVaultSearchJobResultsOK, error)

	ListCloudDomainMigration(params *ListCloudDomainMigrationParams, opts ...ClientOption) (*ListCloudDomainMigrationOK, error)

	ListRemoteVaultRestoreTasks(params *ListRemoteVaultRestoreTasksParams, opts ...ClientOption) (*ListRemoteVaultRestoreTasksOK, error)

	ListRemoteVaultSearchJobByID(params *ListRemoteVaultSearchJobByIDParams, opts ...ClientOption) (*ListRemoteVaultSearchJobByIDOK, error)

	ListRemoteVaultSearchJobs(params *ListRemoteVaultSearchJobsParams, opts ...ClientOption) (*ListRemoteVaultSearchJobsOK, error)

	StopRemoteVaultSearchJob(params *StopRemoteVaultSearchJobParams, opts ...ClientOption) (*StopRemoteVaultSearchJobNoContent, error)

	UploadVaultEncryptionKeys(params *UploadVaultEncryptionKeysParams, opts ...ClientOption) (*UploadVaultEncryptionKeysNoContent, error)
...
*/
func (a *Client) CreateCloudDomainMigrationRequest(params *CreateCloudDomainMigrationRequestParams, opts ...ClientOption) (*CreateCloudDomainMigrationRequestNoContent, error) {
...
*/
func (a *Client) CreateRemoteVaultRestoreTask(params *CreateRemoteVaultRestoreTaskParams, opts ...ClientOption) (*CreateRemoteVaultRestoreTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateRemoteVaultSearchJob(params *CreateRemoteVaultSearchJobParams, opts ...ClientOption) (*CreateRemoteVaultSearchJobCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetRemoteVaultSearchJobResults(params *GetRemoteVaultSearchJobResultsParams, opts ...ClientOption) (*GetRemoteVaultSearchJobResultsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListCloudDomainMigration(params *ListCloudDomainMigrationParams, opts ...ClientOption) (*ListCloudDomainMigrationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
archived data from remote Vaults to an alternative (non-original) Cluster.
*/
func (a *Client) ListRemoteVaultRestoreTasks(params *ListRemoteVaultRestoreTasksParams, opts ...ClientOption) (*ListRemoteVaultRestoreTasksOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
archived data from remote Vaults to an alternative (non-original) Cluster.
*/
func (a *Client) ListRemoteVaultSearchJobByID(params *ListRemoteVaultSearchJobByIDParams, opts ...ClientOption) (*ListRemoteVaultSearchJobByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
A search Job is equivalent to a search task in the Cohesity Dashboard.
*/
func (a *Client) ListRemoteVaultSearchJobs(params *ListRemoteVaultSearchJobsParams, opts ...ClientOption) (*ListRemoteVaultSearchJobsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
archived data from remote Vaults to an alternative (non-original) Cluster.
*/
func (a *Client) StopRemoteVaultSearchJob(params *StopRemoteVaultSearchJobParams, opts ...ClientOption) (*StopRemoteVaultSearchJobNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Cluster.
*/
func (a *Client) UploadVaultEncryptionKeys(params *UploadVaultEncryptionKeysParams, opts ...ClientOption) (*UploadVaultEncryptionKeysNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
