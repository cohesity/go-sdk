...
func (o *ListCloudDomainMigrationOK) Error() string {
	return fmt.Sprintf("[GET /public/remoteVaults/cloudDomainMigration][%d] listCloudDomainMigrationOK  %+v", 200, o.Payload)
}
...
func (o *ListCloudDomainMigrationDefault) Error() string {
	return fmt.Sprintf("[GET /public/remoteVaults/cloudDomainMigration][%d] ListCloudDomainMigration default  %+v", o._statusCode, o.Payload)
}
