...
func (o *UpgradeNodeAccepted) Error() string {
	return fmt.Sprintf("[PUT /public/nodes/software][%d] upgradeNodeAccepted  %+v", 202, o.Payload)
}
...
func (o *UpgradeNodeDefault) Error() string {
	return fmt.Sprintf("[PUT /public/nodes/software][%d] UpgradeNode default  %+v", o._statusCode, o.Payload)
}
