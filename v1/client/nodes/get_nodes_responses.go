...
// Code gets the status code for the get nodes o k response
func (o *GetNodesOK) Code() int {
	return 200
}

func (o *GetNodesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/nodes][%d] getNodesOK %s", 200, payload)
}
...
func (o *GetNodesOK) GetPayload() []*models.Node {
	return o.Payload
}
...
func (o *GetNodesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/nodes][%d] GetNodes default %s", o._statusCode, payload)
}
...
func (o *GetNodesDefault) GetPayload() *models.RequestError {
	return o.Payload
}
