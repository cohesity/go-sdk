...
// WithClusterPartitionIDList adds the clusterPartitionIds to the get nodes params
func (o *GetNodesParams) WithClusterPartitionIDList(clusterPartitionIds []int64) *GetNodesParams {
	o.SetClusterPartitionIDList(clusterPartitionIds)
	return o
}

// SetClusterPartitionIDList adds the clusterPartitionIds to the get nodes params
func (o *GetNodesParams) SetClusterPartitionIDList(clusterPartitionIds []int64) {
...
// WithIDList adds the ids to the get nodes params
func (o *GetNodesParams) WithIDList(ids []int64) *GetNodesParams {
	o.SetIDList(ids)
	return o
}

// SetIDList adds the ids to the get nodes params
func (o *GetNodesParams) SetIDList(ids []int64) {
	o.IDList = ids
}
