...
func (o *ListFreeNodesOK) Error() string {
	return fmt.Sprintf("[GET /public/freeNodes][%d] listFreeNodesOK  %+v", 200, o.Payload)
}
...
func (o *ListFreeNodesDefault) Error() string {
	return fmt.Sprintf("[GET /public/freeNodes][%d] ListFreeNodes default  %+v", o._statusCode, o.Payload)
}
