...
type GetConsumerStatsParams struct {
	...
	*/
	...
	<clusterId>:<clusterIncarnationId>:<consumerId>.

	If only <consumerId> is provided, <clusterId> and <clusterIncarnationId>
	are assumed to be the current cluster's values.
...
// WithConsumerIds adds the consumerIds to the get consumer stats params
func (o *GetConsumerStatsParams) WithConsumerIds(consumerIds []string) *GetConsumerStatsParams {
	o.SetConsumerIds(consumerIds)
	return o
}

// SetConsumerIds adds the consumerIds to the get consumer stats params
func (o *GetConsumerStatsParams) SetConsumerIds(consumerIds []string) {
...
// WithTenantsIDList adds the organizationsIDList to the get consumer stats params
func (o *GetConsumerStatsParams) WithTenantsIDList(organizationsIDList []string) *GetConsumerStatsParams {
	o.SetTenantsIDList(organizationsIDList)
	return o
}

// SetTenantsIDList adds the organizationsIdList to the get consumer stats params
func (o *GetConsumerStatsParams) SetTenantsIDList(organizationsIDList []string) {
	o.TenantsIDList = organizationsIDList
}
...
func (o *GetConsumerStatsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ConsumerIds != nil {
		...
		// binding items for consumerIds
		joinedConsumerIds := o.bindParamConsumerIds(reg)

		// query array param consumerIds
		if err := r.SetQueryParam("consumerIds", joinedConsumerIds...); err != nil {
			return err
		}
	}
...
// bindParamGetConsumerStats binds the parameter consumerIds
func (o *GetConsumerStatsParams) bindParamConsumerIds(formats strfmt.Registry) []string {
	consumerIdsIR := o.ConsumerIds

	var consumerIdsIC []string
	for _, consumerIdsIIR := range consumerIdsIR { // explode []string

		consumerIdsIIV := consumerIdsIIR // string as string
		consumerIdsIC = append(consumerIdsIC, consumerIdsIIV)
	}

	// items.CollectionFormat: ""
	consumerIdsIS := swag.JoinByFormat(consumerIdsIC, "")

	return consumerIdsIS
}
...
func (o *GetConsumerStatsParams) bindParamOrganizationsIDList(formats strfmt.Registry) []string {
	organizationsIDListIR := o.TenantsIDList
