...
// WithOutputFormat adds the outputFormat to the get consumer stats params
func (o *GetConsumerStatsParams) WithOutputFormat(outputFormat *string) *GetConsumerStatsParams {
	o.SetOutputFormat(outputFormat)
	return o
}

// SetOutputFormat adds the outputFormat to the get consumer stats params
func (o *GetConsumerStatsParams) SetOutputFormat(outputFormat *string) {
