...
func (o *GetProtectionRunsStatsOK) Error() string {
	return fmt.Sprintf("[GET /public/stats/protectionRuns][%d] getProtectionRunsStatsOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionRunsStatsDefault) Error() string {
	return fmt.Sprintf("[GET /public/stats/protectionRuns][%d] GetProtectionRunsStats default  %+v", o._statusCode, o.Payload)
}
