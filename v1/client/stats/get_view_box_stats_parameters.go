...
// WithTenantsIDList adds the organizationsIDList to the get view box stats params
func (o *GetViewBoxStatsParams) WithTenantsIDList(organizationsIDList []string) *GetViewBoxStatsParams {
	o.SetTenantsIDList(organizationsIDList)
	return o
}

// SetTenantsIDList adds the organizationsIdList to the get view box stats params
func (o *GetViewBoxStatsParams) SetTenantsIDList(organizationsIDList []string) {
