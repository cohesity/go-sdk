...
func (o *GetProtectionJobAuditOK) Error() string {
	return fmt.Sprintf("[GET /public/protectionJobs/{id}/auditTrail][%d] getProtectionJobAuditOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionJobAuditDefault) Error() string {
	return fmt.Sprintf("[GET /public/protectionJobs/{id}/auditTrail][%d] GetProtectionJobAudit default  %+v", o._statusCode, o.Payload)
}
