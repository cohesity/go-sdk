...
func (o *CreateProtectionJobCreated) Error() string {
	return fmt.Sprintf("[POST /public/protectionJobs][%d] createProtectionJobCreated  %+v", 201, o.Payload)
}
...
func (o *CreateProtectionJobDefault) Error() string {
	return fmt.Sprintf("[POST /public/protectionJobs][%d] CreateProtectionJob default  %+v", o._statusCode, o.Payload)
}
