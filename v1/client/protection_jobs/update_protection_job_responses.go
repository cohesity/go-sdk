...
func (o *UpdateProtectionJobOK) Error() string {
	return fmt.Sprintf("[PUT /public/protectionJobs/{id}][%d] updateProtectionJobOK  %+v", 200, o.Payload)
}
...
func (o *UpdateProtectionJobDefault) Error() string {
	return fmt.Sprintf("[PUT /public/protectionJobs/{id}][%d] UpdateProtectionJob default  %+v", o._statusCode, o.Payload)
}
