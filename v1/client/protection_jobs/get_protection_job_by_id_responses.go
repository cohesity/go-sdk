...
func (o *GetProtectionJobByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/protectionJobs/{id}][%d] getProtectionJobByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionJobByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/protectionJobs/{id}][%d] GetProtectionJobById default  %+v", o._statusCode, o.Payload)
}
