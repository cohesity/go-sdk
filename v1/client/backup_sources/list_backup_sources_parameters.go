...
type ListBackupSourcesParams struct {
	...
	*/
	...
	/* ExcludeGcpTypes.
	     ...
	     ExcludeGcpTypes specifies an array of GCP entity types to be excluded
	from the entity hierarchy. Entities of this type along with their
	children, if any, will be filtered out.
	*/
	ExcludeGcpTypes []int32

	/* ExcludeGoogleWorkspaceTypes.

	     ExcludeGoogleWorkspaceTypes specifies an array of Google Workspace entity
	types to be excluded from the entity hierarchy. Entities of this type
	along with their children, if any, will be filtered out.
	*/
	ExcludeGoogleWorkspaceTypes []int32
	...
	*/
	...
	/* ExcludeOrphanAgentEntities.

	   Specifies whether to exclude orphan agent entities from the response.
	*/
	ExcludeOrphanAgentEntities *bool
	...
	*/
	...
	where all Protection Source objects displayNames
...
// WithCountryList adds the countryList to the list backup sources params
func (o *ListBackupSourcesParams) WithCountryList(countryList []string) *ListBackupSourcesParams {
	o.SetCountryList(countryList)
	return o
}

// SetCountryList adds the countryList to the list backup sources params
func (o *ListBackupSourcesParams) SetCountryList(countryList []string) {
	o.CountryList = countryList
}

// WithDepartmentList adds the departmentList to the list backup sources params
func (o *ListBackupSourcesParams) WithDepartmentList(departmentList []string) *ListBackupSourcesParams {
	o.SetDepartmentList(departmentList)
	return o
}

// SetDepartmentList adds the departmentList to the list backup sources params
func (o *ListBackupSourcesParams) SetDepartmentList(departmentList []string) {
...
// WithExcludeGcpTypes adds the excludeGcpTypes to the list backup sources params
func (o *ListBackupSourcesParams) WithExcludeGcpTypes(excludeGcpTypes []int32) *ListBackupSourcesParams {
	o.SetExcludeGcpTypes(excludeGcpTypes)
	return o
}

// SetExcludeGcpTypes adds the excludeGcpTypes to the list backup sources params
func (o *ListBackupSourcesParams) SetExcludeGcpTypes(excludeGcpTypes []int32) {
	o.ExcludeGcpTypes = excludeGcpTypes
}

// WithExcludeGoogleWorkspaceTypes adds the excludeGoogleWorkspaceTypes to the list backup sources params
func (o *ListBackupSourcesParams) WithExcludeGoogleWorkspaceTypes(excludeGoogleWorkspaceTypes []int32) *ListBackupSourcesParams {
	o.SetExcludeGoogleWorkspaceTypes(excludeGoogleWorkspaceTypes)
	return o
}

// SetExcludeGoogleWorkspaceTypes adds the excludeGoogleWorkspaceTypes to the list backup sources params
func (o *ListBackupSourcesParams) SetExcludeGoogleWorkspaceTypes(excludeGoogleWorkspaceTypes []int32) {
	o.ExcludeGoogleWorkspaceTypes = excludeGoogleWorkspaceTypes
}
...
// WithExcludeOrphanAgentEntities adds the excludeOrphanAgentEntities to the list backup sources params
func (o *ListBackupSourcesParams) WithExcludeOrphanAgentEntities(excludeOrphanAgentEntities *bool) *ListBackupSourcesParams {
	o.SetExcludeOrphanAgentEntities(excludeOrphanAgentEntities)
	return o
}

// SetExcludeOrphanAgentEntities adds the excludeOrphanAgentEntities to the list backup sources params
func (o *ListBackupSourcesParams) SetExcludeOrphanAgentEntities(excludeOrphanAgentEntities *bool) {
	o.ExcludeOrphanAgentEntities = excludeOrphanAgentEntities
}
...
// WithIncludeGroupAndTeamSite adds the includeGroupAndTeamSite to the list backup sources params
func (o *ListBackupSourcesParams) WithIncludeGroupAndTeamSite(includeGroupAndTeamSite *bool) *ListBackupSourcesParams {
	o.SetIncludeGroupAndTeamSite(includeGroupAndTeamSite)
	return o
}

// SetIncludeGroupAndTeamSite adds the includeGroupAndTeamSite to the list backup sources params
func (o *ListBackupSourcesParams) SetIncludeGroupAndTeamSite(includeGroupAndTeamSite *bool) {
	o.IncludeGroupAndTeamSite = includeGroupAndTeamSite
}
...
// WithIncludeTeamsGroup adds the includeTeamsGroup to the list backup sources params
func (o *ListBackupSourcesParams) WithIncludeTeamsGroup(includeTeamsGroup *bool) *ListBackupSourcesParams {
	o.SetIncludeTeamsGroup(includeTeamsGroup)
	return o
}

// SetIncludeTeamsGroup adds the includeTeamsGroup to the list backup sources params
func (o *ListBackupSourcesParams) SetIncludeTeamsGroup(includeTeamsGroup *bool) {
	o.IncludeTeamsGroup = includeTeamsGroup
}
...
// WithName adds the name to the list backup sources params
func (o *ListBackupSourcesParams) WithName(name *string) *ListBackupSourcesParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the list backup sources params
func (o *ListBackupSourcesParams) SetName(name *string) {
	o.Name = name
}
...
// WithPaginationCookie adds the paginationCookie to the list backup sources params
func (o *ListBackupSourcesParams) WithPaginationCookie(paginationCookie *string) *ListBackupSourcesParams {
	o.SetPaginationCookie(paginationCookie)
	return o
}

// SetPaginationCookie adds the paginationCookie to the list backup sources params
func (o *ListBackupSourcesParams) SetPaginationCookie(paginationCookie *string) {
...
// WithTitleList adds the titleList to the list backup sources params
func (o *ListBackupSourcesParams) WithTitleList(titleList []string) *ListBackupSourcesParams {
	o.SetTitleList(titleList)
	return o
}

// SetTitleList adds the titleList to the list backup sources params
func (o *ListBackupSourcesParams) SetTitleList(titleList []string) {
...
func (o *ListBackupSourcesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ExcludeGcpTypes != nil {

		// binding items for excludeGcpTypes
		joinedExcludeGcpTypes := o.bindParamExcludeGcpTypes(reg)

		// query array param excludeGcpTypes
		if err := r.SetQueryParam("excludeGcpTypes", joinedExcludeGcpTypes...); err != nil {
			return err
		}
	}

	if o.ExcludeGoogleWorkspaceTypes != nil {

		// binding items for excludeGoogleWorkspaceTypes
		joinedExcludeGoogleWorkspaceTypes := o.bindParamExcludeGoogleWorkspaceTypes(reg)

		// query array param excludeGoogleWorkspaceTypes
		if err := r.SetQueryParam("excludeGoogleWorkspaceTypes", joinedExcludeGoogleWorkspaceTypes...); err != nil {
			return err
		}
	}
	...
	if o.ExcludeOrphanAgentEntities != nil {

		// query param excludeOrphanAgentEntities
		var qrExcludeOrphanAgentEntities bool

		if o.ExcludeOrphanAgentEntities != nil {
			qrExcludeOrphanAgentEntities = *o.ExcludeOrphanAgentEntities
		}
		qExcludeOrphanAgentEntities := swag.FormatBool(qrExcludeOrphanAgentEntities)
		if qExcludeOrphanAgentEntities != "" {

			if err := r.SetQueryParam("excludeOrphanAgentEntities", qExcludeOrphanAgentEntities); err != nil {
				return err
			}
		}
	}
	...
	if o.IncludeGroupAndTeamSite != nil {

		// query param includeGroupAndTeamSite
		var qrIncludeGroupAndTeamSite bool

		if o.IncludeGroupAndTeamSite != nil {
			qrIncludeGroupAndTeamSite = *o.IncludeGroupAndTeamSite
		}
		qIncludeGroupAndTeamSite := swag.FormatBool(qrIncludeGroupAndTeamSite)
		if qIncludeGroupAndTeamSite != "" {

			if err := r.SetQueryParam("includeGroupAndTeamSite", qIncludeGroupAndTeamSite); err != nil {
				return err
			}
		}
	}
	...
	if o.IncludeTeamsGroup != nil {

		// query param includeTeamsGroup
		var qrIncludeTeamsGroup bool

		if o.IncludeTeamsGroup != nil {
			qrIncludeTeamsGroup = *o.IncludeTeamsGroup
		}
		qIncludeTeamsGroup := swag.FormatBool(qrIncludeTeamsGroup)
		if qIncludeTeamsGroup != "" {

			if err := r.SetQueryParam("includeTeamsGroup", qIncludeTeamsGroup); err != nil {
				return err
			}
		}
	}
...
// bindParamListBackupSources binds the parameter countryList
func (o *ListBackupSourcesParams) bindParamCountryList(formats strfmt.Registry) []string {
...
// bindParamListBackupSources binds the parameter departmentList
func (o *ListBackupSourcesParams) bindParamDepartmentList(formats strfmt.Registry) []string {
...
// bindParamListBackupSources binds the parameter excludeGcpTypes
func (o *ListBackupSourcesParams) bindParamExcludeGcpTypes(formats strfmt.Registry) []string {
	excludeGcpTypesIR := o.ExcludeGcpTypes

	var excludeGcpTypesIC []string
	for _, excludeGcpTypesIIR := range excludeGcpTypesIR { // explode []int32

		excludeGcpTypesIIV := swag.FormatInt32(excludeGcpTypesIIR) // int32 as string
		excludeGcpTypesIC = append(excludeGcpTypesIC, excludeGcpTypesIIV)
	}

	// items.CollectionFormat: ""
	excludeGcpTypesIS := swag.JoinByFormat(excludeGcpTypesIC, "")

	return excludeGcpTypesIS
}

// bindParamListBackupSources binds the parameter excludeGoogleWorkspaceTypes
func (o *ListBackupSourcesParams) bindParamExcludeGoogleWorkspaceTypes(formats strfmt.Registry) []string {
	excludeGoogleWorkspaceTypesIR := o.ExcludeGoogleWorkspaceTypes

	var excludeGoogleWorkspaceTypesIC []string
	for _, excludeGoogleWorkspaceTypesIIR := range excludeGoogleWorkspaceTypesIR { // explode []int32

		excludeGoogleWorkspaceTypesIIV := swag.FormatInt32(excludeGoogleWorkspaceTypesIIR) // int32 as string
		excludeGoogleWorkspaceTypesIC = append(excludeGoogleWorkspaceTypesIC, excludeGoogleWorkspaceTypesIIV)
	}

	// items.CollectionFormat: ""
	excludeGoogleWorkspaceTypesIS := swag.JoinByFormat(excludeGoogleWorkspaceTypesIC, "")

	return excludeGoogleWorkspaceTypesIS
}
...
// bindParamListBackupSources binds the parameter titleList
func (o *ListBackupSourcesParams) bindParamTitleList(formats strfmt.Registry) []string {
