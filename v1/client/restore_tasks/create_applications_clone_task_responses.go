...
func (o *CreateApplicationsCloneTaskCreated) Error() string {
	return fmt.Sprintf("[POST /public/restore/applicationsClone][%d] createApplicationsCloneTaskCreated  %+v", 201, o.Payload)
}
...
func (o *CreateApplicationsCloneTaskDefault) Error() string {
	return fmt.Sprintf("[POST /public/restore/applicationsClone][%d] CreateApplicationsCloneTask default  %+v", o._statusCode, o.Payload)
}
