...
func (o *GetRestoreTasksOK) Error() string {
	return fmt.Sprintf("[GET /public/restore/tasks][%d] getRestoreTasksOK  %+v", 200, o.Payload)
}
...
func (o *GetRestoreTasksDefault) Error() string {
	return fmt.Sprintf("[GET /public/restore/tasks][%d] GetRestoreTasks default  %+v", o._statusCode, o.Payload)
}
