...
func (o *GetVMVolumesInformationOK) Error() string {
	return fmt.Sprintf("[GET /public/restore/vms/volumesInformation][%d] getVmVolumesInformationOK  %+v", 200, o.Payload)
}
...
func (o *GetVMVolumesInformationDefault) Error() string {
	return fmt.Sprintf("[GET /public/restore/vms/volumesInformation][%d] GetVmVolumesInformation default  %+v", o._statusCode, o.Payload)
}
