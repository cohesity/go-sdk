...
func (o *CreateDownloadFilesAndFoldersCreated) Error() string {
	return fmt.Sprintf("[POST /public/restore/downloadFilesAndFolders][%d] createDownloadFilesAndFoldersCreated  %+v", 201, o.Payload)
}
...
func (o *CreateDownloadFilesAndFoldersDefault) Error() string {
	return fmt.Sprintf("[POST /public/restore/downloadFilesAndFolders][%d] CreateDownloadFilesAndFolders default  %+v", o._statusCode, o.Payload)
}
