...
type ClientService interface {
	AdObjectsRestoreStatus(params *AdObjectsRestoreStatusParams, opts ...ClientOption) (*AdObjectsRestoreStatusOK, error)

	CancelRestoreTask(params *CancelRestoreTaskParams, opts ...ClientOption) (*CancelRestoreTaskOK, error)

	CompareAdObjects(params *CompareAdObjectsParams, opts ...ClientOption) (*CompareAdObjectsOK, error)

	CreateApplicationsCloneTask(params *CreateApplicationsCloneTaskParams, opts ...ClientOption) (*CreateApplicationsCloneTaskCreated, error)

	CreateApplicationsRecoverTask(params *CreateApplicationsRecoverTaskParams, opts ...ClientOption) (*CreateApplicationsRecoverTaskCreated, error)

	CreateCloneTask(params *CreateCloneTaskParams, opts ...ClientOption) (*CreateCloneTaskCreated, error)

	CreateDeployTask(params *CreateDeployTaskParams, opts ...ClientOption) (*CreateDeployTaskCreated, error)

	CreateDownloadFilesAndFolders(params *CreateDownloadFilesAndFoldersParams, opts ...ClientOption) (*CreateDownloadFilesAndFoldersCreated, error)

	CreateRecoverTask(params *CreateRecoverTaskParams, opts ...ClientOption) (*CreateRecoverTaskCreated, error)

	CreateRestoreFilesTask(params *CreateRestoreFilesTaskParams, opts ...ClientOption) (*CreateRestoreFilesTaskCreated, error)

	GetAdDomainRootTopology(params *GetAdDomainRootTopologyParams, opts ...ClientOption) (*GetAdDomainRootTopologyOK, error)

	GetAdObjects(params *GetAdObjectsParams, opts ...ClientOption) (*GetAdObjectsOK, error)

	GetFileFstatInformation(params *GetFileFstatInformationParams, opts ...ClientOption) (*GetFileFstatInformationOK, error)

	GetFileSnapshotsInformation(params *GetFileSnapshotsInformationParams, opts ...ClientOption) (*GetFileSnapshotsInformationOK, error)

	GetOneDriveDocuments(params *GetOneDriveDocumentsParams, opts ...ClientOption) (*GetOneDriveDocumentsOK, error)

	GetOutlookEmails(params *GetOutlookEmailsParams, opts ...ClientOption) (*GetOutlookEmailsOK, error)

	GetRestorePointsForTimeRange(params *GetRestorePointsForTimeRangeParams, opts ...ClientOption) (*GetRestorePointsForTimeRangeCreated, error)

	GetRestoreTaskByID(params *GetRestoreTaskByIDParams, opts ...ClientOption) (*GetRestoreTaskByIDOK, error)

	GetRestoreTasks(params *GetRestoreTasksParams, opts ...ClientOption) (*GetRestoreTasksOK, error)

	GetSharepointDocuments(params *GetSharepointDocumentsParams, opts ...ClientOption) (*GetSharepointDocumentsOK, error)

	GetVirtualDiskInformation(params *GetVirtualDiskInformationParams, opts ...ClientOption) (*GetVirtualDiskInformationOK, error)

	GetVMDirectoryList(params *GetVMDirectoryListParams, opts ...ClientOption) (*GetVMDirectoryListOK, error)

	GetVMVolumesInformation(params *GetVMVolumesInformationParams, opts ...ClientOption) (*GetVMVolumesInformationOK, error)

	ListOrgVdcNetworks(params *ListOrgVdcNetworksParams, opts ...ClientOption) (*ListOrgVdcNetworksOK, error)

	ListStorageProfiles(params *ListStorageProfilesParams, opts ...ClientOption) (*ListStorageProfilesOK, error)

	PublicDestroyCloneTask(params *PublicDestroyCloneTaskParams, opts ...ClientOption) (*PublicDestroyCloneTaskNoContent, error)

	SearchAdObjects(params *SearchAdObjectsParams, opts ...ClientOption) (*SearchAdObjectsOK, error)

	SearchObjects(params *SearchObjectsParams, opts ...ClientOption) (*SearchObjectsOK, error)

	SearchProductionAdObjects(params *SearchProductionAdObjectsParams, opts ...ClientOption) (*SearchProductionAdObjectsOK, error)

	SearchRestoredFiles(params *SearchRestoredFilesParams, opts ...ClientOption) (*SearchRestoredFilesOK, error)

	UpdateRestoreTask(params *UpdateRestoreTaskParams, opts ...ClientOption) (*UpdateRestoreTaskOK, error)
...
parameters.
*/
func (a *Client) AdObjectsRestoreStatus(params *AdObjectsRestoreStatusParams, opts ...ClientOption) (*AdObjectsRestoreStatusOK, error) {
...
*/
func (a *Client) CancelRestoreTask(params *CancelRestoreTaskParams, opts ...ClientOption) (*CancelRestoreTaskOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CompareAdObjects(params *CompareAdObjectsParams, opts ...ClientOption) (*CompareAdObjectsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateApplicationsCloneTask(params *CreateApplicationsCloneTaskParams, opts ...ClientOption) (*CreateApplicationsCloneTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
Returns the created Restore Task.
*/
func (a *Client) CreateApplicationsRecoverTask(params *CreateApplicationsRecoverTaskParams, opts ...ClientOption) (*CreateApplicationsRecoverTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateCloneTask(params *CreateCloneTaskParams, opts ...ClientOption) (*CreateCloneTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateDeployTask(params *CreateDeployTaskParams, opts ...ClientOption) (*CreateDeployTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateDownloadFilesAndFolders(params *CreateDownloadFilesAndFoldersParams, opts ...ClientOption) (*CreateDownloadFilesAndFoldersCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateRecoverTask(params *CreateRecoverTaskParams, opts ...ClientOption) (*CreateRecoverTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) CreateRestoreFilesTask(params *CreateRestoreFilesTaskParams, opts ...ClientOption) (*CreateRestoreFilesTaskCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetAdDomainRootTopology(params *GetAdDomainRootTopologyParams, opts ...ClientOption) (*GetAdDomainRootTopologyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetAdObjects(params *GetAdObjectsParams, opts ...ClientOption) (*GetAdObjectsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetFileFstatInformation(params *GetFileFstatInformationParams, opts ...ClientOption) (*GetFileFstatInformationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetFileSnapshotsInformation(params *GetFileSnapshotsInformationParams, opts ...ClientOption) (*GetFileSnapshotsInformationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetOneDriveDocuments(params *GetOneDriveDocumentsParams, opts ...ClientOption) (*GetOneDriveDocumentsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
search and filter criterias on the Cohesity cluster.
*/
func (a *Client) GetOutlookEmails(params *GetOutlookEmailsParams, opts ...ClientOption) (*GetOutlookEmailsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetRestorePointsForTimeRange(params *GetRestorePointsForTimeRangeParams, opts ...ClientOption) (*GetRestorePointsForTimeRangeCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetRestoreTaskByID(params *GetRestoreTaskByIDParams, opts ...ClientOption) (*GetRestoreTaskByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetRestoreTasks(params *GetRestoreTasksParams, opts ...ClientOption) (*GetRestoreTasksOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
search and filter criterias on the Cohesity cluster.
*/
func (a *Client) GetSharepointDocuments(params *GetSharepointDocumentsParams, opts ...ClientOption) (*GetSharepointDocumentsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetVirtualDiskInformation(params *GetVirtualDiskInformationParams, opts ...ClientOption) (*GetVirtualDiskInformationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetVMDirectoryList(params *GetVMDirectoryListParams, opts ...ClientOption) (*GetVMDirectoryListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetVMVolumesInformation(params *GetVMVolumesInformationParams, opts ...ClientOption) (*GetVMVolumesInformationOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListOrgVdcNetworks(params *ListOrgVdcNetworksParams, opts ...ClientOption) (*ListOrgVdcNetworksOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListStorageProfiles(params *ListStorageProfilesParams, opts ...ClientOption) (*ListStorageProfilesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) PublicDestroyCloneTask(params *PublicDestroyCloneTaskParams, opts ...ClientOption) (*PublicDestroyCloneTaskNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SearchAdObjects(params *SearchAdObjectsParams, opts ...ClientOption) (*SearchAdObjectsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SearchProductionAdObjects(params *SearchProductionAdObjectsParams, opts ...ClientOption) (*SearchProductionAdObjectsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SearchRestoredFiles(params *SearchRestoredFilesParams, opts ...ClientOption) (*SearchRestoredFilesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateRestoreTask(params *UpdateRestoreTaskParams, opts ...ClientOption) (*UpdateRestoreTaskOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
