...
// WithUserIds adds the mailboxIds to the get one drive documents params
func (o *GetOneDriveDocumentsParams) WithUserIds(mailboxIds []int64) *GetOneDriveDocumentsParams {
	o.SetUserIds(mailboxIds)
	return o
}

// SetUserIds adds the mailboxIds to the get one drive documents params
func (o *GetOneDriveDocumentsParams) SetUserIds(mailboxIds []int64) {
	o.UserIds = mailboxIds
}
