...
func (o *GetFileFstatInformationOK) Error() string {
	return fmt.Sprintf("[GET /public/restore/files/fstats][%d] getFileFstatInformationOK  %+v", 200, o.Payload)
}
...
func (o *GetFileFstatInformationDefault) Error() string {
	return fmt.Sprintf("[GET /public/restore/files/fstats][%d] GetFileFstatInformation default  %+v", o._statusCode, o.Payload)
}
