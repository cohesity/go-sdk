...
func (o *GetOneDriveDocumentsOK) Error() string {
	return fmt.Sprintf("[GET /public/restore/office365/onedrive/documents][%d] getOneDriveDocumentsOK  %+v", 200, o.Payload)
}
...
func (o *GetOneDriveDocumentsDefault) Error() string {
	return fmt.Sprintf("[GET /public/restore/office365/onedrive/documents][%d] GetOneDriveDocuments default  %+v", o._statusCode, o.Payload)
}
