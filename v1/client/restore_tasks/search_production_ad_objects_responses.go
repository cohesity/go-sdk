...
func (o *SearchProductionAdObjectsOK) Error() string {
	return fmt.Sprintf("[POST /public/restore/adObjects][%d] searchProductionAdObjectsOK  %+v", 200, o.Payload)
}
...
func (o *SearchProductionAdObjectsDefault) Error() string {
	return fmt.Sprintf("[POST /public/restore/adObjects][%d] SearchProductionAdObjects default  %+v", o._statusCode, o.Payload)
}
