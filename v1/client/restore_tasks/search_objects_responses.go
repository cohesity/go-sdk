...
type SearchObjectsOK struct {
	Payload *models.ObjectSearchResults
}
...
func (o *SearchObjectsOK) Error() string {
	return fmt.Sprintf("[GET /public/restore/objects][%d] searchObjectsOK  %+v", 200, o.Payload)
}
...
func (o *SearchObjectsOK) GetPayload() *models.ObjectSearchResults {
	return o.Payload
}
...
func (o *SearchObjectsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ObjectSearchResults)
...
func (o *SearchObjectsDefault) Error() string {
	return fmt.Sprintf("[GET /public/restore/objects][%d] SearchObjects default  %+v", o._statusCode, o.Payload)
}
...
func (o *SearchObjectsDefault) GetPayload() *models.RequestError {
	return o.Payload
}
