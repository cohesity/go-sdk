...
func (o *SearchObjectsOK) Error() string {
	...
	return fmt.Sprintf("[GET /public/restore/objects][%d] searchObjectsOK %s", 200, payload)
}
...
func (o *SearchObjectsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/restore/objects][%d] SearchObjects default %s", o._statusCode, payload)
}
