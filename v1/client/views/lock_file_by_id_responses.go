...
func (o *LockFileByIDOK) Error() string {
	return fmt.Sprintf("[POST /public/views/id/{id}/fileLocks][%d] lockFileByIdOK  %+v", 200, o.Payload)
}
...
func (o *LockFileByIDDefault) Error() string {
	return fmt.Sprintf("[POST /public/views/id/{id}/fileLocks][%d] LockFileById default  %+v", o._statusCode, o.Payload)
}
