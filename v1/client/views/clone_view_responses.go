...
func (o *CloneViewCreated) Error() string {
	return fmt.Sprintf("[POST /public/views/clone][%d] cloneViewCreated  %+v", 201, o.Payload)
}
...
func (o *CloneViewDefault) Error() string {
	return fmt.Sprintf("[POST /public/views/clone][%d] CloneView default  %+v", o._statusCode, o.Payload)
}
