...
func (o *UpdateViewUserQuotaCreated) Error() string {
	return fmt.Sprintf("[PUT /public/viewUserQuotas][%d] updateViewUserQuotaCreated  %+v", 201, o.Payload)
}
...
func (o *UpdateViewUserQuotaDefault) Error() string {
	return fmt.Sprintf("[PUT /public/viewUserQuotas][%d] UpdateViewUserQuota default  %+v", o._statusCode, o.Payload)
}
