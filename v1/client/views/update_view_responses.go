...
func (o *UpdateViewOK) Error() string {
	return fmt.Sprintf("[PUT /public/views][%d] updateViewOK  %+v", 200, o.Payload)
}
...
func (o *UpdateViewDefault) Error() string {
	return fmt.Sprintf("[PUT /public/views][%d] UpdateView default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateViewDefault) GetPayload() *models.RequestError {
	return o.Payload
}
