...
func (o *CreateViewUserQuotaOK) Error() string {
	return fmt.Sprintf("[POST /public/viewUserQuotas][%d] createViewUserQuotaOK  %+v", 200, o.Payload)
}
...
func (o *CreateViewUserQuotaDefault) Error() string {
	return fmt.Sprintf("[POST /public/viewUserQuotas][%d] CreateViewUserQuota default  %+v", o._statusCode, o.Payload)
}
