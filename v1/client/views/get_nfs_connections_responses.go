...
func (o *GetNfsConnectionsOK) Error() string {
	return fmt.Sprintf("[GET /public/nfsConnections][%d] getNfsConnectionsOK  %+v", 200, o.Payload)
}
...
func (o *GetNfsConnectionsDefault) Error() string {
	return fmt.Sprintf("[GET /public/nfsConnections][%d] GetNfsConnections default  %+v", o._statusCode, o.Payload)
}
