...
func (o *GetViewByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/views/id/{id}][%d] getViewByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetViewByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/views/id/{id}][%d] GetViewById default  %+v", o._statusCode, o.Payload)
}
