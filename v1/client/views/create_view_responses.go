...
func (o *CreateViewCreated) Error() string {
	return fmt.Sprintf("[POST /public/views][%d] createViewCreated  %+v", 201, o.Payload)
}
...
func (o *CreateViewDefault) Error() string {
	return fmt.Sprintf("[POST /public/views][%d] CreateView default  %+v", o._statusCode, o.Payload)
}
