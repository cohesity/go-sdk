...
// WithViewBoxIDList adds the viewBoxIds to the get views params
func (o *GetViewsParams) WithViewBoxIDList(viewBoxIds []int64) *GetViewsParams {
	o.SetViewBoxIDList(viewBoxIds)
	return o
}

// SetViewBoxIDList adds the viewBoxIds to the get views params
func (o *GetViewsParams) SetViewBoxIDList(viewBoxIds []int64) {
	o.ViewBoxIDList = viewBoxIds
}

// WithViewBoxNameList adds the viewBoxNames to the get views params
func (o *GetViewsParams) WithViewBoxNameList(viewBoxNames []string) *GetViewsParams {
	o.SetViewBoxNameList(viewBoxNames)
	return o
}

// SetViewBoxNameList adds the viewBoxNames to the get views params
func (o *GetViewsParams) SetViewBoxNameList(viewBoxNames []string) {
	o.ViewBoxNameList = viewBoxNames
}

// WithViewIDList adds the viewIds to the get views params
func (o *GetViewsParams) WithViewIDList(viewIds []int64) *GetViewsParams {
	o.SetViewIDList(viewIds)
	return o
}

// SetViewIDList adds the viewIds to the get views params
func (o *GetViewsParams) SetViewIDList(viewIds []int64) {
	o.ViewIDList = viewIds
}

// WithViewNameList adds the viewNames to the get views params
func (o *GetViewsParams) WithViewNameList(viewNames []string) *GetViewsParams {
	o.SetViewNameList(viewNames)
	return o
}

// SetViewNameList adds the viewNames to the get views params
func (o *GetViewsParams) SetViewNameList(viewNames []string) {
	o.ViewNameList = viewNames
}
...
func (o *GetViewsParams) bindParamViewBoxNames(formats strfmt.Registry) []string {
	viewBoxNamesIR := o.ViewBoxNameList
