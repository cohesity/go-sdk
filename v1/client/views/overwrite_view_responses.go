...
func (o *OverwriteViewOK) Error() string {
	return fmt.Sprintf("[POST /public/views/overwrite][%d] overwriteViewOK  %+v", 200, o.Payload)
}
...
func (o *OverwriteViewDefault) Error() string {
	return fmt.Sprintf("[POST /public/views/overwrite][%d] OverwriteView default  %+v", o._statusCode, o.Payload)
}
