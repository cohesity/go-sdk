...
func (o *GetFileLockStatusOK) Error() string {
	return fmt.Sprintf("[GET /public/views/{name}/fileLocks][%d] getFileLockStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetFileLockStatusDefault) Error() string {
	return fmt.Sprintf("[GET /public/views/{name}/fileLocks][%d] GetFileLockStatus default  %+v", o._statusCode, o.Payload)
}
