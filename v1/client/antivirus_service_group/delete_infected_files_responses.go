...
func (o *DeleteInfectedFilesOK) Error() string {
	return fmt.Sprintf("[DELETE /public/infectedFiles][%d] deleteInfectedFilesOK  %+v", 200, o.Payload)
}
...
func (o *DeleteInfectedFilesDefault) Error() string {
	return fmt.Sprintf("[DELETE /public/infectedFiles][%d] DeleteInfectedFiles default  %+v", o._statusCode, o.Payload)
}
