...
func (o *DeleteInfectedFilesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteInfectedFilesOK()
...
// NewDeleteInfectedFilesOK creates a DeleteInfectedFilesOK with default headers values
func NewDeleteInfectedFilesOK() *DeleteInfectedFilesOK {
	return &DeleteInfectedFilesOK{}
}

/*
DeleteInfectedFilesOK describes a response with status code 200, with default header values.

Success
*/
type DeleteInfectedFilesOK struct {
	Payload *models.DeleteInfectedFileResponse
}

// IsSuccess returns true when this delete infected files o k response has a 2xx status code
func (o *DeleteInfectedFilesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete infected files o k response has a 3xx status code
func (o *DeleteInfectedFilesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete infected files o k response has a 4xx status code
func (o *DeleteInfectedFilesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete infected files o k response has a 5xx status code
func (o *DeleteInfectedFilesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete infected files o k response a status code equal to that given
func (o *DeleteInfectedFilesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete infected files o k response
func (o *DeleteInfectedFilesOK) Code() int {
	return 200
}

func (o *DeleteInfectedFilesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /public/infectedFiles][%d] deleteInfectedFilesOK %s", 200, payload)
}

func (o *DeleteInfectedFilesOK) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /public/infectedFiles][%d] deleteInfectedFilesOK %s", 200, payload)
}

func (o *DeleteInfectedFilesOK) GetPayload() *models.DeleteInfectedFileResponse {
	return o.Payload
}

func (o *DeleteInfectedFilesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.DeleteInfectedFileResponse)
...
func (o *DeleteInfectedFilesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /public/infectedFiles][%d] DeleteInfectedFiles default %s", o._statusCode, payload)
}
...
func (o *DeleteInfectedFilesDefault) GetPayload() *models.RequestError {
	return o.Payload
}
