...
func (o *UpdateAntivirusServiceGroupOK) Error() string {
	return fmt.Sprintf("[PUT /public/antivirusGroups][%d] updateAntivirusServiceGroupOK  %+v", 200, o.Payload)
}
...
func (o *UpdateAntivirusServiceGroupDefault) Error() string {
	return fmt.Sprintf("[PUT /public/antivirusGroups][%d] UpdateAntivirusServiceGroup default  %+v", o._statusCode, o.Payload)
}
