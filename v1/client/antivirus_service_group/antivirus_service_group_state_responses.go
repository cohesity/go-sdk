...
func (o *AntivirusServiceGroupStateOK) Error() string {
	return fmt.Sprintf("[PUT /public/antivirusGroups/states][%d] antivirusServiceGroupStateOK  %+v", 200, o.Payload)
}
...
func (o *AntivirusServiceGroupStateDefault) Error() string {
	return fmt.Sprintf("[PUT /public/antivirusGroups/states][%d] AntivirusServiceGroupState default  %+v", o._statusCode, o.Payload)
}
