...
// WithViewNameList adds the viewNames to the get infected files params
func (o *GetInfectedFilesParams) WithViewNameList(viewNames []string) *GetInfectedFilesParams {
	o.SetViewNameList(viewNames)
	return o
}

// SetViewNameList adds the viewNames to the get infected files params
func (o *GetInfectedFilesParams) SetViewNameList(viewNames []string) {
