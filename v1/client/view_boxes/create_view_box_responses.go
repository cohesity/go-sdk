...
func (o *CreateViewBoxCreated) Error() string {
	return fmt.Sprintf("[POST /public/viewBoxes][%d] createViewBoxCreated  %+v", 201, o.Payload)
}
...
func (o *CreateViewBoxDefault) Error() string {
	return fmt.Sprintf("[POST /public/viewBoxes][%d] CreateViewBox default  %+v", o._statusCode, o.Payload)
}
