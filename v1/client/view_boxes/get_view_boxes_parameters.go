...
// WithClusterPartitionIDList adds the clusterPartitionIds to the get view boxes params
func (o *GetViewBoxesParams) WithClusterPartitionIDList(clusterPartitionIds []int64) *GetViewBoxesParams {
	o.SetClusterPartitionIDList(clusterPartitionIds)
	return o
}

// SetClusterPartitionIDList adds the clusterPartitionIds to the get view boxes params
func (o *GetViewBoxesParams) SetClusterPartitionIDList(clusterPartitionIds []int64) {
	o.ClusterPartitionIDList = clusterPartitionIds
}
...
// WithIDList adds the ids to the get view boxes params
func (o *GetViewBoxesParams) WithIDList(ids []int64) *GetViewBoxesParams {
	o.SetIDList(ids)
	return o
}

// SetIDList adds the ids to the get view boxes params
func (o *GetViewBoxesParams) SetIDList(ids []int64) {
	o.IDList = ids
}
...
// WithNameList adds the names to the get view boxes params
func (o *GetViewBoxesParams) WithNameList(names []string) *GetViewBoxesParams {
	o.SetNameList(names)
	return o
}

// SetNameList adds the names to the get view boxes params
func (o *GetViewBoxesParams) SetNameList(names []string) {
	o.NameList = names
}
...
func (o *GetViewBoxesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ClusterPartitionIDList != nil {
...
func (o *GetViewBoxesParams) bindParamClusterPartitionIds(formats strfmt.Registry) []string {
	clusterPartitionIdsIR := o.ClusterPartitionIDList
