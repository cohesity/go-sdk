...
// WithPurpose adds the purpose to the get view boxes params
func (o *GetViewBoxesParams) WithPurpose(purpose []string) *GetViewBoxesParams {
	o.SetPurpose(purpose)
	return o
}

// SetPurpose adds the purpose to the get view boxes params
func (o *GetViewBoxesParams) SetPurpose(purpose []string) {
	o.Purpose = purpose
}
...
// bindParamGetViewBoxes binds the parameter purpose
func (o *GetViewBoxesParams) bindParamPurpose(formats strfmt.Registry) []string {
	purposeIR := o.Purpose
