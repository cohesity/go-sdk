...
type ClientService interface {
	...
	PerformAppInstanceActions(params *PerformAppInstanceActionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PerformAppInstanceActionsOK, error)
...
**Privileges:** ```APP_LAUNCH``` <br><br>For performing various actions on the installed app instance. Fetch appInstanceId using GET /public/appInstances API.
*/
func (a *Client) PerformAppInstanceActions(params *PerformAppInstanceActionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PerformAppInstanceActionsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
