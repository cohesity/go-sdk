...
type ClientService interface {
	...
	PerformAppInstanceActions(params *PerformAppInstanceActionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PerformAppInstanceActionsAccepted, error)
...
*/
func (a *Client) PerformAppInstanceActions(params *PerformAppInstanceActionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PerformAppInstanceActionsAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	success, ok := result.(*PerformAppInstanceActionsAccepted)
	if ok {
		return success, nil
	}
	// unexpected success response
