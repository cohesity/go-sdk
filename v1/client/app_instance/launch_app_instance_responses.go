...
func (o *LaunchAppInstanceAccepted) Error() string {
	return fmt.Sprintf("[POST /public/appInstances][%d] launchAppInstanceAccepted  %+v", 202, o.Payload)
}
...
func (o *LaunchAppInstanceDefault) Error() string {
	return fmt.Sprintf("[POST /public/appInstances][%d] LaunchAppInstance default  %+v", o._statusCode, o.Payload)
}
