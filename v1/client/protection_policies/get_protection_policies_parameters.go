...
// WithFetchReplicatedPolicies adds the includeReplicated to the get protection policies params
func (o *GetProtectionPoliciesParams) WithFetchReplicatedPolicies(includeReplicated *bool) *GetProtectionPoliciesParams {
	o.SetFetchReplicatedPolicies(includeReplicated)
	return o
}

// SetFetchReplicatedPolicies adds the includeReplicated to the get protection policies params
func (o *GetProtectionPoliciesParams) SetFetchReplicatedPolicies(includeReplicated *bool) {
	o.FetchReplicatedPolicies = includeReplicated
}
...
func (o *GetProtectionPoliciesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.FetchReplicatedPolicies != nil {

		// query param includeReplicated
		var qrIncludeReplicated bool

		if o.FetchReplicatedPolicies != nil {
			qrIncludeReplicated = *o.FetchReplicatedPolicies
		}
		qIncludeReplicated := swag.FormatBool(qrIncludeReplicated)
		if qIncludeReplicated != "" {

			if err := r.SetQueryParam("includeReplicated", qIncludeReplicated); err != nil {
				return err
			}
		}
	}
