...
// WithIncludeReplicated adds the includeReplicated to the get protection policies params
func (o *GetProtectionPoliciesParams) WithIncludeReplicated(includeReplicated *bool) *GetProtectionPoliciesParams {
	o.SetIncludeReplicated(includeReplicated)
	return o
}

// SetIncludeReplicated adds the includeReplicated to the get protection policies params
func (o *GetProtectionPoliciesParams) SetIncludeReplicated(includeReplicated *bool) {
	o.IncludeReplicated = includeReplicated
}
...
func (o *GetProtectionPoliciesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeReplicated != nil {

		// query param includeReplicated
		var qrIncludeReplicated bool

		if o.IncludeReplicated != nil {
			qrIncludeReplicated = *o.IncludeReplicated
		}
