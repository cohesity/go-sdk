...
func (o *GetProtectionPolicyByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/protectionPolicies/{id}][%d] getProtectionPolicyByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionPolicyByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/protectionPolicies/{id}][%d] GetProtectionPolicyById default  %+v", o._statusCode, o.Payload)
}
