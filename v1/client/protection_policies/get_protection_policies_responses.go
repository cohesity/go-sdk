...
func (o *GetProtectionPoliciesOK) Error() string {
	return fmt.Sprintf("[GET /public/protectionPolicies][%d] getProtectionPoliciesOK  %+v", 200, o.Payload)
}
...
func (o *GetProtectionPoliciesDefault) Error() string {
	return fmt.Sprintf("[GET /public/protectionPolicies][%d] GetProtectionPolicies default  %+v", o._statusCode, o.Payload)
}
