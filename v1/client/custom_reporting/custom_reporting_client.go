...
// New creates a new custom reporting API client with basic auth credentials.
...
// New creates a new custom reporting API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
**Privileges:** ```CLUSTER_MODIFY, CUSTOM_REPORTING_VIEW``` <br><br>Returns the list of node information running postgres database.
*/
