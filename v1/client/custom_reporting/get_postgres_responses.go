...
func (o *GetPostgresOK) Error() string {
	...
	return fmt.Sprintf("[GET /public/postgres][%d] getPostgresOK %s", 200, payload)
}
...
func (o *GetPostgresDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/postgres][%d] GetPostgres default %s", o._statusCode, payload)
}
