...
type GetPostgresOK struct {
	Payload []*models.PostgresNodeInfo
}
...
func (o *GetPostgresOK) Error() string {
	return fmt.Sprintf("[GET /public/postgres][%d] getPostgresOK  %+v", 200, o.Payload)
}
...
func (o *GetPostgresOK) GetPayload() []*models.PostgresNodeInfo {
	return o.Payload
}
...
func (o *GetPostgresDefault) Error() string {
	return fmt.Sprintf("[GET /public/postgres][%d] GetPostgres default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetPostgresDefault) GetPayload() *models.RequestError {
	return o.Payload
}
