...
type DeleteKmsConfigParams struct {
	...
	/* Body.
	   ...
	   Request to delete kms config.
	*/
	Body *models.KmsDeleteParams
...
// WithBody adds the body to the delete kms config params
func (o *DeleteKmsConfigParams) WithBody(body *models.KmsDeleteParams) *DeleteKmsConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete kms config params
func (o *DeleteKmsConfigParams) SetBody(body *models.KmsDeleteParams) {
	o.Body = body
}
