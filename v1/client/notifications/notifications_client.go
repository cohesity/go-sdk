...
type ClientService interface {
	...
	UpdateNotifications(params *UpdateNotificationsParams, opts ...ClientOption) (*UpdateNotificationsNoContent, error)
...
*/
func (a *Client) UpdateNotifications(params *UpdateNotificationsParams, opts ...ClientOption) (*UpdateNotificationsNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
