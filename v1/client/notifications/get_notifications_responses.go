...
func (o *GetNotificationsOK) Error() string {
	return fmt.Sprintf("[GET /public/sessionUser/notifications][%d] getNotificationsOK  %+v", 200, o.Payload)
}
...
func (o *GetNotificationsDefault) Error() string {
	return fmt.Sprintf("[GET /public/sessionUser/notifications][%d] GetNotifications default  %+v", o._statusCode, o.Payload)
}
