...
func (o *UpdateClusterOK) Error() string {
	return fmt.Sprintf("[PUT /public/cluster][%d] updateClusterOK  %+v", 200, o.Payload)
}
...
func (o *UpdateClusterDefault) Error() string {
	return fmt.Sprintf("[PUT /public/cluster][%d] UpdateCluster default  %+v", o._statusCode, o.Payload)
}
