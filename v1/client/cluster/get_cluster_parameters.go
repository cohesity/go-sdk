...
type GetClusterParams struct {
	...
	*/
	...
	needed to support based on fault tolerance configured and
	EC configuration on all storage domains.
	*/
	IncludeMinimumFailureDomainsInfo *bool
...
// WithIncludeMinimumFailureDomainsInfo adds the includeMinimumNodesInfo to the get cluster params
func (o *GetClusterParams) WithIncludeMinimumFailureDomainsInfo(includeMinimumNodesInfo *bool) *GetClusterParams {
	o.SetIncludeMinimumFailureDomainsInfo(includeMinimumNodesInfo)
	return o
}

// SetIncludeMinimumFailureDomainsInfo adds the includeMinimumNodesInfo to the get cluster params
func (o *GetClusterParams) SetIncludeMinimumFailureDomainsInfo(includeMinimumNodesInfo *bool) {
	o.IncludeMinimumFailureDomainsInfo = includeMinimumNodesInfo
}
...
func (o *GetClusterParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeMinimumFailureDomainsInfo != nil {

		// query param includeMinimumNodesInfo
		var qrIncludeMinimumNodesInfo bool

		if o.IncludeMinimumFailureDomainsInfo != nil {
			qrIncludeMinimumNodesInfo = *o.IncludeMinimumFailureDomainsInfo
		}
