...
func (o *GetBasicClusterInfoOK) Error() string {
	return fmt.Sprintf("[GET /public/basicClusterInfo][%d] getBasicClusterInfoOK  %+v", 200, o.Payload)
}
...
func (o *GetBasicClusterInfoDefault) Error() string {
	return fmt.Sprintf("[GET /public/basicClusterInfo][%d] GetBasicClusterInfo default  %+v", o._statusCode, o.Payload)
}
