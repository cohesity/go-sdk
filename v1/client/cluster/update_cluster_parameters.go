...
type UpdateClusterParams struct {
	...
	*/
	Body *models.UpdateClusterParams
...
func (o *UpdateClusterParams) WithBody(body *models.UpdateClusterParams) *UpdateClusterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update cluster params
func (o *UpdateClusterParams) SetBody(body *models.UpdateClusterParams) {
	o.Body = body
}
