...
func (o *GetClusterOK) Error() string {
	return fmt.Sprintf("[GET /public/cluster][%d] getClusterOK  %+v", 200, o.Payload)
}
...
func (o *GetClusterDefault) Error() string {
	return fmt.Sprintf("[GET /public/cluster][%d] GetCluster default  %+v", o._statusCode, o.Payload)
}
