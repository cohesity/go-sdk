...
func (o *DownloadPackageAccepted) Error() string {
	return fmt.Sprintf("[POST /public/packages/url][%d] downloadPackageAccepted  %+v", 202, o.Payload)
}
...
func (o *DownloadPackageDefault) Error() string {
	return fmt.Sprintf("[POST /public/packages/url][%d] DownloadPackage default  %+v", o._statusCode, o.Payload)
}
