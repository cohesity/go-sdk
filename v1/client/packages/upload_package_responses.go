...
func (o *UploadPackageOK) Error() string {
	return fmt.Sprintf("[POST /public/packages/file][%d] uploadPackageOK  %+v", 200, o.Payload)
}
...
func (o *UploadPackageDefault) Error() string {
	return fmt.Sprintf("[POST /public/packages/file][%d] UploadPackage default  %+v", o._statusCode, o.Payload)
}
