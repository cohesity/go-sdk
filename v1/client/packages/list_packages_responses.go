...
func (o *ListPackagesOK) Error() string {
	return fmt.Sprintf("[GET /public/packages][%d] listPackagesOK  %+v", 200, o.Payload)
}
...
func (o *ListPackagesDefault) Error() string {
	return fmt.Sprintf("[GET /public/packages][%d] ListPackages default  %+v", o._statusCode, o.Payload)
}
