...
type ClientService interface {
	RecoverVms(params *RecoverVmsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RecoverVmsOK, error)
...
func (a *Client) RecoverVms(params *RecoverVmsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*RecoverVmsOK, error) {
	...
	op := &runtime.ClientOperation{
		...
		Params:             params,
		Reader:             &RecoverVmsReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*RecoverVmsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*RecoverVmsDefault)
