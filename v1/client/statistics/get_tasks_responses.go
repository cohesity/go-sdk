...
func (o *GetTasksOK) Error() string {
	return fmt.Sprintf("[GET /public/tasks/status][%d] getTasksOK  %+v", 200, o.Payload)
}
...
func (o *GetTasksDefault) Error() string {
	return fmt.Sprintf("[GET /public/tasks/status][%d] GetTasks default  %+v", o._statusCode, o.Payload)
}
