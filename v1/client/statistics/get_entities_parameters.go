...
type GetEntitiesParams struct {
	...
	*/
	...
	/* FilterCriteria.
	   ...
	   Specifies a FIQL filter criteria to filter the entities.
	*/
...
// WithFilterCriteria adds the filterCriteria to the get entities params
func (o *GetEntitiesParams) WithFilterCriteria(filterCriteria *string) *GetEntitiesParams {
	o.SetFilterCriteria(filterCriteria)
	return o
}

// SetFilterCriteria adds the filterCriteria to the get entities params
func (o *GetEntitiesParams) SetFilterCriteria(filterCriteria *string) {
...
func (o *GetEntitiesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.FilterCriteria != nil {
		...
		// query param filterCriteria
		var qrFilterCriteria string

		if o.FilterCriteria != nil {
			qrFilterCriteria = *o.FilterCriteria
		}
		qFilterCriteria := qrFilterCriteria
		if qFilterCriteria != "" {

			if err := r.SetQueryParam("filterCriteria", qFilterCriteria); err != nil {
				return err
			}
		}
	}
