...
func (o *ListProtectionSourcesOK) Error() string {
	return fmt.Sprintf("[GET /public/protectionSources][%d] listProtectionSourcesOK  %+v", 200, o.Payload)
}
...
func (o *ListProtectionSourcesDefault) Error() string {
	return fmt.Sprintf("[GET /public/protectionSources][%d] ListProtectionSources default  %+v", o._statusCode, o.Payload)
}
