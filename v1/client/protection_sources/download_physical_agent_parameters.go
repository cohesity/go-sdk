...
// WithLinuxPkgType adds the pkgType to the download physical agent params
func (o *DownloadPhysicalAgentParams) WithLinuxPkgType(pkgType *string) *DownloadPhysicalAgentParams {
	o.SetLinuxPkgType(pkgType)
	return o
}

// SetLinuxPkgType adds the pkgType to the download physical agent params
func (o *DownloadPhysicalAgentParams) SetLinuxPkgType(pkgType *string) {
	o.LinuxPkgType = pkgType
}
...
func (o *DownloadPhysicalAgentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.LinuxPkgType != nil {

		// query param pkgType
		var qrPkgType string

		if o.LinuxPkgType != nil {
			qrPkgType = *o.LinuxPkgType
		}
		qPkgType := qrPkgType
		if qPkgType != "" {
