...
type ListProtectionSourcesRootNodesParams struct {
	...
	*/
	...
	kPhysicalFiles, kIbmFlashSystem, kIsilon, kGPFS, kKVM, kAWS, kExchange,
	kHyperVVSS, kOracle, kGCP, kFlashBlade, kAWSNative, kO365, kO365Outlook,
	kHyperFlex, kGCPNative, kAzureNative, kKubernetes, kElastifile, kAD,
