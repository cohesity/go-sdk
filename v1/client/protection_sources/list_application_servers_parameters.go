...
// WithIncludeExternalMetadata adds the includeExternalMetadata to the list application servers params
func (o *ListApplicationServersParams) WithIncludeExternalMetadata(includeExternalMetadata *bool) *ListApplicationServersParams {
	o.SetIncludeExternalMetadata(includeExternalMetadata)
	return o
}

// SetIncludeExternalMetadata adds the includeExternalMetadata to the list application servers params
func (o *ListApplicationServersParams) SetIncludeExternalMetadata(includeExternalMetadata *bool) {
