...
func (o *UnregisterApplicationServersOK) Error() string {
	return fmt.Sprintf("[DELETE /public/protectionSources/applicationServers/{id}][%d] unregisterApplicationServersOK  %+v", 200, o.Payload)
}
...
func (o *UnregisterApplicationServersDefault) Error() string {
	return fmt.Sprintf("[DELETE /public/protectionSources/applicationServers/{id}][%d] UnregisterApplicationServers default  %+v", o._statusCode, o.Payload)
}
