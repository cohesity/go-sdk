...
type ListProtectionSourcesParams struct {
	...
	*/
	...
	from being returned.
	*/
	ExcludeGoogleWorkspaceTypes []string
...
// WithCountryList adds the countryList to the list protection sources params
func (o *ListProtectionSourcesParams) WithCountryList(countryList []string) *ListProtectionSourcesParams {
	o.SetCountryList(countryList)
	return o
}

// SetCountryList adds the countryList to the list protection sources params
func (o *ListProtectionSourcesParams) SetCountryList(countryList []string) {
	o.CountryList = countryList
}

// WithDepartmentList adds the departmentList to the list protection sources params
func (o *ListProtectionSourcesParams) WithDepartmentList(departmentList []string) *ListProtectionSourcesParams {
	o.SetDepartmentList(departmentList)
	return o
}

// SetDepartmentList adds the departmentList to the list protection sources params
func (o *ListProtectionSourcesParams) SetDepartmentList(departmentList []string) {
...
// WithExcludeGcpTypes adds the excludeGcpTypes to the list protection sources params
func (o *ListProtectionSourcesParams) WithExcludeGcpTypes(excludeGcpTypes []string) *ListProtectionSourcesParams {
	o.SetExcludeGcpTypes(excludeGcpTypes)
	return o
}

// SetExcludeGcpTypes adds the excludeGcpTypes to the list protection sources params
func (o *ListProtectionSourcesParams) SetExcludeGcpTypes(excludeGcpTypes []string) {
	o.ExcludeGcpTypes = excludeGcpTypes
}

// WithExcludeGoogleWorkspaceTypes adds the excludeGoogleWorkspaceTypes to the list protection sources params
func (o *ListProtectionSourcesParams) WithExcludeGoogleWorkspaceTypes(excludeGoogleWorkspaceTypes []string) *ListProtectionSourcesParams {
	o.SetExcludeGoogleWorkspaceTypes(excludeGoogleWorkspaceTypes)
	return o
}

// SetExcludeGoogleWorkspaceTypes adds the excludeGoogleWorkspaceTypes to the list protection sources params
func (o *ListProtectionSourcesParams) SetExcludeGoogleWorkspaceTypes(excludeGoogleWorkspaceTypes []string) {
...
// WithIncludeGroupAndTeamSite adds the includeGroupAndTeamSite to the list protection sources params
func (o *ListProtectionSourcesParams) WithIncludeGroupAndTeamSite(includeGroupAndTeamSite *bool) *ListProtectionSourcesParams {
	o.SetIncludeGroupAndTeamSite(includeGroupAndTeamSite)
	return o
}

// SetIncludeGroupAndTeamSite adds the includeGroupAndTeamSite to the list protection sources params
func (o *ListProtectionSourcesParams) SetIncludeGroupAndTeamSite(includeGroupAndTeamSite *bool) {
...
// WithIncludeTeamsGroup adds the includeTeamsGroup to the list protection sources params
func (o *ListProtectionSourcesParams) WithIncludeTeamsGroup(includeTeamsGroup *bool) *ListProtectionSourcesParams {
	o.SetIncludeTeamsGroup(includeTeamsGroup)
	return o
}

// SetIncludeTeamsGroup adds the includeTeamsGroup to the list protection sources params
func (o *ListProtectionSourcesParams) SetIncludeTeamsGroup(includeTeamsGroup *bool) {
...
// WithName adds the name to the list protection sources params
func (o *ListProtectionSourcesParams) WithName(name *string) *ListProtectionSourcesParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the list protection sources params
func (o *ListProtectionSourcesParams) SetName(name *string) {
	o.Name = name
}
...
// WithPaginationCookie adds the paginationCookie to the list protection sources params
func (o *ListProtectionSourcesParams) WithPaginationCookie(paginationCookie *string) *ListProtectionSourcesParams {
	o.SetPaginationCookie(paginationCookie)
	return o
}

// SetPaginationCookie adds the paginationCookie to the list protection sources params
func (o *ListProtectionSourcesParams) SetPaginationCookie(paginationCookie *string) {
...
// WithTitleList adds the titleList to the list protection sources params
func (o *ListProtectionSourcesParams) WithTitleList(titleList []string) *ListProtectionSourcesParams {
	o.SetTitleList(titleList)
	return o
}

// SetTitleList adds the titleList to the list protection sources params
func (o *ListProtectionSourcesParams) SetTitleList(titleList []string) {
...
// bindParamListProtectionSources binds the parameter countryList
func (o *ListProtectionSourcesParams) bindParamCountryList(formats strfmt.Registry) []string {
...
// bindParamListProtectionSources binds the parameter departmentList
func (o *ListProtectionSourcesParams) bindParamDepartmentList(formats strfmt.Registry) []string {
...
// bindParamListProtectionSources binds the parameter excludeGcpTypes
func (o *ListProtectionSourcesParams) bindParamExcludeGcpTypes(formats strfmt.Registry) []string {
	excludeGcpTypesIR := o.ExcludeGcpTypes

	var excludeGcpTypesIC []string
	for _, excludeGcpTypesIIR := range excludeGcpTypesIR { // explode []string

		excludeGcpTypesIIV := excludeGcpTypesIIR // string as string
...
// bindParamListProtectionSources binds the parameter excludeGoogleWorkspaceTypes
func (o *ListProtectionSourcesParams) bindParamExcludeGoogleWorkspaceTypes(formats strfmt.Registry) []string {
	excludeGoogleWorkspaceTypesIR := o.ExcludeGoogleWorkspaceTypes

	var excludeGoogleWorkspaceTypesIC []string
	for _, excludeGoogleWorkspaceTypesIIR := range excludeGoogleWorkspaceTypesIR { // explode []string

		excludeGoogleWorkspaceTypesIIV := excludeGoogleWorkspaceTypesIIR // string as string
...
// bindParamListProtectionSources binds the parameter titleList
func (o *ListProtectionSourcesParams) bindParamTitleList(formats strfmt.Registry) []string {
