...
func (o *SearchPrincipalsOK) Error() string {
	return fmt.Sprintf("[GET /public/principals/searchPrincipals][%d] searchPrincipalsOK  %+v", 200, o.Payload)
}
...
func (o *SearchPrincipalsDefault) Error() string {
	return fmt.Sprintf("[GET /public/principals/searchPrincipals][%d] SearchPrincipals default  %+v", o._statusCode, o.Payload)
}
