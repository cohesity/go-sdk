...
type DeleteUsersParams struct {
	...
	*/
	Body *models.UserDeleteParameters
...
func (o *DeleteUsersParams) WithBody(body *models.UserDeleteParameters) *DeleteUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete users params
func (o *DeleteUsersParams) SetBody(body *models.UserDeleteParameters) {
	o.Body = body
}
