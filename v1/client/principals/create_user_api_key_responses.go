...
func (o *CreateUserAPIKeyCreated) Error() string {
	...
	return fmt.Sprintf("[POST /public/users/{sid}/apiKeys][%d] createUserApiKeyCreated %s", 201, payload)
}
...
func (o *CreateUserAPIKeyDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /public/users/{sid}/apiKeys][%d] CreateUserApiKey default %s", o._statusCode, payload)
}
