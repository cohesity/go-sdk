...
func (o *CreateUserAPIKeyCreated) Error() string {
	return fmt.Sprintf("[POST /public/users/{sid}/apiKeys][%d] createUserApiKeyCreated  %+v", 201, o.Payload)
}
...
func (o *CreateUserAPIKeyCreated) GetPayload() *models.CreatedAPIKey {
	return o.Payload
}
...
func (o *CreateUserAPIKeyDefault) Error() string {
	return fmt.Sprintf("[POST /public/users/{sid}/apiKeys][%d] CreateUserApiKey default  %+v", o._statusCode, o.Payload)
}
...
func (o *CreateUserAPIKeyDefault) GetPayload() *models.RequestError {
	return o.Payload
}
