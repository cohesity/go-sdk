...
type GetUsersParams struct {
	...
	*/
	...
	/* IncludeOnlyTenantsUsers.

	     Providing this option will only return tenant users and
	will not include out any local users
	*/
	IncludeOnlyTenantsUsers *bool
...
// WithIncludeOnlyTenantsUsers adds the includeOnlyTenantsUsers to the get users params
func (o *GetUsersParams) WithIncludeOnlyTenantsUsers(includeOnlyTenantsUsers *bool) *GetUsersParams {
	o.SetIncludeOnlyTenantsUsers(includeOnlyTenantsUsers)
	return o
}

// SetIncludeOnlyTenantsUsers adds the includeOnlyTenantsUsers to the get users params
func (o *GetUsersParams) SetIncludeOnlyTenantsUsers(includeOnlyTenantsUsers *bool) {
	o.IncludeOnlyTenantsUsers = includeOnlyTenantsUsers
}
...
func (o *GetUsersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeOnlyTenantsUsers != nil {

		// query param includeOnlyTenantsUsers
		var qrIncludeOnlyTenantsUsers bool

		if o.IncludeOnlyTenantsUsers != nil {
			qrIncludeOnlyTenantsUsers = *o.IncludeOnlyTenantsUsers
		}
		qIncludeOnlyTenantsUsers := swag.FormatBool(qrIncludeOnlyTenantsUsers)
		if qIncludeOnlyTenantsUsers != "" {

			if err := r.SetQueryParam("includeOnlyTenantsUsers", qIncludeOnlyTenantsUsers); err != nil {
				return err
			}
		}
	}
