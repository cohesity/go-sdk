...
func (o *GetUserAPIKeysOK) Error() string {
	return fmt.Sprintf("[GET /public/users/{sid}/apiKeys][%d] getUserApiKeysOK  %+v", 200, o.Payload)
}
...
func (o *GetUserAPIKeysOK) GetPayload() []*models.APIKey {
	return o.Payload
}
...
func (o *GetUserAPIKeysDefault) Error() string {
	return fmt.Sprintf("[GET /public/users/{sid}/apiKeys][%d] GetUserApiKeys default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetUserAPIKeysDefault) GetPayload() *models.RequestError {
	return o.Payload
}
