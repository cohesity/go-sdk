...
func (o *GetUserAPIKeysOK) Error() string {
	...
	return fmt.Sprintf("[GET /public/users/{sid}/apiKeys][%d] getUserApiKeysOK %s", 200, payload)
}
...
func (o *GetUserAPIKeysDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /public/users/{sid}/apiKeys][%d] GetUserApiKeys default %s", o._statusCode, payload)
}
