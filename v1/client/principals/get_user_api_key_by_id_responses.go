...
func (o *GetUserAPIKeyByIDOK) Error() string {
	return fmt.Sprintf("[GET /public/users/{sid}/apiKeys/{id}][%d] getUserApiKeyByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetUserAPIKeyByIDDefault) Error() string {
	return fmt.Sprintf("[GET /public/users/{sid}/apiKeys/{id}][%d] GetUserApiKeyById default  %+v", o._statusCode, o.Payload)
}
