...
type ClientService interface {
	...
	CreateUserAPIKey(params *CreateUserAPIKeyParams, opts ...ClientOption) (*CreateUserAPIKeyCreated, error)

	DeleteUserAPIKey(params *DeleteUserAPIKeyParams, opts ...ClientOption) (*DeleteUserAPIKeyNoContent, error)

	DeleteUsers(params *DeleteUsersParams, opts ...ClientOption) (*DeleteUsersNoContent, error)

	GetAllUserAPIKeys(params *GetAllUserAPIKeysParams, opts ...ClientOption) (*GetAllUserAPIKeysOK, error)

	GetSessionUser(params *GetSessionUserParams, opts ...ClientOption) (*GetSessionUserOK, error)

	GetUserAPIKeyByID(params *GetUserAPIKeyByIDParams, opts ...ClientOption) (*GetUserAPIKeyByIDOK, error)

	GetUserAPIKeys(params *GetUserAPIKeysParams, opts ...ClientOption) (*GetUserAPIKeysOK, error)

	GetUserPrivileges(params *GetUserPrivilegesParams, opts ...ClientOption) (*GetUserPrivilegesOK, error)

	GetUsers(params *GetUsersParams, opts ...ClientOption) (*GetUsersOK, error)

	LinuxSupportUserBashShellAccess(params *LinuxSupportUserBashShellAccessParams, opts ...ClientOption) (*LinuxSupportUserBashShellAccessAccepted, error)

	LinuxSupportUserSudoAccess(params *LinuxSupportUserSudoAccessParams, opts ...ClientOption) (*LinuxSupportUserSudoAccessAccepted, error)

	ListSourcesForPrincipals(params *ListSourcesForPrincipalsParams, opts ...ClientOption) (*ListSourcesForPrincipalsOK, error)

	ResetS3SecretKey(params *ResetS3SecretKeyParams, opts ...ClientOption) (*ResetS3SecretKeyOK, error)

	RotateUserAPIKey(params *RotateUserAPIKeyParams, opts ...ClientOption) (*RotateUserAPIKeyOK, error)

	SearchPrincipals(params *SearchPrincipalsParams, opts ...ClientOption) (*SearchPrincipalsOK, error)

	UpdateLinuxCredentials(params *UpdateLinuxCredentialsParams, opts ...ClientOption) (*UpdateLinuxCredentialsAccepted, error)

	UpdateSourcesForPrincipals(params *UpdateSourcesForPrincipalsParams, opts ...ClientOption) (*UpdateSourcesForPrincipalsNoContent, error)

	UpdateUser(params *UpdateUserParams, opts ...ClientOption) (*UpdateUserOK, error)

	UpdateUserAPIKey(params *UpdateUserAPIKeyParams, opts ...ClientOption) (*UpdateUserAPIKeyOK, error)

	VerifyOtpCode(params *VerifyOtpCodeParams, opts ...ClientOption) (*VerifyOtpCodeOK, error)
...
*/
func (a *Client) CreateUserAPIKey(params *CreateUserAPIKeyParams, opts ...ClientOption) (*CreateUserAPIKeyCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) DeleteUserAPIKey(params *DeleteUserAPIKeyParams, opts ...ClientOption) (*DeleteUserAPIKeyNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) DeleteUsers(params *DeleteUsersParams, opts ...ClientOption) (*DeleteUsersNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetAllUserAPIKeys(params *GetAllUserAPIKeysParams, opts ...ClientOption) (*GetAllUserAPIKeysOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetSessionUser(params *GetSessionUserParams, opts ...ClientOption) (*GetSessionUserOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetUserAPIKeyByID(params *GetUserAPIKeyByIDParams, opts ...ClientOption) (*GetUserAPIKeyByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetUserAPIKeys(params *GetUserAPIKeysParams, opts ...ClientOption) (*GetUserAPIKeysOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetUserPrivileges(params *GetUserPrivilegesParams, opts ...ClientOption) (*GetUserPrivilegesOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) LinuxSupportUserBashShellAccess(params *LinuxSupportUserBashShellAccessParams, opts ...ClientOption) (*LinuxSupportUserBashShellAccessAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) LinuxSupportUserSudoAccess(params *LinuxSupportUserSudoAccessParams, opts ...ClientOption) (*LinuxSupportUserSudoAccessAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ListSourcesForPrincipals(params *ListSourcesForPrincipalsParams, opts ...ClientOption) (*ListSourcesForPrincipalsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ResetS3SecretKey(params *ResetS3SecretKeyParams, opts ...ClientOption) (*ResetS3SecretKeyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) RotateUserAPIKey(params *RotateUserAPIKeyParams, opts ...ClientOption) (*RotateUserAPIKeyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SearchPrincipals(params *SearchPrincipalsParams, opts ...ClientOption) (*SearchPrincipalsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateLinuxCredentials(params *UpdateLinuxCredentialsParams, opts ...ClientOption) (*UpdateLinuxCredentialsAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
permissions for.
*/
func (a *Client) UpdateSourcesForPrincipals(params *UpdateSourcesForPrincipalsParams, opts ...ClientOption) (*UpdateSourcesForPrincipalsNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateUserAPIKey(params *UpdateUserAPIKeyParams, opts ...ClientOption) (*UpdateUserAPIKeyOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) VerifyOtpCode(params *VerifyOtpCodeParams, opts ...ClientOption) (*VerifyOtpCodeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
