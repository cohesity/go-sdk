...
func (o *CreateUserCreated) Error() string {
	return fmt.Sprintf("[POST /public/users][%d] createUserCreated  %+v", 201, o.Payload)
}
...
func (o *CreateUserDefault) Error() string {
	return fmt.Sprintf("[POST /public/users][%d] CreateUser default  %+v", o._statusCode, o.Payload)
}
