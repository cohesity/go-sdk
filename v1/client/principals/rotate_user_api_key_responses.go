...
func (o *RotateUserAPIKeyOK) Error() string {
	return fmt.Sprintf("[POST /public/users/{sid}/apiKeys/{id}/rotate][%d] rotateUserApiKeyOK  %+v", 200, o.Payload)
}
...
func (o *RotateUserAPIKeyDefault) Error() string {
	return fmt.Sprintf("[POST /public/users/{sid}/apiKeys/{id}/rotate][%d] RotateUserApiKey default  %+v", o._statusCode, o.Payload)
}
