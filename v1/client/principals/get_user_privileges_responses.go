...
func (o *GetUserPrivilegesOK) Error() string {
	return fmt.Sprintf("[GET /public/users/privileges][%d] getUserPrivilegesOK  %+v", 200, o.Payload)
}
...
func (o *GetUserPrivilegesDefault) Error() string {
	return fmt.Sprintf("[GET /public/users/privileges][%d] GetUserPrivileges default  %+v", o._statusCode, o.Payload)
}
