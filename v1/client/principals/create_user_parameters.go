...
func (o *CreateUserParams) WithBody(body *models.UserParameters) *CreateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create user params
func (o *CreateUserParams) SetBody(body *models.UserParameters) {
	o.Body = body
}
