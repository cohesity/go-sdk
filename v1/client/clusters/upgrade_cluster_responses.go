...
func (o *UpgradeClusterAccepted) Error() string {
	return fmt.Sprintf("[PUT /public/clusters/software][%d] upgradeClusterAccepted  %+v", 202, o.Payload)
}
...
func (o *UpgradeClusterDefault) Error() string {
	return fmt.Sprintf("[PUT /public/clusters/software][%d] UpgradeCluster default  %+v", o._statusCode, o.Payload)
}
