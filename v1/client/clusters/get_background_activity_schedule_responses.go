...
func (o *GetBackgroundActivityScheduleOK) Error() string {
	return fmt.Sprintf("[GET /public/cluster/backgroundActivitySchedule][%d] getBackgroundActivityScheduleOK  %+v", 200, o.Payload)
}
...
func (o *GetBackgroundActivityScheduleDefault) Error() string {
	return fmt.Sprintf("[GET /public/cluster/backgroundActivitySchedule][%d] GetBackgroundActivitySchedule default  %+v", o._statusCode, o.Payload)
}
