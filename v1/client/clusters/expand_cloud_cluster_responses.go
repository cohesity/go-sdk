...
func (o *ExpandCloudClusterAccepted) Error() string {
	return fmt.Sprintf("[POST /public/clusters/cloudEdition/nodes][%d] expandCloudClusterAccepted  %+v", 202, o.Payload)
}
...
func (o *ExpandCloudClusterDefault) Error() string {
	return fmt.Sprintf("[POST /public/clusters/cloudEdition/nodes][%d] ExpandCloudCluster default  %+v", o._statusCode, o.Payload)
}
