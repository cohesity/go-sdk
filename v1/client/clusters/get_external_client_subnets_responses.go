...
func (o *GetExternalClientSubnetsOK) Error() string {
	return fmt.Sprintf("[GET /public/externalClientSubnets][%d] getExternalClientSubnetsOK  %+v", 200, o.Payload)
}
...
func (o *GetExternalClientSubnetsDefault) Error() string {
	return fmt.Sprintf("[GET /public/externalClientSubnets][%d] GetExternalClientSubnets default  %+v", o._statusCode, o.Payload)
}
