...
func (o *ExpandPhysicalClusterAccepted) Error() string {
	return fmt.Sprintf("[POST /public/clusters/physicalEdition/nodes][%d] expandPhysicalClusterAccepted  %+v", 202, o.Payload)
}
...
func (o *ExpandPhysicalClusterDefault) Error() string {
	return fmt.Sprintf("[POST /public/clusters/physicalEdition/nodes][%d] ExpandPhysicalCluster default  %+v", o._statusCode, o.Payload)
}
