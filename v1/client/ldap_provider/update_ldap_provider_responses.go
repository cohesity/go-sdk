...
func (o *UpdateLdapProviderCreated) Error() string {
	return fmt.Sprintf("[PUT /public/ldapProvider][%d] updateLdapProviderCreated  %+v", 201, o.Payload)
}
...
func (o *UpdateLdapProviderDefault) Error() string {
	return fmt.Sprintf("[PUT /public/ldapProvider][%d] UpdateLdapProvider default  %+v", o._statusCode, o.Payload)
}
