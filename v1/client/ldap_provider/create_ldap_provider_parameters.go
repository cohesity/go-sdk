...
// WithBody adds the body to the create ldap provider params
func (o *CreateLdapProviderParams) WithBody(body *models.LdapProvider) *CreateLdapProviderParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create ldap provider params
func (o *CreateLdapProviderParams) SetBody(body *models.LdapProvider) {
	o.Body = body
}
