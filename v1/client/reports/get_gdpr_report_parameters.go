...
// WithObjectIds adds the id to the get gdpr report params
func (o *GetGdprReportParams) WithObjectIds(id []int64) *GetGdprReportParams {
	o.SetObjectIds(id)
	return o
}

// SetObjectIds adds the id to the get gdpr report params
func (o *GetGdprReportParams) SetObjectIds(id []int64) {
	o.ObjectIds = id
}
