...
type ClientService interface {
	GetAgentDeploymentReport(params *GetAgentDeploymentReportParams, opts ...ClientOption) (*GetAgentDeploymentReportOK, error)

	GetCloudArchiveReportRequest(params *GetCloudArchiveReportRequestParams, opts ...ClientOption) (*GetCloudArchiveReportRequestOK, error)

	GetDataTransferFromVaultsReportRequest(params *GetDataTransferFromVaultsReportRequestParams, opts ...ClientOption) (*GetDataTransferFromVaultsReportRequestOK, error)

	GetDataTransferToVaultsReportRequest(params *GetDataTransferToVaultsReportRequestParams, opts ...ClientOption) (*GetDataTransferToVaultsReportRequestOK, error)

	GetGdprReport(params *GetGdprReportParams, opts ...ClientOption) (*GetGdprReportOK, error)

	GetProtectedObjectsTrendsReportRequest(params *GetProtectedObjectsTrendsReportRequestParams, opts ...ClientOption) (*GetProtectedObjectsTrendsReportRequestOK, error)

	GetProtectionSourcesJobRunsReportRequest(params *GetProtectionSourcesJobRunsReportRequestParams, opts ...ClientOption) (*GetProtectionSourcesJobRunsReportRequestOK, error)

	GetProtectionSourcesJobsSummaryReportRequest(params *GetProtectionSourcesJobsSummaryReportRequestParams, opts ...ClientOption) (*GetProtectionSourcesJobsSummaryReportRequestOK, error)
...
*/
func (a *Client) GetAgentDeploymentReport(params *GetAgentDeploymentReportParams, opts ...ClientOption) (*GetAgentDeploymentReportOK, error) {
...
*/
func (a *Client) GetCloudArchiveReportRequest(params *GetCloudArchiveReportRequestParams, opts ...ClientOption) (*GetCloudArchiveReportRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetDataTransferFromVaultsReportRequest(params *GetDataTransferFromVaultsReportRequestParams, opts ...ClientOption) (*GetDataTransferFromVaultsReportRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
This archive data is stored on Tapes and in Cloud Vaults.
*/
func (a *Client) GetDataTransferToVaultsReportRequest(params *GetDataTransferToVaultsReportRequestParams, opts ...ClientOption) (*GetDataTransferToVaultsReportRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetGdprReport(params *GetGdprReportParams, opts ...ClientOption) (*GetGdprReportOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetProtectedObjectsTrendsReportRequest(params *GetProtectedObjectsTrendsReportRequestParams, opts ...ClientOption) (*GetProtectedObjectsTrendsReportRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetProtectionSourcesJobRunsReportRequest(params *GetProtectionSourcesJobRunsReportRequestParams, opts ...ClientOption) (*GetProtectionSourcesJobRunsReportRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetProtectionSourcesJobsSummaryReportRequest(params *GetProtectionSourcesJobsSummaryReportRequestParams, opts ...ClientOption) (*GetProtectionSourcesJobsSummaryReportRequestOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
