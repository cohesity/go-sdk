...
func (o *CreateBondOK) Error() string {
	return fmt.Sprintf("[POST /public/network/bonds][%d] createBondOK  %+v", 200, o.Payload)
}
...
func (o *CreateBondDefault) Error() string {
	return fmt.Sprintf("[POST /public/network/bonds][%d] CreateBond default  %+v", o._statusCode, o.Payload)
}
