...
func (o *CreateIPConfigOK) Error() string {
	return fmt.Sprintf("[POST /public/network/ipConfig][%d] createIpConfigOK  %+v", 200, o.Payload)
}
...
func (o *CreateIPConfigDefault) Error() string {
	return fmt.Sprintf("[POST /public/network/ipConfig][%d] CreateIpConfig default  %+v", o._statusCode, o.Payload)
}
