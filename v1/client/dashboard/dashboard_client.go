...
type ClientService interface {
	GetDashboard(params *GetDashboardParams, opts ...ClientOption) (*GetDashboardOK, error)
...
*/
func (a *Client) GetDashboard(params *GetDashboardParams, opts ...ClientOption) (*GetDashboardOK, error) {
