...
func (o *GetDashboardOK) Error() string {
	return fmt.Sprintf("[GET /public/dashboard][%d] getDashboardOK  %+v", 200, o.Payload)
}
...
func (o *GetDashboardDefault) Error() string {
	return fmt.Sprintf("[GET /public/dashboard][%d] GetDashboard default  %+v", o._statusCode, o.Payload)
}
