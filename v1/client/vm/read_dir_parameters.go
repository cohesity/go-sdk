...
type ReadDirParams struct {
	...
	*/
	...
	/* S3BrowsingCookie.
	     ...
	     Cookie that will be used in case of S3 portal based non-indexed browse
	requests.
	*/
	S3BrowsingCookie *string
...
// WithS3BrowsingCookie adds the s3BrowsingCookie to the read dir params
func (o *ReadDirParams) WithS3BrowsingCookie(s3BrowsingCookie *string) *ReadDirParams {
	o.SetS3BrowsingCookie(s3BrowsingCookie)
	return o
}

// SetS3BrowsingCookie adds the s3BrowsingCookie to the read dir params
func (o *ReadDirParams) SetS3BrowsingCookie(s3BrowsingCookie *string) {
	o.S3BrowsingCookie = s3BrowsingCookie
}
...
func (o *ReadDirParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.S3BrowsingCookie != nil {

		// query param s3BrowsingCookie
		var qrS3BrowsingCookie string

		if o.S3BrowsingCookie != nil {
			qrS3BrowsingCookie = *o.S3BrowsingCookie
		}
		qS3BrowsingCookie := qrS3BrowsingCookie
		if qS3BrowsingCookie != "" {

			if err := r.SetQueryParam("s3BrowsingCookie", qS3BrowsingCookie); err != nil {
				return err
			}
		}
	}
