...
type ClientService interface {
	CreateBifrostVlan(params *CreateBifrostVlanParams, opts ...ClientOption) (*CreateBifrostVlanOK, error)

	CreateVlan(params *CreateVlanParams, opts ...ClientOption) (*CreateVlanOK, error)

	GetBifrostTenantVlans(params *GetBifrostTenantVlansParams, opts ...ClientOption) (*GetBifrostTenantVlansOK, error)

	GetVlanByID(params *GetVlanByIDParams, opts ...ClientOption) (*GetVlanByIDOK, error)

	GetVlans(params *GetVlansParams, opts ...ClientOption) (*GetVlansOK, error)

	RemoveVlan(params *RemoveVlanParams, opts ...ClientOption) (*RemoveVlanNoContent, error)
...
*/
func (a *Client) CreateBifrostVlan(params *CreateBifrostVlanParams, opts ...ClientOption) (*CreateBifrostVlanOK, error) {
...
*/
func (a *Client) CreateVlan(params *CreateVlanParams, opts ...ClientOption) (*CreateVlanOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetBifrostTenantVlans(params *GetBifrostTenantVlansParams, opts ...ClientOption) (*GetBifrostTenantVlansOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetVlanByID(params *GetVlanByIDParams, opts ...ClientOption) (*GetVlanByIDOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) RemoveVlan(params *RemoveVlanParams, opts ...ClientOption) (*RemoveVlanNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
/*
UpdateVlan updates a specific v l a n of the cohesity cluster

Returns the updated VLAN on the Cohesity Cluster.
*/
