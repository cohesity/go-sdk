...
func (o *CreateBifrostVlanOK) Error() string {
	return fmt.Sprintf("[POST /public/bifrost/vlans][%d] createBifrostVlanOK  %+v", 200, o.Payload)
}
...
func (o *CreateBifrostVlanDefault) Error() string {
	return fmt.Sprintf("[POST /public/bifrost/vlans][%d] CreateBifrostVlan default  %+v", o._statusCode, o.Payload)
}
