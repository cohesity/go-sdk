...
func (o *GetBifrostTenantVlansOK) Error() string {
	return fmt.Sprintf("[GET /public/bifrost/vlans][%d] getBifrostTenantVlansOK  %+v", 200, o.Payload)
}
...
func (o *GetBifrostTenantVlansDefault) Error() string {
	return fmt.Sprintf("[GET /public/bifrost/vlans][%d] GetBifrostTenantVlans default  %+v", o._statusCode, o.Payload)
}
