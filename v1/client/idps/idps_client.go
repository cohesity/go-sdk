...
type ClientService interface {
	AddIdpDirectoryPrincipals(params *AddIdpDirectoryPrincipalsParams, opts ...ClientOption) (*AddIdpDirectoryPrincipalsCreated, error)

	CreateIdp(params *CreateIdpParams, opts ...ClientOption) (*CreateIdpCreated, error)

	DeleteIdp(params *DeleteIdpParams, opts ...ClientOption) (*DeleteIdpNoContent, error)

	GetIdps(params *GetIdpsParams, opts ...ClientOption) (*GetIdpsOK, error)

	IdpLogin(params *IdpLoginParams, opts ...ClientOption) error

	UpdateIdp(params *UpdateIdpParams, opts ...ClientOption) (*UpdateIdpOK, error)
...
*/
func (a *Client) AddIdpDirectoryPrincipals(params *AddIdpDirectoryPrincipalsParams, opts ...ClientOption) (*AddIdpDirectoryPrincipalsCreated, error) {
...
*/
func (a *Client) CreateIdp(params *CreateIdpParams, opts ...ClientOption) (*CreateIdpCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) DeleteIdp(params *DeleteIdpParams, opts ...ClientOption) (*DeleteIdpNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) GetIdps(params *GetIdpsParams, opts ...ClientOption) (*GetIdpsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) IdpLogin(params *IdpLoginParams, opts ...ClientOption) error {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) UpdateIdp(params *UpdateIdpParams, opts ...ClientOption) (*UpdateIdpOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
