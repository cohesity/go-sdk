...
func (o *UpdateIdpOK) Error() string {
	return fmt.Sprintf("[PUT /public/idps/{id}][%d] updateIdpOK  %+v", 200, o.Payload)
}
...
func (o *UpdateIdpDefault) Error() string {
	return fmt.Sprintf("[PUT /public/idps/{id}][%d] UpdateIdp default  %+v", o._statusCode, o.Payload)
}
