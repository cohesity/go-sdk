...
func (o *GetInterfaceGroupsOK) Error() string {
	return fmt.Sprintf("[GET /public/interfaceGroups][%d] getInterfaceGroupsOK  %+v", 200, o.Payload)
}
...
func (o *GetInterfaceGroupsDefault) Error() string {
	return fmt.Sprintf("[GET /public/interfaceGroups][%d] GetInterfaceGroups default  %+v", o._statusCode, o.Payload)
}
