...
var storagePolicyTypeCompressionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		storagePolicyTypeCompressionPropEnum = append(storagePolicyTypeCompressionPropEnum, v)
	}
}

const (

	// StoragePolicyCompressionKCompressionNone captures enum value "kCompressionNone"
	StoragePolicyCompressionKCompressionNone string = "kCompressionNone"

	// StoragePolicyCompressionKCompressionLow captures enum value "kCompressionLow"
	StoragePolicyCompressionKCompressionLow string = "kCompressionLow"

	// StoragePolicyCompressionKCompressionHigh captures enum value "kCompressionHigh"
	StoragePolicyCompressionKCompressionHigh string = "kCompressionHigh"
)

// prop value enum
func (m *StoragePolicy) validateCompressionEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, storagePolicyTypeCompressionPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *StoragePolicy) validateCompression(formats strfmt.Registry) error {
...
var storagePolicyTypeEncryptionLevelPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		storagePolicyTypeEncryptionLevelPropEnum = append(storagePolicyTypeEncryptionLevelPropEnum, v)
	}
}

const (

	// StoragePolicyEncryptionLevelKEncryptionNone captures enum value "kEncryptionNone"
	StoragePolicyEncryptionLevelKEncryptionNone string = "kEncryptionNone"

	// StoragePolicyEncryptionLevelKEncryptionStrong captures enum value "kEncryptionStrong"
	StoragePolicyEncryptionLevelKEncryptionStrong string = "kEncryptionStrong"

	// StoragePolicyEncryptionLevelKEncryptionWeak captures enum value "kEncryptionWeak"
	StoragePolicyEncryptionLevelKEncryptionWeak string = "kEncryptionWeak"
)

// prop value enum
func (m *StoragePolicy) validateEncryptionLevelEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, storagePolicyTypeEncryptionLevelPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *StoragePolicy) validateEncryptionLevel(formats strfmt.Registry) error {
