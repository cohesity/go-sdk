...
type StoragePolicy struct {
	...
	// Specifies the redundancy type of the Storage Domain.
	// This value is read-only and is derived from the configured
	// numDiskFailuresTolerated and erasureCodingParams fields.
	// Read Only: true
