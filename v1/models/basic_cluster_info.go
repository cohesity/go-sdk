...
type BasicClusterInfo struct {
	...
	// Specifies the deployment type of Cohesity Software.
	...
	// Specifies hardware models and vendors for nodes in the cluster.
...
var basicClusterInfoTypeClusterDeploymentTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		basicClusterInfoTypeClusterDeploymentTypePropEnum = append(basicClusterInfoTypeClusterDeploymentTypePropEnum, v)
	}
}

const (

	// BasicClusterInfoClusterDeploymentTypeKStandAlone captures enum value "kStandAlone"
	BasicClusterInfoClusterDeploymentTypeKStandAlone string = "kStandAlone"

	// BasicClusterInfoClusterDeploymentTypeKCDC captures enum value "kCDC"
	BasicClusterInfoClusterDeploymentTypeKCDC string = "kCDC"

	// BasicClusterInfoClusterDeploymentTypeKIBMBaaS captures enum value "kIBMBaaS"
	BasicClusterInfoClusterDeploymentTypeKIBMBaaS string = "kIBMBaaS"
)

// prop value enum
func (m *BasicClusterInfo) validateClusterDeploymentTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, basicClusterInfoTypeClusterDeploymentTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *BasicClusterInfo) validateClusterDeploymentType(formats strfmt.Registry) error {
...
const (
	...
	// BasicClusterInfoClusterTypeKOciCloud captures enum value "kOciCloud"
	BasicClusterInfoClusterTypeKOciCloud string = "kOciCloud"
)
...
func (m *BasicClusterInfo) validateHardwareInfo(formats strfmt.Registry) error {
...
var basicClusterInfoTypeSoftwareTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		basicClusterInfoTypeSoftwareTypePropEnum = append(basicClusterInfoTypeSoftwareTypePropEnum, v)
	}
}

const (

	// BasicClusterInfoSoftwareTypeKOneHelios captures enum value "kOneHelios"
	BasicClusterInfoSoftwareTypeKOneHelios string = "kOneHelios"

	// BasicClusterInfoSoftwareTypeKRegular captures enum value "kRegular"
	BasicClusterInfoSoftwareTypeKRegular string = "kRegular"
)

// prop value enum
func (m *BasicClusterInfo) validateSoftwareTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, basicClusterInfoTypeSoftwareTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *BasicClusterInfo) validateSoftwareType(formats strfmt.Registry) error {
...
func (m *BasicClusterInfo) contextValidateHardwareInfo(ctx context.Context, formats strfmt.Registry) error {
