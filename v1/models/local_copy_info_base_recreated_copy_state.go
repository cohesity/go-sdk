...
type LocalCopyInfoBaseRecreatedCopyState struct {
	...
	// Denotes the universal id of the retrieval task created in case hydration
	// was requested. This is set when a hydration is kicked off through the
	// PerformRetrieveArchiveTask API in RecreateLocalCopyTask.
	RetrievalTaskUID *UniversalIDProto `json:"retrievalTaskUid,omitempty"`
...
func (m *LocalCopyInfoBaseRecreatedCopyState) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRetrievalTaskUID(formats); err != nil {
		res = append(res, err)
	}
...
func (m *LocalCopyInfoBaseRecreatedCopyState) validateRetrievalTaskUID(formats strfmt.Registry) error {
	if swag.IsZero(m.RetrievalTaskUID) { // not required
		return nil
	}

	if m.RetrievalTaskUID != nil {
		if err := m.RetrievalTaskUID.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("retrievalTaskUid")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("retrievalTaskUid")
			}
			return err
		}
	}
...
func (m *LocalCopyInfoBaseRecreatedCopyState) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRetrievalTaskUID(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *LocalCopyInfoBaseRecreatedCopyState) contextValidateRetrievalTaskUID(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RetrievalTaskUID != nil {
		...
		if err := m.RetrievalTaskUID.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("retrievalTaskUid")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("retrievalTaskUid")
