...
type RestoredFileInfo struct {
	...
	// Field to hold environment specific params for download file request.
	EnvParams *EnvRestoreFilesParams `json:"envParams,omitempty"`
	...
	IsWindowsDedupeVol *bool `json:"isWindowsDedupeVol,omitempty"`
...
func (m *RestoredFileInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateEnvParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoredFileInfo) validateEnvParams(formats strfmt.Registry) error {
	if swag.IsZero(m.EnvParams) { // not required
		return nil
	}

	if m.EnvParams != nil {
		if err := m.EnvParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("envParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("envParams")
			}
			return err
		}
	}
...
// ContextValidate validate this restored file info based on the context it is used
func (m *RestoredFileInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateEnvParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoredFileInfo) contextValidateEnvParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.EnvParams != nil {
		...
		if err := m.EnvParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("envParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("envParams")
