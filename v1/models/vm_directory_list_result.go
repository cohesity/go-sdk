...
// VMDirectoryListResult VM Directory List Result.
//
// VmDirectoryListResult is a struct containing information about each
// directory entry.
//
// swagger:model VmDirectoryListResult
type VMDirectoryListResult struct {
	...
	Entries []*VMDirEntry `json:"entries"`
}

// Validate validates this Vm directory list result
func (m *VMDirectoryListResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VMDirectoryListResult) validateEntries(formats strfmt.Registry) error {
...
// ContextValidate validate this Vm directory list result based on the context it is used
func (m *VMDirectoryListResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *VMDirectoryListResult) contextValidateEntries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VMDirectoryListResult) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VMDirectoryListResult) UnmarshalBinary(b []byte) error {
	var res VMDirectoryListResult
