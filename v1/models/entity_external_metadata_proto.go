...
// Extensions defined under base path: magneto/connectors/
// extensions                        Location                              No.
// ============================================================================
// azure_sql_entity_metadata        azure/azure.proto                      100
// generic_adapter_entity_metadata  generic_adapter/generic_adapter.proto  101
// azure_kubernetes_entity_metadata
//
...
type EntityExternalMetadataProto struct {
	...
	// Stores the set of pending certificate actions (ADD/DELETE) to be
	// processed for this entity. These actions are applied via
	// perform_certificate_actions_op (triggered via AlarmHandler).
	CertificateActions *CertificateActions `json:"certificateActions,omitempty"`

	// Connector params required to connect to different type of environment.
	CredentialVec []*AppCredentials `json:"credentialVec"`
	...
	// Tag attributes associated with this entity created by the user via the
	// cohesity UI (to be consumed in future epic).
	UserTagAttributesVec []*TagAttributeProto `json:"userTagAttributesVec"`
}
...
func (m *EntityExternalMetadataProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateCertificateActions(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateUserTagAttributesVec(formats); err != nil {
		res = append(res, err)
	}
...
func (m *EntityExternalMetadataProto) validateCertificateActions(formats strfmt.Registry) error {
	if swag.IsZero(m.CertificateActions) { // not required
		return nil
	}

	if m.CertificateActions != nil {
		if err := m.CertificateActions.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("certificateActions")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("certificateActions")
			}
			return err
		}
	}
...
func (m *EntityExternalMetadataProto) validateUserTagAttributesVec(formats strfmt.Registry) error {
	if swag.IsZero(m.UserTagAttributesVec) { // not required
		return nil
	}

	for i := 0; i < len(m.UserTagAttributesVec); i++ {
		if swag.IsZero(m.UserTagAttributesVec[i]) { // not required
			continue
		}

		if m.UserTagAttributesVec[i] != nil {
			if err := m.UserTagAttributesVec[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("userTagAttributesVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("userTagAttributesVec" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *EntityExternalMetadataProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateCertificateActions(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateUserTagAttributesVec(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *EntityExternalMetadataProto) contextValidateCertificateActions(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.CertificateActions != nil {
		...
		if err := m.CertificateActions.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("certificateActions")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("certificateActions")
...
func (m *EntityExternalMetadataProto) contextValidateUserTagAttributesVec(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.UserTagAttributesVec); i++ {
		...
		if m.UserTagAttributesVec[i] != nil {
			...
			if err := m.UserTagAttributesVec[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("userTagAttributesVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("userTagAttributesVec" + "." + strconv.Itoa(i))
