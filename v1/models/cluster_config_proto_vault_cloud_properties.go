...
type ClusterConfigProtoVaultCloudProperties struct {
	...
	// ibm cos properties
	IbmCosProperties *ClusterConfigProtoVaultCloudPropertiesIBMCosProperties `json:"ibmCosProperties,omitempty"`
...
func (m *ClusterConfigProtoVaultCloudProperties) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateIbmCosProperties(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterConfigProtoVaultCloudProperties) validateIbmCosProperties(formats strfmt.Registry) error {
	if swag.IsZero(m.IbmCosProperties) { // not required
		return nil
	}

	if m.IbmCosProperties != nil {
		if err := m.IbmCosProperties.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ibmCosProperties")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ibmCosProperties")
			}
			return err
		}
	}
...
func (m *ClusterConfigProtoVaultCloudProperties) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIbmCosProperties(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ClusterConfigProtoVaultCloudProperties) contextValidateIbmCosProperties(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.IbmCosProperties != nil {
		...
		if err := m.IbmCosProperties.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ibmCosProperties")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ibmCosProperties")
