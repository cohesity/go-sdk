...
func (m *O365AddSnapshotArg) validateGroupInfo(formats strfmt.Registry) error {
...
func (m *O365AddSnapshotArg) contextValidateGroupInfo(ctx context.Context, formats strfmt.Registry) error {
