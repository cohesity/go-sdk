...
// MountVolumesVMwareParams VMware specific additional params.
//
// swagger:model MountVolumesVMwareParams
...
// Validate validates this mount volumes v mware params
func (m *MountVolumesVMwareParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MountVolumesVMwareParams) validateTargetEntityCredentials(formats strfmt.Registry) error {
...
// ContextValidate validate this mount volumes v mware params based on the context it is used
func (m *MountVolumesVMwareParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MountVolumesVMwareParams) contextValidateTargetEntityCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MountVolumesVMwareParams) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MountVolumesVMwareParams) UnmarshalBinary(b []byte) error {
	var res MountVolumesVMwareParams
