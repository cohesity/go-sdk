...
// LdapProviderResponse LDAP Provider Response.
//
// LDAP provider response struct.
//
// swagger:model LdapProviderResponse
...
// Validate validates this ldap provider response
func (m *LdapProviderResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
var ldapProviderResponseTypeAuthTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		ldapProviderResponseTypeAuthTypePropEnum = append(ldapProviderResponseTypeAuthTypePropEnum, v)
	}
}

const (

	// LdapProviderResponseAuthTypeKAnonymous captures enum value "kAnonymous"
	LdapProviderResponseAuthTypeKAnonymous string = "kAnonymous"

	// LdapProviderResponseAuthTypeKSimple captures enum value "kSimple"
	LdapProviderResponseAuthTypeKSimple string = "kSimple"
)

// prop value enum
func (m *LdapProviderResponse) validateAuthTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, ldapProviderResponseTypeAuthTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *LdapProviderResponse) validateAuthType(formats strfmt.Registry) error {
...
// ContextValidate validates this ldap provider response based on context it is used
func (m *LdapProviderResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *LdapProviderResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LdapProviderResponse) UnmarshalBinary(b []byte) error {
	var res LdapProviderResponse
