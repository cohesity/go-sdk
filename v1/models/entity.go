...
func (m *Entity) validateServiceAnnotations(formats strfmt.Registry) error {
...
func (m *Entity) validateServicesToConnectorIdsMap(formats strfmt.Registry) error {
...
func (m *Entity) contextValidateServiceAnnotations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Entity) contextValidateServicesToConnectorIdsMap(ctx context.Context, formats strfmt.Registry) error {
