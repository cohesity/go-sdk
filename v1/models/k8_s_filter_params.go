...
type K8SFilterParams struct {
	...
	LabelEntityType *int32 `json:"labelEntityType,omitempty"`
	...
	// Information of the list of resource types that were filtered and the
	// specific resources that were selected for filtering of that type.
	// If this field is populated it assumes that the resources and
	// object_id field are not populated.
...
func (m *K8SFilterParams) validateSelectedResources(formats strfmt.Registry) error {
...
func (m *K8SFilterParams) contextValidateSelectedResources(ctx context.Context, formats strfmt.Registry) error {
