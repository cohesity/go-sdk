...
type O365BackupParams struct {
	...
	// If set to true, the backup is allowed to use the graph export items
	// APIs and workflow.
	AllowMailboxGraphExportBackup *bool `json:"allowMailboxGraphExportBackup,omitempty"`
	...
	// If set to true, we will capture the verification level for mailbox items
	// and folders downloaded as part of this backup op.
	ShouldCaptureDataVerificationLevel *bool `json:"shouldCaptureDataVerificationLevel,omitempty"`
	...
	// If set to true, we will record the download stats like downloaded data
	// size, download time for mailbox items.
	ShouldRecordItemDownloadStats *bool `json:"shouldRecordItemDownloadStats,omitempty"`
