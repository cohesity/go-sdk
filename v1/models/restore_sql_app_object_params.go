...
type RestoreSQLAppObjectParams struct {
	...
	// The destination location for the flat file recovery. This should not be
	// empty if the restore type is kRecoverAppFiles.
	// Note: In sql flat file recovery we don't support regex to move individual
	// files to separate directory and all the backups files will be copied to
	// this location.
	FlatFilesDestination *string `json:"flatFilesDestination,omitempty"`
