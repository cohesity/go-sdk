...
type RegisterRemoteCluster struct {
	...
	// replication.
	ViewBoxPairInfoList []*ViewBoxPairInfo `json:"viewBoxPairInfo"`
...
func (m *RegisterRemoteCluster) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateViewBoxPairInfoList(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisterRemoteCluster) validateViewBoxPairInfoList(formats strfmt.Registry) error {
	if swag.IsZero(m.ViewBoxPairInfoList) { // not required
		return nil
	}

	for i := 0; i < len(m.ViewBoxPairInfoList); i++ {
		if swag.IsZero(m.ViewBoxPairInfoList[i]) { // not required
			continue
		}

		if m.ViewBoxPairInfoList[i] != nil {
			if err := m.ViewBoxPairInfoList[i].Validate(formats); err != nil {
...
func (m *RegisterRemoteCluster) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateViewBoxPairInfoList(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisterRemoteCluster) contextValidateViewBoxPairInfoList(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ViewBoxPairInfoList); i++ {

		if m.ViewBoxPairInfoList[i] != nil {
			if err := m.ViewBoxPairInfoList[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("viewBoxPairInfo" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("viewBoxPairInfo" + "." + strconv.Itoa(i))
