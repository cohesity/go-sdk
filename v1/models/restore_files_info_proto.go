...
type RestoreFilesInfoProto struct {
	...
	// This consists of list of file paths to be downloaded from UI separately.
	// This can be used to send multiple files for download instead of single
	// file in download_files_path.
	DownloadFilesPathVec []*RestoreFilesInfoProtoDownloadFile `json:"downloadFilesPathVec"`
...
func (m *RestoreFilesInfoProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDownloadFilesPathVec(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreFilesInfoProto) validateDownloadFilesPathVec(formats strfmt.Registry) error {
	if swag.IsZero(m.DownloadFilesPathVec) { // not required
		return nil
	}

	for i := 0; i < len(m.DownloadFilesPathVec); i++ {
		if swag.IsZero(m.DownloadFilesPathVec[i]) { // not required
			continue
		}

		if m.DownloadFilesPathVec[i] != nil {
			if err := m.DownloadFilesPathVec[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("downloadFilesPathVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("downloadFilesPathVec" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *RestoreFilesInfoProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDownloadFilesPathVec(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreFilesInfoProto) contextValidateDownloadFilesPathVec(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.DownloadFilesPathVec); i++ {

		if m.DownloadFilesPathVec[i] != nil {
			if err := m.DownloadFilesPathVec[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("downloadFilesPathVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("downloadFilesPathVec" + "." + strconv.Itoa(i))
