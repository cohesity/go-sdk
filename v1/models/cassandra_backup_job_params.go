...
type CassandraBackupJobParams struct {
	...
	// Flag which determines whether live view is to be created for the current
	// log backup run.
	IsLogBackupLiveViewCreated *bool `json:"isLogBackupLiveViewCreated,omitempty"`
	...
	PreserveSourceSnapshotForInstantRecovery *bool `json:"preserveSourceSnapshotForInstantRecovery,omitempty"`
