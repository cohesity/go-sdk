...
type ProtectionSourceSnapshotInformation struct {
	...
	ScheduleType *string `json:"runType,omitempty"`
}
...
var protectionSourceSnapshotInformationTypeScheduleTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		protectionSourceSnapshotInformationTypeScheduleTypePropEnum = append(protectionSourceSnapshotInformationTypeScheduleTypePropEnum, v)
	}
}

const (

	// ProtectionSourceSnapshotInformationScheduleTypeKRegular captures enum value "kRegular"
	ProtectionSourceSnapshotInformationScheduleTypeKRegular string = "kRegular"

	// ProtectionSourceSnapshotInformationScheduleTypeKFull captures enum value "kFull"
	ProtectionSourceSnapshotInformationScheduleTypeKFull string = "kFull"

	// ProtectionSourceSnapshotInformationScheduleTypeKLog captures enum value "kLog"
	ProtectionSourceSnapshotInformationScheduleTypeKLog string = "kLog"

	// ProtectionSourceSnapshotInformationScheduleTypeKSystem captures enum value "kSystem"
	ProtectionSourceSnapshotInformationScheduleTypeKSystem string = "kSystem"
)

// prop value enum
func (m *ProtectionSourceSnapshotInformation) validateScheduleTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, protectionSourceSnapshotInformationTypeScheduleTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProtectionSourceSnapshotInformation) validateScheduleType(formats strfmt.Registry) error {
	if swag.IsZero(m.ScheduleType) { // not required
		return nil
	}

	// value enum
	if err := m.validateScheduleTypeEnum("runType", "body", *m.ScheduleType); err != nil {
		return err
	}
