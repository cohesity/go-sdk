...
type OracleSourceParams struct {
	...
	// NFS configuration for oracle source
	NfsParams *NFSParams `json:"nfsParams,omitempty"`
}
...
func (m *OracleSourceParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateNfsParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *OracleSourceParams) validateNfsParams(formats strfmt.Registry) error {
	if swag.IsZero(m.NfsParams) { // not required
		return nil
	}

	if m.NfsParams != nil {
		if err := m.NfsParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("nfsParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("nfsParams")
			}
			return err
		}
	}
...
func (m *OracleSourceParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateNfsParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *OracleSourceParams) contextValidateNfsParams(ctx context.Context, formats strfmt.Registry) error {

	if m.NfsParams != nil {
		if err := m.NfsParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("nfsParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("nfsParams")
