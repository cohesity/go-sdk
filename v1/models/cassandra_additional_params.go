...
type CassandraAdditionalParams struct {
	...
	// Info about select hosts of this cluster.
	// Used to determine if some hosts have moved to another cassandra cluster.
	HostInfoVec []*CassandraHostInfo `json:"hostInfoVec"`
...
func (m *CassandraAdditionalParams) validateHostInfoVec(formats strfmt.Registry) error {
...
func (m *CassandraAdditionalParams) contextValidateHostInfoVec(ctx context.Context, formats strfmt.Registry) error {
