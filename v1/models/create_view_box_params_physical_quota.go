...
// CreateViewBoxParamsPhysicalQuota Specifies an optional quota limit (in bytes) for the physical
...
//
// swagger:model createViewBoxParamsPhysicalQuota
type CreateViewBoxParamsPhysicalQuota struct {
	QuotaPolicy
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *CreateViewBoxParamsPhysicalQuota) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 QuotaPolicy
...
func (m CreateViewBoxParamsPhysicalQuota) MarshalJSON() ([]byte, error) {
...
// Validate validates this create view box params physical quota
func (m *CreateViewBoxParamsPhysicalQuota) Validate(formats strfmt.Registry) error {
	var res []error
...
// ContextValidate validate this create view box params physical quota based on the context it is used
func (m *CreateViewBoxParamsPhysicalQuota) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CreateViewBoxParamsPhysicalQuota) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CreateViewBoxParamsPhysicalQuota) UnmarshalBinary(b []byte) error {
	var res CreateViewBoxParamsPhysicalQuota
