...
type DataUptierJobParameters struct {
	...
	// Enum: [kLastAccessed kLastModified]
	FileUptierSelectionPolicy *string `json:"fileSelectionPolicy,omitempty"`
	...
	// Enum: [kGreaterThan kSmallerThan]
	FileUptierSizePolicy *string `json:"fileSizePolicy,omitempty"`
...
func (m *DataUptierJobParameters) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateFileUptierSelectionPolicy(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateFileUptierSizePolicy(formats); err != nil {
		res = append(res, err)
	}
...
var dataUptierJobParametersTypeFileUptierSelectionPolicyPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		dataUptierJobParametersTypeFileUptierSelectionPolicyPropEnum = append(dataUptierJobParametersTypeFileUptierSelectionPolicyPropEnum, v)
	}
}

const (

	// DataUptierJobParametersFileUptierSelectionPolicyKLastAccessed captures enum value "kLastAccessed"
	DataUptierJobParametersFileUptierSelectionPolicyKLastAccessed string = "kLastAccessed"

	// DataUptierJobParametersFileUptierSelectionPolicyKLastModified captures enum value "kLastModified"
	DataUptierJobParametersFileUptierSelectionPolicyKLastModified string = "kLastModified"
)

// prop value enum
func (m *DataUptierJobParameters) validateFileUptierSelectionPolicyEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, dataUptierJobParametersTypeFileUptierSelectionPolicyPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DataUptierJobParameters) validateFileUptierSelectionPolicy(formats strfmt.Registry) error {
	if swag.IsZero(m.FileUptierSelectionPolicy) { // not required
		return nil
	}

	// value enum
	if err := m.validateFileUptierSelectionPolicyEnum("fileSelectionPolicy", "body", *m.FileUptierSelectionPolicy); err != nil {
		return err
	}
...
var dataUptierJobParametersTypeFileUptierSizePolicyPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		dataUptierJobParametersTypeFileUptierSizePolicyPropEnum = append(dataUptierJobParametersTypeFileUptierSizePolicyPropEnum, v)
	}
}

const (

	// DataUptierJobParametersFileUptierSizePolicyKGreaterThan captures enum value "kGreaterThan"
	DataUptierJobParametersFileUptierSizePolicyKGreaterThan string = "kGreaterThan"

	// DataUptierJobParametersFileUptierSizePolicyKSmallerThan captures enum value "kSmallerThan"
	DataUptierJobParametersFileUptierSizePolicyKSmallerThan string = "kSmallerThan"
)

// prop value enum
func (m *DataUptierJobParameters) validateFileUptierSizePolicyEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, dataUptierJobParametersTypeFileUptierSizePolicyPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DataUptierJobParameters) validateFileUptierSizePolicy(formats strfmt.Registry) error {
	if swag.IsZero(m.FileUptierSizePolicy) { // not required
		return nil
	}

	// value enum
	if err := m.validateFileUptierSizePolicyEnum("fileSizePolicy", "body", *m.FileUptierSizePolicy); err != nil {
		return err
	}
