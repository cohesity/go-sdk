...
// VmwareCloneParameters VmWare Clone Parameters.
//
// Specifies the information required for recovering or cloning VmWare VMs.
//
// swagger:model VmwareCloneParameters
type VmwareCloneParameters struct {
	...
	KeepPoweredOn *bool `json:"poweredOn,omitempty"`
...
// Validate validates this vmware clone parameters
func (m *VmwareCloneParameters) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *VmwareCloneParameters) validateNetworkMappings(formats strfmt.Registry) error {
...
var vmwareCloneParametersTypeRecoveryProcessTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		vmwareCloneParametersTypeRecoveryProcessTypePropEnum = append(vmwareCloneParametersTypeRecoveryProcessTypePropEnum, v)
	}
}

const (

	// VmwareCloneParametersRecoveryProcessTypeKInstantRecovery captures enum value "kInstantRecovery"
	VmwareCloneParametersRecoveryProcessTypeKInstantRecovery string = "kInstantRecovery"

	// VmwareCloneParametersRecoveryProcessTypeKCopyRecovery captures enum value "kCopyRecovery"
	VmwareCloneParametersRecoveryProcessTypeKCopyRecovery string = "kCopyRecovery"
)

// prop value enum
func (m *VmwareCloneParameters) validateRecoveryProcessTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, vmwareCloneParametersTypeRecoveryProcessTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *VmwareCloneParameters) validateRecoveryProcessType(formats strfmt.Registry) error {
...
func (m *VmwareCloneParameters) validateOrgVdcNetwork(formats strfmt.Registry) error {
...
// ContextValidate validate this vmware clone parameters based on the context it is used
func (m *VmwareCloneParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *VmwareCloneParameters) contextValidateNetworkMappings(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VmwareCloneParameters) contextValidateOrgVdcNetwork(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VmwareCloneParameters) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *VmwareCloneParameters) UnmarshalBinary(b []byte) error {
	var res VmwareCloneParameters
