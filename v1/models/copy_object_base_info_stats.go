...
type CopyObjectBaseInfoStats struct {
	...
	// Total number of granular objects protected in this backup. This includes
	// both changed and unchanged objects protected in this backup run. Example
	// of granular objects: users, groups, apps in case of AAD backup.
	...
	// Note : The difference between num_changed_granular_objects and
	// num_successful_backed_granular_objects are the objects which got some
	// error during the backup operation.
