...
type RegisteredSourceInfo struct {
	...
	// Contains all the additional params specified by the user while registering
	// the MongoDB Physical source.
	MongodbPhysicalParams *MongoDBPhysicalParams `json:"mongodbPhysicalParams,omitempty"`
...
func (m *RegisteredSourceInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateMongodbPhysicalParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisteredSourceInfo) validateAzureParams(formats strfmt.Registry) error {
...
func (m *RegisteredSourceInfo) validateMongodbPhysicalParams(formats strfmt.Registry) error {
	if swag.IsZero(m.MongodbPhysicalParams) { // not required
		return nil
	}

	if m.MongodbPhysicalParams != nil {
		if err := m.MongodbPhysicalParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("mongodbPhysicalParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("mongodbPhysicalParams")
			}
			return err
		}
	}
...
func (m *RegisteredSourceInfo) validatePineconeParams(formats strfmt.Registry) error {
...
func (m *RegisteredSourceInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateMongodbPhysicalParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisteredSourceInfo) contextValidateAzureParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegisteredSourceInfo) contextValidateMongodbPhysicalParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.MongodbPhysicalParams != nil {
		...
		if err := m.MongodbPhysicalParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("mongodbPhysicalParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("mongodbPhysicalParams")
...
func (m *RegisteredSourceInfo) contextValidatePineconeParams(ctx context.Context, formats strfmt.Registry) error {
