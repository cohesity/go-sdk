...
type EntityVolumeInfo struct {
	...
	// Bus Type of the disk volume is from.
	BusType *int32 `json:"busType,omitempty"`
	...
	// Whether this volume supports files backup through the agent.
	FileBackupSupported *bool `json:"fileBackupSupported,omitempty"`
