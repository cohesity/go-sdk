...
func (m *O365BackupEnvParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTeamsBackupParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *O365BackupEnvParams) validateTeamsBackupParams(formats strfmt.Registry) error {
	if swag.IsZero(m.TeamsBackupParams) { // not required
		return nil
	}

	if m.TeamsBackupParams != nil {
		if err := m.TeamsBackupParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("teamsBackupParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("teamsBackupParams")
			}
			return err
		}
	}
...
func (m *O365BackupEnvParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTeamsBackupParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *O365BackupEnvParams) contextValidateTeamsBackupParams(ctx context.Context, formats strfmt.Registry) error {

	if m.TeamsBackupParams != nil {
		if err := m.TeamsBackupParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("teamsBackupParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("teamsBackupParams")
