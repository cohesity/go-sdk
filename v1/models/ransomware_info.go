...
func (m *RansomwareInfo) validateBanner(formats strfmt.Registry) error {
...
// ContextValidate validate this ransomware info based on the context it is used
...
func (m *RansomwareInfo) contextValidateBanner(ctx context.Context, formats strfmt.Registry) error {
