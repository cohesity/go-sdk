...
type RestoreVMwareVMParams struct {
	...
	// Indicates datastore selected in case of copy recovery is placement
	// compatible.
	IsSelectedDatastorePlacementCompatible *bool `json:"isSelectedDatastorePlacementCompatible,omitempty"`

	// Indicates host selected in case of copy recovery is placement
	// compatible.
	IsSelectedHostPlacementCompatible *bool `json:"isSelectedHostPlacementCompatible,omitempty"`
	...
	RecoverExcludedDiskAsBlankDisk *bool `json:"recoverExcludedDiskAsBlankDisk,omitempty"`

	// Indicates whether to recover the independent disk as blank disk.
	RecoverIndependentDiskAsBlankDisk *bool `json:"recoverIndependentDiskAsBlankDisk,omitempty"`
	...
	// The host on which VM should be created.
	// This field is only for VCD alternate location copy recovery.
	HostEntity *EntityProto `json:"hostEntity,omitempty"`

	// Placement policy selected by the user for alternate location
	// recovery.
	PlacementPolicy *VCDPolicy `json:"placementPolicy,omitempty"`
	...
	// Sizing policy selected by the user for alternate location recovery.
	SizingPolicy *VCDPolicy `json:"sizingPolicy,omitempty"`
...
func (m *RestoreVMwareVMParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSizingPolicy(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreVMwareVMParams) validateHostEntity(formats strfmt.Registry) error {
...
func (m *RestoreVMwareVMParams) validatePlacementPolicy(formats strfmt.Registry) error {
	...
	if m.PlacementPolicy != nil {
		if err := m.PlacementPolicy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("placementPolicy")
			}
			return err
		}
	}
...
func (m *RestoreVMwareVMParams) validateSizingPolicy(formats strfmt.Registry) error {
	if swag.IsZero(m.SizingPolicy) { // not required
		return nil
	}

	if m.SizingPolicy != nil {
		if err := m.SizingPolicy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sizingPolicy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sizingPolicy")
			}
			return err
		}
	}
...
func (m *RestoreVMwareVMParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSizingPolicy(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreVMwareVMParams) contextValidateHostEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestoreVMwareVMParams) contextValidatePlacementPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RestoreVMwareVMParams) contextValidateSizingPolicy(ctx context.Context, formats strfmt.Registry) error {

	if m.SizingPolicy != nil {
		if err := m.SizingPolicy.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("sizingPolicy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("sizingPolicy")
