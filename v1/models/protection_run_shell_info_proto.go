...
// this info extremely efficient. However, if the request is made by a
// restricted user, there will not be any performance gains because the
// full run proto will need to be fetched to verify if the calling user
// has access to the run.
//
