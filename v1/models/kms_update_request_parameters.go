...
type KmsUpdateRequestParameters struct {
	...
	// GCP KMS config update params
	GcpKms *GcpKmsUpdateParams `json:"gcpKms,omitempty"`
...
func (m *KmsUpdateRequestParameters) validateGcpKms(formats strfmt.Registry) error {
...
func (m *KmsUpdateRequestParameters) contextValidateGcpKms(ctx context.Context, formats strfmt.Registry) error {
