...
type FileLevelDataLockConfig struct {
	...
	AutoLockAfterDurationIdleMsecs *uint64 `json:"autoLockAfterDurationIdle,omitempty"`
	...
	// forever.
	DefaultRetentionDurationMsecs *int64 `json:"defaultFileRetentionDurationMsecs,omitempty"`
