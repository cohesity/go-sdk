...
type EntityHierarchyProto struct {
	...
	// Aggregated maintance mode information about all the entities rooted at
	// this node. There is one entry for each environment.
	AggregatedMaintenanceModeInfoVec []*EntityHierarchyProtoAggregatedMaintenanceModeInfo `json:"aggregatedMaintenanceModeInfoVec"`
	...
	// Aggregated information for other related environment will be available
	// afterwards.
...
func (m *EntityHierarchyProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAggregatedMaintenanceModeInfoVec(formats); err != nil {
		res = append(res, err)
	}
...
func (m *EntityHierarchyProto) validateAggregatedMaintenanceModeInfoVec(formats strfmt.Registry) error {
	if swag.IsZero(m.AggregatedMaintenanceModeInfoVec) { // not required
		return nil
	}

	for i := 0; i < len(m.AggregatedMaintenanceModeInfoVec); i++ {
		if swag.IsZero(m.AggregatedMaintenanceModeInfoVec[i]) { // not required
			continue
		}

		if m.AggregatedMaintenanceModeInfoVec[i] != nil {
			if err := m.AggregatedMaintenanceModeInfoVec[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("aggregatedMaintenanceModeInfoVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("aggregatedMaintenanceModeInfoVec" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *EntityHierarchyProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAggregatedMaintenanceModeInfoVec(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *EntityHierarchyProto) contextValidateAggregatedMaintenanceModeInfoVec(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.AggregatedMaintenanceModeInfoVec); i++ {
		...
		if m.AggregatedMaintenanceModeInfoVec[i] != nil {
			...
			if err := m.AggregatedMaintenanceModeInfoVec[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("aggregatedMaintenanceModeInfoVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("aggregatedMaintenanceModeInfoVec" + "." + strconv.Itoa(i))
