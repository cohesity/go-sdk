...
type AddSnapshotArgExtendedInformation struct {
	...
	// view add snapshot arg
	ViewAddSnapshotArg *AddSnapshotArgExtendedInformationViewAddSnapshotArg `json:"viewAddSnapshotArg,omitempty"`
...
func (m *AddSnapshotArgExtendedInformation) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateViewAddSnapshotArg(formats); err != nil {
		res = append(res, err)
	}
...
func (m *AddSnapshotArgExtendedInformation) validateViewAddSnapshotArg(formats strfmt.Registry) error {
	if swag.IsZero(m.ViewAddSnapshotArg) { // not required
		return nil
	}

	if m.ViewAddSnapshotArg != nil {
		if err := m.ViewAddSnapshotArg.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("viewAddSnapshotArg")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("viewAddSnapshotArg")
			}
			return err
		}
	}
...
func (m *AddSnapshotArgExtendedInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateViewAddSnapshotArg(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *AddSnapshotArgExtendedInformation) contextValidateViewAddSnapshotArg(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ViewAddSnapshotArg != nil {
		...
		if err := m.ViewAddSnapshotArg.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("viewAddSnapshotArg")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("viewAddSnapshotArg")
