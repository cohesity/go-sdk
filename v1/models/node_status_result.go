...
type NodeStatusResult struct {
	...
	ComponentRemovalProgressList []*ComponentRemovalProgress `json:"removalProgressList"`
...
func (m *NodeStatusResult) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateComponentRemovalProgressList(formats); err != nil {
		res = append(res, err)
	}
...
func (m *NodeStatusResult) validateComponentRemovalProgressList(formats strfmt.Registry) error {
	if swag.IsZero(m.ComponentRemovalProgressList) { // not required
		return nil
	}

	for i := 0; i < len(m.ComponentRemovalProgressList); i++ {
		if swag.IsZero(m.ComponentRemovalProgressList[i]) { // not required
			continue
		}

		if m.ComponentRemovalProgressList[i] != nil {
			if err := m.ComponentRemovalProgressList[i].Validate(formats); err != nil {
...
func (m *NodeStatusResult) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateComponentRemovalProgressList(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *NodeStatusResult) contextValidateComponentRemovalProgressList(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.ComponentRemovalProgressList); i++ {

		if m.ComponentRemovalProgressList[i] != nil {
			if err := m.ComponentRemovalProgressList[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("removalProgressList" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("removalProgressList" + "." + strconv.Itoa(i))
