...
type FilePartitionBlock struct {
	...
	// Specifies the offset (in bytes) from the beginning of the volume
	// where actual data starts, excluding LVM metadata. This helps in
	// identifying the precise starting point of usable data on the volume.
	LvmDataOffsetBytes *int64 `json:"lvmDataOffsetBytes,omitempty"`
