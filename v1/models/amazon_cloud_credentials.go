...
const (
	...
	// AmazonCloudCredentialsAuthMethodKUseInstanceProfile captures enum value "kUseInstanceProfile"
	AmazonCloudCredentialsAuthMethodKUseInstanceProfile string = "kUseInstanceProfile"
)
