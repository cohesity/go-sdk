...
const (
	...
	// AwsKmsConfigurationAuthMethodKUseInstanceProfile captures enum value "kUseInstanceProfile"
	AwsKmsConfigurationAuthMethodKUseInstanceProfile string = "kUseInstanceProfile"
)
