...
type FileSystemInfo struct {
	...
	// Information about a SMB export. Only valid if this file system is exposed
...
func (m *FileSystemInfo) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSmbInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *FileSystemInfo) validateSmbInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.SmbInfo) { // not required
		return nil
	}

	if m.SmbInfo != nil {
		if err := m.SmbInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("smbInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("smbInfo")
			}
			return err
		}
	}
...
func (m *FileSystemInfo) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSmbInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *FileSystemInfo) contextValidateSmbInfo(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.SmbInfo != nil {
		...
		if err := m.SmbInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("smbInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("smbInfo")
