...
type EntityAccessInfo struct {
	...
	// Connection parameters for EWS Exchange environment.
	...
	// Name of the oracle source. This is required for Oracle cluster where
	// we allow user to provide different scan name and connect endpoint.
	// The 'endpoint' field above is used to changing the connect endpoint,
	// this is used to change the name.
	OracleClusterName *string `json:"oracleClusterName,omitempty"`
...
func (m *EntityAccessInfo) validateEwsExchangeParams(formats strfmt.Registry) error {
...
func (m *EntityAccessInfo) contextValidateEwsExchangeParams(ctx context.Context, formats strfmt.Registry) error {
