...
type RegisteredEntityUdaParams struct {
	...
	// post backup job script failure tolerance
	PostBackupJobScriptFailureTolerance *int32 `json:"postBackupJobScriptFailureTolerance,omitempty"`

	// post restore job script failure tolerance
	PostRestoreJobScriptFailureTolerance *int32 `json:"postRestoreJobScriptFailureTolerance,omitempty"`
	...
	// pre restore job script failure tolerance
	PreRestoreJobScriptFailureTolerance *int32 `json:"preRestoreJobScriptFailureTolerance,omitempty"`
