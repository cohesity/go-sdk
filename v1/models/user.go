...
type User struct {
	...
	// Specifies a list of S3 keys.
	// Read Only: true
	S3Keys []*S3KeyResponse `json:"s3Keys"`
	...
	IbmUserMetadata *IbmUserMetadata `json:"ibmUserMetadata,omitempty"`
...
func (m *User) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAvailableServices(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateS3Keys(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateIbmUserMetadata(formats); err != nil {
		res = append(res, err)
	}
...
func (m *User) validateAvailableServices(formats strfmt.Registry) error {
	if swag.IsZero(m.AvailableServices) { // not required
		return nil
	}

	for i := 0; i < len(m.AvailableServices); i++ {
		if swag.IsZero(m.AvailableServices[i]) { // not required
			continue
		}

		if m.AvailableServices[i] != nil {
			if err := m.AvailableServices[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("availableServices" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("availableServices" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *User) validateS3Keys(formats strfmt.Registry) error {
	if swag.IsZero(m.S3Keys) { // not required
		return nil
	}

	for i := 0; i < len(m.S3Keys); i++ {
		if swag.IsZero(m.S3Keys[i]) { // not required
			continue
		}

		if m.S3Keys[i] != nil {
			if err := m.S3Keys[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("s3Keys" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("s3Keys" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *User) validateIbmUserMetadata(formats strfmt.Registry) error {
	if swag.IsZero(m.IbmUserMetadata) { // not required
		return nil
	}

	if m.IbmUserMetadata != nil {
		if err := m.IbmUserMetadata.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ibmUserMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ibmUserMetadata")
			}
			return err
		}
	}
...
func (m *User) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAvailableServices(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateS3Keys(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateIbmUserMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *User) contextValidateAvailableServices(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.AvailableServices); i++ {

		if m.AvailableServices[i] != nil {
			if err := m.AvailableServices[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("availableServices" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("availableServices" + "." + strconv.Itoa(i))
...
func (m *User) contextValidateIsBuiltIn(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "isBuiltIn", "body", m.IsBuiltIn); err != nil {
		return err
	}
...
func (m *User) contextValidateS3Keys(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "s3Keys", "body", []*S3KeyResponse(m.S3Keys)); err != nil {
		return err
	}
	...
	for i := 0; i < len(m.S3Keys); i++ {
		...
		if m.S3Keys[i] != nil {
			if err := m.S3Keys[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("s3Keys" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("s3Keys" + "." + strconv.Itoa(i))
...
func (m *User) contextValidateIbmUserMetadata(ctx context.Context, formats strfmt.Registry) error {

	if m.IbmUserMetadata != nil {
		if err := m.IbmUserMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ibmUserMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ibmUserMetadata")
