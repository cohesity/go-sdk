...
func (m *ProtectionRunInstance) validateCopyRuns(formats strfmt.Registry) error {
...
func (m *ProtectionRunInstance) contextValidateCopyRuns(ctx context.Context, formats strfmt.Registry) error {
