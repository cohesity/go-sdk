...
type Office365ProtectionSource struct {
	...
	DeltaRefreshParams *DeltaRefreshParams `json:"deltaRefreshParams,omitempty"`
...
func (m *Office365ProtectionSource) validateDeltaRefreshParams(formats strfmt.Registry) error {
...
func (m *Office365ProtectionSource) contextValidateDeltaRefreshParams(ctx context.Context, formats strfmt.Registry) error {
