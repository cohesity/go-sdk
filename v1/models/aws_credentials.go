...
const (
	...
	// AwsCredentialsAuthMethodKUseInstanceProfile captures enum value "kUseInstanceProfile"
	AwsCredentialsAuthMethodKUseInstanceProfile string = "kUseInstanceProfile"
)
