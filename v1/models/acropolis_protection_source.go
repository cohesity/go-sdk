...
type AcropolisProtectionSource struct {
	...
	// SystemDefined indicates whether the tag or capability is system-defined (true) or user-defined (false).
	// System-defined tags are generally managed internally by the platform and not meant to be edited by users.
	SystemDefined *bool `json:"systemDefined,omitempty"`

	// TagAttributes holds a list of additional attributes associated with the tag.
	// These could include metadata like UUIDs, display names, and values for more detailed tag descriptions.
	...
	// Value represents the actual value of the tag assigned to the entity.
	// For example, if the tag is "Environment", the value could be "Production".
...
func (m *AcropolisProtectionSource) validateTagAttributes(formats strfmt.Registry) error {
...
func (m *AcropolisProtectionSource) contextValidateTagAttributes(ctx context.Context, formats strfmt.Registry) error {
