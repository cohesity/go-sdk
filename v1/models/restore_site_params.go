...
type RestoreSiteParams struct {
	...
	// Below fields are valid for teams/group subsite restore.
	// If group/team is deleted we are updating source_site_uuid with new site
	// uuid in case of original restore but we need backedup uuid and web url to
	// construct url for subsites. Entity uuid of backedup source site in case of
	// sharepoint restore.
	// If the source site is not deleted, this field would be the same as
	// source_site_uuid.
	BackupRootSiteUUID *string `json:"backupRootSiteUuid,omitempty"`

	// Entity web url of backedup source site in case of sharepoint restore.
	BackupRootWebURL *string `json:"backupRootWebUrl,omitempty"`
	...
	RestoreUserDoclibsBeforeProvisioningTemplate *bool `json:"restoreUserDoclibsBeforeProvisioningTemplate,omitempty"`
	...
	// Whether pnp library should upload files linked to client side pages while
	...
	SkipClientSidePageFilesUpload *bool `json:"skipClientSidePageFilesUpload,omitempty"`
