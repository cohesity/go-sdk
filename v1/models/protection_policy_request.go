...
type ProtectionPolicyRequest struct {
	...
	SnapshotCloudCopyPolicies []*SnapshotCloudCopyPolicy `json:"cloudDeployPolicies"`
...
func (m *ProtectionPolicyRequest) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateSnapshotCloudCopyPolicies(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionPolicyRequest) validateSnapshotCloudCopyPolicies(formats strfmt.Registry) error {
	if swag.IsZero(m.SnapshotCloudCopyPolicies) { // not required
		return nil
	}

	for i := 0; i < len(m.SnapshotCloudCopyPolicies); i++ {
		if swag.IsZero(m.SnapshotCloudCopyPolicies[i]) { // not required
			continue
		}

		if m.SnapshotCloudCopyPolicies[i] != nil {
			if err := m.SnapshotCloudCopyPolicies[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
...
func (m *ProtectionPolicyRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateSnapshotCloudCopyPolicies(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionPolicyRequest) contextValidateSnapshotCloudCopyPolicies(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.SnapshotCloudCopyPolicies); i++ {

		if m.SnapshotCloudCopyPolicies[i] != nil {
			if err := m.SnapshotCloudCopyPolicies[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("cloudDeployPolicies" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("cloudDeployPolicies" + "." + strconv.Itoa(i))
