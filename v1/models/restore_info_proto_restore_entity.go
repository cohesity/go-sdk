...
type RestoreInfoProtoRestoreEntity struct {
	...
	// Any additional metadata about the restore returned by adapter as opaque
	// data.
	AdditionalRestoreMetadata []uint8 `json:"additionalRestoreMetadata"`
	...
	// List of granular objects which were not succesfully restored. This is a
	// subset of the granular_restore_objects sent in the request.
	FailedGranularRestoreObjects [][]uint8 `json:"failedGranularRestoreObjects"`
