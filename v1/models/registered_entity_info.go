...
type RegisteredEntityInfo struct {
	...
	// Time (in usecs) when there was a refresh attempt, but failed with error.
	LastRefreshErrorTimeUsecs *int64 `json:"lastRefreshErrorTimeUsecs,omitempty"`
	...
	// Captures the time required to refresh the entity.
	SourceRefreshTimeMsec *int64 `json:"sourceRefreshTimeMsec,omitempty"`
