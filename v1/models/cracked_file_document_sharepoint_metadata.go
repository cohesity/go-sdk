...
type CrackedFileDocumentSharepointMetadata struct {
	...
	// Metadata related to the subsite. This is populated only for subsites.
...
func (m *CrackedFileDocumentSharepointMetadata) validateSharepointSubsiteMetadata(formats strfmt.Registry) error {
...
func (m *CrackedFileDocumentSharepointMetadata) contextValidateSharepointSubsiteMetadata(ctx context.Context, formats strfmt.Registry) error {
