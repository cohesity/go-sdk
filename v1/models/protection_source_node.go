...
type ProtectionSourceNode struct {
	...
	CredentialsList []*AppCredentials `json:"credentialList"`
	...
	MaintenanceModeSummary []*MaintenanceModeSummary `json:"maintenanceModeSummary"`
...
func (m *ProtectionSourceNode) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateCredentialsList(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateMaintenanceModeSummary(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionSourceNode) validateCredentialsList(formats strfmt.Registry) error {
	if swag.IsZero(m.CredentialsList) { // not required
		return nil
	}

	for i := 0; i < len(m.CredentialsList); i++ {
		if swag.IsZero(m.CredentialsList[i]) { // not required
			continue
		}

		if m.CredentialsList[i] != nil {
			if err := m.CredentialsList[i].Validate(formats); err != nil {
...
func (m *ProtectionSourceNode) validateMaintenanceModeSummary(formats strfmt.Registry) error {
	if swag.IsZero(m.MaintenanceModeSummary) { // not required
		return nil
	}

	for i := 0; i < len(m.MaintenanceModeSummary); i++ {
		if swag.IsZero(m.MaintenanceModeSummary[i]) { // not required
			continue
		}

		if m.MaintenanceModeSummary[i] != nil {
			if err := m.MaintenanceModeSummary[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("maintenanceModeSummary" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("maintenanceModeSummary" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *ProtectionSourceNode) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateCredentialsList(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateMaintenanceModeSummary(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionSourceNode) contextValidateCredentialsList(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.CredentialsList); i++ {

		if m.CredentialsList[i] != nil {
			if err := m.CredentialsList[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("credentialList" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("credentialList" + "." + strconv.Itoa(i))
...
func (m *ProtectionSourceNode) contextValidateMaintenanceModeSummary(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.MaintenanceModeSummary); i++ {

		if m.MaintenanceModeSummary[i] != nil {
			if err := m.MaintenanceModeSummary[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("maintenanceModeSummary" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("maintenanceModeSummary" + "." + strconv.Itoa(i))
