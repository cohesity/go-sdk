...
type RegisteredEntityParams struct {
	...
	// RegisteredEntityAcropolisParams contains pc_credentials or
	// pe_credentials which are needed for connecting.
	AcropolisParams *RegisteredEntityAcropolisParams `json:"acropolisParams,omitempty"`

	// Any adapter specific additional parameters for the registered source. This
	// is an opaque field to magneto.
	AdditionalRegisteredSourceParams []uint8 `json:"additionalRegisteredSourceParams"`

	// Additional params may be specified for AWS entities.
	AwsParams *RegisteredEntityAWSParams `json:"awsParams,omitempty"`
	...
	// Additional params may be specified for GCP entities.
	GcpParams *RegisteredEntityGCPParams `json:"gcpParams,omitempty"`

	// Additional params may be specified for generic adapter entities (UDAv2).
	GenericAdapterParams *RegisteredEntityGenericAdapterParams `json:"genericAdapterParams,omitempty"`
...
func (m *RegisteredEntityParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGenericAdapterParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisteredEntityParams) validateAcropolisParams(formats strfmt.Registry) error {
...
func (m *RegisteredEntityParams) validateAwsParams(formats strfmt.Registry) error {
...
func (m *RegisteredEntityParams) validateGcpParams(formats strfmt.Registry) error {
...
func (m *RegisteredEntityParams) validateGenericAdapterParams(formats strfmt.Registry) error {
	if swag.IsZero(m.GenericAdapterParams) { // not required
		return nil
	}

	if m.GenericAdapterParams != nil {
		if err := m.GenericAdapterParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterParams")
			}
			return err
		}
	}
...
func (m *RegisteredEntityParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGenericAdapterParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RegisteredEntityParams) contextValidateAcropolisParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegisteredEntityParams) contextValidateAwsParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegisteredEntityParams) contextValidateGcpParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RegisteredEntityParams) contextValidateGenericAdapterParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GenericAdapterParams != nil {
		...
		if err := m.GenericAdapterParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterParams")
