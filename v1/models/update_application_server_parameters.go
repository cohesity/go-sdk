...
// UpdateApplicationServerParameters Update Application Server Parameters.
//
...
//
// swagger:model UpdateApplicationServerParameters
type UpdateApplicationServerParameters struct {
	...
	// Specifies the last time this Application Servers in a
	// Protection Source was updated. If this is passed into a PUT request,
	// then the backend will validate that the timestamp passed in matches the
	// time that the Protection Source was
...
// Validate validates this update application server parameters
func (m *UpdateApplicationServerParameters) Validate(formats strfmt.Registry) error {
	var res []error
...
var updateApplicationServerParametersApplicationsItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateApplicationServerParametersApplicationsItemsEnum = append(updateApplicationServerParametersApplicationsItemsEnum, v)
	}
}

func (m *UpdateApplicationServerParameters) validateApplicationsItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateApplicationServerParametersApplicationsItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *UpdateApplicationServerParameters) validateApplications(formats strfmt.Registry) error {
...
func (m *UpdateApplicationServerParameters) validateCloudCredentials(formats strfmt.Registry) error {
...
// ContextValidate validate this update application server parameters based on the context it is used
func (m *UpdateApplicationServerParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UpdateApplicationServerParameters) contextValidateCloudCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UpdateApplicationServerParameters) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateApplicationServerParameters) UnmarshalBinary(b []byte) error {
	var res UpdateApplicationServerParameters
