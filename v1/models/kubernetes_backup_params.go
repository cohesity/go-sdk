...
type KubernetesBackupParams struct {
	...
	// If true, enables parallel execution of EndBackupOp across different
	// sub-task ranges by using base_sub_task_id for task key computation in
	// Bridge. This is set by the master for Kubernetes file backups when cluster
	// upgrade is not in progress.
	EnableParallelEndBackupOp *bool `json:"enableParallelEndBackupOp,omitempty"`

	// If true, Magneto will exclude .snapshot directories from PVC backups to
	// avoid backing up duplicate data. This applies filtering policy to exclude
	// paths matching .snapshot directory patterns.
	ExcludeSnapshotDirectory *bool `json:"excludeSnapshotDirectory,omitempty"`

	// Container image used to mounting PVCs in temp pods.
	InitContainerImage *string `json:"initContainerImage,omitempty"`

	// Indicates if block volume protection feature is enabled.
	IsBlockVolumeProtectionEnabled *bool `json:"isBlockVolumeProtectionEnabled,omitempty"`

	// Indicates if granular vm backup feature is enabled in the feature enabler.
	IsGranularVMBackupEnabled *bool `json:"isGranularVmBackupEnabled,omitempty"`

	// Indicates if VM backup using KubeVirt VM snapshot API feature is enabled
	// for Kubernetes based RedHat OpenShift Virtualization (RHOV).
	IsKubevirtVMSnapshotEnabled *bool `json:"isKubevirtVmSnapshotEnabled,omitempty"`
...
func (m *KubernetesBackupParams) validateVlanInfoVec(formats strfmt.Registry) error {
...
func (m *KubernetesBackupParams) contextValidateVlanInfoVec(ctx context.Context, formats strfmt.Registry) error {
