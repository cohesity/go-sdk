...
func (m *ProtectionPolicy) validateSnapshotCloudCopyPolicies(formats strfmt.Registry) error {
...
func (m *ProtectionPolicy) contextValidateSnapshotCloudCopyPolicies(ctx context.Context, formats strfmt.Registry) error {
