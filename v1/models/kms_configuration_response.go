...
func (m *KmsConfigurationResponse) validateGcpKms(formats strfmt.Registry) error {
...
func (m *KmsConfigurationResponse) contextValidateGcpKms(ctx context.Context, formats strfmt.Registry) error {
