...
type BackupTaskStateProto struct {
	...
	// The task from which the previous snapshot information is taken.
	PreviousSnapshotTaskID *int64 `json:"previousSnapshotTaskId,omitempty"`
	...
	// This will be populated if a rerun is required.
	RerunProto *RunOnceBackupJobProto `json:"rerunProto,omitempty"`
...
func (m *BackupTaskStateProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRerunProto(formats); err != nil {
		res = append(res, err)
	}
...
func (m *BackupTaskStateProto) validateRerunProto(formats strfmt.Registry) error {
	if swag.IsZero(m.RerunProto) { // not required
		return nil
	}

	if m.RerunProto != nil {
		if err := m.RerunProto.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("rerunProto")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("rerunProto")
			}
			return err
		}
	}
...
func (m *BackupTaskStateProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRerunProto(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *BackupTaskStateProto) contextValidateRerunProto(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RerunProto != nil {
		...
		if err := m.RerunProto.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("rerunProto")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("rerunProto")
