...
type Alert struct {
	...
	EventHost *string `json:"eventSource,omitempty"`
	...
	// List of service instances an alert was raised for
...
const (
	...
	// AlertAlertCategoryKNetBackup captures enum value "kNetBackup"
	AlertAlertCategoryKNetBackup string = "kNetBackup"
)
