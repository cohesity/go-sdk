...
// UpdateLdapProviderParam Update LDAP Provider Parameters.
//
// Specifies the update LDAP provider params.
//
// swagger:model UpdateLdapProviderParam
...
// Validate validates this update ldap provider param
func (m *UpdateLdapProviderParam) Validate(formats strfmt.Registry) error {
	var res []error
...
var updateLdapProviderParamTypeAuthTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateLdapProviderParamTypeAuthTypePropEnum = append(updateLdapProviderParamTypeAuthTypePropEnum, v)
	}
}

const (

	// UpdateLdapProviderParamAuthTypeKAnonymous captures enum value "kAnonymous"
	UpdateLdapProviderParamAuthTypeKAnonymous string = "kAnonymous"

	// UpdateLdapProviderParamAuthTypeKSimple captures enum value "kSimple"
	UpdateLdapProviderParamAuthTypeKSimple string = "kSimple"
)

// prop value enum
func (m *UpdateLdapProviderParam) validateAuthTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateLdapProviderParamTypeAuthTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *UpdateLdapProviderParam) validateAuthType(formats strfmt.Registry) error {
...
// ContextValidate validates this update ldap provider param based on context it is used
func (m *UpdateLdapProviderParam) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *UpdateLdapProviderParam) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *UpdateLdapProviderParam) UnmarshalBinary(b []byte) error {
	var res UpdateLdapProviderParam
