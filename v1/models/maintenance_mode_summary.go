...
// MaintenanceModeSummary MaintenanceModeSummary specifies maintenance mode stats.
//
// swagger:model MaintenanceModeSummary
type MaintenanceModeSummary struct {
...
// Validate validates this maintenance mode summary
func (m *MaintenanceModeSummary) Validate(formats strfmt.Registry) error {
	var res []error
...
var maintenanceModeSummaryTypeEnvironmentPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		maintenanceModeSummaryTypeEnvironmentPropEnum = append(maintenanceModeSummaryTypeEnvironmentPropEnum, v)
	}
}

const (

	// MaintenanceModeSummaryEnvironmentKVMware captures enum value "kVMware"
	MaintenanceModeSummaryEnvironmentKVMware string = "kVMware"

	// MaintenanceModeSummaryEnvironmentKHyperV captures enum value "kHyperV"
	MaintenanceModeSummaryEnvironmentKHyperV string = "kHyperV"

	// MaintenanceModeSummaryEnvironmentKSQL captures enum value "kSQL"
	MaintenanceModeSummaryEnvironmentKSQL string = "kSQL"

	// MaintenanceModeSummaryEnvironmentKView captures enum value "kView"
	MaintenanceModeSummaryEnvironmentKView string = "kView"

	// MaintenanceModeSummaryEnvironmentKPuppeteer captures enum value "kPuppeteer"
	MaintenanceModeSummaryEnvironmentKPuppeteer string = "kPuppeteer"

	// MaintenanceModeSummaryEnvironmentKPhysical captures enum value "kPhysical"
	MaintenanceModeSummaryEnvironmentKPhysical string = "kPhysical"

	// MaintenanceModeSummaryEnvironmentKPure captures enum value "kPure"
	MaintenanceModeSummaryEnvironmentKPure string = "kPure"

	// MaintenanceModeSummaryEnvironmentKNimble captures enum value "kNimble"
	MaintenanceModeSummaryEnvironmentKNimble string = "kNimble"
)

// prop value enum
func (m *MaintenanceModeSummary) validateEnvironmentEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, maintenanceModeSummaryTypeEnvironmentPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *MaintenanceModeSummary) validateEnvironment(formats strfmt.Registry) error {
...
// ContextValidate validates this maintenance mode summary based on context it is used
func (m *MaintenanceModeSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *MaintenanceModeSummary) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MaintenanceModeSummary) UnmarshalBinary(b []byte) error {
	var res MaintenanceModeSummary
