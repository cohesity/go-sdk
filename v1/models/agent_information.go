...
type AgentInformation struct {
	...
	// 'kHostOSVersionDeprecated' indicates the OS version on the host is
	// deprecated and does not support upgrades.
	// kNonUpgradableAgentIsNewer, kNonUpgradableAgentIsOld,
	// kHostOSVersionDeprecated
	// Enum: [kUpgradable kCurrent kUnknown kNonUpgradableInvalidVersion]
...
var agentInformationTypeAgentTypePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kCpp","kJava","kGo","kLegacy"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		agentInformationTypeAgentTypePropEnum = append(agentInformationTypeAgentTypePropEnum, v)
	}
}

const (

	// AgentInformationAgentTypeKCpp captures enum value "kCpp"
	AgentInformationAgentTypeKCpp string = "kCpp"

	// AgentInformationAgentTypeKJava captures enum value "kJava"
	AgentInformationAgentTypeKJava string = "kJava"

	// AgentInformationAgentTypeKGo captures enum value "kGo"
	AgentInformationAgentTypeKGo string = "kGo"

	// AgentInformationAgentTypeKLegacy captures enum value "kLegacy"
	AgentInformationAgentTypeKLegacy string = "kLegacy"
)

// prop value enum
func (m *AgentInformation) validateAgentTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, agentInformationTypeAgentTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *AgentInformation) validateAgentType(formats strfmt.Registry) error {
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kUpgradable","kCurrent","kUnknown","kNonUpgradableInvalidVersion"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
