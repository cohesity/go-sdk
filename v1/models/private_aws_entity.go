...
type PrivateAwsEntity struct {
	...
	// DB engine version of database server.
	// Currently this is only used for RDS instance and Aurora cluster types.
	DbEngineVersion *string `json:"dbEngineVersion,omitempty"`

	// Contains the name of the compute and memory capacity class of the DB
	// instance. Currently only used for various RDS instance and Aurora cluster
	// types such as kRDSPostgresInstance, kAuroraMySQLCluster etc.
	DbInstanceClass *string `json:"dbInstanceClass,omitempty"`

	// This keeps the number of items that are present in the DB Table
	// entity. Currently only used for kDynamoDBTable.
	DbTableItemCounts *int64 `json:"dbTableItemCounts,omitempty"`
	...
	RdsOracleDbInfo *RDSOracleDBInfo `json:"rdsOracleDbInfo,omitempty"`

	// The following is set if the entity is an EC2 instance and DDB tables.
...
func (m *PrivateAwsEntity) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRdsOracleDbInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PrivateAwsEntity) validateRdsOracleDbInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.RdsOracleDbInfo) { // not required
		return nil
	}

	if m.RdsOracleDbInfo != nil {
		if err := m.RdsOracleDbInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("rdsOracleDbInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("rdsOracleDbInfo")
			}
			return err
		}
	}
...
func (m *PrivateAwsEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRdsOracleDbInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PrivateAwsEntity) contextValidateRdsOracleDbInfo(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RdsOracleDbInfo != nil {
		...
		if err := m.RdsOracleDbInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("rdsOracleDbInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("rdsOracleDbInfo")
