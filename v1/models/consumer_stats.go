...
type ConsumerStats struct {
	...
	// Specifies the protection group Uid.
...
func (m *ConsumerStats) validateJobUID(formats strfmt.Registry) error {
...
func (m *ConsumerStats) contextValidateJobUID(ctx context.Context, formats strfmt.Registry) error {
