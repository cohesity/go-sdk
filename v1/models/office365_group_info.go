...
type Office365GroupInfo struct {
	...
	// Directory. Do note that this field may also be true for normal M365
	// Groups in certain cases and therefore should not be considered for
	// security group determination. Please refer to the IsSecurityGroup field
	// for the actual security group determination.
	...
	IsTeamsGroup *bool `json:"isTeamsGroup,omitempty"`
