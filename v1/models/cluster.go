...
type Cluster struct {
	...
	CentralizedPatchingEnabled *bool `json:"centralizedPatchingEnabled,omitempty"`
	...
	CloudRf1Enabled *bool `json:"cloudRf1Enabled,omitempty"`

	// Specifies the type of Deployment for Cluster such as kCDC, kIBMBaaS.
	// 'kStandAlone' indicates the StandAlone/Default deployment of Cluster.
	// 'kCDC' indicates the Cluster is deployed by Cohesity
	// 'kIBMBaaS' indicates the Cluster deployed by IBM
	...
	// on IBM Cloud
	// 'kOciCloud' indicates the Cohesity Cluster is hosted in a VM
	// on OCI Cloud
	// Enum: [kPhysical kVirtualRobo kMicrosoftCloud kAmazonCloud kGoogleCloud kIBMCloud kOciCloud]
	...
	EagleConfigEnableAgent *bool `json:"enableActiveMonitoring,omitempty"`
	...
	FipsCertVersion *string `json:"fipsCertVersion,omitempty"`
	...
	HaloServerEnabled *bool `json:"enableUpgradePkgPolling,omitempty"`
	...
	IbmServiceInstanceName *string `json:"ibmServiceInstanceName,omitempty"`
	...
	IsFortKnoxSelfManagedVaultCluster *bool `json:"isFortKnoxSelfManagedVaultCluster,omitempty"`
	...
	PatchApplyErrorMessage *string `json:"patchApplyFailureErrorMessage,omitempty"`

	// Specifies the error message for a failed patch revert.
	PatchRevertErrorMessage *string `json:"patchRevertFailureErrorMessage,omitempty"`
	...
	// ReverseTunnelExtensionDurationHours specifies the number of hours to
	// extend the reverse tunnel.
	ReverseTunnelExtensionDurationHours *int64 `json:"reverseTunnelExtensionDurationHours,omitempty"`

	// ReverseTunnelEnableExtension specifies if the reverse tunnel should be
	// extended.
	ReverseTunnelExtensionEnabled *bool `json:"reverseTunnelEnableExtension,omitempty"`
	...
	// 'kOneHelios' indicates the one helios Cohesity Cluster.
	// 'kNetBackup' indicates the NetBackup Cohesity Cluster.
	// 'kRegular' indicates the regular Cohesity Cluster.
	// Enum: [kOneHelios kRegular]
	...
	// Virtual dataplane id for the cluster. This will be used
	// to mask the changes in cluster id in scenarios like tenant migration
	VirtualDataplaneIdentifier *string `json:"virtualDataplaneIdentifier,omitempty"`
	...
	// IBM Key Protect configuration for IBM cloud deployments.
	IbmKeyProtectConfig *IbmKeyProtectConfig `json:"ibmKeyProtectConfig,omitempty"`
	...
	LoadBalancerVipConfig *LoadBalancerVipConfig `json:"loadBalancerVipConfig,omitempty"`

	// Specifies the NetBackup Services Configuration
	NetbackupServicesConfig *NetbackupServicesConfig `json:"netbackupServicesConfig,omitempty"`
...
func (m *Cluster) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateIbmKeyProtectConfig(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateNetbackupServicesConfig(formats); err != nil {
		res = append(res, err)
	}
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kPhysical","kVirtualRobo","kMicrosoftCloud","kAmazonCloud","kGoogleCloud","kIBMCloud","kOciCloud"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// ClusterClusterTypeKOciCloud captures enum value "kOciCloud"
	ClusterClusterTypeKOciCloud string = "kOciCloud"
)
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kOneHelios","kRegular"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
func (m *Cluster) validateIbmKeyProtectConfig(formats strfmt.Registry) error {
	if swag.IsZero(m.IbmKeyProtectConfig) { // not required
		return nil
	}

	if m.IbmKeyProtectConfig != nil {
		if err := m.IbmKeyProtectConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ibmKeyProtectConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ibmKeyProtectConfig")
			}
			return err
		}
	}
...
func (m *Cluster) validateNetbackupServicesConfig(formats strfmt.Registry) error {
	if swag.IsZero(m.NetbackupServicesConfig) { // not required
		return nil
	}

	if m.NetbackupServicesConfig != nil {
		if err := m.NetbackupServicesConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("netbackupServicesConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("netbackupServicesConfig")
			}
			return err
		}
	}
...
func (m *Cluster) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateIbmKeyProtectConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateNetbackupServicesConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Cluster) contextValidateHostNames(ctx context.Context, formats strfmt.Registry) error {

	if err := validate.ReadOnly(ctx, "hostNames", "body", []string(m.HostNames)); err != nil {
		return err
	}
...
func (m *Cluster) contextValidateIbmKeyProtectConfig(ctx context.Context, formats strfmt.Registry) error {

	if m.IbmKeyProtectConfig != nil {
		if err := m.IbmKeyProtectConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ibmKeyProtectConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ibmKeyProtectConfig")
...
func (m *Cluster) contextValidateNetbackupServicesConfig(ctx context.Context, formats strfmt.Registry) error {

	if m.NetbackupServicesConfig != nil {
		if err := m.NetbackupServicesConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("netbackupServicesConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("netbackupServicesConfig")
