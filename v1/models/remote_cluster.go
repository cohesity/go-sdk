...
func (m *RemoteCluster) validateViewBoxPairInfoList(formats strfmt.Registry) error {
...
func (m *RemoteCluster) contextValidateViewBoxPairInfoList(ctx context.Context, formats strfmt.Registry) error {
