...
type RestoreInfo struct {
	...
	// Additional metadata related to UDA adapters
...
func (m *RestoreInfo) validateAdapterMetadata(formats strfmt.Registry) error {
...
func (m *RestoreInfo) contextValidateAdapterMetadata(ctx context.Context, formats strfmt.Registry) error {
