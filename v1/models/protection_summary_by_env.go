...
type ProtectionSummaryByEnv struct {
	...
	EntitiesMaintenanceCount *int64 `json:"entitiesMaintenanceCount,omitempty"`
	...
	NonLeafEntitiesMaintenanceCount *int64 `json:"nonLeafEntitiesMaintenanceCount,omitempty"`
