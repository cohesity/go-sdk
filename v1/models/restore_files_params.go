...
type RestoreFilesParams struct {
	...
	ExtendedAttributesBackupEnabled *bool `json:"extendedAttributesBackupEnabled,omitempty"`
	...
	// Maps directory names to their corresponding export policy IDs for NetApp
	// qtrees. This mapping is required to preserve and apply the same export
	// policies to qtrees when restoring to a target volume.
	QtreeExportPolicyMap map[string]int64 `json:"qtreeExportPolicyMap,omitempty"`
	...
	// backup snapshot fields
	BackupSnapshotFields *BackupSnapshotFields `json:"backupSnapshotFields,omitempty"`
	...
	// If specified, these credentials will be used to mount the SMB share
	// Only the specified user would have access to the cloned view
	SmbMountUserCreds *SMBMountUserCredentials `json:"smbMountUserCreds,omitempty"`
...
func (m *RestoreFilesParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateBackupSnapshotFields(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateSmbMountUserCreds(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreFilesParams) validateBackupSnapshotFields(formats strfmt.Registry) error {
	if swag.IsZero(m.BackupSnapshotFields) { // not required
		return nil
	}

	if m.BackupSnapshotFields != nil {
		if err := m.BackupSnapshotFields.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("backupSnapshotFields")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("backupSnapshotFields")
			}
			return err
		}
	}
...
func (m *RestoreFilesParams) validateSmbMountUserCreds(formats strfmt.Registry) error {
	if swag.IsZero(m.SmbMountUserCreds) { // not required
		return nil
	}

	if m.SmbMountUserCreds != nil {
		if err := m.SmbMountUserCreds.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("smbMountUserCreds")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("smbMountUserCreds")
			}
			return err
		}
	}
...
func (m *RestoreFilesParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBackupSnapshotFields(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateSmbMountUserCreds(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreFilesParams) contextValidateBackupSnapshotFields(ctx context.Context, formats strfmt.Registry) error {

	if m.BackupSnapshotFields != nil {
		if err := m.BackupSnapshotFields.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("backupSnapshotFields")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("backupSnapshotFields")
...
func (m *RestoreFilesParams) contextValidateSmbMountUserCreds(ctx context.Context, formats strfmt.Registry) error {

	if m.SmbMountUserCreds != nil {
		if err := m.SmbMountUserCreds.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("smbMountUserCreds")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("smbMountUserCreds")
