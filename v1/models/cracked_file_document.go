...
type CrackedFileDocument struct {
	...
	// List of attributes that are supposed to be purged from attribute store.
	// The corresponding file versions for these attributes have been removed.
	AttributeGraveyard []string `json:"attributeGraveyard"`
	...
	// In case a feature is using ES(In DMaaS) then there is a limit on filename
	// field to be less then 512 bytes. This is because although rocksdb supports
	// larger key size ES has a hard limit on the length.
	Filename *string `json:"filename,omitempty"`

	// gmail metadata
	GmailMetadata *CrackedFileDocumentGMailMetadata `json:"gmailMetadata,omitempty"`

	// google drive metadata
	GoogleDriveMetadata *CrackedFileDocumentGoogleDriveMetadata `json:"googleDriveMetadata,omitempty"`
...
func (m *CrackedFileDocument) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGmailMetadata(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateGoogleDriveMetadata(formats); err != nil {
		res = append(res, err)
	}
...
func (m *CrackedFileDocument) validateGmailMetadata(formats strfmt.Registry) error {
	if swag.IsZero(m.GmailMetadata) { // not required
		return nil
	}

	if m.GmailMetadata != nil {
		if err := m.GmailMetadata.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gmailMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gmailMetadata")
			}
			return err
		}
	}
...
func (m *CrackedFileDocument) validateGoogleDriveMetadata(formats strfmt.Registry) error {
	if swag.IsZero(m.GoogleDriveMetadata) { // not required
		return nil
	}

	if m.GoogleDriveMetadata != nil {
		if err := m.GoogleDriveMetadata.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("googleDriveMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("googleDriveMetadata")
			}
			return err
		}
	}
...
func (m *CrackedFileDocument) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGmailMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateGoogleDriveMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *CrackedFileDocument) contextValidateGmailMetadata(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GmailMetadata != nil {
		...
		if err := m.GmailMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gmailMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gmailMetadata")
...
func (m *CrackedFileDocument) contextValidateGoogleDriveMetadata(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GoogleDriveMetadata != nil {
		...
		if err := m.GoogleDriveMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("googleDriveMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("googleDriveMetadata")
