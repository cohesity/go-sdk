...
// VersionInfo Specifies the Id containing the unique identifer and version
//
// swagger:model VersionInfo
type VersionInfo struct {

	// Unique identifier for the string entity.
	// This field is used to uniquely distinguish different
	// entities within the system.
	ID *string `json:"id,omitempty"`

	// Version number associated with the string id.
