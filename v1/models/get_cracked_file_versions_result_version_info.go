...
type GetCrackedFileVersionsResultVersionInfo struct {
	...
	// Set to true if version has archival replica.
	...
	// Set to true if version has source replica.
	HasSourceReplica *bool `json:"hasSourceReplica,omitempty"`
...
func (m *GetCrackedFileVersionsResultVersionInfo) validateUdaVersionMetadata(formats strfmt.Registry) error {
...
func (m *GetCrackedFileVersionsResultVersionInfo) contextValidateUdaVersionMetadata(ctx context.Context, formats strfmt.Registry) error {
