...
type BackupTaskAdditionalParams struct {
	...
	// Parameters for Generic Adapter backup.
	GenericAdapterBackupParams *GenericAdapterBackupParams `json:"genericAdapterBackupParams,omitempty"`

	// Whether a full backup is required for this source_entity.
	IsFullRequired *bool `json:"isFullRequired,omitempty"`
	...
	// object store backup params
	ObjectStoreBackupParams *ObjectStoreBackupParams `json:"objectStoreBackupParams,omitempty"`
...
func (m *BackupTaskAdditionalParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGenericAdapterBackupParams(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateObjectStoreBackupParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *BackupTaskAdditionalParams) validateGenericAdapterBackupParams(formats strfmt.Registry) error {
	if swag.IsZero(m.GenericAdapterBackupParams) { // not required
		return nil
	}

	if m.GenericAdapterBackupParams != nil {
		if err := m.GenericAdapterBackupParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterBackupParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterBackupParams")
			}
			return err
		}
	}
...
func (m *BackupTaskAdditionalParams) validateObjectStoreBackupParams(formats strfmt.Registry) error {
	if swag.IsZero(m.ObjectStoreBackupParams) { // not required
		return nil
	}

	if m.ObjectStoreBackupParams != nil {
		if err := m.ObjectStoreBackupParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("objectStoreBackupParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("objectStoreBackupParams")
			}
			return err
		}
	}
...
func (m *BackupTaskAdditionalParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGenericAdapterBackupParams(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateObjectStoreBackupParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *BackupTaskAdditionalParams) contextValidateGenericAdapterBackupParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GenericAdapterBackupParams != nil {
		...
		if err := m.GenericAdapterBackupParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterBackupParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterBackupParams")
...
func (m *BackupTaskAdditionalParams) contextValidateObjectStoreBackupParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ObjectStoreBackupParams != nil {
		...
		if err := m.ObjectStoreBackupParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("objectStoreBackupParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("objectStoreBackupParams")
