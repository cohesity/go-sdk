...
type OracleDBConfig struct {
	...
	// Set to true if the restore is TDE enabled. This field is not populated
	// from Iris API, instead, it is populated by Magneto by checking if the
	// backup snapshots included for the restore has TDE data. Currently only PDB
	// alternate restore will populate this field.
	TdeEnabled *bool `json:"tdeEnabled,omitempty"`
}
