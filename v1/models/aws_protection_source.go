...
type AwsProtectionSource struct {
	...
	// 'kUseInstanceProfile' indicates a instance profile based authentication.
	// Enum: ["kUseIAMUser","kUseIAMRole","kUseHelios","kUseInstanceProfile"]
	...
	// RDS Oracle specific info (multi-tenant configuration and tenant DBs).
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kUseIAMUser","kUseIAMRole","kUseHelios","kUseInstanceProfile"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// AwsProtectionSourceAuthMethodKUseInstanceProfile captures enum value "kUseInstanceProfile"
	AwsProtectionSourceAuthMethodKUseInstanceProfile string = "kUseInstanceProfile"
)
...
func (m *AwsProtectionSource) validateRdsOracleDbInfo(formats strfmt.Registry) error {
...
func (m *AwsProtectionSource) contextValidateRdsOracleDbInfo(ctx context.Context, formats strfmt.Registry) error {
