...
type ThrottlingPolicy struct {
	...
	// Throttling configuration for connector defined resources.
	GenericThrottlingConfig *ThrottlingPolicyGenericThrottlingConfig `json:"genericThrottlingConfig,omitempty"`
...
func (m *ThrottlingPolicy) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGenericThrottlingConfig(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ThrottlingPolicy) validateGenericThrottlingConfig(formats strfmt.Registry) error {
	if swag.IsZero(m.GenericThrottlingConfig) { // not required
		return nil
	}

	if m.GenericThrottlingConfig != nil {
		if err := m.GenericThrottlingConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericThrottlingConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericThrottlingConfig")
			}
			return err
		}
	}
...
func (m *ThrottlingPolicy) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGenericThrottlingConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ThrottlingPolicy) contextValidateGenericThrottlingConfig(ctx context.Context, formats strfmt.Registry) error {

	if m.GenericThrottlingConfig != nil {
		if err := m.GenericThrottlingConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericThrottlingConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericThrottlingConfig")
