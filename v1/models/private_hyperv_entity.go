...
type PrivateHypervEntity struct {
	...
	// This is populated for entities of type kHypervHost.
	// It indicates whether this host is part of a hostCluster or hostGroup.
	ParentTypeOfHost *int32 `json:"parentTypeOfHost,omitempty"`

	// Properties for storing key-value pairs, such as cluster information.
...
func (m *PrivateHypervEntity) validateProperties(formats strfmt.Registry) error {
...
func (m *PrivateHypervEntity) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
