...
type VCDAttributes struct {
	...
	// Compute policy info, populated only for placement & sizing policy
	// entities.
	ComputePolicy *VCDComputePolicyInfo `json:"computePolicy,omitempty"`

	// This contains info if vcd entity is enabled or disabled.
	// Its only applicable for some vcd entities like pvdc resource pools,
	// orgvdc, pvdc
	...
	// If this is a vApp template or VM is a part of vApp Template.
	...
	// This contains the entity id of all the resource pools in an orgvdc.
	// resgrp_entity_id field will not be populated for orgvdc.
	ResgrpEntityVec []int64 `json:"resgrpEntityVec"`
...
func (m *VCDAttributes) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateComputePolicy(formats); err != nil {
		res = append(res, err)
	}
...
func (m *VCDAttributes) validateComputePolicy(formats strfmt.Registry) error {
	if swag.IsZero(m.ComputePolicy) { // not required
		return nil
	}

	if m.ComputePolicy != nil {
		if err := m.ComputePolicy.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("computePolicy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("computePolicy")
			}
			return err
		}
	}
...
func (m *VCDAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateComputePolicy(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *VCDAttributes) contextValidateComputePolicy(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.ComputePolicy != nil {
		...
		if err := m.ComputePolicy.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("computePolicy")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("computePolicy")
