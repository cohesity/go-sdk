...
type SchedulingPolicy struct {
	...
	// 'kYearly' means new Job Runs start yearly.
	...
	// Enum: [kContinuous kDaily kMonthly kContinuousRPO kCDP kYearly]
	...
	// Specifies a yearly backup schedule.
	// Set if periodicity is kFirst.
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kContinuous","kDaily","kMonthly","kContinuousRPO","kCDP","kYearly"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// SchedulingPolicyPeriodicityKYearly captures enum value "kYearly"
	SchedulingPolicyPeriodicityKYearly string = "kYearly"
)
...
func (m *SchedulingPolicy) validateYearlySchedule(formats strfmt.Registry) error {
...
func (m *SchedulingPolicy) contextValidateYearlySchedule(ctx context.Context, formats strfmt.Registry) error {
