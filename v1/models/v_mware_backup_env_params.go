...
type VMwareBackupEnvParams struct {
	...
	// will be included for all VMs in this environment unless overriden by the
	// disk inclusion list from BackupSourceParams.VMwareBackupSourceParams.
	VmwareDiskInclusionInfo []*VMwareDiskFilterProto `json:"vmwareDiskInclusionInfo"`
}
...
func (m *VMwareBackupEnvParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateVmwareDiskInclusionInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *VMwareBackupEnvParams) validateVmwareDiskInclusionInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.VmwareDiskInclusionInfo) { // not required
		return nil
	}

	for i := 0; i < len(m.VmwareDiskInclusionInfo); i++ {
		if swag.IsZero(m.VmwareDiskInclusionInfo[i]) { // not required
			continue
		}

		if m.VmwareDiskInclusionInfo[i] != nil {
			if err := m.VmwareDiskInclusionInfo[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("vmwareDiskInclusionInfo" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("vmwareDiskInclusionInfo" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *VMwareBackupEnvParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateVmwareDiskInclusionInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *VMwareBackupEnvParams) contextValidateVmwareDiskInclusionInfo(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.VmwareDiskInclusionInfo); i++ {

		if m.VmwareDiskInclusionInfo[i] != nil {
			if err := m.VmwareDiskInclusionInfo[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("vmwareDiskInclusionInfo" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("vmwareDiskInclusionInfo" + "." + strconv.Itoa(i))
