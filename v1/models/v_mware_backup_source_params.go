...
type VMwareBackupSourceParams struct {
	...
	// List of Virtual Disk(s) to be included from the backup job for the source.
	// Overrides the inclusion list requested (if any) through
	// EnvBackupParams.VMwareBackupEnvParams.
...
func (m *VMwareBackupSourceParams) validateVmwareDiskInclusionInfo(formats strfmt.Registry) error {
...
func (m *VMwareBackupSourceParams) contextValidateVmwareDiskInclusionInfo(ctx context.Context, formats strfmt.Registry) error {
