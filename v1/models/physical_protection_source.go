...
type PhysicalProtectionSource struct {
	...
	// Specifies the cpu architecture of a physical server.
	// Enum: ["kunknown","kx86_64","kppc64le","kppc","ks390x","ksparc","kia64","kx86"]
...
var physicalProtectionSourceTypeCPUArchitecturePropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kunknown","kx86_64","kppc64le","kppc","ks390x","ksparc","kia64","kx86"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		physicalProtectionSourceTypeCPUArchitecturePropEnum = append(physicalProtectionSourceTypeCPUArchitecturePropEnum, v)
	}
}

const (

	// PhysicalProtectionSourceCPUArchitectureKunknown captures enum value "kunknown"
	PhysicalProtectionSourceCPUArchitectureKunknown string = "kunknown"

	// PhysicalProtectionSourceCPUArchitectureKx8664 captures enum value "kx86_64"
	PhysicalProtectionSourceCPUArchitectureKx8664 string = "kx86_64"

	// PhysicalProtectionSourceCPUArchitectureKppc64le captures enum value "kppc64le"
	PhysicalProtectionSourceCPUArchitectureKppc64le string = "kppc64le"

	// PhysicalProtectionSourceCPUArchitectureKppc captures enum value "kppc"
	PhysicalProtectionSourceCPUArchitectureKppc string = "kppc"

	// PhysicalProtectionSourceCPUArchitectureKs390x captures enum value "ks390x"
	PhysicalProtectionSourceCPUArchitectureKs390x string = "ks390x"

	// PhysicalProtectionSourceCPUArchitectureKsparc captures enum value "ksparc"
	PhysicalProtectionSourceCPUArchitectureKsparc string = "ksparc"

	// PhysicalProtectionSourceCPUArchitectureKia64 captures enum value "kia64"
	PhysicalProtectionSourceCPUArchitectureKia64 string = "kia64"

	// PhysicalProtectionSourceCPUArchitectureKx86 captures enum value "kx86"
	PhysicalProtectionSourceCPUArchitectureKx86 string = "kx86"
)

// prop value enum
func (m *PhysicalProtectionSource) validateCPUArchitectureEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, physicalProtectionSourceTypeCPUArchitecturePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PhysicalProtectionSource) validateCPUArchitecture(formats strfmt.Registry) error {
	if swag.IsZero(m.CPUArchitecture) { // not required
		return nil
	}

	// value enum
	if err := m.validateCPUArchitectureEnum("cpuArchitecture", "body", *m.CPUArchitecture); err != nil {
		return err
	}
