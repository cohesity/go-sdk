...
type PrivateAcropolisEntity struct {
	...
	// IP address of a PE cluster.
	// This will be set just for entities of type 'kCluster'.
	ClusterIP *string `json:"clusterIp,omitempty"`

	// The UUID of the cluster (PE UUID) instance to which this entity belongs
	// to. The above field 'uuid' is unique within a cluster. Pair ('uuid' and
	...
	// 'kStandaloneCluster', 'kCluster', 'kTagCategory' and 'kTag'.
	...
	// Only applies to kTag/kTagCategory entities. Whether this entity is Nutanix
	// system defined.
	SystemDefined *bool `json:"systemDefined,omitempty"`

	// Optional list of tag attributes associated with this entity. Only
	// applicable to type kVirtualMachine.
	...
	// Only applies to kTag entities. Represents a possible value for a category
	// key.
...
func (m *PrivateAcropolisEntity) validateTagAttributesVec(formats strfmt.Registry) error {
...
func (m *PrivateAcropolisEntity) contextValidateTagAttributesVec(ctx context.Context, formats strfmt.Registry) error {
