...
type OracleDBChannelInfo struct {
	...
	// If this field is not empty, datagaurd role based backup will be enabled
	// accordingly.
	DgRoleBasedBackup *OracleDBChannelInfoDgRoleBasedBackup `json:"dgRoleBasedBackup,omitempty"`
...
func (m *OracleDBChannelInfo) validateDgRoleBasedBackup(formats strfmt.Registry) error {
...
func (m *OracleDBChannelInfo) contextValidateDgRoleBasedBackup(ctx context.Context, formats strfmt.Registry) error {
