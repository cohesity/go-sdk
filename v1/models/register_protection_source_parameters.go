...
type RegisterProtectionSourceParameters struct {
	...
	// overrideDescription: true
	// Enum: [kStorageArray]
	Hpe3ParType *string `json:"hpe3ParType,omitempty"`
	...
	// Specifies the entity type such as 'kPrismCentral,' if the environment is
	// kNutanixFS.
	// Enum: [kPrismCentral kPrismElement kFileServer kMountTarget]
	NutanixFSType *string `json:"nutanixFSType,omitempty"`
...
func (m *RegisterProtectionSourceParameters) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateHpe3ParType(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateNutanixFSType(formats); err != nil {
		res = append(res, err)
	}
...
var registerProtectionSourceParametersTypeHpe3ParTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		registerProtectionSourceParametersTypeHpe3ParTypePropEnum = append(registerProtectionSourceParametersTypeHpe3ParTypePropEnum, v)
	}
}

const (

	// RegisterProtectionSourceParametersHpe3ParTypeKStorageArray captures enum value "kStorageArray"
	RegisterProtectionSourceParametersHpe3ParTypeKStorageArray string = "kStorageArray"
)

// prop value enum
func (m *RegisterProtectionSourceParameters) validateHpe3ParTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, registerProtectionSourceParametersTypeHpe3ParTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *RegisterProtectionSourceParameters) validateHpe3ParType(formats strfmt.Registry) error {
	if swag.IsZero(m.Hpe3ParType) { // not required
		return nil
	}

	// value enum
	if err := m.validateHpe3ParTypeEnum("hpe3ParType", "body", *m.Hpe3ParType); err != nil {
		return err
	}
...
var registerProtectionSourceParametersTypeNutanixFSTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		registerProtectionSourceParametersTypeNutanixFSTypePropEnum = append(registerProtectionSourceParametersTypeNutanixFSTypePropEnum, v)
	}
}

const (

	// RegisterProtectionSourceParametersNutanixFSTypeKPrismCentral captures enum value "kPrismCentral"
	RegisterProtectionSourceParametersNutanixFSTypeKPrismCentral string = "kPrismCentral"

	// RegisterProtectionSourceParametersNutanixFSTypeKPrismElement captures enum value "kPrismElement"
	RegisterProtectionSourceParametersNutanixFSTypeKPrismElement string = "kPrismElement"

	// RegisterProtectionSourceParametersNutanixFSTypeKFileServer captures enum value "kFileServer"
	RegisterProtectionSourceParametersNutanixFSTypeKFileServer string = "kFileServer"

	// RegisterProtectionSourceParametersNutanixFSTypeKMountTarget captures enum value "kMountTarget"
	RegisterProtectionSourceParametersNutanixFSTypeKMountTarget string = "kMountTarget"
)

// prop value enum
func (m *RegisterProtectionSourceParameters) validateNutanixFSTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, registerProtectionSourceParametersTypeNutanixFSTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *RegisterProtectionSourceParameters) validateNutanixFSType(formats strfmt.Registry) error {
	if swag.IsZero(m.NutanixFSType) { // not required
		return nil
	}

	// value enum
	if err := m.validateNutanixFSTypeEnum("nutanixFSType", "body", *m.NutanixFSType); err != nil {
		return err
	}
