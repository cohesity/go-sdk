...
type PerformRestoreJobStateProto struct {
	...
	// This field defines the Outlook specific params for restore task of type
	// kRecoverEmails, kConvertToPst and kRecoverO365ToExchangeServer.
	...
	// This field captures the user selected cluster interface during VM recovery
	...
	// transient info
	TransientInfo PerformRestoreJobStateProtoTransientInfo `json:"transientInfo,omitempty"`
...
func (m *PerformRestoreJobStateProto) validateFilterParams(formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) validateRestoreAzureBlobStorageParams(formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) validateRestoreOutlookParams(formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) validateRestoreVlanParams(formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) contextValidateFilterParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) contextValidateRestoreAzureBlobStorageParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) contextValidateRestoreOutlookParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PerformRestoreJobStateProto) contextValidateRestoreVlanParams(ctx context.Context, formats strfmt.Registry) error {
