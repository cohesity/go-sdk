...
func (m *MountVolumesParams) validateSmbMountUserCreds(formats strfmt.Registry) error {
...
func (m *MountVolumesParams) contextValidateSmbMountUserCreds(ctx context.Context, formats strfmt.Registry) error {
