...
// StringEntityIds Specifies the model to uniquely id an entity.
//
...
type StringEntityIds struct {
	...
	// Specifies the latest string entity id. This
	...
	// Specifies the latest source-generated ID for an entity.
	...
	// Specifies all the StringIds previously assigned to this
	// entity. Note that it doesn't contain the latest id.
	PreviousIds []*VersionInfo `json:"previousIds"`

	// Specifies a list of previously assigned source-generated IDs for
