...
type ItemMetaData struct {
	...
	// Completed date/time for the task.
	...
	// End date/time for the events (Is also experimentally same as the end
	// date time of the first occurrence in case of reccurring events).
	EndDateTime *ItemMetaDataDateTimeTZone `json:"endDateTime,omitempty"`
	...
	// Name of the folder to which the item belongs to.
	FolderName *string `json:"folderName,omitempty"`

	// The root folder to which the item belongs to.
	...
	// The graph Parent folder id of the item.
	GraphParentFolderID *string `json:"graphParentFolderId,omitempty"`
	...
	// item externalization method
	ItemExternalizationMethod *int32 `json:"itemExternalizationMethod,omitempty"`

	// Having a repeated field will allow us to track item history for future
	// usecases.
	ItemHistory []*ItemMetaDataItemExportStats `json:"itemHistory"`
	...
	// For MSGraph API based backups, populate the parent-folder's rest/Graph ID
	// in graph_parent_folder_id field.
	...
	Recurrence *ItemMetaDataRecurrenceInfo `json:"recurrence,omitempty"`
	...
	// Start date/time for the events (Is also experimentally same as the start
	// date time of the first occurrence in case of reccurring events).
	...
	// Indicates the level of verification checks that were performed on this
	// item when the item was downloaded from Microsoft.
	VerificationLevel *int32 `json:"verificationLevel,omitempty"`
...
func (m *ItemMetaData) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateItemHistory(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ItemMetaData) validateCompletedDateTime(formats strfmt.Registry) error {
...
func (m *ItemMetaData) validateDueDateTime(formats strfmt.Registry) error {
...
func (m *ItemMetaData) validateEndDateTime(formats strfmt.Registry) error {
	...
	if m.EndDateTime != nil {
		if err := m.EndDateTime.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("endDateTime")
			}
			return err
		}
	}
...
func (m *ItemMetaData) validateItemHistory(formats strfmt.Registry) error {
	if swag.IsZero(m.ItemHistory) { // not required
		return nil
	}

	for i := 0; i < len(m.ItemHistory); i++ {
		if swag.IsZero(m.ItemHistory[i]) { // not required
			continue
		}

		if m.ItemHistory[i] != nil {
			if err := m.ItemHistory[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("itemHistory" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("itemHistory" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *ItemMetaData) validateRecurrence(formats strfmt.Registry) error {
...
func (m *ItemMetaData) validateStartDateTime(formats strfmt.Registry) error {
...
func (m *ItemMetaData) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateItemHistory(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ItemMetaData) contextValidateCompletedDateTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItemMetaData) contextValidateDueDateTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItemMetaData) contextValidateEndDateTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItemMetaData) contextValidateItemHistory(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.ItemHistory); i++ {
		...
		if m.ItemHistory[i] != nil {
			...
			if err := m.ItemHistory[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("itemHistory" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("itemHistory" + "." + strconv.Itoa(i))
...
func (m *ItemMetaData) contextValidateRecurrence(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ItemMetaData) contextValidateStartDateTime(ctx context.Context, formats strfmt.Registry) error {
