...
type FileStatInfo struct {
	...
	// Metadata for the onedrive item in browse. This will be set only if we
	// are quering for user onedrive. This is used to further different between
	// item types, for example a kDirectory item in sharepoint site could be a
	// onenote notebook (kNotebook) or folder (kDirectory).
