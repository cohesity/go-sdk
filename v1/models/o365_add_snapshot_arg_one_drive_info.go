...
type O365AddSnapshotArgOneDriveInfo struct {
	...
	// Has Magneto specifically asked full indexing for a particular OneDrive
	// snapshot or not.
	// should_trigger_onedrive_full_indexing has preference over
	// incremental_indexing_enabled.
	ShouldTriggerOnedriveFullIndexing *bool `json:"shouldTriggerOnedriveFullIndexing,omitempty"`
}
