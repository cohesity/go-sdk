...
const (
	...
	// NodeRemovalStateKDontRemove captures enum value "kDontRemove"
	NodeRemovalStateKDontRemove string = "kDontRemove"

	// NodeRemovalStateKMarkedForRemoval captures enum value "kMarkedForRemoval"
	NodeRemovalStateKMarkedForRemoval string = "kMarkedForRemoval"

	// NodeRemovalStateKOkToRemove captures enum value "kOkToRemove"
	NodeRemovalStateKOkToRemove string = "kOkToRemove"
)
