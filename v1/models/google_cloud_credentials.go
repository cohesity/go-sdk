...
type GoogleCloudCredentials struct {
	...
	// Specifies the google authentication type to be used for API calls.
	// 'kServiceAccountKeys': User will input a private key for the service account.
	// 'kServiceAccountAttached': Assumes the identity of the service account
	// attached to the GCP VM and retrieves an access token from the metadata server
	// to authenticate calls to Google Cloud Storage
	// 'kServiceAccountImpersonation': Assumes the identity of a specified service
	// account, requiring that the GCP VM's attached service account has the
	// necessary role to impersonate it.
	// 'kHelios': Use Helios to acquire temporary credentials.
	// Enum: [kServiceAccountKeys kServiceAccountAttached kServiceAccountImpersonation kHelios]
	...
	// Specifies the region for Gcp account. This is only populated for
	// FortKnox vaults.
	...
	// Enum: [kGoogleStandard kGoogleNearline kGoogleColdline kGoogleRegional kGoogleMultiRegional kGoogleArchive]
...
var googleCloudCredentialsTypeAuthMethodPropEnum []interface{}

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kServiceAccountKeys","kServiceAccountAttached","kServiceAccountImpersonation","kHelios"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		googleCloudCredentialsTypeAuthMethodPropEnum = append(googleCloudCredentialsTypeAuthMethodPropEnum, v)
	}
}

const (

	// GoogleCloudCredentialsAuthMethodKServiceAccountKeys captures enum value "kServiceAccountKeys"
	GoogleCloudCredentialsAuthMethodKServiceAccountKeys string = "kServiceAccountKeys"

	// GoogleCloudCredentialsAuthMethodKServiceAccountAttached captures enum value "kServiceAccountAttached"
	GoogleCloudCredentialsAuthMethodKServiceAccountAttached string = "kServiceAccountAttached"

	// GoogleCloudCredentialsAuthMethodKServiceAccountImpersonation captures enum value "kServiceAccountImpersonation"
	GoogleCloudCredentialsAuthMethodKServiceAccountImpersonation string = "kServiceAccountImpersonation"

	// GoogleCloudCredentialsAuthMethodKHelios captures enum value "kHelios"
	GoogleCloudCredentialsAuthMethodKHelios string = "kHelios"
)

// prop value enum
func (m *GoogleCloudCredentials) validateAuthMethodEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, googleCloudCredentialsTypeAuthMethodPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *GoogleCloudCredentials) validateAuthMethod(formats strfmt.Registry) error {
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kGoogleStandard","kGoogleNearline","kGoogleColdline","kGoogleRegional","kGoogleMultiRegional","kGoogleArchive"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// GoogleCloudCredentialsTierTypeKGoogleArchive captures enum value "kGoogleArchive"
	GoogleCloudCredentialsTierTypeKGoogleArchive string = "kGoogleArchive"
)
