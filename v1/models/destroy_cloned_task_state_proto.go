...
type DestroyClonedTaskStateProto struct {
	...
	// Master populates the information about the destroy restore disks task,
	// Slave populates the progress and status of the task.
	DestroyRecoverDisksTaskInfo *DestroyRecoverDisksTaskInfoProto `json:"destroyRecoverDisksTaskInfo,omitempty"`
...
func (m *DestroyClonedTaskStateProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDestroyRecoverDisksTaskInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DestroyClonedTaskStateProto) validateDestroyRecoverDisksTaskInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.DestroyRecoverDisksTaskInfo) { // not required
		return nil
	}

	if m.DestroyRecoverDisksTaskInfo != nil {
		if err := m.DestroyRecoverDisksTaskInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("destroyRecoverDisksTaskInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("destroyRecoverDisksTaskInfo")
			}
			return err
		}
	}
...
func (m *DestroyClonedTaskStateProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDestroyRecoverDisksTaskInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *DestroyClonedTaskStateProto) contextValidateDestroyRecoverDisksTaskInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.DestroyRecoverDisksTaskInfo != nil {
		if err := m.DestroyRecoverDisksTaskInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("destroyRecoverDisksTaskInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("destroyRecoverDisksTaskInfo")
