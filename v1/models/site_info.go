...
type SiteInfo struct {
	...
	// Storage quota (in MB) allocated to the site. Determines the maximum
	// allowed storage space for the site's content.
	StorageQuotaMb *int32 `json:"storageQuotaMb,omitempty"`
