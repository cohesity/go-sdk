...
type HdfsConnectParams struct {
	...
	// Specifies the Hdfs connection type.
	// Hdfs connection type.
	//
	// 'DFS' indicates Hdfs connection type DFS.
	// 'WEBHDFS' indicates Hdfs connection type WEBHDFS.
	// 'HTTPFSLB' indicates Hdfs connection type HTTPFS_LB.
	// 'HTTPFS' indicates Hdfs connection type HTTPFS.
...
var hdfsConnectParamsTypeHdfsConnectionTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		hdfsConnectParamsTypeHdfsConnectionTypePropEnum = append(hdfsConnectParamsTypeHdfsConnectionTypePropEnum, v)
	}
}

const (

	// HdfsConnectParamsHdfsConnectionTypeDFS captures enum value "DFS"
	HdfsConnectParamsHdfsConnectionTypeDFS string = "DFS"

	// HdfsConnectParamsHdfsConnectionTypeWEBHDFS captures enum value "WEBHDFS"
	HdfsConnectParamsHdfsConnectionTypeWEBHDFS string = "WEBHDFS"

	// HdfsConnectParamsHdfsConnectionTypeHTTPFSLB captures enum value "HTTPFSLB"
	HdfsConnectParamsHdfsConnectionTypeHTTPFSLB string = "HTTPFSLB"

	// HdfsConnectParamsHdfsConnectionTypeHTTPFS captures enum value "HTTPFS"
	HdfsConnectParamsHdfsConnectionTypeHTTPFS string = "HTTPFS"
)

// prop value enum
func (m *HdfsConnectParams) validateHdfsConnectionTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, hdfsConnectParamsTypeHdfsConnectionTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *HdfsConnectParams) validateHdfsConnectionType(formats strfmt.Registry) error {
