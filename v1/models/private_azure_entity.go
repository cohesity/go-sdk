...
type PrivateAzureEntity struct {
	...
	// Azure Kubernetes(AKS) specific properties.
	AksProperties *EntityAzureKubernetesProperties `json:"aksProperties,omitempty"`

	// Detailed Azure Storage blob properties,
	// if this entity is a blob container.
	BlobContainer *AzureBlobContainer `json:"blobContainer,omitempty"`
	...
	// Enabled protocol on a File Share. Currently set for entities of type
	// kFileShare
	EnabledProtocols *string `json:"enabledProtocols,omitempty"`

	// Statistics about the number of user/group/applications etc for the tenant.
	EntraIDStats *EntraIDStats `json:"entraIdStats,omitempty"`
	...
	OpaqueEntityInfo []uint8 `json:"opaqueEntityInfo"`
	...
	// Share quota of an Azure File Share. This is set for entities of type
	// kFileShare.
	ShareQuotaGb *int64 `json:"shareQuotaGb,omitempty"`
	...
	// Detailed Azure Storage Account properties,
	// if this entity is a storage account.
	StorageAccount *AzureStorageAccount `json:"storageAccount,omitempty"`
...
func (m *PrivateAzureEntity) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAksProperties(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateBlobContainer(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateEntraIDStats(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PrivateAzureEntity) validateAksProperties(formats strfmt.Registry) error {
	if swag.IsZero(m.AksProperties) { // not required
		return nil
	}

	if m.AksProperties != nil {
		if err := m.AksProperties.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("aksProperties")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("aksProperties")
			}
			return err
		}
	}
...
func (m *PrivateAzureEntity) validateBlobContainer(formats strfmt.Registry) error {
	if swag.IsZero(m.BlobContainer) { // not required
		return nil
	}

	if m.BlobContainer != nil {
		if err := m.BlobContainer.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("blobContainer")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("blobContainer")
			}
			return err
		}
	}
...
func (m *PrivateAzureEntity) validateEntraIDStats(formats strfmt.Registry) error {
	if swag.IsZero(m.EntraIDStats) { // not required
		return nil
	}

	if m.EntraIDStats != nil {
		if err := m.EntraIDStats.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("entraIdStats")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("entraIdStats")
			}
			return err
		}
	}
...
func (m *PrivateAzureEntity) validateStorageAccount(formats strfmt.Registry) error {
...
func (m *PrivateAzureEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAksProperties(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateBlobContainer(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateEntraIDStats(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PrivateAzureEntity) contextValidateAksProperties(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.AksProperties != nil {
		...
		if err := m.AksProperties.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("aksProperties")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("aksProperties")
...
func (m *PrivateAzureEntity) contextValidateBlobContainer(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.BlobContainer != nil {
		...
		if err := m.BlobContainer.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("blobContainer")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("blobContainer")
...
func (m *PrivateAzureEntity) contextValidateEntraIDStats(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.EntraIDStats != nil {
		...
		if err := m.EntraIDStats.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("entraIdStats")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("entraIdStats")
...
func (m *PrivateAzureEntity) contextValidateStorageAccount(ctx context.Context, formats strfmt.Registry) error {
