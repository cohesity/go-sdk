...
type VMwareProtectionSource struct {
	...
	VMwareToolsRunningStatus *string `json:"toolsRunningStatus,omitempty"`
...
func (m *VMwareProtectionSource) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateVMwareToolsRunningStatus(formats); err != nil {
		res = append(res, err)
	}
...
var vMwareProtectionSourceTypeVMwareToolsRunningStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		vMwareProtectionSourceTypeVMwareToolsRunningStatusPropEnum = append(vMwareProtectionSourceTypeVMwareToolsRunningStatusPropEnum, v)
	}
}

const (

	// VMwareProtectionSourceVMwareToolsRunningStatusKUnknown captures enum value "kUnknown"
	VMwareProtectionSourceVMwareToolsRunningStatusKUnknown string = "kUnknown"

	// VMwareProtectionSourceVMwareToolsRunningStatusKGuestToolsExecutingScripts captures enum value "kGuestToolsExecutingScripts"
	VMwareProtectionSourceVMwareToolsRunningStatusKGuestToolsExecutingScripts string = "kGuestToolsExecutingScripts"

	// VMwareProtectionSourceVMwareToolsRunningStatusKGuestToolsNotRunning captures enum value "kGuestToolsNotRunning"
	VMwareProtectionSourceVMwareToolsRunningStatusKGuestToolsNotRunning string = "kGuestToolsNotRunning"

	// VMwareProtectionSourceVMwareToolsRunningStatusKGuestToolsRunning captures enum value "kGuestToolsRunning"
	VMwareProtectionSourceVMwareToolsRunningStatusKGuestToolsRunning string = "kGuestToolsRunning"
)

// prop value enum
func (m *VMwareProtectionSource) validateVMwareToolsRunningStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, vMwareProtectionSourceTypeVMwareToolsRunningStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *VMwareProtectionSource) validateVMwareToolsRunningStatus(formats strfmt.Registry) error {
	if swag.IsZero(m.VMwareToolsRunningStatus) { // not required
		return nil
	}

	// value enum
	if err := m.validateVMwareToolsRunningStatusEnum("toolsRunningStatus", "body", *m.VMwareToolsRunningStatus); err != nil {
		return err
	}
