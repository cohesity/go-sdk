...
type BackupJobTaskStateBaseProtoSourceState struct {
	...
	// The sub entity type of the source when the backup run was created.
	// For example, M365 outlook entities can have a sub_entity_type like
	// kUserMailbox, kSharedMailbox, kLinkedMailbox etc.
	SubEntityType *string `json:"subEntityType,omitempty"`
}
