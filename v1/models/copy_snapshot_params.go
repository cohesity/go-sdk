...
type CopySnapshotParams struct {
	...
	// If there are some entities in this vec, then only those entities will be
	// copied or have their retention / legal hold status updated. If this vec
	// is empty, then these copy snapshot params will be applicable to all the
	// entities in the backup run.
