...
// HypervRestoreParameters Hyperv Restore Parameters.
//
...
// kRecoverVMs.
//
// swagger:model HypervRestoreParameters
...
// Validate validates this hyperv restore parameters
func (m *HypervRestoreParameters) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this hyperv restore parameters based on context it is used
func (m *HypervRestoreParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *HypervRestoreParameters) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *HypervRestoreParameters) UnmarshalBinary(b []byte) error {
	var res HypervRestoreParameters
