...
type KmsCreateRequestParameters struct {
	...
	// GCP KMS config
	GcpKms *GcpKmsConfiguration `json:"gcpKms,omitempty"`
	...
	// 'kIbmKMS' indicates a IBM KMS object.
	// 'kGcpKMS' indicates a GCP KMS object.
	// Enum: ["kInternalKMS","kAwsKMS","kCryptsoftKMS","kAzureKMS","kIbmKMS","kGcpKMS"]
...
func (m *KmsCreateRequestParameters) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGcpKms(formats); err != nil {
		res = append(res, err)
	}
...
func (m *KmsCreateRequestParameters) validateGcpKms(formats strfmt.Registry) error {
	if swag.IsZero(m.GcpKms) { // not required
		return nil
	}

	if m.GcpKms != nil {
		if err := m.GcpKms.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gcpKms")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gcpKms")
			}
			return err
		}
	}
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kInternalKMS","kAwsKMS","kCryptsoftKMS","kAzureKMS","kIbmKMS","kGcpKMS"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// KmsCreateRequestParametersServerTypeKIbmKMS captures enum value "kIbmKMS"
	KmsCreateRequestParametersServerTypeKIbmKMS string = "kIbmKMS"

	// KmsCreateRequestParametersServerTypeKGcpKMS captures enum value "kGcpKMS"
	KmsCreateRequestParametersServerTypeKGcpKMS string = "kGcpKMS"
)
...
func (m *KmsCreateRequestParameters) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGcpKms(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *KmsCreateRequestParameters) contextValidateGcpKms(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GcpKms != nil {
		...
		if err := m.GcpKms.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("gcpKms")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("gcpKms")
