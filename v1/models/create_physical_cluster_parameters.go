...
var createPhysicalClusterParametersTypeClusterSwTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		createPhysicalClusterParametersTypeClusterSwTypePropEnum = append(createPhysicalClusterParametersTypeClusterSwTypePropEnum, v)
	}
}

const (

	// CreatePhysicalClusterParametersClusterSwTypeKOneHelios captures enum value "kOneHelios"
	CreatePhysicalClusterParametersClusterSwTypeKOneHelios string = "kOneHelios"

	// CreatePhysicalClusterParametersClusterSwTypeKNetBackup captures enum value "kNetBackup"
	CreatePhysicalClusterParametersClusterSwTypeKNetBackup string = "kNetBackup"

	// CreatePhysicalClusterParametersClusterSwTypeKRegular captures enum value "kRegular"
	CreatePhysicalClusterParametersClusterSwTypeKRegular string = "kRegular"
)

// prop value enum
func (m *CreatePhysicalClusterParameters) validateClusterSwTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, createPhysicalClusterParametersTypeClusterSwTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CreatePhysicalClusterParameters) validateClusterSwType(formats strfmt.Registry) error {
...
func (m *CreatePhysicalClusterParameters) validateNetbackConfig(formats strfmt.Registry) error {
...
func (m *CreatePhysicalClusterParameters) contextValidateNetbackConfig(ctx context.Context, formats strfmt.Registry) error {
