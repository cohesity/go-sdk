...
type RestoreO365GroupsParams struct {
	...
	ShouldRestoreSystemDoclib *bool `json:"shouldRestoreSystemDoclib,omitempty"`

	// Bool which specifies if group site template needs to be restored.
	ShouldRestoreTemplate *bool `json:"shouldRestoreTemplate,omitempty"`
	...
	// The user entity corresponding to the additional group owner provided for
	// the target group.
	TargetGroupOwnerEntity *EntityProto `json:"targetGroupOwnerEntity,omitempty"`
}
...
func (m *RestoreO365GroupsParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTargetGroupOwnerEntity(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreO365GroupsParams) validateTargetGroupOwnerEntity(formats strfmt.Registry) error {
	if swag.IsZero(m.TargetGroupOwnerEntity) { // not required
		return nil
	}

	if m.TargetGroupOwnerEntity != nil {
		if err := m.TargetGroupOwnerEntity.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("targetGroupOwnerEntity")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("targetGroupOwnerEntity")
			}
			return err
		}
	}
...
func (m *RestoreO365GroupsParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTargetGroupOwnerEntity(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreO365GroupsParams) contextValidateTargetGroupOwnerEntity(ctx context.Context, formats strfmt.Registry) error {

	if m.TargetGroupOwnerEntity != nil {
		if err := m.TargetGroupOwnerEntity.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("targetGroupOwnerEntity")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("targetGroupOwnerEntity")
