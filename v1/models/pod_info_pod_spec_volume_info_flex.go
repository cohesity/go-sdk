...
// PodInfoPodSpecVolumeInfoFlex Flex represents a generic persistent volume resource
// that is provisioned/attached using an exec based plugin.
//
// swagger:model PodInfo_PodSpec_VolumeInfo_Flex
type PodInfoPodSpecVolumeInfoFlex struct {
...
// Validate validates this pod info pod spec volume info flex
...
func (m *PodInfoPodSpecVolumeInfoFlex) validateSecretRef(formats strfmt.Registry) error {
...
// ContextValidate validate this pod info pod spec volume info flex based on the context it is used
...
func (m *PodInfoPodSpecVolumeInfoFlex) contextValidateSecretRef(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PodInfoPodSpecVolumeInfoFlex) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PodInfoPodSpecVolumeInfoFlex) UnmarshalBinary(b []byte) error {
	var res PodInfoPodSpecVolumeInfoFlex
