...
type SalesforceAccountInfo struct {
	...
	// Specifies whether user is a helios self managed approved user.
	IsHeliosSelfManagedApprovedUser *bool `json:"isHeliosSelfManagedApprovedUser,omitempty"`

	// Specifies whether user is a perpetual license user.
	IsPerpetualLicenseUser *bool `json:"isPerpetualLicenseUser,omitempty"`
