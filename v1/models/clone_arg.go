...
type CloneArg struct {
	...
	// Specifies NFS protocol version. This protocol will be employed
	// for mounting the Cohesity storage via NFS on the primary source.
	NfsProtocol *int32 `json:"nfsProtocol,omitempty"`
	...
	// Specifies whether to download data to cluster when cloning a view.
	// This is applicable only for view clone operations.
	ShouldDownloadDataToCluster *bool `json:"shouldDownloadDataToCluster,omitempty"`
