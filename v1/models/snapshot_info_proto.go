...
// o365/o365.proto           133
//
// SnapshotInfo::generic_adapter_snapshot_info    generic_adapter.proto     134
// =============================================================================
//
...
type SnapshotInfoProto struct {
	...
	AdditionalBackupMetadata []uint8 `json:"additionalBackupMetadata"`
	...
	// The name of the directive file persisted to view, this will be set
	// after successfully persisting the directive file to view.
	DirectiveFileViewPath *string `json:"directiveFileViewPath,omitempty"`
	...
	TotalSparseFiles *int64 `json:"totalSparseFiles,omitempty"`
	...
	UsedViewModule *bool `json:"usedViewModule,omitempty"`
	...
	// Stores Tiering reports information for a particular snapshot.
	TieringReportsInfo *TieringReportsInfo `json:"tieringReportsInfo,omitempty"`
}
...
func (m *SnapshotInfoProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateTieringReportsInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *SnapshotInfoProto) validateTieringReportsInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.TieringReportsInfo) { // not required
		return nil
	}

	if m.TieringReportsInfo != nil {
		if err := m.TieringReportsInfo.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("tieringReportsInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("tieringReportsInfo")
			}
			return err
		}
	}
...
func (m *SnapshotInfoProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateTieringReportsInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *SnapshotInfoProto) contextValidateTieringReportsInfo(ctx context.Context, formats strfmt.Registry) error {

	if m.TieringReportsInfo != nil {
		if err := m.TieringReportsInfo.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("tieringReportsInfo")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("tieringReportsInfo")
