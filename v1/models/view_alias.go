...
// Validate validates this view alias
func (m *ViewAlias) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ViewAlias) validateSharePermissions(formats strfmt.Registry) error {
...
func (m *ViewAlias) validateSubnetWhitelist(formats strfmt.Registry) error {
...
// ContextValidate validate this view alias based on the context it is used
func (m *ViewAlias) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ViewAlias) contextValidateSharePermissions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewAlias) contextValidateSubnetWhitelist(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewAlias) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ViewAlias) UnmarshalBinary(b []byte) error {
	var res ViewAlias
