...
type AgentDeploymentStatusResponse struct {
	...
	AgentCertificateIssuer *string `json:"certificateIssuer,omitempty"`
	...
	CertificateExpiryTime *int64 `json:"certificateExpiryTimeUsecs,omitempty"`
	...
	// Specifies the FIPS Status on the agent.
