...
type ProtectionRunStateProto struct {
	...
	// This copy_run contains a merged copy run which represents the current
	// state of all the copies.
	CopyRun *CopyBackupRunStateProto `json:"copyRun,omitempty"`

	// This will contain information about all copy runs of the protection run
	// if it was requested.
	CopyRunsVec []*CopyBackupRunStateProto `json:"copyRunsVec"`
...
func (m *ProtectionRunStateProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateCopyRunsVec(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionRunStateProto) validateCopyRunsVec(formats strfmt.Registry) error {
	if swag.IsZero(m.CopyRunsVec) { // not required
		return nil
	}

	for i := 0; i < len(m.CopyRunsVec); i++ {
		if swag.IsZero(m.CopyRunsVec[i]) { // not required
			continue
		}

		if m.CopyRunsVec[i] != nil {
			if err := m.CopyRunsVec[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("copyRunsVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("copyRunsVec" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *ProtectionRunStateProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateCopyRunsVec(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionRunStateProto) contextValidateCopyRunsVec(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.CopyRunsVec); i++ {
		...
		if m.CopyRunsVec[i] != nil {
			...
			if err := m.CopyRunsVec[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("copyRunsVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("copyRunsVec" + "." + strconv.Itoa(i))
