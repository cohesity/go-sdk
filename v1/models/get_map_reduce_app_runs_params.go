...
type GetMapReduceAppRunsParams struct {
	...
	ApplicationID *int64 `json:"appId,omitempty"`

	// ApplicationInstanceId is the Id of the map reduce application instance.
	ApplicationInstanceID *int64 `json:"appInstanceId,omitempty"`
	...
	MaxRunEndTimestampInSecs *int64 `json:"maxRunEndTimeInSecs,omitempty"`
	...
	MaxRunStartTimestampInSecs *int64 `json:"maxRunStartTimeInSecs,omitempty"`
	...
	// of time.
	MinRunEndTimestampInSecs *int64 `json:"minRunEndTimeInSecs,omitempty"`
	...
	// of time.
	MinRunStartTimestampInSecs *int64 `json:"minRunStartTimeInSecs,omitempty"`
