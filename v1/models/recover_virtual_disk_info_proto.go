...
//
// RecoverVirtualDiskInfoProto extension     Location                    No.
// =============================================================================
// vmware::
// CopyRecoverVirtualDiskInfo::
// vmware_recover_virtual_disk_info          vmware/vmware.proto          100
// azure::
// AzureRecoverVirtualDiskInfo::
// azure_recover_virtual_disk_info           azure/azure.proto            101
// =============================================================================
//
...
type RecoverVirtualDiskInfoProto struct {
	...
	// Maximum size of each sub task while disk recovery is happening.
	MaxSubTaskSizeBytesMb *int64 `json:"maxSubTaskSizeBytesMb,omitempty"`

	// The task moref of the migrate job.
	MigrateTaskMoref *MORef `json:"migrateTaskMoref,omitempty"`

	// Minimum size of each sub task while disk recovery is happening.
	MinSubTaskSizeBytesMb *int64 `json:"minSubTaskSizeBytesMb,omitempty"`
	...
	// Total bytes to write to the destination/source during disk recovery.
	// Used for progress monitoring and sub-task weight calculation.
	// Currently only used by Azure adapter.
	TotalBytesToWriteToSource *int64 `json:"totalBytesToWriteToSource,omitempty"`
