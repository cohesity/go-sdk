...
type RestoreOutlookParams struct {
	...
	// If set to true, the restore is allowed to use the graph item import
	// APIs and workflow.
	AllowGraphImportRestore *bool `json:"allowGraphImportRestore,omitempty"`
	...
	// Parameters about the Exchange server being recovered to.
	EwsExchangeTarget *RestoreOutlookParamsEwsExchangeTarget `json:"ewsExchangeTarget,omitempty"`
...
func (m *RestoreOutlookParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateEwsExchangeTarget(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreOutlookParams) validateEwsExchangeTarget(formats strfmt.Registry) error {
	if swag.IsZero(m.EwsExchangeTarget) { // not required
		return nil
	}

	if m.EwsExchangeTarget != nil {
		if err := m.EwsExchangeTarget.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ewsExchangeTarget")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ewsExchangeTarget")
			}
			return err
		}
	}
...
func (m *RestoreOutlookParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateEwsExchangeTarget(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreOutlookParams) contextValidateEwsExchangeTarget(ctx context.Context, formats strfmt.Registry) error {

	if m.EwsExchangeTarget != nil {
		if err := m.EwsExchangeTarget.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("ewsExchangeTarget")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("ewsExchangeTarget")
