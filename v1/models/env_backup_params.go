...
type EnvBackupParams struct {
	...
	// This is applicable to kAzureBlobStorage job type.
	AzureBlobStorageBackupJobParams AzureBlobStorageBackupJobParams `json:"azureBlobStorageBackupJobParams,omitempty"`
	...
	// This is applicable to environments that support generic adapter backup.
	// This can be populated in addition to any other environment specific field.
	GenericAdapterBackupJobParams *GenericAdapterBackupJobParams `json:"genericAdapterBackupJobParams,omitempty"`
...
func (m *EnvBackupParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGenericAdapterBackupJobParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *EnvBackupParams) validateGenericAdapterBackupJobParams(formats strfmt.Registry) error {
	if swag.IsZero(m.GenericAdapterBackupJobParams) { // not required
		return nil
	}

	if m.GenericAdapterBackupJobParams != nil {
		if err := m.GenericAdapterBackupJobParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterBackupJobParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterBackupJobParams")
			}
			return err
		}
	}
...
func (m *EnvBackupParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGenericAdapterBackupJobParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *EnvBackupParams) contextValidateGenericAdapterBackupJobParams(ctx context.Context, formats strfmt.Registry) error {

	if m.GenericAdapterBackupJobParams != nil {
		if err := m.GenericAdapterBackupJobParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterBackupJobParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterBackupJobParams")
