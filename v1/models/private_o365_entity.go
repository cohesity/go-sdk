...
type PrivateO365Entity struct {
	...
	// Delta refresh params. This is set for kDomain entity.
	DeltaRefreshParams *M365DeltaRefreshParams `json:"deltaRefreshParams,omitempty"`
	...
	// User's OneDrive's site id. This is not populated for kSite entity. Only
	// populated for kUser when onedrive is enabled.
...
func (m *PrivateO365Entity) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDeltaRefreshParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PrivateO365Entity) validateDeltaRefreshParams(formats strfmt.Registry) error {
	if swag.IsZero(m.DeltaRefreshParams) { // not required
		return nil
	}

	if m.DeltaRefreshParams != nil {
		if err := m.DeltaRefreshParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deltaRefreshParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deltaRefreshParams")
			}
			return err
		}
	}
...
func (m *PrivateO365Entity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDeltaRefreshParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PrivateO365Entity) contextValidateDeltaRefreshParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.DeltaRefreshParams != nil {
		...
		if err := m.DeltaRefreshParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("deltaRefreshParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("deltaRefreshParams")
