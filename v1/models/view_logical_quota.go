...
// ViewLogicalQuota Specifies an optional logical quota limit (in bytes) for the usage allowed
// on this View.
...
// across Nodes.
//
// swagger:model viewLogicalQuota
type ViewLogicalQuota struct {
	QuotaPolicy
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *ViewLogicalQuota) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 QuotaPolicy
...
func (m ViewLogicalQuota) MarshalJSON() ([]byte, error) {
...
// Validate validates this view logical quota
func (m *ViewLogicalQuota) Validate(formats strfmt.Registry) error {
	var res []error
...
// ContextValidate validate this view logical quota based on the context it is used
func (m *ViewLogicalQuota) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ViewLogicalQuota) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ViewLogicalQuota) UnmarshalBinary(b []byte) error {
	var res ViewLogicalQuota
