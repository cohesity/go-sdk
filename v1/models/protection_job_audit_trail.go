...
type ProtectionJobAuditTrail struct {
	...
	// kProtectionJobPausedNoteChange implies that protection job has change in
	// the paused note settings.
	// kProtectionJobSchedule, kProtectionJobFullSchedule,
	// kProtectionJobRetrySettings, kProtectionJobRetentionPolicy,
	// kProtectionJobIndexingPolicy, kProtectionJobAlertingPolicy,
	// kProtectionJobPriority, kProtectionJobQuiesce, kProtectionJobSla,
	// kProtectionJobPolicyId, kProtectionJobTimezone,
	// kProtectionJobFutureRunsPaused, kProtectionJobFutureRunsResumed,
	// kSnapshotTargetPolicy, kProtectionJobBlackoutWindow, kProtectionJobQOS,
	// kProtectionJobInvalidField, kProtectionJobPausedNoteChange
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kProtectionJobName","kProtectionJobDescription","kProtectionJobSources"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
