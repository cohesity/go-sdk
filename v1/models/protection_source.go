...
type ProtectionSource struct {
	...
	// Specifies details about a DB2 Protection Source
	// when the environment is set to 'DB2'.
	DB2ProtectionSource struct {
		DB2ProtectionSource
	} `json:"dB2ProtectionSource,omitempty"`
	...
	// Specifies details about a Experimental Adapter Source
	// when the environment is set to 'kExperimentalAdapter'.
	ExperimentalAdapterProtectionSource struct {
		ExperimentalAdapterProtectionSource
	} `json:"experimentalAdapterProtectionSource,omitempty"`
	...
	// Specifies details about a Google Workspace Source
	// when the environment is set to 'kGoogleWorkspace'.
	GoogleWorkspaceProtectionSource struct {
		GoogleWorkspaceProtectionSource
	} `json:"googleWorkspaceProtectionSource,omitempty"`
	...
	// when the environment is set to 'kHpe3Par'.
	Hpe3ParProtectionSource struct {
		Hpe3ParProtectionSource
	} `json:"hpe3ParProtectionSource,omitempty"`
	...
	// Tag attributes associated with this entity for this entity to be indexed
	// against for search purposes. For example, in CCS this will be consumed by
	// ETL for indexing this entity for search via GlobalSearch. All tags in the
	// vec will have their respective keys and values indexed against this global
	// entity.
	IndexableTagAttributes []*IndexableTagAttribute `json:"indexableTagAttributes"`
	...
	// Specifies details about a Jira Protection Source
	// when the environment is set to 'kJira'.
	JiraProtectionSource struct {
		JiraProtectionSource
	} `json:"jiraProtectionSource,omitempty"`
	...
	// Specifies details about a MongoDB Physical Source
	// when the environment is set to 'kMongoDBPhysical'.
	MongoDBPhysicalProtectionSource struct {
		MongoDBPhysicalProtectionSource
	} `json:"mongoDBPhysicalProtectionSource,omitempty"`
	...
	// Specifies details about a NutanixFS Protection Source
	// when the environment is set to 'kNutanixFS'.
	NutanixFSProtectionSource struct {
		NutanixFSProtectionSource
	} `json:"nutanixFSProtectionSource,omitempty"`
	...
	// Specifies details about a Pinecone Protection Source
	// when the environment is set to 'kPinecone'.
	PineconeProtectionSource struct {
		PineconeProtectionSource
	} `json:"pineconeProtectionSource,omitempty"`

	// Specifies details about a Postgres Protection Source
	// when the environment is set to 'kPostgres'.
	PostgresProtectionSource struct {
		PostgresProtectionSource
	} `json:"postgresProtectionSource,omitempty"`
	...
	// Specifies details about a S3 Compatible Protection Source
	// when the environment is set to 'kS3Compatible'.
	S3CompatibleProtectionSource struct {
		S3CompatibleProtectionSource
	} `json:"s3CompatibleProtectionSource,omitempty"`

	// Specifies details about a Salesforce Source
	// when the environment is set to 'kSalesforce'.
	SalesforceProtectionSource struct {
		SalesforceProtectionSource
	} `json:"salesforceProtectionSource,omitempty"`
	...
	// Specifies details about a ServiceNow Source
	// when the environment is set to 'kServiceNow'.
	ServiceNowProtectionSource struct {
		ServiceNowProtectionSource
	} `json:"serviceNowProtectionSource,omitempty"`
...
func (m *ProtectionSource) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDB2ProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateExperimentalAdapterProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateGoogleWorkspaceProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateHpe3ParProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateIndexableTagAttributes(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateJiraProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateMongoDBPhysicalProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateNutanixFSProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validatePineconeProtectionSource(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validatePostgresProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateS3CompatibleProtectionSource(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateSalesforceProtectionSource(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateServiceNowProtectionSource(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionSource) validateDB2ProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.DB2ProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateEntityID(formats strfmt.Registry) error {
...
func (m *ProtectionSource) validateExperimentalAdapterProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.ExperimentalAdapterProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateGoogleWorkspaceProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.GoogleWorkspaceProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateHpe3ParProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.Hpe3ParProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateIndexableTagAttributes(formats strfmt.Registry) error {
	if swag.IsZero(m.IndexableTagAttributes) { // not required
		return nil
	}

	for i := 0; i < len(m.IndexableTagAttributes); i++ {
		if swag.IsZero(m.IndexableTagAttributes[i]) { // not required
			continue
		}

		if m.IndexableTagAttributes[i] != nil {
			if err := m.IndexableTagAttributes[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("indexableTagAttributes" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("indexableTagAttributes" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *ProtectionSource) validateJiraProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.JiraProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateMongoDBPhysicalProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.MongoDBPhysicalProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateNutanixFSProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.NutanixFSProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validatePineconeProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.PineconeProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validatePostgresProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.PostgresProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateS3CompatibleProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.S3CompatibleProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateSalesforceProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.SalesforceProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) validateServiceNowProtectionSource(formats strfmt.Registry) error {
	if swag.IsZero(m.ServiceNowProtectionSource) { // not required
		return nil
	}
...
func (m *ProtectionSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDB2ProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateExperimentalAdapterProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateGoogleWorkspaceProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateHpe3ParProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateIndexableTagAttributes(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateJiraProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateMongoDBPhysicalProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateNutanixFSProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidatePineconeProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidatePostgresProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateS3CompatibleProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}

	if err := m.contextValidateSalesforceProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateServiceNowProtectionSource(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionSource) contextValidateDB2ProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateEntityID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateExperimentalAdapterProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateGoogleWorkspaceProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateHpe3ParProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateIndexableTagAttributes(ctx context.Context, formats strfmt.Registry) error {
	...
	for i := 0; i < len(m.IndexableTagAttributes); i++ {
		...
		if m.IndexableTagAttributes[i] != nil {
			...
			if err := m.IndexableTagAttributes[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("indexableTagAttributes" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("indexableTagAttributes" + "." + strconv.Itoa(i))
...
func (m *ProtectionSource) contextValidateJiraProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateMongoDBPhysicalProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateNutanixFSProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidatePineconeProtectionSource(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *ProtectionSource) contextValidatePostgresProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateS3CompatibleProtectionSource(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *ProtectionSource) contextValidateSalesforceProtectionSource(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionSource) contextValidateServiceNowProtectionSource(ctx context.Context, formats strfmt.Registry) error {
