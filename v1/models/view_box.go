...
type ViewBox struct {
	...
	DefaultUserQuotaPolicy *ViewBoxDefaultUserQuotaPolicy `json:"defaultUserQuotaPolicy,omitempty"`

	// default view quota policy
	DefaultViewQuotaPolicy *ViewBoxDefaultViewQuotaPolicy `json:"defaultViewQuotaPolicy,omitempty"`
	...
	// physical quota
	PhysicalQuota *ViewBoxPhysicalQuota `json:"physicalQuota,omitempty"`
