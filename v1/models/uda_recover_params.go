...
type UdaRecoverParams struct {
	...
	// Additional metadata related to UDA adapters returned as part of
	// UdaRecoverParams
	AdapterMetadata *AdapterMetadata `json:"adapterMetadata,omitempty"`
...
func (m *UdaRecoverParams) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateAdapterMetadata(formats); err != nil {
		res = append(res, err)
	}
...
func (m *UdaRecoverParams) validateAdapterMetadata(formats strfmt.Registry) error {
	if swag.IsZero(m.AdapterMetadata) { // not required
		return nil
	}

	if m.AdapterMetadata != nil {
		if err := m.AdapterMetadata.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("adapterMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("adapterMetadata")
			}
			return err
		}
	}
...
func (m *UdaRecoverParams) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateAdapterMetadata(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *UdaRecoverParams) contextValidateAdapterMetadata(ctx context.Context, formats strfmt.Registry) error {

	if m.AdapterMetadata != nil {
		if err := m.AdapterMetadata.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("adapterMetadata")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("adapterMetadata")
