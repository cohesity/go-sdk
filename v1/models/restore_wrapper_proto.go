...
type RestoreWrapperProto struct {
	...
	// Contains information about snapshot view that was created as part of
	// RecreateLocalCopy API.
	RecreatedLocalCopyState *RecreateLocalCopyStateProto `json:"recreatedLocalCopyState,omitempty"`
...
func (m *RestoreWrapperProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRecreatedLocalCopyState(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreWrapperProto) validateRecreatedLocalCopyState(formats strfmt.Registry) error {
	if swag.IsZero(m.RecreatedLocalCopyState) { // not required
		return nil
	}

	if m.RecreatedLocalCopyState != nil {
		if err := m.RecreatedLocalCopyState.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("recreatedLocalCopyState")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("recreatedLocalCopyState")
			}
			return err
		}
	}
...
func (m *RestoreWrapperProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRecreatedLocalCopyState(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreWrapperProto) contextValidateRecreatedLocalCopyState(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RecreatedLocalCopyState != nil {
		...
		if err := m.RecreatedLocalCopyState.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("recreatedLocalCopyState")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("recreatedLocalCopyState")
