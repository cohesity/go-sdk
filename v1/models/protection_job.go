...
// ProtectionJob Protection Job.
//
// Provides details about a Protection Job.
//
// swagger:model ProtectionJob
type ProtectionJob struct {
	...
	FullProtectionStartTime *ProtectionJobFullProtectionStartTime `json:"fullProtectionStartTime,omitempty"`
	...
	IncrementalProtectionStartTime *ProtectionJobIncrementalProtectionStartTime `json:"incrementalProtectionStartTime,omitempty"`
	...
	MissingEntities []*ProtectionSource `json:"missingEntities"`
	...
	ModifiedByUser *string `json:"modifiedByUser,omitempty"`
	...
	// post backup script
	PostBackupScript *ProtectionJobPostBackupScript `json:"postBackupScript,omitempty"`

	// pre backup script
	PreBackupScript *ProtectionJobPreBackupScript `json:"preBackupScript,omitempty"`
	...
	// remote script
	RemoteScript *ProtectionJobRemoteScript `json:"remoteScript,omitempty"`
	...
	// start time
	StartTime *ProtectionJobStartTime `json:"startTime,omitempty"`
	...
	// uid
	UID *ProtectionJobUID `json:"uid,omitempty"`
...
// Validate validates this protection job
func (m *ProtectionJob) Validate(formats strfmt.Registry) error {
	var res []error
	...
	if err := m.validateSummaryStats(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionJob) validateAlertingConfig(formats strfmt.Registry) error {
...
var protectionJobAlertingPolicyItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		protectionJobAlertingPolicyItemsEnum = append(protectionJobAlertingPolicyItemsEnum, v)
	}
}

func (m *ProtectionJob) validateAlertingPolicyItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, protectionJobAlertingPolicyItemsEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProtectionJob) validateAlertingPolicy(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateCloudParameters(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateDataMigrationPolicy(formats strfmt.Registry) error {
...
var protectionJobTypeEnvironmentPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		protectionJobTypeEnvironmentPropEnum = append(protectionJobTypeEnvironmentPropEnum, v)
	}
}

const (

	// ProtectionJobEnvironmentKVMware captures enum value "kVMware"
	ProtectionJobEnvironmentKVMware string = "kVMware"

	// ProtectionJobEnvironmentKHyperV captures enum value "kHyperV"
	ProtectionJobEnvironmentKHyperV string = "kHyperV"

	// ProtectionJobEnvironmentKSQL captures enum value "kSQL"
	ProtectionJobEnvironmentKSQL string = "kSQL"

	// ProtectionJobEnvironmentKView captures enum value "kView"
	ProtectionJobEnvironmentKView string = "kView"

	// ProtectionJobEnvironmentKPuppeteer captures enum value "kPuppeteer"
	ProtectionJobEnvironmentKPuppeteer string = "kPuppeteer"

	// ProtectionJobEnvironmentKPhysical captures enum value "kPhysical"
	ProtectionJobEnvironmentKPhysical string = "kPhysical"

	// ProtectionJobEnvironmentKPure captures enum value "kPure"
	ProtectionJobEnvironmentKPure string = "kPure"

	// ProtectionJobEnvironmentKNimble captures enum value "kNimble"
	ProtectionJobEnvironmentKNimble string = "kNimble"

	// ProtectionJobEnvironmentKIbmFlashSystem captures enum value "kIbmFlashSystem"
	ProtectionJobEnvironmentKIbmFlashSystem string = "kIbmFlashSystem"

	// ProtectionJobEnvironmentKAzure captures enum value "kAzure"
	ProtectionJobEnvironmentKAzure string = "kAzure"

	// ProtectionJobEnvironmentKNetapp captures enum value "kNetapp"
	ProtectionJobEnvironmentKNetapp string = "kNetapp"

	// ProtectionJobEnvironmentKAgent captures enum value "kAgent"
	ProtectionJobEnvironmentKAgent string = "kAgent"

	// ProtectionJobEnvironmentKGenericNas captures enum value "kGenericNas"
	ProtectionJobEnvironmentKGenericNas string = "kGenericNas"

	// ProtectionJobEnvironmentKAcropolis captures enum value "kAcropolis"
	ProtectionJobEnvironmentKAcropolis string = "kAcropolis"

	// ProtectionJobEnvironmentKPhysicalFiles captures enum value "kPhysicalFiles"
	ProtectionJobEnvironmentKPhysicalFiles string = "kPhysicalFiles"

	// ProtectionJobEnvironmentKIsilon captures enum value "kIsilon"
	ProtectionJobEnvironmentKIsilon string = "kIsilon"

	// ProtectionJobEnvironmentKGPFS captures enum value "kGPFS"
	ProtectionJobEnvironmentKGPFS string = "kGPFS"

	// ProtectionJobEnvironmentKKVM captures enum value "kKVM"
	ProtectionJobEnvironmentKKVM string = "kKVM"

	// ProtectionJobEnvironmentKAWS captures enum value "kAWS"
	ProtectionJobEnvironmentKAWS string = "kAWS"

	// ProtectionJobEnvironmentKExchange captures enum value "kExchange"
	ProtectionJobEnvironmentKExchange string = "kExchange"

	// ProtectionJobEnvironmentKHyperVVSS captures enum value "kHyperVVSS"
	ProtectionJobEnvironmentKHyperVVSS string = "kHyperVVSS"

	// ProtectionJobEnvironmentKOracle captures enum value "kOracle"
	ProtectionJobEnvironmentKOracle string = "kOracle"

	// ProtectionJobEnvironmentKGCP captures enum value "kGCP"
	ProtectionJobEnvironmentKGCP string = "kGCP"

	// ProtectionJobEnvironmentKFlashBlade captures enum value "kFlashBlade"
	ProtectionJobEnvironmentKFlashBlade string = "kFlashBlade"

	// ProtectionJobEnvironmentKAWSNative captures enum value "kAWSNative"
	ProtectionJobEnvironmentKAWSNative string = "kAWSNative"

	// ProtectionJobEnvironmentKO365 captures enum value "kO365"
	ProtectionJobEnvironmentKO365 string = "kO365"

	// ProtectionJobEnvironmentKO365Outlook captures enum value "kO365Outlook"
	ProtectionJobEnvironmentKO365Outlook string = "kO365Outlook"

	// ProtectionJobEnvironmentKHyperFlex captures enum value "kHyperFlex"
	ProtectionJobEnvironmentKHyperFlex string = "kHyperFlex"

	// ProtectionJobEnvironmentKGCPNative captures enum value "kGCPNative"
	ProtectionJobEnvironmentKGCPNative string = "kGCPNative"

	// ProtectionJobEnvironmentKAzureNative captures enum value "kAzureNative"
	ProtectionJobEnvironmentKAzureNative string = "kAzureNative"

	// ProtectionJobEnvironmentKKubernetes captures enum value "kKubernetes"
	ProtectionJobEnvironmentKKubernetes string = "kKubernetes"

	// ProtectionJobEnvironmentKElastifile captures enum value "kElastifile"
	ProtectionJobEnvironmentKElastifile string = "kElastifile"

	// ProtectionJobEnvironmentKAD captures enum value "kAD"
	ProtectionJobEnvironmentKAD string = "kAD"

	// ProtectionJobEnvironmentKRDSSnapshotManager captures enum value "kRDSSnapshotManager"
	ProtectionJobEnvironmentKRDSSnapshotManager string = "kRDSSnapshotManager"

	// ProtectionJobEnvironmentKCassandra captures enum value "kCassandra"
	ProtectionJobEnvironmentKCassandra string = "kCassandra"

	// ProtectionJobEnvironmentKMongoDB captures enum value "kMongoDB"
	ProtectionJobEnvironmentKMongoDB string = "kMongoDB"

	// ProtectionJobEnvironmentKCouchbase captures enum value "kCouchbase"
	ProtectionJobEnvironmentKCouchbase string = "kCouchbase"

	// ProtectionJobEnvironmentKHdfs captures enum value "kHdfs"
	ProtectionJobEnvironmentKHdfs string = "kHdfs"

	// ProtectionJobEnvironmentKHive captures enum value "kHive"
	ProtectionJobEnvironmentKHive string = "kHive"

	// ProtectionJobEnvironmentKHBase captures enum value "kHBase"
	ProtectionJobEnvironmentKHBase string = "kHBase"

	// ProtectionJobEnvironmentKUDA captures enum value "kUDA"
	ProtectionJobEnvironmentKUDA string = "kUDA"

	// ProtectionJobEnvironmentKO365Teams captures enum value "kO365Teams"
	ProtectionJobEnvironmentKO365Teams string = "kO365Teams"

	// ProtectionJobEnvironmentKO365Group captures enum value "kO365Group"
	ProtectionJobEnvironmentKO365Group string = "kO365Group"

	// ProtectionJobEnvironmentKO365Exchange captures enum value "kO365Exchange"
	ProtectionJobEnvironmentKO365Exchange string = "kO365Exchange"

	// ProtectionJobEnvironmentKO365OneDrive captures enum value "kO365OneDrive"
	ProtectionJobEnvironmentKO365OneDrive string = "kO365OneDrive"

	// ProtectionJobEnvironmentKO365Sharepoint captures enum value "kO365Sharepoint"
	ProtectionJobEnvironmentKO365Sharepoint string = "kO365Sharepoint"

	// ProtectionJobEnvironmentKO365PublicFolders captures enum value "kO365PublicFolders"
	ProtectionJobEnvironmentKO365PublicFolders string = "kO365PublicFolders"
)

// prop value enum
func (m *ProtectionJob) validateEnvironmentEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, protectionJobTypeEnvironmentPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProtectionJob) validateEnvironment(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateEnvironmentParameters(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateFullProtectionStartTime(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateIncrementalProtectionStartTime(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateIndexingPolicy(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateLastRun(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateMissingEntities(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateName(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validatePolicyID(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validatePostBackupScript(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validatePreBackupScript(formats strfmt.Registry) error {
...
var protectionJobTypePriorityPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		protectionJobTypePriorityPropEnum = append(protectionJobTypePriorityPropEnum, v)
	}
}

const (

	// ProtectionJobPriorityKLow captures enum value "kLow"
	ProtectionJobPriorityKLow string = "kLow"

	// ProtectionJobPriorityKMedium captures enum value "kMedium"
	ProtectionJobPriorityKMedium string = "kMedium"

	// ProtectionJobPriorityKHigh captures enum value "kHigh"
	ProtectionJobPriorityKHigh string = "kHigh"
)

// prop value enum
func (m *ProtectionJob) validatePriorityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, protectionJobTypePriorityPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProtectionJob) validatePriority(formats strfmt.Registry) error {
...
var protectionJobTypeQosTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		protectionJobTypeQosTypePropEnum = append(protectionJobTypeQosTypePropEnum, v)
	}
}

const (

	// ProtectionJobQosTypeKBackupHDD captures enum value "kBackupHDD"
	ProtectionJobQosTypeKBackupHDD string = "kBackupHDD"

	// ProtectionJobQosTypeKBackupSSD captures enum value "kBackupSSD"
	ProtectionJobQosTypeKBackupSSD string = "kBackupSSD"

	// ProtectionJobQosTypeKTestAndDevHigh captures enum value "kTestAndDevHigh"
	ProtectionJobQosTypeKTestAndDevHigh string = "kTestAndDevHigh"

	// ProtectionJobQosTypeKBackupAll captures enum value "kBackupAll"
	ProtectionJobQosTypeKBackupAll string = "kBackupAll"
)

// prop value enum
func (m *ProtectionJob) validateQosTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, protectionJobTypeQosTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ProtectionJob) validateQosType(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateRemoteScript(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateRemoteViewConfigList(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateSourceSpecialParameters(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateSources(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateStartTime(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateSummaryStats(formats strfmt.Registry) error {
	if swag.IsZero(m.SummaryStats) { // not required
		return nil
	}

	if m.SummaryStats != nil {
		if err := m.SummaryStats.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("summaryStats")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("summaryStats")
			}
			return err
		}
	}
...
func (m *ProtectionJob) validateTaskTimeouts(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateUID(formats strfmt.Registry) error {
...
func (m *ProtectionJob) validateViewBoxID(formats strfmt.Registry) error {
...
// ContextValidate validate this protection job based on the context it is used
func (m *ProtectionJob) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
	...
	if err := m.contextValidateSummaryStats(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ProtectionJob) contextValidateAlertingConfig(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateCloudParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateDataMigrationPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateEnvironmentParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateFullProtectionStartTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateIncrementalProtectionStartTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateIndexingPolicy(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateLastRun(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateMissingEntities(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidatePostBackupScript(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidatePreBackupScript(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateRemoteScript(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateRemoteViewConfigList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateSourceSpecialParameters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateSources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateStartTime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateSummaryStats(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.SummaryStats != nil {
		...
		if err := m.SummaryStats.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("summaryStats")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("summaryStats")
...
func (m *ProtectionJob) contextValidateTaskTimeouts(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) contextValidateUID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProtectionJob) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ProtectionJob) UnmarshalBinary(b []byte) error {
	var res ProtectionJob
