...
type Vlan struct {
	...
	// for display.
	LoopbackInterfaceGroupID *int32 `json:"interfaceGroupId,omitempty"`

	// mtu
	Mtu *int32 `json:"mtu,omitempty"`

	// Static Vips
	StaticVips []*StaticVip `json:"staticVips"`
...
func (m *Vlan) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateStaticVips(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Vlan) validateStaticVips(formats strfmt.Registry) error {
	if swag.IsZero(m.StaticVips) { // not required
		return nil
	}

	for i := 0; i < len(m.StaticVips); i++ {
		if swag.IsZero(m.StaticVips[i]) { // not required
			continue
		}

		if m.StaticVips[i] != nil {
			if err := m.StaticVips[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("staticVips" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("staticVips" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *Vlan) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateStaticVips(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Vlan) contextValidateStaticVips(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.StaticVips); i++ {

		if m.StaticVips[i] != nil {
			if err := m.StaticVips[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("staticVips" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("staticVips" + "." + strconv.Itoa(i))
