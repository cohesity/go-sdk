...
type PerformRestoreTaskStateProto struct {
	...
	// Aggregated stats information for all objects recovered by this restore
	// task.
	AggregatedStats *RestoreStatsProto `json:"aggregatedStats,omitempty"`
	...
	// When a restore job is translated into a restore task, the list of child
	// tasks from the restore job is stored here.
	ChildRestoreTaskIDVec []int64 `json:"childRestoreTaskIdVec"`
	...
	// Whether to download the data to cluster during restore.
	// If this is false, then the cluster will download the corresponding data
	// only when files in the view are read.
	DownloadDataToCluster *bool `json:"downloadDataToCluster,omitempty"`
	...
	// This field defines the common filter params for filtering the entities
	// being restored. Eg - This is used in O365 restore tasks to filter and
	// selectively recover items in a mailbox entity.
	...
	// NFS protocol that will be used for mounting the Cohesity view to
	// target environment. This is applicable only if the recovery request
	// mounts the Cohesity view on the target environment.
	...
	// set for restore types
	// kRecoverApp/kCloneApp/kCloneRefreshApp/kRecoverAppFiles.
	RestoreAppTaskState *RestoreAppTaskStateProto `json:"restoreAppTaskState,omitempty"`

	// This field defines the Azure blob storage specific params for restore task
	// of type kRecoverAzureBlobStorage.
	RestoreAzureBlobStorageParams *RestoreAzureBlobStorageParams `json:"restoreAzureBlobStorageParams,omitempty"`
	...
	// kRecoverEmails and kRecoverO365ToExchangeServer.
	...
	// Whether to restore standard metadata fields (Author, Editor, Created,
	// Modified) for supported O365 workloads when applicable. If set to true,
	// slave will attempt to restore these fields subject to feature support and
	// environment semantics.
	ShouldRestoreStandardMetadataFields *bool `json:"shouldRestoreStandardMetadataFields,omitempty"`
...
func (m *PerformRestoreTaskStateProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRestoreAzureBlobStorageParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *PerformRestoreTaskStateProto) validateAggregatedStats(formats strfmt.Registry) error {
...
func (m *PerformRestoreTaskStateProto) validateFilterParams(formats strfmt.Registry) error {
...
func (m *PerformRestoreTaskStateProto) validateRestoreAzureBlobStorageParams(formats strfmt.Registry) error {
	if swag.IsZero(m.RestoreAzureBlobStorageParams) { // not required
		return nil
	}

	if m.RestoreAzureBlobStorageParams != nil {
		if err := m.RestoreAzureBlobStorageParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("restoreAzureBlobStorageParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("restoreAzureBlobStorageParams")
			}
			return err
		}
	}
...
func (m *PerformRestoreTaskStateProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateRestoreAzureBlobStorageParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *PerformRestoreTaskStateProto) contextValidateAggregatedStats(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PerformRestoreTaskStateProto) contextValidateFilterParams(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PerformRestoreTaskStateProto) contextValidateRestoreAzureBlobStorageParams(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.RestoreAzureBlobStorageParams != nil {
		...
		if err := m.RestoreAzureBlobStorageParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("restoreAzureBlobStorageParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("restoreAzureBlobStorageParams")
