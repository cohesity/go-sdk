...
type Tenant struct {
	...
	DeletionInfo []*TenantDeletionInfo `json:"deletionInfoVec"`
...
func (m *Tenant) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDeletionInfo(formats); err != nil {
		res = append(res, err)
	}
...
func (m *Tenant) validateDeletionInfo(formats strfmt.Registry) error {
	if swag.IsZero(m.DeletionInfo) { // not required
		return nil
	}

	for i := 0; i < len(m.DeletionInfo); i++ {
		if swag.IsZero(m.DeletionInfo[i]) { // not required
			continue
		}

		if m.DeletionInfo[i] != nil {
			if err := m.DeletionInfo[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
...
func (m *Tenant) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDeletionInfo(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *Tenant) contextValidateDeletionInfo(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.DeletionInfo); i++ {

		if m.DeletionInfo[i] != nil {
			if err := m.DeletionInfo[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("deletionInfoVec" + "." + strconv.Itoa(i))
				} else if ce, ok := err.(*errors.CompositeError); ok {
					return ce.ValidateName("deletionInfoVec" + "." + strconv.Itoa(i))
