...
type CapacityByTier struct {
	...
	// the storage tier.
	TierMaxPhysicalCapacityBytes *int64 `json:"tierMaxPhysicalCapacityBytes,omitempty"`
}
...
const (
	...
	// CapacityByTierStorageTierSATADashSSD captures enum value "SATA-SSD"
	CapacityByTierStorageTierSATADashSSD string = "SATA-SSD"

	// CapacityByTierStorageTierSATADashHDD captures enum value "SATA-HDD"
	CapacityByTierStorageTierSATADashHDD string = "SATA-HDD"
