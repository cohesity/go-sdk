...
type S3BucketConfigProto struct {
	...
	// This field describes the logging policy set on a bucket.
	BucketLoggingConfig *BucketLoggingProto `json:"bucketLoggingConfig,omitempty"`
...
func (m *S3BucketConfigProto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateBucketLoggingConfig(formats); err != nil {
		res = append(res, err)
	}
...
func (m *S3BucketConfigProto) validateBucketLoggingConfig(formats strfmt.Registry) error {
	if swag.IsZero(m.BucketLoggingConfig) { // not required
		return nil
	}

	if m.BucketLoggingConfig != nil {
		if err := m.BucketLoggingConfig.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("bucketLoggingConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("bucketLoggingConfig")
			}
			return err
		}
	}
...
func (m *S3BucketConfigProto) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateBucketLoggingConfig(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *S3BucketConfigProto) contextValidateBucketLoggingConfig(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.BucketLoggingConfig != nil {
		...
		if err := m.BucketLoggingConfig.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("bucketLoggingConfig")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("bucketLoggingConfig")
