...
func (m *OracleBackupJobParams) validateNfsParams(formats strfmt.Registry) error {
...
func (m *OracleBackupJobParams) contextValidateNfsParams(ctx context.Context, formats strfmt.Registry) error {
