...
func (m *RestoreOracleAppObjectParams) validateNfsParams(formats strfmt.Registry) error {
...
func (m *RestoreOracleAppObjectParams) contextValidateNfsParams(ctx context.Context, formats strfmt.Registry) error {
