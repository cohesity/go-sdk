...
type AzureCloudCredentials struct {
	...
	// 'kAzureTierCold' indicates a tier type of Azure properties that is
	// accessed less frequently, and stored for at least 90 days.
	// Enum: ["kAzureTierHot","kAzureTierCool","kAzureTierArchive","kAzureTierCold"]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["kAzureTierHot","kAzureTierCool","kAzureTierArchive","kAzureTierCold"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// AzureCloudCredentialsTierTypeKAzureTierCold captures enum value "kAzureTierCold"
	AzureCloudCredentialsTierTypeKAzureTierCold string = "kAzureTierCold"
)
