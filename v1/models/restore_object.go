...
type RestoreObject struct {
	...
	AdditionalRestoreTaskParams []uint8 `json:"additionalRestoreTaskParams"`
	...
	// Opaque bytes with list of granular objects to restore like UUID of AAD
	// objects with any restore parameters applicable to the specific object.
	GranularRestoreObjectInfo [][]uint8 `json:"granularRestoreObjectInfo"`
	...
	// Recover params specific to Generic adapters.
	GenericAdapterRecoverParams *GenericAdapterRecoverParams `json:"genericAdapterRecoverParams,omitempty"`
	...
	// O365 outlook specific parameters needed to restore a single Mailbox.
	OutlookRestoreEntityParams *O365OutlookRestoreEntityParams `json:"outlookRestoreEntityParams,omitempty"`
...
func (m *RestoreObject) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGenericAdapterRecoverParams(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateOutlookRestoreEntityParams(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreObject) validateGenericAdapterRecoverParams(formats strfmt.Registry) error {
	if swag.IsZero(m.GenericAdapterRecoverParams) { // not required
		return nil
	}

	if m.GenericAdapterRecoverParams != nil {
		if err := m.GenericAdapterRecoverParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterRecoverParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterRecoverParams")
			}
			return err
		}
	}
...
func (m *RestoreObject) validateOutlookRestoreEntityParams(formats strfmt.Registry) error {
	if swag.IsZero(m.OutlookRestoreEntityParams) { // not required
		return nil
	}

	if m.OutlookRestoreEntityParams != nil {
		if err := m.OutlookRestoreEntityParams.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("outlookRestoreEntityParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("outlookRestoreEntityParams")
			}
			return err
		}
	}
...
func (m *RestoreObject) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGenericAdapterRecoverParams(ctx, formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.contextValidateOutlookRestoreEntityParams(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RestoreObject) contextValidateGenericAdapterRecoverParams(ctx context.Context, formats strfmt.Registry) error {

	if m.GenericAdapterRecoverParams != nil {
		if err := m.GenericAdapterRecoverParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("genericAdapterRecoverParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("genericAdapterRecoverParams")
...
func (m *RestoreObject) contextValidateOutlookRestoreEntityParams(ctx context.Context, formats strfmt.Registry) error {

	if m.OutlookRestoreEntityParams != nil {
		if err := m.OutlookRestoreEntityParams.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("outlookRestoreEntityParams")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("outlookRestoreEntityParams")
