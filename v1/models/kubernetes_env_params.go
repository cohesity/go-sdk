...
type KubernetesEnvParams struct {
	...
	// If set to true, magneto will exclude .snapshot directories from PVC
	// backups to avoid backing up duplicate data. This applies filtering policy
	// to exclude paths matching .snapshot directory patterns.
	...
	// User specified timeout in seconds for snapshot creation.
	SnapshotTimeoutSecs *int32 `json:"snapshotTimeoutSecs,omitempty"`
