...
// AlertResolutionDetails Specifies information about the Alert Resolution such as a summary, id assigned by the Cohesity Cluster, user who resolved the Alerts, etc.
...
func (o *AlertResolutionDetails) GetResolutionId() int64 {
	if o == nil || o.ResolutionId.Get() == nil {
		var ret int64
		return ret
	}
